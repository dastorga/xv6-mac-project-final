...
opentest(void)
{
  ...
  if(fd < 0){
    ...
    printf(stdout, "open echo failed!\n");
      38:	a1 b8 5e 00 00       	mov    0x5eb8,%eax
  ...
  if(fd >= 0){
    ...
    printf(stdout, "open doesnotexist succeeded!\n");
      7a:	a1 b8 5e 00 00       	mov    0x5eb8,%eax
  ...
  printf(stdout, "open test ok\n");
      94:	a1 b8 5e 00 00       	mov    0x5eb8,%eax
...
writetest(void)
{
  ...
  printf(stdout, "small file test\n");
      b1:	a1 b8 5e 00 00       	mov    0x5eb8,%eax
  ...
  if(fd >= 0){
    ...
    printf(stdout, "creat small succeeded; ok\n");
      e3:	a1 b8 5e 00 00       	mov    0x5eb8,%eax
  ...
  for(i = 0; i < 100; i++){
    ...
    printf(stdout, "error: creat small failed!\n");
     104:	a1 b8 5e 00 00       	mov    0x5eb8,%eax
    ...
    if(write(fd, "aaaaaaaaaa", 10) != 10){
     ...
     13e:	a1 b8 5e 00 00       	mov    0x5eb8,%eax
    ...
    if(write(fd, "bbbbbbbbbb", 10) != 10){
     ...
     17f:	a1 b8 5e 00 00       	mov    0x5eb8,%eax
  ...
  printf(stdout, "writes ok\n");
     1ad:	a1 b8 5e 00 00       	mov    0x5eb8,%eax
     1b2:	c7 44 24 04 80 42 00 	movl   $0x4280,0x4(%esp)
     1b9:	00 
     1ba:	89 04 24             	mov    %eax,(%esp)
     1bd:	e8 db 3b 00 00       	call   3d9d <printf>
  close(fd);
  ...
  fd = open("small", O_RDONLY);
     ...
     1d4:	00 
     1d5:	c7 04 24 e2 41 00 00 	movl   $0x41e2,(%esp)
  ...
  if(fd >= 0){
    ...
    printf(stdout, "open small succeeded ok\n");
     1ea:	a1 b8 5e 00 00       	mov    0x5eb8,%eax
     1ef:	c7 44 24 04 8b 42 00 	movl   $0x428b,0x4(%esp)
     1f6:	00 
     1f7:	89 04 24             	mov    %eax,(%esp)
     1fa:	e8 9e 3b 00 00       	call   3d9d <printf>
  } else {
  ...
  if(i == 2000){
    ...
    printf(stdout, "error: open small failed!\n");
     228:	a1 b8 5e 00 00       	mov    0x5eb8,%eax
     22d:	c7 44 24 04 a4 42 00 	movl   $0x42a4,0x4(%esp)
     234:	00 
     235:	89 04 24             	mov    %eax,(%esp)
     238:	e8 60 3b 00 00       	call   3d9d <printf>
    exit();
     23d:	e8 c3 39 00 00       	call   3c05 <exit>
    printf(stdout, "read succeeded ok\n");
     242:	a1 b8 5e 00 00       	mov    0x5eb8,%eax
     247:	c7 44 24 04 bf 42 00 	movl   $0x42bf,0x4(%esp)
     24e:	00 
     24f:	89 04 24             	mov    %eax,(%esp)
     252:	e8 46 3b 00 00       	call   3d9d <printf>
  } else {
  ...
  if(unlink("small") < 0){
     262:	c7 04 24 e2 41 00 00 	movl   $0x41e2,(%esp)
     269:	e8 e7 39 00 00       	call   3c55 <unlink>
     26e:	85 c0                	test   %eax,%eax
     270:	78 1c                	js     28e <writetest+0x1e3>
     272:	eb 34                	jmp    2a8 <writetest+0x1fd>
    printf(stdout, "read failed\n");
     274:	a1 b8 5e 00 00       	mov    0x5eb8,%eax
     279:	c7 44 24 04 d2 42 00 	movl   $0x42d2,0x4(%esp)
     280:	00 
     281:	89 04 24             	mov    %eax,(%esp)
     284:	e8 14 3b 00 00       	call   3d9d <printf>
    exit();
     289:	e8 77 39 00 00       	call   3c05 <exit>
    printf(stdout, "unlink small failed\n");
     28e:	a1 b8 5e 00 00       	mov    0x5eb8,%eax
     293:	c7 44 24 04 df 42 00 	movl   $0x42df,0x4(%esp)
     29a:	00 
     29b:	89 04 24             	mov    %eax,(%esp)
     29e:	e8 fa 3a 00 00       	call   3d9d <printf>
    exit();
     2a3:	e8 5d 39 00 00       	call   3c05 <exit>
  }
  printf(stdout, "small file test ok\n");
     2a8:	a1 b8 5e 00 00       	mov    0x5eb8,%eax
     2ad:	c7 44 24 04 f4 42 00 	movl   $0x42f4,0x4(%esp)
     2b4:	00 
     2b5:	89 04 24             	mov    %eax,(%esp)
     2b8:	e8 e0 3a 00 00       	call   3d9d <printf>
}
     2bd:	c9                   	leave  
     2be:	c3                   	ret    
...
writetest1(void)
{
  ...
  printf(stdout, "big files test\n");
     ...
     2ca:	c7 44 24 04 08 43 00 	movl   $0x4308,0x4(%esp)
     2d1:	00 
     2d2:	89 04 24             	mov    %eax,(%esp)
     2d5:	e8 c3 3a 00 00       	call   3d9d <printf>

  fd = open("big", O_CREATE|O_RDWR);
     2da:	c7 44 24 04 02 02 00 	movl   $0x202,0x4(%esp)
     2e1:	00 
     2e2:	c7 04 24 18 43 00 00 	movl   $0x4318,(%esp)
  ...
  if(fd < 0){
    ...
    printf(stdout, "error: creat big failed!\n");
     2f7:	a1 b8 5e 00 00       	mov    0x5eb8,%eax
     2fc:	c7 44 24 04 1c 43 00 	movl   $0x431c,0x4(%esp)
     303:	00 
     304:	89 04 24             	mov    %eax,(%esp)
     307:	e8 91 3a 00 00       	call   3d9d <printf>
    exit();
  ...
  for(i = 0; i < MAXFILE; i++){
    ...
    if(write(fd, buf, 512) != 512){
     ...
     352:	c7 44 24 04 36 43 00 	movl   $0x4336,0x4(%esp)
     359:	00 
     35a:	89 04 24             	mov    %eax,(%esp)
     35d:	e8 3b 3a 00 00       	call   3d9d <printf>
      exit();
  ...
  fd = open("big", O_RDONLY);
     ...
     386:	00 
     387:	c7 04 24 18 43 00 00 	movl   $0x4318,(%esp)
  ...
  if(fd < 0){
    ...
    printf(stdout, "error: open big failed!\n");
     39c:	a1 b8 5e 00 00       	mov    0x5eb8,%eax
     3a1:	c7 44 24 04 54 43 00 	movl   $0x4354,0x4(%esp)
     3a8:	00 
     3a9:	89 04 24             	mov    %eax,(%esp)
     3ac:	e8 ec 39 00 00       	call   3d9d <printf>
    exit();
  ...
  for(;;){
    ...
    if(i == 0){
     ...
     3ee:	a1 b8 5e 00 00       	mov    0x5eb8,%eax
     3f3:	8b 55 f0             	mov    -0x10(%ebp),%edx
     3f6:	89 54 24 08          	mov    %edx,0x8(%esp)
     3fa:	c7 44 24 04 6d 43 00 	movl   $0x436d,0x4(%esp)
     401:	00 
     402:	89 04 24             	mov    %eax,(%esp)
     405:	e8 93 39 00 00       	call   3d9d <printf>
        exit();
     ...
     418:	a1 b8 5e 00 00       	mov    0x5eb8,%eax
     41d:	8b 55 f4             	mov    -0xc(%ebp),%edx
     420:	89 54 24 08          	mov    %edx,0x8(%esp)
     424:	c7 44 24 04 8a 43 00 	movl   $0x438a,0x4(%esp)
     42b:	00 
     42c:	89 04 24             	mov    %eax,(%esp)
     42f:	e8 69 39 00 00       	call   3d9d <printf>
      exit();
  ...
  if(unlink("big") < 0){
     485:	c7 04 24 18 43 00 00 	movl   $0x4318,(%esp)
     48c:	e8 c4 37 00 00       	call   3c55 <unlink>
     491:	85 c0                	test   %eax,%eax
     493:	79 1a                	jns    4af <writetest1+0x1f0>
    printf(stdout, "unlink big failed\n");
     495:	a1 b8 5e 00 00       	mov    0x5eb8,%eax
     49a:	c7 44 24 04 bc 43 00 	movl   $0x43bc,0x4(%esp)
     4a1:	00 
     4a2:	89 04 24             	mov    %eax,(%esp)
     4a5:	e8 f3 38 00 00       	call   3d9d <printf>
    exit();
     4aa:	e8 56 37 00 00       	call   3c05 <exit>
  }
  printf(stdout, "big files ok\n");
     4af:	a1 b8 5e 00 00       	mov    0x5eb8,%eax
     4b4:	c7 44 24 04 cf 43 00 	movl   $0x43cf,0x4(%esp)
     4bb:	00 
     4bc:	89 04 24             	mov    %eax,(%esp)
     4bf:	e8 d9 38 00 00       	call   3d9d <printf>
}
     4c4:	c9                   	leave  
     4c5:	c3                   	ret    
...
createtest(void)
{
  ...
  printf(stdout, "many creates, followed by unlink test\n");
     4cc:	a1 b8 5e 00 00       	mov    0x5eb8,%eax
     4d1:	c7 44 24 04 e0 43 00 	movl   $0x43e0,0x4(%esp)
     4d8:	00 
     4d9:	89 04 24             	mov    %eax,(%esp)
     4dc:	e8 bc 38 00 00       	call   3d9d <printf>
  ...
  printf(stdout, "many creates, followed by unlink; ok\n");
     ...
     56a:	c7 44 24 04 08 44 00 	movl   $0x4408,0x4(%esp)
     571:	00 
     572:	89 04 24             	mov    %eax,(%esp)
     575:	e8 23 38 00 00       	call   3d9d <printf>
}
     57a:	c9                   	leave  
     57b:	c3                   	ret    
...
void dirtest(void)
{
  ...
  printf(stdout, "mkdir test\n");
     582:	a1 b8 5e 00 00       	mov    0x5eb8,%eax
     587:	c7 44 24 04 2e 44 00 	movl   $0x442e,0x4(%esp)
     58e:	00 
     58f:	89 04 24             	mov    %eax,(%esp)
     592:	e8 06 38 00 00       	call   3d9d <printf>

  if(mkdir("dir0") < 0){
     597:	c7 04 24 3a 44 00 00 	movl   $0x443a,(%esp)
     59e:	e8 ca 36 00 00       	call   3c6d <mkdir>
     5a3:	85 c0                	test   %eax,%eax
     5a5:	79 1a                	jns    5c1 <dirtest+0x45>
    printf(stdout, "mkdir failed\n");
     5a7:	a1 b8 5e 00 00       	mov    0x5eb8,%eax
     5ac:	c7 44 24 04 3f 44 00 	movl   $0x443f,0x4(%esp)
     5b3:	00 
     5b4:	89 04 24             	mov    %eax,(%esp)
     5b7:	e8 e1 37 00 00       	call   3d9d <printf>
    exit();
     5bc:	e8 44 36 00 00       	call   3c05 <exit>
  }

  if(chdir("dir0") < 0){
     5c1:	c7 04 24 3a 44 00 00 	movl   $0x443a,(%esp)
     5c8:	e8 a8 36 00 00       	call   3c75 <chdir>
     5cd:	85 c0                	test   %eax,%eax
     5cf:	79 1a                	jns    5eb <dirtest+0x6f>
    printf(stdout, "chdir dir0 failed\n");
     5d1:	a1 b8 5e 00 00       	mov    0x5eb8,%eax
     5d6:	c7 44 24 04 4d 44 00 	movl   $0x444d,0x4(%esp)
     5dd:	00 
     5de:	89 04 24             	mov    %eax,(%esp)
     5e1:	e8 b7 37 00 00       	call   3d9d <printf>
    exit();
     5e6:	e8 1a 36 00 00       	call   3c05 <exit>
  }

  if(chdir("..") < 0){
     5eb:	c7 04 24 60 44 00 00 	movl   $0x4460,(%esp)
     5f2:	e8 7e 36 00 00       	call   3c75 <chdir>
     5f7:	85 c0                	test   %eax,%eax
     5f9:	79 1a                	jns    615 <dirtest+0x99>
    printf(stdout, "chdir .. failed\n");
     5fb:	a1 b8 5e 00 00       	mov    0x5eb8,%eax
     600:	c7 44 24 04 63 44 00 	movl   $0x4463,0x4(%esp)
     607:	00 
     608:	89 04 24             	mov    %eax,(%esp)
     60b:	e8 8d 37 00 00       	call   3d9d <printf>
    exit();
     610:	e8 f0 35 00 00       	call   3c05 <exit>
  }

  if(unlink("dir0") < 0){
     615:	c7 04 24 3a 44 00 00 	movl   $0x443a,(%esp)
     61c:	e8 34 36 00 00       	call   3c55 <unlink>
     621:	85 c0                	test   %eax,%eax
     623:	79 1a                	jns    63f <dirtest+0xc3>
    printf(stdout, "unlink dir0 failed\n");
     625:	a1 b8 5e 00 00       	mov    0x5eb8,%eax
     62a:	c7 44 24 04 74 44 00 	movl   $0x4474,0x4(%esp)
     631:	00 
     632:	89 04 24             	mov    %eax,(%esp)
     635:	e8 63 37 00 00       	call   3d9d <printf>
    exit();
     63a:	e8 c6 35 00 00       	call   3c05 <exit>
  }
  printf(stdout, "mkdir test\n");
     63f:	a1 b8 5e 00 00       	mov    0x5eb8,%eax
     644:	c7 44 24 04 2e 44 00 	movl   $0x442e,0x4(%esp)
     64b:	00 
     64c:	89 04 24             	mov    %eax,(%esp)
     64f:	e8 49 37 00 00       	call   3d9d <printf>
}
     654:	c9                   	leave  
     655:	c3                   	ret    
...
exectest(void)
{
  ...
  printf(stdout, "exec test\n");
     65c:	a1 b8 5e 00 00       	mov    0x5eb8,%eax
     661:	c7 44 24 04 88 44 00 	movl   $0x4488,0x4(%esp)
     668:	00 
     669:	89 04 24             	mov    %eax,(%esp)
     66c:	e8 2c 37 00 00       	call   3d9d <printf>
  if(exec("echo", echoargv) < 0){
     671:	c7 44 24 04 a4 5e 00 	movl   $0x5ea4,0x4(%esp)
     678:	00 
     679:	c7 04 24 64 41 00 00 	movl   $0x4164,(%esp)
     680:	e8 b8 35 00 00       	call   3c3d <exec>
     685:	85 c0                	test   %eax,%eax
     687:	79 1a                	jns    6a3 <exectest+0x4d>
    printf(stdout, "exec echo failed\n");
     689:	a1 b8 5e 00 00       	mov    0x5eb8,%eax
     68e:	c7 44 24 04 93 44 00 	movl   $0x4493,0x4(%esp)
     695:	00 
     696:	89 04 24             	mov    %eax,(%esp)
     699:	e8 ff 36 00 00       	call   3d9d <printf>
    exit();
...
pipe1(void)
{
  ...
  if(pipe(fds) != 0){
    ...
    printf(1, "pipe() failed\n");
     6ba:	c7 44 24 04 a5 44 00 	movl   $0x44a5,0x4(%esp)
     6c1:	00 
     6c2:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
     6c9:	e8 cf 36 00 00       	call   3d9d <printf>
    exit();
  ...
  if(pid == 0){
    ...
    for(n = 0; n < 5; n++){
     ...
     748:	c7 44 24 04 b4 44 00 	movl   $0x44b4,0x4(%esp)
     74f:	00 
     750:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
     757:	e8 41 36 00 00       	call   3d9d <printf>
        exit();
    ...
    while((n = read(fds[0], buf, cc)) > 0){
     ...
     7be:	c7 44 24 04 c2 44 00 	movl   $0x44c2,0x4(%esp)
     7c5:	00 
     7c6:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
     7cd:	e8 cb 35 00 00       	call   3d9d <printf>
    ...
    if(total != 5 * 1033){
     ...
     833:	c7 44 24 04 d0 44 00 	movl   $0x44d0,0x4(%esp)
     83a:	00 
     83b:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
     842:	e8 56 35 00 00       	call   3d9d <printf>
      exit();
  ...
  printf(1, "pipe1 ok\n");
     85c:	c7 44 24 04 e7 44 00 	movl   $0x44e7,0x4(%esp)
     863:	00 
     864:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
     86b:	e8 2d 35 00 00       	call   3d9d <printf>
     870:	eb 19                	jmp    88b <pipe1+0x1e6>
    printf(1, "fork() failed\n");
     872:	c7 44 24 04 f1 44 00 	movl   $0x44f1,0x4(%esp)
     879:	00 
     87a:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
     881:	e8 17 35 00 00       	call   3d9d <printf>
    exit();
...
preempt(void)
{
  ...
  printf(1, "preempt: ");
     893:	c7 44 24 04 00 45 00 	movl   $0x4500,0x4(%esp)
     89a:	00 
     89b:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
     8a2:	e8 f6 34 00 00       	call   3d9d <printf>
  pid1 = fork();
  ...
  if(pid3 == 0){
    ...
    if(write(pfds[1], "x", 1) != 1)
     ...
     8f5:	00 
     8f6:	c7 44 24 04 0a 45 00 	movl   $0x450a,0x4(%esp)
     8fd:	00 
     ...
     90b:	c7 44 24 04 0c 45 00 	movl   $0x450c,0x4(%esp)
     912:	00 
     913:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
     91a:	e8 7e 34 00 00       	call   3d9d <printf>
    close(pfds[1]);
  ...
  if(read(pfds[0], buf, sizeof(buf)) != 1){
    ...
    printf(1, "preempt read error");
     957:	c7 44 24 04 20 45 00 	movl   $0x4520,0x4(%esp)
     95e:	00 
     95f:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
     966:	e8 32 34 00 00       	call   3d9d <printf>
  ...
  printf(1, "kill... ");
     978:	c7 44 24 04 33 45 00 	movl   $0x4533,0x4(%esp)
     97f:	00 
     980:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
     987:	e8 11 34 00 00       	call   3d9d <printf>
  kill(pid1);
  ...
  printf(1, "wait... ");
     9ad:	c7 44 24 04 3c 45 00 	movl   $0x453c,0x4(%esp)
     9b4:	00 
     9b5:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
     9bc:	e8 dc 33 00 00       	call   3d9d <printf>
  wait();
  ...
  printf(1, "preempt ok\n");
     9d0:	c7 44 24 04 45 45 00 	movl   $0x4545,0x4(%esp)
     9d7:	00 
     9d8:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
     9df:	e8 b9 33 00 00       	call   3d9d <printf>
}
     9e4:	c9                   	leave  
     9e5:	c3                   	ret    
...
exitwait(void)
{
  ...
  for(i = 0; i < 100; i++){
    ...
    if(pid < 0){
     ...
     a01:	79 16                	jns    a19 <exitwait+0x33>
      printf(1, "fork failed\n");
     a03:	c7 44 24 04 51 45 00 	movl   $0x4551,0x4(%esp)
     a0a:	00 
     a0b:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
     a12:	e8 86 33 00 00       	call   3d9d <printf>
      return;
    ...
    if(pid){
     ...
     a29:	c7 44 24 04 5e 45 00 	movl   $0x455e,0x4(%esp)
     a30:	00 
     a31:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
     a38:	e8 60 33 00 00       	call   3d9d <printf>
        return;
  ...
  printf(1, "exitwait ok\n");
     a4d:	c7 44 24 04 6e 45 00 	movl   $0x456e,0x4(%esp)
     a54:	00 
     a55:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
     a5c:	e8 3c 33 00 00       	call   3d9d <printf>
}
     a61:	c9                   	leave  
     a62:	c3                   	ret    
...
mem(void)
{
  ...
  printf(1, "mem test\n");
     a69:	c7 44 24 04 7b 45 00 	movl   $0x457b,0x4(%esp)
     a70:	00 
     a71:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
     a78:	e8 20 33 00 00       	call   3d9d <printf>
  ppid = getpid();
  ...
  if((pid = fork()) == 0){
    ...
    while((m2 = malloc(10001)) != 0){
     ...
     ab5:	e8 ca 35 00 00       	call   4084 <malloc>
    ...
    while(m1){
     ...
     ad3:	e8 73 34 00 00       	call   3f4b <free>
      m1 = m2;
    ...
    free(m1);
     ...
     b23:	e8 23 34 00 00       	call   3f4b <free>
    printf(1, "mem ok\n");
     b28:	c7 44 24 04 9f 45 00 	movl   $0x459f,0x4(%esp)
     b2f:	00 
     b30:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
     b37:	e8 61 32 00 00       	call   3d9d <printf>
    exit();
...
sharedfd(void)
{
  ...
  printf(1, "sharedfd test\n");
     b4e:	c7 44 24 04 a7 45 00 	movl   $0x45a7,0x4(%esp)
     b55:	00 
     b56:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
     b5d:	e8 3b 32 00 00       	call   3d9d <printf>

  unlink("sharedfd");
     b62:	c7 04 24 b6 45 00 00 	movl   $0x45b6,(%esp)
     b69:	e8 e7 30 00 00       	call   3c55 <unlink>
  fd = open("sharedfd", O_CREATE|O_RDWR);
     b6e:	c7 44 24 04 02 02 00 	movl   $0x202,0x4(%esp)
     b75:	00 
     b76:	c7 04 24 b6 45 00 00 	movl   $0x45b6,(%esp)
  ...
  if(fd < 0){
    ...
    printf(1, "fstests: cannot open sharedfd for writing");
     b8b:	c7 44 24 04 c0 45 00 	movl   $0x45c0,0x4(%esp)
     b92:	00 
     b93:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
     b9a:	e8 fe 31 00 00       	call   3d9d <printf>
  ...
  for(i = 0; i < 1000; i++){
    ...
    if(write(fd, buf, sizeof(buf)) != sizeof(buf)){
     ...
     bfd:	c7 44 24 04 ec 45 00 	movl   $0x45ec,0x4(%esp)
     c04:	00 
     c05:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
     c0c:	e8 8c 31 00 00       	call   3d9d <printf>
      break;
  ...
  fd = open("sharedfd", 0);
     ...
     c41:	00 
     c42:	c7 04 24 b6 45 00 00 	movl   $0x45b6,(%esp)
  ...
  if(fd < 0){
    ...
    printf(1, "fstests: cannot open sharedfd for reading\n");
     c57:	c7 44 24 04 0c 46 00 	movl   $0x460c,0x4(%esp)
     c5e:	00 
     c5f:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
     c66:	e8 32 31 00 00       	call   3d9d <printf>
  ...
  unlink("sharedfd");
     ce3:	c7 04 24 b6 45 00 00 	movl   $0x45b6,(%esp)
  ...
  if(nc == 10000 && np == 10000){
    ...
    printf(1, "sharedfd ok\n");
     d01:	c7 44 24 04 37 46 00 	movl   $0x4637,0x4(%esp)
     d08:	00 
     d09:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
     d10:	e8 88 30 00 00       	call   3d9d <printf>
    ...
    printf(1, "sharedfd oops %d %d\n", nc, np);
     ...
     d25:	c7 44 24 04 44 46 00 	movl   $0x4644,0x4(%esp)
     d2c:	00 
     d2d:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
     d34:	e8 64 30 00 00       	call   3d9d <printf>
    exit();
...
twofiles(void)
{
  ...
  printf(1, "twofiles test\n");
     d46:	c7 44 24 04 59 46 00 	movl   $0x4659,0x4(%esp)
     d4d:	00 
     d4e:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
     d55:	e8 43 30 00 00       	call   3d9d <printf>

  unlink("f1");
     d5a:	c7 04 24 68 46 00 00 	movl   $0x4668,(%esp)
     d61:	e8 ef 2e 00 00       	call   3c55 <unlink>
  unlink("f2");
     d66:	c7 04 24 6b 46 00 00 	movl   $0x466b,(%esp)
  ...
  if(pid < 0){
    ...
    printf(1, "fork failed\n");
     d80:	c7 44 24 04 51 45 00 	movl   $0x4551,0x4(%esp)
     d87:	00 
     d88:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
     d8f:	e8 09 30 00 00       	call   3d9d <printf>
    exit();
  ...
  fname = pid ? "f1" : "f2";
     ...
     d9f:	b8 68 46 00 00       	mov    $0x4668,%eax
     da4:	eb 05                	jmp    dab <twofiles+0x6b>
     da6:	b8 6b 46 00 00       	mov    $0x466b,%eax
  ...
  if(fd < 0){
    ...
    printf(1, "create failed\n");
     dca:	c7 44 24 04 6e 46 00 	movl   $0x466e,0x4(%esp)
     dd1:	00 
     dd2:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
     dd9:	e8 bf 2f 00 00       	call   3d9d <printf>
    exit();
  ...
  for(i = 0; i < 12; i++){
    ...
    if((n = write(fd, buf, 500)) != 500){
     ...
     e44:	c7 44 24 04 7d 46 00 	movl   $0x467d,0x4(%esp)
     e4b:	00 
     e4c:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
     e53:	e8 45 2f 00 00       	call   3d9d <printf>
      exit();
  ...
  for(i = 0; i < 2; i++){
    ...
    fd = open(i?"f1":"f2", 0);
     ...
     e93:	b8 68 46 00 00       	mov    $0x4668,%eax
     e98:	eb 05                	jmp    e9f <twofiles+0x15f>
     e9a:	b8 6b 46 00 00       	mov    $0x466b,%eax
    ...
    while((n = read(fd, buf, sizeof(buf))) > 0){
     ...
     ee5:	74 19                	je     f00 <twofiles+0x1c0>
          printf(1, "wrong char\n");
     ee7:	c7 44 24 04 8e 46 00 	movl   $0x468e,0x4(%esp)
     eee:	00 
     eef:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
     ef6:	e8 a2 2e 00 00       	call   3d9d <printf>
          exit();
    ...
    if(total != 12*500){
     ...
     f50:	c7 44 24 04 9a 46 00 	movl   $0x469a,0x4(%esp)
     f57:	00 
     f58:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
     f5f:	e8 39 2e 00 00       	call   3d9d <printf>
      exit();
  ...
  unlink("f1");
     f76:	c7 04 24 68 46 00 00 	movl   $0x4668,(%esp)
     f7d:	e8 d3 2c 00 00       	call   3c55 <unlink>
  unlink("f2");
     f82:	c7 04 24 6b 46 00 00 	movl   $0x466b,(%esp)
     f89:	e8 c7 2c 00 00       	call   3c55 <unlink>

  printf(1, "twofiles ok\n");
     f8e:	c7 44 24 04 ab 46 00 	movl   $0x46ab,0x4(%esp)
     f95:	00 
     f96:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
     f9d:	e8 fb 2d 00 00       	call   3d9d <printf>
}
     fa2:	c9                   	leave  
     fa3:	c3                   	ret    
...
createdelete(void)
{
  ...
  printf(1, "createdelete test\n");
     faa:	c7 44 24 04 b8 46 00 	movl   $0x46b8,0x4(%esp)
     fb1:	00 
     fb2:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
     fb9:	e8 df 2d 00 00       	call   3d9d <printf>
  pid = fork();
  ...
  if(pid < 0){
    ...
    printf(1, "fork failed\n");
     fcc:	c7 44 24 04 51 45 00 	movl   $0x4551,0x4(%esp)
     fd3:	00 
     fd4:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
     fdb:	e8 bd 2d 00 00       	call   3d9d <printf>
    exit();
  ...
  for(i = 0; i < N; i++){
    ...
    1027:	79 19                	jns    1042 <createdelete+0x9e>
      printf(1, "create failed\n");
    1029:	c7 44 24 04 6e 46 00 	movl   $0x466e,0x4(%esp)
    1030:	00 
    1031:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    1038:	e8 60 2d 00 00       	call   3d9d <printf>
      exit();
    ...
    107e:	c7 44 24 04 cb 46 00 	movl   $0x46cb,0x4(%esp)
    1085:	00 
    1086:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    108d:	e8 0b 2d 00 00       	call   3d9d <printf>
        exit();
  ...
  for(i = 0; i < N; i++){
    ...
    10fc:	c7 44 24 04 dc 46 00 	movl   $0x46dc,0x4(%esp)
    1103:	00 
    1104:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    110b:	e8 8d 2c 00 00       	call   3d9d <printf>
      exit();
    ...
    112e:	c7 44 24 04 00 47 00 	movl   $0x4700,0x4(%esp)
    1135:	00 
    1136:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    113d:	e8 5b 2c 00 00       	call   3d9d <printf>
      exit();
    ...
    1194:	c7 44 24 04 dc 46 00 	movl   $0x46dc,0x4(%esp)
    119b:	00 
    119c:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    11a3:	e8 f5 2b 00 00       	call   3d9d <printf>
      exit();
    ...
    11c6:	c7 44 24 04 00 47 00 	movl   $0x4700,0x4(%esp)
    11cd:	00 
    11ce:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    11d5:	e8 c3 2b 00 00       	call   3d9d <printf>
      exit();
  ...
  printf(1, "createdelete ok\n");
    1236:	c7 44 24 04 20 47 00 	movl   $0x4720,0x4(%esp)
    123d:	00 
    123e:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    1245:	e8 53 2b 00 00       	call   3d9d <printf>
}
    124a:	c9                   	leave  
    124b:	c3                   	ret    
...
unlinkread(void)
{
  ...
  printf(1, "unlinkread test\n");
    1252:	c7 44 24 04 31 47 00 	movl   $0x4731,0x4(%esp)
    1259:	00 
    125a:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    1261:	e8 37 2b 00 00       	call   3d9d <printf>
  fd = open("unlinkread", O_CREATE | O_RDWR);
    1266:	c7 44 24 04 02 02 00 	movl   $0x202,0x4(%esp)
    126d:	00 
    126e:	c7 04 24 42 47 00 00 	movl   $0x4742,(%esp)
  ...
  if(fd < 0){
    ...
    1283:	c7 44 24 04 4d 47 00 	movl   $0x474d,0x4(%esp)
    128a:	00 
    128b:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    1292:	e8 06 2b 00 00       	call   3d9d <printf>
    exit();
  ...
  write(fd, "hello", 5);
    ...
    12a3:	00 
    12a4:	c7 44 24 04 67 47 00 	movl   $0x4767,0x4(%esp)
    12ab:	00 
  ...
  fd = open("unlinkread", O_RDWR);
    ...
    12c9:	00 
    12ca:	c7 04 24 42 47 00 00 	movl   $0x4742,(%esp)
  ...
  if(read(fd, buf, sizeof(buf)) != 5){
    ...
    137e:	c7 44 24 04 a3 47 00 	movl   $0x47a3,0x4(%esp)
    1385:	00 
    1386:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    138d:	e8 0b 2a 00 00       	call   3d9d <printf>
    exit();
  ...
  if(buf[0] != 'h'){
    ...
    13a0:	c7 44 24 04 ba 47 00 	movl   $0x47ba,0x4(%esp)
    13a7:	00 
    13a8:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    13af:	e8 e9 29 00 00       	call   3d9d <printf>
    exit();
  ...
  if(write(fd, buf, 10) != 10){
    ...
    13d9:	c7 44 24 04 d1 47 00 	movl   $0x47d1,0x4(%esp)
    13e0:	00 
    13e1:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    13e8:	e8 b0 29 00 00       	call   3d9d <printf>
    exit();
  ...
  unlink("unlinkread");
    13fd:	c7 04 24 42 47 00 00 	movl   $0x4742,(%esp)
    1404:	e8 4c 28 00 00       	call   3c55 <unlink>
  printf(1, "unlinkread ok\n");
    1409:	c7 44 24 04 ea 47 00 	movl   $0x47ea,0x4(%esp)
    1410:	00 
    1411:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    1418:	e8 80 29 00 00       	call   3d9d <printf>
}
    141d:	c9                   	leave  
    141e:	c3                   	ret    
...
linktest(void)
{
  ...
  printf(1, "linktest\n");
    1425:	c7 44 24 04 f9 47 00 	movl   $0x47f9,0x4(%esp)
    142c:	00 
    142d:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    1434:	e8 64 29 00 00       	call   3d9d <printf>

  unlink("lf1");
    1439:	c7 04 24 03 48 00 00 	movl   $0x4803,(%esp)
    1440:	e8 10 28 00 00       	call   3c55 <unlink>
  unlink("lf2");
    1445:	c7 04 24 07 48 00 00 	movl   $0x4807,(%esp)
    144c:	e8 04 28 00 00       	call   3c55 <unlink>

  fd = open("lf1", O_CREATE|O_RDWR);
    1451:	c7 44 24 04 02 02 00 	movl   $0x202,0x4(%esp)
    1458:	00 
    1459:	c7 04 24 03 48 00 00 	movl   $0x4803,(%esp)
  ...
  if(fd < 0){
    ...
    146e:	c7 44 24 04 0b 48 00 	movl   $0x480b,0x4(%esp)
    1475:	00 
    1476:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    147d:	e8 1b 29 00 00       	call   3d9d <printf>
    exit();
  ...
  if(write(fd, "hello", 5) != 5){
    ...
    148e:	00 
    148f:	c7 44 24 04 67 47 00 	movl   $0x4767,0x4(%esp)
    1496:	00 
    ...
    14a7:	c7 44 24 04 1e 48 00 	movl   $0x481e,0x4(%esp)
    14ae:	00 
    14af:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    14b6:	e8 e2 28 00 00       	call   3d9d <printf>
    exit();
  ...
  fd = open("lf2", 0);
    ...
    1540:	00 
    1541:	c7 04 24 07 48 00 00 	movl   $0x4807,(%esp)
  ...
  if(fd < 0){
    ...
    1556:	c7 44 24 04 6d 48 00 	movl   $0x486d,0x4(%esp)
    155d:	00 
    155e:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    1565:	e8 33 28 00 00       	call   3d9d <printf>
    exit();
  ...
  if(read(fd, buf, sizeof(buf)) != 5){
    ...
    158f:	c7 44 24 04 7e 48 00 	movl   $0x487e,0x4(%esp)
    1596:	00 
    1597:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    159e:	e8 fa 27 00 00       	call   3d9d <printf>
    exit();
  ...
  if(link("lf2", "lf2") >= 0){
    15b3:	c7 44 24 04 07 48 00 	movl   $0x4807,0x4(%esp)
    15ba:	00 
    15bb:	c7 04 24 07 48 00 00 	movl   $0x4807,(%esp)
    15c2:	e8 9e 26 00 00       	call   3c65 <link>
    15c7:	85 c0                	test   %eax,%eax
    15c9:	78 19                	js     15e4 <linktest+0x1c5>
    printf(1, "link lf2 lf2 succeeded! oops\n");
    15cb:	c7 44 24 04 8f 48 00 	movl   $0x488f,0x4(%esp)
    15d2:	00 
    15d3:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    15da:	e8 be 27 00 00       	call   3d9d <printf>
    exit();
    15df:	e8 21 26 00 00       	call   3c05 <exit>
  }

  unlink("lf2");
    15e4:	c7 04 24 07 48 00 00 	movl   $0x4807,(%esp)
    15eb:	e8 65 26 00 00       	call   3c55 <unlink>
  if(link("lf2", "lf1") >= 0){
    15f0:	c7 44 24 04 03 48 00 	movl   $0x4803,0x4(%esp)
    15f7:	00 
    15f8:	c7 04 24 07 48 00 00 	movl   $0x4807,(%esp)
    15ff:	e8 61 26 00 00       	call   3c65 <link>
    1604:	85 c0                	test   %eax,%eax
    1606:	78 19                	js     1621 <linktest+0x202>
    printf(1, "link non-existant succeeded! oops\n");
    1608:	c7 44 24 04 b0 48 00 	movl   $0x48b0,0x4(%esp)
    160f:	00 
    1610:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    1617:	e8 81 27 00 00       	call   3d9d <printf>
    exit();
    161c:	e8 e4 25 00 00       	call   3c05 <exit>
  }

  if(link(".", "lf1") >= 0){
    1621:	c7 44 24 04 03 48 00 	movl   $0x4803,0x4(%esp)
    1628:	00 
    1629:	c7 04 24 d3 48 00 00 	movl   $0x48d3,(%esp)
    1630:	e8 30 26 00 00       	call   3c65 <link>
    1635:	85 c0                	test   %eax,%eax
    1637:	78 19                	js     1652 <linktest+0x233>
    printf(1, "link . lf1 succeeded! oops\n");
    1639:	c7 44 24 04 d5 48 00 	movl   $0x48d5,0x4(%esp)
    1640:	00 
    1641:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    1648:	e8 50 27 00 00       	call   3d9d <printf>
    exit();
    164d:	e8 b3 25 00 00       	call   3c05 <exit>
  }

  printf(1, "linktest ok\n");
    1652:	c7 44 24 04 f1 48 00 	movl   $0x48f1,0x4(%esp)
    1659:	00 
...
concreate(void)
{
  ...
  printf(1, "concreate test\n");
    166e:	c7 44 24 04 fe 48 00 	movl   $0x48fe,0x4(%esp)
    1675:	00 
    1676:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    167d:	e8 1b 27 00 00       	call   3d9d <printf>
  file[0] = 'C';
  ...
  for(i = 0; i < 40; i++){
    ...
    16d1:	c7 04 24 0e 49 00 00 	movl   $0x490e,(%esp)
    ...
    172f:	c7 44 24 04 11 49 00 	movl   $0x4911,0x4(%esp)
    1736:	00 
    1737:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    173e:	e8 5a 26 00 00       	call   3d9d <printf>
        exit();
  ...
  fd = open(".", 0);
    ...
    1792:	00 
    1793:	c7 04 24 d3 48 00 00 	movl   $0x48d3,(%esp)
  ...
  while(read(fd, &de, sizeof(de)) > 0){
    ...
    17f0:	c7 44 24 04 2d 49 00 	movl   $0x492d,0x4(%esp)
    17f7:	00 
    17f8:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    17ff:	e8 99 25 00 00       	call   3d9d <printf>
        exit();
    ...
    1821:	c7 44 24 04 46 49 00 	movl   $0x4946,0x4(%esp)
    1828:	00 
    1829:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    1830:	e8 68 25 00 00       	call   3d9d <printf>
        exit();
  ...
  if(n != 40){
    ...
    187e:	c7 44 24 04 64 49 00 	movl   $0x4964,0x4(%esp)
    1885:	00 
    1886:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    188d:	e8 0b 25 00 00       	call   3d9d <printf>
    exit();
  ...
  for(i = 0; i < 40; i++){
    ...
    18b8:	79 19                	jns    18d3 <concreate+0x26b>
      printf(1, "fork failed\n");
    18ba:	c7 44 24 04 51 45 00 	movl   $0x4551,0x4(%esp)
    18c1:	00 
    18c2:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    18c9:	e8 cf 24 00 00       	call   3d9d <printf>
      exit();
  ...
  printf(1, "concreate ok\n");
    19b9:	c7 44 24 04 95 49 00 	movl   $0x4995,0x4(%esp)
    19c0:	00 
    19c1:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    19c8:	e8 d0 23 00 00       	call   3d9d <printf>
}
    19cd:	c9                   	leave  
    19ce:	c3                   	ret    
...
linkunlink()
{
  ...
  printf(1, "linkunlink test\n");
    19d5:	c7 44 24 04 a3 49 00 	movl   $0x49a3,0x4(%esp)
    19dc:	00 
    19dd:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    19e4:	e8 b4 23 00 00       	call   3d9d <printf>

  unlink("x");
    19e9:	c7 04 24 0a 45 00 00 	movl   $0x450a,(%esp)
  ...
  if(pid < 0){
    ...
    printf(1, "fork failed\n");
    1a03:	c7 44 24 04 51 45 00 	movl   $0x4551,0x4(%esp)
    1a0a:	00 
    1a0b:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    1a12:	e8 86 23 00 00       	call   3d9d <printf>
    exit();
  ...
  for(i = 0; i < 100; i++){
    ...
    1a90:	00 
    1a91:	c7 04 24 0a 45 00 00 	movl   $0x450a,(%esp)
    ...
    1abb:	75 16                	jne    1ad3 <linkunlink+0x104>
      link("cat", "x");
    1abd:	c7 44 24 04 0a 45 00 	movl   $0x450a,0x4(%esp)
    1ac4:	00 
    1ac5:	c7 04 24 b4 49 00 00 	movl   $0x49b4,(%esp)
  ...
  printf(1, "linkunlink ok\n");
    1af7:	c7 44 24 04 b8 49 00 	movl   $0x49b8,0x4(%esp)
    1afe:	00 
    1aff:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    1b06:	e8 92 22 00 00       	call   3d9d <printf>
...
bigdir(void)
{
  ...
  printf(1, "bigdir test\n");
    1b1a:	c7 44 24 04 c7 49 00 	movl   $0x49c7,0x4(%esp)
    1b21:	00 
    1b22:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    1b29:	e8 6f 22 00 00       	call   3d9d <printf>
  unlink("bd");
    1b2e:	c7 04 24 d4 49 00 00 	movl   $0x49d4,(%esp)
    1b35:	e8 1b 21 00 00       	call   3c55 <unlink>

  fd = open("bd", O_CREATE);
    1b3a:	c7 44 24 04 00 02 00 	movl   $0x200,0x4(%esp)
    1b41:	00 
    1b42:	c7 04 24 d4 49 00 00 	movl   $0x49d4,(%esp)
  ...
  if(fd < 0){
    ...
    1b57:	c7 44 24 04 d7 49 00 	movl   $0x49d7,0x4(%esp)
    1b5e:	00 
    1b5f:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    1b66:	e8 32 22 00 00       	call   3d9d <printf>
    exit();
  ...
  unlink("bd");
    1bf2:	c7 04 24 d4 49 00 00 	movl   $0x49d4,(%esp)
  ...
  for(i = 0; i < 500; i++){
    ...
    1c48:	c7 44 24 04 01 4a 00 	movl   $0x4a01,0x4(%esp)
    1c4f:	00 
    1c50:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    1c57:	e8 41 21 00 00       	call   3d9d <printf>
      exit();
  ...
  printf(1, "bigdir ok\n");
    1c6d:	c7 44 24 04 16 4a 00 	movl   $0x4a16,0x4(%esp)
    1c74:	00 
    1c75:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    1c7c:	e8 1c 21 00 00       	call   3d9d <printf>
}
    1c81:	c9                   	leave  
    1c82:	c3                   	ret    
...
subdir(void)
{
  ...
  printf(1, "subdir test\n");
    1c89:	c7 44 24 04 21 4a 00 	movl   $0x4a21,0x4(%esp)
    1c90:	00 
    1c91:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    1c98:	e8 00 21 00 00       	call   3d9d <printf>

  unlink("ff");
    1c9d:	c7 04 24 2e 4a 00 00 	movl   $0x4a2e,(%esp)
    1ca4:	e8 ac 1f 00 00       	call   3c55 <unlink>
  if(mkdir("dd") != 0){
    1ca9:	c7 04 24 31 4a 00 00 	movl   $0x4a31,(%esp)
    1cb0:	e8 b8 1f 00 00       	call   3c6d <mkdir>
    1cb5:	85 c0                	test   %eax,%eax
    1cb7:	74 19                	je     1cd2 <subdir+0x4f>
    printf(1, "subdir mkdir dd failed\n");
    1cb9:	c7 44 24 04 34 4a 00 	movl   $0x4a34,0x4(%esp)
    1cc0:	00 
    1cc1:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    1cc8:	e8 d0 20 00 00       	call   3d9d <printf>
    exit();
  ...
  fd = open("dd/ff", O_CREATE | O_RDWR);
    ...
    1cd9:	00 
    1cda:	c7 04 24 4c 4a 00 00 	movl   $0x4a4c,(%esp)
  ...
  if(fd < 0){
    ...
    1cef:	c7 44 24 04 52 4a 00 	movl   $0x4a52,0x4(%esp)
    1cf6:	00 
    1cf7:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    1cfe:	e8 9a 20 00 00       	call   3d9d <printf>
    exit();
  ...
  write(fd, "ff", 2);
    ...
    1d0f:	00 
    1d10:	c7 44 24 04 2e 4a 00 	movl   $0x4a2e,0x4(%esp)
    1d17:	00 
  ...
  fd = open("dd/dd/ff", O_CREATE | O_RDWR);
    ...
    1d87:	00 
    1d88:	c7 04 24 b0 4a 00 00 	movl   $0x4ab0,(%esp)
  ...
  if(fd < 0){
    ...
    1d9d:	c7 44 24 04 b9 4a 00 	movl   $0x4ab9,0x4(%esp)
    1da4:	00 
    1da5:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    1dac:	e8 ec 1f 00 00       	call   3d9d <printf>
    exit();
  ...
  write(fd, "FF", 2);
    ...
    1dbd:	00 
    1dbe:	c7 44 24 04 d1 4a 00 	movl   $0x4ad1,0x4(%esp)
    1dc5:	00 
  ...
  fd = open("dd/dd/../ff", 0);
    ...
    1de3:	00 
    1de4:	c7 04 24 d4 4a 00 00 	movl   $0x4ad4,(%esp)
  ...
  if(fd < 0){
    ...
    1df9:	c7 44 24 04 e0 4a 00 	movl   $0x4ae0,0x4(%esp)
    1e00:	00 
    1e01:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    1e08:	e8 90 1f 00 00       	call   3d9d <printf>
    exit();
  ...
  if(cc != 2 || buf[0] != 'f'){
    ...
    1e3f:	c7 44 24 04 f9 4a 00 	movl   $0x4af9,0x4(%esp)
    1e46:	00 
    1e47:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    1e4e:	e8 4a 1f 00 00       	call   3d9d <printf>
    exit();
  ...
  fd = open("dd/dd/ffff", 0);
    ...
    1f99:	00 
    1f9a:	c7 04 24 14 4b 00 00 	movl   $0x4b14,(%esp)
  ...
  if(fd < 0){
    ...
    1faf:	c7 44 24 04 de 4b 00 	movl   $0x4bde,0x4(%esp)
    1fb6:	00 
    1fb7:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    1fbe:	e8 da 1d 00 00       	call   3d9d <printf>
    exit();
  ...
  if(read(fd, buf, sizeof(buf)) != 2){
    ...
    1fe8:	c7 44 24 04 f6 4b 00 	movl   $0x4bf6,0x4(%esp)
    1fef:	00 
    1ff0:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    1ff7:	e8 a1 1d 00 00       	call   3d9d <printf>
    exit();
...
bigwrite(void)
{
  ...
  printf(1, "bigwrite test\n");
    23cd:	c7 44 24 04 70 4e 00 	movl   $0x4e70,0x4(%esp)
    23d4:	00 
    23d5:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    23dc:	e8 bc 19 00 00       	call   3d9d <printf>

  unlink("bigwrite");
    23e1:	c7 04 24 7f 4e 00 00 	movl   $0x4e7f,(%esp)
  ...
  for(sz = 499; sz < 12*512; sz += 471){
    ...
    2400:	00 
    2401:	c7 04 24 7f 4e 00 00 	movl   $0x4e7f,(%esp)
    ...
    2416:	c7 44 24 04 88 4e 00 	movl   $0x4e88,0x4(%esp)
    241d:	00 
    241e:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    2425:	e8 73 19 00 00       	call   3d9d <printf>
      exit();
    ...
    246b:	c7 44 24 04 a0 4e 00 	movl   $0x4ea0,0x4(%esp)
    2472:	00 
    2473:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    247a:	e8 1e 19 00 00       	call   3d9d <printf>
        exit();
    ...
    unlink("bigwrite");
    2498:	c7 04 24 7f 4e 00 00 	movl   $0x4e7f,(%esp)
  ...
  printf(1, "bigwrite ok\n");
    24b8:	c7 44 24 04 b2 4e 00 	movl   $0x4eb2,0x4(%esp)
    24bf:	00 
    24c0:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    24c7:	e8 d1 18 00 00       	call   3d9d <printf>
}
    24cc:	c9                   	leave  
    24cd:	c3                   	ret    
...
bigfile(void)
{
  ...
  printf(1, "bigfile test\n");
    24d4:	c7 44 24 04 bf 4e 00 	movl   $0x4ebf,0x4(%esp)
    24db:	00 
    24dc:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    24e3:	e8 b5 18 00 00       	call   3d9d <printf>

  unlink("bigfile");
    24e8:	c7 04 24 cd 4e 00 00 	movl   $0x4ecd,(%esp)
    24ef:	e8 61 17 00 00       	call   3c55 <unlink>
  fd = open("bigfile", O_CREATE | O_RDWR);
    24f4:	c7 44 24 04 02 02 00 	movl   $0x202,0x4(%esp)
    24fb:	00 
    24fc:	c7 04 24 cd 4e 00 00 	movl   $0x4ecd,(%esp)
  ...
  if(fd < 0){
    ...
    2511:	c7 44 24 04 d5 4e 00 	movl   $0x4ed5,0x4(%esp)
    2518:	00 
    2519:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    2520:	e8 78 18 00 00       	call   3d9d <printf>
    exit();
  ...
  for(i = 0; i < 20; i++){
    ...
    2570:	c7 44 24 04 eb 4e 00 	movl   $0x4eeb,0x4(%esp)
    2577:	00 
    2578:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    257f:	e8 19 18 00 00       	call   3d9d <printf>
      exit();
  ...
  fd = open("bigfile", 0);
    ...
    25a4:	00 
    25a5:	c7 04 24 cd 4e 00 00 	movl   $0x4ecd,(%esp)
  ...
  if(fd < 0){
    ...
    25ba:	c7 44 24 04 01 4f 00 	movl   $0x4f01,0x4(%esp)
    25c1:	00 
    25c2:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    25c9:	e8 cf 17 00 00       	call   3d9d <printf>
    exit();
  ...
  for(i = 0; ; i++){
    ...
    2605:	c7 44 24 04 16 4f 00 	movl   $0x4f16,0x4(%esp)
    260c:	00 
    260d:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    2614:	e8 84 17 00 00       	call   3d9d <printf>
      exit();
    ...
    262d:	c7 44 24 04 2b 4f 00 	movl   $0x4f2b,0x4(%esp)
    2634:	00 
    2635:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    263c:	e8 5c 17 00 00       	call   3d9d <printf>
      exit();
    ...
    2676:	c7 44 24 04 3f 4f 00 	movl   $0x4f3f,0x4(%esp)
    267d:	00 
    267e:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    2685:	e8 13 17 00 00       	call   3d9d <printf>
      exit();
  ...
  if(total != 20*600){
    ...
    26b2:	c7 44 24 04 58 4f 00 	movl   $0x4f58,0x4(%esp)
    26b9:	00 
    26ba:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    26c1:	e8 d7 16 00 00       	call   3d9d <printf>
    exit();
    26c6:	e8 3a 15 00 00       	call   3c05 <exit>
  }
  unlink("bigfile");
    26cb:	c7 04 24 cd 4e 00 00 	movl   $0x4ecd,(%esp)
    26d2:	e8 7e 15 00 00       	call   3c55 <unlink>

  printf(1, "bigfile test ok\n");
    26d7:	c7 44 24 04 72 4f 00 	movl   $0x4f72,0x4(%esp)
    26de:	00 
    26df:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    26e6:	e8 b2 16 00 00       	call   3d9d <printf>
}
    26eb:	c9                   	leave  
    26ec:	c3                   	ret    
...
fourteen(void)
{
  ...
  fd = open("123456789012345/123456789012345/123456789012345", O_CREATE);
    ...
    2760:	00 
    2761:	c7 04 24 10 50 00 00 	movl   $0x5010,(%esp)
  ...
  if(fd < 0){
    ...
    2776:	c7 44 24 04 40 50 00 	movl   $0x5040,0x4(%esp)
    277d:	00 
    277e:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    2785:	e8 13 16 00 00       	call   3d9d <printf>
    exit();
  ...
  fd = open("12345678901234/12345678901234/12345678901234", 0);
    ...
    27a1:	00 
    27a2:	c7 04 24 80 50 00 00 	movl   $0x5080,(%esp)
  ...
  if(fd < 0){
    ...
    27b7:	c7 44 24 04 b0 50 00 	movl   $0x50b0,0x4(%esp)
    27be:	00 
    27bf:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    27c6:	e8 d2 15 00 00       	call   3d9d <printf>
    exit();
  ...
  printf(1, "fourteen ok\n");
    282d:	c7 44 24 04 89 51 00 	movl   $0x5189,0x4(%esp)
    2834:	00 
    2835:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    283c:	e8 5c 15 00 00       	call   3d9d <printf>
}
    2841:	c9                   	leave  
    2842:	c3                   	ret    
...
dirfile(void)
{
  ...
  printf(1, "dir vs file\n");
    29c1:	c7 44 24 04 59 52 00 	movl   $0x5259,0x4(%esp)
    29c8:	00 
    29c9:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    29d0:	e8 c8 13 00 00       	call   3d9d <printf>

  fd = open("dirfile", O_CREATE);
    29d5:	c7 44 24 04 00 02 00 	movl   $0x200,0x4(%esp)
    29dc:	00 
    29dd:	c7 04 24 66 52 00 00 	movl   $0x5266,(%esp)
  ...
  if(fd < 0){
    ...
    29f2:	c7 44 24 04 6e 52 00 	movl   $0x526e,0x4(%esp)
    29f9:	00 
    29fa:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    2a01:	e8 97 13 00 00       	call   3d9d <printf>
    exit();
  ...
  fd = open("dirfile/xx", 0);
    ...
    2a46:	00 
    2a47:	c7 04 24 9f 52 00 00 	movl   $0x529f,(%esp)
  ...
  if(fd >= 0){
    ...
    2a5c:	c7 44 24 04 aa 52 00 	movl   $0x52aa,0x4(%esp)
    2a63:	00 
    2a64:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    2a6b:	e8 2d 13 00 00       	call   3d9d <printf>
    exit();
  ...
  fd = open("dirfile/xx", O_CREATE);
    ...
    2a7c:	00 
    2a7d:	c7 04 24 9f 52 00 00 	movl   $0x529f,(%esp)
  ...
  if(fd >= 0){
    ...
    printf(1, "create dirfile/xx succeeded!\n");
    2a92:	c7 44 24 04 aa 52 00 	movl   $0x52aa,0x4(%esp)
    2a99:	00 
    2a9a:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    2aa1:	e8 f7 12 00 00       	call   3d9d <printf>
    exit();
  ...
  fd = open(".", O_RDWR);
    ...
    2b5e:	00 
    2b5f:	c7 04 24 d3 48 00 00 	movl   $0x48d3,(%esp)
  ...
  if(fd >= 0){
    ...
    2b74:	c7 44 24 04 44 53 00 	movl   $0x5344,0x4(%esp)
    2b7b:	00 
    2b7c:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    2b83:	e8 15 12 00 00       	call   3d9d <printf>
    exit();
  ...
  if(write(fd, "x", 1) > 0){
    ...
    2bc3:	c7 44 24 04 63 53 00 	movl   $0x5363,0x4(%esp)
    2bca:	00 
    2bcb:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    2bd2:	e8 c6 11 00 00       	call   3d9d <printf>
    exit();
  ...
  printf(1, "dir vs file OK\n");
    2be7:	c7 44 24 04 77 53 00 	movl   $0x5377,0x4(%esp)
    2bee:	00 
    2bef:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    2bf6:	e8 a2 11 00 00       	call   3d9d <printf>
}
    2bfb:	c9                   	leave  
    2bfc:	c3                   	ret    
...
iref(void)
{
  ...
  printf(1, "empty file name\n");
    2c03:	c7 44 24 04 87 53 00 	movl   $0x5387,0x4(%esp)
    2c0a:	00 
    2c0b:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    2c12:	e8 86 11 00 00       	call   3d9d <printf>
  ...
  for(i = 0; i < 50 + 1; i++){
    ...
    2cc4:	00 
    2cc5:	c7 04 24 c7 53 00 00 	movl   $0x53c7,(%esp)
    ...
    unlink("xx");
    2ce5:	c7 04 24 c7 53 00 00 	movl   $0x53c7,(%esp)
  ...
  chdir("/");
    2cfe:	c7 04 24 ea 51 00 00 	movl   $0x51ea,(%esp)
    2d05:	e8 6b 0f 00 00       	call   3c75 <chdir>
  printf(1, "empty file name OK\n");
    2d0a:	c7 44 24 04 ca 53 00 	movl   $0x53ca,0x4(%esp)
    2d11:	00 
    2d12:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    2d19:	e8 7f 10 00 00       	call   3d9d <printf>
}
    2d1e:	c9                   	leave  
    2d1f:	c3                   	ret    
...
forktest(void)
{
  ...
  printf(1, "fork test\n");
    2d26:	c7 44 24 04 de 53 00 	movl   $0x53de,0x4(%esp)
    2d2d:	00 
    2d2e:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    2d35:	e8 63 10 00 00       	call   3d9d <printf>
  ...
  if(n == 1000){
    ...
    2d74:	c7 44 24 04 ec 53 00 	movl   $0x53ec,0x4(%esp)
    2d7b:	00 
    2d7c:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    2d83:	e8 15 10 00 00       	call   3d9d <printf>
    exit();
  ...
  for(; n > 0; n--){
    ...
    2d96:	c7 44 24 04 0e 54 00 	movl   $0x540e,0x4(%esp)
    2d9d:	00 
    2d9e:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    2da5:	e8 f3 0f 00 00       	call   3d9d <printf>
      exit();
  ...
  if(wait() != -1){
    ...
    2dc2:	c7 44 24 04 22 54 00 	movl   $0x5422,0x4(%esp)
    2dc9:	00 
    2dca:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    2dd1:	e8 c7 0f 00 00       	call   3d9d <printf>
    exit();
    2dd6:	e8 2a 0e 00 00       	call   3c05 <exit>
  }
  
  printf(1, "fork test OK\n");
    2ddb:	c7 44 24 04 35 54 00 	movl   $0x5435,0x4(%esp)
    2de2:	00 
    2de3:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    2dea:	e8 ae 0f 00 00       	call   3d9d <printf>
}
    2def:	c9                   	leave  
    2df0:	c3                   	ret    
...
sbrktest(void)
{
  ...
  printf(stdout, "sbrk test\n");
    2dfb:	a1 b8 5e 00 00       	mov    0x5eb8,%eax
    2e00:	c7 44 24 04 43 54 00 	movl   $0x5443,0x4(%esp)
    2e07:	00 
    2e08:	89 04 24             	mov    %eax,(%esp)
    2e0b:	e8 8d 0f 00 00       	call   3d9d <printf>
  oldbrk = sbrk(0);
  ...
  for(i = 0; i < 5000; i++){ 
    ...
    2e4e:	a1 b8 5e 00 00       	mov    0x5eb8,%eax
    ...
    2e68:	c7 44 24 04 4e 54 00 	movl   $0x544e,0x4(%esp)
    2e6f:	00 
    2e70:	89 04 24             	mov    %eax,(%esp)
    2e73:	e8 25 0f 00 00       	call   3d9d <printf>
      exit();
  ...
  if(pid < 0){
    ...
    2ea4:	a1 b8 5e 00 00       	mov    0x5eb8,%eax
    2ea9:	c7 44 24 04 69 54 00 	movl   $0x5469,0x4(%esp)
    2eb0:	00 
    2eb1:	89 04 24             	mov    %eax,(%esp)
    2eb4:	e8 e4 0e 00 00       	call   3d9d <printf>
    exit();
  ...
  if(c != a + 1){
    ...
    2ee5:	a1 b8 5e 00 00       	mov    0x5eb8,%eax
    2eea:	c7 44 24 04 80 54 00 	movl   $0x5480,0x4(%esp)
    2ef1:	00 
    2ef2:	89 04 24             	mov    %eax,(%esp)
    2ef5:	e8 a3 0e 00 00       	call   3d9d <printf>
    exit();
...
#define BIG (100*1024*1024)
  ...
  if (p != a) { 
    ...
    2f45:	a1 b8 5e 00 00       	mov    0x5eb8,%eax
    2f4a:	c7 44 24 04 9c 54 00 	movl   $0x549c,0x4(%esp)
    2f51:	00 
    2f52:	89 04 24             	mov    %eax,(%esp)
    2f55:	e8 43 0e 00 00       	call   3d9d <printf>
    exit();
  ...
  *lastaddr = 99;
  ...
  if(c == (char*)0xffffffff){
    ...
    2f90:	a1 b8 5e 00 00       	mov    0x5eb8,%eax
    2f95:	c7 44 24 04 da 54 00 	movl   $0x54da,0x4(%esp)
    2f9c:	00 
    2f9d:	89 04 24             	mov    %eax,(%esp)
    2fa0:	e8 f8 0d 00 00       	call   3d9d <printf>
    exit();
  ...
  if(c != a - 4096){
    ...
    2fc6:	a1 b8 5e 00 00       	mov    0x5eb8,%eax
    ...
    2fd9:	c7 44 24 04 f8 54 00 	movl   $0x54f8,0x4(%esp)
    2fe0:	00 
    2fe1:	89 04 24             	mov    %eax,(%esp)
    2fe4:	e8 b4 0d 00 00       	call   3d9d <printf>
    exit();
  ...
  if(c != a || sbrk(0) != a + 4096){
    ...
    302d:	a1 b8 5e 00 00       	mov    0x5eb8,%eax
    ...
    3040:	c7 44 24 04 30 55 00 	movl   $0x5530,0x4(%esp)
    3047:	00 
    3048:	89 04 24             	mov    %eax,(%esp)
    304b:	e8 4d 0d 00 00       	call   3d9d <printf>
    exit();
  ...
  if(*lastaddr == 99){
    ...
    305e:	a1 b8 5e 00 00       	mov    0x5eb8,%eax
    3063:	c7 44 24 04 58 55 00 	movl   $0x5558,0x4(%esp)
    306a:	00 
    306b:	89 04 24             	mov    %eax,(%esp)
    306e:	e8 2a 0d 00 00       	call   3d9d <printf>
    exit();
  ...
  if(c != a){
    ...
    30af:	a1 b8 5e 00 00       	mov    0x5eb8,%eax
    ...
    30c2:	c7 44 24 04 88 55 00 	movl   $0x5588,0x4(%esp)
    30c9:	00 
    30ca:	89 04 24             	mov    %eax,(%esp)
    30cd:	e8 cb 0c 00 00       	call   3d9d <printf>
    exit();
  ...
  for(a = (char*)(KERNBASE); a < (char*) (KERNBASE+2000000); a += 50000){
    ...
    30f6:	a1 b8 5e 00 00       	mov    0x5eb8,%eax
    30fb:	c7 44 24 04 51 45 00 	movl   $0x4551,0x4(%esp)
    3102:	00 
    3103:	89 04 24             	mov    %eax,(%esp)
    3106:	e8 92 0c 00 00       	call   3d9d <printf>
      exit();
  ...
  if(pipe(fds) != 0){
    ...
    printf(1, "pipe() failed\n");
    3176:	c7 44 24 04 a5 44 00 	movl   $0x44a5,0x4(%esp)
    317d:	00 
    317e:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    3185:	e8 13 0c 00 00       	call   3d9d <printf>
    exit();
  ...
  for(i = 0; i < sizeof(pids)/sizeof(pids[0]); i++){
    ...
    31db:	00 
    31dc:	c7 44 24 04 0a 45 00 	movl   $0x450a,0x4(%esp)
    31e3:	00 
  ...
  if(c == (char*)0xffffffff){
    ...
    327b:	a1 b8 5e 00 00       	mov    0x5eb8,%eax
    3280:	c7 44 24 04 c2 55 00 	movl   $0x55c2,0x4(%esp)
    3287:	00 
    3288:	89 04 24             	mov    %eax,(%esp)
    328b:	e8 0d 0b 00 00       	call   3d9d <printf>
    exit();
  ...
  printf(stdout, "sbrk test OK\n");
    32c3:	a1 b8 5e 00 00       	mov    0x5eb8,%eax
    32c8:	c7 44 24 04 dd 55 00 	movl   $0x55dd,0x4(%esp)
    32cf:	00 
    32d0:	89 04 24             	mov    %eax,(%esp)
    32d3:	e8 c5 0a 00 00       	call   3d9d <printf>
}
...
validatetest(void)
{
  ...
  printf(stdout, "validate test\n");
    3312:	a1 b8 5e 00 00       	mov    0x5eb8,%eax
    3317:	c7 44 24 04 eb 55 00 	movl   $0x55eb,0x4(%esp)
    331e:	00 
    331f:	89 04 24             	mov    %eax,(%esp)
    3322:	e8 76 0a 00 00       	call   3d9d <printf>
  hi = 1100*1024;
  ...
  for(p = 0; p <= (uint)hi; p += 4096){
    ...
    3384:	c7 04 24 fa 55 00 00 	movl   $0x55fa,(%esp)
    338b:	e8 d5 08 00 00       	call   3c65 <link>
    3390:	83 f8 ff             	cmp    $0xffffffff,%eax
    3393:	74 1a                	je     33af <validatetest+0xa3>
      printf(stdout, "link should not succeed\n");
    3395:	a1 b8 5e 00 00       	mov    0x5eb8,%eax
    339a:	c7 44 24 04 05 56 00 	movl   $0x5605,0x4(%esp)
    33a1:	00 
    33a2:	89 04 24             	mov    %eax,(%esp)
    33a5:	e8 f3 09 00 00       	call   3d9d <printf>
      exit();
  ...
  printf(stdout, "validate ok\n");
    33c2:	a1 b8 5e 00 00       	mov    0x5eb8,%eax
    33c7:	c7 44 24 04 1e 56 00 	movl   $0x561e,0x4(%esp)
    33ce:	00 
    33cf:	89 04 24             	mov    %eax,(%esp)
    33d2:	e8 c6 09 00 00       	call   3d9d <printf>
}
    33d7:	c9                   	leave  
    33d8:	c3                   	ret    
...
bsstest(void)
{
  ...
  printf(stdout, "bss test\n");
    33df:	a1 b8 5e 00 00       	mov    0x5eb8,%eax
    33e4:	c7 44 24 04 2b 56 00 	movl   $0x562b,0x4(%esp)
    33eb:	00 
    33ec:	89 04 24             	mov    %eax,(%esp)
    33ef:	e8 a9 09 00 00       	call   3d9d <printf>
  for(i = 0; i < sizeof(uninit); i++){
    ...
    340b:	a1 b8 5e 00 00       	mov    0x5eb8,%eax
    3410:	c7 44 24 04 35 56 00 	movl   $0x5635,0x4(%esp)
    3417:	00 
    3418:	89 04 24             	mov    %eax,(%esp)
    341b:	e8 7d 09 00 00       	call   3d9d <printf>
      exit();
  ...
  printf(stdout, "bss test ok\n");
    3432:	a1 b8 5e 00 00       	mov    0x5eb8,%eax
    3437:	c7 44 24 04 46 56 00 	movl   $0x5646,0x4(%esp)
    343e:	00 
    343f:	89 04 24             	mov    %eax,(%esp)
    3442:	e8 56 09 00 00       	call   3d9d <printf>
}
    3447:	c9                   	leave  
    3448:	c3                   	ret    
...
bigargtest(void)
{
  ...
  unlink("bigarg-ok");
    344f:	c7 04 24 53 56 00 00 	movl   $0x5653,(%esp)
  ...
  if(pid == 0){
    ...
    3479:	c7 04 85 e0 5e 00 00 	movl   $0x5660,0x5ee0(,%eax,4)
    3480:	60 56 00 00 
    for(i = 0; i < MAXARG-1; i++)
    ...
    3497:	a1 b8 5e 00 00       	mov    0x5eb8,%eax
    349c:	c7 44 24 04 3d 57 00 	movl   $0x573d,0x4(%esp)
    34a3:	00 
    34a4:	89 04 24             	mov    %eax,(%esp)
    34a7:	e8 f1 08 00 00       	call   3d9d <printf>
    exec("echo", args);
    34ac:	c7 44 24 04 e0 5e 00 	movl   $0x5ee0,0x4(%esp)
    34b3:	00 
    34b4:	c7 04 24 64 41 00 00 	movl   $0x4164,(%esp)
    34bb:	e8 7d 07 00 00       	call   3c3d <exec>
    printf(stdout, "bigarg test ok\n");
    34c0:	a1 b8 5e 00 00       	mov    0x5eb8,%eax
    34c5:	c7 44 24 04 4a 57 00 	movl   $0x574a,0x4(%esp)
    34cc:	00 
    34cd:	89 04 24             	mov    %eax,(%esp)
    34d0:	e8 c8 08 00 00       	call   3d9d <printf>
    fd = open("bigarg-ok", O_CREATE);
    34d5:	c7 44 24 04 00 02 00 	movl   $0x200,0x4(%esp)
    34dc:	00 
    34dd:	c7 04 24 53 56 00 00 	movl   $0x5653,(%esp)
    ...
    3502:	a1 b8 5e 00 00       	mov    0x5eb8,%eax
    3507:	c7 44 24 04 5a 57 00 	movl   $0x575a,0x4(%esp)
    350e:	00 
    350f:	89 04 24             	mov    %eax,(%esp)
    3512:	e8 86 08 00 00       	call   3d9d <printf>
    exit();
  ...
  fd = open("bigarg-ok", 0);
    ...
    3528:	00 
    3529:	c7 04 24 53 56 00 00 	movl   $0x5653,(%esp)
  ...
  if(fd < 0){
    ...
    353e:	a1 b8 5e 00 00       	mov    0x5eb8,%eax
    3543:	c7 44 24 04 73 57 00 	movl   $0x5773,0x4(%esp)
    354a:	00 
    354b:	89 04 24             	mov    %eax,(%esp)
    354e:	e8 4a 08 00 00       	call   3d9d <printf>
    exit();
  ...
  unlink("bigarg-ok");
    3563:	c7 04 24 53 56 00 00 	movl   $0x5653,(%esp)
...
fsfull()
{
  ...
  printf(1, "fsfull test\n");
    357f:	c7 44 24 04 88 57 00 	movl   $0x5788,0x4(%esp)
    3586:	00 
    3587:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    358e:	e8 0a 08 00 00       	call   3d9d <printf>
  ...
  for(nfiles = 0; ; nfiles++){
    ...
    368d:	c7 44 24 04 95 57 00 	movl   $0x5795,0x4(%esp)
    3694:	00 
    3695:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    369c:	e8 fc 06 00 00       	call   3d9d <printf>
    ...
    36c4:	c7 44 24 04 a1 57 00 	movl   $0x57a1,0x4(%esp)
    36cb:	00 
    36cc:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    36d3:	e8 c5 06 00 00       	call   3d9d <printf>
    close(fd);
    if(total == 0)
      break;
  }
  ...
  while(nfiles >= 0){
    ...
    371e:	c7 44 24 04 b1 57 00 	movl   $0x57b1,0x4(%esp)
    3725:	00 
    3726:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    372d:	e8 6b 06 00 00       	call   3d9d <printf>
    close(fd);
  ...
  printf(1, "fsfull test finished\n");
    3853:	c7 44 24 04 c1 57 00 	movl   $0x57c1,0x4(%esp)
    385a:	00 
    385b:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    3862:	e8 36 05 00 00       	call   3d9d <printf>
}
...
rand()
{
  ...
  randstate = randstate * 1664525 + 1013904223;
    3870:	8b 15 bc 5e 00 00    	mov    0x5ebc,%edx
    ...
    38ab:	a3 bc 5e 00 00       	mov    %eax,0x5ebc
  return randstate;
    38b0:	a1 bc 5e 00 00       	mov    0x5ebc,%eax
}
    38b5:	5d                   	pop    %ebp
    38b6:	c3                   	ret    
...
main(int argc, char *argv[])
{
  ...
  close(open("usertests.ran", O_CREATE));
    ...
    390c:	00 
    390d:	c7 04 24 eb 57 00 00 	movl   $0x57eb,(%esp)
...
putc(int fd, char c)
{
    ...
    3cc8:	83 ec 28             	sub    $0x28,%esp
    3ccb:	8b 45 0c             	mov    0xc(%ebp),%eax
    3cce:	88 45 f4             	mov    %al,-0xc(%ebp)
  write(fd, &c, 1);
    3cd1:	c7 44 24 08 01 00 00 	movl   $0x1,0x8(%esp)
    3cd8:	00 
    3cd9:	8d 45 f4             	lea    -0xc(%ebp),%eax
    3cdc:	89 44 24 04          	mov    %eax,0x4(%esp)
    3ce0:	8b 45 08             	mov    0x8(%ebp),%eax
    3ce3:	89 04 24             	mov    %eax,(%esp)
    3ce6:	e8 3a ff ff ff       	call   3c25 <write>
}
    3ceb:	c9                   	leave  
    3cec:	c3                   	ret    
...
printint(int fd, int xx, int base, int sgn)
{
  ...
  if(sgn && xx < 0){
    ...
    3cfe:	74 17                	je     3d17 <printint+0x2a>
    3d00:	83 7d 0c 00          	cmpl   $0x0,0xc(%ebp)
    3d04:	79 11                	jns    3d17 <printint+0x2a>
    neg = 1;
    3d06:	c7 45 f0 01 00 00 00 	movl   $0x1,-0x10(%ebp)
    x = -xx;
    3d0d:	8b 45 0c             	mov    0xc(%ebp),%eax
    3d10:	f7 d8                	neg    %eax
    3d12:	89 45 ec             	mov    %eax,-0x14(%ebp)
    3d15:	eb 06                	jmp    3d1d <printint+0x30>
  } else {
    x = xx;
    3d17:	8b 45 0c             	mov    0xc(%ebp),%eax
    3d1a:	89 45 ec             	mov    %eax,-0x14(%ebp)
  }

  i = 0;
    3d1d:	c7 45 f4 00 00 00 00 	movl   $0x0,-0xc(%ebp)
  do{
    buf[i++] = digits[x % base];
    3d24:	8b 4d 10             	mov    0x10(%ebp),%ecx
    3d27:	8b 45 ec             	mov    -0x14(%ebp),%eax
    3d2a:	ba 00 00 00 00       	mov    $0x0,%edx
    3d2f:	f7 f1                	div    %ecx
    3d31:	89 d0                	mov    %edx,%eax
    3d33:	8a 80 c0 5e 00 00    	mov    0x5ec0(%eax),%al
    3d39:	8d 4d dc             	lea    -0x24(%ebp),%ecx
    3d3c:	8b 55 f4             	mov    -0xc(%ebp),%edx
    3d3f:	01 ca                	add    %ecx,%edx
    3d41:	88 02                	mov    %al,(%edx)
    3d43:	ff 45 f4             	incl   -0xc(%ebp)
  }while((x /= base) != 0);
    3d46:	8b 55 10             	mov    0x10(%ebp),%edx
    3d49:	89 55 d4             	mov    %edx,-0x2c(%ebp)
    3d4c:	8b 45 ec             	mov    -0x14(%ebp),%eax
    3d4f:	ba 00 00 00 00       	mov    $0x0,%edx
    3d54:	f7 75 d4             	divl   -0x2c(%ebp)
    3d57:	89 45 ec             	mov    %eax,-0x14(%ebp)
    3d5a:	83 7d ec 00          	cmpl   $0x0,-0x14(%ebp)
    3d5e:	75 c4                	jne    3d24 <printint+0x37>
  if(neg)
    3d60:	83 7d f0 00          	cmpl   $0x0,-0x10(%ebp)
    3d64:	74 2c                	je     3d92 <printint+0xa5>
    buf[i++] = '-';
    3d66:	8d 55 dc             	lea    -0x24(%ebp),%edx
    3d69:	8b 45 f4             	mov    -0xc(%ebp),%eax
    3d6c:	01 d0                	add    %edx,%eax
    3d6e:	c6 00 2d             	movb   $0x2d,(%eax)
    3d71:	ff 45 f4             	incl   -0xc(%ebp)

  while(--i >= 0)
    3d74:	eb 1c                	jmp    3d92 <printint+0xa5>
    putc(fd, buf[i]);
    3d76:	8d 55 dc             	lea    -0x24(%ebp),%edx
    3d79:	8b 45 f4             	mov    -0xc(%ebp),%eax
    3d7c:	01 d0                	add    %edx,%eax
    3d7e:	8a 00                	mov    (%eax),%al
    3d80:	0f be c0             	movsbl %al,%eax
    3d83:	89 44 24 04          	mov    %eax,0x4(%esp)
    3d87:	8b 45 08             	mov    0x8(%ebp),%eax
    3d8a:	89 04 24             	mov    %eax,(%esp)
    3d8d:	e8 33 ff ff ff       	call   3cc5 <putc>
  while(--i >= 0)
    3d92:	ff 4d f4             	decl   -0xc(%ebp)
    3d95:	83 7d f4 00          	cmpl   $0x0,-0xc(%ebp)
    3d99:	79 db                	jns    3d76 <printint+0x89>
}
    3d9b:	c9                   	leave  
    3d9c:	c3                   	ret    
...
printf(int fd, char *fmt, ...)
{
  ...
  state = 0;
    3da3:	c7 45 ec 00 00 00 00 	movl   $0x0,-0x14(%ebp)
  ap = (uint*)(void*)&fmt + 1;
    3daa:	8d 45 0c             	lea    0xc(%ebp),%eax
    3dad:	83 c0 04             	add    $0x4,%eax
    3db0:	89 45 e8             	mov    %eax,-0x18(%ebp)
  for(i = 0; fmt[i]; i++){
    3db3:	c7 45 f0 00 00 00 00 	movl   $0x0,-0x10(%ebp)
    3dba:	e9 78 01 00 00       	jmp    3f37 <printf+0x19a>
    c = fmt[i] & 0xff;
    3dbf:	8b 55 0c             	mov    0xc(%ebp),%edx
    3dc2:	8b 45 f0             	mov    -0x10(%ebp),%eax
    3dc5:	01 d0                	add    %edx,%eax
    3dc7:	8a 00                	mov    (%eax),%al
    3dc9:	0f be c0             	movsbl %al,%eax
    3dcc:	25 ff 00 00 00       	and    $0xff,%eax
    3dd1:	89 45 e4             	mov    %eax,-0x1c(%ebp)
    if(state == 0){
    3dd4:	83 7d ec 00          	cmpl   $0x0,-0x14(%ebp)
    3dd8:	75 2c                	jne    3e06 <printf+0x69>
      if(c == '%'){
    3dda:	83 7d e4 25          	cmpl   $0x25,-0x1c(%ebp)
    3dde:	75 0c                	jne    3dec <printf+0x4f>
        state = '%';
    3de0:	c7 45 ec 25 00 00 00 	movl   $0x25,-0x14(%ebp)
    3de7:	e9 48 01 00 00       	jmp    3f34 <printf+0x197>
      } else {
        putc(fd, c);
    3dec:	8b 45 e4             	mov    -0x1c(%ebp),%eax
    3def:	0f be c0             	movsbl %al,%eax
    3df2:	89 44 24 04          	mov    %eax,0x4(%esp)
    3df6:	8b 45 08             	mov    0x8(%ebp),%eax
    3df9:	89 04 24             	mov    %eax,(%esp)
    3dfc:	e8 c4 fe ff ff       	call   3cc5 <putc>
    3e01:	e9 2e 01 00 00       	jmp    3f34 <printf+0x197>
      }
    } else if(state == '%'){
    3e06:	83 7d ec 25          	cmpl   $0x25,-0x14(%ebp)
    3e0a:	0f 85 24 01 00 00    	jne    3f34 <printf+0x197>
      if(c == 'd'){
    3e10:	83 7d e4 64          	cmpl   $0x64,-0x1c(%ebp)
    3e14:	75 2d                	jne    3e43 <printf+0xa6>
        printint(fd, *ap, 10, 1);
    3e16:	8b 45 e8             	mov    -0x18(%ebp),%eax
    3e19:	8b 00                	mov    (%eax),%eax
    3e1b:	c7 44 24 0c 01 00 00 	movl   $0x1,0xc(%esp)
    3e22:	00 
    3e23:	c7 44 24 08 0a 00 00 	movl   $0xa,0x8(%esp)
    3e2a:	00 
    3e2b:	89 44 24 04          	mov    %eax,0x4(%esp)
    3e2f:	8b 45 08             	mov    0x8(%ebp),%eax
    3e32:	89 04 24             	mov    %eax,(%esp)
    3e35:	e8 b3 fe ff ff       	call   3ced <printint>
        ap++;
    3e3a:	83 45 e8 04          	addl   $0x4,-0x18(%ebp)
    3e3e:	e9 ea 00 00 00       	jmp    3f2d <printf+0x190>
      } else if(c == 'x' || c == 'p'){
    3e43:	83 7d e4 78          	cmpl   $0x78,-0x1c(%ebp)
    3e47:	74 06                	je     3e4f <printf+0xb2>
    3e49:	83 7d e4 70          	cmpl   $0x70,-0x1c(%ebp)
    3e4d:	75 2d                	jne    3e7c <printf+0xdf>
        printint(fd, *ap, 16, 0);
    3e4f:	8b 45 e8             	mov    -0x18(%ebp),%eax
    3e52:	8b 00                	mov    (%eax),%eax
    3e54:	c7 44 24 0c 00 00 00 	movl   $0x0,0xc(%esp)
    3e5b:	00 
    3e5c:	c7 44 24 08 10 00 00 	movl   $0x10,0x8(%esp)
    3e63:	00 
    3e64:	89 44 24 04          	mov    %eax,0x4(%esp)
    3e68:	8b 45 08             	mov    0x8(%ebp),%eax
    3e6b:	89 04 24             	mov    %eax,(%esp)
    3e6e:	e8 7a fe ff ff       	call   3ced <printint>
        ap++;
    3e73:	83 45 e8 04          	addl   $0x4,-0x18(%ebp)
    3e77:	e9 b1 00 00 00       	jmp    3f2d <printf+0x190>
      } else if(c == 's'){
    3e7c:	83 7d e4 73          	cmpl   $0x73,-0x1c(%ebp)
    3e80:	75 43                	jne    3ec5 <printf+0x128>
        s = (char*)*ap;
    3e82:	8b 45 e8             	mov    -0x18(%ebp),%eax
    3e85:	8b 00                	mov    (%eax),%eax
    3e87:	89 45 f4             	mov    %eax,-0xc(%ebp)
        ap++;
    3e8a:	83 45 e8 04          	addl   $0x4,-0x18(%ebp)
        if(s == 0)
    3e8e:	83 7d f4 00          	cmpl   $0x0,-0xc(%ebp)
    3e92:	75 25                	jne    3eb9 <printf+0x11c>
          s = "(null)";
    3e94:	c7 45 f4 26 58 00 00 	movl   $0x5826,-0xc(%ebp)
        while(*s != 0){
    3e9b:	eb 1c                	jmp    3eb9 <printf+0x11c>
          putc(fd, *s);
    ...
    3eaf:	e8 11 fe ff ff       	call   3cc5 <putc>
          s++;
    3eb4:	ff 45 f4             	incl   -0xc(%ebp)
    3eb7:	eb 01                	jmp    3eba <printf+0x11d>
        while(*s != 0){
    3eb9:	90                   	nop
    3eba:	8b 45 f4             	mov    -0xc(%ebp),%eax
    3ebd:	8a 00                	mov    (%eax),%al
    3ebf:	84 c0                	test   %al,%al
    3ec1:	75 da                	jne    3e9d <printf+0x100>
    3ec3:	eb 68                	jmp    3f2d <printf+0x190>
        }
      } else if(c == 'c'){
    3ec5:	83 7d e4 63          	cmpl   $0x63,-0x1c(%ebp)
    3ec9:	75 1d                	jne    3ee8 <printf+0x14b>
        putc(fd, *ap);
    3ecb:	8b 45 e8             	mov    -0x18(%ebp),%eax
    ...
    3edd:	e8 e3 fd ff ff       	call   3cc5 <putc>
        ap++;
    3ee2:	83 45 e8 04          	addl   $0x4,-0x18(%ebp)
    3ee6:	eb 45                	jmp    3f2d <printf+0x190>
      } else if(c == '%'){
    3ee8:	83 7d e4 25          	cmpl   $0x25,-0x1c(%ebp)
    3eec:	75 17                	jne    3f05 <printf+0x168>
        putc(fd, c);
    3eee:	8b 45 e4             	mov    -0x1c(%ebp),%eax
    3ef1:	0f be c0             	movsbl %al,%eax
    3ef4:	89 44 24 04          	mov    %eax,0x4(%esp)
    3ef8:	8b 45 08             	mov    0x8(%ebp),%eax
    3efb:	89 04 24             	mov    %eax,(%esp)
    3efe:	e8 c2 fd ff ff       	call   3cc5 <putc>
    3f03:	eb 28                	jmp    3f2d <printf+0x190>
      } else {
        // Unknown % sequence.  Print it to draw attention.
        putc(fd, '%');
    3f05:	c7 44 24 04 25 00 00 	movl   $0x25,0x4(%esp)
    3f0c:	00 
    3f0d:	8b 45 08             	mov    0x8(%ebp),%eax
    3f10:	89 04 24             	mov    %eax,(%esp)
    3f13:	e8 ad fd ff ff       	call   3cc5 <putc>
        putc(fd, c);
    3f18:	8b 45 e4             	mov    -0x1c(%ebp),%eax
    3f1b:	0f be c0             	movsbl %al,%eax
    3f1e:	89 44 24 04          	mov    %eax,0x4(%esp)
    3f22:	8b 45 08             	mov    0x8(%ebp),%eax
    3f25:	89 04 24             	mov    %eax,(%esp)
    3f28:	e8 98 fd ff ff       	call   3cc5 <putc>
      }
      state = 0;
    3f2d:	c7 45 ec 00 00 00 00 	movl   $0x0,-0x14(%ebp)
  for(i = 0; fmt[i]; i++){
    3f34:	ff 45 f0             	incl   -0x10(%ebp)
    3f37:	8b 55 0c             	mov    0xc(%ebp),%edx
    3f3a:	8b 45 f0             	mov    -0x10(%ebp),%eax
    3f3d:	01 d0                	add    %edx,%eax
    3f3f:	8a 00                	mov    (%eax),%al
    3f41:	84 c0                	test   %al,%al
    3f43:	0f 85 76 fe ff ff    	jne    3dbf <printf+0x22>
    }
  }
}
    3f49:	c9                   	leave  
...
morecore(uint nu)
{
  ...
  p = sbrk(nu * sizeof(Header));
    ...
    404b:	e8 3d fc ff ff       	call   3c8d <sbrk>
...
malloc(uint nbytes)
{
  ...
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
    ...
    4093:	40                   	inc    %eax
    4094:	89 45 ec             	mov    %eax,-0x14(%ebp)
  if((prevp = freep) == 0){
    4097:	a1 68 5f 00 00       	mov    0x5f68,%eax
    409c:	89 45 f0             	mov    %eax,-0x10(%ebp)
    409f:	83 7d f0 00          	cmpl   $0x0,-0x10(%ebp)
    40a3:	75 23                	jne    40c8 <malloc+0x44>
    base.s.ptr = freep = prevp = &base;
    40a5:	c7 45 f0 60 5f 00 00 	movl   $0x5f60,-0x10(%ebp)
    40ac:	8b 45 f0             	mov    -0x10(%ebp),%eax
    40af:	a3 68 5f 00 00       	mov    %eax,0x5f68
    40b4:	a1 68 5f 00 00       	mov    0x5f68,%eax
    40b9:	a3 60 5f 00 00       	mov    %eax,0x5f60
    base.s.size = 0;
    40be:	c7 05 64 5f 00 00 00 	movl   $0x0,0x5f64
    40c5:	00 00 00 
  }
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
    40c8:	8b 45 f0             	mov    -0x10(%ebp),%eax
    40cb:	8b 00                	mov    (%eax),%eax
    40cd:	89 45 f4             	mov    %eax,-0xc(%ebp)
    if(p->s.size >= nunits){
    40d0:	8b 45 f4             	mov    -0xc(%ebp),%eax
    40d3:	8b 40 04             	mov    0x4(%eax),%eax
    40d6:	3b 45 ec             	cmp    -0x14(%ebp),%eax
    40d9:	72 4d                	jb     4128 <malloc+0xa4>
      if(p->s.size == nunits)
    40db:	8b 45 f4             	mov    -0xc(%ebp),%eax
    40de:	8b 40 04             	mov    0x4(%eax),%eax
    40e1:	3b 45 ec             	cmp    -0x14(%ebp),%eax
    40e4:	75 0c                	jne    40f2 <malloc+0x6e>
        prevp->s.ptr = p->s.ptr;
    40e6:	8b 45 f4             	mov    -0xc(%ebp),%eax
    40e9:	8b 10                	mov    (%eax),%edx
    40eb:	8b 45 f0             	mov    -0x10(%ebp),%eax
    40ee:	89 10                	mov    %edx,(%eax)
    40f0:	eb 26                	jmp    4118 <malloc+0x94>
      else {
        p->s.size -= nunits;
    40f2:	8b 45 f4             	mov    -0xc(%ebp),%eax
    40f5:	8b 40 04             	mov    0x4(%eax),%eax
    40f8:	89 c2                	mov    %eax,%edx
    40fa:	2b 55 ec             	sub    -0x14(%ebp),%edx
    40fd:	8b 45 f4             	mov    -0xc(%ebp),%eax
    4100:	89 50 04             	mov    %edx,0x4(%eax)
        p += p->s.size;
    4103:	8b 45 f4             	mov    -0xc(%ebp),%eax
    4106:	8b 40 04             	mov    0x4(%eax),%eax
    4109:	c1 e0 03             	shl    $0x3,%eax
    410c:	01 45 f4             	add    %eax,-0xc(%ebp)
        p->s.size = nunits;
    410f:	8b 45 f4             	mov    -0xc(%ebp),%eax
    4112:	8b 55 ec             	mov    -0x14(%ebp),%edx
    4115:	89 50 04             	mov    %edx,0x4(%eax)
      }
      freep = prevp;
    4118:	8b 45 f0             	mov    -0x10(%ebp),%eax
    411b:	a3 68 5f 00 00       	mov    %eax,0x5f68
      return (void*)(p + 1);
    4120:	8b 45 f4             	mov    -0xc(%ebp),%eax
    4123:	83 c0 08             	add    $0x8,%eax
    4126:	eb 38                	jmp    4160 <malloc+0xdc>
    }
    if(p == freep)
    4128:	a1 68 5f 00 00       	mov    0x5f68,%eax
    412d:	39 45 f4             	cmp    %eax,-0xc(%ebp)
    4130:	75 1b                	jne    414d <malloc+0xc9>
      if((p = morecore(nunits)) == 0)
    4132:	8b 45 ec             	mov    -0x14(%ebp),%eax
    4135:	89 04 24             	mov    %eax,(%esp)
    4138:	e8 ef fe ff ff       	call   402c <morecore>
    413d:	89 45 f4             	mov    %eax,-0xc(%ebp)
    4140:	83 7d f4 00          	cmpl   $0x0,-0xc(%ebp)
    4144:	75 07                	jne    414d <malloc+0xc9>
        return 0;
    4146:	b8 00 00 00 00       	mov    $0x0,%eax
    414b:	eb 13                	jmp    4160 <malloc+0xdc>
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
    414d:	8b 45 f4             	mov    -0xc(%ebp),%eax
    4150:	89 45 f0             	mov    %eax,-0x10(%ebp)
    4153:	8b 45 f4             	mov    -0xc(%ebp),%eax
    4156:	8b 00                	mov    (%eax),%eax
    4158:	89 45 f4             	mov    %eax,-0xc(%ebp)
  }
    415b:	e9 70 ff ff ff       	jmp    40d0 <malloc+0x4c>
}
    4160:	c9                   	leave  
    4161:	c3                   	ret    
