...
main(void)
{
 ...
 1a3:	00 
 1a4:	c7 44 24 04 bd 0c 00 	movl   $0xcbd,0x4(%esp)
 1ab:	00 
 ...
 1d9:	a3 1c 10 00 00       	mov    %eax,0x101c
      if(semprod < 0){
 1de:	a1 1c 10 00 00       	mov    0x101c,%eax
 1e3:	85 c0                	test   %eax,%eax
 1e5:	79 19                	jns    200 <main+0xba>
        printf(1,"invalid semprod \n");
 1e7:	c7 44 24 04 d4 0c 00 	movl   $0xcd4,0x4(%esp)
 1ee:	00 
 ...
 214:	a3 28 10 00 00       	mov    %eax,0x1028
    if(semcom < 0){
 219:	a1 28 10 00 00       	mov    0x1028,%eax
 21e:	85 c0                	test   %eax,%eax
 220:	79 19                	jns    23b <main+0xf5>
      printf(1,"invalid semcom\n");
 222:	c7 44 24 04 e6 0c 00 	movl   $0xce6,0x4(%esp)
 229:	00 
 ...
 24f:	a3 20 10 00 00       	mov    %eax,0x1020
    if(sembuff < 0){
 254:	a1 20 10 00 00       	mov    0x1020,%eax
 259:	85 c0                	test   %eax,%eax
 25b:	79 19                	jns    276 <main+0x130>
      printf(1,"invalid sembuff\n");
 25d:	c7 44 24 04 f6 0c 00 	movl   $0xcf6,0x4(%esp)
 264:	00 
 ...
 2a2:	c7 44 24 04 08 0d 00 	movl   $0xd08,0x4(%esp)
 2a9:	00 
 ...
 352:	c7 44 24 04 28 0d 00 	movl   $0xd28,0x4(%esp)
 359:	00 
 ...
 40c:	c7 44 24 04 48 0d 00 	movl   $0xd48,0x4(%esp)
 413:	00 
...
printint(int fd, int xx, int base, int sgn)
{
 ...
 7d4:	8a 80 fc 0f 00 00    	mov    0xffc(%eax),%al
...
printf(int fd, char *fmt, ...)
{
 ...
 933:	75 25                	jne    95a <printf+0x11c>
          s = "(null)";
 935:	c7 45 f4 78 0d 00 00 	movl   $0xd78,-0xc(%ebp)
        while(*s != 0){
...
free(void *ap)
{
 ...
 9fb:	a1 18 10 00 00       	mov    0x1018,%eax
 ...
 ac6:	a3 18 10 00 00       	mov    %eax,0x1018
}
 acb:	c9                   	leave  
 acc:	c3                   	ret    
...
morecore(uint nu)
{
 ...
 b19:	e8 ce fe ff ff       	call   9ec <free>
  return freep;
 b1e:	a1 18 10 00 00       	mov    0x1018,%eax
}
 b23:	c9                   	leave  
 b24:	c3                   	ret    
...
malloc(uint nbytes)
{
 ...
 b35:	89 45 ec             	mov    %eax,-0x14(%ebp)
  if((prevp = freep) == 0){
 b38:	a1 18 10 00 00       	mov    0x1018,%eax
 b3d:	89 45 f0             	mov    %eax,-0x10(%ebp)
 b40:	83 7d f0 00          	cmpl   $0x0,-0x10(%ebp)
 b44:	75 23                	jne    b69 <malloc+0x44>
    base.s.ptr = freep = prevp = &base;
 b46:	c7 45 f0 10 10 00 00 	movl   $0x1010,-0x10(%ebp)
 b4d:	8b 45 f0             	mov    -0x10(%ebp),%eax
 b50:	a3 18 10 00 00       	mov    %eax,0x1018
 b55:	a1 18 10 00 00       	mov    0x1018,%eax
 b5a:	a3 10 10 00 00       	mov    %eax,0x1010
    base.s.size = 0;
 b5f:	c7 05 14 10 00 00 00 	movl   $0x0,0x1014
 b66:	00 00 00 
  }
 ...
 bbc:	a3 18 10 00 00       	mov    %eax,0x1018
      return (void*)(p + 1);
 ...
 bc7:	eb 38                	jmp    c01 <malloc+0xdc>
    ...
    if(p == freep)
 bc9:	a1 18 10 00 00       	mov    0x1018,%eax
