...
_prodconstest:     formato del fichero elf32-i386
...
consume(char* memConsumer)
{
  ...
  a9:	c7 44 24 04 42 0c 00 	movl   $0xc42,0x4(%esp)
  b0:	00 
  ...
  c4:	eb 78                	jmp    13e <consume+0x9b>
    ...
    semdown(semcom);
  c6:	a1 18 10 00 00       	mov    0x1018,%eax
  cb:	89 04 24             	mov    %eax,(%esp)
  ce:	e8 6b 06 00 00       	call   73e <semdown>
    semdown(sembuff);
  d3:	a1 10 10 00 00       	mov    0x1010,%eax
...
main(void)
{
 ...
 188:	c7 44 24 04 80 0c 00 	movl   $0xc80,0x4(%esp)
 18f:	00 
 ...
 1a3:	00 
 1a4:	c7 44 24 04 b1 0c 00 	movl   $0xcb1,0x4(%esp)
 1ab:	00 
 ...
 1d9:	a3 0c 10 00 00       	mov    %eax,0x100c
      if(semprod < 0){
 1de:	a1 0c 10 00 00       	mov    0x100c,%eax
 1e3:	85 c0                	test   %eax,%eax
 1e5:	79 19                	jns    200 <main+0xba>
        printf(1,"invalid semprod \n");
 1e7:	c7 44 24 04 c2 0c 00 	movl   $0xcc2,0x4(%esp)
 1ee:	00 
 ...
 214:	a3 18 10 00 00       	mov    %eax,0x1018
    if(semcom < 0){
 219:	a1 18 10 00 00       	mov    0x1018,%eax
 21e:	85 c0                	test   %eax,%eax
 220:	79 19                	jns    23b <main+0xf5>
      printf(1,"invalid semcom\n");
 222:	c7 44 24 04 d4 0c 00 	movl   $0xcd4,0x4(%esp)
 229:	00 
 ...
 24f:	a3 10 10 00 00       	mov    %eax,0x1010
    if(sembuff < 0){
 254:	a1 10 10 00 00       	mov    0x1010,%eax
 259:	85 c0                	test   %eax,%eax
 25b:	79 19                	jns    276 <main+0x130>
      printf(1,"invalid sembuff\n");
 25d:	c7 44 24 04 e4 0c 00 	movl   $0xce4,0x4(%esp)
 264:	00 
 ...
 2a2:	c7 44 24 04 f8 0c 00 	movl   $0xcf8,0x4(%esp)
 2a9:	00 
 ...
 352:	c7 44 24 04 18 0d 00 	movl   $0xd18,0x4(%esp)
 359:	00 
 ...
 40c:	c7 44 24 04 38 0d 00 	movl   $0xd38,0x4(%esp)
 413:	00 
...
printint(int fd, int xx, int base, int sgn)
{
 ...
 7d4:	8a 80 ec 0f 00 00    	mov    0xfec(%eax),%al
...
printf(int fd, char *fmt, ...)
{
 ...
 933:	75 25                	jne    95a <printf+0x11c>
          s = "(null)";
 935:	c7 45 f4 67 0d 00 00 	movl   $0xd67,-0xc(%ebp)
        while(*s != 0){
...
free(void *ap)
{
 ...
 9fb:	a1 08 10 00 00       	mov    0x1008,%eax
 ...
 ac6:	a3 08 10 00 00       	mov    %eax,0x1008
}
 acb:	c9                   	leave  
 acc:	c3                   	ret    
...
morecore(uint nu)
{
 ...
 b19:	e8 ce fe ff ff       	call   9ec <free>
  return freep;
 b1e:	a1 08 10 00 00       	mov    0x1008,%eax
}
 b23:	c9                   	leave  
 b24:	c3                   	ret    
...
malloc(uint nbytes)
{
 ...
 b35:	89 45 ec             	mov    %eax,-0x14(%ebp)
  if((prevp = freep) == 0){
 b38:	a1 08 10 00 00       	mov    0x1008,%eax
 b3d:	89 45 f0             	mov    %eax,-0x10(%ebp)
 b40:	83 7d f0 00          	cmpl   $0x0,-0x10(%ebp)
 b44:	75 23                	jne    b69 <malloc+0x44>
    base.s.ptr = freep = prevp = &base;
 b46:	c7 45 f0 00 10 00 00 	movl   $0x1000,-0x10(%ebp)
 b4d:	8b 45 f0             	mov    -0x10(%ebp),%eax
 b50:	a3 08 10 00 00       	mov    %eax,0x1008
 b55:	a1 08 10 00 00       	mov    0x1008,%eax
 b5a:	a3 00 10 00 00       	mov    %eax,0x1000
    base.s.size = 0;
 b5f:	c7 05 04 10 00 00 00 	movl   $0x0,0x1004
 b66:	00 00 00 
  }
 ...
 bbc:	a3 08 10 00 00       	mov    %eax,0x1008
      return (void*)(p + 1);
 ...
 bc7:	eb 38                	jmp    c01 <malloc+0xdc>
    ...
    if(p == freep)
 bc9:	a1 08 10 00 00       	mov    0x1008,%eax
