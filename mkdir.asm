...
main(int argc, char *argv[])
{
  ...
  66:	c7 44 24 04 4b 08 00 	movl   $0x84b,0x4(%esp)
  6d:	00 
...
printint(int fd, int xx, int base, int sgn)
{
 ...
 405:	8a 80 ac 0a 00 00    	mov    0xaac(%eax),%al
...
printf(int fd, char *fmt, ...)
{
 ...
 564:	75 25                	jne    58b <printf+0x11c>
          s = "(null)";
 566:	c7 45 f4 67 08 00 00 	movl   $0x867,-0xc(%ebp)
        while(*s != 0){
...
free(void *ap)
{
 ...
 62c:	a1 c8 0a 00 00       	mov    0xac8,%eax
 ...
 6f7:	a3 c8 0a 00 00       	mov    %eax,0xac8
}
 6fc:	c9                   	leave  
 6fd:	c3                   	ret    
...
morecore(uint nu)
{
 ...
 74a:	e8 ce fe ff ff       	call   61d <free>
  return freep;
 74f:	a1 c8 0a 00 00       	mov    0xac8,%eax
}
 754:	c9                   	leave  
 755:	c3                   	ret    
...
malloc(uint nbytes)
{
 ...
 766:	89 45 ec             	mov    %eax,-0x14(%ebp)
  if((prevp = freep) == 0){
 769:	a1 c8 0a 00 00       	mov    0xac8,%eax
 76e:	89 45 f0             	mov    %eax,-0x10(%ebp)
 771:	83 7d f0 00          	cmpl   $0x0,-0x10(%ebp)
 775:	75 23                	jne    79a <malloc+0x44>
    base.s.ptr = freep = prevp = &base;
 777:	c7 45 f0 c0 0a 00 00 	movl   $0xac0,-0x10(%ebp)
 77e:	8b 45 f0             	mov    -0x10(%ebp),%eax
 781:	a3 c8 0a 00 00       	mov    %eax,0xac8
 786:	a1 c8 0a 00 00       	mov    0xac8,%eax
 78b:	a3 c0 0a 00 00       	mov    %eax,0xac0
    base.s.size = 0;
 790:	c7 05 c4 0a 00 00 00 	movl   $0x0,0xac4
 797:	00 00 00 
  }
 ...
 7ed:	a3 c8 0a 00 00       	mov    %eax,0xac8
      return (void*)(p + 1);
 ...
 7f8:	eb 38                	jmp    832 <malloc+0xdc>
    ...
    if(p == freep)
 7fa:	a1 c8 0a 00 00       	mov    0xac8,%eax
