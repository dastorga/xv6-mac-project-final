...
main(int argc, char *argv[])
{
  ...
  66:	c7 44 24 04 83 08 00 	movl   $0x883,0x4(%esp)
  6d:	00 
...
printint(int fd, int xx, int base, int sgn)
{
 ...
 43d:	8a 80 e4 0a 00 00    	mov    0xae4(%eax),%al
...
printf(int fd, char *fmt, ...)
{
 ...
 59c:	75 25                	jne    5c3 <printf+0x11c>
          s = "(null)";
 59e:	c7 45 f4 9f 08 00 00 	movl   $0x89f,-0xc(%ebp)
        while(*s != 0){
...
free(void *ap)
{
 ...
 664:	a1 00 0b 00 00       	mov    0xb00,%eax
 ...
 72f:	a3 00 0b 00 00       	mov    %eax,0xb00
}
 734:	c9                   	leave  
 735:	c3                   	ret    
...
malloc(uint nbytes)
{
 ...
 79e:	89 45 ec             	mov    %eax,-0x14(%ebp)
  if((prevp = freep) == 0){
 7a1:	a1 00 0b 00 00       	mov    0xb00,%eax
 7a6:	89 45 f0             	mov    %eax,-0x10(%ebp)
 7a9:	83 7d f0 00          	cmpl   $0x0,-0x10(%ebp)
 7ad:	75 23                	jne    7d2 <malloc+0x44>
    base.s.ptr = freep = prevp = &base;
 7af:	c7 45 f0 f8 0a 00 00 	movl   $0xaf8,-0x10(%ebp)
 7b6:	8b 45 f0             	mov    -0x10(%ebp),%eax
 7b9:	a3 00 0b 00 00       	mov    %eax,0xb00
 7be:	a1 00 0b 00 00       	mov    0xb00,%eax
 7c3:	a3 f8 0a 00 00       	mov    %eax,0xaf8
    base.s.size = 0;
 7c8:	c7 05 fc 0a 00 00 00 	movl   $0x0,0xafc
 7cf:	00 00 00 
  }
 ...
 825:	a3 00 0b 00 00       	mov    %eax,0xb00
      return (void*)(p + 1);
 ...
 830:	eb 38                	jmp    86a <malloc+0xdc>
    ...
    if(p == freep)
 832:	a1 00 0b 00 00       	mov    0xb00,%eax
