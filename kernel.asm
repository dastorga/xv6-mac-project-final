...
8010003a:	c7 44 24 04 50 8e 10 	movl   $0x80108e50,0x4(%esp)
80100041:	80 
80100042:	c7 04 24 a0 d6 10 80 	movl   $0x8010d6a0,(%esp)
80100049:	e8 3a 55 00 00       	call   80105588 <initlock>
...
801000bd:	e8 e7 54 00 00       	call   801055a9 <acquire>
...
80100104:	e8 02 55 00 00       	call   8010560b <release>
        return b;
...
8010011f:	e8 bd 49 00 00       	call   80104ae1 <sleep>
      goto loop;
...
8010017c:	e8 8a 54 00 00       	call   8010560b <release>
      return b;
...
80100198:	c7 04 24 57 8e 10 80 	movl   $0x80108e57,(%esp)
...
801001ed:	75 0c                	jne    801001fb <bwrite+0x1e>
    panic("bwrite");
801001ef:	c7 04 24 68 8e 10 80 	movl   $0x80108e68,(%esp)
...
80100227:	75 0c                	jne    80100235 <brelse+0x1e>
    panic("brelse");
80100229:	c7 04 24 6f 8e 10 80 	movl   $0x80108e6f,(%esp)
80100230:	e8 01 03 00 00       	call   80100536 <panic>

  acquire(&bcache.lock);
80100235:	c7 04 24 a0 d6 10 80 	movl   $0x8010d6a0,(%esp)
8010023c:	e8 68 53 00 00       	call   801055a9 <acquire>
...
8010029d:	e8 47 49 00 00       	call   80104be9 <wakeup>

  release(&bcache.lock);
801002a2:	c7 04 24 a0 d6 10 80 	movl   $0x8010d6a0,(%esp)
801002a9:	e8 5d 53 00 00       	call   8010560b <release>
}
801002ae:	c9                   	leave  
801002af:	c3                   	ret    
...
801003bc:	e8 e8 51 00 00       	call   801055a9 <acquire>
...
801003c6:	75 0c                	jne    801003d4 <cprintf+0x33>
    panic("null fmt");
801003c8:	c7 04 24 76 8e 10 80 	movl   $0x80108e76,(%esp)
...
801004ab:	74 1e                	je     801004cb <cprintf+0x12a>
        s = "(null)";
801004ad:	c7 45 ec 7f 8e 10 80 	movl   $0x80108e7f,-0x14(%ebp)
      for(; *s; s++)
...
8010052f:	e8 d7 50 00 00       	call   8010560b <release>
}
80100534:	c9                   	leave  
80100535:	c3                   	ret    
...
8010055a:	c7 04 24 86 8e 10 80 	movl   $0x80108e86,(%esp)
...
8010056c:	e8 30 fe ff ff       	call   801003a1 <cprintf>
  cprintf("\n");
80100571:	c7 04 24 95 8e 10 80 	movl   $0x80108e95,(%esp)
...
8010058a:	e8 cb 50 00 00       	call   8010565a <getcallerpcs>
  for(i=0; i<10; i++)
...
801005a3:	c7 04 24 97 8e 10 80 	movl   $0x80108e97,(%esp)
...
80100695:	e8 2d 52 00 00       	call   801058c7 <memmove>
    pos -= 80;
...
801006c4:	e8 32 51 00 00       	call   801057fb <memset>
  }
...
8010079d:	e8 07 4e 00 00       	call   801055a9 <acquire>
  while((c = getc()) >= 0){
...
801007c8:	eb 7e                	jmp    80100848 <consoleintr+0xb8>
    case C('P'):  // Process listing.
      procdump();
801007ca:	e8 c9 44 00 00       	call   80104c98 <procdump>
      break;
...
801008ce:	e8 16 43 00 00       	call   80104be9 <wakeup>
        }
      }
      break;
...
801008f5:	e8 11 4d 00 00       	call   8010560b <release>
}
801008fa:	c9                   	leave  
801008fb:	c3                   	ret    
...
8010091a:	e8 8a 4c 00 00       	call   801055a9 <acquire>
  while(n > 0){
...
80100938:	e8 ce 4c 00 00       	call   8010560b <release>
        ilock(ip);
...
80100961:	e8 7b 41 00 00       	call   80104ae1 <sleep>
...
801009d8:	e8 2e 4c 00 00       	call   8010560b <release>
  ilock(ip);
...
80100a0e:	e8 96 4b 00 00       	call   801055a9 <acquire>
  for(i = 0; i < n; i++)
...
80100a48:	e8 be 4b 00 00       	call   8010560b <release>
  ilock(ip);
...
80100a63:	c7 44 24 04 9b 8e 10 	movl   $0x80108e9b,0x4(%esp)
80100a6a:	80 
80100a6b:	c7 04 24 00 c6 10 80 	movl   $0x8010c600,(%esp)
80100a72:	e8 11 4b 00 00       	call   80105588 <initlock>
  initlock(&input.lock, "input");
80100a77:	c7 44 24 04 a3 8e 10 	movl   $0x80108ea3,0x4(%esp)
80100a7e:	80 
80100a7f:	c7 04 24 e0 ed 10 80 	movl   $0x8010ede0,(%esp)
80100a86:	e8 fd 4a 00 00       	call   80105588 <initlock>
...
80100b3d:	0f 85 4f 03 00 00    	jne    80100e92 <exec+0x3c7>
  ...
  if((pgdir = setupkvm()) == 0)
80100b43:	e8 d7 79 00 00       	call   8010851f <setupkvm>
...
80100bdc:	e8 04 7d 00 00       	call   801088e5 <allocuvm>
...
80100c19:	e8 d8 7b 00 00       	call   801087f6 <loaduvm>
...
80100c82:	e8 5e 7c 00 00       	call   801088e5 <allocuvm>
...
80100ca6:	e8 84 7e 00 00       	call   80108b2f <clearpteu>
  sp = sz;
...
80100cdb:	e8 76 4d 00 00       	call   80105a56 <strlen>
...
80100d03:	e8 4e 4d 00 00       	call   80105a56 <strlen>
80100d08:	40                   	inc    %eax
...
80100d31:	e8 04 80 00 00       	call   80108d3a <copyout>
...
80100dd4:	e8 61 7f 00 00       	call   80108d3a <copyout>
...
80100e26:	e8 e2 4b 00 00       	call   80105a0d <safestrcpy>
...
80100e78:	e8 93 77 00 00       	call   80108610 <switchuvm>
  freevm(oldpgdir);
80100e7d:	8b 45 d0             	mov    -0x30(%ebp),%eax
80100e80:	89 04 24             	mov    %eax,(%esp)
80100e83:	e8 0e 7c 00 00       	call   80108a96 <freevm>
  return 0;
...
80100eba:	e8 d7 7b 00 00       	call   80108a96 <freevm>
  if(ip)
...
80100edd:	c7 44 24 04 a9 8e 10 	movl   $0x80108ea9,0x4(%esp)
80100ee4:	80 
80100ee5:	c7 04 24 a0 ee 10 80 	movl   $0x8010eea0,(%esp)
80100eec:	e8 97 46 00 00       	call   80105588 <initlock>
}
80100ef1:	c9                   	leave  
80100ef2:	c3                   	ret    
...
80100f00:	e8 a4 46 00 00       	call   801055a9 <acquire>
...
80100f29:	e8 dd 46 00 00       	call   8010560b <release>
      return f;
...
80100f47:	e8 bf 46 00 00       	call   8010560b <release>
  return 0;
...
80100f60:	e8 44 46 00 00       	call   801055a9 <acquire>
  if(f->ref < 1)
...
80100f6d:	7f 0c                	jg     80100f7b <filedup+0x28>
    panic("filedup");
80100f6f:	c7 04 24 b0 8e 10 80 	movl   $0x80108eb0,(%esp)
...
80100f91:	e8 75 46 00 00       	call   8010560b <release>
  return f;
...
80100fab:	e8 f9 45 00 00       	call   801055a9 <acquire>
  if(f->ref < 1)
...
80100fb8:	7f 0c                	jg     80100fc6 <fileclose+0x2b>
    panic("fileclose");
80100fba:	c7 04 24 b8 8e 10 80 	movl   $0x80108eb8,(%esp)
...
80100fe6:	e8 20 46 00 00       	call   8010560b <release>
...
8010101c:	e8 ea 45 00 00       	call   8010560b <release>
...
8010115f:	eb 0c                	jmp    8010116d <fileread+0xb9>
  ...
  panic("fileread");
80101161:	c7 04 24 c2 8e 10 80 	movl   $0x80108ec2,(%esp)
...
8010126c:	c7 04 24 cb 8e 10 80 	movl   $0x80108ecb,(%esp)
...
8010129f:	eb 0c                	jmp    801012ad <filewrite+0x13e>
  ...
  panic("filewrite");
801012a1:	c7 04 24 db 8e 10 80 	movl   $0x80108edb,(%esp)
...
801012e7:	e8 db 45 00 00       	call   801058c7 <memmove>
  brelse(bp);
...
8010132d:	e8 c9 44 00 00       	call   801057fb <memset>
  log_write(bp);
...
80101495:	c7 04 24 e5 8e 10 80 	movl   $0x80108ee5,(%esp)
...
80101538:	c7 04 24 fb 8e 10 80 	movl   $0x80108efb,(%esp)
...
8010158d:	c7 44 24 04 0e 8f 10 	movl   $0x80108f0e,0x4(%esp)
80101594:	80 
80101595:	c7 04 24 a0 f8 10 80 	movl   $0x8010f8a0,(%esp)
8010159c:	e8 e7 3f 00 00       	call   80105588 <initlock>
}
801015a1:	c9                   	leave  
801015a2:	c3                   	ret    
...
80101626:	e8 d0 41 00 00       	call   801057fb <memset>
      dip->type = type;
...
8010167d:	c7 04 24 15 8f 10 80 	movl   $0x80108f15,(%esp)
...
80101724:	e8 9e 41 00 00       	call   801058c7 <memmove>
  log_write(bp);
...
8010174e:	e8 56 3e 00 00       	call   801055a9 <acquire>
...
80101798:	e8 6e 3e 00 00       	call   8010560b <release>
      return ip;
...
801017cb:	c7 04 24 27 8f 10 80 	movl   $0x80108f27,(%esp)
...
80101809:	e8 fd 3d 00 00       	call   8010560b <release>
...
80101820:	e8 84 3d 00 00       	call   801055a9 <acquire>
  ip->ref++;
...
8010183b:	e8 cb 3d 00 00       	call   8010560b <release>
  return ip;
...
80101859:	7f 0c                	jg     80101867 <ilock+0x22>
    panic("ilock");
8010185b:	c7 04 24 37 8f 10 80 	movl   $0x80108f37,(%esp)
80101862:	e8 cf ec ff ff       	call   80100536 <panic>

  acquire(&icache.lock);
80101867:	c7 04 24 a0 f8 10 80 	movl   $0x8010f8a0,(%esp)
8010186e:	e8 36 3d 00 00       	call   801055a9 <acquire>
...
80101883:	e8 59 32 00 00       	call   80104ae1 <sleep>
  while(ip->flags & I_BUSY)
...
801018ad:	e8 59 3d 00 00       	call   8010560b <release>
...
80101956:	e8 6c 3f 00 00       	call   801058c7 <memmove>
    brelse(bp);
...
80101980:	75 0c                	jne    8010198e <ilock+0x149>
      panic("ilock: no type");
80101982:	c7 04 24 3d 8f 10 80 	movl   $0x80108f3d,(%esp)
...
801019b1:	7f 0c                	jg     801019bf <iunlock+0x2f>
    panic("iunlock");
801019b3:	c7 04 24 4c 8f 10 80 	movl   $0x80108f4c,(%esp)
801019ba:	e8 77 eb ff ff       	call   80100536 <panic>

  acquire(&icache.lock);
801019bf:	c7 04 24 a0 f8 10 80 	movl   $0x8010f8a0,(%esp)
801019c6:	e8 de 3b 00 00       	call   801055a9 <acquire>
  ip->flags &= ~I_BUSY;
...
801019e2:	e8 02 32 00 00       	call   80104be9 <wakeup>
  release(&icache.lock);
801019e7:	c7 04 24 a0 f8 10 80 	movl   $0x8010f8a0,(%esp)
801019ee:	e8 18 3c 00 00       	call   8010560b <release>
}
801019f3:	c9                   	leave  
801019f4:	c3                   	ret    
...
80101a02:	e8 a2 3b 00 00       	call   801055a9 <acquire>
...
80101a3e:	74 0c                	je     80101a4c <iput+0x57>
      panic("iput busy");
80101a40:	c7 04 24 54 8f 10 80 	movl   $0x80108f54,(%esp)
...
80101a64:	e8 a2 3b 00 00       	call   8010560b <release>
    itrunc(ip);
...
80101a8f:	e8 15 3b 00 00       	call   801055a9 <acquire>
    ip->flags = 0;
...
80101aa4:	e8 40 31 00 00       	call   80104be9 <wakeup>
  }
  ip->ref--;
...
80101abf:	e8 47 3b 00 00       	call   8010560b <release>
}
80101ac4:	c9                   	leave  
80101ac5:	c3                   	ret    
...
80101bdf:	c7 04 24 5e 8f 10 80 	movl   $0x80108f5e,(%esp)
...
80101e7e:	e8 44 3a 00 00       	call   801058c7 <memmove>
    brelse(bp);
...
80101fde:	e8 e4 38 00 00       	call   801058c7 <memmove>
    log_write(bp);
...
8010205c:	e8 02 39 00 00       	call   80105963 <strncmp>
}
80102061:	c9                   	leave  
80102062:	c3                   	ret    
...
80102075:	c7 04 24 71 8f 10 80 	movl   $0x80108f71,(%esp)
...
801020b1:	74 0c                	je     801020bf <dirlookup+0x5c>
      panic("dirlink read");
801020b3:	c7 04 24 83 8f 10 80 	movl   $0x80108f83,(%esp)
...
80102193:	74 0c                	je     801021a1 <dirlink+0x79>
      panic("dirlink read");
80102195:	c7 04 24 83 8f 10 80 	movl   $0x80108f83,(%esp)
...
801021da:	e8 d4 37 00 00       	call   801059b3 <strncpy>
  de.inum = inum;
...
8010220a:	74 0c                	je     80102218 <dirlink+0xf0>
    panic("dirlink");
8010220c:	c7 04 24 90 8f 10 80 	movl   $0x80108f90,(%esp)
...
8010228d:	e8 35 36 00 00       	call   801058c7 <memmove>
  else {
    memmove(name, s, len);
    name[len] = 0;
  }
...
801022a8:	e8 1a 36 00 00       	call   801058c7 <memmove>
    name[len] = 0;
...
801024fb:	c7 44 24 04 98 8f 10 	movl   $0x80108f98,0x4(%esp)
80102502:	80 
80102503:	c7 04 24 40 c6 10 80 	movl   $0x8010c640,(%esp)
8010250a:	e8 79 30 00 00       	call   80105588 <initlock>
  picenable(IRQ_IDE);
...
801025a2:	75 0c                	jne    801025b0 <idestart+0x18>
    panic("idestart");
801025a4:	c7 04 24 9c 8f 10 80 	movl   $0x80108f9c,(%esp)
...
801026ca:	e8 da 2e 00 00       	call   801055a9 <acquire>
  if((b = idequeue) == 0){
...
801026e4:	e8 22 2f 00 00       	call   8010560b <release>
...
80102757:	e8 8d 24 00 00       	call   80104be9 <wakeup>
...
80102779:	e8 8d 2e 00 00       	call   8010560b <release>
}
8010277e:	c9                   	leave  
8010277f:	c3                   	ret    
...
80102792:	c7 04 24 a5 8f 10 80 	movl   $0x80108fa5,(%esp)
...
801027ab:	c7 04 24 b9 8f 10 80 	movl   $0x80108fb9,(%esp)
...
80102836:	e8 a6 22 00 00       	call   80104ae1 <sleep>
...
80102852:	e8 b4 2d 00 00       	call   8010560b <release>
}
80102857:	c9                   	leave  
80102858:	c3                   	ret    
...
801028dd:	c7 04 24 ec 8f 10 80 	movl   $0x80108fec,(%esp)
...
80102996:	c7 44 24 04 1e 90 10 	movl   $0x8010901e,0x4(%esp)
8010299d:	80 
8010299e:	c7 04 24 80 08 11 80 	movl   $0x80110880,(%esp)
801029a5:	e8 de 2b 00 00       	call   80105588 <initlock>
  kmem.use_lock = 0;
...
80102a50:	76 0c                	jbe    80102a5e <kfree+0x39>
    panic("kfree");
80102a52:	c7 04 24 23 90 10 80 	movl   $0x80109023,(%esp)
...
80102a74:	e8 82 2d 00 00       	call   801057fb <memset>
...
80102a89:	e8 1b 2b 00 00       	call   801055a9 <acquire>
  r = (struct run*)v;
...
80102ab7:	e8 4f 2b 00 00       	call   8010560b <release>
}
80102abc:	c9                   	leave  
80102abd:	c3                   	ret    
...
80102ad4:	e8 d0 2a 00 00       	call   801055a9 <acquire>
  r = kmem.freelist;
...
80102b01:	e8 05 2b 00 00       	call   8010560b <release>
  return (char*)r;
...
80102e74:	c7 04 24 2c 90 10 80 	movl   $0x8010902c,(%esp)
...
80102fcb:	c7 44 24 04 58 90 10 	movl   $0x80109058,0x4(%esp)
80102fd2:	80 
80102fd3:	c7 04 24 c0 08 11 80 	movl   $0x801108c0,(%esp)
80102fda:	e8 a9 25 00 00       	call   80105588 <initlock>
  readsb(ROOTDEV, &sb);
...
8010308e:	e8 34 28 00 00       	call   801058c7 <memmove>
...
801031dd:	e8 c7 23 00 00       	call   801055a9 <acquire>
  while (log.busy) {
...
801031f3:	e8 e9 18 00 00       	call   80104ae1 <sleep>
  while (log.busy) {
...
80103212:	e8 f4 23 00 00       	call   8010560b <release>
}
80103217:	c9                   	leave  
80103218:	c3                   	ret    
...
80103291:	c7 04 24 5c 90 10 80 	movl   $0x8010905c,(%esp)
...
801032a6:	c7 04 24 72 90 10 80 	movl   $0x80109072,(%esp)
...
80103335:	e8 8d 25 00 00       	call   801058c7 <memmove>
  bwrite(lbuf);
...
801033f5:	c7 04 24 89 90 10 80 	movl   $0x80109089,(%esp)
...
80103410:	e8 d8 3e 00 00       	call   801072ed <uartinit>
  pinit();         // process table
80103415:	e8 c9 0b 00 00       	call   80103fe3 <pinit>
  tvinit();        // trap vectors
8010341a:	e8 81 3a 00 00       	call   80106ea0 <tvinit>
  binit();         // buffer cache
...
8010343c:	e8 a7 39 00 00       	call   80106de8 <timerinit>
...
80103467:	83 ec 08             	sub    $0x8,%esp
  switchkvm(); 
8010346a:	e8 84 51 00 00       	call   801085f3 <switchkvm>
  seginit();
8010346f:	e8 24 4b 00 00       	call   80107f98 <seginit>
  lapicinit();
...
80103493:	c7 04 24 a0 90 10 80 	movl   $0x801090a0,(%esp)
8010349a:	e8 02 cf ff ff       	call   801003a1 <cprintf>
  idtinit();       // load idt register
8010349f:	e8 59 3b 00 00       	call   80106ffd <idtinit>
...
801034f1:	e8 d1 23 00 00       	call   801058c7 <memmove>
...
801036c8:	00 
801036c9:	c7 44 24 04 b4 90 10 	movl   $0x801090b4,0x4(%esp)
801036d0:	80 
801036d1:	8b 45 f4             	mov    -0xc(%ebp),%eax
801036d4:	89 04 24             	mov    %eax,(%esp)
801036d7:	e8 96 21 00 00       	call   80105872 <memcmp>
...
80103805:	00 
80103806:	c7 44 24 04 b9 90 10 	movl   $0x801090b9,0x4(%esp)
8010380d:	80 
8010380e:	8b 45 f0             	mov    -0x10(%ebp),%eax
80103811:	89 04 24             	mov    %eax,(%esp)
80103814:	e8 59 20 00 00       	call   80105872 <memcmp>
...
801038dc:	8b 04 85 fc 90 10 80 	mov    -0x7fef6f04(,%eax,4),%eax
...
80103913:	c7 04 24 be 90 10 80 	movl   $0x801090be,(%esp)
...
801039b3:	c7 04 24 dc 90 10 80 	movl   $0x801090dc,(%esp)
...
80103ca9:	c7 44 24 04 10 91 10 	movl   $0x80109110,0x4(%esp)
80103cb0:	80 
80103cb1:	89 04 24             	mov    %eax,(%esp)
80103cb4:	e8 cf 18 00 00       	call   80105588 <initlock>
  (*f0)->type = FD_PIPE;
...
80103d61:	e8 43 18 00 00       	call   801055a9 <acquire>
  if(writable){
...
80103d84:	e8 60 0e 00 00       	call   80104be9 <wakeup>
...
80103da3:	e8 41 0e 00 00       	call   80104be9 <wakeup>
  }
...
80103dc8:	e8 3e 18 00 00       	call   8010560b <release>
    kfree((char*)p);
...
80103de0:	e8 26 18 00 00       	call   8010560b <release>
}
80103de5:	c9                   	leave  
80103de6:	c3                   	ret    
...
80103df4:	e8 b0 17 00 00       	call   801055a9 <acquire>
  for(i = 0; i < n; i++){
...
80103e25:	e8 e1 17 00 00       	call   8010560b <release>
        return -1;
...
80103e3f:	e8 a5 0d 00 00       	call   80104be9 <wakeup>
...
80103e57:	e8 85 0c 00 00       	call   80104ae1 <sleep>
...
80103ebe:	e8 26 0d 00 00       	call   80104be9 <wakeup>
  release(&p->lock);
80103ec3:	8b 45 08             	mov    0x8(%ebp),%eax
80103ec6:	89 04 24             	mov    %eax,(%esp)
80103ec9:	e8 3d 17 00 00       	call   8010560b <release>
  return n;
...
80103ee4:	e8 c0 16 00 00       	call   801055a9 <acquire>
...
80103efe:	e8 08 17 00 00       	call   8010560b <release>
      return -1;
...
80103f20:	e8 bc 0b 00 00       	call   80104ae1 <sleep>
  while(p->nread == p->nwrite && p->writeopen){  //DOC: pipe-empty
...
80103faf:	e8 35 0c 00 00       	call   80104be9 <wakeup>
  release(&p->lock);
80103fb4:	8b 45 08             	mov    0x8(%ebp),%eax
80103fb7:	89 04 24             	mov    %eax,(%esp)
80103fba:	e8 4c 16 00 00       	call   8010560b <release>
  return i;
...
80103fe9:	c7 44 24 04 18 91 10 	movl   $0x80109118,0x4(%esp)
80103ff0:	80 
80103ff1:	c7 04 24 00 10 11 80 	movl   $0x80111000,(%esp)
80103ff8:	e8 8b 15 00 00       	call   80105588 <initlock>
  shm_init(); // New: Add in project final: inicializo shmtable.sharedmemory[i].refcount = -1
80103ffd:	e8 f9 10 00 00       	call   801050fb <shm_init>
}
80104002:	c9                   	leave  
80104003:	c3                   	ret    
...
801040d3:	c7 04 24 1f 91 10 80 	movl   $0x8010911f,(%esp)
...
801041cf:	e8 d5 13 00 00       	call   801055a9 <acquire>
...
801041fe:	e8 08 14 00 00       	call   8010560b <release>
  return 0;
...
80104230:	e8 d6 13 00 00       	call   8010560b <release>
...
80104287:	ba 58 6e 10 80       	mov    $0x80106e58,%edx
...
801042b7:	e8 3f 15 00 00       	call   801057fb <memset>
  p->context->eip = (uint)forkret;
801042bc:	8b 45 f4             	mov    -0xc(%ebp),%eax
801042bf:	8b 40 1c             	mov    0x1c(%eax),%eax
801042c2:	ba b5 4a 10 80       	mov    $0x80104ab5,%edx
...
801042e5:	e8 35 42 00 00       	call   8010851f <setupkvm>
...
801042fa:	c7 04 24 2e 91 10 80 	movl   $0x8010912e,(%esp)
...
80104320:	e8 46 44 00 00       	call   8010876b <inituvm>
  p->sz = PGSIZE;
...
80104347:	e8 af 14 00 00       	call   801057fb <memset>
...
801043be:	00 
801043bf:	c7 44 24 04 47 91 10 	movl   $0x80109147,0x4(%esp)
801043c6:	80 
801043c7:	89 04 24             	mov    %eax,(%esp)
801043ca:	e8 3e 16 00 00       	call   80105a0d <safestrcpy>
  p->cwd = namei("/");
801043cf:	c7 04 24 50 91 10 80 	movl   $0x80109150,(%esp)
...
8010442c:	e8 b4 44 00 00       	call   801088e5 <allocuvm>
...
80104466:	e8 54 45 00 00       	call   801089bf <deallocuvm>
...
8010448f:	e8 7c 41 00 00       	call   80108610 <switchuvm>
  return 0;
...
801044d4:	e8 9c 46 00 00       	call   80108b75 <copyuvm>
...
8010460f:	e8 f9 13 00 00       	call   80105a0d <safestrcpy>
  return pid;
...
80104634:	75 0c                	jne    80104642 <exit+0x23>
    panic("init exiting");
80104636:	c7 04 24 52 91 10 80 	movl   $0x80109152,(%esp)
...
801046c3:	e8 17 07 00 00       	call   80104ddf <getstable>
...
801046d4:	e8 6d 08 00 00       	call   80104f46 <semfree>
  for(sd = 0; sd < MAXSEMPROC; sd++){
...
80104729:	e8 da 0a 00 00       	call   80105208 <shm_close>
  for(i = 0; i < MAXSHMPROC; i++){
...
8010473e:	e8 66 0e 00 00       	call   801055a9 <acquire>
...
8010474f:	e8 4b 04 00 00       	call   80104b9f <wakeup1>
...
8010478c:	e8 0e 04 00 00       	call   80104b9f <wakeup1>
  for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
...
801047a7:	c7 40 0c 05 00 00 00 	movl   $0x5,0xc(%eax)
  sched();
801047ae:	e8 f1 01 00 00       	call   801049a4 <sched>
  panic("zombie exit");
801047b3:	c7 04 24 5f 91 10 80 	movl   $0x8010915f,(%esp)
...
801047cc:	e8 d8 0d 00 00       	call   801055a9 <acquire>
  for(;;){
...
80104834:	e8 5d 42 00 00       	call   80108a96 <freevm>
        p->state = UNUSED;
...
8010486f:	e8 97 0d 00 00       	call   8010560b <release>
        return pid;
...
801048a8:	e8 5e 0d 00 00       	call   8010560b <release>
      return -1;
...
801048c5:	e8 17 02 00 00       	call   80104ae1 <sleep>
  }
...
801048e3:	e8 c1 0c 00 00       	call   801055a9 <acquire>
    // for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
    //   if(p->state != RUNNABLE)
...
80104924:	74 6d                	je     80104993 <scheduler+0xc2>
...
80104935:	e8 d6 3c 00 00       	call   80108610 <switchuvm>
      p->state = RUNNING;
...
80104951:	83 c0 6c             	add    $0x6c,%eax
80104954:	89 44 24 04          	mov    %eax,0x4(%esp)
80104958:	c7 04 24 6c 91 10 80 	movl   $0x8010916c,(%esp)
8010495f:	e8 3d ba ff ff       	call   801003a1 <cprintf>
      swtch(&cpu->scheduler, proc->context);
80104964:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
8010496a:	8b 40 1c             	mov    0x1c(%eax),%eax
8010496d:	65 8b 15 00 00 00 00 	mov    %gs:0x0,%edx
80104974:	83 c2 04             	add    $0x4,%edx
80104977:	89 44 24 04          	mov    %eax,0x4(%esp)
8010497b:	89 14 24             	mov    %edx,(%esp)
8010497e:	e8 f8 10 00 00       	call   80105a7b <swtch>
      switchkvm(); // Switch h/w page table register to the kernel-only page table,
80104983:	e8 6b 3c 00 00       	call   801085f3 <switchkvm>
                  // for when no process is running.

      // Process is done running for now.
      // It should have changed its p->state before coming back.
      proc = 0;
80104988:	65 c7 05 04 00 00 00 	movl   $0x0,%gs:0x4
8010498f:	00 00 00 00 
    }
    release(&ptable.lock);
80104993:	c7 04 24 00 10 11 80 	movl   $0x80111000,(%esp)
8010499a:	e8 6c 0c 00 00       	call   8010560b <release>

  }
8010499f:	e9 33 ff ff ff       	jmp    801048d7 <scheduler+0x6>
...
801049aa:	c7 04 24 00 10 11 80 	movl   $0x80111000,(%esp)
801049b1:	e8 1b 0d 00 00       	call   801056d1 <holding>
801049b6:	85 c0                	test   %eax,%eax
801049b8:	75 0c                	jne    801049c6 <sched+0x22>
    panic("sched ptable.lock");
801049ba:	c7 04 24 95 91 10 80 	movl   $0x80109195,(%esp)
801049c1:	e8 70 bb ff ff       	call   80100536 <panic>
  if(cpu->ncli != 1)
801049c6:	65 a1 00 00 00 00    	mov    %gs:0x0,%eax
801049cc:	8b 80 ac 00 00 00    	mov    0xac(%eax),%eax
801049d2:	83 f8 01             	cmp    $0x1,%eax
801049d5:	74 0c                	je     801049e3 <sched+0x3f>
    panic("sched locks");
801049d7:	c7 04 24 a7 91 10 80 	movl   $0x801091a7,(%esp)
801049de:	e8 53 bb ff ff       	call   80100536 <panic>
  if(proc->state == RUNNING)
801049e3:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
801049e9:	8b 40 0c             	mov    0xc(%eax),%eax
801049ec:	83 f8 04             	cmp    $0x4,%eax
801049ef:	75 0c                	jne    801049fd <sched+0x59>
    panic("sched running");
801049f1:	c7 04 24 b3 91 10 80 	movl   $0x801091b3,(%esp)
801049f8:	e8 39 bb ff ff       	call   80100536 <panic>
  if(readeflags()&FL_IF)
801049fd:	e8 c6 f5 ff ff       	call   80103fc8 <readeflags>
80104a02:	25 00 02 00 00       	and    $0x200,%eax
80104a07:	85 c0                	test   %eax,%eax
80104a09:	74 0c                	je     80104a17 <sched+0x73>
    panic("sched interruptible");
80104a0b:	c7 04 24 c1 91 10 80 	movl   $0x801091c1,(%esp)
80104a12:	e8 1f bb ff ff       	call   80100536 <panic>
  intena = cpu->intena;
80104a17:	65 a1 00 00 00 00    	mov    %gs:0x0,%eax
80104a1d:	8b 80 b0 00 00 00    	mov    0xb0(%eax),%eax
80104a23:	89 45 f4             	mov    %eax,-0xc(%ebp)
  swtch(&proc->context, cpu->scheduler);
80104a26:	65 a1 00 00 00 00    	mov    %gs:0x0,%eax
80104a2c:	8b 40 04             	mov    0x4(%eax),%eax
80104a2f:	65 8b 15 04 00 00 00 	mov    %gs:0x4,%edx
80104a36:	83 c2 1c             	add    $0x1c,%edx
80104a39:	89 44 24 04          	mov    %eax,0x4(%esp)
80104a3d:	89 14 24             	mov    %edx,(%esp)
80104a40:	e8 36 10 00 00       	call   80105a7b <swtch>
  cpu->intena = intena;
80104a45:	65 a1 00 00 00 00    	mov    %gs:0x0,%eax
80104a4b:	8b 55 f4             	mov    -0xc(%ebp),%edx
80104a4e:	89 90 b0 00 00 00    	mov    %edx,0xb0(%eax)
}
80104a54:	c9                   	leave  
80104a55:	c3                   	ret    
...
80104a5c:	c7 04 24 00 10 11 80 	movl   $0x80111000,(%esp)
80104a63:	e8 41 0b 00 00       	call   801055a9 <acquire>
  // proc->state = RUNNABLE;
  // sched();
  if(proc->priority<3){ 
80104a68:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
80104a6e:	8b 80 80 00 00 00    	mov    0x80(%eax),%eax
80104a74:	83 f8 02             	cmp    $0x2,%eax
80104a77:	7f 13                	jg     80104a8c <yield+0x36>
    proc->priority++;
80104a79:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
80104a7f:	8b 90 80 00 00 00    	mov    0x80(%eax),%edx
80104a85:	42                   	inc    %edx
80104a86:	89 90 80 00 00 00    	mov    %edx,0x80(%eax)
  }
  makerunnable(proc,1); // New: Added in proyect 2: enqueue proc
80104a8c:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
80104a92:	c7 44 24 04 01 00 00 	movl   $0x1,0x4(%esp)
80104a99:	00 
80104a9a:	89 04 24             	mov    %eax,(%esp)
80104a9d:	e8 b2 f6 ff ff       	call   80104154 <makerunnable>
  sched(); 
80104aa2:	e8 fd fe ff ff       	call   801049a4 <sched>
  release(&ptable.lock);
80104aa7:	c7 04 24 00 10 11 80 	movl   $0x80111000,(%esp)
80104aae:	e8 58 0b 00 00       	call   8010560b <release>
}
80104ab3:	c9                   	leave  
80104ab4:	c3                   	ret    
...
80104ab8:	83 ec 18             	sub    $0x18,%esp
  static int first = 1;
  // Still holding ptable.lock from scheduler.
  release(&ptable.lock);
80104abb:	c7 04 24 00 10 11 80 	movl   $0x80111000,(%esp)
80104ac2:	e8 44 0b 00 00       	call   8010560b <release>

  if (first) {
80104ac7:	a1 20 c0 10 80       	mov    0x8010c020,%eax
80104acc:	85 c0                	test   %eax,%eax
80104ace:	74 0f                	je     80104adf <forkret+0x2a>
    // Some initialization functions must be run in the context
    // of a regular process (e.g., they call sleep), and thus cannot 
    // be run from main().
    first = 0;
80104ad0:	c7 05 20 c0 10 80 00 	movl   $0x0,0x8010c020
80104ad7:	00 00 00 
    initlog();
80104ada:	e8 e3 e4 ff ff       	call   80102fc2 <initlog>
  }
...
80104aef:	75 0c                	jne    80104afd <sleep+0x1c>
    panic("sleep");
80104af1:	c7 04 24 d5 91 10 80 	movl   $0x801091d5,(%esp)
80104af8:	e8 39 ba ff ff       	call   80100536 <panic>

  if(lk == 0)
80104afd:	83 7d 0c 00          	cmpl   $0x0,0xc(%ebp)
80104b01:	75 0c                	jne    80104b0f <sleep+0x2e>
    panic("sleep without lk");
80104b03:	c7 04 24 db 91 10 80 	movl   $0x801091db,(%esp)
80104b0a:	e8 27 ba ff ff       	call   80100536 <panic>
...
80104b0f:	81 7d 0c 00 10 11 80 	cmpl   $0x80111000,0xc(%ebp)
80104b16:	74 17                	je     80104b2f <sleep+0x4e>
    acquire(&ptable.lock);  //DOC: sleeplock1
80104b18:	c7 04 24 00 10 11 80 	movl   $0x80111000,(%esp)
80104b1f:	e8 85 0a 00 00       	call   801055a9 <acquire>
    release(lk);
80104b24:	8b 45 0c             	mov    0xc(%ebp),%eax
80104b27:	89 04 24             	mov    %eax,(%esp)
80104b2a:	e8 dc 0a 00 00       	call   8010560b <release>
  }
...
80104b38:	89 50 20             	mov    %edx,0x20(%eax)
  proc->state = SLEEPING; 
80104b3b:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
80104b41:	c7 40 0c 02 00 00 00 	movl   $0x2,0xc(%eax)
...
80104b4e:	8b 80 80 00 00 00    	mov    0x80(%eax),%eax
80104b54:	85 c0                	test   %eax,%eax
80104b56:	7e 13                	jle    80104b6b <sleep+0x8a>
    proc->priority--;
80104b58:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
80104b5e:	8b 90 80 00 00 00    	mov    0x80(%eax),%edx
80104b64:	4a                   	dec    %edx
80104b65:	89 90 80 00 00 00    	mov    %edx,0x80(%eax)
  }
  sched();
80104b6b:	e8 34 fe ff ff       	call   801049a4 <sched>

  // Tidy up.
  proc->chan = 0;
80104b70:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
80104b76:	c7 40 20 00 00 00 00 	movl   $0x0,0x20(%eax)

  // Reacquire original lock.
  if(lk != &ptable.lock){  //DOC: sleeplock2
80104b7d:	81 7d 0c 00 10 11 80 	cmpl   $0x80111000,0xc(%ebp)
80104b84:	74 17                	je     80104b9d <sleep+0xbc>
    release(&ptable.lock);
80104b86:	c7 04 24 00 10 11 80 	movl   $0x80111000,(%esp)
80104b8d:	e8 79 0a 00 00       	call   8010560b <release>
    acquire(lk);
80104b92:	8b 45 0c             	mov    0xc(%ebp),%eax
80104b95:	89 04 24             	mov    %eax,(%esp)
80104b98:	e8 0c 0a 00 00       	call   801055a9 <acquire>
  }
}
80104b9d:	c9                   	leave  
80104b9e:	c3                   	ret    
...
80104ba2:	83 ec 28             	sub    $0x28,%esp
  struct proc *p;

  for(p = ptable.proc; p < &ptable.proc[NPROC]; p++)
80104ba5:	c7 45 f4 34 10 11 80 	movl   $0x80111034,-0xc(%ebp)
80104bac:	eb 30                	jmp    80104bde <wakeup1+0x3f>
    // if(p->state == SLEEPING && p->chan == chan)
    //   p->state = RUNNABLE;
    if(p->state == SLEEPING && p->chan == chan){ // Added in project 2
80104bae:	8b 45 f4             	mov    -0xc(%ebp),%eax
80104bb1:	8b 40 0c             	mov    0xc(%eax),%eax
80104bb4:	83 f8 02             	cmp    $0x2,%eax
80104bb7:	75 1e                	jne    80104bd7 <wakeup1+0x38>
80104bb9:	8b 45 f4             	mov    -0xc(%ebp),%eax
80104bbc:	8b 40 20             	mov    0x20(%eax),%eax
80104bbf:	3b 45 08             	cmp    0x8(%ebp),%eax
80104bc2:	75 13                	jne    80104bd7 <wakeup1+0x38>
      // New - enqueue proc
      makerunnable(p,-1);
80104bc4:	c7 44 24 04 ff ff ff 	movl   $0xffffffff,0x4(%esp)
80104bcb:	ff 
80104bcc:	8b 45 f4             	mov    -0xc(%ebp),%eax
80104bcf:	89 04 24             	mov    %eax,(%esp)
80104bd2:	e8 7d f5 ff ff       	call   80104154 <makerunnable>
  for(p = ptable.proc; p < &ptable.proc[NPROC]; p++)
80104bd7:	81 45 f4 ac 00 00 00 	addl   $0xac,-0xc(%ebp)
80104bde:	81 7d f4 34 3b 11 80 	cmpl   $0x80113b34,-0xc(%ebp)
80104be5:	72 c7                	jb     80104bae <wakeup1+0xf>
    }
}
80104be7:	c9                   	leave  
80104be8:	c3                   	ret    
...
80104bec:	83 ec 18             	sub    $0x18,%esp
  acquire(&ptable.lock);
80104bef:	c7 04 24 00 10 11 80 	movl   $0x80111000,(%esp)
80104bf6:	e8 ae 09 00 00       	call   801055a9 <acquire>
  wakeup1(chan);
80104bfb:	8b 45 08             	mov    0x8(%ebp),%eax
80104bfe:	89 04 24             	mov    %eax,(%esp)
80104c01:	e8 99 ff ff ff       	call   80104b9f <wakeup1>
  release(&ptable.lock);
80104c06:	c7 04 24 00 10 11 80 	movl   $0x80111000,(%esp)
80104c0d:	e8 f9 09 00 00       	call   8010560b <release>
}
80104c12:	c9                   	leave  
80104c13:	c3                   	ret    
...
80104c17:	83 ec 28             	sub    $0x28,%esp
  ...
  acquire(&ptable.lock);
80104c1a:	c7 04 24 00 10 11 80 	movl   $0x80111000,(%esp)
80104c21:	e8 83 09 00 00       	call   801055a9 <acquire>
  for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
80104c26:	c7 45 f4 34 10 11 80 	movl   $0x80111034,-0xc(%ebp)
80104c2d:	eb 4d                	jmp    80104c7c <kill+0x68>
    if(p->pid == pid){
80104c2f:	8b 45 f4             	mov    -0xc(%ebp),%eax
80104c32:	8b 40 10             	mov    0x10(%eax),%eax
80104c35:	3b 45 08             	cmp    0x8(%ebp),%eax
80104c38:	75 3b                	jne    80104c75 <kill+0x61>
      p->killed = 1;
80104c3a:	8b 45 f4             	mov    -0xc(%ebp),%eax
80104c3d:	c7 40 24 01 00 00 00 	movl   $0x1,0x24(%eax)
      // Wake process from sleep if necessary.
      // if(p->state == SLEEPING)
      //   p->state = RUNNABLE;
      if(p->state == SLEEPING){ // Added in proyect 2
80104c44:	8b 45 f4             	mov    -0xc(%ebp),%eax
80104c47:	8b 40 0c             	mov    0xc(%eax),%eax
80104c4a:	83 f8 02             	cmp    $0x2,%eax
80104c4d:	75 13                	jne    80104c62 <kill+0x4e>
        // New - enqueue proc
        makerunnable(p,0);
80104c4f:	c7 44 24 04 00 00 00 	movl   $0x0,0x4(%esp)
80104c56:	00 
80104c57:	8b 45 f4             	mov    -0xc(%ebp),%eax
80104c5a:	89 04 24             	mov    %eax,(%esp)
80104c5d:	e8 f2 f4 ff ff       	call   80104154 <makerunnable>
      }
      release(&ptable.lock);
80104c62:	c7 04 24 00 10 11 80 	movl   $0x80111000,(%esp)
80104c69:	e8 9d 09 00 00       	call   8010560b <release>
      return 0;
80104c6e:	b8 00 00 00 00       	mov    $0x0,%eax
80104c73:	eb 21                	jmp    80104c96 <kill+0x82>
  for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
80104c75:	81 45 f4 ac 00 00 00 	addl   $0xac,-0xc(%ebp)
80104c7c:	81 7d f4 34 3b 11 80 	cmpl   $0x80113b34,-0xc(%ebp)
80104c83:	72 aa                	jb     80104c2f <kill+0x1b>
    }
  }
  release(&ptable.lock);
80104c85:	c7 04 24 00 10 11 80 	movl   $0x80111000,(%esp)
80104c8c:	e8 7a 09 00 00       	call   8010560b <release>
  return -1;
...
80104c9b:	83 ec 68             	sub    $0x68,%esp
  int i;
  struct proc *p;
  char *state;
  uint pc[10];
  ...
  for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
80104c9e:	c7 45 f0 34 10 11 80 	movl   $0x80111034,-0x10(%ebp)
80104ca5:	e9 e7 00 00 00       	jmp    80104d91 <procdump+0xf9>
    if(p->state == UNUSED)
80104caa:	8b 45 f0             	mov    -0x10(%ebp),%eax
80104cad:	8b 40 0c             	mov    0xc(%eax),%eax
80104cb0:	85 c0                	test   %eax,%eax
80104cb2:	0f 84 d1 00 00 00    	je     80104d89 <procdump+0xf1>
      continue;
    if(p->state >= 0 && p->state < NELEM(states) && states[p->state])
80104cb8:	8b 45 f0             	mov    -0x10(%ebp),%eax
80104cbb:	8b 40 0c             	mov    0xc(%eax),%eax
80104cbe:	83 f8 05             	cmp    $0x5,%eax
80104cc1:	77 23                	ja     80104ce6 <procdump+0x4e>
80104cc3:	8b 45 f0             	mov    -0x10(%ebp),%eax
80104cc6:	8b 40 0c             	mov    0xc(%eax),%eax
80104cc9:	8b 04 85 08 c0 10 80 	mov    -0x7fef3ff8(,%eax,4),%eax
80104cd0:	85 c0                	test   %eax,%eax
80104cd2:	74 12                	je     80104ce6 <procdump+0x4e>
      state = states[p->state];
80104cd4:	8b 45 f0             	mov    -0x10(%ebp),%eax
80104cd7:	8b 40 0c             	mov    0xc(%eax),%eax
80104cda:	8b 04 85 08 c0 10 80 	mov    -0x7fef3ff8(,%eax,4),%eax
80104ce1:	89 45 ec             	mov    %eax,-0x14(%ebp)
80104ce4:	eb 07                	jmp    80104ced <procdump+0x55>
    else
      state = "???";
80104ce6:	c7 45 ec ec 91 10 80 	movl   $0x801091ec,-0x14(%ebp)
    // cprintf("%d %s %s", p->pid, state, p->name);
    cprintf("%d %s %s %d", p->pid, state, p->name, p->priority);
80104ced:	8b 45 f0             	mov    -0x10(%ebp),%eax
80104cf0:	8b 90 80 00 00 00    	mov    0x80(%eax),%edx
...
80104d02:	89 54 24 10          	mov    %edx,0x10(%esp)
80104d06:	89 4c 24 0c          	mov    %ecx,0xc(%esp)
80104d0a:	8b 55 ec             	mov    -0x14(%ebp),%edx
80104d0d:	89 54 24 08          	mov    %edx,0x8(%esp)
80104d11:	89 44 24 04          	mov    %eax,0x4(%esp)
80104d15:	c7 04 24 f0 91 10 80 	movl   $0x801091f0,(%esp)
80104d1c:	e8 80 b6 ff ff       	call   801003a1 <cprintf>
    if(p->state == SLEEPING){
80104d21:	8b 45 f0             	mov    -0x10(%ebp),%eax
80104d24:	8b 40 0c             	mov    0xc(%eax),%eax
80104d27:	83 f8 02             	cmp    $0x2,%eax
80104d2a:	75 4f                	jne    80104d7b <procdump+0xe3>
      getcallerpcs((uint*)p->context->ebp+2, pc);
80104d2c:	8b 45 f0             	mov    -0x10(%ebp),%eax
80104d2f:	8b 40 1c             	mov    0x1c(%eax),%eax
80104d32:	8b 40 0c             	mov    0xc(%eax),%eax
80104d35:	83 c0 08             	add    $0x8,%eax
80104d38:	8d 55 c4             	lea    -0x3c(%ebp),%edx
80104d3b:	89 54 24 04          	mov    %edx,0x4(%esp)
80104d3f:	89 04 24             	mov    %eax,(%esp)
80104d42:	e8 13 09 00 00       	call   8010565a <getcallerpcs>
      for(i=0; i<10 && pc[i] != 0; i++)
80104d47:	c7 45 f4 00 00 00 00 	movl   $0x0,-0xc(%ebp)
80104d4e:	eb 1a                	jmp    80104d6a <procdump+0xd2>
        cprintf(" %p", pc[i]);
80104d50:	8b 45 f4             	mov    -0xc(%ebp),%eax
80104d53:	8b 44 85 c4          	mov    -0x3c(%ebp,%eax,4),%eax
80104d57:	89 44 24 04          	mov    %eax,0x4(%esp)
80104d5b:	c7 04 24 fc 91 10 80 	movl   $0x801091fc,(%esp)
80104d62:	e8 3a b6 ff ff       	call   801003a1 <cprintf>
      for(i=0; i<10 && pc[i] != 0; i++)
80104d67:	ff 45 f4             	incl   -0xc(%ebp)
80104d6a:	83 7d f4 09          	cmpl   $0x9,-0xc(%ebp)
80104d6e:	7f 0b                	jg     80104d7b <procdump+0xe3>
80104d70:	8b 45 f4             	mov    -0xc(%ebp),%eax
80104d73:	8b 44 85 c4          	mov    -0x3c(%ebp,%eax,4),%eax
80104d77:	85 c0                	test   %eax,%eax
80104d79:	75 d5                	jne    80104d50 <procdump+0xb8>
    }
    cprintf("\n");
80104d7b:	c7 04 24 00 92 10 80 	movl   $0x80109200,(%esp)
80104d82:	e8 1a b6 ff ff       	call   801003a1 <cprintf>
80104d87:	eb 01                	jmp    80104d8a <procdump+0xf2>
      continue;
80104d89:	90                   	nop
  for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
80104d8a:	81 45 f0 ac 00 00 00 	addl   $0xac,-0x10(%ebp)
80104d91:	81 7d f0 34 3b 11 80 	cmpl   $0x80113b34,-0x10(%ebp)
80104d98:	0f 82 0c ff ff ff    	jb     80104caa <procdump+0x12>
  }
}
80104d9e:	c9                   	leave  
80104d9f:	c3                   	ret    

80104da0 <checkprocsem>:
...
80104da3:	83 ec 10             	sub    $0x10,%esp
	struct sem **r;
...
80104dac:	05 88 00 00 00       	add    $0x88,%eax
80104db1:	89 45 fc             	mov    %eax,-0x4(%ebp)
80104db4:	eb 12                	jmp    80104dc8 <checkprocsem+0x28>
		if (*r == 0)
80104db6:	8b 45 fc             	mov    -0x4(%ebp),%eax
80104db9:	8b 00                	mov    (%eax),%eax
80104dbb:	85 c0                	test   %eax,%eax
80104dbd:	75 05                	jne    80104dc4 <checkprocsem+0x24>
			return r;
80104dbf:	8b 45 fc             	mov    -0x4(%ebp),%eax
80104dc2:	eb 19                	jmp    80104ddd <checkprocsem+0x3d>
	for (r = proc->procsem; r < proc->procsem + MAXSEMPROC; r++) {
80104dc4:	83 45 fc 04          	addl   $0x4,-0x4(%ebp)
80104dc8:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
80104dce:	05 98 00 00 00       	add    $0x98,%eax
80104dd3:	3b 45 fc             	cmp    -0x4(%ebp),%eax
80104dd6:	77 de                	ja     80104db6 <checkprocsem+0x16>
	}
	return 0;
...
80104de0:	89 e5                	mov    %esp,%ebp
	return stable.sem;
80104de2:	b8 94 3b 11 80       	mov    $0x80113b94,%eax
}
80104de7:	5d                   	pop    %ebp
80104de8:	c3                   	ret    
...
80104dec:	83 ec 28             	sub    $0x28,%esp
	struct sem *t;
	struct sem *s;
	struct sem **r;
	...
	if (first_time) {
80104def:	a1 24 c0 10 80       	mov    0x8010c024,%eax
80104df4:	85 c0                	test   %eax,%eax
80104df6:	74 1e                	je     80104e16 <semget+0x2d>
		initlock(&stable.lock, "stable"); // begin the mutual exclusion
80104df8:	c7 44 24 04 2c 92 10 	movl   $0x8010922c,0x4(%esp)
80104dff:	80 
80104e00:	c7 04 24 60 3b 11 80 	movl   $0x80113b60,(%esp)
80104e07:	e8 7c 07 00 00       	call   80105588 <initlock>
		first_time = 0;
80104e0c:	c7 05 24 c0 10 80 00 	movl   $0x0,0x8010c024
80104e13:	00 00 00 
	}

	acquire(&stable.lock);
80104e16:	c7 04 24 60 3b 11 80 	movl   $0x80113b60,(%esp)
80104e1d:	e8 87 07 00 00       	call   801055a9 <acquire>
	if (sem_id == -1) { // se desea CREAR un semaforo nuevo
80104e22:	83 7d 08 ff          	cmpl   $0xffffffff,0x8(%ebp)
80104e26:	0f 85 9d 00 00 00    	jne    80104ec9 <semget+0xe0>
		for (t = stable.sem; t < stable.sem + MAXSEM; t++)
80104e2c:	c7 45 f4 94 3b 11 80 	movl   $0x80113b94,-0xc(%ebp)
80104e33:	eb 3b                	jmp    80104e70 <semget+0x87>
		if (t->refcount == 0){
80104e35:	8b 45 f4             	mov    -0xc(%ebp),%eax
80104e38:	8b 40 04             	mov    0x4(%eax),%eax
80104e3b:	85 c0                	test   %eax,%eax
80104e3d:	75 2d                	jne    80104e6c <semget+0x83>
			s = t;
80104e3f:	8b 45 f4             	mov    -0xc(%ebp),%eax
80104e42:	89 45 f0             	mov    %eax,-0x10(%ebp)
			if (*(r = checkprocsem()) == 0)
80104e45:	e8 56 ff ff ff       	call   80104da0 <checkprocsem>
80104e4a:	89 45 ec             	mov    %eax,-0x14(%ebp)
80104e4d:	8b 45 ec             	mov    -0x14(%ebp),%eax
80104e50:	8b 00                	mov    (%eax),%eax
80104e52:	85 c0                	test   %eax,%eax
80104e54:	74 39                	je     80104e8f <semget+0xa6>
				goto found; // encontro
			release(&stable.lock);
80104e56:	c7 04 24 60 3b 11 80 	movl   $0x80113b60,(%esp)
80104e5d:	e8 a9 07 00 00       	call   8010560b <release>
			return -2; // el proceso ya obtuvo el numero maximo de semaforos
80104e62:	b8 fe ff ff ff       	mov    $0xfffffffe,%eax
80104e67:	e9 d8 00 00 00       	jmp    80104f44 <semget+0x15b>
		for (t = stable.sem; t < stable.sem + MAXSEM; t++)
80104e6c:	83 45 f4 08          	addl   $0x8,-0xc(%ebp)
80104e70:	81 7d f4 14 3c 11 80 	cmpl   $0x80113c14,-0xc(%ebp)
80104e77:	72 bc                	jb     80104e35 <semget+0x4c>
		}
		release(&stable.lock);
80104e79:	c7 04 24 60 3b 11 80 	movl   $0x80113b60,(%esp)
80104e80:	e8 86 07 00 00       	call   8010560b <release>
		return -3; // no ahi mas semaforos disponibles en el sistema
80104e85:	b8 fd ff ff ff       	mov    $0xfffffffd,%eax
80104e8a:	e9 b5 00 00 00       	jmp    80104f44 <semget+0x15b>
				goto found; // encontro
80104e8f:	90                   	nop
...
80104e96:	89 10                	mov    %edx,(%eax)
		s->refcount=1;
80104e98:	8b 45 f0             	mov    -0x10(%ebp),%eax
80104e9b:	c7 40 04 01 00 00 00 	movl   $0x1,0x4(%eax)
		*r = s;
80104ea2:	8b 45 ec             	mov    -0x14(%ebp),%eax
80104ea5:	8b 55 f0             	mov    -0x10(%ebp),%edx
80104ea8:	89 10                	mov    %edx,(%eax)
		...
		release(&stable.lock);
80104eaa:	c7 04 24 60 3b 11 80 	movl   $0x80113b60,(%esp)
80104eb1:	e8 55 07 00 00       	call   8010560b <release>
		return s - stable.sem;	
80104eb6:	8b 55 f0             	mov    -0x10(%ebp),%edx
80104eb9:	b8 94 3b 11 80       	mov    $0x80113b94,%eax
80104ebe:	89 d1                	mov    %edx,%ecx
80104ec0:	29 c1                	sub    %eax,%ecx
80104ec2:	89 c8                	mov    %ecx,%eax
80104ec4:	c1 f8 03             	sar    $0x3,%eax
80104ec7:	eb 7b                	jmp    80104f44 <semget+0x15b>

	} else { // en caso de que NO se desea crear un semaforo nuevo
		s = stable.sem + sem_id;
80104ec9:	8b 45 08             	mov    0x8(%ebp),%eax
80104ecc:	83 c0 06             	add    $0x6,%eax
80104ecf:	c1 e0 03             	shl    $0x3,%eax
80104ed2:	05 60 3b 11 80       	add    $0x80113b60,%eax
80104ed7:	83 c0 04             	add    $0x4,%eax
80104eda:	89 45 f0             	mov    %eax,-0x10(%ebp)
		if (s->refcount == 0){
80104edd:	8b 45 f0             	mov    -0x10(%ebp),%eax
80104ee0:	8b 40 04             	mov    0x4(%eax),%eax
80104ee3:	85 c0                	test   %eax,%eax
80104ee5:	75 13                	jne    80104efa <semget+0x111>
			release(&stable.lock);
80104ee7:	c7 04 24 60 3b 11 80 	movl   $0x80113b60,(%esp)
80104eee:	e8 18 07 00 00       	call   8010560b <release>
			return -1; // el semaforo con ese "sem_id" no esta en uso 
80104ef3:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80104ef8:	eb 4a                	jmp    80104f44 <semget+0x15b>
		}else if (*(r = checkprocsem()) == 0){
80104efa:	e8 a1 fe ff ff       	call   80104da0 <checkprocsem>
80104eff:	89 45 ec             	mov    %eax,-0x14(%ebp)
80104f02:	8b 45 ec             	mov    -0x14(%ebp),%eax
80104f05:	8b 00                	mov    (%eax),%eax
80104f07:	85 c0                	test   %eax,%eax
80104f09:	75 28                	jne    80104f33 <semget+0x14a>
			*r = s;
80104f0b:	8b 45 ec             	mov    -0x14(%ebp),%eax
80104f0e:	8b 55 f0             	mov    -0x10(%ebp),%edx
80104f11:	89 10                	mov    %edx,(%eax)
			s->refcount++;
80104f13:	8b 45 f0             	mov    -0x10(%ebp),%eax
80104f16:	8b 40 04             	mov    0x4(%eax),%eax
80104f19:	8d 50 01             	lea    0x1(%eax),%edx
80104f1c:	8b 45 f0             	mov    -0x10(%ebp),%eax
80104f1f:	89 50 04             	mov    %edx,0x4(%eax)
			release(&stable.lock);
80104f22:	c7 04 24 60 3b 11 80 	movl   $0x80113b60,(%esp)
80104f29:	e8 dd 06 00 00       	call   8010560b <release>
			return sem_id;
80104f2e:	8b 45 08             	mov    0x8(%ebp),%eax
80104f31:	eb 11                	jmp    80104f44 <semget+0x15b>
		}	else {
			release(&stable.lock);
80104f33:	c7 04 24 60 3b 11 80 	movl   $0x80113b60,(%esp)
80104f3a:	e8 cc 06 00 00       	call   8010560b <release>
			return -2; // el proceso ya obtuvo el maximo de semaforos
80104f3f:	b8 fe ff ff ff       	mov    $0xfffffffe,%eax
...
80104f4f:	83 c0 06             	add    $0x6,%eax
80104f52:	c1 e0 03             	shl    $0x3,%eax
80104f55:	05 60 3b 11 80       	add    $0x80113b60,%eax
80104f5a:	83 c0 04             	add    $0x4,%eax
80104f5d:	89 45 f0             	mov    %eax,-0x10(%ebp)
...
80104f68:	75 07                	jne    80104f71 <semfree+0x2b>
		return -1;		 //  y no es posible liberarlo, se produce un ERROR! 
80104f6a:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80104f6f:	eb 6a                	jmp    80104fdb <semfree+0x95>

	// recorro todos los semaforos del proceso
	for (r = proc->procsem; r < proc->procsem + MAXSEMPROC; r++) {
80104f71:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
80104f77:	05 88 00 00 00       	add    $0x88,%eax
80104f7c:	89 45 f4             	mov    %eax,-0xc(%ebp)
80104f7f:	eb 45                	jmp    80104fc6 <semfree+0x80>
		if (*r == s) {
80104f81:	8b 45 f4             	mov    -0xc(%ebp),%eax
80104f84:	8b 00                	mov    (%eax),%eax
80104f86:	3b 45 f0             	cmp    -0x10(%ebp),%eax
80104f89:	75 37                	jne    80104fc2 <semfree+0x7c>
			*r = 0;
80104f8b:	8b 45 f4             	mov    -0xc(%ebp),%eax
80104f8e:	c7 00 00 00 00 00    	movl   $0x0,(%eax)
			acquire(&stable.lock);
80104f94:	c7 04 24 60 3b 11 80 	movl   $0x80113b60,(%esp)
80104f9b:	e8 09 06 00 00       	call   801055a9 <acquire>
...
80104fac:	89 50 04             	mov    %edx,0x4(%eax)
			release(&stable.lock);
80104faf:	c7 04 24 60 3b 11 80 	movl   $0x80113b60,(%esp)
80104fb6:	e8 50 06 00 00       	call   8010560b <release>
			return 0;
80104fbb:	b8 00 00 00 00       	mov    $0x0,%eax
80104fc0:	eb 19                	jmp    80104fdb <semfree+0x95>
	for (r = proc->procsem; r < proc->procsem + MAXSEMPROC; r++) {
80104fc2:	83 45 f4 04          	addl   $0x4,-0xc(%ebp)
80104fc6:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
80104fcc:	05 98 00 00 00       	add    $0x98,%eax
80104fd1:	3b 45 f4             	cmp    -0xc(%ebp),%eax
80104fd4:	77 ab                	ja     80104f81 <semfree+0x3b>
		}
	}
	return -1;
...
80104fe6:	83 c0 06             	add    $0x6,%eax
80104fe9:	c1 e0 03             	shl    $0x3,%eax
80104fec:	05 60 3b 11 80       	add    $0x80113b60,%eax
...
80104ffe:	e8 a6 05 00 00       	call   801055a9 <acquire>
	if (s->refcount <= 0) {
80105003:	8b 45 f4             	mov    -0xc(%ebp),%eax
80105006:	8b 40 04             	mov    0x4(%eax),%eax
80105009:	85 c0                	test   %eax,%eax
8010500b:	7f 28                	jg     80105035 <semdown+0x58>
		release(&stable.lock);
8010500d:	c7 04 24 60 3b 11 80 	movl   $0x80113b60,(%esp)
80105014:	e8 f2 05 00 00       	call   8010560b <release>
		// cprintf("SEMDOWN>> sem_id = %d, semaforo %d, valor = %d, refcount = %d\n", sem_id, s, s->value, s->refcount);
		return -1; // error!!
80105019:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
8010501e:	eb 3d                	jmp    8010505d <semdown+0x80>
	}
	while (s->value == 0)
	sleep(s, &stable.lock); 
80105020:	c7 44 24 04 60 3b 11 	movl   $0x80113b60,0x4(%esp)
80105027:	80 
80105028:	8b 45 f4             	mov    -0xc(%ebp),%eax
8010502b:	89 04 24             	mov    %eax,(%esp)
8010502e:	e8 ae fa ff ff       	call   80104ae1 <sleep>
80105033:	eb 01                	jmp    80105036 <semdown+0x59>
	while (s->value == 0)
80105035:	90                   	nop
80105036:	8b 45 f4             	mov    -0xc(%ebp),%eax
80105039:	8b 00                	mov    (%eax),%eax
8010503b:	85 c0                	test   %eax,%eax
8010503d:	74 e1                	je     80105020 <semdown+0x43>
...
8010504a:	89 10                	mov    %edx,(%eax)
	// cprintf("SEMDOWN>> sem_id = %d, semaforo %d, valor = %d, refcount = %d\n", sem_id, s, s->value, s->refcount);
	release(&stable.lock);
8010504c:	c7 04 24 60 3b 11 80 	movl   $0x80113b60,(%esp)
80105053:	e8 b3 05 00 00       	call   8010560b <release>
	return 0;
...
80105068:	83 c0 06             	add    $0x6,%eax
8010506b:	c1 e0 03             	shl    $0x3,%eax
8010506e:	05 60 3b 11 80       	add    $0x80113b60,%eax
80105073:	83 c0 04             	add    $0x4,%eax
...
801050c7:	e8 1d fb ff ff       	call   80104be9 <wakeup>
801050cc:	eb 0d                	jmp    801050db <semup+0x7c>
		}else
			s->value++;
...
801050d9:	89 10                	mov    %edx,(%eax)
			release(&stable.lock);
801050db:	c7 04 24 60 3b 11 80 	movl   $0x80113b60,(%esp)
801050e2:	e8 24 05 00 00       	call   8010560b <release>
			// cprintf("SEMUP>> sem_id = %d, semaforo %d, valor = %d, refcount = %d\n", sem_id, s, s->value, s->refcount);
	}
	return 0;
...
801050f4:	05 00 00 00 80       	add    $0x80000000,%eax
801050f9:	5d                   	pop    %ebp
801050fa:	c3                   	ret    
...
80105101:	c7 44 24 04 33 92 10 	movl   $0x80109233,0x4(%esp)
80105108:	80 
80105109:	c7 04 24 c0 0f 11 80 	movl   $0x80110fc0,(%esp)
80105110:	e8 73 04 00 00       	call   80105588 <initlock>
  for(i = 0; i<MAXSHM; i++){ //recorro el arreglo hasta los MAXSHM=12 espacios de memoria compartida del sistema.
80105115:	c7 45 f4 00 00 00 00 	movl   $0x0,-0xc(%ebp)
8010511c:	eb 11                	jmp    8010512f <shm_init+0x34>
...
80105121:	c7 04 c5 64 0f 11 80 	movl   $0xffffffff,-0x7feef09c(,%eax,8)
80105128:	ff ff ff ff 
  for(i = 0; i<MAXSHM; i++){ //recorro el arreglo hasta los MAXSHM=12 espacios de memoria compartida del sistema.
8010512c:	ff 45 f4             	incl   -0xc(%ebp)
8010512f:	83 7d f4 0b          	cmpl   $0xb,-0xc(%ebp)
80105133:	7e e9                	jle    8010511e <shm_init+0x23>
  }
  return 0;
80105135:	b8 00 00 00 00       	mov    $0x0,%eax
}
8010513a:	c9                   	leave  
8010513b:	c3                   	ret    
...
8010513f:	83 ec 28             	sub    $0x28,%esp
  acquire(&shmtable.lock);
80105142:	c7 04 24 c0 0f 11 80 	movl   $0x80110fc0,(%esp)
80105149:	e8 5b 04 00 00       	call   801055a9 <acquire>
  if ( shmtable.quantity == MAXSHM ){ // si la cantidad de espacios activos en sharedmemory es igual a 12
8010514e:	a1 f4 0f 11 80       	mov    0x80110ff4,%eax
80105153:	66 83 f8 0c          	cmp    $0xc,%ax
80105157:	75 16                	jne    8010516f <shm_create+0x33>
    release(&shmtable.lock);         // es la logitud maxima del array sharedmemory, entonces:
80105159:	c7 04 24 c0 0f 11 80 	movl   $0x80110fc0,(%esp)
80105160:	e8 a6 04 00 00       	call   8010560b <release>
...
8010516a:	e9 97 00 00 00       	jmp    80105206 <shm_create+0xca>
  }
  int i = 0;
8010516f:	c7 45 f4 00 00 00 00 	movl   $0x0,-0xc(%ebp)
  while (i<MAXSHM){ // busco el primer espacio desocupado
80105176:	eb 77                	jmp    801051ef <shm_create+0xb3>
    if (shmtable.sharedmemory[i].refcount == -1){ // si es -1, esta desocupado el espacio.
80105178:	8b 45 f4             	mov    -0xc(%ebp),%eax
8010517b:	8b 04 c5 64 0f 11 80 	mov    -0x7feef09c(,%eax,8),%eax
80105182:	83 f8 ff             	cmp    $0xffffffff,%eax
80105185:	75 65                	jne    801051ec <shm_create+0xb0>
      shmtable.sharedmemory[i].addr = kalloc(); // El "kalloc" asigna una pagina de 4096 bytes de memoria fisica,
80105187:	e8 32 d9 ff ff       	call   80102abe <kalloc>
8010518c:	8b 55 f4             	mov    -0xc(%ebp),%edx
8010518f:	89 04 d5 60 0f 11 80 	mov    %eax,-0x7feef0a0(,%edx,8)
...
80105199:	8b 04 c5 60 0f 11 80 	mov    -0x7feef0a0(,%eax,8),%eax
801051a0:	c7 44 24 08 00 10 00 	movl   $0x1000,0x8(%esp)
801051a7:	00 
801051a8:	c7 44 24 04 00 00 00 	movl   $0x0,0x4(%esp)
801051af:	00 
801051b0:	89 04 24             	mov    %eax,(%esp)
801051b3:	e8 43 06 00 00       	call   801057fb <memset>
...
801051bb:	8b 04 c5 64 0f 11 80 	mov    -0x7feef09c(,%eax,8),%eax
801051c2:	8d 50 01             	lea    0x1(%eax),%edx
801051c5:	8b 45 f4             	mov    -0xc(%ebp),%eax
801051c8:	89 14 c5 64 0f 11 80 	mov    %edx,-0x7feef09c(,%eax,8)
      shmtable.quantity++; // se tomo un espacio del arreglo 
801051cf:	a1 f4 0f 11 80       	mov    0x80110ff4,%eax
801051d4:	40                   	inc    %eax
801051d5:	66 a3 f4 0f 11 80    	mov    %ax,0x80110ff4
      release(&shmtable.lock);
801051db:	c7 04 24 c0 0f 11 80 	movl   $0x80110fc0,(%esp)
801051e2:	e8 24 04 00 00       	call   8010560b <release>
...
801051ea:	eb 1a                	jmp    80105206 <shm_create+0xca>
    } else
      ++i;
801051ec:	ff 45 f4             	incl   -0xc(%ebp)
  while (i<MAXSHM){ // busco el primer espacio desocupado
801051ef:	83 7d f4 0b          	cmpl   $0xb,-0xc(%ebp)
801051f3:	7e 83                	jle    80105178 <shm_create+0x3c>
  }
  release(&shmtable.lock);
801051f5:	c7 04 24 c0 0f 11 80 	movl   $0x80110fc0,(%esp)
801051fc:	e8 0a 04 00 00       	call   8010560b <release>
...
8010520b:	83 ec 28             	sub    $0x28,%esp
  acquire(&shmtable.lock);  
8010520e:	c7 04 24 c0 0f 11 80 	movl   $0x80110fc0,(%esp)
80105215:	e8 8f 03 00 00       	call   801055a9 <acquire>
  if ( key < 0 || key > MAXSHM || shmtable.sharedmemory[key].refcount == -1){
8010521a:	83 7d 08 00          	cmpl   $0x0,0x8(%ebp)
8010521e:	78 15                	js     80105235 <shm_close+0x2d>
80105220:	83 7d 08 0c          	cmpl   $0xc,0x8(%ebp)
80105224:	7f 0f                	jg     80105235 <shm_close+0x2d>
80105226:	8b 45 08             	mov    0x8(%ebp),%eax
80105229:	8b 04 c5 64 0f 11 80 	mov    -0x7feef09c(,%eax,8),%eax
80105230:	83 f8 ff             	cmp    $0xffffffff,%eax
80105233:	75 16                	jne    8010524b <shm_close+0x43>
    release(&shmtable.lock);
80105235:	c7 04 24 c0 0f 11 80 	movl   $0x80110fc0,(%esp)
8010523c:	e8 ca 03 00 00       	call   8010560b <release>
...
80105246:	e9 8d 00 00 00       	jmp    801052d8 <shm_close+0xd0>
  }
  int i = 0;
8010524b:	c7 45 f4 00 00 00 00 	movl   $0x0,-0xc(%ebp)
  while (i<MAXSHMPROC && (proc->shmref[i] != shmtable.sharedmemory[key].addr)){ // para poder buscar donde se encuentra
80105252:	eb 03                	jmp    80105257 <shm_close+0x4f>
    i++; // avanzo al proximo
80105254:	ff 45 f4             	incl   -0xc(%ebp)
  while (i<MAXSHMPROC && (proc->shmref[i] != shmtable.sharedmemory[key].addr)){ // para poder buscar donde se encuentra
80105257:	83 7d f4 03          	cmpl   $0x3,-0xc(%ebp)
8010525b:	7f 1e                	jg     8010527b <shm_close+0x73>
8010525d:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
80105263:	8b 55 f4             	mov    -0xc(%ebp),%edx
80105266:	83 c2 24             	add    $0x24,%edx
80105269:	8b 54 90 08          	mov    0x8(%eax,%edx,4),%edx
8010526d:	8b 45 08             	mov    0x8(%ebp),%eax
80105270:	8b 04 c5 60 0f 11 80 	mov    -0x7feef0a0(,%eax,8),%eax
80105277:	39 c2                	cmp    %eax,%edx
80105279:	75 d9                	jne    80105254 <shm_close+0x4c>
  }
  if (i == MAXSHMPROC){ 
8010527b:	83 7d f4 04          	cmpl   $0x4,-0xc(%ebp)
8010527f:	75 13                	jne    80105294 <shm_close+0x8c>
    release(&shmtable.lock);
80105281:	c7 04 24 c0 0f 11 80 	movl   $0x80110fc0,(%esp)
80105288:	e8 7e 03 00 00       	call   8010560b <release>
...
801052bc:	c7 04 c5 64 0f 11 80 	movl   $0xffffffff,-0x7feef09c(,%eax,8)
801052c3:	ff ff ff ff 
  }
  release(&shmtable.lock);
801052c7:	c7 04 24 c0 0f 11 80 	movl   $0x80110fc0,(%esp)
801052ce:	e8 38 03 00 00       	call   8010560b <release>
...
801052dd:	83 ec 38             	sub    $0x38,%esp
  int j;
  acquire(&shmtable.lock);
801052e0:	c7 04 24 c0 0f 11 80 	movl   $0x80110fc0,(%esp)
801052e7:	e8 bd 02 00 00       	call   801055a9 <acquire>
  if ( key < 0 || key > MAXSHM || shmtable.sharedmemory[key].refcount == MAXSHMPROC ){ 
801052ec:	83 7d 08 00          	cmpl   $0x0,0x8(%ebp)
801052f0:	78 15                	js     80105307 <shm_get+0x2d>
801052f2:	83 7d 08 0c          	cmpl   $0xc,0x8(%ebp)
801052f6:	7f 0f                	jg     80105307 <shm_get+0x2d>
801052f8:	8b 45 08             	mov    0x8(%ebp),%eax
801052fb:	8b 04 c5 64 0f 11 80 	mov    -0x7feef09c(,%eax,8),%eax
80105302:	83 f8 04             	cmp    $0x4,%eax
80105305:	75 16                	jne    8010531d <shm_get+0x43>
    release(&shmtable.lock);                 
80105307:	c7 04 24 c0 0f 11 80 	movl   $0x80110fc0,(%esp)
8010530e:	e8 f8 02 00 00       	call   8010560b <release>
    return -1; // key invalida, debido a que esta fuera de los indices la key.
80105313:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80105318:	e9 24 01 00 00       	jmp    80105441 <shm_get+0x167>
  }  
  int i = 0;
8010531d:	c7 45 f4 00 00 00 00 	movl   $0x0,-0xc(%ebp)
  while (i<MAXSHMPROC && proc->shmref[i] != 0 ){ // existe una referencia
80105324:	eb 03                	jmp    80105329 <shm_get+0x4f>
    i++;
80105326:	ff 45 f4             	incl   -0xc(%ebp)
  while (i<MAXSHMPROC && proc->shmref[i] != 0 ){ // existe una referencia
80105329:	83 7d f4 03          	cmpl   $0x3,-0xc(%ebp)
8010532d:	7f 14                	jg     80105343 <shm_get+0x69>
8010532f:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
80105335:	8b 55 f4             	mov    -0xc(%ebp),%edx
80105338:	83 c2 24             	add    $0x24,%edx
8010533b:	8b 44 90 08          	mov    0x8(%eax,%edx,4),%eax
8010533f:	85 c0                	test   %eax,%eax
80105341:	75 e3                	jne    80105326 <shm_get+0x4c>
  }
  if (i == MAXSHMPROC ){ // si agoto los 4 espacios que posee el proceso disponible, entonces..
80105343:	83 7d f4 04          	cmpl   $0x4,-0xc(%ebp)
80105347:	75 16                	jne    8010535f <shm_get+0x85>
    release(&shmtable.lock); 
80105349:	c7 04 24 c0 0f 11 80 	movl   $0x80110fc0,(%esp)
80105350:	e8 b6 02 00 00       	call   8010560b <release>
...
8010535a:	e9 e2 00 00 00       	jmp    80105441 <shm_get+0x167>
  } else {  
...
80105362:	8b 04 c5 60 0f 11 80 	mov    -0x7feef0a0(,%eax,8),%eax
80105369:	89 04 24             	mov    %eax,(%esp)
8010536c:	e8 7d fd ff ff       	call   801050ee <v2p>
80105371:	65 8b 15 04 00 00 00 	mov    %gs:0x4,%edx
80105378:	8b 12                	mov    (%edx),%edx
8010537a:	81 e2 00 f0 ff ff    	and    $0xfffff000,%edx
80105380:	89 d1                	mov    %edx,%ecx
80105382:	65 8b 15 04 00 00 00 	mov    %gs:0x4,%edx
80105389:	8b 52 04             	mov    0x4(%edx),%edx
8010538c:	c7 44 24 10 06 00 00 	movl   $0x6,0x10(%esp)
80105393:	00 
80105394:	89 44 24 0c          	mov    %eax,0xc(%esp)
80105398:	c7 44 24 08 00 10 00 	movl   $0x1000,0x8(%esp)
8010539f:	00 
801053a0:	89 4c 24 04          	mov    %ecx,0x4(%esp)
801053a4:	89 14 24             	mov    %edx,(%esp)
801053a7:	e8 df 30 00 00       	call   8010848b <mappages>
801053ac:	89 45 f0             	mov    %eax,-0x10(%ebp)
...
801053af:	83 7d f0 ff          	cmpl   $0xffffffff,-0x10(%ebp)
801053b3:	75 0c                	jne    801053c1 <shm_get+0xe7>
801053b5:	c7 04 24 3c 92 10 80 	movl   $0x8010923c,(%esp)
801053bc:	e8 e0 af ff ff       	call   801003a1 <cprintf>

    proc->shmref[i] = shmtable.sharedmemory[key].addr; // la guardo en shmref[i]
801053c1:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
801053c7:	8b 55 08             	mov    0x8(%ebp),%edx
801053ca:	8b 14 d5 60 0f 11 80 	mov    -0x7feef0a0(,%edx,8),%edx
801053d1:	8b 4d f4             	mov    -0xc(%ebp),%ecx
801053d4:	83 c1 24             	add    $0x24,%ecx
801053d7:	89 54 88 08          	mov    %edx,0x8(%eax,%ecx,4)
    shmtable.sharedmemory[key].refcount++; 
801053db:	8b 45 08             	mov    0x8(%ebp),%eax
801053de:	8b 04 c5 64 0f 11 80 	mov    -0x7feef09c(,%eax,8),%eax
801053e5:	8d 50 01             	lea    0x1(%eax),%edx
801053e8:	8b 45 08             	mov    0x8(%ebp),%eax
801053eb:	89 14 c5 64 0f 11 80 	mov    %edx,-0x7feef09c(,%eax,8)
...
801053fa:	25 00 f0 ff ff       	and    $0xfffff000,%eax
...
8010540c:	8b 90 a8 00 00 00    	mov    0xa8(%eax),%edx
80105412:	42                   	inc    %edx
80105413:	89 90 a8 00 00 00    	mov    %edx,0xa8(%eax)
...
8010541f:	65 8b 15 04 00 00 00 	mov    %gs:0x4,%edx
80105426:	8b 12                	mov    (%edx),%edx
80105428:	81 c2 00 10 00 00    	add    $0x1000,%edx
8010542e:	89 10                	mov    %edx,(%eax)
    release(&shmtable.lock);
80105430:	c7 04 24 c0 0f 11 80 	movl   $0x80110fc0,(%esp)
80105437:	e8 cf 01 00 00       	call   8010560b <release>
...
80105446:	b8 60 0f 11 80       	mov    $0x80110f60,%eax
}
8010544b:	5d                   	pop    %ebp
8010544c:	c3                   	ret    

8010544d <sys_shm_create>:
...
80105450:	83 ec 28             	sub    $0x28,%esp
  int size;
...
80105461:	e8 c6 06 00 00       	call   80105b2c <argint>
80105466:	85 c0                	test   %eax,%eax
80105468:	79 0e                	jns    80105478 <sys_shm_create+0x2b>
8010546a:	8b 45 f0             	mov    -0x10(%ebp),%eax
8010546d:	85 c0                	test   %eax,%eax
8010546f:	7e 07                	jle    80105478 <sys_shm_create+0x2b>
    return -1;
80105471:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80105476:	eb 0b                	jmp    80105483 <sys_shm_create+0x36>
  int k = shm_create();
80105478:	e8 bf fc ff ff       	call   8010513c <shm_create>
...
80105488:	83 ec 28             	sub    $0x28,%esp
  int k;
  int mem = 0;  
8010548b:	c7 45 f0 00 00 00 00 	movl   $0x0,-0x10(%ebp)
  if (proc->shmemquantity >= MAXSHMPROC)
80105492:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
80105498:	8b 80 a8 00 00 00    	mov    0xa8(%eax),%eax
8010549e:	83 f8 03             	cmp    $0x3,%eax
801054a1:	7e 07                	jle    801054aa <sys_shm_get+0x25>
    return -1;
801054a3:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
801054a8:	eb 55                	jmp    801054ff <sys_shm_get+0x7a>
  if(argint(0, &k) < 0)
801054aa:	8d 45 f4             	lea    -0xc(%ebp),%eax
801054ad:	89 44 24 04          	mov    %eax,0x4(%esp)
801054b1:	c7 04 24 00 00 00 00 	movl   $0x0,(%esp)
801054b8:	e8 6f 06 00 00       	call   80105b2c <argint>
801054bd:	85 c0                	test   %eax,%eax
801054bf:	79 07                	jns    801054c8 <sys_shm_get+0x43>
    return -1;
801054c1:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
801054c6:	eb 37                	jmp    801054ff <sys_shm_get+0x7a>
  argint(1,&mem); 
801054c8:	8d 45 f0             	lea    -0x10(%ebp),%eax
801054cb:	89 44 24 04          	mov    %eax,0x4(%esp)
801054cf:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
801054d6:	e8 51 06 00 00       	call   80105b2c <argint>
  if (!shm_get(k,(char**)mem)){ 
801054db:	8b 45 f0             	mov    -0x10(%ebp),%eax
801054de:	89 c2                	mov    %eax,%edx
801054e0:	8b 45 f4             	mov    -0xc(%ebp),%eax
801054e3:	89 54 24 04          	mov    %edx,0x4(%esp)
801054e7:	89 04 24             	mov    %eax,(%esp)
801054ea:	e8 eb fd ff ff       	call   801052da <shm_get>
801054ef:	85 c0                	test   %eax,%eax
801054f1:	75 07                	jne    801054fa <sys_shm_get+0x75>
    return 0;
801054f3:	b8 00 00 00 00       	mov    $0x0,%eax
801054f8:	eb 05                	jmp    801054ff <sys_shm_get+0x7a>
  }
  return -1;
...
80105504:	83 ec 28             	sub    $0x28,%esp
  int k;
  if(argint(0, &k) < 0)
80105507:	8d 45 f4             	lea    -0xc(%ebp),%eax
8010550a:	89 44 24 04          	mov    %eax,0x4(%esp)
8010550e:	c7 04 24 00 00 00 00 	movl   $0x0,(%esp)
80105515:	e8 12 06 00 00       	call   80105b2c <argint>
8010551a:	85 c0                	test   %eax,%eax
8010551c:	79 07                	jns    80105525 <sys_shm_close+0x24>
    return -1;
8010551e:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80105523:	eb 1b                	jmp    80105540 <sys_shm_close+0x3f>
  if (!shm_close(k)){    
80105525:	8b 45 f4             	mov    -0xc(%ebp),%eax
80105528:	89 04 24             	mov    %eax,(%esp)
8010552b:	e8 d8 fc ff ff       	call   80105208 <shm_close>
80105530:	85 c0                	test   %eax,%eax
80105532:	75 07                	jne    8010553b <sys_shm_close+0x3a>
    return 0;
80105534:	b8 00 00 00 00       	mov    $0x0,%eax
80105539:	eb 05                	jmp    80105540 <sys_shm_close+0x3f>
  }
  return -1;
...
80105549:	9c                   	pushf  
8010554a:	5b                   	pop    %ebx
8010554b:	89 5d f8             	mov    %ebx,-0x8(%ebp)
  return eflags;
...
8010556d:	8b 45 0c             	mov    0xc(%ebp),%eax
               "+m" (*addr), "=a" (result) :
80105570:	8b 4d 08             	mov    0x8(%ebp),%ecx
  asm volatile("lock; xchgl %0, %1" :
80105573:	89 c3                	mov    %eax,%ebx
80105575:	89 d8                	mov    %ebx,%eax
80105577:	f0 87 02             	lock xchg %eax,(%edx)
8010557a:	89 c3                	mov    %eax,%ebx
8010557c:	89 5d f8             	mov    %ebx,-0x8(%ebp)
  return result;
8010557f:	8b 45 f8             	mov    -0x8(%ebp),%eax
}
...
8010558e:	8b 55 0c             	mov    0xc(%ebp),%edx
80105591:	89 50 04             	mov    %edx,0x4(%eax)
  lk->locked = 0;
80105594:	8b 45 08             	mov    0x8(%ebp),%eax
80105597:	c7 00 00 00 00 00    	movl   $0x0,(%eax)
  lk->cpu = 0;
8010559d:	8b 45 08             	mov    0x8(%ebp),%eax
801055a0:	c7 40 08 00 00 00 00 	movl   $0x0,0x8(%eax)
}
801055a7:	5d                   	pop    %ebp
801055a8:	c3                   	ret    
...
801055af:	e8 47 01 00 00       	call   801056fb <pushcli>
  if(holding(lk))
801055b4:	8b 45 08             	mov    0x8(%ebp),%eax
801055b7:	89 04 24             	mov    %eax,(%esp)
801055ba:	e8 12 01 00 00       	call   801056d1 <holding>
801055bf:	85 c0                	test   %eax,%eax
801055c1:	74 0c                	je     801055cf <acquire+0x26>
    panic("acquire");
801055c3:	c7 04 24 4d 92 10 80 	movl   $0x8010924d,(%esp)
801055ca:	e8 67 af ff ff       	call   80100536 <panic>
...
801055d3:	c7 44 24 04 01 00 00 	movl   $0x1,0x4(%esp)
801055da:	00 
801055db:	89 04 24             	mov    %eax,(%esp)
801055de:	e8 80 ff ff ff       	call   80105563 <xchg>
801055e3:	85 c0                	test   %eax,%eax
801055e5:	75 e9                	jne    801055d0 <acquire+0x27>
    ;

  // Record info about lock acquisition for debugging.
  lk->cpu = cpu;
801055e7:	8b 45 08             	mov    0x8(%ebp),%eax
801055ea:	65 8b 15 00 00 00 00 	mov    %gs:0x0,%edx
801055f1:	89 50 08             	mov    %edx,0x8(%eax)
  getcallerpcs(&lk, lk->pcs);
801055f4:	8b 45 08             	mov    0x8(%ebp),%eax
801055f7:	83 c0 0c             	add    $0xc,%eax
801055fa:	89 44 24 04          	mov    %eax,0x4(%esp)
801055fe:	8d 45 08             	lea    0x8(%ebp),%eax
80105601:	89 04 24             	mov    %eax,(%esp)
80105604:	e8 51 00 00 00       	call   8010565a <getcallerpcs>
}
80105609:	c9                   	leave  
8010560a:	c3                   	ret    
...
8010560e:	83 ec 18             	sub    $0x18,%esp
  if(!holding(lk))
80105611:	8b 45 08             	mov    0x8(%ebp),%eax
80105614:	89 04 24             	mov    %eax,(%esp)
80105617:	e8 b5 00 00 00       	call   801056d1 <holding>
8010561c:	85 c0                	test   %eax,%eax
8010561e:	75 0c                	jne    8010562c <release+0x21>
    panic("release");
80105620:	c7 04 24 55 92 10 80 	movl   $0x80109255,(%esp)
80105627:	e8 0a af ff ff       	call   80100536 <panic>

  lk->pcs[0] = 0;
8010562c:	8b 45 08             	mov    0x8(%ebp),%eax
8010562f:	c7 40 0c 00 00 00 00 	movl   $0x0,0xc(%eax)
  lk->cpu = 0;
80105636:	8b 45 08             	mov    0x8(%ebp),%eax
80105639:	c7 40 08 00 00 00 00 	movl   $0x0,0x8(%eax)
...
80105643:	c7 44 24 04 00 00 00 	movl   $0x0,0x4(%esp)
8010564a:	00 
8010564b:	89 04 24             	mov    %eax,(%esp)
8010564e:	e8 10 ff ff ff       	call   80105563 <xchg>

  popcli();
80105653:	e8 e9 00 00 00       	call   80105741 <popcli>
}
80105658:	c9                   	leave  
80105659:	c3                   	ret    

8010565a <getcallerpcs>:
...
80105663:	83 e8 08             	sub    $0x8,%eax
80105666:	89 45 fc             	mov    %eax,-0x4(%ebp)
  for(i = 0; i < 10; i++){
80105669:	c7 45 f8 00 00 00 00 	movl   $0x0,-0x8(%ebp)
80105670:	eb 37                	jmp    801056a9 <getcallerpcs+0x4f>
    if(ebp == 0 || ebp < (uint*)KERNBASE || ebp == (uint*)0xffffffff)
80105672:	83 7d fc 00          	cmpl   $0x0,-0x4(%ebp)
80105676:	74 51                	je     801056c9 <getcallerpcs+0x6f>
80105678:	81 7d fc ff ff ff 7f 	cmpl   $0x7fffffff,-0x4(%ebp)
8010567f:	76 48                	jbe    801056c9 <getcallerpcs+0x6f>
80105681:	83 7d fc ff          	cmpl   $0xffffffff,-0x4(%ebp)
80105685:	74 42                	je     801056c9 <getcallerpcs+0x6f>
      break;
    pcs[i] = ebp[1];     // saved %eip
80105687:	8b 45 f8             	mov    -0x8(%ebp),%eax
8010568a:	8d 14 85 00 00 00 00 	lea    0x0(,%eax,4),%edx
80105691:	8b 45 0c             	mov    0xc(%ebp),%eax
80105694:	01 c2                	add    %eax,%edx
80105696:	8b 45 fc             	mov    -0x4(%ebp),%eax
80105699:	8b 40 04             	mov    0x4(%eax),%eax
8010569c:	89 02                	mov    %eax,(%edx)
    ebp = (uint*)ebp[0]; // saved %ebp
8010569e:	8b 45 fc             	mov    -0x4(%ebp),%eax
801056a1:	8b 00                	mov    (%eax),%eax
801056a3:	89 45 fc             	mov    %eax,-0x4(%ebp)
  for(i = 0; i < 10; i++){
801056a6:	ff 45 f8             	incl   -0x8(%ebp)
801056a9:	83 7d f8 09          	cmpl   $0x9,-0x8(%ebp)
801056ad:	7e c3                	jle    80105672 <getcallerpcs+0x18>
  }
  for(; i < 10; i++)
801056af:	eb 18                	jmp    801056c9 <getcallerpcs+0x6f>
    pcs[i] = 0;
801056b1:	8b 45 f8             	mov    -0x8(%ebp),%eax
801056b4:	8d 14 85 00 00 00 00 	lea    0x0(,%eax,4),%edx
801056bb:	8b 45 0c             	mov    0xc(%ebp),%eax
801056be:	01 d0                	add    %edx,%eax
801056c0:	c7 00 00 00 00 00    	movl   $0x0,(%eax)
  for(; i < 10; i++)
801056c6:	ff 45 f8             	incl   -0x8(%ebp)
801056c9:	83 7d f8 09          	cmpl   $0x9,-0x8(%ebp)
801056cd:	7e e2                	jle    801056b1 <getcallerpcs+0x57>
}
801056cf:	c9                   	leave  
801056d0:	c3                   	ret    
...
801056db:	74 17                	je     801056f4 <holding+0x23>
801056dd:	8b 45 08             	mov    0x8(%ebp),%eax
801056e0:	8b 50 08             	mov    0x8(%eax),%edx
801056e3:	65 a1 00 00 00 00    	mov    %gs:0x0,%eax
801056e9:	39 c2                	cmp    %eax,%edx
801056eb:	75 07                	jne    801056f4 <holding+0x23>
801056ed:	b8 01 00 00 00       	mov    $0x1,%eax
801056f2:	eb 05                	jmp    801056f9 <holding+0x28>
...
801056fe:	83 ec 10             	sub    $0x10,%esp
  ...
  eflags = readeflags();
80105701:	e8 3c fe ff ff       	call   80105542 <readeflags>
80105706:	89 45 fc             	mov    %eax,-0x4(%ebp)
  cli();
80105709:	e8 49 fe ff ff       	call   80105557 <cli>
  if(cpu->ncli++ == 0)
8010570e:	65 a1 00 00 00 00    	mov    %gs:0x0,%eax
80105714:	8b 90 ac 00 00 00    	mov    0xac(%eax),%edx
8010571a:	85 d2                	test   %edx,%edx
8010571c:	0f 94 c1             	sete   %cl
8010571f:	42                   	inc    %edx
80105720:	89 90 ac 00 00 00    	mov    %edx,0xac(%eax)
80105726:	84 c9                	test   %cl,%cl
80105728:	74 15                	je     8010573f <pushcli+0x44>
    cpu->intena = eflags & FL_IF;
8010572a:	65 a1 00 00 00 00    	mov    %gs:0x0,%eax
80105730:	8b 55 fc             	mov    -0x4(%ebp),%edx
80105733:	81 e2 00 02 00 00    	and    $0x200,%edx
80105739:	89 90 b0 00 00 00    	mov    %edx,0xb0(%eax)
}
8010573f:	c9                   	leave  
80105740:	c3                   	ret    
...
80105744:	83 ec 18             	sub    $0x18,%esp
  if(readeflags()&FL_IF)
80105747:	e8 f6 fd ff ff       	call   80105542 <readeflags>
8010574c:	25 00 02 00 00       	and    $0x200,%eax
80105751:	85 c0                	test   %eax,%eax
80105753:	74 0c                	je     80105761 <popcli+0x20>
    panic("popcli - interruptible");
80105755:	c7 04 24 5d 92 10 80 	movl   $0x8010925d,(%esp)
8010575c:	e8 d5 ad ff ff       	call   80100536 <panic>
  if(--cpu->ncli < 0)
80105761:	65 a1 00 00 00 00    	mov    %gs:0x0,%eax
80105767:	8b 90 ac 00 00 00    	mov    0xac(%eax),%edx
8010576d:	4a                   	dec    %edx
8010576e:	89 90 ac 00 00 00    	mov    %edx,0xac(%eax)
80105774:	8b 80 ac 00 00 00    	mov    0xac(%eax),%eax
8010577a:	85 c0                	test   %eax,%eax
8010577c:	79 0c                	jns    8010578a <popcli+0x49>
    panic("popcli");
8010577e:	c7 04 24 74 92 10 80 	movl   $0x80109274,(%esp)
80105785:	e8 ac ad ff ff       	call   80100536 <panic>
  if(cpu->ncli == 0 && cpu->intena)
8010578a:	65 a1 00 00 00 00    	mov    %gs:0x0,%eax
80105790:	8b 80 ac 00 00 00    	mov    0xac(%eax),%eax
80105796:	85 c0                	test   %eax,%eax
80105798:	75 15                	jne    801057af <popcli+0x6e>
8010579a:	65 a1 00 00 00 00    	mov    %gs:0x0,%eax
801057a0:	8b 80 b0 00 00 00    	mov    0xb0(%eax),%eax
801057a6:	85 c0                	test   %eax,%eax
801057a8:	74 05                	je     801057af <popcli+0x6e>
    sti();
801057aa:	e8 ae fd ff ff       	call   8010555d <sti>
}
801057af:	c9                   	leave  
801057b0:	c3                   	ret    
...
801057b6:	8b 4d 08             	mov    0x8(%ebp),%ecx
801057b9:	8b 55 10             	mov    0x10(%ebp),%edx
801057bc:	8b 45 0c             	mov    0xc(%ebp),%eax
801057bf:	89 cb                	mov    %ecx,%ebx
801057c1:	89 df                	mov    %ebx,%edi
801057c3:	89 d1                	mov    %edx,%ecx
801057c5:	fc                   	cld    
801057c6:	f3 aa                	rep stos %al,%es:(%edi)
801057c8:	89 ca                	mov    %ecx,%edx
801057ca:	89 fb                	mov    %edi,%ebx
801057cc:	89 5d 08             	mov    %ebx,0x8(%ebp)
801057cf:	89 55 10             	mov    %edx,0x10(%ebp)
}
801057d2:	5b                   	pop    %ebx
801057d3:	5f                   	pop    %edi
801057d4:	5d                   	pop    %ebp
...
801057db:	8b 4d 08             	mov    0x8(%ebp),%ecx
801057de:	8b 55 10             	mov    0x10(%ebp),%edx
801057e1:	8b 45 0c             	mov    0xc(%ebp),%eax
801057e4:	89 cb                	mov    %ecx,%ebx
801057e6:	89 df                	mov    %ebx,%edi
801057e8:	89 d1                	mov    %edx,%ecx
801057ea:	fc                   	cld    
801057eb:	f3 ab                	rep stos %eax,%es:(%edi)
801057ed:	89 ca                	mov    %ecx,%edx
801057ef:	89 fb                	mov    %edi,%ebx
801057f1:	89 5d 08             	mov    %ebx,0x8(%ebp)
801057f4:	89 55 10             	mov    %edx,0x10(%ebp)
}
801057f7:	5b                   	pop    %ebx
801057f8:	5f                   	pop    %edi
801057f9:	5d                   	pop    %ebp
...
80105809:	75 49                	jne    80105854 <memset+0x59>
8010580b:	8b 45 10             	mov    0x10(%ebp),%eax
8010580e:	83 e0 03             	and    $0x3,%eax
80105811:	85 c0                	test   %eax,%eax
80105813:	75 3f                	jne    80105854 <memset+0x59>
    c &= 0xFF;
80105815:	81 65 0c ff 00 00 00 	andl   $0xff,0xc(%ebp)
    stosl(dst, (c<<24)|(c<<16)|(c<<8)|c, n/4);
8010581c:	8b 45 10             	mov    0x10(%ebp),%eax
8010581f:	c1 e8 02             	shr    $0x2,%eax
80105822:	89 c2                	mov    %eax,%edx
80105824:	8b 45 0c             	mov    0xc(%ebp),%eax
80105827:	89 c1                	mov    %eax,%ecx
80105829:	c1 e1 18             	shl    $0x18,%ecx
8010582c:	8b 45 0c             	mov    0xc(%ebp),%eax
8010582f:	c1 e0 10             	shl    $0x10,%eax
80105832:	09 c1                	or     %eax,%ecx
80105834:	8b 45 0c             	mov    0xc(%ebp),%eax
80105837:	c1 e0 08             	shl    $0x8,%eax
8010583a:	09 c8                	or     %ecx,%eax
8010583c:	0b 45 0c             	or     0xc(%ebp),%eax
8010583f:	89 54 24 08          	mov    %edx,0x8(%esp)
80105843:	89 44 24 04          	mov    %eax,0x4(%esp)
80105847:	8b 45 08             	mov    0x8(%ebp),%eax
8010584a:	89 04 24             	mov    %eax,(%esp)
8010584d:	e8 84 ff ff ff       	call   801057d6 <stosl>
80105852:	eb 19                	jmp    8010586d <memset+0x72>
  } else
    stosb(dst, c, n);
80105854:	8b 45 10             	mov    0x10(%ebp),%eax
...
80105868:	e8 44 ff ff ff       	call   801057b1 <stosb>
  return dst;
...
80105881:	89 45 f8             	mov    %eax,-0x8(%ebp)
  while(n-- > 0){
80105884:	eb 2c                	jmp    801058b2 <memcmp+0x40>
    if(*s1 != *s2)
80105886:	8b 45 fc             	mov    -0x4(%ebp),%eax
80105889:	8a 10                	mov    (%eax),%dl
8010588b:	8b 45 f8             	mov    -0x8(%ebp),%eax
8010588e:	8a 00                	mov    (%eax),%al
80105890:	38 c2                	cmp    %al,%dl
80105892:	74 18                	je     801058ac <memcmp+0x3a>
      return *s1 - *s2;
80105894:	8b 45 fc             	mov    -0x4(%ebp),%eax
80105897:	8a 00                	mov    (%eax),%al
80105899:	0f b6 d0             	movzbl %al,%edx
8010589c:	8b 45 f8             	mov    -0x8(%ebp),%eax
8010589f:	8a 00                	mov    (%eax),%al
801058a1:	0f b6 c0             	movzbl %al,%eax
801058a4:	89 d1                	mov    %edx,%ecx
801058a6:	29 c1                	sub    %eax,%ecx
801058a8:	89 c8                	mov    %ecx,%eax
801058aa:	eb 19                	jmp    801058c5 <memcmp+0x53>
    s1++, s2++;
801058ac:	ff 45 fc             	incl   -0x4(%ebp)
801058af:	ff 45 f8             	incl   -0x8(%ebp)
  while(n-- > 0){
801058b2:	83 7d 10 00          	cmpl   $0x0,0x10(%ebp)
801058b6:	0f 95 c0             	setne  %al
801058b9:	ff 4d 10             	decl   0x10(%ebp)
801058bc:	84 c0                	test   %al,%al
801058be:	75 c6                	jne    80105886 <memcmp+0x14>
  }

  return 0;
801058c0:	b8 00 00 00 00       	mov    $0x0,%eax
}
801058c5:	c9                   	leave  
801058c6:	c3                   	ret    
...
801058d0:	89 45 fc             	mov    %eax,-0x4(%ebp)
  d = dst;
801058d3:	8b 45 08             	mov    0x8(%ebp),%eax
801058d6:	89 45 f8             	mov    %eax,-0x8(%ebp)
  if(s < d && s + n > d){
801058d9:	8b 45 fc             	mov    -0x4(%ebp),%eax
801058dc:	3b 45 f8             	cmp    -0x8(%ebp),%eax
801058df:	73 4d                	jae    8010592e <memmove+0x67>
801058e1:	8b 45 10             	mov    0x10(%ebp),%eax
801058e4:	8b 55 fc             	mov    -0x4(%ebp),%edx
801058e7:	01 d0                	add    %edx,%eax
801058e9:	3b 45 f8             	cmp    -0x8(%ebp),%eax
801058ec:	76 40                	jbe    8010592e <memmove+0x67>
    s += n;
801058ee:	8b 45 10             	mov    0x10(%ebp),%eax
801058f1:	01 45 fc             	add    %eax,-0x4(%ebp)
    d += n;
801058f4:	8b 45 10             	mov    0x10(%ebp),%eax
801058f7:	01 45 f8             	add    %eax,-0x8(%ebp)
    while(n-- > 0)
801058fa:	eb 10                	jmp    8010590c <memmove+0x45>
      *--d = *--s;
801058fc:	ff 4d f8             	decl   -0x8(%ebp)
801058ff:	ff 4d fc             	decl   -0x4(%ebp)
80105902:	8b 45 fc             	mov    -0x4(%ebp),%eax
80105905:	8a 10                	mov    (%eax),%dl
80105907:	8b 45 f8             	mov    -0x8(%ebp),%eax
8010590a:	88 10                	mov    %dl,(%eax)
    while(n-- > 0)
8010590c:	83 7d 10 00          	cmpl   $0x0,0x10(%ebp)
80105910:	0f 95 c0             	setne  %al
80105913:	ff 4d 10             	decl   0x10(%ebp)
80105916:	84 c0                	test   %al,%al
80105918:	75 e2                	jne    801058fc <memmove+0x35>
  if(s < d && s + n > d){
8010591a:	eb 21                	jmp    8010593d <memmove+0x76>
  } else
    while(n-- > 0)
      *d++ = *s++;
8010591c:	8b 45 fc             	mov    -0x4(%ebp),%eax
8010591f:	8a 10                	mov    (%eax),%dl
80105921:	8b 45 f8             	mov    -0x8(%ebp),%eax
80105924:	88 10                	mov    %dl,(%eax)
80105926:	ff 45 f8             	incl   -0x8(%ebp)
80105929:	ff 45 fc             	incl   -0x4(%ebp)
8010592c:	eb 01                	jmp    8010592f <memmove+0x68>
    while(n-- > 0)
8010592e:	90                   	nop
8010592f:	83 7d 10 00          	cmpl   $0x0,0x10(%ebp)
80105933:	0f 95 c0             	setne  %al
80105936:	ff 4d 10             	decl   0x10(%ebp)
80105939:	84 c0                	test   %al,%al
8010593b:	75 df                	jne    8010591c <memmove+0x55>
...
80105948:	8b 45 10             	mov    0x10(%ebp),%eax
...
8010595c:	e8 66 ff ff ff       	call   801058c7 <memmove>
}
80105961:	c9                   	leave  
80105962:	c3                   	ret    
...
80105964:	89 e5                	mov    %esp,%ebp
  while(n > 0 && *p && *p == *q)
80105966:	eb 09                	jmp    80105971 <strncmp+0xe>
    n--, p++, q++;
80105968:	ff 4d 10             	decl   0x10(%ebp)
8010596b:	ff 45 08             	incl   0x8(%ebp)
8010596e:	ff 45 0c             	incl   0xc(%ebp)
  while(n > 0 && *p && *p == *q)
80105971:	83 7d 10 00          	cmpl   $0x0,0x10(%ebp)
80105975:	74 17                	je     8010598e <strncmp+0x2b>
80105977:	8b 45 08             	mov    0x8(%ebp),%eax
8010597a:	8a 00                	mov    (%eax),%al
8010597c:	84 c0                	test   %al,%al
8010597e:	74 0e                	je     8010598e <strncmp+0x2b>
80105980:	8b 45 08             	mov    0x8(%ebp),%eax
80105983:	8a 10                	mov    (%eax),%dl
80105985:	8b 45 0c             	mov    0xc(%ebp),%eax
80105988:	8a 00                	mov    (%eax),%al
8010598a:	38 c2                	cmp    %al,%dl
8010598c:	74 da                	je     80105968 <strncmp+0x5>
  if(n == 0)
8010598e:	83 7d 10 00          	cmpl   $0x0,0x10(%ebp)
80105992:	75 07                	jne    8010599b <strncmp+0x38>
    return 0;
80105994:	b8 00 00 00 00       	mov    $0x0,%eax
80105999:	eb 16                	jmp    801059b1 <strncmp+0x4e>
  return (uchar)*p - (uchar)*q;
8010599b:	8b 45 08             	mov    0x8(%ebp),%eax
8010599e:	8a 00                	mov    (%eax),%al
801059a0:	0f b6 d0             	movzbl %al,%edx
801059a3:	8b 45 0c             	mov    0xc(%ebp),%eax
801059a6:	8a 00                	mov    (%eax),%al
801059a8:	0f b6 c0             	movzbl %al,%eax
801059ab:	89 d1                	mov    %edx,%ecx
801059ad:	29 c1                	sub    %eax,%ecx
...
801059b6:	83 ec 10             	sub    $0x10,%esp
  char *os;
...
801059c4:	0f 9f c0             	setg   %al
801059c7:	ff 4d 10             	decl   0x10(%ebp)
801059ca:	84 c0                	test   %al,%al
801059cc:	74 2b                	je     801059f9 <strncpy+0x46>
801059ce:	8b 45 0c             	mov    0xc(%ebp),%eax
801059d1:	8a 10                	mov    (%eax),%dl
801059d3:	8b 45 08             	mov    0x8(%ebp),%eax
801059d6:	88 10                	mov    %dl,(%eax)
801059d8:	8b 45 08             	mov    0x8(%ebp),%eax
801059db:	8a 00                	mov    (%eax),%al
801059dd:	84 c0                	test   %al,%al
801059df:	0f 95 c0             	setne  %al
801059e2:	ff 45 08             	incl   0x8(%ebp)
801059e5:	ff 45 0c             	incl   0xc(%ebp)
801059e8:	84 c0                	test   %al,%al
801059ea:	75 d4                	jne    801059c0 <strncpy+0xd>
    ;
  while(n-- > 0)
801059ec:	eb 0b                	jmp    801059f9 <strncpy+0x46>
    *s++ = 0;
801059ee:	8b 45 08             	mov    0x8(%ebp),%eax
801059f1:	c6 00 00             	movb   $0x0,(%eax)
801059f4:	ff 45 08             	incl   0x8(%ebp)
801059f7:	eb 01                	jmp    801059fa <strncpy+0x47>
  while(n-- > 0)
801059f9:	90                   	nop
801059fa:	83 7d 10 00          	cmpl   $0x0,0x10(%ebp)
801059fe:	0f 9f c0             	setg   %al
80105a01:	ff 4d 10             	decl   0x10(%ebp)
80105a04:	84 c0                	test   %al,%al
80105a06:	75 e6                	jne    801059ee <strncpy+0x3b>
  return os;
...
80105a16:	89 45 fc             	mov    %eax,-0x4(%ebp)
  if(n <= 0)
80105a19:	83 7d 10 00          	cmpl   $0x0,0x10(%ebp)
80105a1d:	7f 05                	jg     80105a24 <safestrcpy+0x17>
    return os;
80105a1f:	8b 45 fc             	mov    -0x4(%ebp),%eax
80105a22:	eb 30                	jmp    80105a54 <safestrcpy+0x47>
  while(--n > 0 && (*s++ = *t++) != 0)
80105a24:	ff 4d 10             	decl   0x10(%ebp)
80105a27:	83 7d 10 00          	cmpl   $0x0,0x10(%ebp)
80105a2b:	7e 1e                	jle    80105a4b <safestrcpy+0x3e>
80105a2d:	8b 45 0c             	mov    0xc(%ebp),%eax
80105a30:	8a 10                	mov    (%eax),%dl
80105a32:	8b 45 08             	mov    0x8(%ebp),%eax
80105a35:	88 10                	mov    %dl,(%eax)
80105a37:	8b 45 08             	mov    0x8(%ebp),%eax
80105a3a:	8a 00                	mov    (%eax),%al
80105a3c:	84 c0                	test   %al,%al
80105a3e:	0f 95 c0             	setne  %al
80105a41:	ff 45 08             	incl   0x8(%ebp)
80105a44:	ff 45 0c             	incl   0xc(%ebp)
80105a47:	84 c0                	test   %al,%al
80105a49:	75 d9                	jne    80105a24 <safestrcpy+0x17>
    ;
  *s = 0;
80105a4b:	8b 45 08             	mov    0x8(%ebp),%eax
80105a4e:	c6 00 00             	movb   $0x0,(%eax)
  return os;
...
80105a59:	83 ec 10             	sub    $0x10,%esp
  ...
  for(n = 0; s[n]; n++)
80105a5c:	c7 45 fc 00 00 00 00 	movl   $0x0,-0x4(%ebp)
80105a63:	eb 03                	jmp    80105a68 <strlen+0x12>
80105a65:	ff 45 fc             	incl   -0x4(%ebp)
80105a68:	8b 55 fc             	mov    -0x4(%ebp),%edx
80105a6b:	8b 45 08             	mov    0x8(%ebp),%eax
80105a6e:	01 d0                	add    %edx,%eax
80105a70:	8a 00                	mov    (%eax),%al
80105a72:	84 c0                	test   %al,%al
80105a74:	75 ef                	jne    80105a65 <strlen+0xf>
    ;
  return n;
80105a76:	8b 45 fc             	mov    -0x4(%ebp),%eax
}
80105a79:	c9                   	leave  
80105a7a:	c3                   	ret    

80105a7b <swtch>:
80105a7b:	8b 44 24 04          	mov    0x4(%esp),%eax
80105a7f:	8b 54 24 08          	mov    0x8(%esp),%edx
80105a83:	55                   	push   %ebp
80105a84:	53                   	push   %ebx
80105a85:	56                   	push   %esi
80105a86:	57                   	push   %edi
80105a87:	89 20                	mov    %esp,(%eax)
80105a89:	89 d4                	mov    %edx,%esp
80105a8b:	5f                   	pop    %edi
80105a8c:	5e                   	pop    %esi
80105a8d:	5b                   	pop    %ebx
80105a8e:	5d                   	pop    %ebp
...
80105a9e:	76 12                	jbe    80105ab2 <fetchint+0x22>
...
80105ab0:	76 07                	jbe    80105ab9 <fetchint+0x29>
    return -1;
80105ab2:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80105ab7:	eb 0f                	jmp    80105ac8 <fetchint+0x38>
  *ip = *(int*)(addr);
...
80105acd:	83 ec 10             	sub    $0x10,%esp
  char *s, *ep;

  if(addr >= proc->sz)
80105ad0:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
80105ad6:	8b 00                	mov    (%eax),%eax
80105ad8:	3b 45 08             	cmp    0x8(%ebp),%eax
80105adb:	77 07                	ja     80105ae4 <fetchstr+0x1a>
    return -1;
80105add:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80105ae2:	eb 46                	jmp    80105b2a <fetchstr+0x60>
  *pp = (char*)addr;
80105ae4:	8b 55 08             	mov    0x8(%ebp),%edx
80105ae7:	8b 45 0c             	mov    0xc(%ebp),%eax
80105aea:	89 10                	mov    %edx,(%eax)
  ep = (char*)proc->sz;
80105aec:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
80105af2:	8b 00                	mov    (%eax),%eax
...
80105aff:	eb 1c                	jmp    80105b1d <fetchstr+0x53>
    if(*s == 0)
80105b01:	8b 45 fc             	mov    -0x4(%ebp),%eax
80105b04:	8a 00                	mov    (%eax),%al
80105b06:	84 c0                	test   %al,%al
80105b08:	75 10                	jne    80105b1a <fetchstr+0x50>
      return s - *pp;
80105b0a:	8b 55 fc             	mov    -0x4(%ebp),%edx
80105b0d:	8b 45 0c             	mov    0xc(%ebp),%eax
80105b10:	8b 00                	mov    (%eax),%eax
80105b12:	89 d1                	mov    %edx,%ecx
80105b14:	29 c1                	sub    %eax,%ecx
80105b16:	89 c8                	mov    %ecx,%eax
80105b18:	eb 10                	jmp    80105b2a <fetchstr+0x60>
  for(s = *pp; s < ep; s++)
80105b1a:	ff 45 fc             	incl   -0x4(%ebp)
80105b1d:	8b 45 fc             	mov    -0x4(%ebp),%eax
80105b20:	3b 45 f8             	cmp    -0x8(%ebp),%eax
80105b23:	72 dc                	jb     80105b01 <fetchstr+0x37>
  return -1;
...
80105b6d:	e8 ba ff ff ff       	call   80105b2c <argint>
...
80105c0d:	7e 30                	jle    80105c3f <syscall+0x4c>
80105c0f:	8b 45 f4             	mov    -0xc(%ebp),%eax
80105c12:	83 f8 20             	cmp    $0x20,%eax
80105c15:	77 28                	ja     80105c3f <syscall+0x4c>
80105c17:	8b 45 f4             	mov    -0xc(%ebp),%eax
80105c1a:	8b 04 85 40 c0 10 80 	mov    -0x7fef3fc0(,%eax,4),%eax
80105c21:	85 c0                	test   %eax,%eax
80105c23:	74 1a                	je     80105c3f <syscall+0x4c>
...
80105c3d:	eb 3d                	jmp    80105c7c <syscall+0x89>
  } else {
...
80105c60:	c7 04 24 7b 92 10 80 	movl   $0x8010927b,(%esp)
...
80105c95:	e8 92 fe ff ff       	call   80105b2c <argint>
80105c9a:	85 c0                	test   %eax,%eax
80105c9c:	79 07                	jns    80105ca5 <argfd+0x23>
    return -1;
80105c9e:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80105ca3:	eb 50                	jmp    80105cf5 <argfd+0x73>
  if(fd < 0 || fd >= NOFILE || (f=proc->ofile[fd]) == 0)
80105ca5:	8b 45 f0             	mov    -0x10(%ebp),%eax
80105ca8:	85 c0                	test   %eax,%eax
80105caa:	78 21                	js     80105ccd <argfd+0x4b>
80105cac:	8b 45 f0             	mov    -0x10(%ebp),%eax
80105caf:	83 f8 0f             	cmp    $0xf,%eax
80105cb2:	7f 19                	jg     80105ccd <argfd+0x4b>
80105cb4:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
80105cba:	8b 55 f0             	mov    -0x10(%ebp),%edx
80105cbd:	83 c2 08             	add    $0x8,%edx
80105cc0:	8b 44 90 08          	mov    0x8(%eax,%edx,4),%eax
80105cc4:	89 45 f4             	mov    %eax,-0xc(%ebp)
80105cc7:	83 7d f4 00          	cmpl   $0x0,-0xc(%ebp)
80105ccb:	75 07                	jne    80105cd4 <argfd+0x52>
    return -1;
80105ccd:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80105cd2:	eb 21                	jmp    80105cf5 <argfd+0x73>
  if(pfd)
80105cd4:	83 7d 0c 00          	cmpl   $0x0,0xc(%ebp)
80105cd8:	74 08                	je     80105ce2 <argfd+0x60>
    *pfd = fd;
80105cda:	8b 55 f0             	mov    -0x10(%ebp),%edx
80105cdd:	8b 45 0c             	mov    0xc(%ebp),%eax
80105ce0:	89 10                	mov    %edx,(%eax)
  if(pf)
80105ce2:	83 7d 10 00          	cmpl   $0x0,0x10(%ebp)
80105ce6:	74 08                	je     80105cf0 <argfd+0x6e>
    *pf = f;
80105ce8:	8b 45 10             	mov    0x10(%ebp),%eax
80105ceb:	8b 55 f4             	mov    -0xc(%ebp),%edx
80105cee:	89 10                	mov    %edx,(%eax)
  return 0;
...
80105cfa:	83 ec 10             	sub    $0x10,%esp
  ...
  for(fd = 0; fd < NOFILE; fd++){
80105cfd:	c7 45 fc 00 00 00 00 	movl   $0x0,-0x4(%ebp)
80105d04:	eb 2f                	jmp    80105d35 <fdalloc+0x3e>
    if(proc->ofile[fd] == 0){
80105d06:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
80105d0c:	8b 55 fc             	mov    -0x4(%ebp),%edx
80105d0f:	83 c2 08             	add    $0x8,%edx
80105d12:	8b 44 90 08          	mov    0x8(%eax,%edx,4),%eax
80105d16:	85 c0                	test   %eax,%eax
80105d18:	75 18                	jne    80105d32 <fdalloc+0x3b>
      proc->ofile[fd] = f;
80105d1a:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
80105d20:	8b 55 fc             	mov    -0x4(%ebp),%edx
80105d23:	8d 4a 08             	lea    0x8(%edx),%ecx
80105d26:	8b 55 08             	mov    0x8(%ebp),%edx
80105d29:	89 54 88 08          	mov    %edx,0x8(%eax,%ecx,4)
      return fd;
80105d2d:	8b 45 fc             	mov    -0x4(%ebp),%eax
80105d30:	eb 0e                	jmp    80105d40 <fdalloc+0x49>
  for(fd = 0; fd < NOFILE; fd++){
80105d32:	ff 45 fc             	incl   -0x4(%ebp)
80105d35:	83 7d fc 0f          	cmpl   $0xf,-0x4(%ebp)
80105d39:	7e cb                	jle    80105d06 <fdalloc+0xf>
    }
  }
  return -1;
...
80105d4f:	c7 44 24 04 00 00 00 	movl   $0x0,0x4(%esp)
80105d56:	00 
80105d57:	c7 04 24 00 00 00 00 	movl   $0x0,(%esp)
80105d5e:	e8 1f ff ff ff       	call   80105c82 <argfd>
80105d63:	85 c0                	test   %eax,%eax
80105d65:	79 07                	jns    80105d6e <sys_dup+0x2c>
    return -1;
80105d67:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80105d6c:	eb 29                	jmp    80105d97 <sys_dup+0x55>
  if((fd=fdalloc(f)) < 0)
80105d6e:	8b 45 f0             	mov    -0x10(%ebp),%eax
80105d71:	89 04 24             	mov    %eax,(%esp)
80105d74:	e8 7e ff ff ff       	call   80105cf7 <fdalloc>
80105d79:	89 45 f4             	mov    %eax,-0xc(%ebp)
80105d7c:	83 7d f4 00          	cmpl   $0x0,-0xc(%ebp)
80105d80:	79 07                	jns    80105d89 <sys_dup+0x47>
    return -1;
80105d82:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80105d87:	eb 0e                	jmp    80105d97 <sys_dup+0x55>
  filedup(f);
80105d89:	8b 45 f0             	mov    -0x10(%ebp),%eax
80105d8c:	89 04 24             	mov    %eax,(%esp)
80105d8f:	e8 bf b1 ff ff       	call   80100f53 <filedup>
  return fd;
...
80105d9c:	83 ec 28             	sub    $0x28,%esp
  struct file *f;
  int n;
  char *p;

  if(argfd(0, 0, &f) < 0 || argint(2, &n) < 0 || argptr(1, &p, n) < 0)
80105d9f:	8d 45 f4             	lea    -0xc(%ebp),%eax
80105da2:	89 44 24 08          	mov    %eax,0x8(%esp)
80105da6:	c7 44 24 04 00 00 00 	movl   $0x0,0x4(%esp)
80105dad:	00 
80105dae:	c7 04 24 00 00 00 00 	movl   $0x0,(%esp)
80105db5:	e8 c8 fe ff ff       	call   80105c82 <argfd>
80105dba:	85 c0                	test   %eax,%eax
80105dbc:	78 35                	js     80105df3 <sys_read+0x5a>
80105dbe:	8d 45 f0             	lea    -0x10(%ebp),%eax
80105dc1:	89 44 24 04          	mov    %eax,0x4(%esp)
80105dc5:	c7 04 24 02 00 00 00 	movl   $0x2,(%esp)
80105dcc:	e8 5b fd ff ff       	call   80105b2c <argint>
80105dd1:	85 c0                	test   %eax,%eax
80105dd3:	78 1e                	js     80105df3 <sys_read+0x5a>
...
80105dea:	e8 6b fd ff ff       	call   80105b5a <argptr>
80105def:	85 c0                	test   %eax,%eax
80105df1:	79 07                	jns    80105dfa <sys_read+0x61>
    return -1;
80105df3:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80105df8:	eb 19                	jmp    80105e13 <sys_read+0x7a>
  return fileread(f, p, n);
80105dfa:	8b 4d f0             	mov    -0x10(%ebp),%ecx
80105dfd:	8b 55 ec             	mov    -0x14(%ebp),%edx
80105e00:	8b 45 f4             	mov    -0xc(%ebp),%eax
80105e03:	89 4c 24 08          	mov    %ecx,0x8(%esp)
80105e07:	89 54 24 04          	mov    %edx,0x4(%esp)
80105e0b:	89 04 24             	mov    %eax,(%esp)
80105e0e:	e8 a1 b2 ff ff       	call   801010b4 <fileread>
}
80105e13:	c9                   	leave  
80105e14:	c3                   	ret    
...
80105e22:	c7 44 24 04 00 00 00 	movl   $0x0,0x4(%esp)
80105e29:	00 
80105e2a:	c7 04 24 00 00 00 00 	movl   $0x0,(%esp)
80105e31:	e8 4c fe ff ff       	call   80105c82 <argfd>
80105e36:	85 c0                	test   %eax,%eax
80105e38:	78 35                	js     80105e6f <sys_write+0x5a>
80105e3a:	8d 45 f0             	lea    -0x10(%ebp),%eax
80105e3d:	89 44 24 04          	mov    %eax,0x4(%esp)
80105e41:	c7 04 24 02 00 00 00 	movl   $0x2,(%esp)
80105e48:	e8 df fc ff ff       	call   80105b2c <argint>
80105e4d:	85 c0                	test   %eax,%eax
80105e4f:	78 1e                	js     80105e6f <sys_write+0x5a>
80105e51:	8b 45 f0             	mov    -0x10(%ebp),%eax
80105e54:	89 44 24 08          	mov    %eax,0x8(%esp)
80105e58:	8d 45 ec             	lea    -0x14(%ebp),%eax
80105e5b:	89 44 24 04          	mov    %eax,0x4(%esp)
80105e5f:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
80105e66:	e8 ef fc ff ff       	call   80105b5a <argptr>
80105e6b:	85 c0                	test   %eax,%eax
80105e6d:	79 07                	jns    80105e76 <sys_write+0x61>
    return -1;
80105e6f:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80105e74:	eb 19                	jmp    80105e8f <sys_write+0x7a>
  return filewrite(f, p, n);
80105e76:	8b 4d f0             	mov    -0x10(%ebp),%ecx
80105e79:	8b 55 ec             	mov    -0x14(%ebp),%edx
80105e7c:	8b 45 f4             	mov    -0xc(%ebp),%eax
80105e7f:	89 4c 24 08          	mov    %ecx,0x8(%esp)
80105e83:	89 54 24 04          	mov    %edx,0x4(%esp)
80105e87:	89 04 24             	mov    %eax,(%esp)
80105e8a:	e8 e0 b2 ff ff       	call   8010116f <filewrite>
}
80105e8f:	c9                   	leave  
80105e90:	c3                   	ret    
...
80105e9e:	8d 45 f4             	lea    -0xc(%ebp),%eax
80105ea1:	89 44 24 04          	mov    %eax,0x4(%esp)
80105ea5:	c7 04 24 00 00 00 00 	movl   $0x0,(%esp)
80105eac:	e8 d1 fd ff ff       	call   80105c82 <argfd>
  if (f->type == FD_INODE) {
80105eb1:	8b 45 f0             	mov    -0x10(%ebp),%eax
80105eb4:	8b 00                	mov    (%eax),%eax
80105eb6:	83 f8 02             	cmp    $0x2,%eax
80105eb9:	75 20                	jne    80105edb <sys_isatty+0x4a>
...
80105ebe:	8b 40 10             	mov    0x10(%eax),%eax
80105ec1:	85 c0                	test   %eax,%eax
80105ec3:	74 16                	je     80105edb <sys_isatty+0x4a>
80105ec5:	8b 45 f0             	mov    -0x10(%ebp),%eax
80105ec8:	8b 40 10             	mov    0x10(%eax),%eax
80105ecb:	8b 40 10             	mov    0x10(%eax),%eax
80105ece:	66 83 f8 03          	cmp    $0x3,%ax
80105ed2:	75 07                	jne    80105edb <sys_isatty+0x4a>
      return 1;
80105ed4:	b8 01 00 00 00       	mov    $0x1,%eax
80105ed9:	eb 05                	jmp    80105ee0 <sys_isatty+0x4f>
  }
  return 0;
...
80105ee5:	83 ec 48             	sub    $0x48,%esp
	int zerosize, i;
	char *zeroed, *z;
	...
	argfd(0, &fd, &f);
80105ee8:	8d 45 d4             	lea    -0x2c(%ebp),%eax
80105eeb:	89 44 24 08          	mov    %eax,0x8(%esp)
80105eef:	8d 45 e0             	lea    -0x20(%ebp),%eax
80105ef2:	89 44 24 04          	mov    %eax,0x4(%esp)
80105ef6:	c7 04 24 00 00 00 00 	movl   $0x0,(%esp)
80105efd:	e8 80 fd ff ff       	call   80105c82 <argfd>
	argint(1, &offset);
80105f02:	8d 45 dc             	lea    -0x24(%ebp),%eax
80105f05:	89 44 24 04          	mov    %eax,0x4(%esp)
80105f09:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
80105f10:	e8 17 fc ff ff       	call   80105b2c <argint>
	argint(2, &base);
80105f15:	8d 45 d8             	lea    -0x28(%ebp),%eax
80105f18:	89 44 24 04          	mov    %eax,0x4(%esp)
80105f1c:	c7 04 24 02 00 00 00 	movl   $0x2,(%esp)
80105f23:	e8 04 fc ff ff       	call   80105b2c <argint>

	if( base == SEEK_SET) {
80105f28:	8b 45 d8             	mov    -0x28(%ebp),%eax
80105f2b:	85 c0                	test   %eax,%eax
80105f2d:	75 06                	jne    80105f35 <sys_lseek+0x53>
		newoff = offset;
80105f2f:	8b 45 dc             	mov    -0x24(%ebp),%eax
80105f32:	89 45 f4             	mov    %eax,-0xc(%ebp)
	}

	if (base == SEEK_CUR)
80105f35:	8b 45 d8             	mov    -0x28(%ebp),%eax
80105f38:	83 f8 01             	cmp    $0x1,%eax
80105f3b:	75 0e                	jne    80105f4b <sys_lseek+0x69>
		newoff = f->off + offset;
80105f3d:	8b 45 d4             	mov    -0x2c(%ebp),%eax
80105f40:	8b 50 14             	mov    0x14(%eax),%edx
80105f43:	8b 45 dc             	mov    -0x24(%ebp),%eax
80105f46:	01 d0                	add    %edx,%eax
80105f48:	89 45 f4             	mov    %eax,-0xc(%ebp)

	if (base == SEEK_END)
80105f4b:	8b 45 d8             	mov    -0x28(%ebp),%eax
80105f4e:	83 f8 02             	cmp    $0x2,%eax
80105f51:	75 11                	jne    80105f64 <sys_lseek+0x82>
		newoff = f->ip->size + offset;
80105f53:	8b 45 d4             	mov    -0x2c(%ebp),%eax
80105f56:	8b 40 10             	mov    0x10(%eax),%eax
80105f59:	8b 50 18             	mov    0x18(%eax),%edx
80105f5c:	8b 45 dc             	mov    -0x24(%ebp),%eax
80105f5f:	01 d0                	add    %edx,%eax
80105f61:	89 45 f4             	mov    %eax,-0xc(%ebp)
	if (newoff < f->ip->size)
80105f64:	8b 55 f4             	mov    -0xc(%ebp),%edx
80105f67:	8b 45 d4             	mov    -0x2c(%ebp),%eax
80105f6a:	8b 40 10             	mov    0x10(%eax),%eax
80105f6d:	8b 40 18             	mov    0x18(%eax),%eax
80105f70:	39 c2                	cmp    %eax,%edx
80105f72:	73 0a                	jae    80105f7e <sys_lseek+0x9c>
		return -1;
80105f74:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80105f79:	e9 92 00 00 00       	jmp    80106010 <sys_lseek+0x12e>

	if (newoff > f->ip->size){
80105f7e:	8b 55 f4             	mov    -0xc(%ebp),%edx
80105f81:	8b 45 d4             	mov    -0x2c(%ebp),%eax
80105f84:	8b 40 10             	mov    0x10(%eax),%eax
80105f87:	8b 40 18             	mov    0x18(%eax),%eax
80105f8a:	39 c2                	cmp    %eax,%edx
80105f8c:	76 74                	jbe    80106002 <sys_lseek+0x120>
		zerosize = newoff - f->ip->size;
80105f8e:	8b 55 f4             	mov    -0xc(%ebp),%edx
80105f91:	8b 45 d4             	mov    -0x2c(%ebp),%eax
80105f94:	8b 40 10             	mov    0x10(%eax),%eax
80105f97:	8b 40 18             	mov    0x18(%eax),%eax
80105f9a:	89 d1                	mov    %edx,%ecx
80105f9c:	29 c1                	sub    %eax,%ecx
80105f9e:	89 c8                	mov    %ecx,%eax
80105fa0:	89 45 f0             	mov    %eax,-0x10(%ebp)
		zeroed = kalloc();
80105fa3:	e8 16 cb ff ff       	call   80102abe <kalloc>
80105fa8:	89 45 e4             	mov    %eax,-0x1c(%ebp)
		z = zeroed;
80105fab:	8b 45 e4             	mov    -0x1c(%ebp),%eax
80105fae:	89 45 e8             	mov    %eax,-0x18(%ebp)
		for (i = 0; i < 4096; i++)
80105fb1:	c7 45 ec 00 00 00 00 	movl   $0x0,-0x14(%ebp)
80105fb8:	eb 0c                	jmp    80105fc6 <sys_lseek+0xe4>
			*z++ = 0;
80105fba:	8b 45 e8             	mov    -0x18(%ebp),%eax
80105fbd:	c6 00 00             	movb   $0x0,(%eax)
80105fc0:	ff 45 e8             	incl   -0x18(%ebp)
		for (i = 0; i < 4096; i++)
80105fc3:	ff 45 ec             	incl   -0x14(%ebp)
80105fc6:	81 7d ec ff 0f 00 00 	cmpl   $0xfff,-0x14(%ebp)
80105fcd:	7e eb                	jle    80105fba <sys_lseek+0xd8>
		while (zerosize > 0){
80105fcf:	eb 20                	jmp    80105ff1 <sys_lseek+0x10f>
			filewrite(f, zeroed, zerosize);
80105fd1:	8b 45 d4             	mov    -0x2c(%ebp),%eax
80105fd4:	8b 55 f0             	mov    -0x10(%ebp),%edx
80105fd7:	89 54 24 08          	mov    %edx,0x8(%esp)
80105fdb:	8b 55 e4             	mov    -0x1c(%ebp),%edx
80105fde:	89 54 24 04          	mov    %edx,0x4(%esp)
80105fe2:	89 04 24             	mov    %eax,(%esp)
80105fe5:	e8 85 b1 ff ff       	call   8010116f <filewrite>
			zerosize -= 4096;
80105fea:	81 6d f0 00 10 00 00 	subl   $0x1000,-0x10(%ebp)
		while (zerosize > 0){
80105ff1:	83 7d f0 00          	cmpl   $0x0,-0x10(%ebp)
80105ff5:	7f da                	jg     80105fd1 <sys_lseek+0xef>
		}
		kfree(zeroed);
80105ff7:	8b 45 e4             	mov    -0x1c(%ebp),%eax
80105ffa:	89 04 24             	mov    %eax,(%esp)
80105ffd:	e8 23 ca ff ff       	call   80102a25 <kfree>
	}

	f->off = newoff;
80106002:	8b 45 d4             	mov    -0x2c(%ebp),%eax
80106005:	8b 55 f4             	mov    -0xc(%ebp),%edx
80106008:	89 50 14             	mov    %edx,0x14(%eax)
	return 0;
...
80106015:	83 ec 28             	sub    $0x28,%esp
  ...
  if(argfd(0, &fd, &f) < 0)
80106018:	8d 45 f0             	lea    -0x10(%ebp),%eax
...
8010602d:	e8 50 fc ff ff       	call   80105c82 <argfd>
80106032:	85 c0                	test   %eax,%eax
80106034:	79 07                	jns    8010603d <sys_close+0x2b>
    return -1;
80106036:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
8010603b:	eb 24                	jmp    80106061 <sys_close+0x4f>
  proc->ofile[fd] = 0;
8010603d:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
80106043:	8b 55 f4             	mov    -0xc(%ebp),%edx
80106046:	83 c2 08             	add    $0x8,%edx
80106049:	c7 44 90 08 00 00 00 	movl   $0x0,0x8(%eax,%edx,4)
80106050:	00 
  fileclose(f);
80106051:	8b 45 f0             	mov    -0x10(%ebp),%eax
80106054:	89 04 24             	mov    %eax,(%esp)
80106057:	e8 3f af ff ff       	call   80100f9b <fileclose>
  return 0;
...
80106066:	83 ec 28             	sub    $0x28,%esp
  struct file *f;
  struct stat *st;
...
80106070:	c7 44 24 04 00 00 00 	movl   $0x0,0x4(%esp)
80106077:	00 
80106078:	c7 04 24 00 00 00 00 	movl   $0x0,(%esp)
8010607f:	e8 fe fb ff ff       	call   80105c82 <argfd>
80106084:	85 c0                	test   %eax,%eax
80106086:	78 1f                	js     801060a7 <sys_fstat+0x44>
80106088:	c7 44 24 08 14 00 00 	movl   $0x14,0x8(%esp)
8010608f:	00 
80106090:	8d 45 f0             	lea    -0x10(%ebp),%eax
80106093:	89 44 24 04          	mov    %eax,0x4(%esp)
80106097:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
8010609e:	e8 b7 fa ff ff       	call   80105b5a <argptr>
801060a3:	85 c0                	test   %eax,%eax
801060a5:	79 07                	jns    801060ae <sys_fstat+0x4b>
    return -1;
801060a7:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
801060ac:	eb 12                	jmp    801060c0 <sys_fstat+0x5d>
...
801060bb:	e8 a5 af ff ff       	call   80101065 <filestat>
}
801060c0:	c9                   	leave  
801060c1:	c3                   	ret    
...
801060c5:	83 ec 38             	sub    $0x38,%esp
  char name[DIRSIZ], *new, *old;
  struct inode *dp, *ip;

  if(argstr(0, &old) < 0 || argstr(1, &new) < 0)
801060c8:	8d 45 d8             	lea    -0x28(%ebp),%eax
801060cb:	89 44 24 04          	mov    %eax,0x4(%esp)
801060cf:	c7 04 24 00 00 00 00 	movl   $0x0,(%esp)
801060d6:	e8 e1 fa ff ff       	call   80105bbc <argstr>
801060db:	85 c0                	test   %eax,%eax
801060dd:	78 17                	js     801060f6 <sys_link+0x34>
801060df:	8d 45 dc             	lea    -0x24(%ebp),%eax
801060e2:	89 44 24 04          	mov    %eax,0x4(%esp)
801060e6:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
801060ed:	e8 ca fa ff ff       	call   80105bbc <argstr>
801060f2:	85 c0                	test   %eax,%eax
801060f4:	79 0a                	jns    80106100 <sys_link+0x3e>
    return -1;
801060f6:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
801060fb:	e9 37 01 00 00       	jmp    80106237 <sys_link+0x175>
  if((ip = namei(old)) == 0)
80106100:	8b 45 d8             	mov    -0x28(%ebp),%eax
80106103:	89 04 24             	mov    %eax,(%esp)
80106106:	e8 d4 c2 ff ff       	call   801023df <namei>
8010610b:	89 45 f4             	mov    %eax,-0xc(%ebp)
8010610e:	83 7d f4 00          	cmpl   $0x0,-0xc(%ebp)
80106112:	75 0a                	jne    8010611e <sys_link+0x5c>
    return -1;
80106114:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80106119:	e9 19 01 00 00       	jmp    80106237 <sys_link+0x175>

  begin_trans();
8010611e:	e8 ad d0 ff ff       	call   801031d0 <begin_trans>

  ilock(ip);
80106123:	8b 45 f4             	mov    -0xc(%ebp),%eax
80106126:	89 04 24             	mov    %eax,(%esp)
80106129:	e8 17 b7 ff ff       	call   80101845 <ilock>
  if(ip->type == T_DIR){
8010612e:	8b 45 f4             	mov    -0xc(%ebp),%eax
80106131:	8b 40 10             	mov    0x10(%eax),%eax
80106134:	66 83 f8 01          	cmp    $0x1,%ax
80106138:	75 1a                	jne    80106154 <sys_link+0x92>
    iunlockput(ip);
8010613a:	8b 45 f4             	mov    -0xc(%ebp),%eax
8010613d:	89 04 24             	mov    %eax,(%esp)
80106140:	e8 81 b9 ff ff       	call   80101ac6 <iunlockput>
    commit_trans();
80106145:	e8 cf d0 ff ff       	call   80103219 <commit_trans>
    return -1;
8010614a:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
8010614f:	e9 e3 00 00 00       	jmp    80106237 <sys_link+0x175>
  }

  ip->nlink++;
80106154:	8b 45 f4             	mov    -0xc(%ebp),%eax
80106157:	66 8b 40 16          	mov    0x16(%eax),%ax
8010615b:	40                   	inc    %eax
8010615c:	8b 55 f4             	mov    -0xc(%ebp),%edx
8010615f:	66 89 42 16          	mov    %ax,0x16(%edx)
  iupdate(ip);
80106163:	8b 45 f4             	mov    -0xc(%ebp),%eax
80106166:	89 04 24             	mov    %eax,(%esp)
80106169:	e8 1d b5 ff ff       	call   8010168b <iupdate>
  iunlock(ip);
8010616e:	8b 45 f4             	mov    -0xc(%ebp),%eax
80106171:	89 04 24             	mov    %eax,(%esp)
80106174:	e8 17 b8 ff ff       	call   80101990 <iunlock>

  if((dp = nameiparent(new, name)) == 0)
80106179:	8b 45 dc             	mov    -0x24(%ebp),%eax
8010617c:	8d 55 e2             	lea    -0x1e(%ebp),%edx
8010617f:	89 54 24 04          	mov    %edx,0x4(%esp)
80106183:	89 04 24             	mov    %eax,(%esp)
80106186:	e8 76 c2 ff ff       	call   80102401 <nameiparent>
8010618b:	89 45 f0             	mov    %eax,-0x10(%ebp)
8010618e:	83 7d f0 00          	cmpl   $0x0,-0x10(%ebp)
80106192:	74 68                	je     801061fc <sys_link+0x13a>
    goto bad;
  ilock(dp);
80106194:	8b 45 f0             	mov    -0x10(%ebp),%eax
80106197:	89 04 24             	mov    %eax,(%esp)
8010619a:	e8 a6 b6 ff ff       	call   80101845 <ilock>
  if(dp->dev != ip->dev || dirlink(dp, name, ip->inum) < 0){
8010619f:	8b 45 f0             	mov    -0x10(%ebp),%eax
801061a2:	8b 10                	mov    (%eax),%edx
801061a4:	8b 45 f4             	mov    -0xc(%ebp),%eax
801061a7:	8b 00                	mov    (%eax),%eax
801061a9:	39 c2                	cmp    %eax,%edx
801061ab:	75 20                	jne    801061cd <sys_link+0x10b>
801061ad:	8b 45 f4             	mov    -0xc(%ebp),%eax
801061b0:	8b 40 04             	mov    0x4(%eax),%eax
801061b3:	89 44 24 08          	mov    %eax,0x8(%esp)
801061b7:	8d 45 e2             	lea    -0x1e(%ebp),%eax
801061ba:	89 44 24 04          	mov    %eax,0x4(%esp)
801061be:	8b 45 f0             	mov    -0x10(%ebp),%eax
801061c1:	89 04 24             	mov    %eax,(%esp)
801061c4:	e8 5f bf ff ff       	call   80102128 <dirlink>
801061c9:	85 c0                	test   %eax,%eax
801061cb:	79 0d                	jns    801061da <sys_link+0x118>
    iunlockput(dp);
801061cd:	8b 45 f0             	mov    -0x10(%ebp),%eax
801061d0:	89 04 24             	mov    %eax,(%esp)
801061d3:	e8 ee b8 ff ff       	call   80101ac6 <iunlockput>
    goto bad;
801061d8:	eb 23                	jmp    801061fd <sys_link+0x13b>
  }
  iunlockput(dp);
801061da:	8b 45 f0             	mov    -0x10(%ebp),%eax
801061dd:	89 04 24             	mov    %eax,(%esp)
801061e0:	e8 e1 b8 ff ff       	call   80101ac6 <iunlockput>
  iput(ip);
801061e5:	8b 45 f4             	mov    -0xc(%ebp),%eax
801061e8:	89 04 24             	mov    %eax,(%esp)
801061eb:	e8 05 b8 ff ff       	call   801019f5 <iput>

  commit_trans();
801061f0:	e8 24 d0 ff ff       	call   80103219 <commit_trans>

  return 0;
801061f5:	b8 00 00 00 00       	mov    $0x0,%eax
801061fa:	eb 3b                	jmp    80106237 <sys_link+0x175>
    goto bad;
801061fc:	90                   	nop
...
80106203:	e8 3d b6 ff ff       	call   80101845 <ilock>
  ip->nlink--;
80106208:	8b 45 f4             	mov    -0xc(%ebp),%eax
8010620b:	66 8b 40 16          	mov    0x16(%eax),%ax
8010620f:	48                   	dec    %eax
80106210:	8b 55 f4             	mov    -0xc(%ebp),%edx
80106213:	66 89 42 16          	mov    %ax,0x16(%edx)
  iupdate(ip);
80106217:	8b 45 f4             	mov    -0xc(%ebp),%eax
8010621a:	89 04 24             	mov    %eax,(%esp)
8010621d:	e8 69 b4 ff ff       	call   8010168b <iupdate>
  iunlockput(ip);
80106222:	8b 45 f4             	mov    -0xc(%ebp),%eax
80106225:	89 04 24             	mov    %eax,(%esp)
80106228:	e8 99 b8 ff ff       	call   80101ac6 <iunlockput>
  commit_trans();
8010622d:	e8 e7 cf ff ff       	call   80103219 <commit_trans>
  return -1;
...
8010623f:	c7 45 f4 20 00 00 00 	movl   $0x20,-0xc(%ebp)
80106246:	eb 4a                	jmp    80106292 <isdirempty+0x59>
    if(readi(dp, (char*)&de, off, sizeof(de)) != sizeof(de))
80106248:	8b 45 f4             	mov    -0xc(%ebp),%eax
8010624b:	c7 44 24 0c 10 00 00 	movl   $0x10,0xc(%esp)
80106252:	00 
80106253:	89 44 24 08          	mov    %eax,0x8(%esp)
80106257:	8d 45 e4             	lea    -0x1c(%ebp),%eax
8010625a:	89 44 24 04          	mov    %eax,0x4(%esp)
8010625e:	8b 45 08             	mov    0x8(%ebp),%eax
80106261:	89 04 24             	mov    %eax,(%esp)
80106264:	e8 e3 ba ff ff       	call   80101d4c <readi>
80106269:	83 f8 10             	cmp    $0x10,%eax
8010626c:	74 0c                	je     8010627a <isdirempty+0x41>
      panic("isdirempty: readi");
8010626e:	c7 04 24 97 92 10 80 	movl   $0x80109297,(%esp)
80106275:	e8 bc a2 ff ff       	call   80100536 <panic>
    if(de.inum != 0)
8010627a:	8b 45 e4             	mov    -0x1c(%ebp),%eax
8010627d:	66 85 c0             	test   %ax,%ax
80106280:	74 07                	je     80106289 <isdirempty+0x50>
      return 0;
80106282:	b8 00 00 00 00       	mov    $0x0,%eax
80106287:	eb 1b                	jmp    801062a4 <isdirempty+0x6b>
  for(off=2*sizeof(de); off<dp->size; off+=sizeof(de)){
80106289:	8b 45 f4             	mov    -0xc(%ebp),%eax
8010628c:	83 c0 10             	add    $0x10,%eax
8010628f:	89 45 f4             	mov    %eax,-0xc(%ebp)
80106292:	8b 55 f4             	mov    -0xc(%ebp),%edx
80106295:	8b 45 08             	mov    0x8(%ebp),%eax
80106298:	8b 40 18             	mov    0x18(%eax),%eax
8010629b:	39 c2                	cmp    %eax,%edx
8010629d:	72 a9                	jb     80106248 <isdirempty+0xf>
  }
  return 1;
8010629f:	b8 01 00 00 00       	mov    $0x1,%eax
}
801062a4:	c9                   	leave  
801062a5:	c3                   	ret    
...
801062a9:	83 ec 48             	sub    $0x48,%esp
  struct inode *ip, *dp;
  struct dirent de;
  ...
  if(argstr(0, &path) < 0)
801062ac:	8d 45 cc             	lea    -0x34(%ebp),%eax
801062af:	89 44 24 04          	mov    %eax,0x4(%esp)
801062b3:	c7 04 24 00 00 00 00 	movl   $0x0,(%esp)
801062ba:	e8 fd f8 ff ff       	call   80105bbc <argstr>
801062bf:	85 c0                	test   %eax,%eax
801062c1:	79 0a                	jns    801062cd <sys_unlink+0x27>
    return -1;
801062c3:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
801062c8:	e9 a4 01 00 00       	jmp    80106471 <sys_unlink+0x1cb>
  if((dp = nameiparent(path, name)) == 0)
801062cd:	8b 45 cc             	mov    -0x34(%ebp),%eax
801062d0:	8d 55 d2             	lea    -0x2e(%ebp),%edx
801062d3:	89 54 24 04          	mov    %edx,0x4(%esp)
801062d7:	89 04 24             	mov    %eax,(%esp)
801062da:	e8 22 c1 ff ff       	call   80102401 <nameiparent>
801062df:	89 45 f4             	mov    %eax,-0xc(%ebp)
801062e2:	83 7d f4 00          	cmpl   $0x0,-0xc(%ebp)
801062e6:	75 0a                	jne    801062f2 <sys_unlink+0x4c>
    return -1;
801062e8:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
801062ed:	e9 7f 01 00 00       	jmp    80106471 <sys_unlink+0x1cb>

  begin_trans();
801062f2:	e8 d9 ce ff ff       	call   801031d0 <begin_trans>

  ilock(dp);
801062f7:	8b 45 f4             	mov    -0xc(%ebp),%eax
801062fa:	89 04 24             	mov    %eax,(%esp)
801062fd:	e8 43 b5 ff ff       	call   80101845 <ilock>

  // Cannot unlink "." or "..".
  if(namecmp(name, ".") == 0 || namecmp(name, "..") == 0)
80106302:	c7 44 24 04 a9 92 10 	movl   $0x801092a9,0x4(%esp)
80106309:	80 
8010630a:	8d 45 d2             	lea    -0x2e(%ebp),%eax
8010630d:	89 04 24             	mov    %eax,(%esp)
80106310:	e8 2c bd ff ff       	call   80102041 <namecmp>
80106315:	85 c0                	test   %eax,%eax
80106317:	0f 84 3f 01 00 00    	je     8010645c <sys_unlink+0x1b6>
8010631d:	c7 44 24 04 ab 92 10 	movl   $0x801092ab,0x4(%esp)
80106324:	80 
80106325:	8d 45 d2             	lea    -0x2e(%ebp),%eax
80106328:	89 04 24             	mov    %eax,(%esp)
8010632b:	e8 11 bd ff ff       	call   80102041 <namecmp>
80106330:	85 c0                	test   %eax,%eax
80106332:	0f 84 24 01 00 00    	je     8010645c <sys_unlink+0x1b6>
    goto bad;

  if((ip = dirlookup(dp, name, &off)) == 0)
80106338:	8d 45 c8             	lea    -0x38(%ebp),%eax
8010633b:	89 44 24 08          	mov    %eax,0x8(%esp)
8010633f:	8d 45 d2             	lea    -0x2e(%ebp),%eax
80106342:	89 44 24 04          	mov    %eax,0x4(%esp)
80106346:	8b 45 f4             	mov    -0xc(%ebp),%eax
80106349:	89 04 24             	mov    %eax,(%esp)
8010634c:	e8 12 bd ff ff       	call   80102063 <dirlookup>
80106351:	89 45 f0             	mov    %eax,-0x10(%ebp)
80106354:	83 7d f0 00          	cmpl   $0x0,-0x10(%ebp)
80106358:	0f 84 fd 00 00 00    	je     8010645b <sys_unlink+0x1b5>
    goto bad;
  ilock(ip);
8010635e:	8b 45 f0             	mov    -0x10(%ebp),%eax
80106361:	89 04 24             	mov    %eax,(%esp)
80106364:	e8 dc b4 ff ff       	call   80101845 <ilock>

  if(ip->nlink < 1)
80106369:	8b 45 f0             	mov    -0x10(%ebp),%eax
8010636c:	66 8b 40 16          	mov    0x16(%eax),%ax
80106370:	66 85 c0             	test   %ax,%ax
80106373:	7f 0c                	jg     80106381 <sys_unlink+0xdb>
    panic("unlink: nlink < 1");
80106375:	c7 04 24 ae 92 10 80 	movl   $0x801092ae,(%esp)
8010637c:	e8 b5 a1 ff ff       	call   80100536 <panic>
  if(ip->type == T_DIR && !isdirempty(ip)){
80106381:	8b 45 f0             	mov    -0x10(%ebp),%eax
80106384:	8b 40 10             	mov    0x10(%eax),%eax
80106387:	66 83 f8 01          	cmp    $0x1,%ax
8010638b:	75 1f                	jne    801063ac <sys_unlink+0x106>
8010638d:	8b 45 f0             	mov    -0x10(%ebp),%eax
80106390:	89 04 24             	mov    %eax,(%esp)
80106393:	e8 a1 fe ff ff       	call   80106239 <isdirempty>
80106398:	85 c0                	test   %eax,%eax
8010639a:	75 10                	jne    801063ac <sys_unlink+0x106>
    iunlockput(ip);
8010639c:	8b 45 f0             	mov    -0x10(%ebp),%eax
8010639f:	89 04 24             	mov    %eax,(%esp)
801063a2:	e8 1f b7 ff ff       	call   80101ac6 <iunlockput>
    goto bad;
801063a7:	e9 b0 00 00 00       	jmp    8010645c <sys_unlink+0x1b6>
  }

  memset(&de, 0, sizeof(de));
801063ac:	c7 44 24 08 10 00 00 	movl   $0x10,0x8(%esp)
801063b3:	00 
801063b4:	c7 44 24 04 00 00 00 	movl   $0x0,0x4(%esp)
801063bb:	00 
801063bc:	8d 45 e0             	lea    -0x20(%ebp),%eax
801063bf:	89 04 24             	mov    %eax,(%esp)
801063c2:	e8 34 f4 ff ff       	call   801057fb <memset>
  if(writei(dp, (char*)&de, off, sizeof(de)) != sizeof(de))
801063c7:	8b 45 c8             	mov    -0x38(%ebp),%eax
801063ca:	c7 44 24 0c 10 00 00 	movl   $0x10,0xc(%esp)
801063d1:	00 
801063d2:	89 44 24 08          	mov    %eax,0x8(%esp)
801063d6:	8d 45 e0             	lea    -0x20(%ebp),%eax
801063d9:	89 44 24 04          	mov    %eax,0x4(%esp)
801063dd:	8b 45 f4             	mov    -0xc(%ebp),%eax
801063e0:	89 04 24             	mov    %eax,(%esp)
801063e3:	e8 c9 ba ff ff       	call   80101eb1 <writei>
801063e8:	83 f8 10             	cmp    $0x10,%eax
801063eb:	74 0c                	je     801063f9 <sys_unlink+0x153>
    panic("unlink: writei");
801063ed:	c7 04 24 c0 92 10 80 	movl   $0x801092c0,(%esp)
801063f4:	e8 3d a1 ff ff       	call   80100536 <panic>
  if(ip->type == T_DIR){
801063f9:	8b 45 f0             	mov    -0x10(%ebp),%eax
801063fc:	8b 40 10             	mov    0x10(%eax),%eax
801063ff:	66 83 f8 01          	cmp    $0x1,%ax
80106403:	75 1a                	jne    8010641f <sys_unlink+0x179>
    dp->nlink--;
80106405:	8b 45 f4             	mov    -0xc(%ebp),%eax
80106408:	66 8b 40 16          	mov    0x16(%eax),%ax
8010640c:	48                   	dec    %eax
8010640d:	8b 55 f4             	mov    -0xc(%ebp),%edx
80106410:	66 89 42 16          	mov    %ax,0x16(%edx)
    iupdate(dp);
80106414:	8b 45 f4             	mov    -0xc(%ebp),%eax
80106417:	89 04 24             	mov    %eax,(%esp)
8010641a:	e8 6c b2 ff ff       	call   8010168b <iupdate>
  }
  iunlockput(dp);
8010641f:	8b 45 f4             	mov    -0xc(%ebp),%eax
80106422:	89 04 24             	mov    %eax,(%esp)
80106425:	e8 9c b6 ff ff       	call   80101ac6 <iunlockput>

  ip->nlink--;
8010642a:	8b 45 f0             	mov    -0x10(%ebp),%eax
8010642d:	66 8b 40 16          	mov    0x16(%eax),%ax
80106431:	48                   	dec    %eax
80106432:	8b 55 f0             	mov    -0x10(%ebp),%edx
80106435:	66 89 42 16          	mov    %ax,0x16(%edx)
  iupdate(ip);
80106439:	8b 45 f0             	mov    -0x10(%ebp),%eax
8010643c:	89 04 24             	mov    %eax,(%esp)
8010643f:	e8 47 b2 ff ff       	call   8010168b <iupdate>
  iunlockput(ip);
80106444:	8b 45 f0             	mov    -0x10(%ebp),%eax
80106447:	89 04 24             	mov    %eax,(%esp)
8010644a:	e8 77 b6 ff ff       	call   80101ac6 <iunlockput>

  commit_trans();
8010644f:	e8 c5 cd ff ff       	call   80103219 <commit_trans>

  return 0;
80106454:	b8 00 00 00 00       	mov    $0x0,%eax
80106459:	eb 16                	jmp    80106471 <sys_unlink+0x1cb>
    goto bad;
8010645b:	90                   	nop
...
80106462:	e8 5f b6 ff ff       	call   80101ac6 <iunlockput>
  commit_trans();
80106467:	e8 ad cd ff ff       	call   80103219 <commit_trans>
  return -1;
...
80106476:	83 ec 48             	sub    $0x48,%esp
80106479:	8b 4d 0c             	mov    0xc(%ebp),%ecx
8010647c:	8b 55 10             	mov    0x10(%ebp),%edx
8010647f:	8b 45 14             	mov    0x14(%ebp),%eax
80106482:	66 89 4d d4          	mov    %cx,-0x2c(%ebp)
80106486:	66 89 55 d0          	mov    %dx,-0x30(%ebp)
8010648a:	66 89 45 cc          	mov    %ax,-0x34(%ebp)
  uint off;
  struct inode *ip, *dp;
  char name[DIRSIZ];

  if((dp = nameiparent(path, name)) == 0)
8010648e:	8d 45 de             	lea    -0x22(%ebp),%eax
80106491:	89 44 24 04          	mov    %eax,0x4(%esp)
80106495:	8b 45 08             	mov    0x8(%ebp),%eax
80106498:	89 04 24             	mov    %eax,(%esp)
8010649b:	e8 61 bf ff ff       	call   80102401 <nameiparent>
801064a0:	89 45 f4             	mov    %eax,-0xc(%ebp)
801064a3:	83 7d f4 00          	cmpl   $0x0,-0xc(%ebp)
801064a7:	75 0a                	jne    801064b3 <create+0x40>
    return 0;
801064a9:	b8 00 00 00 00       	mov    $0x0,%eax
801064ae:	e9 79 01 00 00       	jmp    8010662c <create+0x1b9>
  ilock(dp);
801064b3:	8b 45 f4             	mov    -0xc(%ebp),%eax
801064b6:	89 04 24             	mov    %eax,(%esp)
801064b9:	e8 87 b3 ff ff       	call   80101845 <ilock>

  if((ip = dirlookup(dp, name, &off)) != 0){
801064be:	8d 45 ec             	lea    -0x14(%ebp),%eax
801064c1:	89 44 24 08          	mov    %eax,0x8(%esp)
801064c5:	8d 45 de             	lea    -0x22(%ebp),%eax
801064c8:	89 44 24 04          	mov    %eax,0x4(%esp)
801064cc:	8b 45 f4             	mov    -0xc(%ebp),%eax
801064cf:	89 04 24             	mov    %eax,(%esp)
801064d2:	e8 8c bb ff ff       	call   80102063 <dirlookup>
801064d7:	89 45 f0             	mov    %eax,-0x10(%ebp)
801064da:	83 7d f0 00          	cmpl   $0x0,-0x10(%ebp)
801064de:	74 46                	je     80106526 <create+0xb3>
    iunlockput(dp);
801064e0:	8b 45 f4             	mov    -0xc(%ebp),%eax
801064e3:	89 04 24             	mov    %eax,(%esp)
801064e6:	e8 db b5 ff ff       	call   80101ac6 <iunlockput>
    ilock(ip);
801064eb:	8b 45 f0             	mov    -0x10(%ebp),%eax
801064ee:	89 04 24             	mov    %eax,(%esp)
801064f1:	e8 4f b3 ff ff       	call   80101845 <ilock>
    if(type == T_FILE && ip->type == T_FILE)
801064f6:	66 83 7d d4 02       	cmpw   $0x2,-0x2c(%ebp)
801064fb:	75 14                	jne    80106511 <create+0x9e>
801064fd:	8b 45 f0             	mov    -0x10(%ebp),%eax
80106500:	8b 40 10             	mov    0x10(%eax),%eax
80106503:	66 83 f8 02          	cmp    $0x2,%ax
80106507:	75 08                	jne    80106511 <create+0x9e>
      return ip;
80106509:	8b 45 f0             	mov    -0x10(%ebp),%eax
8010650c:	e9 1b 01 00 00       	jmp    8010662c <create+0x1b9>
    iunlockput(ip);
80106511:	8b 45 f0             	mov    -0x10(%ebp),%eax
80106514:	89 04 24             	mov    %eax,(%esp)
80106517:	e8 aa b5 ff ff       	call   80101ac6 <iunlockput>
    return 0;
8010651c:	b8 00 00 00 00       	mov    $0x0,%eax
80106521:	e9 06 01 00 00       	jmp    8010662c <create+0x1b9>
  }

  if((ip = ialloc(dp->dev, type)) == 0)
80106526:	0f bf 55 d4          	movswl -0x2c(%ebp),%edx
8010652a:	8b 45 f4             	mov    -0xc(%ebp),%eax
8010652d:	8b 00                	mov    (%eax),%eax
8010652f:	89 54 24 04          	mov    %edx,0x4(%esp)
80106533:	89 04 24             	mov    %eax,(%esp)
80106536:	e8 68 b0 ff ff       	call   801015a3 <ialloc>
8010653b:	89 45 f0             	mov    %eax,-0x10(%ebp)
8010653e:	83 7d f0 00          	cmpl   $0x0,-0x10(%ebp)
80106542:	75 0c                	jne    80106550 <create+0xdd>
    panic("create: ialloc");
80106544:	c7 04 24 cf 92 10 80 	movl   $0x801092cf,(%esp)
8010654b:	e8 e6 9f ff ff       	call   80100536 <panic>

  ilock(ip);
80106550:	8b 45 f0             	mov    -0x10(%ebp),%eax
80106553:	89 04 24             	mov    %eax,(%esp)
80106556:	e8 ea b2 ff ff       	call   80101845 <ilock>
  ip->major = major;
8010655b:	8b 55 f0             	mov    -0x10(%ebp),%edx
8010655e:	8b 45 d0             	mov    -0x30(%ebp),%eax
80106561:	66 89 42 12          	mov    %ax,0x12(%edx)
  ip->minor = minor;
80106565:	8b 55 f0             	mov    -0x10(%ebp),%edx
80106568:	8b 45 cc             	mov    -0x34(%ebp),%eax
8010656b:	66 89 42 14          	mov    %ax,0x14(%edx)
  ip->nlink = 1;
8010656f:	8b 45 f0             	mov    -0x10(%ebp),%eax
80106572:	66 c7 40 16 01 00    	movw   $0x1,0x16(%eax)
  iupdate(ip);
80106578:	8b 45 f0             	mov    -0x10(%ebp),%eax
8010657b:	89 04 24             	mov    %eax,(%esp)
8010657e:	e8 08 b1 ff ff       	call   8010168b <iupdate>

  if(type == T_DIR){  // Create . and .. entries.
80106583:	66 83 7d d4 01       	cmpw   $0x1,-0x2c(%ebp)
80106588:	75 68                	jne    801065f2 <create+0x17f>
    dp->nlink++;  // for ".."
8010658a:	8b 45 f4             	mov    -0xc(%ebp),%eax
8010658d:	66 8b 40 16          	mov    0x16(%eax),%ax
80106591:	40                   	inc    %eax
80106592:	8b 55 f4             	mov    -0xc(%ebp),%edx
80106595:	66 89 42 16          	mov    %ax,0x16(%edx)
    iupdate(dp);
80106599:	8b 45 f4             	mov    -0xc(%ebp),%eax
8010659c:	89 04 24             	mov    %eax,(%esp)
8010659f:	e8 e7 b0 ff ff       	call   8010168b <iupdate>
    // No ip->nlink++ for ".": avoid cyclic ref count.
    if(dirlink(ip, ".", ip->inum) < 0 || dirlink(ip, "..", dp->inum) < 0)
801065a4:	8b 45 f0             	mov    -0x10(%ebp),%eax
801065a7:	8b 40 04             	mov    0x4(%eax),%eax
801065aa:	89 44 24 08          	mov    %eax,0x8(%esp)
801065ae:	c7 44 24 04 a9 92 10 	movl   $0x801092a9,0x4(%esp)
801065b5:	80 
801065b6:	8b 45 f0             	mov    -0x10(%ebp),%eax
801065b9:	89 04 24             	mov    %eax,(%esp)
801065bc:	e8 67 bb ff ff       	call   80102128 <dirlink>
801065c1:	85 c0                	test   %eax,%eax
801065c3:	78 21                	js     801065e6 <create+0x173>
801065c5:	8b 45 f4             	mov    -0xc(%ebp),%eax
801065c8:	8b 40 04             	mov    0x4(%eax),%eax
801065cb:	89 44 24 08          	mov    %eax,0x8(%esp)
801065cf:	c7 44 24 04 ab 92 10 	movl   $0x801092ab,0x4(%esp)
801065d6:	80 
801065d7:	8b 45 f0             	mov    -0x10(%ebp),%eax
801065da:	89 04 24             	mov    %eax,(%esp)
801065dd:	e8 46 bb ff ff       	call   80102128 <dirlink>
801065e2:	85 c0                	test   %eax,%eax
801065e4:	79 0c                	jns    801065f2 <create+0x17f>
      panic("create dots");
801065e6:	c7 04 24 de 92 10 80 	movl   $0x801092de,(%esp)
801065ed:	e8 44 9f ff ff       	call   80100536 <panic>
  }

  if(dirlink(dp, name, ip->inum) < 0)
801065f2:	8b 45 f0             	mov    -0x10(%ebp),%eax
801065f5:	8b 40 04             	mov    0x4(%eax),%eax
801065f8:	89 44 24 08          	mov    %eax,0x8(%esp)
801065fc:	8d 45 de             	lea    -0x22(%ebp),%eax
801065ff:	89 44 24 04          	mov    %eax,0x4(%esp)
80106603:	8b 45 f4             	mov    -0xc(%ebp),%eax
80106606:	89 04 24             	mov    %eax,(%esp)
80106609:	e8 1a bb ff ff       	call   80102128 <dirlink>
8010660e:	85 c0                	test   %eax,%eax
80106610:	79 0c                	jns    8010661e <create+0x1ab>
    panic("create: dirlink");
80106612:	c7 04 24 ea 92 10 80 	movl   $0x801092ea,(%esp)
80106619:	e8 18 9f ff ff       	call   80100536 <panic>

  iunlockput(dp);
8010661e:	8b 45 f4             	mov    -0xc(%ebp),%eax
80106621:	89 04 24             	mov    %eax,(%esp)
80106624:	e8 9d b4 ff ff       	call   80101ac6 <iunlockput>
...
80106631:	83 ec 38             	sub    $0x38,%esp
  char *path;
  int fd, omode;
  struct file *f;
  struct inode *ip;
...
80106634:	8d 45 e8             	lea    -0x18(%ebp),%eax
80106637:	89 44 24 04          	mov    %eax,0x4(%esp)
8010663b:	c7 04 24 00 00 00 00 	movl   $0x0,(%esp)
80106642:	e8 75 f5 ff ff       	call   80105bbc <argstr>
80106647:	85 c0                	test   %eax,%eax
80106649:	78 17                	js     80106662 <sys_open+0x34>
8010664b:	8d 45 e4             	lea    -0x1c(%ebp),%eax
8010664e:	89 44 24 04          	mov    %eax,0x4(%esp)
80106652:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
80106659:	e8 ce f4 ff ff       	call   80105b2c <argint>
8010665e:	85 c0                	test   %eax,%eax
80106660:	79 0a                	jns    8010666c <sys_open+0x3e>
    return -1;
80106662:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80106667:	e9 47 01 00 00       	jmp    801067b3 <sys_open+0x185>
  if(omode & O_CREATE){
8010666c:	8b 45 e4             	mov    -0x1c(%ebp),%eax
8010666f:	25 00 02 00 00       	and    $0x200,%eax
80106674:	85 c0                	test   %eax,%eax
80106676:	74 40                	je     801066b8 <sys_open+0x8a>
    begin_trans();
80106678:	e8 53 cb ff ff       	call   801031d0 <begin_trans>
    ip = create(path, T_FILE, 0, 0);
8010667d:	8b 45 e8             	mov    -0x18(%ebp),%eax
80106680:	c7 44 24 0c 00 00 00 	movl   $0x0,0xc(%esp)
80106687:	00 
80106688:	c7 44 24 08 00 00 00 	movl   $0x0,0x8(%esp)
8010668f:	00 
80106690:	c7 44 24 04 02 00 00 	movl   $0x2,0x4(%esp)
80106697:	00 
80106698:	89 04 24             	mov    %eax,(%esp)
8010669b:	e8 d3 fd ff ff       	call   80106473 <create>
801066a0:	89 45 f4             	mov    %eax,-0xc(%ebp)
    commit_trans();
801066a3:	e8 71 cb ff ff       	call   80103219 <commit_trans>
    if(ip == 0)
801066a8:	83 7d f4 00          	cmpl   $0x0,-0xc(%ebp)
801066ac:	75 5b                	jne    80106709 <sys_open+0xdb>
      return -1;
801066ae:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
801066b3:	e9 fb 00 00 00       	jmp    801067b3 <sys_open+0x185>
  } else {
    if((ip = namei(path)) == 0)
801066b8:	8b 45 e8             	mov    -0x18(%ebp),%eax
801066bb:	89 04 24             	mov    %eax,(%esp)
801066be:	e8 1c bd ff ff       	call   801023df <namei>
801066c3:	89 45 f4             	mov    %eax,-0xc(%ebp)
801066c6:	83 7d f4 00          	cmpl   $0x0,-0xc(%ebp)
801066ca:	75 0a                	jne    801066d6 <sys_open+0xa8>
      return -1;
801066cc:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
801066d1:	e9 dd 00 00 00       	jmp    801067b3 <sys_open+0x185>
    ilock(ip);
801066d6:	8b 45 f4             	mov    -0xc(%ebp),%eax
801066d9:	89 04 24             	mov    %eax,(%esp)
801066dc:	e8 64 b1 ff ff       	call   80101845 <ilock>
    if(ip->type == T_DIR && omode != O_RDONLY){
801066e1:	8b 45 f4             	mov    -0xc(%ebp),%eax
801066e4:	8b 40 10             	mov    0x10(%eax),%eax
801066e7:	66 83 f8 01          	cmp    $0x1,%ax
801066eb:	75 1c                	jne    80106709 <sys_open+0xdb>
801066ed:	8b 45 e4             	mov    -0x1c(%ebp),%eax
801066f0:	85 c0                	test   %eax,%eax
801066f2:	74 15                	je     80106709 <sys_open+0xdb>
      iunlockput(ip);
801066f4:	8b 45 f4             	mov    -0xc(%ebp),%eax
801066f7:	89 04 24             	mov    %eax,(%esp)
801066fa:	e8 c7 b3 ff ff       	call   80101ac6 <iunlockput>
      return -1;
801066ff:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80106704:	e9 aa 00 00 00       	jmp    801067b3 <sys_open+0x185>
    }
  }

  if((f = filealloc()) == 0 || (fd = fdalloc(f)) < 0){
80106709:	e8 e5 a7 ff ff       	call   80100ef3 <filealloc>
8010670e:	89 45 f0             	mov    %eax,-0x10(%ebp)
80106711:	83 7d f0 00          	cmpl   $0x0,-0x10(%ebp)
80106715:	74 14                	je     8010672b <sys_open+0xfd>
80106717:	8b 45 f0             	mov    -0x10(%ebp),%eax
8010671a:	89 04 24             	mov    %eax,(%esp)
8010671d:	e8 d5 f5 ff ff       	call   80105cf7 <fdalloc>
80106722:	89 45 ec             	mov    %eax,-0x14(%ebp)
80106725:	83 7d ec 00          	cmpl   $0x0,-0x14(%ebp)
80106729:	79 23                	jns    8010674e <sys_open+0x120>
    if(f)
8010672b:	83 7d f0 00          	cmpl   $0x0,-0x10(%ebp)
8010672f:	74 0b                	je     8010673c <sys_open+0x10e>
      fileclose(f);
80106731:	8b 45 f0             	mov    -0x10(%ebp),%eax
80106734:	89 04 24             	mov    %eax,(%esp)
80106737:	e8 5f a8 ff ff       	call   80100f9b <fileclose>
    iunlockput(ip);
8010673c:	8b 45 f4             	mov    -0xc(%ebp),%eax
8010673f:	89 04 24             	mov    %eax,(%esp)
80106742:	e8 7f b3 ff ff       	call   80101ac6 <iunlockput>
    return -1;
80106747:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
8010674c:	eb 65                	jmp    801067b3 <sys_open+0x185>
  }
  iunlock(ip);
8010674e:	8b 45 f4             	mov    -0xc(%ebp),%eax
80106751:	89 04 24             	mov    %eax,(%esp)
80106754:	e8 37 b2 ff ff       	call   80101990 <iunlock>

  f->type = FD_INODE;
80106759:	8b 45 f0             	mov    -0x10(%ebp),%eax
8010675c:	c7 00 02 00 00 00    	movl   $0x2,(%eax)
  f->ip = ip;
80106762:	8b 45 f0             	mov    -0x10(%ebp),%eax
80106765:	8b 55 f4             	mov    -0xc(%ebp),%edx
80106768:	89 50 10             	mov    %edx,0x10(%eax)
  f->off = 0;
8010676b:	8b 45 f0             	mov    -0x10(%ebp),%eax
8010676e:	c7 40 14 00 00 00 00 	movl   $0x0,0x14(%eax)
  f->readable = !(omode & O_WRONLY);
80106775:	8b 45 e4             	mov    -0x1c(%ebp),%eax
80106778:	83 e0 01             	and    $0x1,%eax
8010677b:	85 c0                	test   %eax,%eax
8010677d:	0f 94 c0             	sete   %al
80106780:	88 c2                	mov    %al,%dl
80106782:	8b 45 f0             	mov    -0x10(%ebp),%eax
80106785:	88 50 08             	mov    %dl,0x8(%eax)
  f->writable = (omode & O_WRONLY) || (omode & O_RDWR);
80106788:	8b 45 e4             	mov    -0x1c(%ebp),%eax
8010678b:	83 e0 01             	and    $0x1,%eax
8010678e:	85 c0                	test   %eax,%eax
80106790:	75 0a                	jne    8010679c <sys_open+0x16e>
80106792:	8b 45 e4             	mov    -0x1c(%ebp),%eax
80106795:	83 e0 02             	and    $0x2,%eax
80106798:	85 c0                	test   %eax,%eax
8010679a:	74 07                	je     801067a3 <sys_open+0x175>
8010679c:	b8 01 00 00 00       	mov    $0x1,%eax
801067a1:	eb 05                	jmp    801067a8 <sys_open+0x17a>
801067a3:	b8 00 00 00 00       	mov    $0x0,%eax
801067a8:	88 c2                	mov    %al,%dl
801067aa:	8b 45 f0             	mov    -0x10(%ebp),%eax
801067ad:	88 50 09             	mov    %dl,0x9(%eax)
  return fd;
...
801067b8:	83 ec 28             	sub    $0x28,%esp
  char *path;
  struct inode *ip;

  begin_trans();
801067bb:	e8 10 ca ff ff       	call   801031d0 <begin_trans>
  if(argstr(0, &path) < 0 || (ip = create(path, T_DIR, 0, 0)) == 0){
801067c0:	8d 45 f0             	lea    -0x10(%ebp),%eax
801067c3:	89 44 24 04          	mov    %eax,0x4(%esp)
801067c7:	c7 04 24 00 00 00 00 	movl   $0x0,(%esp)
801067ce:	e8 e9 f3 ff ff       	call   80105bbc <argstr>
801067d3:	85 c0                	test   %eax,%eax
801067d5:	78 2c                	js     80106803 <sys_mkdir+0x4e>
801067d7:	8b 45 f0             	mov    -0x10(%ebp),%eax
801067da:	c7 44 24 0c 00 00 00 	movl   $0x0,0xc(%esp)
801067e1:	00 
801067e2:	c7 44 24 08 00 00 00 	movl   $0x0,0x8(%esp)
801067e9:	00 
801067ea:	c7 44 24 04 01 00 00 	movl   $0x1,0x4(%esp)
801067f1:	00 
801067f2:	89 04 24             	mov    %eax,(%esp)
801067f5:	e8 79 fc ff ff       	call   80106473 <create>
801067fa:	89 45 f4             	mov    %eax,-0xc(%ebp)
801067fd:	83 7d f4 00          	cmpl   $0x0,-0xc(%ebp)
80106801:	75 0c                	jne    8010680f <sys_mkdir+0x5a>
    commit_trans();
80106803:	e8 11 ca ff ff       	call   80103219 <commit_trans>
    return -1;
80106808:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
8010680d:	eb 15                	jmp    80106824 <sys_mkdir+0x6f>
  }
  iunlockput(ip);
8010680f:	8b 45 f4             	mov    -0xc(%ebp),%eax
80106812:	89 04 24             	mov    %eax,(%esp)
80106815:	e8 ac b2 ff ff       	call   80101ac6 <iunlockput>
  commit_trans();
8010681a:	e8 fa c9 ff ff       	call   80103219 <commit_trans>
  return 0;
8010681f:	b8 00 00 00 00       	mov    $0x0,%eax
}
80106824:	c9                   	leave  
80106825:	c3                   	ret    
...
80106829:	83 ec 38             	sub    $0x38,%esp
  ...
  begin_trans();
8010682c:	e8 9f c9 ff ff       	call   801031d0 <begin_trans>
  if((len=argstr(0, &path)) < 0 ||
80106831:	8d 45 ec             	lea    -0x14(%ebp),%eax
80106834:	89 44 24 04          	mov    %eax,0x4(%esp)
80106838:	c7 04 24 00 00 00 00 	movl   $0x0,(%esp)
8010683f:	e8 78 f3 ff ff       	call   80105bbc <argstr>
80106844:	89 45 f4             	mov    %eax,-0xc(%ebp)
80106847:	83 7d f4 00          	cmpl   $0x0,-0xc(%ebp)
8010684b:	78 5e                	js     801068ab <sys_mknod+0x85>
     argint(1, &major) < 0 ||
8010684d:	8d 45 e8             	lea    -0x18(%ebp),%eax
80106850:	89 44 24 04          	mov    %eax,0x4(%esp)
80106854:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
8010685b:	e8 cc f2 ff ff       	call   80105b2c <argint>
  if((len=argstr(0, &path)) < 0 ||
80106860:	85 c0                	test   %eax,%eax
80106862:	78 47                	js     801068ab <sys_mknod+0x85>
     argint(2, &minor) < 0 ||
80106864:	8d 45 e4             	lea    -0x1c(%ebp),%eax
80106867:	89 44 24 04          	mov    %eax,0x4(%esp)
8010686b:	c7 04 24 02 00 00 00 	movl   $0x2,(%esp)
80106872:	e8 b5 f2 ff ff       	call   80105b2c <argint>
     argint(1, &major) < 0 ||
80106877:	85 c0                	test   %eax,%eax
80106879:	78 30                	js     801068ab <sys_mknod+0x85>
     (ip = create(path, T_DEV, major, minor)) == 0){
8010687b:	8b 45 e4             	mov    -0x1c(%ebp),%eax
8010687e:	0f bf c8             	movswl %ax,%ecx
80106881:	8b 45 e8             	mov    -0x18(%ebp),%eax
80106884:	0f bf d0             	movswl %ax,%edx
80106887:	8b 45 ec             	mov    -0x14(%ebp),%eax
     argint(2, &minor) < 0 ||
8010688a:	89 4c 24 0c          	mov    %ecx,0xc(%esp)
8010688e:	89 54 24 08          	mov    %edx,0x8(%esp)
80106892:	c7 44 24 04 03 00 00 	movl   $0x3,0x4(%esp)
80106899:	00 
8010689a:	89 04 24             	mov    %eax,(%esp)
8010689d:	e8 d1 fb ff ff       	call   80106473 <create>
801068a2:	89 45 f0             	mov    %eax,-0x10(%ebp)
801068a5:	83 7d f0 00          	cmpl   $0x0,-0x10(%ebp)
801068a9:	75 0c                	jne    801068b7 <sys_mknod+0x91>
    commit_trans();
801068ab:	e8 69 c9 ff ff       	call   80103219 <commit_trans>
    return -1;
801068b0:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
801068b5:	eb 15                	jmp    801068cc <sys_mknod+0xa6>
  }
  iunlockput(ip);
801068b7:	8b 45 f0             	mov    -0x10(%ebp),%eax
801068ba:	89 04 24             	mov    %eax,(%esp)
801068bd:	e8 04 b2 ff ff       	call   80101ac6 <iunlockput>
  commit_trans();
801068c2:	e8 52 c9 ff ff       	call   80103219 <commit_trans>
  return 0;
...
801068d1:	83 ec 28             	sub    $0x28,%esp
  char *path;
  struct inode *ip;

  if(argstr(0, &path) < 0 || (ip = namei(path)) == 0)
801068d4:	8d 45 f0             	lea    -0x10(%ebp),%eax
801068d7:	89 44 24 04          	mov    %eax,0x4(%esp)
801068db:	c7 04 24 00 00 00 00 	movl   $0x0,(%esp)
801068e2:	e8 d5 f2 ff ff       	call   80105bbc <argstr>
801068e7:	85 c0                	test   %eax,%eax
801068e9:	78 14                	js     801068ff <sys_chdir+0x31>
801068eb:	8b 45 f0             	mov    -0x10(%ebp),%eax
801068ee:	89 04 24             	mov    %eax,(%esp)
801068f1:	e8 e9 ba ff ff       	call   801023df <namei>
801068f6:	89 45 f4             	mov    %eax,-0xc(%ebp)
801068f9:	83 7d f4 00          	cmpl   $0x0,-0xc(%ebp)
801068fd:	75 07                	jne    80106906 <sys_chdir+0x38>
    return -1;
801068ff:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80106904:	eb 56                	jmp    8010695c <sys_chdir+0x8e>
  ilock(ip);
80106906:	8b 45 f4             	mov    -0xc(%ebp),%eax
80106909:	89 04 24             	mov    %eax,(%esp)
8010690c:	e8 34 af ff ff       	call   80101845 <ilock>
  if(ip->type != T_DIR){
80106911:	8b 45 f4             	mov    -0xc(%ebp),%eax
80106914:	8b 40 10             	mov    0x10(%eax),%eax
80106917:	66 83 f8 01          	cmp    $0x1,%ax
8010691b:	74 12                	je     8010692f <sys_chdir+0x61>
    iunlockput(ip);
8010691d:	8b 45 f4             	mov    -0xc(%ebp),%eax
80106920:	89 04 24             	mov    %eax,(%esp)
80106923:	e8 9e b1 ff ff       	call   80101ac6 <iunlockput>
    return -1;
80106928:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
8010692d:	eb 2d                	jmp    8010695c <sys_chdir+0x8e>
  }
  iunlock(ip);
8010692f:	8b 45 f4             	mov    -0xc(%ebp),%eax
80106932:	89 04 24             	mov    %eax,(%esp)
80106935:	e8 56 b0 ff ff       	call   80101990 <iunlock>
  iput(proc->cwd);
8010693a:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
80106940:	8b 40 68             	mov    0x68(%eax),%eax
80106943:	89 04 24             	mov    %eax,(%esp)
80106946:	e8 aa b0 ff ff       	call   801019f5 <iput>
  proc->cwd = ip;
8010694b:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
80106951:	8b 55 f4             	mov    -0xc(%ebp),%edx
80106954:	89 50 68             	mov    %edx,0x68(%eax)
  return 0;
80106957:	b8 00 00 00 00       	mov    $0x0,%eax
}
8010695c:	c9                   	leave  
8010695d:	c3                   	ret    
...
80106961:	81 ec a8 00 00 00    	sub    $0xa8,%esp
...
80106975:	e8 42 f2 ff ff       	call   80105bbc <argstr>
8010697a:	85 c0                	test   %eax,%eax
8010697c:	78 1a                	js     80106998 <sys_exec+0x3a>
8010697e:	8d 85 6c ff ff ff    	lea    -0x94(%ebp),%eax
80106984:	89 44 24 04          	mov    %eax,0x4(%esp)
80106988:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
8010698f:	e8 98 f1 ff ff       	call   80105b2c <argint>
80106994:	85 c0                	test   %eax,%eax
80106996:	79 0a                	jns    801069a2 <sys_exec+0x44>
    return -1;
80106998:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
8010699d:	e9 c7 00 00 00       	jmp    80106a69 <sys_exec+0x10b>
  }
  memset(argv, 0, sizeof(argv));
801069a2:	c7 44 24 08 80 00 00 	movl   $0x80,0x8(%esp)
801069a9:	00 
801069aa:	c7 44 24 04 00 00 00 	movl   $0x0,0x4(%esp)
801069b1:	00 
801069b2:	8d 85 70 ff ff ff    	lea    -0x90(%ebp),%eax
801069b8:	89 04 24             	mov    %eax,(%esp)
801069bb:	e8 3b ee ff ff       	call   801057fb <memset>
  for(i=0;; i++){
801069c0:	c7 45 f4 00 00 00 00 	movl   $0x0,-0xc(%ebp)
    if(i >= NELEM(argv))
801069c7:	8b 45 f4             	mov    -0xc(%ebp),%eax
801069ca:	83 f8 1f             	cmp    $0x1f,%eax
801069cd:	76 0a                	jbe    801069d9 <sys_exec+0x7b>
      return -1;
801069cf:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
801069d4:	e9 90 00 00 00       	jmp    80106a69 <sys_exec+0x10b>
    if(fetchint(uargv+4*i, (int*)&uarg) < 0)
801069d9:	8b 45 f4             	mov    -0xc(%ebp),%eax
801069dc:	c1 e0 02             	shl    $0x2,%eax
801069df:	89 c2                	mov    %eax,%edx
801069e1:	8b 85 6c ff ff ff    	mov    -0x94(%ebp),%eax
801069e7:	01 c2                	add    %eax,%edx
801069e9:	8d 85 68 ff ff ff    	lea    -0x98(%ebp),%eax
801069ef:	89 44 24 04          	mov    %eax,0x4(%esp)
801069f3:	89 14 24             	mov    %edx,(%esp)
801069f6:	e8 95 f0 ff ff       	call   80105a90 <fetchint>
801069fb:	85 c0                	test   %eax,%eax
801069fd:	79 07                	jns    80106a06 <sys_exec+0xa8>
      return -1;
801069ff:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80106a04:	eb 63                	jmp    80106a69 <sys_exec+0x10b>
    if(uarg == 0){
80106a06:	8b 85 68 ff ff ff    	mov    -0x98(%ebp),%eax
80106a0c:	85 c0                	test   %eax,%eax
80106a0e:	75 26                	jne    80106a36 <sys_exec+0xd8>
      argv[i] = 0;
80106a10:	8b 45 f4             	mov    -0xc(%ebp),%eax
80106a13:	c7 84 85 70 ff ff ff 	movl   $0x0,-0x90(%ebp,%eax,4)
80106a1a:	00 00 00 00 
      break;
80106a1e:	90                   	nop
    }
...
80106a22:	8d 95 70 ff ff ff    	lea    -0x90(%ebp),%edx
80106a28:	89 54 24 04          	mov    %edx,0x4(%esp)
80106a2c:	89 04 24             	mov    %eax,(%esp)
80106a2f:	e8 97 a0 ff ff       	call   80100acb <exec>
80106a34:	eb 33                	jmp    80106a69 <sys_exec+0x10b>
    if(fetchstr(uarg, &argv[i]) < 0)
80106a36:	8d 85 70 ff ff ff    	lea    -0x90(%ebp),%eax
80106a3c:	8b 55 f4             	mov    -0xc(%ebp),%edx
80106a3f:	c1 e2 02             	shl    $0x2,%edx
80106a42:	01 c2                	add    %eax,%edx
80106a44:	8b 85 68 ff ff ff    	mov    -0x98(%ebp),%eax
80106a4a:	89 54 24 04          	mov    %edx,0x4(%esp)
80106a4e:	89 04 24             	mov    %eax,(%esp)
80106a51:	e8 74 f0 ff ff       	call   80105aca <fetchstr>
80106a56:	85 c0                	test   %eax,%eax
80106a58:	79 07                	jns    80106a61 <sys_exec+0x103>
      return -1;
80106a5a:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80106a5f:	eb 08                	jmp    80106a69 <sys_exec+0x10b>
  for(i=0;; i++){
80106a61:	ff 45 f4             	incl   -0xc(%ebp)
  }
80106a64:	e9 5e ff ff ff       	jmp    801069c7 <sys_exec+0x69>
}
80106a69:	c9                   	leave  
80106a6a:	c3                   	ret    
...
80106a6e:	83 ec 38             	sub    $0x38,%esp
  int *fd;
  struct file *rf, *wf;
  int fd0, fd1;

  if(argptr(0, (void*)&fd, 2*sizeof(fd[0])) < 0)
80106a71:	c7 44 24 08 08 00 00 	movl   $0x8,0x8(%esp)
80106a78:	00 
80106a79:	8d 45 ec             	lea    -0x14(%ebp),%eax
80106a7c:	89 44 24 04          	mov    %eax,0x4(%esp)
80106a80:	c7 04 24 00 00 00 00 	movl   $0x0,(%esp)
80106a87:	e8 ce f0 ff ff       	call   80105b5a <argptr>
80106a8c:	85 c0                	test   %eax,%eax
80106a8e:	79 0a                	jns    80106a9a <sys_pipe+0x2f>
    return -1;
80106a90:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80106a95:	e9 9b 00 00 00       	jmp    80106b35 <sys_pipe+0xca>
  if(pipealloc(&rf, &wf) < 0)
80106a9a:	8d 45 e4             	lea    -0x1c(%ebp),%eax
80106a9d:	89 44 24 04          	mov    %eax,0x4(%esp)
80106aa1:	8d 45 e8             	lea    -0x18(%ebp),%eax
80106aa4:	89 04 24             	mov    %eax,(%esp)
80106aa7:	e8 66 d1 ff ff       	call   80103c12 <pipealloc>
80106aac:	85 c0                	test   %eax,%eax
80106aae:	79 07                	jns    80106ab7 <sys_pipe+0x4c>
    return -1;
80106ab0:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80106ab5:	eb 7e                	jmp    80106b35 <sys_pipe+0xca>
  fd0 = -1;
80106ab7:	c7 45 f4 ff ff ff ff 	movl   $0xffffffff,-0xc(%ebp)
  if((fd0 = fdalloc(rf)) < 0 || (fd1 = fdalloc(wf)) < 0){
80106abe:	8b 45 e8             	mov    -0x18(%ebp),%eax
80106ac1:	89 04 24             	mov    %eax,(%esp)
80106ac4:	e8 2e f2 ff ff       	call   80105cf7 <fdalloc>
80106ac9:	89 45 f4             	mov    %eax,-0xc(%ebp)
80106acc:	83 7d f4 00          	cmpl   $0x0,-0xc(%ebp)
80106ad0:	78 14                	js     80106ae6 <sys_pipe+0x7b>
80106ad2:	8b 45 e4             	mov    -0x1c(%ebp),%eax
80106ad5:	89 04 24             	mov    %eax,(%esp)
80106ad8:	e8 1a f2 ff ff       	call   80105cf7 <fdalloc>
80106add:	89 45 f0             	mov    %eax,-0x10(%ebp)
80106ae0:	83 7d f0 00          	cmpl   $0x0,-0x10(%ebp)
80106ae4:	79 37                	jns    80106b1d <sys_pipe+0xb2>
    if(fd0 >= 0)
80106ae6:	83 7d f4 00          	cmpl   $0x0,-0xc(%ebp)
80106aea:	78 14                	js     80106b00 <sys_pipe+0x95>
      proc->ofile[fd0] = 0;
80106aec:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
80106af2:	8b 55 f4             	mov    -0xc(%ebp),%edx
80106af5:	83 c2 08             	add    $0x8,%edx
80106af8:	c7 44 90 08 00 00 00 	movl   $0x0,0x8(%eax,%edx,4)
80106aff:	00 
    fileclose(rf);
80106b00:	8b 45 e8             	mov    -0x18(%ebp),%eax
80106b03:	89 04 24             	mov    %eax,(%esp)
80106b06:	e8 90 a4 ff ff       	call   80100f9b <fileclose>
    fileclose(wf);
80106b0b:	8b 45 e4             	mov    -0x1c(%ebp),%eax
80106b0e:	89 04 24             	mov    %eax,(%esp)
80106b11:	e8 85 a4 ff ff       	call   80100f9b <fileclose>
    return -1;
80106b16:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80106b1b:	eb 18                	jmp    80106b35 <sys_pipe+0xca>
  }
  fd[0] = fd0;
80106b1d:	8b 45 ec             	mov    -0x14(%ebp),%eax
80106b20:	8b 55 f4             	mov    -0xc(%ebp),%edx
80106b23:	89 10                	mov    %edx,(%eax)
  fd[1] = fd1;
80106b25:	8b 45 ec             	mov    -0x14(%ebp),%eax
80106b28:	8d 50 04             	lea    0x4(%eax),%edx
80106b2b:	8b 45 f0             	mov    -0x10(%ebp),%eax
80106b2e:	89 02                	mov    %eax,(%edx)
  return 0;
80106b30:	b8 00 00 00 00       	mov    $0x0,%eax
}
80106b35:	c9                   	leave  
80106b36:	c3                   	ret    
...
80106b3a:	83 ec 08             	sub    $0x8,%esp
  return fork();
80106b3d:	e8 59 d9 ff ff       	call   8010449b <fork>
}
80106b42:	c9                   	leave  
80106b43:	c3                   	ret    
...
80106b47:	83 ec 08             	sub    $0x8,%esp
  exit();
80106b4a:	e8 d0 da ff ff       	call   8010461f <exit>
  return 0;  // not reached
80106b4f:	b8 00 00 00 00       	mov    $0x0,%eax
}
80106b54:	c9                   	leave  
80106b55:	c3                   	ret    
...
80106b59:	83 ec 08             	sub    $0x8,%esp
  return wait();
80106b5c:	e8 5e dc ff ff       	call   801047bf <wait>
}
80106b61:	c9                   	leave  
80106b62:	c3                   	ret    
...
80106b9d:	8b 40 10             	mov    0x10(%eax),%eax
}
80106ba0:	5d                   	pop    %ebp
80106ba1:	c3                   	ret    
...
80106ba5:	83 ec 28             	sub    $0x28,%esp
  ...
  if(argint(0, &n) < 0)
80106ba8:	8d 45 f0             	lea    -0x10(%ebp),%eax
80106bab:	89 44 24 04          	mov    %eax,0x4(%esp)
80106baf:	c7 04 24 00 00 00 00 	movl   $0x0,(%esp)
80106bb6:	e8 71 ef ff ff       	call   80105b2c <argint>
80106bbb:	85 c0                	test   %eax,%eax
80106bbd:	79 07                	jns    80106bc6 <sys_sbrk+0x24>
    return -1;
80106bbf:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80106bc4:	eb 24                	jmp    80106bea <sys_sbrk+0x48>
  addr = proc->sz;
...
80106bd7:	e8 1a d8 ff ff       	call   801043f6 <growproc>
80106bdc:	85 c0                	test   %eax,%eax
80106bde:	79 07                	jns    80106be7 <sys_sbrk+0x45>
    return -1;
80106be0:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80106be5:	eb 03                	jmp    80106bea <sys_sbrk+0x48>
  return addr;
...
80106bf9:	c7 04 24 00 00 00 00 	movl   $0x0,(%esp)
80106c00:	e8 27 ef ff ff       	call   80105b2c <argint>
80106c05:	85 c0                	test   %eax,%eax
80106c07:	79 07                	jns    80106c10 <sys_sleep+0x24>
    return -1;
80106c09:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80106c0e:	eb 6c                	jmp    80106c7c <sys_sleep+0x90>
  acquire(&tickslock);
80106c10:	c7 04 24 20 3c 11 80 	movl   $0x80113c20,(%esp)
80106c17:	e8 8d e9 ff ff       	call   801055a9 <acquire>
  ticks0 = ticks;
80106c1c:	a1 60 44 11 80       	mov    0x80114460,%eax
80106c21:	89 45 f4             	mov    %eax,-0xc(%ebp)
  while(ticks - ticks0 < n){
80106c24:	eb 34                	jmp    80106c5a <sys_sleep+0x6e>
    if(proc->killed){
80106c26:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
80106c2c:	8b 40 24             	mov    0x24(%eax),%eax
80106c2f:	85 c0                	test   %eax,%eax
80106c31:	74 13                	je     80106c46 <sys_sleep+0x5a>
      release(&tickslock);
80106c33:	c7 04 24 20 3c 11 80 	movl   $0x80113c20,(%esp)
80106c3a:	e8 cc e9 ff ff       	call   8010560b <release>
      return -1;
80106c3f:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80106c44:	eb 36                	jmp    80106c7c <sys_sleep+0x90>
    }
    sleep(&ticks, &tickslock);
80106c46:	c7 44 24 04 20 3c 11 	movl   $0x80113c20,0x4(%esp)
80106c4d:	80 
80106c4e:	c7 04 24 60 44 11 80 	movl   $0x80114460,(%esp)
80106c55:	e8 87 de ff ff       	call   80104ae1 <sleep>
  while(ticks - ticks0 < n){
80106c5a:	a1 60 44 11 80       	mov    0x80114460,%eax
80106c5f:	89 c2                	mov    %eax,%edx
80106c61:	2b 55 f4             	sub    -0xc(%ebp),%edx
80106c64:	8b 45 f0             	mov    -0x10(%ebp),%eax
80106c67:	39 c2                	cmp    %eax,%edx
80106c69:	72 bb                	jb     80106c26 <sys_sleep+0x3a>
  }
  release(&tickslock);
80106c6b:	c7 04 24 20 3c 11 80 	movl   $0x80113c20,(%esp)
80106c72:	e8 94 e9 ff ff       	call   8010560b <release>
  return 0;
...
80106c81:	83 ec 28             	sub    $0x28,%esp
  ...
  acquire(&tickslock);
80106c84:	c7 04 24 20 3c 11 80 	movl   $0x80113c20,(%esp)
80106c8b:	e8 19 e9 ff ff       	call   801055a9 <acquire>
  xticks = ticks;
80106c90:	a1 60 44 11 80       	mov    0x80114460,%eax
80106c95:	89 45 f4             	mov    %eax,-0xc(%ebp)
  release(&tickslock);
80106c98:	c7 04 24 20 3c 11 80 	movl   $0x80113c20,(%esp)
80106c9f:	e8 67 e9 ff ff       	call   8010560b <release>
  return xticks;
...
80106caf:	e8 e4 df ff ff       	call   80104c98 <procdump>
  return 0; 
...
80106cbe:	83 ec 28             	sub    $0x28,%esp
  int pr;
  argint(0, &pr);
80106cc1:	8d 45 f4             	lea    -0xc(%ebp),%eax
80106cc4:	89 44 24 04          	mov    %eax,0x4(%esp)
80106cc8:	c7 04 24 00 00 00 00 	movl   $0x0,(%esp)
80106ccf:	e8 58 ee ff ff       	call   80105b2c <argint>
  proc->priority=pr;
80106cd4:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
80106cda:	8b 55 f4             	mov    -0xc(%ebp),%edx
80106cdd:	89 90 80 00 00 00    	mov    %edx,0x80(%eax)
  return 0;
80106ce3:	b8 00 00 00 00       	mov    $0x0,%eax
}
80106ce8:	c9                   	leave  
80106ce9:	c3                   	ret    
...
80106d3c:	83 ec 28             	sub    $0x28,%esp
  int semid;
  if(argint(0, &semid) < 0)
80106d3f:	8d 45 f4             	lea    -0xc(%ebp),%eax
80106d42:	89 44 24 04          	mov    %eax,0x4(%esp)
80106d46:	c7 04 24 00 00 00 00 	movl   $0x0,(%esp)
80106d4d:	e8 da ed ff ff       	call   80105b2c <argint>
80106d52:	85 c0                	test   %eax,%eax
80106d54:	79 07                	jns    80106d5d <sys_semfree+0x24>
    return -1;
80106d56:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80106d5b:	eb 0b                	jmp    80106d68 <sys_semfree+0x2f>
  return semfree(semid);
80106d5d:	8b 45 f4             	mov    -0xc(%ebp),%eax
80106d60:	89 04 24             	mov    %eax,(%esp)
80106d63:	e8 de e1 ff ff       	call   80104f46 <semfree>
}
80106d68:	c9                   	leave  
80106d69:	c3                   	ret    

80106d6a <sys_semdown>:
...
80106d6d:	83 ec 28             	sub    $0x28,%esp
  int semid;
  if(argint(0, &semid) < 0)
80106d70:	8d 45 f4             	lea    -0xc(%ebp),%eax
80106d73:	89 44 24 04          	mov    %eax,0x4(%esp)
80106d77:	c7 04 24 00 00 00 00 	movl   $0x0,(%esp)
80106d7e:	e8 a9 ed ff ff       	call   80105b2c <argint>
80106d83:	85 c0                	test   %eax,%eax
80106d85:	79 07                	jns    80106d8e <sys_semdown+0x24>
    return -1;
80106d87:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80106d8c:	eb 0b                	jmp    80106d99 <sys_semdown+0x2f>
  return semdown(semid);
80106d8e:	8b 45 f4             	mov    -0xc(%ebp),%eax
80106d91:	89 04 24             	mov    %eax,(%esp)
80106d94:	e8 44 e2 ff ff       	call   80104fdd <semdown>
}
80106d99:	c9                   	leave  
80106d9a:	c3                   	ret    
...
80106d9e:	83 ec 28             	sub    $0x28,%esp
  int semid;
  if(argint(0, &semid) < 0)
80106da1:	8d 45 f4             	lea    -0xc(%ebp),%eax
80106da4:	89 44 24 04          	mov    %eax,0x4(%esp)
80106da8:	c7 04 24 00 00 00 00 	movl   $0x0,(%esp)
80106daf:	e8 78 ed ff ff       	call   80105b2c <argint>
80106db4:	85 c0                	test   %eax,%eax
80106db6:	79 07                	jns    80106dbf <sys_semup+0x24>
    return -1;
80106db8:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80106dbd:	eb 0b                	jmp    80106dca <sys_semup+0x2f>
  return semup(semid);
80106dbf:	8b 45 f4             	mov    -0xc(%ebp),%eax
80106dc2:	89 04 24             	mov    %eax,(%esp)
80106dc5:	e8 95 e2 ff ff       	call   8010505f <semup>
}
80106dca:	c9                   	leave  
80106dcb:	c3                   	ret    
...
80106dcf:	83 ec 08             	sub    $0x8,%esp
80106dd2:	8b 45 08             	mov    0x8(%ebp),%eax
80106dd5:	8b 55 0c             	mov    0xc(%ebp),%edx
80106dd8:	66 89 45 fc          	mov    %ax,-0x4(%ebp)
80106ddc:	88 55 f8             	mov    %dl,-0x8(%ebp)
  asm volatile("out %0,%1" : : "a" (data), "d" (port));
80106ddf:	8a 45 f8             	mov    -0x8(%ebp),%al
80106de2:	8b 55 fc             	mov    -0x4(%ebp),%edx
...
80106deb:	83 ec 18             	sub    $0x18,%esp
  // Interrupt 100 times/sec.
  outb(TIMER_MODE, TIMER_SEL0 | TIMER_RATEGEN | TIMER_16BIT);
80106dee:	c7 44 24 04 34 00 00 	movl   $0x34,0x4(%esp)
80106df5:	00 
80106df6:	c7 04 24 43 00 00 00 	movl   $0x43,(%esp)
80106dfd:	e8 ca ff ff ff       	call   80106dcc <outb>
  outb(IO_TIMER1, TIMER_DIV(100) % 256);
80106e02:	c7 44 24 04 9c 00 00 	movl   $0x9c,0x4(%esp)
80106e09:	00 
80106e0a:	c7 04 24 40 00 00 00 	movl   $0x40,(%esp)
80106e11:	e8 b6 ff ff ff       	call   80106dcc <outb>
  outb(IO_TIMER1, TIMER_DIV(100) / 256);
80106e16:	c7 44 24 04 2e 00 00 	movl   $0x2e,0x4(%esp)
80106e1d:	00 
80106e1e:	c7 04 24 40 00 00 00 	movl   $0x40,(%esp)
80106e25:	e8 a2 ff ff ff       	call   80106dcc <outb>
  picenable(IRQ_TIMER);
80106e2a:	c7 04 24 00 00 00 00 	movl   $0x0,(%esp)
80106e31:	e8 6b cc ff ff       	call   80103aa1 <picenable>
}
80106e36:	c9                   	leave  
80106e37:	c3                   	ret    
...
80106e38:	1e                   	push   %ds
80106e39:	06                   	push   %es
80106e3a:	0f a0                	push   %fs
80106e3c:	0f a8                	push   %gs
80106e3e:	60                   	pusha  
80106e3f:	66 b8 10 00          	mov    $0x10,%ax
80106e43:	8e d8                	mov    %eax,%ds
80106e45:	8e c0                	mov    %eax,%es
80106e47:	66 b8 18 00          	mov    $0x18,%ax
80106e4b:	8e e0                	mov    %eax,%fs
80106e4d:	8e e8                	mov    %eax,%gs
80106e4f:	54                   	push   %esp
80106e50:	e8 c4 01 00 00       	call   80107019 <trap>
80106e55:	83 c4 04             	add    $0x4,%esp

80106e58 <trapret>:
80106e58:	61                   	popa   
80106e59:	0f a9                	pop    %gs
80106e5b:	0f a1                	pop    %fs
80106e5d:	07                   	pop    %es
80106e5e:	1f                   	pop    %ds
80106e5f:	83 c4 08             	add    $0x8,%esp
80106e62:	cf                   	iret   
...
80106e66:	83 ec 10             	sub    $0x10,%esp
  pd[0] = size-1;
80106e69:	8b 45 0c             	mov    0xc(%ebp),%eax
80106e6c:	48                   	dec    %eax
80106e6d:	66 89 45 fa          	mov    %ax,-0x6(%ebp)
  pd[1] = (uint)p;
...
80106e7e:	66 89 45 fe          	mov    %ax,-0x2(%ebp)
  asm volatile("lidt (%0)" : : "r" (pd));
80106e82:	8d 45 fa             	lea    -0x6(%ebp),%eax
80106e85:	0f 01 18             	lidtl  (%eax)
}
80106e88:	c9                   	leave  
80106e89:	c3                   	ret    
...
80106e8d:	53                   	push   %ebx
80106e8e:	83 ec 10             	sub    $0x10,%esp
  uint val;
  asm volatile("movl %%cr2,%0" : "=r" (val));
80106e91:	0f 20 d3             	mov    %cr2,%ebx
80106e94:	89 5d f8             	mov    %ebx,-0x8(%ebp)
  return val;
80106e97:	8b 45 f8             	mov    -0x8(%ebp),%eax
}
...
80106ea3:	83 ec 28             	sub    $0x28,%esp
  ...
  for(i = 0; i < 256; i++)
80106ea6:	c7 45 f4 00 00 00 00 	movl   $0x0,-0xc(%ebp)
80106ead:	e9 b8 00 00 00       	jmp    80106f6a <tvinit+0xca>
    SETGATE(idt[i], 0, SEG_KCODE<<3, vectors[i], 0);
80106eb2:	8b 45 f4             	mov    -0xc(%ebp),%eax
80106eb5:	8b 04 85 c4 c0 10 80 	mov    -0x7fef3f3c(,%eax,4),%eax
80106ebc:	8b 55 f4             	mov    -0xc(%ebp),%edx
80106ebf:	66 89 04 d5 60 3c 11 	mov    %ax,-0x7feec3a0(,%edx,8)
80106ec6:	80 
80106ec7:	8b 45 f4             	mov    -0xc(%ebp),%eax
80106eca:	66 c7 04 c5 62 3c 11 	movw   $0x8,-0x7feec39e(,%eax,8)
80106ed1:	80 08 00 
80106ed4:	8b 45 f4             	mov    -0xc(%ebp),%eax
80106ed7:	8a 14 c5 64 3c 11 80 	mov    -0x7feec39c(,%eax,8),%dl
80106ede:	83 e2 e0             	and    $0xffffffe0,%edx
80106ee1:	88 14 c5 64 3c 11 80 	mov    %dl,-0x7feec39c(,%eax,8)
80106ee8:	8b 45 f4             	mov    -0xc(%ebp),%eax
80106eeb:	8a 14 c5 64 3c 11 80 	mov    -0x7feec39c(,%eax,8),%dl
80106ef2:	83 e2 1f             	and    $0x1f,%edx
80106ef5:	88 14 c5 64 3c 11 80 	mov    %dl,-0x7feec39c(,%eax,8)
80106efc:	8b 45 f4             	mov    -0xc(%ebp),%eax
80106eff:	8a 14 c5 65 3c 11 80 	mov    -0x7feec39b(,%eax,8),%dl
80106f06:	83 e2 f0             	and    $0xfffffff0,%edx
80106f09:	83 ca 0e             	or     $0xe,%edx
80106f0c:	88 14 c5 65 3c 11 80 	mov    %dl,-0x7feec39b(,%eax,8)
80106f13:	8b 45 f4             	mov    -0xc(%ebp),%eax
80106f16:	8a 14 c5 65 3c 11 80 	mov    -0x7feec39b(,%eax,8),%dl
80106f1d:	83 e2 ef             	and    $0xffffffef,%edx
80106f20:	88 14 c5 65 3c 11 80 	mov    %dl,-0x7feec39b(,%eax,8)
80106f27:	8b 45 f4             	mov    -0xc(%ebp),%eax
80106f2a:	8a 14 c5 65 3c 11 80 	mov    -0x7feec39b(,%eax,8),%dl
80106f31:	83 e2 9f             	and    $0xffffff9f,%edx
80106f34:	88 14 c5 65 3c 11 80 	mov    %dl,-0x7feec39b(,%eax,8)
80106f3b:	8b 45 f4             	mov    -0xc(%ebp),%eax
80106f3e:	8a 14 c5 65 3c 11 80 	mov    -0x7feec39b(,%eax,8),%dl
80106f45:	83 ca 80             	or     $0xffffff80,%edx
80106f48:	88 14 c5 65 3c 11 80 	mov    %dl,-0x7feec39b(,%eax,8)
80106f4f:	8b 45 f4             	mov    -0xc(%ebp),%eax
80106f52:	8b 04 85 c4 c0 10 80 	mov    -0x7fef3f3c(,%eax,4),%eax
80106f59:	c1 e8 10             	shr    $0x10,%eax
80106f5c:	8b 55 f4             	mov    -0xc(%ebp),%edx
80106f5f:	66 89 04 d5 66 3c 11 	mov    %ax,-0x7feec39a(,%edx,8)
80106f66:	80 
  for(i = 0; i < 256; i++)
80106f67:	ff 45 f4             	incl   -0xc(%ebp)
80106f6a:	81 7d f4 ff 00 00 00 	cmpl   $0xff,-0xc(%ebp)
80106f71:	0f 8e 3b ff ff ff    	jle    80106eb2 <tvinit+0x12>
  SETGATE(idt[T_SYSCALL], 1, SEG_KCODE<<3, vectors[T_SYSCALL], DPL_USER);
80106f77:	a1 c4 c1 10 80       	mov    0x8010c1c4,%eax
80106f7c:	66 a3 60 3e 11 80    	mov    %ax,0x80113e60
80106f82:	66 c7 05 62 3e 11 80 	movw   $0x8,0x80113e62
80106f89:	08 00 
80106f8b:	a0 64 3e 11 80       	mov    0x80113e64,%al
80106f90:	83 e0 e0             	and    $0xffffffe0,%eax
80106f93:	a2 64 3e 11 80       	mov    %al,0x80113e64
80106f98:	a0 64 3e 11 80       	mov    0x80113e64,%al
80106f9d:	83 e0 1f             	and    $0x1f,%eax
80106fa0:	a2 64 3e 11 80       	mov    %al,0x80113e64
80106fa5:	a0 65 3e 11 80       	mov    0x80113e65,%al
80106faa:	83 c8 0f             	or     $0xf,%eax
80106fad:	a2 65 3e 11 80       	mov    %al,0x80113e65
80106fb2:	a0 65 3e 11 80       	mov    0x80113e65,%al
80106fb7:	83 e0 ef             	and    $0xffffffef,%eax
80106fba:	a2 65 3e 11 80       	mov    %al,0x80113e65
80106fbf:	a0 65 3e 11 80       	mov    0x80113e65,%al
80106fc4:	83 c8 60             	or     $0x60,%eax
80106fc7:	a2 65 3e 11 80       	mov    %al,0x80113e65
80106fcc:	a0 65 3e 11 80       	mov    0x80113e65,%al
80106fd1:	83 c8 80             	or     $0xffffff80,%eax
80106fd4:	a2 65 3e 11 80       	mov    %al,0x80113e65
80106fd9:	a1 c4 c1 10 80       	mov    0x8010c1c4,%eax
80106fde:	c1 e8 10             	shr    $0x10,%eax
80106fe1:	66 a3 66 3e 11 80    	mov    %ax,0x80113e66
  
  initlock(&tickslock, "time");
80106fe7:	c7 44 24 04 fc 92 10 	movl   $0x801092fc,0x4(%esp)
80106fee:	80 
80106fef:	c7 04 24 20 3c 11 80 	movl   $0x80113c20,(%esp)
80106ff6:	e8 8d e5 ff ff       	call   80105588 <initlock>
}
80106ffb:	c9                   	leave  
80106ffc:	c3                   	ret    
...
80107000:	83 ec 08             	sub    $0x8,%esp
  lidt(idt, sizeof(idt));
80107003:	c7 44 24 04 00 08 00 	movl   $0x800,0x4(%esp)
8010700a:	00 
8010700b:	c7 04 24 60 3c 11 80 	movl   $0x80113c60,(%esp)
80107012:	e8 4c fe ff ff       	call   80106e63 <lidt>
}
80107017:	c9                   	leave  
80107018:	c3                   	ret    
...
8010701d:	56                   	push   %esi
8010701e:	53                   	push   %ebx
8010701f:	83 ec 3c             	sub    $0x3c,%esp
  if(tf->trapno == T_SYSCALL){
80107022:	8b 45 08             	mov    0x8(%ebp),%eax
80107025:	8b 40 30             	mov    0x30(%eax),%eax
80107028:	83 f8 40             	cmp    $0x40,%eax
8010702b:	75 3e                	jne    8010706b <trap+0x52>
    if(proc->killed)
8010702d:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
80107033:	8b 40 24             	mov    0x24(%eax),%eax
80107036:	85 c0                	test   %eax,%eax
80107038:	74 05                	je     8010703f <trap+0x26>
      exit();
8010703a:	e8 e0 d5 ff ff       	call   8010461f <exit>
    proc->tf = tf;
8010703f:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
80107045:	8b 55 08             	mov    0x8(%ebp),%edx
80107048:	89 50 18             	mov    %edx,0x18(%eax)
    syscall();
8010704b:	e8 a3 eb ff ff       	call   80105bf3 <syscall>
    if(proc->killed)
80107050:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
80107056:	8b 40 24             	mov    0x24(%eax),%eax
80107059:	85 c0                	test   %eax,%eax
8010705b:	0f 84 3f 02 00 00    	je     801072a0 <trap+0x287>
      exit();
80107061:	e8 b9 d5 ff ff       	call   8010461f <exit>
    return;
80107066:	e9 35 02 00 00       	jmp    801072a0 <trap+0x287>
  }

  switch(tf->trapno){
8010706b:	8b 45 08             	mov    0x8(%ebp),%eax
8010706e:	8b 40 30             	mov    0x30(%eax),%eax
80107071:	83 e8 20             	sub    $0x20,%eax
80107074:	83 f8 1f             	cmp    $0x1f,%eax
80107077:	0f 87 b7 00 00 00    	ja     80107134 <trap+0x11b>
8010707d:	8b 04 85 a4 93 10 80 	mov    -0x7fef6c5c(,%eax,4),%eax
80107084:	ff e0                	jmp    *%eax
  case T_IRQ0 + IRQ_TIMER:
    if(cpu->id == 0){
80107086:	65 a1 00 00 00 00    	mov    %gs:0x0,%eax
8010708c:	8a 00                	mov    (%eax),%al
8010708e:	84 c0                	test   %al,%al
80107090:	75 2f                	jne    801070c1 <trap+0xa8>
      acquire(&tickslock);
80107092:	c7 04 24 20 3c 11 80 	movl   $0x80113c20,(%esp)
80107099:	e8 0b e5 ff ff       	call   801055a9 <acquire>
      ticks++;
8010709e:	a1 60 44 11 80       	mov    0x80114460,%eax
801070a3:	40                   	inc    %eax
801070a4:	a3 60 44 11 80       	mov    %eax,0x80114460
      wakeup(&ticks);
801070a9:	c7 04 24 60 44 11 80 	movl   $0x80114460,(%esp)
801070b0:	e8 34 db ff ff       	call   80104be9 <wakeup>
      release(&tickslock);
801070b5:	c7 04 24 20 3c 11 80 	movl   $0x80113c20,(%esp)
801070bc:	e8 4a e5 ff ff       	call   8010560b <release>
    }
    lapiceoi();
801070c1:	e8 d9 bd ff ff       	call   80102e9f <lapiceoi>
    break;
801070c6:	e9 3c 01 00 00       	jmp    80107207 <trap+0x1ee>
  case T_IRQ0 + IRQ_IDE:
    ideintr();
801070cb:	e8 ed b5 ff ff       	call   801026bd <ideintr>
    lapiceoi();
801070d0:	e8 ca bd ff ff       	call   80102e9f <lapiceoi>
    break;
801070d5:	e9 2d 01 00 00       	jmp    80107207 <trap+0x1ee>
  case T_IRQ0 + IRQ_IDE+1:
    // Bochs generates spurious IDE1 interrupts.
    break;
  case T_IRQ0 + IRQ_KBD:
    kbdintr();
801070da:	e8 a3 bb ff ff       	call   80102c82 <kbdintr>
    lapiceoi();
801070df:	e8 bb bd ff ff       	call   80102e9f <lapiceoi>
    break;
801070e4:	e9 1e 01 00 00       	jmp    80107207 <trap+0x1ee>
  case T_IRQ0 + IRQ_COM1:
    uartintr();
801070e9:	e8 af 03 00 00       	call   8010749d <uartintr>
    lapiceoi();
801070ee:	e8 ac bd ff ff       	call   80102e9f <lapiceoi>
    break;
801070f3:	e9 0f 01 00 00       	jmp    80107207 <trap+0x1ee>
  case T_IRQ0 + 7:
...
801070f8:	8b 45 08             	mov    0x8(%ebp),%eax
    cprintf("cpu%d: spurious interrupt at %x:%x\n",
801070fb:	8b 48 38             	mov    0x38(%eax),%ecx
            cpu->id, tf->cs, tf->eip);
801070fe:	8b 45 08             	mov    0x8(%ebp),%eax
80107101:	8b 40 3c             	mov    0x3c(%eax),%eax
    cprintf("cpu%d: spurious interrupt at %x:%x\n",
80107104:	0f b7 d0             	movzwl %ax,%edx
            cpu->id, tf->cs, tf->eip);
80107107:	65 a1 00 00 00 00    	mov    %gs:0x0,%eax
8010710d:	8a 00                	mov    (%eax),%al
    cprintf("cpu%d: spurious interrupt at %x:%x\n",
8010710f:	0f b6 c0             	movzbl %al,%eax
80107112:	89 4c 24 0c          	mov    %ecx,0xc(%esp)
80107116:	89 54 24 08          	mov    %edx,0x8(%esp)
8010711a:	89 44 24 04          	mov    %eax,0x4(%esp)
8010711e:	c7 04 24 04 93 10 80 	movl   $0x80109304,(%esp)
80107125:	e8 77 92 ff ff       	call   801003a1 <cprintf>
    lapiceoi();
8010712a:	e8 70 bd ff ff       	call   80102e9f <lapiceoi>
    break;
8010712f:	e9 d3 00 00 00       	jmp    80107207 <trap+0x1ee>
   
  //PAGEBREAK: 13
  default:
    if(proc == 0 || (tf->cs&3) == 0){
80107134:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
8010713a:	85 c0                	test   %eax,%eax
8010713c:	74 10                	je     8010714e <trap+0x135>
8010713e:	8b 45 08             	mov    0x8(%ebp),%eax
80107141:	8b 40 3c             	mov    0x3c(%eax),%eax
80107144:	0f b7 c0             	movzwl %ax,%eax
80107147:	83 e0 03             	and    $0x3,%eax
8010714a:	85 c0                	test   %eax,%eax
8010714c:	75 45                	jne    80107193 <trap+0x17a>
      // In kernel, it must be our mistake.
      cprintf("unexpected trap %d from cpu %d eip %x (cr2=0x%x)\n",
8010714e:	e8 37 fd ff ff       	call   80106e8a <rcr2>
              tf->trapno, cpu->id, tf->eip, rcr2());
80107153:	8b 55 08             	mov    0x8(%ebp),%edx
      cprintf("unexpected trap %d from cpu %d eip %x (cr2=0x%x)\n",
80107156:	8b 5a 38             	mov    0x38(%edx),%ebx
              tf->trapno, cpu->id, tf->eip, rcr2());
80107159:	65 8b 15 00 00 00 00 	mov    %gs:0x0,%edx
80107160:	8a 12                	mov    (%edx),%dl
      cprintf("unexpected trap %d from cpu %d eip %x (cr2=0x%x)\n",
80107162:	0f b6 ca             	movzbl %dl,%ecx
              tf->trapno, cpu->id, tf->eip, rcr2());
80107165:	8b 55 08             	mov    0x8(%ebp),%edx
      cprintf("unexpected trap %d from cpu %d eip %x (cr2=0x%x)\n",
80107168:	8b 52 30             	mov    0x30(%edx),%edx
8010716b:	89 44 24 10          	mov    %eax,0x10(%esp)
8010716f:	89 5c 24 0c          	mov    %ebx,0xc(%esp)
80107173:	89 4c 24 08          	mov    %ecx,0x8(%esp)
80107177:	89 54 24 04          	mov    %edx,0x4(%esp)
8010717b:	c7 04 24 28 93 10 80 	movl   $0x80109328,(%esp)
80107182:	e8 1a 92 ff ff       	call   801003a1 <cprintf>
      panic("trap");
80107187:	c7 04 24 5a 93 10 80 	movl   $0x8010935a,(%esp)
8010718e:	e8 a3 93 ff ff       	call   80100536 <panic>
    }
    // In user space, assume process misbehaved.
    cprintf("pid %d %s: trap %d err %d on cpu %d "
80107193:	e8 f2 fc ff ff       	call   80106e8a <rcr2>
80107198:	89 c2                	mov    %eax,%edx
            "eip 0x%x addr 0x%x--kill proc\n",
            proc->pid, proc->name, tf->trapno, tf->err, cpu->id, tf->eip, 
8010719a:	8b 45 08             	mov    0x8(%ebp),%eax
    cprintf("pid %d %s: trap %d err %d on cpu %d "
8010719d:	8b 78 38             	mov    0x38(%eax),%edi
            proc->pid, proc->name, tf->trapno, tf->err, cpu->id, tf->eip, 
801071a0:	65 a1 00 00 00 00    	mov    %gs:0x0,%eax
801071a6:	8a 00                	mov    (%eax),%al
    cprintf("pid %d %s: trap %d err %d on cpu %d "
801071a8:	0f b6 f0             	movzbl %al,%esi
            proc->pid, proc->name, tf->trapno, tf->err, cpu->id, tf->eip, 
801071ab:	8b 45 08             	mov    0x8(%ebp),%eax
    cprintf("pid %d %s: trap %d err %d on cpu %d "
801071ae:	8b 58 34             	mov    0x34(%eax),%ebx
            proc->pid, proc->name, tf->trapno, tf->err, cpu->id, tf->eip, 
801071b1:	8b 45 08             	mov    0x8(%ebp),%eax
    cprintf("pid %d %s: trap %d err %d on cpu %d "
801071b4:	8b 48 30             	mov    0x30(%eax),%ecx
            proc->pid, proc->name, tf->trapno, tf->err, cpu->id, tf->eip, 
801071b7:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
801071bd:	83 c0 6c             	add    $0x6c,%eax
801071c0:	89 45 e4             	mov    %eax,-0x1c(%ebp)
801071c3:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
    cprintf("pid %d %s: trap %d err %d on cpu %d "
801071c9:	8b 40 10             	mov    0x10(%eax),%eax
801071cc:	89 54 24 1c          	mov    %edx,0x1c(%esp)
801071d0:	89 7c 24 18          	mov    %edi,0x18(%esp)
801071d4:	89 74 24 14          	mov    %esi,0x14(%esp)
801071d8:	89 5c 24 10          	mov    %ebx,0x10(%esp)
801071dc:	89 4c 24 0c          	mov    %ecx,0xc(%esp)
801071e0:	8b 55 e4             	mov    -0x1c(%ebp),%edx
801071e3:	89 54 24 08          	mov    %edx,0x8(%esp)
801071e7:	89 44 24 04          	mov    %eax,0x4(%esp)
801071eb:	c7 04 24 60 93 10 80 	movl   $0x80109360,(%esp)
801071f2:	e8 aa 91 ff ff       	call   801003a1 <cprintf>
            rcr2());
    proc->killed = 1;
801071f7:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
801071fd:	c7 40 24 01 00 00 00 	movl   $0x1,0x24(%eax)
80107204:	eb 01                	jmp    80107207 <trap+0x1ee>
    break;
80107206:	90                   	nop
  }
...
8010720f:	74 23                	je     80107234 <trap+0x21b>
80107211:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
80107217:	8b 40 24             	mov    0x24(%eax),%eax
8010721a:	85 c0                	test   %eax,%eax
8010721c:	74 16                	je     80107234 <trap+0x21b>
8010721e:	8b 45 08             	mov    0x8(%ebp),%eax
80107221:	8b 40 3c             	mov    0x3c(%eax),%eax
80107224:	0f b7 c0             	movzwl %ax,%eax
80107227:	83 e0 03             	and    $0x3,%eax
8010722a:	83 f8 03             	cmp    $0x3,%eax
8010722d:	75 05                	jne    80107234 <trap+0x21b>
    exit();
8010722f:	e8 eb d3 ff ff       	call   8010461f <exit>

  // Force process to give up CPU on clock tick.
  // If interrupts were on while locks held, would need to check nlock.
  if(proc && proc->state == RUNNING && tf->trapno == T_IRQ0+IRQ_TIMER && ++(proc->ticksProc) == QUANTUM) {
80107234:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
8010723a:	85 c0                	test   %eax,%eax
8010723c:	74 33                	je     80107271 <trap+0x258>
8010723e:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
80107244:	8b 40 0c             	mov    0xc(%eax),%eax
80107247:	83 f8 04             	cmp    $0x4,%eax
8010724a:	75 25                	jne    80107271 <trap+0x258>
8010724c:	8b 45 08             	mov    0x8(%ebp),%eax
8010724f:	8b 40 30             	mov    0x30(%eax),%eax
80107252:	83 f8 20             	cmp    $0x20,%eax
80107255:	75 1a                	jne    80107271 <trap+0x258>
80107257:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
8010725d:	8b 50 7c             	mov    0x7c(%eax),%edx
80107260:	42                   	inc    %edx
80107261:	89 50 7c             	mov    %edx,0x7c(%eax)
80107264:	8b 40 7c             	mov    0x7c(%eax),%eax
80107267:	83 f8 06             	cmp    $0x6,%eax
8010726a:	75 05                	jne    80107271 <trap+0x258>
      // del proyecto 0
      ...
      yield();
8010726c:	e8 e5 d7 ff ff       	call   80104a56 <yield>
  }
...
80107279:	74 26                	je     801072a1 <trap+0x288>
8010727b:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
80107281:	8b 40 24             	mov    0x24(%eax),%eax
80107284:	85 c0                	test   %eax,%eax
80107286:	74 19                	je     801072a1 <trap+0x288>
80107288:	8b 45 08             	mov    0x8(%ebp),%eax
8010728b:	8b 40 3c             	mov    0x3c(%eax),%eax
8010728e:	0f b7 c0             	movzwl %ax,%eax
80107291:	83 e0 03             	and    $0x3,%eax
80107294:	83 f8 03             	cmp    $0x3,%eax
80107297:	75 08                	jne    801072a1 <trap+0x288>
    exit();
80107299:	e8 81 d3 ff ff       	call   8010461f <exit>
8010729e:	eb 01                	jmp    801072a1 <trap+0x288>
    return;
801072a0:	90                   	nop
}
801072a1:	83 c4 3c             	add    $0x3c,%esp
801072a4:	5b                   	pop    %ebx
801072a5:	5e                   	pop    %esi
801072a6:	5f                   	pop    %edi
801072a7:	5d                   	pop    %ebp
...
801072ac:	53                   	push   %ebx
801072ad:	83 ec 14             	sub    $0x14,%esp
801072b0:	8b 45 08             	mov    0x8(%ebp),%eax
801072b3:	66 89 45 e8          	mov    %ax,-0x18(%ebp)
  asm volatile("in %1,%0" : "=a" (data) : "d" (port));
801072b7:	8b 55 e8             	mov    -0x18(%ebp),%edx
801072ba:	66 89 55 ea          	mov    %dx,-0x16(%ebp)
801072be:	66 8b 55 ea          	mov    -0x16(%ebp),%dx
801072c2:	ec                   	in     (%dx),%al
801072c3:	88 c3                	mov    %al,%bl
801072c5:	88 5d fb             	mov    %bl,-0x5(%ebp)
  return data;
801072c8:	8a 45 fb             	mov    -0x5(%ebp),%al
}
801072cb:	83 c4 14             	add    $0x14,%esp
801072ce:	5b                   	pop    %ebx
801072cf:	5d                   	pop    %ebp
801072d0:	c3                   	ret    
...
801072da:	8b 55 0c             	mov    0xc(%ebp),%edx
801072dd:	66 89 45 fc          	mov    %ax,-0x4(%ebp)
801072e1:	88 55 f8             	mov    %dl,-0x8(%ebp)
  asm volatile("out %0,%1" : : "a" (data), "d" (port));
801072e4:	8a 45 f8             	mov    -0x8(%ebp),%al
801072e7:	8b 55 fc             	mov    -0x4(%ebp),%edx
...
uartinit(void)
{
801072ed:	55                   	push   %ebp
801072ee:	89 e5                	mov    %esp,%ebp
801072f0:	83 ec 28             	sub    $0x28,%esp
  char *p;

  // Turn off the FIFO
  outb(COM1+2, 0);
801072f3:	c7 44 24 04 00 00 00 	movl   $0x0,0x4(%esp)
801072fa:	00 
801072fb:	c7 04 24 fa 03 00 00 	movl   $0x3fa,(%esp)
80107302:	e8 ca ff ff ff       	call   801072d1 <outb>
  
  // 9600 baud, 8 data bits, 1 stop bit, parity off.
  outb(COM1+3, 0x80);    // Unlock divisor
80107307:	c7 44 24 04 80 00 00 	movl   $0x80,0x4(%esp)
8010730e:	00 
8010730f:	c7 04 24 fb 03 00 00 	movl   $0x3fb,(%esp)
80107316:	e8 b6 ff ff ff       	call   801072d1 <outb>
  outb(COM1+0, 115200/9600);
8010731b:	c7 44 24 04 0c 00 00 	movl   $0xc,0x4(%esp)
80107322:	00 
80107323:	c7 04 24 f8 03 00 00 	movl   $0x3f8,(%esp)
8010732a:	e8 a2 ff ff ff       	call   801072d1 <outb>
  outb(COM1+1, 0);
8010732f:	c7 44 24 04 00 00 00 	movl   $0x0,0x4(%esp)
80107336:	00 
80107337:	c7 04 24 f9 03 00 00 	movl   $0x3f9,(%esp)
8010733e:	e8 8e ff ff ff       	call   801072d1 <outb>
  outb(COM1+3, 0x03);    // Lock divisor, 8 data bits.
80107343:	c7 44 24 04 03 00 00 	movl   $0x3,0x4(%esp)
8010734a:	00 
8010734b:	c7 04 24 fb 03 00 00 	movl   $0x3fb,(%esp)
80107352:	e8 7a ff ff ff       	call   801072d1 <outb>
  outb(COM1+4, 0);
80107357:	c7 44 24 04 00 00 00 	movl   $0x0,0x4(%esp)
8010735e:	00 
8010735f:	c7 04 24 fc 03 00 00 	movl   $0x3fc,(%esp)
80107366:	e8 66 ff ff ff       	call   801072d1 <outb>
  outb(COM1+1, 0x01);    // Enable receive interrupts.
8010736b:	c7 44 24 04 01 00 00 	movl   $0x1,0x4(%esp)
80107372:	00 
80107373:	c7 04 24 f9 03 00 00 	movl   $0x3f9,(%esp)
8010737a:	e8 52 ff ff ff       	call   801072d1 <outb>

  // If status is 0xFF, no serial port.
  if(inb(COM1+5) == 0xFF)
8010737f:	c7 04 24 fd 03 00 00 	movl   $0x3fd,(%esp)
80107386:	e8 1e ff ff ff       	call   801072a9 <inb>
8010738b:	3c ff                	cmp    $0xff,%al
8010738d:	74 69                	je     801073f8 <uartinit+0x10b>
    return;
  uart = 1;
8010738f:	c7 05 8c c6 10 80 01 	movl   $0x1,0x8010c68c
80107396:	00 00 00 

  // Acknowledge pre-existing interrupt conditions;
  // enable interrupts.
  inb(COM1+2);
80107399:	c7 04 24 fa 03 00 00 	movl   $0x3fa,(%esp)
801073a0:	e8 04 ff ff ff       	call   801072a9 <inb>
  inb(COM1+0);
801073a5:	c7 04 24 f8 03 00 00 	movl   $0x3f8,(%esp)
801073ac:	e8 f8 fe ff ff       	call   801072a9 <inb>
  picenable(IRQ_COM1);
801073b1:	c7 04 24 04 00 00 00 	movl   $0x4,(%esp)
801073b8:	e8 e4 c6 ff ff       	call   80103aa1 <picenable>
  ioapicenable(IRQ_COM1, 0);
801073bd:	c7 44 24 04 00 00 00 	movl   $0x0,0x4(%esp)
801073c4:	00 
801073c5:	c7 04 24 04 00 00 00 	movl   $0x4,(%esp)
801073cc:	e8 69 b5 ff ff       	call   8010293a <ioapicenable>
  
  // Announce that we're here.
  for(p="xv6...\n"; *p; p++)
801073d1:	c7 45 f4 24 94 10 80 	movl   $0x80109424,-0xc(%ebp)
801073d8:	eb 13                	jmp    801073ed <uartinit+0x100>
    uartputc(*p);
801073da:	8b 45 f4             	mov    -0xc(%ebp),%eax
801073dd:	8a 00                	mov    (%eax),%al
801073df:	0f be c0             	movsbl %al,%eax
801073e2:	89 04 24             	mov    %eax,(%esp)
801073e5:	e8 11 00 00 00       	call   801073fb <uartputc>
  for(p="xv6...\n"; *p; p++)
801073ea:	ff 45 f4             	incl   -0xc(%ebp)
801073ed:	8b 45 f4             	mov    -0xc(%ebp),%eax
801073f0:	8a 00                	mov    (%eax),%al
801073f2:	84 c0                	test   %al,%al
801073f4:	75 e4                	jne    801073da <uartinit+0xed>
801073f6:	eb 01                	jmp    801073f9 <uartinit+0x10c>
    return;
801073f8:	90                   	nop
}
801073f9:	c9                   	leave  
...
801073fe:	83 ec 28             	sub    $0x28,%esp
  ...
  if(!uart)
80107401:	a1 8c c6 10 80       	mov    0x8010c68c,%eax
80107406:	85 c0                	test   %eax,%eax
80107408:	74 4c                	je     80107456 <uartputc+0x5b>
    return;
  for(i = 0; i < 128 && !(inb(COM1+5) & 0x20); i++)
8010740a:	c7 45 f4 00 00 00 00 	movl   $0x0,-0xc(%ebp)
80107411:	eb 0f                	jmp    80107422 <uartputc+0x27>
    microdelay(10);
80107413:	c7 04 24 0a 00 00 00 	movl   $0xa,(%esp)
8010741a:	e8 a5 ba ff ff       	call   80102ec4 <microdelay>
  for(i = 0; i < 128 && !(inb(COM1+5) & 0x20); i++)
8010741f:	ff 45 f4             	incl   -0xc(%ebp)
80107422:	83 7d f4 7f          	cmpl   $0x7f,-0xc(%ebp)
80107426:	7f 16                	jg     8010743e <uartputc+0x43>
80107428:	c7 04 24 fd 03 00 00 	movl   $0x3fd,(%esp)
8010742f:	e8 75 fe ff ff       	call   801072a9 <inb>
80107434:	0f b6 c0             	movzbl %al,%eax
80107437:	83 e0 20             	and    $0x20,%eax
8010743a:	85 c0                	test   %eax,%eax
8010743c:	74 d5                	je     80107413 <uartputc+0x18>
  outb(COM1+0, c);
8010743e:	8b 45 08             	mov    0x8(%ebp),%eax
80107441:	0f b6 c0             	movzbl %al,%eax
80107444:	89 44 24 04          	mov    %eax,0x4(%esp)
80107448:	c7 04 24 f8 03 00 00 	movl   $0x3f8,(%esp)
8010744f:	e8 7d fe ff ff       	call   801072d1 <outb>
80107454:	eb 01                	jmp    80107457 <uartputc+0x5c>
    return;
80107456:	90                   	nop
}
80107457:	c9                   	leave  
...
8010745c:	83 ec 04             	sub    $0x4,%esp
  if(!uart)
8010745f:	a1 8c c6 10 80       	mov    0x8010c68c,%eax
80107464:	85 c0                	test   %eax,%eax
80107466:	75 07                	jne    8010746f <uartgetc+0x16>
    return -1;
80107468:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
8010746d:	eb 2c                	jmp    8010749b <uartgetc+0x42>
  if(!(inb(COM1+5) & 0x01))
8010746f:	c7 04 24 fd 03 00 00 	movl   $0x3fd,(%esp)
80107476:	e8 2e fe ff ff       	call   801072a9 <inb>
8010747b:	0f b6 c0             	movzbl %al,%eax
8010747e:	83 e0 01             	and    $0x1,%eax
80107481:	85 c0                	test   %eax,%eax
80107483:	75 07                	jne    8010748c <uartgetc+0x33>
    return -1;
80107485:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
8010748a:	eb 0f                	jmp    8010749b <uartgetc+0x42>
  return inb(COM1+0);
8010748c:	c7 04 24 f8 03 00 00 	movl   $0x3f8,(%esp)
80107493:	e8 11 fe ff ff       	call   801072a9 <inb>
80107498:	0f b6 c0             	movzbl %al,%eax
}
8010749b:	c9                   	leave  
8010749c:	c3                   	ret    
...
801074a0:	83 ec 18             	sub    $0x18,%esp
  consoleintr(uartgetc);
801074a3:	c7 04 24 59 74 10 80 	movl   $0x80107459,(%esp)
801074aa:	e8 e1 92 ff ff       	call   80100790 <consoleintr>
}
801074af:	c9                   	leave  
801074b0:	c3                   	ret    
...
801074b5:	e9 7e f9 ff ff       	jmp    80106e38 <alltraps>

801074ba <vector1>:
801074ba:	6a 00                	push   $0x0
801074bc:	6a 01                	push   $0x1
801074be:	e9 75 f9 ff ff       	jmp    80106e38 <alltraps>

801074c3 <vector2>:
801074c3:	6a 00                	push   $0x0
801074c5:	6a 02                	push   $0x2
801074c7:	e9 6c f9 ff ff       	jmp    80106e38 <alltraps>

801074cc <vector3>:
801074cc:	6a 00                	push   $0x0
801074ce:	6a 03                	push   $0x3
801074d0:	e9 63 f9 ff ff       	jmp    80106e38 <alltraps>

801074d5 <vector4>:
801074d5:	6a 00                	push   $0x0
801074d7:	6a 04                	push   $0x4
801074d9:	e9 5a f9 ff ff       	jmp    80106e38 <alltraps>

801074de <vector5>:
801074de:	6a 00                	push   $0x0
801074e0:	6a 05                	push   $0x5
801074e2:	e9 51 f9 ff ff       	jmp    80106e38 <alltraps>

801074e7 <vector6>:
801074e7:	6a 00                	push   $0x0
801074e9:	6a 06                	push   $0x6
801074eb:	e9 48 f9 ff ff       	jmp    80106e38 <alltraps>

801074f0 <vector7>:
801074f0:	6a 00                	push   $0x0
801074f2:	6a 07                	push   $0x7
801074f4:	e9 3f f9 ff ff       	jmp    80106e38 <alltraps>

801074f9 <vector8>:
801074f9:	6a 08                	push   $0x8
801074fb:	e9 38 f9 ff ff       	jmp    80106e38 <alltraps>

80107500 <vector9>:
80107500:	6a 00                	push   $0x0
80107502:	6a 09                	push   $0x9
80107504:	e9 2f f9 ff ff       	jmp    80106e38 <alltraps>

80107509 <vector10>:
80107509:	6a 0a                	push   $0xa
8010750b:	e9 28 f9 ff ff       	jmp    80106e38 <alltraps>

80107510 <vector11>:
80107510:	6a 0b                	push   $0xb
80107512:	e9 21 f9 ff ff       	jmp    80106e38 <alltraps>

80107517 <vector12>:
80107517:	6a 0c                	push   $0xc
80107519:	e9 1a f9 ff ff       	jmp    80106e38 <alltraps>

8010751e <vector13>:
8010751e:	6a 0d                	push   $0xd
80107520:	e9 13 f9 ff ff       	jmp    80106e38 <alltraps>

80107525 <vector14>:
80107525:	6a 0e                	push   $0xe
80107527:	e9 0c f9 ff ff       	jmp    80106e38 <alltraps>

8010752c <vector15>:
8010752c:	6a 00                	push   $0x0
8010752e:	6a 0f                	push   $0xf
80107530:	e9 03 f9 ff ff       	jmp    80106e38 <alltraps>

80107535 <vector16>:
80107535:	6a 00                	push   $0x0
80107537:	6a 10                	push   $0x10
80107539:	e9 fa f8 ff ff       	jmp    80106e38 <alltraps>

8010753e <vector17>:
8010753e:	6a 11                	push   $0x11
80107540:	e9 f3 f8 ff ff       	jmp    80106e38 <alltraps>

80107545 <vector18>:
80107545:	6a 00                	push   $0x0
80107547:	6a 12                	push   $0x12
80107549:	e9 ea f8 ff ff       	jmp    80106e38 <alltraps>

8010754e <vector19>:
8010754e:	6a 00                	push   $0x0
80107550:	6a 13                	push   $0x13
80107552:	e9 e1 f8 ff ff       	jmp    80106e38 <alltraps>

80107557 <vector20>:
80107557:	6a 00                	push   $0x0
80107559:	6a 14                	push   $0x14
8010755b:	e9 d8 f8 ff ff       	jmp    80106e38 <alltraps>

80107560 <vector21>:
80107560:	6a 00                	push   $0x0
80107562:	6a 15                	push   $0x15
80107564:	e9 cf f8 ff ff       	jmp    80106e38 <alltraps>

80107569 <vector22>:
80107569:	6a 00                	push   $0x0
8010756b:	6a 16                	push   $0x16
8010756d:	e9 c6 f8 ff ff       	jmp    80106e38 <alltraps>

80107572 <vector23>:
80107572:	6a 00                	push   $0x0
80107574:	6a 17                	push   $0x17
80107576:	e9 bd f8 ff ff       	jmp    80106e38 <alltraps>

8010757b <vector24>:
8010757b:	6a 00                	push   $0x0
8010757d:	6a 18                	push   $0x18
8010757f:	e9 b4 f8 ff ff       	jmp    80106e38 <alltraps>

80107584 <vector25>:
80107584:	6a 00                	push   $0x0
80107586:	6a 19                	push   $0x19
80107588:	e9 ab f8 ff ff       	jmp    80106e38 <alltraps>

8010758d <vector26>:
8010758d:	6a 00                	push   $0x0
8010758f:	6a 1a                	push   $0x1a
80107591:	e9 a2 f8 ff ff       	jmp    80106e38 <alltraps>

80107596 <vector27>:
80107596:	6a 00                	push   $0x0
80107598:	6a 1b                	push   $0x1b
8010759a:	e9 99 f8 ff ff       	jmp    80106e38 <alltraps>

8010759f <vector28>:
8010759f:	6a 00                	push   $0x0
801075a1:	6a 1c                	push   $0x1c
801075a3:	e9 90 f8 ff ff       	jmp    80106e38 <alltraps>

801075a8 <vector29>:
801075a8:	6a 00                	push   $0x0
801075aa:	6a 1d                	push   $0x1d
801075ac:	e9 87 f8 ff ff       	jmp    80106e38 <alltraps>

801075b1 <vector30>:
801075b1:	6a 00                	push   $0x0
801075b3:	6a 1e                	push   $0x1e
801075b5:	e9 7e f8 ff ff       	jmp    80106e38 <alltraps>

801075ba <vector31>:
801075ba:	6a 00                	push   $0x0
801075bc:	6a 1f                	push   $0x1f
801075be:	e9 75 f8 ff ff       	jmp    80106e38 <alltraps>

801075c3 <vector32>:
801075c3:	6a 00                	push   $0x0
801075c5:	6a 20                	push   $0x20
801075c7:	e9 6c f8 ff ff       	jmp    80106e38 <alltraps>

801075cc <vector33>:
801075cc:	6a 00                	push   $0x0
801075ce:	6a 21                	push   $0x21
801075d0:	e9 63 f8 ff ff       	jmp    80106e38 <alltraps>

801075d5 <vector34>:
801075d5:	6a 00                	push   $0x0
801075d7:	6a 22                	push   $0x22
801075d9:	e9 5a f8 ff ff       	jmp    80106e38 <alltraps>

801075de <vector35>:
801075de:	6a 00                	push   $0x0
801075e0:	6a 23                	push   $0x23
801075e2:	e9 51 f8 ff ff       	jmp    80106e38 <alltraps>

801075e7 <vector36>:
801075e7:	6a 00                	push   $0x0
801075e9:	6a 24                	push   $0x24
801075eb:	e9 48 f8 ff ff       	jmp    80106e38 <alltraps>

801075f0 <vector37>:
801075f0:	6a 00                	push   $0x0
801075f2:	6a 25                	push   $0x25
801075f4:	e9 3f f8 ff ff       	jmp    80106e38 <alltraps>

801075f9 <vector38>:
801075f9:	6a 00                	push   $0x0
801075fb:	6a 26                	push   $0x26
801075fd:	e9 36 f8 ff ff       	jmp    80106e38 <alltraps>

80107602 <vector39>:
80107602:	6a 00                	push   $0x0
80107604:	6a 27                	push   $0x27
80107606:	e9 2d f8 ff ff       	jmp    80106e38 <alltraps>

8010760b <vector40>:
8010760b:	6a 00                	push   $0x0
8010760d:	6a 28                	push   $0x28
8010760f:	e9 24 f8 ff ff       	jmp    80106e38 <alltraps>

80107614 <vector41>:
80107614:	6a 00                	push   $0x0
80107616:	6a 29                	push   $0x29
80107618:	e9 1b f8 ff ff       	jmp    80106e38 <alltraps>

8010761d <vector42>:
8010761d:	6a 00                	push   $0x0
8010761f:	6a 2a                	push   $0x2a
80107621:	e9 12 f8 ff ff       	jmp    80106e38 <alltraps>

80107626 <vector43>:
80107626:	6a 00                	push   $0x0
80107628:	6a 2b                	push   $0x2b
8010762a:	e9 09 f8 ff ff       	jmp    80106e38 <alltraps>

8010762f <vector44>:
8010762f:	6a 00                	push   $0x0
80107631:	6a 2c                	push   $0x2c
80107633:	e9 00 f8 ff ff       	jmp    80106e38 <alltraps>

80107638 <vector45>:
80107638:	6a 00                	push   $0x0
8010763a:	6a 2d                	push   $0x2d
8010763c:	e9 f7 f7 ff ff       	jmp    80106e38 <alltraps>

80107641 <vector46>:
80107641:	6a 00                	push   $0x0
80107643:	6a 2e                	push   $0x2e
80107645:	e9 ee f7 ff ff       	jmp    80106e38 <alltraps>

8010764a <vector47>:
8010764a:	6a 00                	push   $0x0
8010764c:	6a 2f                	push   $0x2f
8010764e:	e9 e5 f7 ff ff       	jmp    80106e38 <alltraps>

80107653 <vector48>:
80107653:	6a 00                	push   $0x0
80107655:	6a 30                	push   $0x30
80107657:	e9 dc f7 ff ff       	jmp    80106e38 <alltraps>

8010765c <vector49>:
8010765c:	6a 00                	push   $0x0
8010765e:	6a 31                	push   $0x31
80107660:	e9 d3 f7 ff ff       	jmp    80106e38 <alltraps>

80107665 <vector50>:
80107665:	6a 00                	push   $0x0
80107667:	6a 32                	push   $0x32
80107669:	e9 ca f7 ff ff       	jmp    80106e38 <alltraps>

8010766e <vector51>:
8010766e:	6a 00                	push   $0x0
80107670:	6a 33                	push   $0x33
80107672:	e9 c1 f7 ff ff       	jmp    80106e38 <alltraps>

80107677 <vector52>:
80107677:	6a 00                	push   $0x0
80107679:	6a 34                	push   $0x34
8010767b:	e9 b8 f7 ff ff       	jmp    80106e38 <alltraps>

80107680 <vector53>:
80107680:	6a 00                	push   $0x0
80107682:	6a 35                	push   $0x35
80107684:	e9 af f7 ff ff       	jmp    80106e38 <alltraps>

80107689 <vector54>:
80107689:	6a 00                	push   $0x0
8010768b:	6a 36                	push   $0x36
8010768d:	e9 a6 f7 ff ff       	jmp    80106e38 <alltraps>

80107692 <vector55>:
80107692:	6a 00                	push   $0x0
80107694:	6a 37                	push   $0x37
80107696:	e9 9d f7 ff ff       	jmp    80106e38 <alltraps>

8010769b <vector56>:
8010769b:	6a 00                	push   $0x0
8010769d:	6a 38                	push   $0x38
8010769f:	e9 94 f7 ff ff       	jmp    80106e38 <alltraps>

801076a4 <vector57>:
801076a4:	6a 00                	push   $0x0
801076a6:	6a 39                	push   $0x39
801076a8:	e9 8b f7 ff ff       	jmp    80106e38 <alltraps>

801076ad <vector58>:
801076ad:	6a 00                	push   $0x0
801076af:	6a 3a                	push   $0x3a
801076b1:	e9 82 f7 ff ff       	jmp    80106e38 <alltraps>

801076b6 <vector59>:
801076b6:	6a 00                	push   $0x0
801076b8:	6a 3b                	push   $0x3b
801076ba:	e9 79 f7 ff ff       	jmp    80106e38 <alltraps>

801076bf <vector60>:
801076bf:	6a 00                	push   $0x0
801076c1:	6a 3c                	push   $0x3c
801076c3:	e9 70 f7 ff ff       	jmp    80106e38 <alltraps>

801076c8 <vector61>:
801076c8:	6a 00                	push   $0x0
801076ca:	6a 3d                	push   $0x3d
801076cc:	e9 67 f7 ff ff       	jmp    80106e38 <alltraps>

801076d1 <vector62>:
801076d1:	6a 00                	push   $0x0
801076d3:	6a 3e                	push   $0x3e
801076d5:	e9 5e f7 ff ff       	jmp    80106e38 <alltraps>

801076da <vector63>:
801076da:	6a 00                	push   $0x0
801076dc:	6a 3f                	push   $0x3f
801076de:	e9 55 f7 ff ff       	jmp    80106e38 <alltraps>

801076e3 <vector64>:
801076e3:	6a 00                	push   $0x0
801076e5:	6a 40                	push   $0x40
801076e7:	e9 4c f7 ff ff       	jmp    80106e38 <alltraps>

801076ec <vector65>:
801076ec:	6a 00                	push   $0x0
801076ee:	6a 41                	push   $0x41
801076f0:	e9 43 f7 ff ff       	jmp    80106e38 <alltraps>

801076f5 <vector66>:
801076f5:	6a 00                	push   $0x0
801076f7:	6a 42                	push   $0x42
801076f9:	e9 3a f7 ff ff       	jmp    80106e38 <alltraps>

801076fe <vector67>:
801076fe:	6a 00                	push   $0x0
80107700:	6a 43                	push   $0x43
80107702:	e9 31 f7 ff ff       	jmp    80106e38 <alltraps>

80107707 <vector68>:
80107707:	6a 00                	push   $0x0
80107709:	6a 44                	push   $0x44
8010770b:	e9 28 f7 ff ff       	jmp    80106e38 <alltraps>

80107710 <vector69>:
80107710:	6a 00                	push   $0x0
80107712:	6a 45                	push   $0x45
80107714:	e9 1f f7 ff ff       	jmp    80106e38 <alltraps>

80107719 <vector70>:
80107719:	6a 00                	push   $0x0
8010771b:	6a 46                	push   $0x46
8010771d:	e9 16 f7 ff ff       	jmp    80106e38 <alltraps>

80107722 <vector71>:
80107722:	6a 00                	push   $0x0
80107724:	6a 47                	push   $0x47
80107726:	e9 0d f7 ff ff       	jmp    80106e38 <alltraps>

8010772b <vector72>:
8010772b:	6a 00                	push   $0x0
8010772d:	6a 48                	push   $0x48
8010772f:	e9 04 f7 ff ff       	jmp    80106e38 <alltraps>

80107734 <vector73>:
80107734:	6a 00                	push   $0x0
80107736:	6a 49                	push   $0x49
80107738:	e9 fb f6 ff ff       	jmp    80106e38 <alltraps>

8010773d <vector74>:
8010773d:	6a 00                	push   $0x0
8010773f:	6a 4a                	push   $0x4a
80107741:	e9 f2 f6 ff ff       	jmp    80106e38 <alltraps>

80107746 <vector75>:
80107746:	6a 00                	push   $0x0
80107748:	6a 4b                	push   $0x4b
8010774a:	e9 e9 f6 ff ff       	jmp    80106e38 <alltraps>

8010774f <vector76>:
8010774f:	6a 00                	push   $0x0
80107751:	6a 4c                	push   $0x4c
80107753:	e9 e0 f6 ff ff       	jmp    80106e38 <alltraps>

80107758 <vector77>:
80107758:	6a 00                	push   $0x0
8010775a:	6a 4d                	push   $0x4d
8010775c:	e9 d7 f6 ff ff       	jmp    80106e38 <alltraps>

80107761 <vector78>:
80107761:	6a 00                	push   $0x0
80107763:	6a 4e                	push   $0x4e
80107765:	e9 ce f6 ff ff       	jmp    80106e38 <alltraps>

8010776a <vector79>:
8010776a:	6a 00                	push   $0x0
8010776c:	6a 4f                	push   $0x4f
8010776e:	e9 c5 f6 ff ff       	jmp    80106e38 <alltraps>

80107773 <vector80>:
80107773:	6a 00                	push   $0x0
80107775:	6a 50                	push   $0x50
80107777:	e9 bc f6 ff ff       	jmp    80106e38 <alltraps>

8010777c <vector81>:
8010777c:	6a 00                	push   $0x0
8010777e:	6a 51                	push   $0x51
80107780:	e9 b3 f6 ff ff       	jmp    80106e38 <alltraps>

80107785 <vector82>:
80107785:	6a 00                	push   $0x0
80107787:	6a 52                	push   $0x52
80107789:	e9 aa f6 ff ff       	jmp    80106e38 <alltraps>

8010778e <vector83>:
8010778e:	6a 00                	push   $0x0
80107790:	6a 53                	push   $0x53
80107792:	e9 a1 f6 ff ff       	jmp    80106e38 <alltraps>

80107797 <vector84>:
80107797:	6a 00                	push   $0x0
80107799:	6a 54                	push   $0x54
8010779b:	e9 98 f6 ff ff       	jmp    80106e38 <alltraps>

801077a0 <vector85>:
801077a0:	6a 00                	push   $0x0
801077a2:	6a 55                	push   $0x55
801077a4:	e9 8f f6 ff ff       	jmp    80106e38 <alltraps>

801077a9 <vector86>:
801077a9:	6a 00                	push   $0x0
801077ab:	6a 56                	push   $0x56
801077ad:	e9 86 f6 ff ff       	jmp    80106e38 <alltraps>

801077b2 <vector87>:
801077b2:	6a 00                	push   $0x0
801077b4:	6a 57                	push   $0x57
801077b6:	e9 7d f6 ff ff       	jmp    80106e38 <alltraps>

801077bb <vector88>:
801077bb:	6a 00                	push   $0x0
801077bd:	6a 58                	push   $0x58
801077bf:	e9 74 f6 ff ff       	jmp    80106e38 <alltraps>

801077c4 <vector89>:
801077c4:	6a 00                	push   $0x0
801077c6:	6a 59                	push   $0x59
801077c8:	e9 6b f6 ff ff       	jmp    80106e38 <alltraps>

801077cd <vector90>:
801077cd:	6a 00                	push   $0x0
801077cf:	6a 5a                	push   $0x5a
801077d1:	e9 62 f6 ff ff       	jmp    80106e38 <alltraps>

801077d6 <vector91>:
801077d6:	6a 00                	push   $0x0
801077d8:	6a 5b                	push   $0x5b
801077da:	e9 59 f6 ff ff       	jmp    80106e38 <alltraps>

801077df <vector92>:
801077df:	6a 00                	push   $0x0
801077e1:	6a 5c                	push   $0x5c
801077e3:	e9 50 f6 ff ff       	jmp    80106e38 <alltraps>

801077e8 <vector93>:
801077e8:	6a 00                	push   $0x0
801077ea:	6a 5d                	push   $0x5d
801077ec:	e9 47 f6 ff ff       	jmp    80106e38 <alltraps>

801077f1 <vector94>:
801077f1:	6a 00                	push   $0x0
801077f3:	6a 5e                	push   $0x5e
801077f5:	e9 3e f6 ff ff       	jmp    80106e38 <alltraps>

801077fa <vector95>:
801077fa:	6a 00                	push   $0x0
801077fc:	6a 5f                	push   $0x5f
801077fe:	e9 35 f6 ff ff       	jmp    80106e38 <alltraps>

80107803 <vector96>:
80107803:	6a 00                	push   $0x0
80107805:	6a 60                	push   $0x60
80107807:	e9 2c f6 ff ff       	jmp    80106e38 <alltraps>

8010780c <vector97>:
8010780c:	6a 00                	push   $0x0
8010780e:	6a 61                	push   $0x61
80107810:	e9 23 f6 ff ff       	jmp    80106e38 <alltraps>

80107815 <vector98>:
80107815:	6a 00                	push   $0x0
80107817:	6a 62                	push   $0x62
80107819:	e9 1a f6 ff ff       	jmp    80106e38 <alltraps>

8010781e <vector99>:
8010781e:	6a 00                	push   $0x0
80107820:	6a 63                	push   $0x63
80107822:	e9 11 f6 ff ff       	jmp    80106e38 <alltraps>

80107827 <vector100>:
80107827:	6a 00                	push   $0x0
80107829:	6a 64                	push   $0x64
8010782b:	e9 08 f6 ff ff       	jmp    80106e38 <alltraps>

80107830 <vector101>:
80107830:	6a 00                	push   $0x0
80107832:	6a 65                	push   $0x65
80107834:	e9 ff f5 ff ff       	jmp    80106e38 <alltraps>

80107839 <vector102>:
80107839:	6a 00                	push   $0x0
8010783b:	6a 66                	push   $0x66
8010783d:	e9 f6 f5 ff ff       	jmp    80106e38 <alltraps>

80107842 <vector103>:
80107842:	6a 00                	push   $0x0
80107844:	6a 67                	push   $0x67
80107846:	e9 ed f5 ff ff       	jmp    80106e38 <alltraps>

8010784b <vector104>:
8010784b:	6a 00                	push   $0x0
8010784d:	6a 68                	push   $0x68
8010784f:	e9 e4 f5 ff ff       	jmp    80106e38 <alltraps>

80107854 <vector105>:
80107854:	6a 00                	push   $0x0
80107856:	6a 69                	push   $0x69
80107858:	e9 db f5 ff ff       	jmp    80106e38 <alltraps>

8010785d <vector106>:
8010785d:	6a 00                	push   $0x0
8010785f:	6a 6a                	push   $0x6a
80107861:	e9 d2 f5 ff ff       	jmp    80106e38 <alltraps>

80107866 <vector107>:
80107866:	6a 00                	push   $0x0
80107868:	6a 6b                	push   $0x6b
8010786a:	e9 c9 f5 ff ff       	jmp    80106e38 <alltraps>

8010786f <vector108>:
8010786f:	6a 00                	push   $0x0
80107871:	6a 6c                	push   $0x6c
80107873:	e9 c0 f5 ff ff       	jmp    80106e38 <alltraps>

80107878 <vector109>:
80107878:	6a 00                	push   $0x0
8010787a:	6a 6d                	push   $0x6d
8010787c:	e9 b7 f5 ff ff       	jmp    80106e38 <alltraps>

80107881 <vector110>:
80107881:	6a 00                	push   $0x0
80107883:	6a 6e                	push   $0x6e
80107885:	e9 ae f5 ff ff       	jmp    80106e38 <alltraps>

8010788a <vector111>:
8010788a:	6a 00                	push   $0x0
8010788c:	6a 6f                	push   $0x6f
8010788e:	e9 a5 f5 ff ff       	jmp    80106e38 <alltraps>

80107893 <vector112>:
80107893:	6a 00                	push   $0x0
80107895:	6a 70                	push   $0x70
80107897:	e9 9c f5 ff ff       	jmp    80106e38 <alltraps>

8010789c <vector113>:
8010789c:	6a 00                	push   $0x0
8010789e:	6a 71                	push   $0x71
801078a0:	e9 93 f5 ff ff       	jmp    80106e38 <alltraps>

801078a5 <vector114>:
801078a5:	6a 00                	push   $0x0
801078a7:	6a 72                	push   $0x72
801078a9:	e9 8a f5 ff ff       	jmp    80106e38 <alltraps>

801078ae <vector115>:
801078ae:	6a 00                	push   $0x0
801078b0:	6a 73                	push   $0x73
801078b2:	e9 81 f5 ff ff       	jmp    80106e38 <alltraps>

801078b7 <vector116>:
801078b7:	6a 00                	push   $0x0
801078b9:	6a 74                	push   $0x74
801078bb:	e9 78 f5 ff ff       	jmp    80106e38 <alltraps>

801078c0 <vector117>:
801078c0:	6a 00                	push   $0x0
801078c2:	6a 75                	push   $0x75
801078c4:	e9 6f f5 ff ff       	jmp    80106e38 <alltraps>

801078c9 <vector118>:
801078c9:	6a 00                	push   $0x0
801078cb:	6a 76                	push   $0x76
801078cd:	e9 66 f5 ff ff       	jmp    80106e38 <alltraps>

801078d2 <vector119>:
801078d2:	6a 00                	push   $0x0
801078d4:	6a 77                	push   $0x77
801078d6:	e9 5d f5 ff ff       	jmp    80106e38 <alltraps>

801078db <vector120>:
801078db:	6a 00                	push   $0x0
801078dd:	6a 78                	push   $0x78
801078df:	e9 54 f5 ff ff       	jmp    80106e38 <alltraps>

801078e4 <vector121>:
801078e4:	6a 00                	push   $0x0
801078e6:	6a 79                	push   $0x79
801078e8:	e9 4b f5 ff ff       	jmp    80106e38 <alltraps>

801078ed <vector122>:
801078ed:	6a 00                	push   $0x0
801078ef:	6a 7a                	push   $0x7a
801078f1:	e9 42 f5 ff ff       	jmp    80106e38 <alltraps>

801078f6 <vector123>:
801078f6:	6a 00                	push   $0x0
801078f8:	6a 7b                	push   $0x7b
801078fa:	e9 39 f5 ff ff       	jmp    80106e38 <alltraps>

801078ff <vector124>:
801078ff:	6a 00                	push   $0x0
80107901:	6a 7c                	push   $0x7c
80107903:	e9 30 f5 ff ff       	jmp    80106e38 <alltraps>

80107908 <vector125>:
80107908:	6a 00                	push   $0x0
8010790a:	6a 7d                	push   $0x7d
8010790c:	e9 27 f5 ff ff       	jmp    80106e38 <alltraps>

80107911 <vector126>:
80107911:	6a 00                	push   $0x0
80107913:	6a 7e                	push   $0x7e
80107915:	e9 1e f5 ff ff       	jmp    80106e38 <alltraps>

8010791a <vector127>:
8010791a:	6a 00                	push   $0x0
8010791c:	6a 7f                	push   $0x7f
8010791e:	e9 15 f5 ff ff       	jmp    80106e38 <alltraps>

80107923 <vector128>:
80107923:	6a 00                	push   $0x0
80107925:	68 80 00 00 00       	push   $0x80
8010792a:	e9 09 f5 ff ff       	jmp    80106e38 <alltraps>

8010792f <vector129>:
8010792f:	6a 00                	push   $0x0
80107931:	68 81 00 00 00       	push   $0x81
80107936:	e9 fd f4 ff ff       	jmp    80106e38 <alltraps>

8010793b <vector130>:
8010793b:	6a 00                	push   $0x0
8010793d:	68 82 00 00 00       	push   $0x82
80107942:	e9 f1 f4 ff ff       	jmp    80106e38 <alltraps>

80107947 <vector131>:
80107947:	6a 00                	push   $0x0
80107949:	68 83 00 00 00       	push   $0x83
8010794e:	e9 e5 f4 ff ff       	jmp    80106e38 <alltraps>

80107953 <vector132>:
80107953:	6a 00                	push   $0x0
80107955:	68 84 00 00 00       	push   $0x84
8010795a:	e9 d9 f4 ff ff       	jmp    80106e38 <alltraps>

8010795f <vector133>:
8010795f:	6a 00                	push   $0x0
80107961:	68 85 00 00 00       	push   $0x85
80107966:	e9 cd f4 ff ff       	jmp    80106e38 <alltraps>

8010796b <vector134>:
8010796b:	6a 00                	push   $0x0
8010796d:	68 86 00 00 00       	push   $0x86
80107972:	e9 c1 f4 ff ff       	jmp    80106e38 <alltraps>

80107977 <vector135>:
80107977:	6a 00                	push   $0x0
80107979:	68 87 00 00 00       	push   $0x87
8010797e:	e9 b5 f4 ff ff       	jmp    80106e38 <alltraps>

80107983 <vector136>:
80107983:	6a 00                	push   $0x0
80107985:	68 88 00 00 00       	push   $0x88
8010798a:	e9 a9 f4 ff ff       	jmp    80106e38 <alltraps>

8010798f <vector137>:
8010798f:	6a 00                	push   $0x0
80107991:	68 89 00 00 00       	push   $0x89
80107996:	e9 9d f4 ff ff       	jmp    80106e38 <alltraps>

8010799b <vector138>:
8010799b:	6a 00                	push   $0x0
8010799d:	68 8a 00 00 00       	push   $0x8a
801079a2:	e9 91 f4 ff ff       	jmp    80106e38 <alltraps>

801079a7 <vector139>:
801079a7:	6a 00                	push   $0x0
801079a9:	68 8b 00 00 00       	push   $0x8b
801079ae:	e9 85 f4 ff ff       	jmp    80106e38 <alltraps>

801079b3 <vector140>:
801079b3:	6a 00                	push   $0x0
801079b5:	68 8c 00 00 00       	push   $0x8c
801079ba:	e9 79 f4 ff ff       	jmp    80106e38 <alltraps>

801079bf <vector141>:
801079bf:	6a 00                	push   $0x0
801079c1:	68 8d 00 00 00       	push   $0x8d
801079c6:	e9 6d f4 ff ff       	jmp    80106e38 <alltraps>

801079cb <vector142>:
801079cb:	6a 00                	push   $0x0
801079cd:	68 8e 00 00 00       	push   $0x8e
801079d2:	e9 61 f4 ff ff       	jmp    80106e38 <alltraps>

801079d7 <vector143>:
801079d7:	6a 00                	push   $0x0
801079d9:	68 8f 00 00 00       	push   $0x8f
801079de:	e9 55 f4 ff ff       	jmp    80106e38 <alltraps>

801079e3 <vector144>:
801079e3:	6a 00                	push   $0x0
801079e5:	68 90 00 00 00       	push   $0x90
801079ea:	e9 49 f4 ff ff       	jmp    80106e38 <alltraps>

801079ef <vector145>:
801079ef:	6a 00                	push   $0x0
801079f1:	68 91 00 00 00       	push   $0x91
801079f6:	e9 3d f4 ff ff       	jmp    80106e38 <alltraps>

801079fb <vector146>:
801079fb:	6a 00                	push   $0x0
801079fd:	68 92 00 00 00       	push   $0x92
80107a02:	e9 31 f4 ff ff       	jmp    80106e38 <alltraps>

80107a07 <vector147>:
80107a07:	6a 00                	push   $0x0
80107a09:	68 93 00 00 00       	push   $0x93
80107a0e:	e9 25 f4 ff ff       	jmp    80106e38 <alltraps>

80107a13 <vector148>:
80107a13:	6a 00                	push   $0x0
80107a15:	68 94 00 00 00       	push   $0x94
80107a1a:	e9 19 f4 ff ff       	jmp    80106e38 <alltraps>

80107a1f <vector149>:
80107a1f:	6a 00                	push   $0x0
80107a21:	68 95 00 00 00       	push   $0x95
80107a26:	e9 0d f4 ff ff       	jmp    80106e38 <alltraps>

80107a2b <vector150>:
80107a2b:	6a 00                	push   $0x0
80107a2d:	68 96 00 00 00       	push   $0x96
80107a32:	e9 01 f4 ff ff       	jmp    80106e38 <alltraps>

80107a37 <vector151>:
80107a37:	6a 00                	push   $0x0
80107a39:	68 97 00 00 00       	push   $0x97
80107a3e:	e9 f5 f3 ff ff       	jmp    80106e38 <alltraps>

80107a43 <vector152>:
80107a43:	6a 00                	push   $0x0
80107a45:	68 98 00 00 00       	push   $0x98
80107a4a:	e9 e9 f3 ff ff       	jmp    80106e38 <alltraps>

80107a4f <vector153>:
80107a4f:	6a 00                	push   $0x0
80107a51:	68 99 00 00 00       	push   $0x99
80107a56:	e9 dd f3 ff ff       	jmp    80106e38 <alltraps>

80107a5b <vector154>:
80107a5b:	6a 00                	push   $0x0
80107a5d:	68 9a 00 00 00       	push   $0x9a
80107a62:	e9 d1 f3 ff ff       	jmp    80106e38 <alltraps>

80107a67 <vector155>:
80107a67:	6a 00                	push   $0x0
80107a69:	68 9b 00 00 00       	push   $0x9b
80107a6e:	e9 c5 f3 ff ff       	jmp    80106e38 <alltraps>

80107a73 <vector156>:
80107a73:	6a 00                	push   $0x0
80107a75:	68 9c 00 00 00       	push   $0x9c
80107a7a:	e9 b9 f3 ff ff       	jmp    80106e38 <alltraps>

80107a7f <vector157>:
80107a7f:	6a 00                	push   $0x0
80107a81:	68 9d 00 00 00       	push   $0x9d
80107a86:	e9 ad f3 ff ff       	jmp    80106e38 <alltraps>

80107a8b <vector158>:
80107a8b:	6a 00                	push   $0x0
80107a8d:	68 9e 00 00 00       	push   $0x9e
80107a92:	e9 a1 f3 ff ff       	jmp    80106e38 <alltraps>

80107a97 <vector159>:
80107a97:	6a 00                	push   $0x0
80107a99:	68 9f 00 00 00       	push   $0x9f
80107a9e:	e9 95 f3 ff ff       	jmp    80106e38 <alltraps>

80107aa3 <vector160>:
80107aa3:	6a 00                	push   $0x0
80107aa5:	68 a0 00 00 00       	push   $0xa0
80107aaa:	e9 89 f3 ff ff       	jmp    80106e38 <alltraps>

80107aaf <vector161>:
80107aaf:	6a 00                	push   $0x0
80107ab1:	68 a1 00 00 00       	push   $0xa1
80107ab6:	e9 7d f3 ff ff       	jmp    80106e38 <alltraps>

80107abb <vector162>:
80107abb:	6a 00                	push   $0x0
80107abd:	68 a2 00 00 00       	push   $0xa2
80107ac2:	e9 71 f3 ff ff       	jmp    80106e38 <alltraps>

80107ac7 <vector163>:
80107ac7:	6a 00                	push   $0x0
80107ac9:	68 a3 00 00 00       	push   $0xa3
80107ace:	e9 65 f3 ff ff       	jmp    80106e38 <alltraps>

80107ad3 <vector164>:
80107ad3:	6a 00                	push   $0x0
80107ad5:	68 a4 00 00 00       	push   $0xa4
80107ada:	e9 59 f3 ff ff       	jmp    80106e38 <alltraps>

80107adf <vector165>:
80107adf:	6a 00                	push   $0x0
80107ae1:	68 a5 00 00 00       	push   $0xa5
80107ae6:	e9 4d f3 ff ff       	jmp    80106e38 <alltraps>

80107aeb <vector166>:
80107aeb:	6a 00                	push   $0x0
80107aed:	68 a6 00 00 00       	push   $0xa6
80107af2:	e9 41 f3 ff ff       	jmp    80106e38 <alltraps>

80107af7 <vector167>:
80107af7:	6a 00                	push   $0x0
80107af9:	68 a7 00 00 00       	push   $0xa7
80107afe:	e9 35 f3 ff ff       	jmp    80106e38 <alltraps>

80107b03 <vector168>:
80107b03:	6a 00                	push   $0x0
80107b05:	68 a8 00 00 00       	push   $0xa8
80107b0a:	e9 29 f3 ff ff       	jmp    80106e38 <alltraps>

80107b0f <vector169>:
80107b0f:	6a 00                	push   $0x0
80107b11:	68 a9 00 00 00       	push   $0xa9
80107b16:	e9 1d f3 ff ff       	jmp    80106e38 <alltraps>

80107b1b <vector170>:
80107b1b:	6a 00                	push   $0x0
80107b1d:	68 aa 00 00 00       	push   $0xaa
80107b22:	e9 11 f3 ff ff       	jmp    80106e38 <alltraps>

80107b27 <vector171>:
80107b27:	6a 00                	push   $0x0
80107b29:	68 ab 00 00 00       	push   $0xab
80107b2e:	e9 05 f3 ff ff       	jmp    80106e38 <alltraps>

80107b33 <vector172>:
80107b33:	6a 00                	push   $0x0
80107b35:	68 ac 00 00 00       	push   $0xac
80107b3a:	e9 f9 f2 ff ff       	jmp    80106e38 <alltraps>

80107b3f <vector173>:
80107b3f:	6a 00                	push   $0x0
80107b41:	68 ad 00 00 00       	push   $0xad
80107b46:	e9 ed f2 ff ff       	jmp    80106e38 <alltraps>

80107b4b <vector174>:
80107b4b:	6a 00                	push   $0x0
80107b4d:	68 ae 00 00 00       	push   $0xae
80107b52:	e9 e1 f2 ff ff       	jmp    80106e38 <alltraps>

80107b57 <vector175>:
80107b57:	6a 00                	push   $0x0
80107b59:	68 af 00 00 00       	push   $0xaf
80107b5e:	e9 d5 f2 ff ff       	jmp    80106e38 <alltraps>

80107b63 <vector176>:
80107b63:	6a 00                	push   $0x0
80107b65:	68 b0 00 00 00       	push   $0xb0
80107b6a:	e9 c9 f2 ff ff       	jmp    80106e38 <alltraps>

80107b6f <vector177>:
80107b6f:	6a 00                	push   $0x0
80107b71:	68 b1 00 00 00       	push   $0xb1
80107b76:	e9 bd f2 ff ff       	jmp    80106e38 <alltraps>

80107b7b <vector178>:
80107b7b:	6a 00                	push   $0x0
80107b7d:	68 b2 00 00 00       	push   $0xb2
80107b82:	e9 b1 f2 ff ff       	jmp    80106e38 <alltraps>

80107b87 <vector179>:
80107b87:	6a 00                	push   $0x0
80107b89:	68 b3 00 00 00       	push   $0xb3
80107b8e:	e9 a5 f2 ff ff       	jmp    80106e38 <alltraps>

80107b93 <vector180>:
80107b93:	6a 00                	push   $0x0
80107b95:	68 b4 00 00 00       	push   $0xb4
80107b9a:	e9 99 f2 ff ff       	jmp    80106e38 <alltraps>

80107b9f <vector181>:
80107b9f:	6a 00                	push   $0x0
80107ba1:	68 b5 00 00 00       	push   $0xb5
80107ba6:	e9 8d f2 ff ff       	jmp    80106e38 <alltraps>

80107bab <vector182>:
80107bab:	6a 00                	push   $0x0
80107bad:	68 b6 00 00 00       	push   $0xb6
80107bb2:	e9 81 f2 ff ff       	jmp    80106e38 <alltraps>

80107bb7 <vector183>:
80107bb7:	6a 00                	push   $0x0
80107bb9:	68 b7 00 00 00       	push   $0xb7
80107bbe:	e9 75 f2 ff ff       	jmp    80106e38 <alltraps>

80107bc3 <vector184>:
80107bc3:	6a 00                	push   $0x0
80107bc5:	68 b8 00 00 00       	push   $0xb8
80107bca:	e9 69 f2 ff ff       	jmp    80106e38 <alltraps>

80107bcf <vector185>:
80107bcf:	6a 00                	push   $0x0
80107bd1:	68 b9 00 00 00       	push   $0xb9
80107bd6:	e9 5d f2 ff ff       	jmp    80106e38 <alltraps>

80107bdb <vector186>:
80107bdb:	6a 00                	push   $0x0
80107bdd:	68 ba 00 00 00       	push   $0xba
80107be2:	e9 51 f2 ff ff       	jmp    80106e38 <alltraps>

80107be7 <vector187>:
80107be7:	6a 00                	push   $0x0
80107be9:	68 bb 00 00 00       	push   $0xbb
80107bee:	e9 45 f2 ff ff       	jmp    80106e38 <alltraps>

80107bf3 <vector188>:
80107bf3:	6a 00                	push   $0x0
80107bf5:	68 bc 00 00 00       	push   $0xbc
80107bfa:	e9 39 f2 ff ff       	jmp    80106e38 <alltraps>

80107bff <vector189>:
80107bff:	6a 00                	push   $0x0
80107c01:	68 bd 00 00 00       	push   $0xbd
80107c06:	e9 2d f2 ff ff       	jmp    80106e38 <alltraps>

80107c0b <vector190>:
80107c0b:	6a 00                	push   $0x0
80107c0d:	68 be 00 00 00       	push   $0xbe
80107c12:	e9 21 f2 ff ff       	jmp    80106e38 <alltraps>

80107c17 <vector191>:
80107c17:	6a 00                	push   $0x0
80107c19:	68 bf 00 00 00       	push   $0xbf
80107c1e:	e9 15 f2 ff ff       	jmp    80106e38 <alltraps>

80107c23 <vector192>:
80107c23:	6a 00                	push   $0x0
80107c25:	68 c0 00 00 00       	push   $0xc0
80107c2a:	e9 09 f2 ff ff       	jmp    80106e38 <alltraps>

80107c2f <vector193>:
80107c2f:	6a 00                	push   $0x0
80107c31:	68 c1 00 00 00       	push   $0xc1
80107c36:	e9 fd f1 ff ff       	jmp    80106e38 <alltraps>

80107c3b <vector194>:
80107c3b:	6a 00                	push   $0x0
80107c3d:	68 c2 00 00 00       	push   $0xc2
80107c42:	e9 f1 f1 ff ff       	jmp    80106e38 <alltraps>

80107c47 <vector195>:
80107c47:	6a 00                	push   $0x0
80107c49:	68 c3 00 00 00       	push   $0xc3
80107c4e:	e9 e5 f1 ff ff       	jmp    80106e38 <alltraps>

80107c53 <vector196>:
80107c53:	6a 00                	push   $0x0
80107c55:	68 c4 00 00 00       	push   $0xc4
80107c5a:	e9 d9 f1 ff ff       	jmp    80106e38 <alltraps>

80107c5f <vector197>:
80107c5f:	6a 00                	push   $0x0
80107c61:	68 c5 00 00 00       	push   $0xc5
80107c66:	e9 cd f1 ff ff       	jmp    80106e38 <alltraps>

80107c6b <vector198>:
80107c6b:	6a 00                	push   $0x0
80107c6d:	68 c6 00 00 00       	push   $0xc6
80107c72:	e9 c1 f1 ff ff       	jmp    80106e38 <alltraps>

80107c77 <vector199>:
80107c77:	6a 00                	push   $0x0
80107c79:	68 c7 00 00 00       	push   $0xc7
80107c7e:	e9 b5 f1 ff ff       	jmp    80106e38 <alltraps>

80107c83 <vector200>:
80107c83:	6a 00                	push   $0x0
80107c85:	68 c8 00 00 00       	push   $0xc8
80107c8a:	e9 a9 f1 ff ff       	jmp    80106e38 <alltraps>

80107c8f <vector201>:
80107c8f:	6a 00                	push   $0x0
80107c91:	68 c9 00 00 00       	push   $0xc9
80107c96:	e9 9d f1 ff ff       	jmp    80106e38 <alltraps>

80107c9b <vector202>:
80107c9b:	6a 00                	push   $0x0
80107c9d:	68 ca 00 00 00       	push   $0xca
80107ca2:	e9 91 f1 ff ff       	jmp    80106e38 <alltraps>

80107ca7 <vector203>:
80107ca7:	6a 00                	push   $0x0
80107ca9:	68 cb 00 00 00       	push   $0xcb
80107cae:	e9 85 f1 ff ff       	jmp    80106e38 <alltraps>

80107cb3 <vector204>:
80107cb3:	6a 00                	push   $0x0
80107cb5:	68 cc 00 00 00       	push   $0xcc
80107cba:	e9 79 f1 ff ff       	jmp    80106e38 <alltraps>

80107cbf <vector205>:
80107cbf:	6a 00                	push   $0x0
80107cc1:	68 cd 00 00 00       	push   $0xcd
80107cc6:	e9 6d f1 ff ff       	jmp    80106e38 <alltraps>

80107ccb <vector206>:
80107ccb:	6a 00                	push   $0x0
80107ccd:	68 ce 00 00 00       	push   $0xce
80107cd2:	e9 61 f1 ff ff       	jmp    80106e38 <alltraps>

80107cd7 <vector207>:
80107cd7:	6a 00                	push   $0x0
80107cd9:	68 cf 00 00 00       	push   $0xcf
80107cde:	e9 55 f1 ff ff       	jmp    80106e38 <alltraps>

80107ce3 <vector208>:
80107ce3:	6a 00                	push   $0x0
80107ce5:	68 d0 00 00 00       	push   $0xd0
80107cea:	e9 49 f1 ff ff       	jmp    80106e38 <alltraps>

80107cef <vector209>:
80107cef:	6a 00                	push   $0x0
80107cf1:	68 d1 00 00 00       	push   $0xd1
80107cf6:	e9 3d f1 ff ff       	jmp    80106e38 <alltraps>

80107cfb <vector210>:
80107cfb:	6a 00                	push   $0x0
80107cfd:	68 d2 00 00 00       	push   $0xd2
80107d02:	e9 31 f1 ff ff       	jmp    80106e38 <alltraps>

80107d07 <vector211>:
80107d07:	6a 00                	push   $0x0
80107d09:	68 d3 00 00 00       	push   $0xd3
80107d0e:	e9 25 f1 ff ff       	jmp    80106e38 <alltraps>

80107d13 <vector212>:
80107d13:	6a 00                	push   $0x0
80107d15:	68 d4 00 00 00       	push   $0xd4
80107d1a:	e9 19 f1 ff ff       	jmp    80106e38 <alltraps>

80107d1f <vector213>:
80107d1f:	6a 00                	push   $0x0
80107d21:	68 d5 00 00 00       	push   $0xd5
80107d26:	e9 0d f1 ff ff       	jmp    80106e38 <alltraps>

80107d2b <vector214>:
80107d2b:	6a 00                	push   $0x0
80107d2d:	68 d6 00 00 00       	push   $0xd6
80107d32:	e9 01 f1 ff ff       	jmp    80106e38 <alltraps>

80107d37 <vector215>:
80107d37:	6a 00                	push   $0x0
80107d39:	68 d7 00 00 00       	push   $0xd7
80107d3e:	e9 f5 f0 ff ff       	jmp    80106e38 <alltraps>

80107d43 <vector216>:
80107d43:	6a 00                	push   $0x0
80107d45:	68 d8 00 00 00       	push   $0xd8
80107d4a:	e9 e9 f0 ff ff       	jmp    80106e38 <alltraps>

80107d4f <vector217>:
80107d4f:	6a 00                	push   $0x0
80107d51:	68 d9 00 00 00       	push   $0xd9
80107d56:	e9 dd f0 ff ff       	jmp    80106e38 <alltraps>

80107d5b <vector218>:
80107d5b:	6a 00                	push   $0x0
80107d5d:	68 da 00 00 00       	push   $0xda
80107d62:	e9 d1 f0 ff ff       	jmp    80106e38 <alltraps>

80107d67 <vector219>:
80107d67:	6a 00                	push   $0x0
80107d69:	68 db 00 00 00       	push   $0xdb
80107d6e:	e9 c5 f0 ff ff       	jmp    80106e38 <alltraps>

80107d73 <vector220>:
80107d73:	6a 00                	push   $0x0
80107d75:	68 dc 00 00 00       	push   $0xdc
80107d7a:	e9 b9 f0 ff ff       	jmp    80106e38 <alltraps>

80107d7f <vector221>:
80107d7f:	6a 00                	push   $0x0
80107d81:	68 dd 00 00 00       	push   $0xdd
80107d86:	e9 ad f0 ff ff       	jmp    80106e38 <alltraps>

80107d8b <vector222>:
80107d8b:	6a 00                	push   $0x0
80107d8d:	68 de 00 00 00       	push   $0xde
80107d92:	e9 a1 f0 ff ff       	jmp    80106e38 <alltraps>

80107d97 <vector223>:
80107d97:	6a 00                	push   $0x0
80107d99:	68 df 00 00 00       	push   $0xdf
80107d9e:	e9 95 f0 ff ff       	jmp    80106e38 <alltraps>

80107da3 <vector224>:
80107da3:	6a 00                	push   $0x0
80107da5:	68 e0 00 00 00       	push   $0xe0
80107daa:	e9 89 f0 ff ff       	jmp    80106e38 <alltraps>

80107daf <vector225>:
80107daf:	6a 00                	push   $0x0
80107db1:	68 e1 00 00 00       	push   $0xe1
80107db6:	e9 7d f0 ff ff       	jmp    80106e38 <alltraps>

80107dbb <vector226>:
80107dbb:	6a 00                	push   $0x0
80107dbd:	68 e2 00 00 00       	push   $0xe2
80107dc2:	e9 71 f0 ff ff       	jmp    80106e38 <alltraps>

80107dc7 <vector227>:
80107dc7:	6a 00                	push   $0x0
80107dc9:	68 e3 00 00 00       	push   $0xe3
80107dce:	e9 65 f0 ff ff       	jmp    80106e38 <alltraps>

80107dd3 <vector228>:
80107dd3:	6a 00                	push   $0x0
80107dd5:	68 e4 00 00 00       	push   $0xe4
80107dda:	e9 59 f0 ff ff       	jmp    80106e38 <alltraps>

80107ddf <vector229>:
80107ddf:	6a 00                	push   $0x0
80107de1:	68 e5 00 00 00       	push   $0xe5
80107de6:	e9 4d f0 ff ff       	jmp    80106e38 <alltraps>

80107deb <vector230>:
80107deb:	6a 00                	push   $0x0
80107ded:	68 e6 00 00 00       	push   $0xe6
80107df2:	e9 41 f0 ff ff       	jmp    80106e38 <alltraps>

80107df7 <vector231>:
80107df7:	6a 00                	push   $0x0
80107df9:	68 e7 00 00 00       	push   $0xe7
80107dfe:	e9 35 f0 ff ff       	jmp    80106e38 <alltraps>

80107e03 <vector232>:
80107e03:	6a 00                	push   $0x0
80107e05:	68 e8 00 00 00       	push   $0xe8
80107e0a:	e9 29 f0 ff ff       	jmp    80106e38 <alltraps>

80107e0f <vector233>:
80107e0f:	6a 00                	push   $0x0
80107e11:	68 e9 00 00 00       	push   $0xe9
80107e16:	e9 1d f0 ff ff       	jmp    80106e38 <alltraps>

80107e1b <vector234>:
80107e1b:	6a 00                	push   $0x0
80107e1d:	68 ea 00 00 00       	push   $0xea
80107e22:	e9 11 f0 ff ff       	jmp    80106e38 <alltraps>

80107e27 <vector235>:
80107e27:	6a 00                	push   $0x0
80107e29:	68 eb 00 00 00       	push   $0xeb
80107e2e:	e9 05 f0 ff ff       	jmp    80106e38 <alltraps>

80107e33 <vector236>:
80107e33:	6a 00                	push   $0x0
80107e35:	68 ec 00 00 00       	push   $0xec
80107e3a:	e9 f9 ef ff ff       	jmp    80106e38 <alltraps>

80107e3f <vector237>:
80107e3f:	6a 00                	push   $0x0
80107e41:	68 ed 00 00 00       	push   $0xed
80107e46:	e9 ed ef ff ff       	jmp    80106e38 <alltraps>

80107e4b <vector238>:
80107e4b:	6a 00                	push   $0x0
80107e4d:	68 ee 00 00 00       	push   $0xee
80107e52:	e9 e1 ef ff ff       	jmp    80106e38 <alltraps>

80107e57 <vector239>:
80107e57:	6a 00                	push   $0x0
80107e59:	68 ef 00 00 00       	push   $0xef
80107e5e:	e9 d5 ef ff ff       	jmp    80106e38 <alltraps>

80107e63 <vector240>:
80107e63:	6a 00                	push   $0x0
80107e65:	68 f0 00 00 00       	push   $0xf0
80107e6a:	e9 c9 ef ff ff       	jmp    80106e38 <alltraps>

80107e6f <vector241>:
80107e6f:	6a 00                	push   $0x0
80107e71:	68 f1 00 00 00       	push   $0xf1
80107e76:	e9 bd ef ff ff       	jmp    80106e38 <alltraps>

80107e7b <vector242>:
80107e7b:	6a 00                	push   $0x0
80107e7d:	68 f2 00 00 00       	push   $0xf2
80107e82:	e9 b1 ef ff ff       	jmp    80106e38 <alltraps>

80107e87 <vector243>:
80107e87:	6a 00                	push   $0x0
80107e89:	68 f3 00 00 00       	push   $0xf3
80107e8e:	e9 a5 ef ff ff       	jmp    80106e38 <alltraps>

80107e93 <vector244>:
80107e93:	6a 00                	push   $0x0
80107e95:	68 f4 00 00 00       	push   $0xf4
80107e9a:	e9 99 ef ff ff       	jmp    80106e38 <alltraps>

80107e9f <vector245>:
80107e9f:	6a 00                	push   $0x0
80107ea1:	68 f5 00 00 00       	push   $0xf5
80107ea6:	e9 8d ef ff ff       	jmp    80106e38 <alltraps>

80107eab <vector246>:
80107eab:	6a 00                	push   $0x0
80107ead:	68 f6 00 00 00       	push   $0xf6
80107eb2:	e9 81 ef ff ff       	jmp    80106e38 <alltraps>

80107eb7 <vector247>:
80107eb7:	6a 00                	push   $0x0
80107eb9:	68 f7 00 00 00       	push   $0xf7
80107ebe:	e9 75 ef ff ff       	jmp    80106e38 <alltraps>

80107ec3 <vector248>:
80107ec3:	6a 00                	push   $0x0
80107ec5:	68 f8 00 00 00       	push   $0xf8
80107eca:	e9 69 ef ff ff       	jmp    80106e38 <alltraps>

80107ecf <vector249>:
80107ecf:	6a 00                	push   $0x0
80107ed1:	68 f9 00 00 00       	push   $0xf9
80107ed6:	e9 5d ef ff ff       	jmp    80106e38 <alltraps>

80107edb <vector250>:
80107edb:	6a 00                	push   $0x0
80107edd:	68 fa 00 00 00       	push   $0xfa
80107ee2:	e9 51 ef ff ff       	jmp    80106e38 <alltraps>

80107ee7 <vector251>:
80107ee7:	6a 00                	push   $0x0
80107ee9:	68 fb 00 00 00       	push   $0xfb
80107eee:	e9 45 ef ff ff       	jmp    80106e38 <alltraps>

80107ef3 <vector252>:
80107ef3:	6a 00                	push   $0x0
80107ef5:	68 fc 00 00 00       	push   $0xfc
80107efa:	e9 39 ef ff ff       	jmp    80106e38 <alltraps>

80107eff <vector253>:
80107eff:	6a 00                	push   $0x0
80107f01:	68 fd 00 00 00       	push   $0xfd
80107f06:	e9 2d ef ff ff       	jmp    80106e38 <alltraps>

80107f0b <vector254>:
80107f0b:	6a 00                	push   $0x0
80107f0d:	68 fe 00 00 00       	push   $0xfe
80107f12:	e9 21 ef ff ff       	jmp    80106e38 <alltraps>

80107f17 <vector255>:
80107f17:	6a 00                	push   $0x0
80107f19:	68 ff 00 00 00       	push   $0xff
80107f1e:	e9 15 ef ff ff       	jmp    80106e38 <alltraps>

80107f23 <lgdt>:
{
80107f23:	55                   	push   %ebp
80107f24:	89 e5                	mov    %esp,%ebp
80107f26:	83 ec 10             	sub    $0x10,%esp
  pd[0] = size-1;
80107f29:	8b 45 0c             	mov    0xc(%ebp),%eax
80107f2c:	48                   	dec    %eax
80107f2d:	66 89 45 fa          	mov    %ax,-0x6(%ebp)
  pd[1] = (uint)p;
80107f31:	8b 45 08             	mov    0x8(%ebp),%eax
80107f34:	66 89 45 fc          	mov    %ax,-0x4(%ebp)
  pd[2] = (uint)p >> 16;
80107f38:	8b 45 08             	mov    0x8(%ebp),%eax
80107f3b:	c1 e8 10             	shr    $0x10,%eax
80107f3e:	66 89 45 fe          	mov    %ax,-0x2(%ebp)
  asm volatile("lgdt (%0)" : : "r" (pd));
80107f42:	8d 45 fa             	lea    -0x6(%ebp),%eax
...
80107f4d:	83 ec 04             	sub    $0x4,%esp
80107f50:	8b 45 08             	mov    0x8(%ebp),%eax
80107f53:	66 89 45 fc          	mov    %ax,-0x4(%ebp)
  asm volatile("ltr %0" : : "r" (sel));
80107f57:	8b 45 fc             	mov    -0x4(%ebp),%eax
80107f5a:	0f 00 d8             	ltr    %ax
}
80107f5d:	c9                   	leave  
80107f5e:	c3                   	ret    
...
80107f68:	66 89 45 fc          	mov    %ax,-0x4(%ebp)
  asm volatile("movw %0, %%gs" : : "r" (v));
80107f6c:	8b 45 fc             	mov    -0x4(%ebp),%eax
80107f6f:	8e e8                	mov    %eax,%gs
}
80107f71:	c9                   	leave  
80107f72:	c3                   	ret    
...
80107f91:	05 00 00 00 80       	add    $0x80000000,%eax
80107f96:	5d                   	pop    %ebp
80107f97:	c3                   	ret    
...
80107f9c:	83 ec 24             	sub    $0x24,%esp
  ...
  c = &cpus[cpunum()];
80107f9f:	e8 a1 ae ff ff       	call   80102e45 <cpunum>
80107fa4:	89 c2                	mov    %eax,%edx
80107fa6:	89 d0                	mov    %edx,%eax
80107fa8:	d1 e0                	shl    %eax
80107faa:	01 d0                	add    %edx,%eax
80107fac:	c1 e0 04             	shl    $0x4,%eax
80107faf:	29 d0                	sub    %edx,%eax
80107fb1:	c1 e0 02             	shl    $0x2,%eax
80107fb4:	05 60 09 11 80       	add    $0x80110960,%eax
80107fb9:	89 45 f4             	mov    %eax,-0xc(%ebp)
  c->gdt[SEG_KCODE] = SEG(STA_X|STA_R, 0, 0xffffffff, 0);
80107fbc:	8b 45 f4             	mov    -0xc(%ebp),%eax
80107fbf:	66 c7 40 78 ff ff    	movw   $0xffff,0x78(%eax)
80107fc5:	8b 45 f4             	mov    -0xc(%ebp),%eax
80107fc8:	66 c7 40 7a 00 00    	movw   $0x0,0x7a(%eax)
80107fce:	8b 45 f4             	mov    -0xc(%ebp),%eax
80107fd1:	c6 40 7c 00          	movb   $0x0,0x7c(%eax)
80107fd5:	8b 45 f4             	mov    -0xc(%ebp),%eax
80107fd8:	8a 50 7d             	mov    0x7d(%eax),%dl
80107fdb:	83 e2 f0             	and    $0xfffffff0,%edx
80107fde:	83 ca 0a             	or     $0xa,%edx
80107fe1:	88 50 7d             	mov    %dl,0x7d(%eax)
80107fe4:	8b 45 f4             	mov    -0xc(%ebp),%eax
80107fe7:	8a 50 7d             	mov    0x7d(%eax),%dl
80107fea:	83 ca 10             	or     $0x10,%edx
80107fed:	88 50 7d             	mov    %dl,0x7d(%eax)
80107ff0:	8b 45 f4             	mov    -0xc(%ebp),%eax
80107ff3:	8a 50 7d             	mov    0x7d(%eax),%dl
80107ff6:	83 e2 9f             	and    $0xffffff9f,%edx
80107ff9:	88 50 7d             	mov    %dl,0x7d(%eax)
80107ffc:	8b 45 f4             	mov    -0xc(%ebp),%eax
80107fff:	8a 50 7d             	mov    0x7d(%eax),%dl
80108002:	83 ca 80             	or     $0xffffff80,%edx
80108005:	88 50 7d             	mov    %dl,0x7d(%eax)
80108008:	8b 45 f4             	mov    -0xc(%ebp),%eax
8010800b:	8a 50 7e             	mov    0x7e(%eax),%dl
8010800e:	83 ca 0f             	or     $0xf,%edx
80108011:	88 50 7e             	mov    %dl,0x7e(%eax)
80108014:	8b 45 f4             	mov    -0xc(%ebp),%eax
80108017:	8a 50 7e             	mov    0x7e(%eax),%dl
8010801a:	83 e2 ef             	and    $0xffffffef,%edx
8010801d:	88 50 7e             	mov    %dl,0x7e(%eax)
80108020:	8b 45 f4             	mov    -0xc(%ebp),%eax
80108023:	8a 50 7e             	mov    0x7e(%eax),%dl
80108026:	83 e2 df             	and    $0xffffffdf,%edx
80108029:	88 50 7e             	mov    %dl,0x7e(%eax)
8010802c:	8b 45 f4             	mov    -0xc(%ebp),%eax
8010802f:	8a 50 7e             	mov    0x7e(%eax),%dl
80108032:	83 ca 40             	or     $0x40,%edx
80108035:	88 50 7e             	mov    %dl,0x7e(%eax)
80108038:	8b 45 f4             	mov    -0xc(%ebp),%eax
8010803b:	8a 50 7e             	mov    0x7e(%eax),%dl
8010803e:	83 ca 80             	or     $0xffffff80,%edx
80108041:	88 50 7e             	mov    %dl,0x7e(%eax)
80108044:	8b 45 f4             	mov    -0xc(%ebp),%eax
80108047:	c6 40 7f 00          	movb   $0x0,0x7f(%eax)
  c->gdt[SEG_KDATA] = SEG(STA_W, 0, 0xffffffff, 0);
8010804b:	8b 45 f4             	mov    -0xc(%ebp),%eax
8010804e:	66 c7 80 80 00 00 00 	movw   $0xffff,0x80(%eax)
80108055:	ff ff 
80108057:	8b 45 f4             	mov    -0xc(%ebp),%eax
8010805a:	66 c7 80 82 00 00 00 	movw   $0x0,0x82(%eax)
80108061:	00 00 
80108063:	8b 45 f4             	mov    -0xc(%ebp),%eax
80108066:	c6 80 84 00 00 00 00 	movb   $0x0,0x84(%eax)
8010806d:	8b 45 f4             	mov    -0xc(%ebp),%eax
80108070:	8a 90 85 00 00 00    	mov    0x85(%eax),%dl
...
80108085:	8a 90 85 00 00 00    	mov    0x85(%eax),%dl
8010808b:	83 ca 10             	or     $0x10,%edx
8010808e:	88 90 85 00 00 00    	mov    %dl,0x85(%eax)
80108094:	8b 45 f4             	mov    -0xc(%ebp),%eax
80108097:	8a 90 85 00 00 00    	mov    0x85(%eax),%dl
8010809d:	83 e2 9f             	and    $0xffffff9f,%edx
801080a0:	88 90 85 00 00 00    	mov    %dl,0x85(%eax)
801080a6:	8b 45 f4             	mov    -0xc(%ebp),%eax
801080a9:	8a 90 85 00 00 00    	mov    0x85(%eax),%dl
801080af:	83 ca 80             	or     $0xffffff80,%edx
801080b2:	88 90 85 00 00 00    	mov    %dl,0x85(%eax)
801080b8:	8b 45 f4             	mov    -0xc(%ebp),%eax
801080bb:	8a 90 86 00 00 00    	mov    0x86(%eax),%dl
801080c1:	83 ca 0f             	or     $0xf,%edx
801080c4:	88 90 86 00 00 00    	mov    %dl,0x86(%eax)
801080ca:	8b 45 f4             	mov    -0xc(%ebp),%eax
801080cd:	8a 90 86 00 00 00    	mov    0x86(%eax),%dl
801080d3:	83 e2 ef             	and    $0xffffffef,%edx
801080d6:	88 90 86 00 00 00    	mov    %dl,0x86(%eax)
801080dc:	8b 45 f4             	mov    -0xc(%ebp),%eax
801080df:	8a 90 86 00 00 00    	mov    0x86(%eax),%dl
801080e5:	83 e2 df             	and    $0xffffffdf,%edx
801080e8:	88 90 86 00 00 00    	mov    %dl,0x86(%eax)
801080ee:	8b 45 f4             	mov    -0xc(%ebp),%eax
801080f1:	8a 90 86 00 00 00    	mov    0x86(%eax),%dl
801080f7:	83 ca 40             	or     $0x40,%edx
801080fa:	88 90 86 00 00 00    	mov    %dl,0x86(%eax)
80108100:	8b 45 f4             	mov    -0xc(%ebp),%eax
80108103:	8a 90 86 00 00 00    	mov    0x86(%eax),%dl
80108109:	83 ca 80             	or     $0xffffff80,%edx
8010810c:	88 90 86 00 00 00    	mov    %dl,0x86(%eax)
80108112:	8b 45 f4             	mov    -0xc(%ebp),%eax
80108115:	c6 80 87 00 00 00 00 	movb   $0x0,0x87(%eax)
...
80108141:	8a 90 95 00 00 00    	mov    0x95(%eax),%dl
80108147:	83 e2 f0             	and    $0xfffffff0,%edx
8010814a:	83 ca 0a             	or     $0xa,%edx
8010814d:	88 90 95 00 00 00    	mov    %dl,0x95(%eax)
80108153:	8b 45 f4             	mov    -0xc(%ebp),%eax
80108156:	8a 90 95 00 00 00    	mov    0x95(%eax),%dl
8010815c:	83 ca 10             	or     $0x10,%edx
8010815f:	88 90 95 00 00 00    	mov    %dl,0x95(%eax)
80108165:	8b 45 f4             	mov    -0xc(%ebp),%eax
80108168:	8a 90 95 00 00 00    	mov    0x95(%eax),%dl
8010816e:	83 ca 60             	or     $0x60,%edx
80108171:	88 90 95 00 00 00    	mov    %dl,0x95(%eax)
80108177:	8b 45 f4             	mov    -0xc(%ebp),%eax
8010817a:	8a 90 95 00 00 00    	mov    0x95(%eax),%dl
80108180:	83 ca 80             	or     $0xffffff80,%edx
80108183:	88 90 95 00 00 00    	mov    %dl,0x95(%eax)
80108189:	8b 45 f4             	mov    -0xc(%ebp),%eax
8010818c:	8a 90 96 00 00 00    	mov    0x96(%eax),%dl
80108192:	83 ca 0f             	or     $0xf,%edx
80108195:	88 90 96 00 00 00    	mov    %dl,0x96(%eax)
8010819b:	8b 45 f4             	mov    -0xc(%ebp),%eax
8010819e:	8a 90 96 00 00 00    	mov    0x96(%eax),%dl
801081a4:	83 e2 ef             	and    $0xffffffef,%edx
801081a7:	88 90 96 00 00 00    	mov    %dl,0x96(%eax)
801081ad:	8b 45 f4             	mov    -0xc(%ebp),%eax
801081b0:	8a 90 96 00 00 00    	mov    0x96(%eax),%dl
801081b6:	83 e2 df             	and    $0xffffffdf,%edx
801081b9:	88 90 96 00 00 00    	mov    %dl,0x96(%eax)
801081bf:	8b 45 f4             	mov    -0xc(%ebp),%eax
801081c2:	8a 90 96 00 00 00    	mov    0x96(%eax),%dl
801081c8:	83 ca 40             	or     $0x40,%edx
801081cb:	88 90 96 00 00 00    	mov    %dl,0x96(%eax)
801081d1:	8b 45 f4             	mov    -0xc(%ebp),%eax
801081d4:	8a 90 96 00 00 00    	mov    0x96(%eax),%dl
801081da:	83 ca 80             	or     $0xffffff80,%edx
801081dd:	88 90 96 00 00 00    	mov    %dl,0x96(%eax)
801081e3:	8b 45 f4             	mov    -0xc(%ebp),%eax
801081e6:	c6 80 97 00 00 00 00 	movb   $0x0,0x97(%eax)
  c->gdt[SEG_UDATA] = SEG(STA_W, 0, 0xffffffff, DPL_USER);
801081ed:	8b 45 f4             	mov    -0xc(%ebp),%eax
801081f0:	66 c7 80 98 00 00 00 	movw   $0xffff,0x98(%eax)
801081f7:	ff ff 
801081f9:	8b 45 f4             	mov    -0xc(%ebp),%eax
801081fc:	66 c7 80 9a 00 00 00 	movw   $0x0,0x9a(%eax)
80108203:	00 00 
80108205:	8b 45 f4             	mov    -0xc(%ebp),%eax
80108208:	c6 80 9c 00 00 00 00 	movb   $0x0,0x9c(%eax)
8010820f:	8b 45 f4             	mov    -0xc(%ebp),%eax
80108212:	8a 90 9d 00 00 00    	mov    0x9d(%eax),%dl
80108218:	83 e2 f0             	and    $0xfffffff0,%edx
8010821b:	83 ca 02             	or     $0x2,%edx
8010821e:	88 90 9d 00 00 00    	mov    %dl,0x9d(%eax)
80108224:	8b 45 f4             	mov    -0xc(%ebp),%eax
80108227:	8a 90 9d 00 00 00    	mov    0x9d(%eax),%dl
8010822d:	83 ca 10             	or     $0x10,%edx
80108230:	88 90 9d 00 00 00    	mov    %dl,0x9d(%eax)
80108236:	8b 45 f4             	mov    -0xc(%ebp),%eax
80108239:	8a 90 9d 00 00 00    	mov    0x9d(%eax),%dl
8010823f:	83 ca 60             	or     $0x60,%edx
80108242:	88 90 9d 00 00 00    	mov    %dl,0x9d(%eax)
80108248:	8b 45 f4             	mov    -0xc(%ebp),%eax
8010824b:	8a 90 9d 00 00 00    	mov    0x9d(%eax),%dl
80108251:	83 ca 80             	or     $0xffffff80,%edx
80108254:	88 90 9d 00 00 00    	mov    %dl,0x9d(%eax)
8010825a:	8b 45 f4             	mov    -0xc(%ebp),%eax
8010825d:	8a 90 9e 00 00 00    	mov    0x9e(%eax),%dl
80108263:	83 ca 0f             	or     $0xf,%edx
80108266:	88 90 9e 00 00 00    	mov    %dl,0x9e(%eax)
8010826c:	8b 45 f4             	mov    -0xc(%ebp),%eax
8010826f:	8a 90 9e 00 00 00    	mov    0x9e(%eax),%dl
80108275:	83 e2 ef             	and    $0xffffffef,%edx
80108278:	88 90 9e 00 00 00    	mov    %dl,0x9e(%eax)
8010827e:	8b 45 f4             	mov    -0xc(%ebp),%eax
80108281:	8a 90 9e 00 00 00    	mov    0x9e(%eax),%dl
80108287:	83 e2 df             	and    $0xffffffdf,%edx
8010828a:	88 90 9e 00 00 00    	mov    %dl,0x9e(%eax)
80108290:	8b 45 f4             	mov    -0xc(%ebp),%eax
80108293:	8a 90 9e 00 00 00    	mov    0x9e(%eax),%dl
80108299:	83 ca 40             	or     $0x40,%edx
8010829c:	88 90 9e 00 00 00    	mov    %dl,0x9e(%eax)
801082a2:	8b 45 f4             	mov    -0xc(%ebp),%eax
801082a5:	8a 90 9e 00 00 00    	mov    0x9e(%eax),%dl
801082ab:	83 ca 80             	or     $0xffffff80,%edx
801082ae:	88 90 9e 00 00 00    	mov    %dl,0x9e(%eax)
801082b4:	8b 45 f4             	mov    -0xc(%ebp),%eax
801082b7:	c6 80 9f 00 00 00 00 	movb   $0x0,0x9f(%eax)

  // Map cpu, and curproc
  c->gdt[SEG_KCPU] = SEG(STA_W, &c->cpu, 8, 0);
801082be:	8b 45 f4             	mov    -0xc(%ebp),%eax
801082c1:	05 b4 00 00 00       	add    $0xb4,%eax
801082c6:	8b 55 f4             	mov    -0xc(%ebp),%edx
801082c9:	81 c2 b4 00 00 00    	add    $0xb4,%edx
801082cf:	c1 ea 10             	shr    $0x10,%edx
801082d2:	88 d1                	mov    %dl,%cl
801082d4:	8b 55 f4             	mov    -0xc(%ebp),%edx
801082d7:	81 c2 b4 00 00 00    	add    $0xb4,%edx
801082dd:	c1 ea 18             	shr    $0x18,%edx
801082e0:	8b 5d f4             	mov    -0xc(%ebp),%ebx
801082e3:	66 c7 83 88 00 00 00 	movw   $0x0,0x88(%ebx)
801082ea:	00 00 
801082ec:	8b 5d f4             	mov    -0xc(%ebp),%ebx
801082ef:	66 89 83 8a 00 00 00 	mov    %ax,0x8a(%ebx)
801082f6:	8b 45 f4             	mov    -0xc(%ebp),%eax
801082f9:	88 88 8c 00 00 00    	mov    %cl,0x8c(%eax)
801082ff:	8b 45 f4             	mov    -0xc(%ebp),%eax
80108302:	8a 88 8d 00 00 00    	mov    0x8d(%eax),%cl
80108308:	83 e1 f0             	and    $0xfffffff0,%ecx
8010830b:	83 c9 02             	or     $0x2,%ecx
8010830e:	88 88 8d 00 00 00    	mov    %cl,0x8d(%eax)
80108314:	8b 45 f4             	mov    -0xc(%ebp),%eax
80108317:	8a 88 8d 00 00 00    	mov    0x8d(%eax),%cl
8010831d:	83 c9 10             	or     $0x10,%ecx
80108320:	88 88 8d 00 00 00    	mov    %cl,0x8d(%eax)
80108326:	8b 45 f4             	mov    -0xc(%ebp),%eax
80108329:	8a 88 8d 00 00 00    	mov    0x8d(%eax),%cl
8010832f:	83 e1 9f             	and    $0xffffff9f,%ecx
80108332:	88 88 8d 00 00 00    	mov    %cl,0x8d(%eax)
80108338:	8b 45 f4             	mov    -0xc(%ebp),%eax
8010833b:	8a 88 8d 00 00 00    	mov    0x8d(%eax),%cl
80108341:	83 c9 80             	or     $0xffffff80,%ecx
80108344:	88 88 8d 00 00 00    	mov    %cl,0x8d(%eax)
8010834a:	8b 45 f4             	mov    -0xc(%ebp),%eax
8010834d:	8a 88 8e 00 00 00    	mov    0x8e(%eax),%cl
80108353:	83 e1 f0             	and    $0xfffffff0,%ecx
80108356:	88 88 8e 00 00 00    	mov    %cl,0x8e(%eax)
8010835c:	8b 45 f4             	mov    -0xc(%ebp),%eax
8010835f:	8a 88 8e 00 00 00    	mov    0x8e(%eax),%cl
80108365:	83 e1 ef             	and    $0xffffffef,%ecx
80108368:	88 88 8e 00 00 00    	mov    %cl,0x8e(%eax)
8010836e:	8b 45 f4             	mov    -0xc(%ebp),%eax
80108371:	8a 88 8e 00 00 00    	mov    0x8e(%eax),%cl
80108377:	83 e1 df             	and    $0xffffffdf,%ecx
8010837a:	88 88 8e 00 00 00    	mov    %cl,0x8e(%eax)
80108380:	8b 45 f4             	mov    -0xc(%ebp),%eax
80108383:	8a 88 8e 00 00 00    	mov    0x8e(%eax),%cl
80108389:	83 c9 40             	or     $0x40,%ecx
8010838c:	88 88 8e 00 00 00    	mov    %cl,0x8e(%eax)
80108392:	8b 45 f4             	mov    -0xc(%ebp),%eax
80108395:	8a 88 8e 00 00 00    	mov    0x8e(%eax),%cl
8010839b:	83 c9 80             	or     $0xffffff80,%ecx
8010839e:	88 88 8e 00 00 00    	mov    %cl,0x8e(%eax)
801083a4:	8b 45 f4             	mov    -0xc(%ebp),%eax
801083a7:	88 90 8f 00 00 00    	mov    %dl,0x8f(%eax)

  lgdt(c->gdt, sizeof(c->gdt));
801083ad:	8b 45 f4             	mov    -0xc(%ebp),%eax
801083b0:	83 c0 70             	add    $0x70,%eax
801083b3:	c7 44 24 04 38 00 00 	movl   $0x38,0x4(%esp)
801083ba:	00 
801083bb:	89 04 24             	mov    %eax,(%esp)
801083be:	e8 60 fb ff ff       	call   80107f23 <lgdt>
  loadgs(SEG_KCPU << 3);
801083c3:	c7 04 24 18 00 00 00 	movl   $0x18,(%esp)
801083ca:	e8 90 fb ff ff       	call   80107f5f <loadgs>
  
  // Initialize cpu-local storage.
  cpu = c;
801083cf:	8b 45 f4             	mov    -0xc(%ebp),%eax
801083d2:	65 a3 00 00 00 00    	mov    %eax,%gs:0x0
  proc = 0;
801083d8:	65 c7 05 04 00 00 00 	movl   $0x0,%gs:0x4
801083df:	00 00 00 00 
}
801083e3:	83 c4 24             	add    $0x24,%esp
801083e6:	5b                   	pop    %ebx
801083e7:	5d                   	pop    %ebp
801083e8:	c3                   	ret    
...
801083ec:	83 ec 28             	sub    $0x28,%esp
  pde_t *pde;
  pte_t *pgtab;

  pde = &pgdir[PDX(va)];
801083ef:	8b 45 0c             	mov    0xc(%ebp),%eax
801083f2:	c1 e8 16             	shr    $0x16,%eax
801083f5:	8d 14 85 00 00 00 00 	lea    0x0(,%eax,4),%edx
...
80108409:	83 e0 01             	and    $0x1,%eax
8010840c:	85 c0                	test   %eax,%eax
8010840e:	74 17                	je     80108427 <walkpgdir+0x3e>
...
8010841d:	e8 69 fb ff ff       	call   80107f8b <p2v>
80108422:	89 45 f4             	mov    %eax,-0xc(%ebp)
80108425:	eb 4b                	jmp    80108472 <walkpgdir+0x89>
  } else {
    if(!alloc || (pgtab = (pte_t*)kalloc()) == 0) // kalloc es 0 cuando no puede asignar la memoria.
80108427:	83 7d 10 00          	cmpl   $0x0,0x10(%ebp)
8010842b:	74 0e                	je     8010843b <walkpgdir+0x52>
8010842d:	e8 8c a6 ff ff       	call   80102abe <kalloc>
80108432:	89 45 f4             	mov    %eax,-0xc(%ebp)
80108435:	83 7d f4 00          	cmpl   $0x0,-0xc(%ebp)
80108439:	75 07                	jne    80108442 <walkpgdir+0x59>
      return 0;
8010843b:	b8 00 00 00 00       	mov    $0x0,%eax
80108440:	eb 47                	jmp    80108489 <walkpgdir+0xa0>
...
80108458:	e8 9e d3 ff ff       	call   801057fb <memset>
...
80108463:	e8 16 fb ff ff       	call   80107f7e <v2p>
80108468:	89 c2                	mov    %eax,%edx
8010846a:	83 ca 07             	or     $0x7,%edx
8010846d:	8b 45 f0             	mov    -0x10(%ebp),%eax
80108470:	89 10                	mov    %edx,(%eax)
  }
  return &pgtab[PTX(va)]; // PTX (va) me retorna un index de la tabla de pagina, que luego aplicando, &pgtab[..] me retorna su direccion. 
80108472:	8b 45 0c             	mov    0xc(%ebp),%eax
80108475:	c1 e8 0c             	shr    $0xc,%eax
80108478:	25 ff 03 00 00       	and    $0x3ff,%eax
...
801084ad:	c7 44 24 08 01 00 00 	movl   $0x1,0x8(%esp)
801084b4:	00 
...
801084c2:	e8 22 ff ff ff       	call   801083e9 <walkpgdir>
801084c7:	89 45 ec             	mov    %eax,-0x14(%ebp)
801084ca:	83 7d ec 00          	cmpl   $0x0,-0x14(%ebp)
801084ce:	75 07                	jne    801084d7 <mappages+0x4c>
...
801084d5:	eb 46                	jmp    8010851d <mappages+0x92>
    if(*pte & PTE_P)
801084d7:	8b 45 ec             	mov    -0x14(%ebp),%eax
801084da:	8b 00                	mov    (%eax),%eax
801084dc:	83 e0 01             	and    $0x1,%eax
801084df:	85 c0                	test   %eax,%eax
801084e1:	74 0c                	je     801084ef <mappages+0x64>
      panic("remap");
801084e3:	c7 04 24 2c 94 10 80 	movl   $0x8010942c,(%esp)
801084ea:	e8 47 80 ff ff       	call   80100536 <panic>
    *pte = pa | perm | PTE_P;
801084ef:	8b 45 18             	mov    0x18(%ebp),%eax
801084f2:	0b 45 14             	or     0x14(%ebp),%eax
801084f5:	89 c2                	mov    %eax,%edx
801084f7:	83 ca 01             	or     $0x1,%edx
801084fa:	8b 45 ec             	mov    -0x14(%ebp),%eax
801084fd:	89 10                	mov    %edx,(%eax)
    if(a == last)
801084ff:	8b 45 f4             	mov    -0xc(%ebp),%eax
80108502:	3b 45 f0             	cmp    -0x10(%ebp),%eax
80108505:	74 10                	je     80108517 <mappages+0x8c>
      break;
    a += PGSIZE;
80108507:	81 45 f4 00 10 00 00 	addl   $0x1000,-0xc(%ebp)
    pa += PGSIZE;
8010850e:	81 45 14 00 10 00 00 	addl   $0x1000,0x14(%ebp)
  }
80108515:	eb 96                	jmp    801084ad <mappages+0x22>
      break;
80108517:	90                   	nop
  return 0;
80108518:	b8 00 00 00 00       	mov    $0x0,%eax
}
8010851d:	c9                   	leave  
8010851e:	c3                   	ret    
...
80108523:	83 ec 34             	sub    $0x34,%esp
  pde_t *pgdir;
  struct kmap *k;

  if((pgdir = (pde_t*)kalloc()) == 0)
80108526:	e8 93 a5 ff ff       	call   80102abe <kalloc>
8010852b:	89 45 f0             	mov    %eax,-0x10(%ebp)
8010852e:	83 7d f0 00          	cmpl   $0x0,-0x10(%ebp)
80108532:	75 0a                	jne    8010853e <setupkvm+0x1f>
    return 0;
80108534:	b8 00 00 00 00       	mov    $0x0,%eax
80108539:	e9 98 00 00 00       	jmp    801085d6 <setupkvm+0xb7>
  memset(pgdir, 0, PGSIZE);
8010853e:	c7 44 24 08 00 10 00 	movl   $0x1000,0x8(%esp)
80108545:	00 
80108546:	c7 44 24 04 00 00 00 	movl   $0x0,0x4(%esp)
8010854d:	00 
8010854e:	8b 45 f0             	mov    -0x10(%ebp),%eax
80108551:	89 04 24             	mov    %eax,(%esp)
80108554:	e8 a2 d2 ff ff       	call   801057fb <memset>
  if (p2v(PHYSTOP) > (void*)DEVSPACE)
80108559:	c7 04 24 00 00 00 0e 	movl   $0xe000000,(%esp)
80108560:	e8 26 fa ff ff       	call   80107f8b <p2v>
80108565:	3d 00 00 00 fe       	cmp    $0xfe000000,%eax
8010856a:	76 0c                	jbe    80108578 <setupkvm+0x59>
    panic("PHYSTOP too high");
8010856c:	c7 04 24 32 94 10 80 	movl   $0x80109432,(%esp)
80108573:	e8 be 7f ff ff       	call   80100536 <panic>
  for(k = kmap; k < &kmap[NELEM(kmap)]; k++)
80108578:	c7 45 f4 e0 c4 10 80 	movl   $0x8010c4e0,-0xc(%ebp)
8010857f:	eb 49                	jmp    801085ca <setupkvm+0xab>
    if(mappages(pgdir, k->virt, k->phys_end - k->phys_start, 
                (uint)k->phys_start, k->perm) < 0)
80108581:	8b 45 f4             	mov    -0xc(%ebp),%eax
    if(mappages(pgdir, k->virt, k->phys_end - k->phys_start, 
80108584:	8b 48 0c             	mov    0xc(%eax),%ecx
                (uint)k->phys_start, k->perm) < 0)
80108587:	8b 45 f4             	mov    -0xc(%ebp),%eax
    if(mappages(pgdir, k->virt, k->phys_end - k->phys_start, 
8010858a:	8b 50 04             	mov    0x4(%eax),%edx
8010858d:	8b 45 f4             	mov    -0xc(%ebp),%eax
80108590:	8b 58 08             	mov    0x8(%eax),%ebx
80108593:	8b 45 f4             	mov    -0xc(%ebp),%eax
80108596:	8b 40 04             	mov    0x4(%eax),%eax
80108599:	29 c3                	sub    %eax,%ebx
8010859b:	8b 45 f4             	mov    -0xc(%ebp),%eax
8010859e:	8b 00                	mov    (%eax),%eax
801085a0:	89 4c 24 10          	mov    %ecx,0x10(%esp)
801085a4:	89 54 24 0c          	mov    %edx,0xc(%esp)
801085a8:	89 5c 24 08          	mov    %ebx,0x8(%esp)
801085ac:	89 44 24 04          	mov    %eax,0x4(%esp)
801085b0:	8b 45 f0             	mov    -0x10(%ebp),%eax
801085b3:	89 04 24             	mov    %eax,(%esp)
801085b6:	e8 d0 fe ff ff       	call   8010848b <mappages>
801085bb:	85 c0                	test   %eax,%eax
801085bd:	79 07                	jns    801085c6 <setupkvm+0xa7>
      return 0;
801085bf:	b8 00 00 00 00       	mov    $0x0,%eax
801085c4:	eb 10                	jmp    801085d6 <setupkvm+0xb7>
  for(k = kmap; k < &kmap[NELEM(kmap)]; k++)
801085c6:	83 45 f4 10          	addl   $0x10,-0xc(%ebp)
801085ca:	81 7d f4 20 c5 10 80 	cmpl   $0x8010c520,-0xc(%ebp)
801085d1:	72 ae                	jb     80108581 <setupkvm+0x62>
  return pgdir;
801085d3:	8b 45 f0             	mov    -0x10(%ebp),%eax
}
801085d6:	83 c4 34             	add    $0x34,%esp
801085d9:	5b                   	pop    %ebx
801085da:	5d                   	pop    %ebp
801085db:	c3                   	ret    
...
801085df:	83 ec 08             	sub    $0x8,%esp
  kpgdir = setupkvm();
801085e2:	e8 38 ff ff ff       	call   8010851f <setupkvm>
801085e7:	a3 b8 44 11 80       	mov    %eax,0x801144b8
  switchkvm();
801085ec:	e8 02 00 00 00       	call   801085f3 <switchkvm>
}
801085f1:	c9                   	leave  
801085f2:	c3                   	ret    
...
801085f9:	a1 b8 44 11 80       	mov    0x801144b8,%eax
801085fe:	89 04 24             	mov    %eax,(%esp)
80108601:	e8 78 f9 ff ff       	call   80107f7e <v2p>
80108606:	89 04 24             	mov    %eax,(%esp)
80108609:	e8 65 f9 ff ff       	call   80107f73 <lcr3>
}
8010860e:	c9                   	leave  
8010860f:	c3                   	ret    
...
80108614:	83 ec 14             	sub    $0x14,%esp
  pushcli();
80108617:	e8 df d0 ff ff       	call   801056fb <pushcli>
  cpu->gdt[SEG_TSS] = SEG16(STS_T32A, &cpu->ts, sizeof(cpu->ts)-1, 0);
8010861c:	65 a1 00 00 00 00    	mov    %gs:0x0,%eax
80108622:	65 8b 15 00 00 00 00 	mov    %gs:0x0,%edx
80108629:	83 c2 08             	add    $0x8,%edx
8010862c:	65 8b 0d 00 00 00 00 	mov    %gs:0x0,%ecx
80108633:	83 c1 08             	add    $0x8,%ecx
80108636:	c1 e9 10             	shr    $0x10,%ecx
80108639:	88 cb                	mov    %cl,%bl
8010863b:	65 8b 0d 00 00 00 00 	mov    %gs:0x0,%ecx
80108642:	83 c1 08             	add    $0x8,%ecx
80108645:	c1 e9 18             	shr    $0x18,%ecx
80108648:	66 c7 80 a0 00 00 00 	movw   $0x67,0xa0(%eax)
8010864f:	67 00 
80108651:	66 89 90 a2 00 00 00 	mov    %dx,0xa2(%eax)
80108658:	88 98 a4 00 00 00    	mov    %bl,0xa4(%eax)
8010865e:	8a 90 a5 00 00 00    	mov    0xa5(%eax),%dl
80108664:	83 e2 f0             	and    $0xfffffff0,%edx
80108667:	83 ca 09             	or     $0x9,%edx
8010866a:	88 90 a5 00 00 00    	mov    %dl,0xa5(%eax)
80108670:	8a 90 a5 00 00 00    	mov    0xa5(%eax),%dl
80108676:	83 ca 10             	or     $0x10,%edx
80108679:	88 90 a5 00 00 00    	mov    %dl,0xa5(%eax)
8010867f:	8a 90 a5 00 00 00    	mov    0xa5(%eax),%dl
80108685:	83 e2 9f             	and    $0xffffff9f,%edx
80108688:	88 90 a5 00 00 00    	mov    %dl,0xa5(%eax)
8010868e:	8a 90 a5 00 00 00    	mov    0xa5(%eax),%dl
80108694:	83 ca 80             	or     $0xffffff80,%edx
80108697:	88 90 a5 00 00 00    	mov    %dl,0xa5(%eax)
8010869d:	8a 90 a6 00 00 00    	mov    0xa6(%eax),%dl
801086a3:	83 e2 f0             	and    $0xfffffff0,%edx
801086a6:	88 90 a6 00 00 00    	mov    %dl,0xa6(%eax)
801086ac:	8a 90 a6 00 00 00    	mov    0xa6(%eax),%dl
801086b2:	83 e2 ef             	and    $0xffffffef,%edx
801086b5:	88 90 a6 00 00 00    	mov    %dl,0xa6(%eax)
801086bb:	8a 90 a6 00 00 00    	mov    0xa6(%eax),%dl
801086c1:	83 e2 df             	and    $0xffffffdf,%edx
801086c4:	88 90 a6 00 00 00    	mov    %dl,0xa6(%eax)
801086ca:	8a 90 a6 00 00 00    	mov    0xa6(%eax),%dl
801086d0:	83 ca 40             	or     $0x40,%edx
801086d3:	88 90 a6 00 00 00    	mov    %dl,0xa6(%eax)
801086d9:	8a 90 a6 00 00 00    	mov    0xa6(%eax),%dl
801086df:	83 e2 7f             	and    $0x7f,%edx
801086e2:	88 90 a6 00 00 00    	mov    %dl,0xa6(%eax)
801086e8:	88 88 a7 00 00 00    	mov    %cl,0xa7(%eax)
  cpu->gdt[SEG_TSS].s = 0;
801086ee:	65 a1 00 00 00 00    	mov    %gs:0x0,%eax
801086f4:	8a 90 a5 00 00 00    	mov    0xa5(%eax),%dl
801086fa:	83 e2 ef             	and    $0xffffffef,%edx
801086fd:	88 90 a5 00 00 00    	mov    %dl,0xa5(%eax)
  cpu->ts.ss0 = SEG_KDATA << 3;
80108703:	65 a1 00 00 00 00    	mov    %gs:0x0,%eax
80108709:	66 c7 40 10 10 00    	movw   $0x10,0x10(%eax)
  cpu->ts.esp0 = (uint)proc->kstack + KSTACKSIZE;
8010870f:	65 a1 00 00 00 00    	mov    %gs:0x0,%eax
80108715:	65 8b 15 04 00 00 00 	mov    %gs:0x4,%edx
8010871c:	8b 52 08             	mov    0x8(%edx),%edx
8010871f:	81 c2 00 10 00 00    	add    $0x1000,%edx
80108725:	89 50 0c             	mov    %edx,0xc(%eax)
  ltr(SEG_TSS << 3);
80108728:	c7 04 24 30 00 00 00 	movl   $0x30,(%esp)
8010872f:	e8 16 f8 ff ff       	call   80107f4a <ltr>
  if(p->pgdir == 0)
80108734:	8b 45 08             	mov    0x8(%ebp),%eax
80108737:	8b 40 04             	mov    0x4(%eax),%eax
8010873a:	85 c0                	test   %eax,%eax
8010873c:	75 0c                	jne    8010874a <switchuvm+0x13a>
    panic("switchuvm: no pgdir");
8010873e:	c7 04 24 43 94 10 80 	movl   $0x80109443,(%esp)
80108745:	e8 ec 7d ff ff       	call   80100536 <panic>
  lcr3(v2p(p->pgdir));  // switch to new address space
8010874a:	8b 45 08             	mov    0x8(%ebp),%eax
8010874d:	8b 40 04             	mov    0x4(%eax),%eax
80108750:	89 04 24             	mov    %eax,(%esp)
80108753:	e8 26 f8 ff ff       	call   80107f7e <v2p>
80108758:	89 04 24             	mov    %eax,(%esp)
8010875b:	e8 13 f8 ff ff       	call   80107f73 <lcr3>
  popcli();
80108760:	e8 dc cf ff ff       	call   80105741 <popcli>
}
80108765:	83 c4 14             	add    $0x14,%esp
80108768:	5b                   	pop    %ebx
80108769:	5d                   	pop    %ebp
8010876a:	c3                   	ret    
...
8010876e:	83 ec 38             	sub    $0x38,%esp
  ...
  if(sz >= PGSIZE)
80108771:	81 7d 10 ff 0f 00 00 	cmpl   $0xfff,0x10(%ebp)
80108778:	76 0c                	jbe    80108786 <inituvm+0x1b>
    panic("inituvm: more than a page");
8010877a:	c7 04 24 57 94 10 80 	movl   $0x80109457,(%esp)
80108781:	e8 b0 7d ff ff       	call   80100536 <panic>
  mem = kalloc();
80108786:	e8 33 a3 ff ff       	call   80102abe <kalloc>
8010878b:	89 45 f4             	mov    %eax,-0xc(%ebp)
  memset(mem, 0, PGSIZE);
8010878e:	c7 44 24 08 00 10 00 	movl   $0x1000,0x8(%esp)
80108795:	00 
80108796:	c7 44 24 04 00 00 00 	movl   $0x0,0x4(%esp)
8010879d:	00 
8010879e:	8b 45 f4             	mov    -0xc(%ebp),%eax
801087a1:	89 04 24             	mov    %eax,(%esp)
801087a4:	e8 52 d0 ff ff       	call   801057fb <memset>
  mappages(pgdir, 0, PGSIZE, v2p(mem), PTE_W|PTE_U);
801087a9:	8b 45 f4             	mov    -0xc(%ebp),%eax
801087ac:	89 04 24             	mov    %eax,(%esp)
801087af:	e8 ca f7 ff ff       	call   80107f7e <v2p>
801087b4:	c7 44 24 10 06 00 00 	movl   $0x6,0x10(%esp)
801087bb:	00 
801087bc:	89 44 24 0c          	mov    %eax,0xc(%esp)
801087c0:	c7 44 24 08 00 10 00 	movl   $0x1000,0x8(%esp)
801087c7:	00 
801087c8:	c7 44 24 04 00 00 00 	movl   $0x0,0x4(%esp)
801087cf:	00 
801087d0:	8b 45 08             	mov    0x8(%ebp),%eax
801087d3:	89 04 24             	mov    %eax,(%esp)
801087d6:	e8 b0 fc ff ff       	call   8010848b <mappages>
  memmove(mem, init, sz);
801087db:	8b 45 10             	mov    0x10(%ebp),%eax
801087de:	89 44 24 08          	mov    %eax,0x8(%esp)
801087e2:	8b 45 0c             	mov    0xc(%ebp),%eax
801087e5:	89 44 24 04          	mov    %eax,0x4(%esp)
801087e9:	8b 45 f4             	mov    -0xc(%ebp),%eax
801087ec:	89 04 24             	mov    %eax,(%esp)
801087ef:	e8 d3 d0 ff ff       	call   801058c7 <memmove>
}
801087f4:	c9                   	leave  
801087f5:	c3                   	ret    
...
80108800:	25 ff 0f 00 00       	and    $0xfff,%eax
80108805:	85 c0                	test   %eax,%eax
80108807:	74 0c                	je     80108815 <loaduvm+0x1f>
    panic("loaduvm: addr must be page aligned");
80108809:	c7 04 24 74 94 10 80 	movl   $0x80109474,(%esp)
80108810:	e8 21 7d ff ff       	call   80100536 <panic>
  for(i = 0; i < sz; i += PGSIZE){
80108815:	c7 45 f4 00 00 00 00 	movl   $0x0,-0xc(%ebp)
8010881c:	e9 ad 00 00 00       	jmp    801088ce <loaduvm+0xd8>
    if((pte = walkpgdir(pgdir, addr+i, 0)) == 0)
80108821:	8b 45 f4             	mov    -0xc(%ebp),%eax
80108824:	8b 55 0c             	mov    0xc(%ebp),%edx
80108827:	01 d0                	add    %edx,%eax
80108829:	c7 44 24 08 00 00 00 	movl   $0x0,0x8(%esp)
80108830:	00 
80108831:	89 44 24 04          	mov    %eax,0x4(%esp)
80108835:	8b 45 08             	mov    0x8(%ebp),%eax
80108838:	89 04 24             	mov    %eax,(%esp)
8010883b:	e8 a9 fb ff ff       	call   801083e9 <walkpgdir>
80108840:	89 45 ec             	mov    %eax,-0x14(%ebp)
80108843:	83 7d ec 00          	cmpl   $0x0,-0x14(%ebp)
80108847:	75 0c                	jne    80108855 <loaduvm+0x5f>
      panic("loaduvm: address should exist");
80108849:	c7 04 24 97 94 10 80 	movl   $0x80109497,(%esp)
80108850:	e8 e1 7c ff ff       	call   80100536 <panic>
    pa = PTE_ADDR(*pte);
80108855:	8b 45 ec             	mov    -0x14(%ebp),%eax
80108858:	8b 00                	mov    (%eax),%eax
8010885a:	25 00 f0 ff ff       	and    $0xfffff000,%eax
8010885f:	89 45 e8             	mov    %eax,-0x18(%ebp)
    if(sz - i < PGSIZE)
80108862:	8b 45 f4             	mov    -0xc(%ebp),%eax
80108865:	8b 55 18             	mov    0x18(%ebp),%edx
80108868:	89 d1                	mov    %edx,%ecx
8010886a:	29 c1                	sub    %eax,%ecx
8010886c:	89 c8                	mov    %ecx,%eax
8010886e:	3d ff 0f 00 00       	cmp    $0xfff,%eax
80108873:	77 11                	ja     80108886 <loaduvm+0x90>
      n = sz - i;
80108875:	8b 45 f4             	mov    -0xc(%ebp),%eax
80108878:	8b 55 18             	mov    0x18(%ebp),%edx
8010887b:	89 d1                	mov    %edx,%ecx
8010887d:	29 c1                	sub    %eax,%ecx
8010887f:	89 c8                	mov    %ecx,%eax
80108881:	89 45 f0             	mov    %eax,-0x10(%ebp)
80108884:	eb 07                	jmp    8010888d <loaduvm+0x97>
    else
      n = PGSIZE;
80108886:	c7 45 f0 00 10 00 00 	movl   $0x1000,-0x10(%ebp)
    if(readi(ip, p2v(pa), offset+i, n) != n)
8010888d:	8b 45 f4             	mov    -0xc(%ebp),%eax
80108890:	8b 55 14             	mov    0x14(%ebp),%edx
80108893:	8d 1c 02             	lea    (%edx,%eax,1),%ebx
80108896:	8b 45 e8             	mov    -0x18(%ebp),%eax
80108899:	89 04 24             	mov    %eax,(%esp)
8010889c:	e8 ea f6 ff ff       	call   80107f8b <p2v>
801088a1:	8b 55 f0             	mov    -0x10(%ebp),%edx
801088a4:	89 54 24 0c          	mov    %edx,0xc(%esp)
801088a8:	89 5c 24 08          	mov    %ebx,0x8(%esp)
801088ac:	89 44 24 04          	mov    %eax,0x4(%esp)
801088b0:	8b 45 10             	mov    0x10(%ebp),%eax
801088b3:	89 04 24             	mov    %eax,(%esp)
801088b6:	e8 91 94 ff ff       	call   80101d4c <readi>
801088bb:	3b 45 f0             	cmp    -0x10(%ebp),%eax
801088be:	74 07                	je     801088c7 <loaduvm+0xd1>
      return -1;
801088c0:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
801088c5:	eb 18                	jmp    801088df <loaduvm+0xe9>
  for(i = 0; i < sz; i += PGSIZE){
801088c7:	81 45 f4 00 10 00 00 	addl   $0x1000,-0xc(%ebp)
801088ce:	8b 45 f4             	mov    -0xc(%ebp),%eax
801088d1:	3b 45 18             	cmp    0x18(%ebp),%eax
801088d4:	0f 82 47 ff ff ff    	jb     80108821 <loaduvm+0x2b>
  }
  return 0;
801088da:	b8 00 00 00 00       	mov    $0x0,%eax
}
801088df:	83 c4 24             	add    $0x24,%esp
801088e2:	5b                   	pop    %ebx
801088e3:	5d                   	pop    %ebp
801088e4:	c3                   	ret    
...
801088e8:	83 ec 38             	sub    $0x38,%esp
  char *mem;
  uint a;

  if(newsz >= KERNBASE)
801088eb:	8b 45 10             	mov    0x10(%ebp),%eax
801088ee:	85 c0                	test   %eax,%eax
801088f0:	79 0a                	jns    801088fc <allocuvm+0x17>
    return 0;
801088f2:	b8 00 00 00 00       	mov    $0x0,%eax
801088f7:	e9 c1 00 00 00       	jmp    801089bd <allocuvm+0xd8>
  if(newsz < oldsz)
801088fc:	8b 45 10             	mov    0x10(%ebp),%eax
801088ff:	3b 45 0c             	cmp    0xc(%ebp),%eax
80108902:	73 08                	jae    8010890c <allocuvm+0x27>
    return oldsz;
80108904:	8b 45 0c             	mov    0xc(%ebp),%eax
80108907:	e9 b1 00 00 00       	jmp    801089bd <allocuvm+0xd8>

  a = PGROUNDUP(oldsz);
8010890c:	8b 45 0c             	mov    0xc(%ebp),%eax
8010890f:	05 ff 0f 00 00       	add    $0xfff,%eax
80108914:	25 00 f0 ff ff       	and    $0xfffff000,%eax
80108919:	89 45 f4             	mov    %eax,-0xc(%ebp)
  for(; a < newsz; a += PGSIZE){
8010891c:	e9 8d 00 00 00       	jmp    801089ae <allocuvm+0xc9>
    mem = kalloc();
80108921:	e8 98 a1 ff ff       	call   80102abe <kalloc>
80108926:	89 45 f0             	mov    %eax,-0x10(%ebp)
    if(mem == 0){
80108929:	83 7d f0 00          	cmpl   $0x0,-0x10(%ebp)
8010892d:	75 2c                	jne    8010895b <allocuvm+0x76>
      cprintf("allocuvm out of memory\n");
8010892f:	c7 04 24 b5 94 10 80 	movl   $0x801094b5,(%esp)
80108936:	e8 66 7a ff ff       	call   801003a1 <cprintf>
      deallocuvm(pgdir, newsz, oldsz);
8010893b:	8b 45 0c             	mov    0xc(%ebp),%eax
8010893e:	89 44 24 08          	mov    %eax,0x8(%esp)
80108942:	8b 45 10             	mov    0x10(%ebp),%eax
80108945:	89 44 24 04          	mov    %eax,0x4(%esp)
80108949:	8b 45 08             	mov    0x8(%ebp),%eax
8010894c:	89 04 24             	mov    %eax,(%esp)
8010894f:	e8 6b 00 00 00       	call   801089bf <deallocuvm>
      return 0;
80108954:	b8 00 00 00 00       	mov    $0x0,%eax
80108959:	eb 62                	jmp    801089bd <allocuvm+0xd8>
    }
    memset(mem, 0, PGSIZE);
8010895b:	c7 44 24 08 00 10 00 	movl   $0x1000,0x8(%esp)
80108962:	00 
80108963:	c7 44 24 04 00 00 00 	movl   $0x0,0x4(%esp)
8010896a:	00 
8010896b:	8b 45 f0             	mov    -0x10(%ebp),%eax
8010896e:	89 04 24             	mov    %eax,(%esp)
80108971:	e8 85 ce ff ff       	call   801057fb <memset>
    mappages(pgdir, (char*)a, PGSIZE, v2p(mem), PTE_W|PTE_U);
80108976:	8b 45 f0             	mov    -0x10(%ebp),%eax
80108979:	89 04 24             	mov    %eax,(%esp)
8010897c:	e8 fd f5 ff ff       	call   80107f7e <v2p>
80108981:	8b 55 f4             	mov    -0xc(%ebp),%edx
80108984:	c7 44 24 10 06 00 00 	movl   $0x6,0x10(%esp)
8010898b:	00 
8010898c:	89 44 24 0c          	mov    %eax,0xc(%esp)
80108990:	c7 44 24 08 00 10 00 	movl   $0x1000,0x8(%esp)
80108997:	00 
80108998:	89 54 24 04          	mov    %edx,0x4(%esp)
8010899c:	8b 45 08             	mov    0x8(%ebp),%eax
8010899f:	89 04 24             	mov    %eax,(%esp)
801089a2:	e8 e4 fa ff ff       	call   8010848b <mappages>
  for(; a < newsz; a += PGSIZE){
801089a7:	81 45 f4 00 10 00 00 	addl   $0x1000,-0xc(%ebp)
801089ae:	8b 45 f4             	mov    -0xc(%ebp),%eax
801089b1:	3b 45 10             	cmp    0x10(%ebp),%eax
801089b4:	0f 82 67 ff ff ff    	jb     80108921 <allocuvm+0x3c>
  }
  return newsz;
801089ba:	8b 45 10             	mov    0x10(%ebp),%eax
}
801089bd:	c9                   	leave  
801089be:	c3                   	ret    
...
801089c5:	c7 45 f0 01 00 00 00 	movl   $0x1,-0x10(%ebp)

  if(newsz >= oldsz)
801089cc:	8b 45 10             	mov    0x10(%ebp),%eax
801089cf:	3b 45 0c             	cmp    0xc(%ebp),%eax
801089d2:	72 08                	jb     801089dc <deallocuvm+0x1d>
    return oldsz;
801089d4:	8b 45 0c             	mov    0xc(%ebp),%eax
801089d7:	e9 b8 00 00 00       	jmp    80108a94 <deallocuvm+0xd5>

  //pte_s
  a = PGROUNDUP(newsz);
801089dc:	8b 45 10             	mov    0x10(%ebp),%eax
801089df:	05 ff 0f 00 00       	add    $0xfff,%eax
801089e4:	25 00 f0 ff ff       	and    $0xfffff000,%eax
801089e9:	89 45 f4             	mov    %eax,-0xc(%ebp)
  for(; a  < oldsz; a += PGSIZE){
801089ec:	e9 94 00 00 00       	jmp    80108a85 <deallocuvm+0xc6>
...
80108a06:	e8 de f9 ff ff       	call   801083e9 <walkpgdir>
80108a0b:	89 45 ec             	mov    %eax,-0x14(%ebp)
    if(!pte)
80108a0e:	83 7d ec 00          	cmpl   $0x0,-0x14(%ebp)
80108a12:	75 09                	jne    80108a1d <deallocuvm+0x5e>
      a += (NPTENTRIES - 1) * PGSIZE;
80108a14:	81 45 f4 00 f0 3f 00 	addl   $0x3ff000,-0xc(%ebp)
80108a1b:	eb 61                	jmp    80108a7e <deallocuvm+0xbf>
    else if((*pte & PTE_P) != 0){
80108a1d:	8b 45 ec             	mov    -0x14(%ebp),%eax
80108a20:	8b 00                	mov    (%eax),%eax
80108a22:	83 e0 01             	and    $0x1,%eax
80108a25:	85 c0                	test   %eax,%eax
80108a27:	74 55                	je     80108a7e <deallocuvm+0xbf>
      pa = PTE_ADDR(*pte);
80108a29:	8b 45 ec             	mov    -0x14(%ebp),%eax
80108a2c:	8b 00                	mov    (%eax),%eax
80108a2e:	25 00 f0 ff ff       	and    $0xfffff000,%eax
80108a33:	89 45 e8             	mov    %eax,-0x18(%ebp)
      save_this = is_shared(pa); //New: Add in project final
80108a36:	8b 45 e8             	mov    -0x18(%ebp),%eax
80108a39:	89 04 24             	mov    %eax,(%esp)
80108a3c:	e8 a4 03 00 00       	call   80108de5 <is_shared>
80108a41:	89 45 f0             	mov    %eax,-0x10(%ebp)
      if(pa == 0)
80108a44:	83 7d e8 00          	cmpl   $0x0,-0x18(%ebp)
80108a48:	75 0c                	jne    80108a56 <deallocuvm+0x97>
        panic("kfree");
80108a4a:	c7 04 24 cd 94 10 80 	movl   $0x801094cd,(%esp)
80108a51:	e8 e0 7a ff ff       	call   80100536 <panic>
      // char *v = p2v(pa);
      // kfree(v);
      // *pte = 0;
      if (!save_this){ // New: Add in project final, ahi uno solo, le aplico el kfree
80108a56:	83 7d f0 00          	cmpl   $0x0,-0x10(%ebp)
80108a5a:	75 22                	jne    80108a7e <deallocuvm+0xbf>
        char *v = p2v(pa);
80108a5c:	8b 45 e8             	mov    -0x18(%ebp),%eax
80108a5f:	89 04 24             	mov    %eax,(%esp)
80108a62:	e8 24 f5 ff ff       	call   80107f8b <p2v>
80108a67:	89 45 e4             	mov    %eax,-0x1c(%ebp)
        kfree(v);
80108a6a:	8b 45 e4             	mov    -0x1c(%ebp),%eax
80108a6d:	89 04 24             	mov    %eax,(%esp)
80108a70:	e8 b0 9f ff ff       	call   80102a25 <kfree>
        *pte = 0;
80108a75:	8b 45 ec             	mov    -0x14(%ebp),%eax
80108a78:	c7 00 00 00 00 00    	movl   $0x0,(%eax)
  for(; a  < oldsz; a += PGSIZE){
80108a7e:	81 45 f4 00 10 00 00 	addl   $0x1000,-0xc(%ebp)
80108a85:	8b 45 f4             	mov    -0xc(%ebp),%eax
80108a88:	3b 45 0c             	cmp    0xc(%ebp),%eax
80108a8b:	0f 82 60 ff ff ff    	jb     801089f1 <deallocuvm+0x32>
      }
    }
  }
  return newsz;
...
80108a99:	83 ec 28             	sub    $0x28,%esp
  ...
  if(pgdir == 0)
80108a9c:	83 7d 08 00          	cmpl   $0x0,0x8(%ebp)
80108aa0:	75 0c                	jne    80108aae <freevm+0x18>
    panic("freevm: no pgdir");
80108aa2:	c7 04 24 d3 94 10 80 	movl   $0x801094d3,(%esp)
80108aa9:	e8 88 7a ff ff       	call   80100536 <panic>
  deallocuvm(pgdir, KERNBASE, 0);
80108aae:	c7 44 24 08 00 00 00 	movl   $0x0,0x8(%esp)
80108ab5:	00 
80108ab6:	c7 44 24 04 00 00 00 	movl   $0x80000000,0x4(%esp)
80108abd:	80 
80108abe:	8b 45 08             	mov    0x8(%ebp),%eax
80108ac1:	89 04 24             	mov    %eax,(%esp)
80108ac4:	e8 f6 fe ff ff       	call   801089bf <deallocuvm>
  for(i = 0; i < NPDENTRIES; i++){
80108ac9:	c7 45 f4 00 00 00 00 	movl   $0x0,-0xc(%ebp)
80108ad0:	eb 47                	jmp    80108b19 <freevm+0x83>
    if(pgdir[i] & PTE_P){
80108ad2:	8b 45 f4             	mov    -0xc(%ebp),%eax
80108ad5:	8d 14 85 00 00 00 00 	lea    0x0(,%eax,4),%edx
80108adc:	8b 45 08             	mov    0x8(%ebp),%eax
80108adf:	01 d0                	add    %edx,%eax
80108ae1:	8b 00                	mov    (%eax),%eax
80108ae3:	83 e0 01             	and    $0x1,%eax
80108ae6:	85 c0                	test   %eax,%eax
80108ae8:	74 2c                	je     80108b16 <freevm+0x80>
...
80108afb:	25 00 f0 ff ff       	and    $0xfffff000,%eax
80108b00:	89 04 24             	mov    %eax,(%esp)
80108b03:	e8 83 f4 ff ff       	call   80107f8b <p2v>
80108b08:	89 45 f0             	mov    %eax,-0x10(%ebp)
      kfree(v);
80108b0b:	8b 45 f0             	mov    -0x10(%ebp),%eax
80108b0e:	89 04 24             	mov    %eax,(%esp)
80108b11:	e8 0f 9f ff ff       	call   80102a25 <kfree>
  for(i = 0; i < NPDENTRIES; i++){
80108b16:	ff 45 f4             	incl   -0xc(%ebp)
80108b19:	81 7d f4 ff 03 00 00 	cmpl   $0x3ff,-0xc(%ebp)
80108b20:	76 b0                	jbe    80108ad2 <freevm+0x3c>
    }
  }
  kfree((char*)pgdir);
80108b22:	8b 45 08             	mov    0x8(%ebp),%eax
80108b25:	89 04 24             	mov    %eax,(%esp)
80108b28:	e8 f8 9e ff ff       	call   80102a25 <kfree>
}
80108b2d:	c9                   	leave  
80108b2e:	c3                   	ret    
...
80108b32:	83 ec 28             	sub    $0x28,%esp
  pte_t *pte;

  pte = walkpgdir(pgdir, uva, 0);
80108b35:	c7 44 24 08 00 00 00 	movl   $0x0,0x8(%esp)
80108b3c:	00 
80108b3d:	8b 45 0c             	mov    0xc(%ebp),%eax
80108b40:	89 44 24 04          	mov    %eax,0x4(%esp)
80108b44:	8b 45 08             	mov    0x8(%ebp),%eax
80108b47:	89 04 24             	mov    %eax,(%esp)
80108b4a:	e8 9a f8 ff ff       	call   801083e9 <walkpgdir>
80108b4f:	89 45 f4             	mov    %eax,-0xc(%ebp)
  if(pte == 0)
80108b52:	83 7d f4 00          	cmpl   $0x0,-0xc(%ebp)
80108b56:	75 0c                	jne    80108b64 <clearpteu+0x35>
    panic("clearpteu");
80108b58:	c7 04 24 e4 94 10 80 	movl   $0x801094e4,(%esp)
80108b5f:	e8 d2 79 ff ff       	call   80100536 <panic>
  *pte &= ~PTE_U;
80108b64:	8b 45 f4             	mov    -0xc(%ebp),%eax
80108b67:	8b 00                	mov    (%eax),%eax
80108b69:	89 c2                	mov    %eax,%edx
80108b6b:	83 e2 fb             	and    $0xfffffffb,%edx
...
{
80108b75:	55                   	push   %ebp
80108b76:	89 e5                	mov    %esp,%ebp
80108b78:	53                   	push   %ebx
80108b79:	83 ec 44             	sub    $0x44,%esp
  pte_t *pte;
  uint pa, i, flags;
  char *mem;
  ...
  if((d = setupkvm()) == 0)
80108b7c:	e8 9e f9 ff ff       	call   8010851f <setupkvm>
80108b81:	89 45 f0             	mov    %eax,-0x10(%ebp)
80108b84:	83 7d f0 00          	cmpl   $0x0,-0x10(%ebp)
80108b88:	75 0a                	jne    80108b94 <copyuvm+0x1f>
    return 0;
80108b8a:	b8 00 00 00 00       	mov    $0x0,%eax
80108b8f:	e9 43 01 00 00       	jmp    80108cd7 <copyuvm+0x162>
  for(i = 0; i < sz; i += PGSIZE){
80108b94:	c7 45 f4 00 00 00 00 	movl   $0x0,-0xc(%ebp)
80108b9b:	e9 12 01 00 00       	jmp    80108cb2 <copyuvm+0x13d>
    if((pte = walkpgdir(pgdir, (void *) i, 0)) == 0)
80108ba0:	8b 45 f4             	mov    -0xc(%ebp),%eax
80108ba3:	c7 44 24 08 00 00 00 	movl   $0x0,0x8(%esp)
80108baa:	00 
80108bab:	89 44 24 04          	mov    %eax,0x4(%esp)
80108baf:	8b 45 08             	mov    0x8(%ebp),%eax
80108bb2:	89 04 24             	mov    %eax,(%esp)
80108bb5:	e8 2f f8 ff ff       	call   801083e9 <walkpgdir>
80108bba:	89 45 ec             	mov    %eax,-0x14(%ebp)
80108bbd:	83 7d ec 00          	cmpl   $0x0,-0x14(%ebp)
80108bc1:	75 0c                	jne    80108bcf <copyuvm+0x5a>
      panic("copyuvm: pte should exist");
80108bc3:	c7 04 24 ee 94 10 80 	movl   $0x801094ee,(%esp)
80108bca:	e8 67 79 ff ff       	call   80100536 <panic>
    if(!(*pte & PTE_P))
80108bcf:	8b 45 ec             	mov    -0x14(%ebp),%eax
80108bd2:	8b 00                	mov    (%eax),%eax
80108bd4:	83 e0 01             	and    $0x1,%eax
80108bd7:	85 c0                	test   %eax,%eax
80108bd9:	75 0c                	jne    80108be7 <copyuvm+0x72>
      panic("copyuvm: page not present");
80108bdb:	c7 04 24 08 95 10 80 	movl   $0x80109508,(%esp)
80108be2:	e8 4f 79 ff ff       	call   80100536 <panic>
    pa = PTE_ADDR(*pte);
...
80108bf9:	25 ff 0f 00 00       	and    $0xfff,%eax
80108bfe:	89 45 e4             	mov    %eax,-0x1c(%ebp)

    only_map = is_shared(pa); // New: Add in project final
80108c01:	8b 45 e8             	mov    -0x18(%ebp),%eax
80108c04:	89 04 24             	mov    %eax,(%esp)
80108c07:	e8 d9 01 00 00       	call   80108de5 <is_shared>
80108c0c:	89 45 e0             	mov    %eax,-0x20(%ebp)
    if (!only_map) { 
80108c0f:	83 7d e0 00          	cmpl   $0x0,-0x20(%ebp)
80108c13:	75 6a                	jne    80108c7f <copyuvm+0x10a>
      if((mem = kalloc()) == 0) // el kalloc no pudo asignar la memoria
80108c15:	e8 a4 9e ff ff       	call   80102abe <kalloc>
80108c1a:	89 45 dc             	mov    %eax,-0x24(%ebp)
80108c1d:	83 7d dc 00          	cmpl   $0x0,-0x24(%ebp)
80108c21:	0f 84 9c 00 00 00    	je     80108cc3 <copyuvm+0x14e>
        goto bad;
      memmove(mem, (char*)p2v(pa), PGSIZE);
80108c27:	8b 45 e8             	mov    -0x18(%ebp),%eax
80108c2a:	89 04 24             	mov    %eax,(%esp)
80108c2d:	e8 59 f3 ff ff       	call   80107f8b <p2v>
80108c32:	c7 44 24 08 00 10 00 	movl   $0x1000,0x8(%esp)
80108c39:	00 
80108c3a:	89 44 24 04          	mov    %eax,0x4(%esp)
80108c3e:	8b 45 dc             	mov    -0x24(%ebp),%eax
80108c41:	89 04 24             	mov    %eax,(%esp)
80108c44:	e8 7e cc ff ff       	call   801058c7 <memmove>
      if(mappages(d, (void*)i, PGSIZE, v2p(mem), flags) < 0)
80108c49:	8b 5d e4             	mov    -0x1c(%ebp),%ebx
80108c4c:	8b 45 dc             	mov    -0x24(%ebp),%eax
80108c4f:	89 04 24             	mov    %eax,(%esp)
80108c52:	e8 27 f3 ff ff       	call   80107f7e <v2p>
80108c57:	8b 55 f4             	mov    -0xc(%ebp),%edx
80108c5a:	89 5c 24 10          	mov    %ebx,0x10(%esp)
80108c5e:	89 44 24 0c          	mov    %eax,0xc(%esp)
80108c62:	c7 44 24 08 00 10 00 	movl   $0x1000,0x8(%esp)
80108c69:	00 
80108c6a:	89 54 24 04          	mov    %edx,0x4(%esp)
80108c6e:	8b 45 f0             	mov    -0x10(%ebp),%eax
80108c71:	89 04 24             	mov    %eax,(%esp)
80108c74:	e8 12 f8 ff ff       	call   8010848b <mappages>
80108c79:	85 c0                	test   %eax,%eax
80108c7b:	79 2e                	jns    80108cab <copyuvm+0x136>
        goto bad;
80108c7d:	eb 48                	jmp    80108cc7 <copyuvm+0x152>
    } else {
      if(mappages(d, (void*)i, PGSIZE, pa, flags) < 0)
80108c7f:	8b 55 e4             	mov    -0x1c(%ebp),%edx
80108c82:	8b 45 f4             	mov    -0xc(%ebp),%eax
80108c85:	89 54 24 10          	mov    %edx,0x10(%esp)
80108c89:	8b 55 e8             	mov    -0x18(%ebp),%edx
80108c8c:	89 54 24 0c          	mov    %edx,0xc(%esp)
80108c90:	c7 44 24 08 00 10 00 	movl   $0x1000,0x8(%esp)
80108c97:	00 
80108c98:	89 44 24 04          	mov    %eax,0x4(%esp)
80108c9c:	8b 45 f0             	mov    -0x10(%ebp),%eax
80108c9f:	89 04 24             	mov    %eax,(%esp)
80108ca2:	e8 e4 f7 ff ff       	call   8010848b <mappages>
80108ca7:	85 c0                	test   %eax,%eax
80108ca9:	78 1b                	js     80108cc6 <copyuvm+0x151>
  for(i = 0; i < sz; i += PGSIZE){
80108cab:	81 45 f4 00 10 00 00 	addl   $0x1000,-0xc(%ebp)
80108cb2:	8b 45 f4             	mov    -0xc(%ebp),%eax
80108cb5:	3b 45 0c             	cmp    0xc(%ebp),%eax
80108cb8:	0f 82 e2 fe ff ff    	jb     80108ba0 <copyuvm+0x2b>
        goto bad;
     }
  }
  return d;
80108cbe:	8b 45 f0             	mov    -0x10(%ebp),%eax
80108cc1:	eb 14                	jmp    80108cd7 <copyuvm+0x162>
        goto bad;
80108cc3:	90                   	nop
80108cc4:	eb 01                	jmp    80108cc7 <copyuvm+0x152>
        goto bad;
80108cc6:	90                   	nop

bad:
  freevm(d);
80108cc7:	8b 45 f0             	mov    -0x10(%ebp),%eax
80108cca:	89 04 24             	mov    %eax,(%esp)
80108ccd:	e8 c4 fd ff ff       	call   80108a96 <freevm>
  return 0;
80108cd2:	b8 00 00 00 00       	mov    $0x0,%eax
}
80108cd7:	83 c4 44             	add    $0x44,%esp
80108cda:	5b                   	pop    %ebx
80108cdb:	5d                   	pop    %ebp
80108cdc:	c3                   	ret    
...
80108ce0:	83 ec 28             	sub    $0x28,%esp
  pte_t *pte;
...
80108cf8:	e8 ec f6 ff ff       	call   801083e9 <walkpgdir>
80108cfd:	89 45 f4             	mov    %eax,-0xc(%ebp)
  if((*pte & PTE_P) == 0)
80108d00:	8b 45 f4             	mov    -0xc(%ebp),%eax
80108d03:	8b 00                	mov    (%eax),%eax
80108d05:	83 e0 01             	and    $0x1,%eax
80108d08:	85 c0                	test   %eax,%eax
80108d0a:	75 07                	jne    80108d13 <uva2ka+0x36>
    return 0;
80108d0c:	b8 00 00 00 00       	mov    $0x0,%eax
80108d11:	eb 25                	jmp    80108d38 <uva2ka+0x5b>
  if((*pte & PTE_U) == 0)
80108d13:	8b 45 f4             	mov    -0xc(%ebp),%eax
80108d16:	8b 00                	mov    (%eax),%eax
80108d18:	83 e0 04             	and    $0x4,%eax
80108d1b:	85 c0                	test   %eax,%eax
80108d1d:	75 07                	jne    80108d26 <uva2ka+0x49>
    return 0;
80108d1f:	b8 00 00 00 00       	mov    $0x0,%eax
80108d24:	eb 12                	jmp    80108d38 <uva2ka+0x5b>
  return (char*)p2v(PTE_ADDR(*pte));
80108d26:	8b 45 f4             	mov    -0xc(%ebp),%eax
80108d29:	8b 00                	mov    (%eax),%eax
80108d2b:	25 00 f0 ff ff       	and    $0xfffff000,%eax
80108d30:	89 04 24             	mov    %eax,(%esp)
80108d33:	e8 53 f2 ff ff       	call   80107f8b <p2v>
}
80108d38:	c9                   	leave  
80108d39:	c3                   	ret    
...
{
80108d3a:	55                   	push   %ebp
80108d3b:	89 e5                	mov    %esp,%ebp
80108d3d:	83 ec 28             	sub    $0x28,%esp
  char *buf, *pa0;
  uint n, va0;

  buf = (char*)p;
80108d40:	8b 45 10             	mov    0x10(%ebp),%eax
80108d43:	89 45 f4             	mov    %eax,-0xc(%ebp)
  while(len > 0){
80108d46:	e9 89 00 00 00       	jmp    80108dd4 <copyout+0x9a>
    va0 = (uint)PGROUNDDOWN(va);
80108d4b:	8b 45 0c             	mov    0xc(%ebp),%eax
80108d4e:	25 00 f0 ff ff       	and    $0xfffff000,%eax
80108d53:	89 45 ec             	mov    %eax,-0x14(%ebp)
    pa0 = uva2ka(pgdir, (char*)va0);
80108d56:	8b 45 ec             	mov    -0x14(%ebp),%eax
80108d59:	89 44 24 04          	mov    %eax,0x4(%esp)
80108d5d:	8b 45 08             	mov    0x8(%ebp),%eax
80108d60:	89 04 24             	mov    %eax,(%esp)
80108d63:	e8 75 ff ff ff       	call   80108cdd <uva2ka>
80108d68:	89 45 e8             	mov    %eax,-0x18(%ebp)
    if(pa0 == 0)
80108d6b:	83 7d e8 00          	cmpl   $0x0,-0x18(%ebp)
80108d6f:	75 07                	jne    80108d78 <copyout+0x3e>
      return -1;
80108d71:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80108d76:	eb 6b                	jmp    80108de3 <copyout+0xa9>
    n = PGSIZE - (va - va0);
80108d78:	8b 45 0c             	mov    0xc(%ebp),%eax
80108d7b:	8b 55 ec             	mov    -0x14(%ebp),%edx
80108d7e:	89 d1                	mov    %edx,%ecx
80108d80:	29 c1                	sub    %eax,%ecx
80108d82:	89 c8                	mov    %ecx,%eax
80108d84:	05 00 10 00 00       	add    $0x1000,%eax
80108d89:	89 45 f0             	mov    %eax,-0x10(%ebp)
    if(n > len)
80108d8c:	8b 45 f0             	mov    -0x10(%ebp),%eax
80108d8f:	3b 45 14             	cmp    0x14(%ebp),%eax
80108d92:	76 06                	jbe    80108d9a <copyout+0x60>
      n = len;
80108d94:	8b 45 14             	mov    0x14(%ebp),%eax
80108d97:	89 45 f0             	mov    %eax,-0x10(%ebp)
    memmove(pa0 + (va - va0), buf, n);
80108d9a:	8b 45 ec             	mov    -0x14(%ebp),%eax
80108d9d:	8b 55 0c             	mov    0xc(%ebp),%edx
80108da0:	29 c2                	sub    %eax,%edx
80108da2:	8b 45 e8             	mov    -0x18(%ebp),%eax
80108da5:	01 c2                	add    %eax,%edx
80108da7:	8b 45 f0             	mov    -0x10(%ebp),%eax
80108daa:	89 44 24 08          	mov    %eax,0x8(%esp)
80108dae:	8b 45 f4             	mov    -0xc(%ebp),%eax
80108db1:	89 44 24 04          	mov    %eax,0x4(%esp)
80108db5:	89 14 24             	mov    %edx,(%esp)
80108db8:	e8 0a cb ff ff       	call   801058c7 <memmove>
    len -= n;
80108dbd:	8b 45 f0             	mov    -0x10(%ebp),%eax
80108dc0:	29 45 14             	sub    %eax,0x14(%ebp)
    buf += n;
80108dc3:	8b 45 f0             	mov    -0x10(%ebp),%eax
80108dc6:	01 45 f4             	add    %eax,-0xc(%ebp)
    va = va0 + PGSIZE;
80108dc9:	8b 45 ec             	mov    -0x14(%ebp),%eax
80108dcc:	05 00 10 00 00       	add    $0x1000,%eax
80108dd1:	89 45 0c             	mov    %eax,0xc(%ebp)
  while(len > 0){
80108dd4:	83 7d 14 00          	cmpl   $0x0,0x14(%ebp)
80108dd8:	0f 85 6d ff ff ff    	jne    80108d4b <copyout+0x11>
  }
  return 0;
80108dde:	b8 00 00 00 00       	mov    $0x0,%eax
}
80108de3:	c9                   	leave  
80108de4:	c3                   	ret    
...
80108deb:	e8 53 c6 ff ff       	call   80105443 <get_shm_table>
80108df0:	89 45 ec             	mov    %eax,-0x14(%ebp)
  int shared = 0;
80108df3:	c7 45 f0 00 00 00 00 	movl   $0x0,-0x10(%ebp)

  for(j=0; j<MAXSHM; j++){ // recorro mi arreglo sharedmemory
80108dfa:	c7 45 f4 00 00 00 00 	movl   $0x0,-0xc(%ebp)
80108e01:	eb 42                	jmp    80108e45 <is_shared+0x60>
    if (p2v(pa) == shared_array[j].addr && shared_array[j].refcount > 0){ // refcount tiene a 2 entonces 
80108e03:	8b 45 08             	mov    0x8(%ebp),%eax
80108e06:	89 04 24             	mov    %eax,(%esp)
80108e09:	e8 7d f1 ff ff       	call   80107f8b <p2v>
80108e0e:	8b 55 f4             	mov    -0xc(%ebp),%edx
80108e11:	8d 0c d5 00 00 00 00 	lea    0x0(,%edx,8),%ecx
80108e18:	8b 55 ec             	mov    -0x14(%ebp),%edx
80108e1b:	01 ca                	add    %ecx,%edx
80108e1d:	8b 12                	mov    (%edx),%edx
80108e1f:	39 d0                	cmp    %edx,%eax
80108e21:	75 1f                	jne    80108e42 <is_shared+0x5d>
80108e23:	8b 45 f4             	mov    -0xc(%ebp),%eax
80108e26:	8d 14 c5 00 00 00 00 	lea    0x0(,%eax,8),%edx
80108e2d:	8b 45 ec             	mov    -0x14(%ebp),%eax
80108e30:	01 d0                	add    %edx,%eax
80108e32:	8b 40 04             	mov    0x4(%eax),%eax
80108e35:	85 c0                	test   %eax,%eax
80108e37:	7e 09                	jle    80108e42 <is_shared+0x5d>
      shared = j+1;
80108e39:	8b 45 f4             	mov    -0xc(%ebp),%eax
80108e3c:	40                   	inc    %eax
80108e3d:	89 45 f0             	mov    %eax,-0x10(%ebp)
      break;
80108e40:	eb 09                	jmp    80108e4b <is_shared+0x66>
  for(j=0; j<MAXSHM; j++){ // recorro mi arreglo sharedmemory
80108e42:	ff 45 f4             	incl   -0xc(%ebp)
80108e45:	83 7d f4 0b          	cmpl   $0xb,-0xc(%ebp)
80108e49:	7e b8                	jle    80108e03 <is_shared+0x1e>
    }
  }
  return shared; // ahi uno solo
80108e4b:	8b 45 f0             	mov    -0x10(%ebp),%eax
}
80108e4e:	c9                   	leave  
80108e4f:	c3                   	ret    
