...
80100049:	e8 37 55 00 00       	call   80105585 <initlock>
...
801000bd:	e8 e4 54 00 00       	call   801055a6 <acquire>
...
80100104:	e8 ff 54 00 00       	call   80105608 <release>
        return b;
...
8010017c:	e8 87 54 00 00       	call   80105608 <release>
      return b;
...
8010023c:	e8 65 53 00 00       	call   801055a6 <acquire>
...
801002a9:	e8 5a 53 00 00       	call   80105608 <release>
}
801002ae:	c9                   	leave  
801002af:	c3                   	ret    
...
801003bc:	e8 e5 51 00 00       	call   801055a6 <acquire>
...
8010052f:	e8 d4 50 00 00       	call   80105608 <release>
}
80100534:	c9                   	leave  
80100535:	c3                   	ret    
...
8010058a:	e8 c8 50 00 00       	call   80105657 <getcallerpcs>
  for(i=0; i<10; i++)
...
80100695:	e8 2a 52 00 00       	call   801058c4 <memmove>
    pos -= 80;
...
801006c4:	e8 2f 51 00 00       	call   801057f8 <memset>
  }
...
8010079d:	e8 04 4e 00 00       	call   801055a6 <acquire>
  while((c = getc()) >= 0){
...
801008f5:	e8 0e 4d 00 00       	call   80105608 <release>
}
801008fa:	c9                   	leave  
801008fb:	c3                   	ret    
...
8010091a:	e8 87 4c 00 00       	call   801055a6 <acquire>
  while(n > 0){
...
80100938:	e8 cb 4c 00 00       	call   80105608 <release>
        ilock(ip);
...
801009d8:	e8 2b 4c 00 00       	call   80105608 <release>
  ilock(ip);
...
80100a0e:	e8 93 4b 00 00       	call   801055a6 <acquire>
  for(i = 0; i < n; i++)
...
80100a48:	e8 bb 4b 00 00       	call   80105608 <release>
  ilock(ip);
...
80100b3d:	0f 85 4f 03 00 00    	jne    80100e92 <exec+0x3c7>
  ...
  if((pgdir = setupkvm()) == 0)
80100b43:	e8 d4 79 00 00       	call   8010851c <setupkvm>
...
80100bdc:	e8 01 7d 00 00       	call   801088e2 <allocuvm>
...
80100c19:	e8 d5 7b 00 00       	call   801087f3 <loaduvm>
...
80100c82:	e8 5b 7c 00 00       	call   801088e2 <allocuvm>
...
80100ca6:	e8 81 7e 00 00       	call   80108b2c <clearpteu>
  sp = sz;
...
80100cdb:	e8 73 4d 00 00       	call   80105a53 <strlen>
...
80100d03:	e8 4b 4d 00 00       	call   80105a53 <strlen>
80100d08:	40                   	inc    %eax
...
80100d31:	e8 01 80 00 00       	call   80108d37 <copyout>
...
80100dd4:	e8 5e 7f 00 00       	call   80108d37 <copyout>
...
80100e26:	e8 df 4b 00 00       	call   80105a0a <safestrcpy>
...
80100e78:	e8 90 77 00 00       	call   8010860d <switchuvm>
  freevm(oldpgdir);
80100e7d:	8b 45 d0             	mov    -0x30(%ebp),%eax
80100e80:	89 04 24             	mov    %eax,(%esp)
80100e83:	e8 0b 7c 00 00       	call   80108a93 <freevm>
  return 0;
...
80100eba:	e8 d4 7b 00 00       	call   80108a93 <freevm>
  if(ip)
...
80100eec:	e8 94 46 00 00       	call   80105585 <initlock>
}
80100ef1:	c9                   	leave  
80100ef2:	c3                   	ret    
...
80100f00:	e8 a1 46 00 00       	call   801055a6 <acquire>
...
80100f29:	e8 da 46 00 00       	call   80105608 <release>
      return f;
...
80100f47:	e8 bc 46 00 00       	call   80105608 <release>
  return 0;
...
80100f60:	e8 41 46 00 00       	call   801055a6 <acquire>
  if(f->ref < 1)
...
80100f91:	e8 72 46 00 00       	call   80105608 <release>
  return f;
...
80100fab:	e8 f6 45 00 00       	call   801055a6 <acquire>
  if(f->ref < 1)
...
80100fe6:	e8 1d 46 00 00       	call   80105608 <release>
...
8010101c:	e8 e7 45 00 00       	call   80105608 <release>
...
801012e7:	e8 d8 45 00 00       	call   801058c4 <memmove>
  brelse(bp);
...
8010132d:	e8 c6 44 00 00       	call   801057f8 <memset>
  log_write(bp);
...
8010159c:	e8 e4 3f 00 00       	call   80105585 <initlock>
}
801015a1:	c9                   	leave  
801015a2:	c3                   	ret    
...
80101626:	e8 cd 41 00 00       	call   801057f8 <memset>
      dip->type = type;
...
80101724:	e8 9b 41 00 00       	call   801058c4 <memmove>
  log_write(bp);
...
8010174e:	e8 53 3e 00 00       	call   801055a6 <acquire>
...
80101798:	e8 6b 3e 00 00       	call   80105608 <release>
      return ip;
...
80101809:	e8 fa 3d 00 00       	call   80105608 <release>
...
80101820:	e8 81 3d 00 00       	call   801055a6 <acquire>
  ip->ref++;
...
8010183b:	e8 c8 3d 00 00       	call   80105608 <release>
  return ip;
...
8010186e:	e8 33 3d 00 00       	call   801055a6 <acquire>
...
801018ad:	e8 56 3d 00 00       	call   80105608 <release>
...
80101956:	e8 69 3f 00 00       	call   801058c4 <memmove>
    brelse(bp);
...
801019c6:	e8 db 3b 00 00       	call   801055a6 <acquire>
  ip->flags &= ~I_BUSY;
...
801019ee:	e8 15 3c 00 00       	call   80105608 <release>
}
801019f3:	c9                   	leave  
801019f4:	c3                   	ret    
...
80101a02:	e8 9f 3b 00 00       	call   801055a6 <acquire>
...
80101a64:	e8 9f 3b 00 00       	call   80105608 <release>
    itrunc(ip);
...
80101a8f:	e8 12 3b 00 00       	call   801055a6 <acquire>
    ip->flags = 0;
...
80101abf:	e8 44 3b 00 00       	call   80105608 <release>
}
80101ac4:	c9                   	leave  
80101ac5:	c3                   	ret    
...
80101e7e:	e8 41 3a 00 00       	call   801058c4 <memmove>
    brelse(bp);
...
80101fde:	e8 e1 38 00 00       	call   801058c4 <memmove>
    log_write(bp);
...
8010205c:	e8 ff 38 00 00       	call   80105960 <strncmp>
}
80102061:	c9                   	leave  
80102062:	c3                   	ret    
...
801021da:	e8 d1 37 00 00       	call   801059b0 <strncpy>
  de.inum = inum;
...
8010228d:	e8 32 36 00 00       	call   801058c4 <memmove>
  else {
    memmove(name, s, len);
    name[len] = 0;
  }
...
801022a8:	e8 17 36 00 00       	call   801058c4 <memmove>
    name[len] = 0;
...
8010250a:	e8 76 30 00 00       	call   80105585 <initlock>
  picenable(IRQ_IDE);
...
801026ca:	e8 d7 2e 00 00       	call   801055a6 <acquire>
  if((b = idequeue) == 0){
...
801026e4:	e8 1f 2f 00 00       	call   80105608 <release>
...
80102779:	e8 8a 2e 00 00       	call   80105608 <release>
}
8010277e:	c9                   	leave  
8010277f:	c3                   	ret    
...
801027dd:	e8 c4 2d 00 00       	call   801055a6 <acquire>
...
80102852:	e8 b1 2d 00 00       	call   80105608 <release>
}
80102857:	c9                   	leave  
80102858:	c3                   	ret    
...
801029a5:	e8 db 2b 00 00       	call   80105585 <initlock>
  kmem.use_lock = 0;
...
80102a74:	e8 7f 2d 00 00       	call   801057f8 <memset>
...
80102a89:	e8 18 2b 00 00       	call   801055a6 <acquire>
  r = (struct run*)v;
...
80102ab7:	e8 4c 2b 00 00       	call   80105608 <release>
}
80102abc:	c9                   	leave  
80102abd:	c3                   	ret    
...
80102ad4:	e8 cd 2a 00 00       	call   801055a6 <acquire>
  r = kmem.freelist;
...
80102b01:	e8 02 2b 00 00       	call   80105608 <release>
  return (char*)r;
...
80102fda:	e8 a6 25 00 00       	call   80105585 <initlock>
  readsb(ROOTDEV, &sb);
...
8010308e:	e8 31 28 00 00       	call   801058c4 <memmove>
...
801031dd:	e8 c4 23 00 00       	call   801055a6 <acquire>
  while (log.busy) {
...
80103212:	e8 f1 23 00 00       	call   80105608 <release>
}
80103217:	c9                   	leave  
80103218:	c3                   	ret    
...
80103248:	e8 59 23 00 00       	call   801055a6 <acquire>
  log.busy = 0;
...
8010326a:	e8 99 23 00 00       	call   80105608 <release>
}
8010326f:	c9                   	leave  
80103270:	c3                   	ret    
...
80103335:	e8 8a 25 00 00       	call   801058c4 <memmove>
  bwrite(lbuf);
...
80103410:	e8 d5 3e 00 00       	call   801072ea <uartinit>
  pinit();         // process table
80103415:	e8 c9 0b 00 00       	call   80103fe3 <pinit>
  tvinit();        // trap vectors
8010341a:	e8 7e 3a 00 00       	call   80106e9d <tvinit>
  binit();         // buffer cache
...
8010343c:	e8 a4 39 00 00       	call   80106de5 <timerinit>
...
80103467:	83 ec 08             	sub    $0x8,%esp
  switchkvm(); 
8010346a:	e8 81 51 00 00       	call   801085f0 <switchkvm>
  seginit();
8010346f:	e8 21 4b 00 00       	call   80107f95 <seginit>
  lapicinit();
...
8010349f:	e8 56 3b 00 00       	call   80106ffa <idtinit>
...
801034f1:	e8 ce 23 00 00       	call   801058c4 <memmove>
...
801036d7:	e8 93 21 00 00       	call   8010586f <memcmp>
...
80103814:	e8 56 20 00 00       	call   8010586f <memcmp>
...
80103cb4:	e8 cc 18 00 00       	call   80105585 <initlock>
  (*f0)->type = FD_PIPE;
...
80103d61:	e8 40 18 00 00       	call   801055a6 <acquire>
  if(writable){
...
80103dc8:	e8 3b 18 00 00       	call   80105608 <release>
    kfree((char*)p);
...
80103de0:	e8 23 18 00 00       	call   80105608 <release>
}
80103de5:	c9                   	leave  
80103de6:	c3                   	ret    
...
80103df4:	e8 ad 17 00 00       	call   801055a6 <acquire>
  for(i = 0; i < n; i++){
...
80103e25:	e8 de 17 00 00       	call   80105608 <release>
        return -1;
...
80103ec9:	e8 3a 17 00 00       	call   80105608 <release>
  return n;
...
80103ee4:	e8 bd 16 00 00       	call   801055a6 <acquire>
...
80103efe:	e8 05 17 00 00       	call   80105608 <release>
      return -1;
...
80103fba:	e8 49 16 00 00       	call   80105608 <release>
  return i;
...
80103fe9:	c7 44 24 04 15 91 10 	movl   $0x80109115,0x4(%esp)
80103ff0:	80 
80103ff1:	c7 04 24 00 10 11 80 	movl   $0x80111000,(%esp)
80103ff8:	e8 88 15 00 00       	call   80105585 <initlock>
  shm_init(); // New: Add in project final: inicializo shmtable.sharedmemory[i].refcount = -1
80103ffd:	e8 f6 10 00 00       	call   801050f8 <shm_init>
}
80104002:	c9                   	leave  
80104003:	c3                   	ret    
...
801040d3:	c7 04 24 1c 91 10 80 	movl   $0x8010911c,(%esp)
...
801041e2:	e8 bf 13 00 00       	call   801055a6 <acquire>
...
80104211:	e8 f2 13 00 00       	call   80105608 <release>
  return 0;
...
80104243:	e8 c0 13 00 00       	call   80105608 <release>
...
8010429a:	ba 55 6e 10 80       	mov    $0x80106e55,%edx
...
801042ca:	e8 29 15 00 00       	call   801057f8 <memset>
...
801042f8:	e8 1f 42 00 00       	call   8010851c <setupkvm>
...
8010430d:	c7 04 24 2b 91 10 80 	movl   $0x8010912b,(%esp)
...
80104333:	e8 30 44 00 00       	call   80108768 <inituvm>
  p->sz = PGSIZE;
...
8010435a:	e8 99 14 00 00       	call   801057f8 <memset>
...
801043d1:	00 
801043d2:	c7 44 24 04 44 91 10 	movl   $0x80109144,0x4(%esp)
801043d9:	80 
801043da:	89 04 24             	mov    %eax,(%esp)
801043dd:	e8 28 16 00 00       	call   80105a0a <safestrcpy>
  p->cwd = namei("/");
801043e2:	c7 04 24 4d 91 10 80 	movl   $0x8010914d,(%esp)
...
8010443f:	e8 9e 44 00 00       	call   801088e2 <allocuvm>
...
80104479:	e8 3e 45 00 00       	call   801089bc <deallocuvm>
...
801044a2:	e8 66 41 00 00       	call   8010860d <switchuvm>
  return 0;
...
801044e7:	e8 86 46 00 00       	call   80108b72 <copyuvm>
...
80104622:	e8 e3 13 00 00       	call   80105a0a <safestrcpy>
  return pid;
...
80104647:	75 0c                	jne    80104655 <exit+0x23>
    panic("init exiting");
80104649:	c7 04 24 4f 91 10 80 	movl   $0x8010914f,(%esp)
...
801046e7:	e8 57 08 00 00       	call   80104f43 <semfree>
  for(sd = 0; sd < MAXSEMPROC; sd++){
...
8010473c:	e8 c4 0a 00 00       	call   80105205 <shm_close>
  for(i = 0; i < MAXSHMPROC; i++){
...
80104751:	e8 50 0e 00 00       	call   801055a6 <acquire>
...
801047c1:	e8 db 01 00 00       	call   801049a1 <sched>
  panic("zombie exit");
801047c6:	c7 04 24 5c 91 10 80 	movl   $0x8010915c,(%esp)
...
801047df:	e8 c2 0d 00 00       	call   801055a6 <acquire>
  for(;;){
...
80104847:	e8 47 42 00 00       	call   80108a93 <freevm>
        p->state = UNUSED;
...
80104882:	e8 81 0d 00 00       	call   80105608 <release>
        return pid;
...
801048bb:	e8 48 0d 00 00       	call   80105608 <release>
      return -1;
...
801048f6:	e8 ab 0c 00 00       	call   801055a6 <acquire>
    // for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
    //   if(p->state != RUNNABLE)
...
80104948:	e8 c0 3c 00 00       	call   8010860d <switchuvm>
      p->state = RUNNING;
...
8010497b:	e8 f8 10 00 00       	call   80105a78 <swtch>
      switchkvm(); // Switch h/w page table register to the kernel-only page table,
80104980:	e8 6b 3c 00 00       	call   801085f0 <switchkvm>
...
80104997:	e8 6c 0c 00 00       	call   80105608 <release>
...
801049ae:	e8 1b 0d 00 00       	call   801056ce <holding>
801049b3:	85 c0                	test   %eax,%eax
801049b5:	75 0c                	jne    801049c3 <sched+0x22>
    panic("sched ptable.lock");
801049b7:	c7 04 24 68 91 10 80 	movl   $0x80109168,(%esp)
...
801049d2:	74 0c                	je     801049e0 <sched+0x3f>
    panic("sched locks");
801049d4:	c7 04 24 7a 91 10 80 	movl   $0x8010917a,(%esp)
...
801049ec:	75 0c                	jne    801049fa <sched+0x59>
    panic("sched running");
801049ee:	c7 04 24 86 91 10 80 	movl   $0x80109186,(%esp)
...
80104a08:	c7 04 24 94 91 10 80 	movl   $0x80109194,(%esp)
...
80104a3d:	e8 36 10 00 00       	call   80105a78 <swtch>
  cpu->intena = intena;
...
80104a60:	e8 41 0b 00 00       	call   801055a6 <acquire>
  // proc->state = RUNNABLE;
  // sched();
  if(proc->priority<3){ 
...
80104aab:	e8 58 0b 00 00       	call   80105608 <release>
}
80104ab0:	c9                   	leave  
80104ab1:	c3                   	ret    
...
80104abf:	e8 44 0b 00 00       	call   80105608 <release>
...
80104aec:	75 0c                	jne    80104afa <sleep+0x1c>
    panic("sleep");
80104aee:	c7 04 24 a8 91 10 80 	movl   $0x801091a8,(%esp)
...
80104b00:	c7 04 24 ae 91 10 80 	movl   $0x801091ae,(%esp)
...
80104b1c:	e8 85 0a 00 00       	call   801055a6 <acquire>
    release(lk);
80104b21:	8b 45 0c             	mov    0xc(%ebp),%eax
80104b24:	89 04 24             	mov    %eax,(%esp)
80104b27:	e8 dc 0a 00 00       	call   80105608 <release>
  }
...
80104b8a:	e8 79 0a 00 00       	call   80105608 <release>
    acquire(lk);
80104b8f:	8b 45 0c             	mov    0xc(%ebp),%eax
80104b92:	89 04 24             	mov    %eax,(%esp)
80104b95:	e8 0c 0a 00 00       	call   801055a6 <acquire>
  }
}
80104b9a:	c9                   	leave  
80104b9b:	c3                   	ret    
...
80104bf3:	e8 ae 09 00 00       	call   801055a6 <acquire>
  wakeup1(chan);
...
80104c0a:	e8 f9 09 00 00       	call   80105608 <release>
}
80104c0f:	c9                   	leave  
80104c10:	c3                   	ret    
...
80104c1e:	e8 83 09 00 00       	call   801055a6 <acquire>
  for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
...
80104c66:	e8 9d 09 00 00       	call   80105608 <release>
      return 0;
...
80104c89:	e8 7a 09 00 00       	call   80105608 <release>
  return -1;
...
80104ce1:	eb 07                	jmp    80104cea <procdump+0x55>
      ...
      state = "???";
80104ce3:	c7 45 ec bf 91 10 80 	movl   $0x801091bf,-0x14(%ebp)
...
80104d12:	c7 04 24 c3 91 10 80 	movl   $0x801091c3,(%esp)
...
80104d3f:	e8 13 09 00 00       	call   80105657 <getcallerpcs>
...
80104d58:	c7 04 24 cf 91 10 80 	movl   $0x801091cf,(%esp)
...
80104d76:	75 d5                	jne    80104d4d <procdump+0xb8>
    ...
    cprintf("\n");
80104d78:	c7 04 24 d3 91 10 80 	movl   $0x801091d3,(%esp)
...
80104de9:	83 ec 28             	sub    $0x28,%esp
	struct sem *t;
	struct sem *s;
	struct sem **r;
	...
	if (first_time) {
80104dec:	a1 24 c0 10 80       	mov    0x8010c024,%eax
80104df1:	85 c0                	test   %eax,%eax
80104df3:	74 1e                	je     80104e13 <semget+0x2d>
		initlock(&stable.lock, "stable"); // begin the mutual exclusion
80104df5:	c7 44 24 04 ff 91 10 	movl   $0x801091ff,0x4(%esp)
80104dfc:	80 
80104dfd:	c7 04 24 60 3b 11 80 	movl   $0x80113b60,(%esp)
80104e04:	e8 7c 07 00 00       	call   80105585 <initlock>
		first_time = 0;
80104e09:	c7 05 24 c0 10 80 00 	movl   $0x0,0x8010c024
80104e10:	00 00 00 
	}

	acquire(&stable.lock);
80104e13:	c7 04 24 60 3b 11 80 	movl   $0x80113b60,(%esp)
80104e1a:	e8 87 07 00 00       	call   801055a6 <acquire>
	if (sem_id == -1) { // se desea CREAR un semaforo nuevo
80104e1f:	83 7d 08 ff          	cmpl   $0xffffffff,0x8(%ebp)
80104e23:	0f 85 9d 00 00 00    	jne    80104ec6 <semget+0xe0>
		for (t = stable.sem; t < stable.sem + MAXSEM; t++)
80104e29:	c7 45 f4 94 3b 11 80 	movl   $0x80113b94,-0xc(%ebp)
80104e30:	eb 3b                	jmp    80104e6d <semget+0x87>
		if (t->refcount == 0){
80104e32:	8b 45 f4             	mov    -0xc(%ebp),%eax
80104e35:	8b 40 04             	mov    0x4(%eax),%eax
80104e38:	85 c0                	test   %eax,%eax
80104e3a:	75 2d                	jne    80104e69 <semget+0x83>
			s = t;
80104e3c:	8b 45 f4             	mov    -0xc(%ebp),%eax
80104e3f:	89 45 f0             	mov    %eax,-0x10(%ebp)
			if (*(r = checkprocsem()) == 0)
80104e42:	e8 56 ff ff ff       	call   80104d9d <checkprocsem>
80104e47:	89 45 ec             	mov    %eax,-0x14(%ebp)
80104e4a:	8b 45 ec             	mov    -0x14(%ebp),%eax
80104e4d:	8b 00                	mov    (%eax),%eax
80104e4f:	85 c0                	test   %eax,%eax
80104e51:	74 39                	je     80104e8c <semget+0xa6>
				goto found; // encontro
			release(&stable.lock);
80104e53:	c7 04 24 60 3b 11 80 	movl   $0x80113b60,(%esp)
80104e5a:	e8 a9 07 00 00       	call   80105608 <release>
			return -2; // el proceso ya obtuvo el numero maximo de semaforos
80104e5f:	b8 fe ff ff ff       	mov    $0xfffffffe,%eax
80104e64:	e9 d8 00 00 00       	jmp    80104f41 <semget+0x15b>
		for (t = stable.sem; t < stable.sem + MAXSEM; t++)
80104e69:	83 45 f4 08          	addl   $0x8,-0xc(%ebp)
80104e6d:	81 7d f4 14 3c 11 80 	cmpl   $0x80113c14,-0xc(%ebp)
80104e74:	72 bc                	jb     80104e32 <semget+0x4c>
		}
		release(&stable.lock);
80104e76:	c7 04 24 60 3b 11 80 	movl   $0x80113b60,(%esp)
80104e7d:	e8 86 07 00 00       	call   80105608 <release>
		return -3; // no ahi mas semaforos disponibles en el sistema
80104e82:	b8 fd ff ff ff       	mov    $0xfffffffd,%eax
80104e87:	e9 b5 00 00 00       	jmp    80104f41 <semget+0x15b>
				goto found; // encontro
80104e8c:	90                   	nop
...
80104e90:	8b 55 0c             	mov    0xc(%ebp),%edx
80104e93:	89 10                	mov    %edx,(%eax)
		s->refcount=1;
80104e95:	8b 45 f0             	mov    -0x10(%ebp),%eax
80104e98:	c7 40 04 01 00 00 00 	movl   $0x1,0x4(%eax)
		*r = s;
...
80104ea5:	89 10                	mov    %edx,(%eax)
		...
		release(&stable.lock);
80104ea7:	c7 04 24 60 3b 11 80 	movl   $0x80113b60,(%esp)
80104eae:	e8 55 07 00 00       	call   80105608 <release>
		return s - stable.sem;	
80104eb3:	8b 55 f0             	mov    -0x10(%ebp),%edx
80104eb6:	b8 94 3b 11 80       	mov    $0x80113b94,%eax
80104ebb:	89 d1                	mov    %edx,%ecx
80104ebd:	29 c1                	sub    %eax,%ecx
80104ebf:	89 c8                	mov    %ecx,%eax
80104ec1:	c1 f8 03             	sar    $0x3,%eax
80104ec4:	eb 7b                	jmp    80104f41 <semget+0x15b>

	} else { // en caso de que NO se desea crear un semaforo nuevo
		s = stable.sem + sem_id;
80104ec6:	8b 45 08             	mov    0x8(%ebp),%eax
80104ec9:	83 c0 06             	add    $0x6,%eax
80104ecc:	c1 e0 03             	shl    $0x3,%eax
80104ecf:	05 60 3b 11 80       	add    $0x80113b60,%eax
...
80104ee2:	75 13                	jne    80104ef7 <semget+0x111>
			release(&stable.lock);
80104ee4:	c7 04 24 60 3b 11 80 	movl   $0x80113b60,(%esp)
80104eeb:	e8 18 07 00 00       	call   80105608 <release>
			return -1; // el semaforo con ese "sem_id" no esta en uso 
80104ef0:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80104ef5:	eb 4a                	jmp    80104f41 <semget+0x15b>
		}else if (*(r = checkprocsem()) == 0){
80104ef7:	e8 a1 fe ff ff       	call   80104d9d <checkprocsem>
80104efc:	89 45 ec             	mov    %eax,-0x14(%ebp)
80104eff:	8b 45 ec             	mov    -0x14(%ebp),%eax
80104f02:	8b 00                	mov    (%eax),%eax
80104f04:	85 c0                	test   %eax,%eax
80104f06:	75 28                	jne    80104f30 <semget+0x14a>
			*r = s;
80104f08:	8b 45 ec             	mov    -0x14(%ebp),%eax
80104f0b:	8b 55 f0             	mov    -0x10(%ebp),%edx
80104f0e:	89 10                	mov    %edx,(%eax)
			s->refcount++;
80104f10:	8b 45 f0             	mov    -0x10(%ebp),%eax
80104f13:	8b 40 04             	mov    0x4(%eax),%eax
80104f16:	8d 50 01             	lea    0x1(%eax),%edx
80104f19:	8b 45 f0             	mov    -0x10(%ebp),%eax
80104f1c:	89 50 04             	mov    %edx,0x4(%eax)
			release(&stable.lock);
80104f1f:	c7 04 24 60 3b 11 80 	movl   $0x80113b60,(%esp)
80104f26:	e8 dd 06 00 00       	call   80105608 <release>
			return sem_id;
80104f2b:	8b 45 08             	mov    0x8(%ebp),%eax
80104f2e:	eb 11                	jmp    80104f41 <semget+0x15b>
		}	else {
			release(&stable.lock);
80104f30:	c7 04 24 60 3b 11 80 	movl   $0x80113b60,(%esp)
80104f37:	e8 cc 06 00 00       	call   80105608 <release>
			return -2; // el proceso ya obtuvo el maximo de semaforos
80104f3c:	b8 fe ff ff ff       	mov    $0xfffffffe,%eax
...
80104f46:	83 ec 28             	sub    $0x28,%esp
	struct sem *s;
	struct sem **r;

	s = stable.sem + sem_id;
80104f49:	8b 45 08             	mov    0x8(%ebp),%eax
80104f4c:	83 c0 06             	add    $0x6,%eax
80104f4f:	c1 e0 03             	shl    $0x3,%eax
80104f52:	05 60 3b 11 80       	add    $0x80113b60,%eax
80104f57:	83 c0 04             	add    $0x4,%eax
80104f5a:	89 45 f0             	mov    %eax,-0x10(%ebp)
	if (s->refcount == 0) // si no tiene ninguna referencia, entonces no esta en uso,	
80104f5d:	8b 45 f0             	mov    -0x10(%ebp),%eax
80104f60:	8b 40 04             	mov    0x4(%eax),%eax
80104f63:	85 c0                	test   %eax,%eax
80104f65:	75 07                	jne    80104f6e <semfree+0x2b>
		return -1;		 //  y no es posible liberarlo, se produce un ERROR! 
80104f67:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80104f6c:	eb 6a                	jmp    80104fd8 <semfree+0x95>

	// recorro todos los semaforos del proceso
	for (r = proc->procsem; r < proc->procsem + MAXSEMPROC; r++) {
80104f6e:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
80104f74:	05 88 00 00 00       	add    $0x88,%eax
80104f79:	89 45 f4             	mov    %eax,-0xc(%ebp)
80104f7c:	eb 45                	jmp    80104fc3 <semfree+0x80>
		if (*r == s) {
80104f7e:	8b 45 f4             	mov    -0xc(%ebp),%eax
80104f81:	8b 00                	mov    (%eax),%eax
80104f83:	3b 45 f0             	cmp    -0x10(%ebp),%eax
80104f86:	75 37                	jne    80104fbf <semfree+0x7c>
			*r = 0;
80104f88:	8b 45 f4             	mov    -0xc(%ebp),%eax
80104f8b:	c7 00 00 00 00 00    	movl   $0x0,(%eax)
			acquire(&stable.lock);
80104f91:	c7 04 24 60 3b 11 80 	movl   $0x80113b60,(%esp)
80104f98:	e8 09 06 00 00       	call   801055a6 <acquire>
...
80104fa3:	8d 50 ff             	lea    -0x1(%eax),%edx
80104fa6:	8b 45 f0             	mov    -0x10(%ebp),%eax
80104fa9:	89 50 04             	mov    %edx,0x4(%eax)
			release(&stable.lock);
80104fac:	c7 04 24 60 3b 11 80 	movl   $0x80113b60,(%esp)
80104fb3:	e8 50 06 00 00       	call   80105608 <release>
			return 0;
80104fb8:	b8 00 00 00 00       	mov    $0x0,%eax
80104fbd:	eb 19                	jmp    80104fd8 <semfree+0x95>
	for (r = proc->procsem; r < proc->procsem + MAXSEMPROC; r++) {
80104fbf:	83 45 f4 04          	addl   $0x4,-0xc(%ebp)
80104fc3:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
80104fc9:	05 98 00 00 00       	add    $0x98,%eax
80104fce:	3b 45 f4             	cmp    -0xc(%ebp),%eax
80104fd1:	77 ab                	ja     80104f7e <semfree+0x3b>
		}
	}
	return -1;
...
80104fdd:	83 ec 28             	sub    $0x28,%esp
	struct sem *s;

	s = stable.sem + sem_id;
80104fe0:	8b 45 08             	mov    0x8(%ebp),%eax
80104fe3:	83 c0 06             	add    $0x6,%eax
80104fe6:	c1 e0 03             	shl    $0x3,%eax
80104fe9:	05 60 3b 11 80       	add    $0x80113b60,%eax
80104fee:	83 c0 04             	add    $0x4,%eax
80104ff1:	89 45 f4             	mov    %eax,-0xc(%ebp)
	// cprintf("SEMDOWN>> sem_id = %d, semaforo %d, valor = %d, refcount = %d\n", sem_id, s, s->value, s->refcount);
	acquire(&stable.lock);
80104ff4:	c7 04 24 60 3b 11 80 	movl   $0x80113b60,(%esp)
80104ffb:	e8 a6 05 00 00       	call   801055a6 <acquire>
	if (s->refcount <= 0) {
80105000:	8b 45 f4             	mov    -0xc(%ebp),%eax
80105003:	8b 40 04             	mov    0x4(%eax),%eax
80105006:	85 c0                	test   %eax,%eax
80105008:	7f 28                	jg     80105032 <semdown+0x58>
		release(&stable.lock);
8010500a:	c7 04 24 60 3b 11 80 	movl   $0x80113b60,(%esp)
80105011:	e8 f2 05 00 00       	call   80105608 <release>
		// cprintf("SEMDOWN>> sem_id = %d, semaforo %d, valor = %d, refcount = %d\n", sem_id, s, s->value, s->refcount);
		return -1; // error!!
80105016:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
8010501b:	eb 3d                	jmp    8010505a <semdown+0x80>
	}
	while (s->value == 0)
	sleep(s, &stable.lock); 
8010501d:	c7 44 24 04 60 3b 11 	movl   $0x80113b60,0x4(%esp)
80105024:	80 
80105025:	8b 45 f4             	mov    -0xc(%ebp),%eax
80105028:	89 04 24             	mov    %eax,(%esp)
8010502b:	e8 ae fa ff ff       	call   80104ade <sleep>
80105030:	eb 01                	jmp    80105033 <semdown+0x59>
	while (s->value == 0)
80105032:	90                   	nop
80105033:	8b 45 f4             	mov    -0xc(%ebp),%eax
80105036:	8b 00                	mov    (%eax),%eax
80105038:	85 c0                	test   %eax,%eax
8010503a:	74 e1                	je     8010501d <semdown+0x43>
...
80105047:	89 10                	mov    %edx,(%eax)
	// cprintf("SEMDOWN>> sem_id = %d, semaforo %d, valor = %d, refcount = %d\n", sem_id, s, s->value, s->refcount);
	release(&stable.lock);
80105049:	c7 04 24 60 3b 11 80 	movl   $0x80113b60,(%esp)
80105050:	e8 b3 05 00 00       	call   80105608 <release>
	return 0;
...
8010505f:	83 ec 28             	sub    $0x28,%esp
struct sem *s;

	s = stable.sem + sem_id;
80105062:	8b 45 08             	mov    0x8(%ebp),%eax
80105065:	83 c0 06             	add    $0x6,%eax
80105068:	c1 e0 03             	shl    $0x3,%eax
8010506b:	05 60 3b 11 80       	add    $0x80113b60,%eax
80105070:	83 c0 04             	add    $0x4,%eax
80105073:	89 45 f4             	mov    %eax,-0xc(%ebp)
	// cprintf("SEMUP>> sem_id = %d, semaforo %d, valor = %d, refcount = %d\n", sem_id, s, s->value, s->refcount);
	acquire(&stable.lock);
80105076:	c7 04 24 60 3b 11 80 	movl   $0x80113b60,(%esp)
8010507d:	e8 24 05 00 00       	call   801055a6 <acquire>
	if (s->refcount <= 0) {
80105082:	8b 45 f4             	mov    -0xc(%ebp),%eax
80105085:	8b 40 04             	mov    0x4(%eax),%eax
80105088:	85 c0                	test   %eax,%eax
8010508a:	7f 13                	jg     8010509f <semup+0x43>
		release(&stable.lock);
8010508c:	c7 04 24 60 3b 11 80 	movl   $0x80113b60,(%esp)
80105093:	e8 70 05 00 00       	call   80105608 <release>
		// cprintf("SEMUP>> sem_id = %d, semaforo %d, valor = %d, refcount = %d\n", sem_id, s, s->value, s->refcount);
		return -1; // error, por que no ahi referencias en este semaforo.
80105098:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
8010509d:	eb 4a                	jmp    801050e9 <semup+0x8d>
	}
	if (s->value >= 0) {
8010509f:	8b 45 f4             	mov    -0xc(%ebp),%eax
801050a2:	8b 00                	mov    (%eax),%eax
801050a4:	85 c0                	test   %eax,%eax
801050a6:	78 3c                	js     801050e4 <semup+0x88>
		if (s->value == 0){
801050a8:	8b 45 f4             	mov    -0xc(%ebp),%eax
801050ab:	8b 00                	mov    (%eax),%eax
801050ad:	85 c0                	test   %eax,%eax
801050af:	75 1a                	jne    801050cb <semup+0x6f>
			s->value++;
801050b1:	8b 45 f4             	mov    -0xc(%ebp),%eax
801050b4:	8b 00                	mov    (%eax),%eax
801050b6:	8d 50 01             	lea    0x1(%eax),%edx
801050b9:	8b 45 f4             	mov    -0xc(%ebp),%eax
801050bc:	89 10                	mov    %edx,(%eax)
			wakeup(s); // despierto
801050be:	8b 45 f4             	mov    -0xc(%ebp),%eax
801050c1:	89 04 24             	mov    %eax,(%esp)
801050c4:	e8 1d fb ff ff       	call   80104be6 <wakeup>
801050c9:	eb 0d                	jmp    801050d8 <semup+0x7c>
		}else
			s->value++;
801050cb:	8b 45 f4             	mov    -0xc(%ebp),%eax
801050ce:	8b 00                	mov    (%eax),%eax
801050d0:	8d 50 01             	lea    0x1(%eax),%edx
801050d3:	8b 45 f4             	mov    -0xc(%ebp),%eax
801050d6:	89 10                	mov    %edx,(%eax)
			release(&stable.lock);
801050d8:	c7 04 24 60 3b 11 80 	movl   $0x80113b60,(%esp)
801050df:	e8 24 05 00 00       	call   80105608 <release>
			// cprintf("SEMUP>> sem_id = %d, semaforo %d, valor = %d, refcount = %d\n", sem_id, s, s->value, s->refcount);
	}
	return 0;
...
801050f1:	05 00 00 00 80       	add    $0x80000000,%eax
801050f6:	5d                   	pop    %ebp
801050f7:	c3                   	ret    
...
801050fe:	c7 44 24 04 06 92 10 	movl   $0x80109206,0x4(%esp)
80105105:	80 
80105106:	c7 04 24 c0 0f 11 80 	movl   $0x80110fc0,(%esp)
8010510d:	e8 73 04 00 00       	call   80105585 <initlock>
...
80105119:	eb 11                	jmp    8010512c <shm_init+0x34>
...
8010511e:	c7 04 c5 64 0f 11 80 	movl   $0xffffffff,-0x7feef09c(,%eax,8)
80105125:	ff ff ff ff 
  for(i = 0; i<MAXSHM; i++){ //recorro el arreglo hasta los MAXSHM=12 espacios de memoria compartida del sistema.
80105129:	ff 45 f4             	incl   -0xc(%ebp)
8010512c:	83 7d f4 0b          	cmpl   $0xb,-0xc(%ebp)
80105130:	7e e9                	jle    8010511b <shm_init+0x23>
  }
  return 0;
...
8010513c:	83 ec 28             	sub    $0x28,%esp
  acquire(&shmtable.lock);
8010513f:	c7 04 24 c0 0f 11 80 	movl   $0x80110fc0,(%esp)
80105146:	e8 5b 04 00 00       	call   801055a6 <acquire>
  if ( shmtable.quantity == MAXSHM ){ // si la cantidad de espacios activos en sharedmemory es igual a 12
8010514b:	a1 f4 0f 11 80       	mov    0x80110ff4,%eax
80105150:	66 83 f8 0c          	cmp    $0xc,%ax
80105154:	75 16                	jne    8010516c <shm_create+0x33>
    release(&shmtable.lock);         // es la logitud maxima del array sharedmemory, entonces:
80105156:	c7 04 24 c0 0f 11 80 	movl   $0x80110fc0,(%esp)
8010515d:	e8 a6 04 00 00       	call   80105608 <release>
...
80105196:	8b 04 c5 60 0f 11 80 	mov    -0x7feef0a0(,%eax,8),%eax
8010519d:	c7 44 24 08 00 10 00 	movl   $0x1000,0x8(%esp)
801051a4:	00 
801051a5:	c7 44 24 04 00 00 00 	movl   $0x0,0x4(%esp)
801051ac:	00 
801051ad:	89 04 24             	mov    %eax,(%esp)
801051b0:	e8 43 06 00 00       	call   801057f8 <memset>
...
801051b8:	8b 04 c5 64 0f 11 80 	mov    -0x7feef09c(,%eax,8),%eax
801051bf:	8d 50 01             	lea    0x1(%eax),%edx
801051c2:	8b 45 f4             	mov    -0xc(%ebp),%eax
801051c5:	89 14 c5 64 0f 11 80 	mov    %edx,-0x7feef09c(,%eax,8)
      shmtable.quantity++; // se tomo un espacio del arreglo 
801051cc:	a1 f4 0f 11 80       	mov    0x80110ff4,%eax
801051d1:	40                   	inc    %eax
801051d2:	66 a3 f4 0f 11 80    	mov    %ax,0x80110ff4
      release(&shmtable.lock);
801051d8:	c7 04 24 c0 0f 11 80 	movl   $0x80110fc0,(%esp)
801051df:	e8 24 04 00 00       	call   80105608 <release>
...
801051e7:	eb 1a                	jmp    80105203 <shm_create+0xca>
    } else
      ++i;
801051e9:	ff 45 f4             	incl   -0xc(%ebp)
  while (i<MAXSHM){ // busco el primer espacio desocupado
801051ec:	83 7d f4 0b          	cmpl   $0xb,-0xc(%ebp)
801051f0:	7e 83                	jle    80105175 <shm_create+0x3c>
  }
  release(&shmtable.lock);
801051f2:	c7 04 24 c0 0f 11 80 	movl   $0x80110fc0,(%esp)
801051f9:	e8 0a 04 00 00       	call   80105608 <release>
...
80105208:	83 ec 28             	sub    $0x28,%esp
  acquire(&shmtable.lock);  
8010520b:	c7 04 24 c0 0f 11 80 	movl   $0x80110fc0,(%esp)
80105212:	e8 8f 03 00 00       	call   801055a6 <acquire>
  if ( key < 0 || key > MAXSHM || shmtable.sharedmemory[key].refcount == -1){
80105217:	83 7d 08 00          	cmpl   $0x0,0x8(%ebp)
8010521b:	78 15                	js     80105232 <shm_close+0x2d>
8010521d:	83 7d 08 0c          	cmpl   $0xc,0x8(%ebp)
80105221:	7f 0f                	jg     80105232 <shm_close+0x2d>
80105223:	8b 45 08             	mov    0x8(%ebp),%eax
80105226:	8b 04 c5 64 0f 11 80 	mov    -0x7feef09c(,%eax,8),%eax
8010522d:	83 f8 ff             	cmp    $0xffffffff,%eax
80105230:	75 16                	jne    80105248 <shm_close+0x43>
    release(&shmtable.lock);
80105232:	c7 04 24 c0 0f 11 80 	movl   $0x80110fc0,(%esp)
80105239:	e8 ca 03 00 00       	call   80105608 <release>
...
80105243:	e9 8d 00 00 00       	jmp    801052d5 <shm_close+0xd0>
  }
  int i = 0;
80105248:	c7 45 f4 00 00 00 00 	movl   $0x0,-0xc(%ebp)
  while (i<MAXSHMPROC && (proc->shmref[i] != shmtable.sharedmemory[key].addr)){ // para poder buscar donde se encuentra
8010524f:	eb 03                	jmp    80105254 <shm_close+0x4f>
    i++; // avanzo al proximo
80105251:	ff 45 f4             	incl   -0xc(%ebp)
  while (i<MAXSHMPROC && (proc->shmref[i] != shmtable.sharedmemory[key].addr)){ // para poder buscar donde se encuentra
80105254:	83 7d f4 03          	cmpl   $0x3,-0xc(%ebp)
80105258:	7f 1e                	jg     80105278 <shm_close+0x73>
8010525a:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
80105260:	8b 55 f4             	mov    -0xc(%ebp),%edx
80105263:	83 c2 24             	add    $0x24,%edx
80105266:	8b 54 90 08          	mov    0x8(%eax,%edx,4),%edx
8010526a:	8b 45 08             	mov    0x8(%ebp),%eax
8010526d:	8b 04 c5 60 0f 11 80 	mov    -0x7feef0a0(,%eax,8),%eax
80105274:	39 c2                	cmp    %eax,%edx
80105276:	75 d9                	jne    80105251 <shm_close+0x4c>
  }
  if (i == MAXSHMPROC){ 
80105278:	83 7d f4 04          	cmpl   $0x4,-0xc(%ebp)
8010527c:	75 13                	jne    80105291 <shm_close+0x8c>
    release(&shmtable.lock);
8010527e:	c7 04 24 c0 0f 11 80 	movl   $0x80110fc0,(%esp)
80105285:	e8 7e 03 00 00       	call   80105608 <release>
...
801052b9:	c7 04 c5 64 0f 11 80 	movl   $0xffffffff,-0x7feef09c(,%eax,8)
801052c0:	ff ff ff ff 
  }
  release(&shmtable.lock);
801052c4:	c7 04 24 c0 0f 11 80 	movl   $0x80110fc0,(%esp)
801052cb:	e8 38 03 00 00       	call   80105608 <release>
...
801052da:	83 ec 38             	sub    $0x38,%esp
  int j;
  acquire(&shmtable.lock);
801052dd:	c7 04 24 c0 0f 11 80 	movl   $0x80110fc0,(%esp)
801052e4:	e8 bd 02 00 00       	call   801055a6 <acquire>
  if ( key < 0 || key > MAXSHM || shmtable.sharedmemory[key].refcount == MAXSHMPROC ){ 
801052e9:	83 7d 08 00          	cmpl   $0x0,0x8(%ebp)
801052ed:	78 15                	js     80105304 <shm_get+0x2d>
801052ef:	83 7d 08 0c          	cmpl   $0xc,0x8(%ebp)
801052f3:	7f 0f                	jg     80105304 <shm_get+0x2d>
801052f5:	8b 45 08             	mov    0x8(%ebp),%eax
801052f8:	8b 04 c5 64 0f 11 80 	mov    -0x7feef09c(,%eax,8),%eax
801052ff:	83 f8 04             	cmp    $0x4,%eax
80105302:	75 16                	jne    8010531a <shm_get+0x43>
    release(&shmtable.lock);                 
80105304:	c7 04 24 c0 0f 11 80 	movl   $0x80110fc0,(%esp)
8010530b:	e8 f8 02 00 00       	call   80105608 <release>
    return -1; // key invalida, debido a que esta fuera de los indices la key.
80105310:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80105315:	e9 24 01 00 00       	jmp    8010543e <shm_get+0x167>
  }  
  int i = 0;
8010531a:	c7 45 f4 00 00 00 00 	movl   $0x0,-0xc(%ebp)
  while (i<MAXSHMPROC && proc->shmref[i] != 0 ){ // existe una referencia
80105321:	eb 03                	jmp    80105326 <shm_get+0x4f>
    i++;
80105323:	ff 45 f4             	incl   -0xc(%ebp)
  while (i<MAXSHMPROC && proc->shmref[i] != 0 ){ // existe una referencia
80105326:	83 7d f4 03          	cmpl   $0x3,-0xc(%ebp)
8010532a:	7f 14                	jg     80105340 <shm_get+0x69>
8010532c:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
80105332:	8b 55 f4             	mov    -0xc(%ebp),%edx
80105335:	83 c2 24             	add    $0x24,%edx
80105338:	8b 44 90 08          	mov    0x8(%eax,%edx,4),%eax
8010533c:	85 c0                	test   %eax,%eax
8010533e:	75 e3                	jne    80105323 <shm_get+0x4c>
  }
  if (i == MAXSHMPROC ){ // si agoto los 4 espacios que posee el proceso disponible, entonces..
80105340:	83 7d f4 04          	cmpl   $0x4,-0xc(%ebp)
80105344:	75 16                	jne    8010535c <shm_get+0x85>
    release(&shmtable.lock); 
80105346:	c7 04 24 c0 0f 11 80 	movl   $0x80110fc0,(%esp)
8010534d:	e8 b6 02 00 00       	call   80105608 <release>
...
80105357:	e9 e2 00 00 00       	jmp    8010543e <shm_get+0x167>
  } else {  
...
80105369:	e8 7d fd ff ff       	call   801050eb <v2p>
8010536e:	65 8b 15 04 00 00 00 	mov    %gs:0x4,%edx
80105375:	8b 12                	mov    (%edx),%edx
80105377:	81 e2 00 f0 ff ff    	and    $0xfffff000,%edx
8010537d:	89 d1                	mov    %edx,%ecx
8010537f:	65 8b 15 04 00 00 00 	mov    %gs:0x4,%edx
80105386:	8b 52 04             	mov    0x4(%edx),%edx
80105389:	c7 44 24 10 06 00 00 	movl   $0x6,0x10(%esp)
80105390:	00 
80105391:	89 44 24 0c          	mov    %eax,0xc(%esp)
80105395:	c7 44 24 08 00 10 00 	movl   $0x1000,0x8(%esp)
8010539c:	00 
8010539d:	89 4c 24 04          	mov    %ecx,0x4(%esp)
801053a1:	89 14 24             	mov    %edx,(%esp)
801053a4:	e8 df 30 00 00       	call   80108488 <mappages>
801053a9:	89 45 f0             	mov    %eax,-0x10(%ebp)
...
801053ac:	83 7d f0 ff          	cmpl   $0xffffffff,-0x10(%ebp)
801053b0:	75 0c                	jne    801053be <shm_get+0xe7>
801053b2:	c7 04 24 0f 92 10 80 	movl   $0x8010920f,(%esp)
801053b9:	e8 e3 af ff ff       	call   801003a1 <cprintf>
...
801053c7:	8b 14 d5 60 0f 11 80 	mov    -0x7feef0a0(,%edx,8),%edx
801053ce:	8b 4d f4             	mov    -0xc(%ebp),%ecx
801053d1:	83 c1 24             	add    $0x24,%ecx
801053d4:	89 54 88 08          	mov    %edx,0x8(%eax,%ecx,4)
    shmtable.sharedmemory[key].refcount++; 
801053d8:	8b 45 08             	mov    0x8(%ebp),%eax
801053db:	8b 04 c5 64 0f 11 80 	mov    -0x7feef09c(,%eax,8),%eax
801053e2:	8d 50 01             	lea    0x1(%eax),%edx
801053e5:	8b 45 08             	mov    0x8(%ebp),%eax
801053e8:	89 14 c5 64 0f 11 80 	mov    %edx,-0x7feef09c(,%eax,8)
...
801053f7:	25 00 f0 ff ff       	and    $0xfffff000,%eax
801053fc:	89 c2                	mov    %eax,%edx
...
80105409:	8b 90 a8 00 00 00    	mov    0xa8(%eax),%edx
8010540f:	42                   	inc    %edx
80105410:	89 90 a8 00 00 00    	mov    %edx,0xa8(%eax)
...
80105423:	8b 12                	mov    (%edx),%edx
80105425:	81 c2 00 10 00 00    	add    $0x1000,%edx
8010542b:	89 10                	mov    %edx,(%eax)
    release(&shmtable.lock);
8010542d:	c7 04 24 c0 0f 11 80 	movl   $0x80110fc0,(%esp)
80105434:	e8 cf 01 00 00       	call   80105608 <release>
...
80105443:	b8 60 0f 11 80       	mov    $0x80110f60,%eax
}
80105448:	5d                   	pop    %ebp
80105449:	c3                   	ret    

8010544a <sys_shm_create>:
...
8010545e:	e8 c6 06 00 00       	call   80105b29 <argint>
80105463:	85 c0                	test   %eax,%eax
80105465:	79 0e                	jns    80105475 <sys_shm_create+0x2b>
80105467:	8b 45 f0             	mov    -0x10(%ebp),%eax
8010546a:	85 c0                	test   %eax,%eax
8010546c:	7e 07                	jle    80105475 <sys_shm_create+0x2b>
    return -1;
8010546e:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80105473:	eb 0b                	jmp    80105480 <sys_shm_create+0x36>
  int k = shm_create();
80105475:	e8 bf fc ff ff       	call   80105139 <shm_create>
...
80105485:	83 ec 28             	sub    $0x28,%esp
  int k;
  int mem = 0;  
80105488:	c7 45 f0 00 00 00 00 	movl   $0x0,-0x10(%ebp)
  if (proc->shmemquantity >= MAXSHMPROC)
8010548f:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
80105495:	8b 80 a8 00 00 00    	mov    0xa8(%eax),%eax
8010549b:	83 f8 03             	cmp    $0x3,%eax
8010549e:	7e 07                	jle    801054a7 <sys_shm_get+0x25>
    return -1;
801054a0:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
801054a5:	eb 55                	jmp    801054fc <sys_shm_get+0x7a>
  if(argint(0, &k) < 0)
801054a7:	8d 45 f4             	lea    -0xc(%ebp),%eax
801054aa:	89 44 24 04          	mov    %eax,0x4(%esp)
801054ae:	c7 04 24 00 00 00 00 	movl   $0x0,(%esp)
801054b5:	e8 6f 06 00 00       	call   80105b29 <argint>
801054ba:	85 c0                	test   %eax,%eax
801054bc:	79 07                	jns    801054c5 <sys_shm_get+0x43>
    return -1;
801054be:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
801054c3:	eb 37                	jmp    801054fc <sys_shm_get+0x7a>
  argint(1,&mem); 
801054c5:	8d 45 f0             	lea    -0x10(%ebp),%eax
801054c8:	89 44 24 04          	mov    %eax,0x4(%esp)
801054cc:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
801054d3:	e8 51 06 00 00       	call   80105b29 <argint>
...
801054e7:	e8 eb fd ff ff       	call   801052d7 <shm_get>
801054ec:	85 c0                	test   %eax,%eax
801054ee:	75 07                	jne    801054f7 <sys_shm_get+0x75>
    return 0;
801054f0:	b8 00 00 00 00       	mov    $0x0,%eax
801054f5:	eb 05                	jmp    801054fc <sys_shm_get+0x7a>
  }
  return -1;
...
80105501:	83 ec 28             	sub    $0x28,%esp
  int k;
  if(argint(0, &k) < 0)
80105504:	8d 45 f4             	lea    -0xc(%ebp),%eax
80105507:	89 44 24 04          	mov    %eax,0x4(%esp)
8010550b:	c7 04 24 00 00 00 00 	movl   $0x0,(%esp)
80105512:	e8 12 06 00 00       	call   80105b29 <argint>
80105517:	85 c0                	test   %eax,%eax
80105519:	79 07                	jns    80105522 <sys_shm_close+0x24>
    return -1;
8010551b:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80105520:	eb 1b                	jmp    8010553d <sys_shm_close+0x3f>
  if (!shm_close(k)){    
80105522:	8b 45 f4             	mov    -0xc(%ebp),%eax
80105525:	89 04 24             	mov    %eax,(%esp)
80105528:	e8 d8 fc ff ff       	call   80105205 <shm_close>
8010552d:	85 c0                	test   %eax,%eax
8010552f:	75 07                	jne    80105538 <sys_shm_close+0x3a>
    return 0;
80105531:	b8 00 00 00 00       	mov    $0x0,%eax
80105536:	eb 05                	jmp    8010553d <sys_shm_close+0x3f>
  }
  return -1;
...
80105546:	9c                   	pushf  
80105547:	5b                   	pop    %ebx
80105548:	89 5d f8             	mov    %ebx,-0x8(%ebp)
  return eflags;
...
8010558e:	89 50 04             	mov    %edx,0x4(%eax)
  lk->locked = 0;
80105591:	8b 45 08             	mov    0x8(%ebp),%eax
80105594:	c7 00 00 00 00 00    	movl   $0x0,(%eax)
  lk->cpu = 0;
8010559a:	8b 45 08             	mov    0x8(%ebp),%eax
8010559d:	c7 40 08 00 00 00 00 	movl   $0x0,0x8(%eax)
}
801055a4:	5d                   	pop    %ebp
801055a5:	c3                   	ret    
...
801055ac:	e8 47 01 00 00       	call   801056f8 <pushcli>
  if(holding(lk))
801055b1:	8b 45 08             	mov    0x8(%ebp),%eax
801055b4:	89 04 24             	mov    %eax,(%esp)
801055b7:	e8 12 01 00 00       	call   801056ce <holding>
801055bc:	85 c0                	test   %eax,%eax
801055be:	74 0c                	je     801055cc <acquire+0x26>
    panic("acquire");
801055c0:	c7 04 24 20 92 10 80 	movl   $0x80109220,(%esp)
801055c7:	e8 6a af ff ff       	call   80100536 <panic>
...
801055d0:	c7 44 24 04 01 00 00 	movl   $0x1,0x4(%esp)
801055d7:	00 
801055d8:	89 04 24             	mov    %eax,(%esp)
801055db:	e8 80 ff ff ff       	call   80105560 <xchg>
801055e0:	85 c0                	test   %eax,%eax
801055e2:	75 e9                	jne    801055cd <acquire+0x27>
    ;

  // Record info about lock acquisition for debugging.
  lk->cpu = cpu;
801055e4:	8b 45 08             	mov    0x8(%ebp),%eax
801055e7:	65 8b 15 00 00 00 00 	mov    %gs:0x0,%edx
801055ee:	89 50 08             	mov    %edx,0x8(%eax)
  getcallerpcs(&lk, lk->pcs);
801055f1:	8b 45 08             	mov    0x8(%ebp),%eax
801055f4:	83 c0 0c             	add    $0xc,%eax
801055f7:	89 44 24 04          	mov    %eax,0x4(%esp)
801055fb:	8d 45 08             	lea    0x8(%ebp),%eax
801055fe:	89 04 24             	mov    %eax,(%esp)
80105601:	e8 51 00 00 00       	call   80105657 <getcallerpcs>
}
80105606:	c9                   	leave  
80105607:	c3                   	ret    
...
80105614:	e8 b5 00 00 00       	call   801056ce <holding>
80105619:	85 c0                	test   %eax,%eax
8010561b:	75 0c                	jne    80105629 <release+0x21>
    panic("release");
8010561d:	c7 04 24 28 92 10 80 	movl   $0x80109228,(%esp)
80105624:	e8 0d af ff ff       	call   80100536 <panic>

  lk->pcs[0] = 0;
80105629:	8b 45 08             	mov    0x8(%ebp),%eax
8010562c:	c7 40 0c 00 00 00 00 	movl   $0x0,0xc(%eax)
  lk->cpu = 0;
80105633:	8b 45 08             	mov    0x8(%ebp),%eax
80105636:	c7 40 08 00 00 00 00 	movl   $0x0,0x8(%eax)
...
80105640:	c7 44 24 04 00 00 00 	movl   $0x0,0x4(%esp)
80105647:	00 
80105648:	89 04 24             	mov    %eax,(%esp)
8010564b:	e8 10 ff ff ff       	call   80105560 <xchg>

  popcli();
80105650:	e8 e9 00 00 00       	call   8010573e <popcli>
}
80105655:	c9                   	leave  
80105656:	c3                   	ret    

80105657 <getcallerpcs>:
...
80105660:	83 e8 08             	sub    $0x8,%eax
80105663:	89 45 fc             	mov    %eax,-0x4(%ebp)
  for(i = 0; i < 10; i++){
80105666:	c7 45 f8 00 00 00 00 	movl   $0x0,-0x8(%ebp)
8010566d:	eb 37                	jmp    801056a6 <getcallerpcs+0x4f>
    if(ebp == 0 || ebp < (uint*)KERNBASE || ebp == (uint*)0xffffffff)
8010566f:	83 7d fc 00          	cmpl   $0x0,-0x4(%ebp)
80105673:	74 51                	je     801056c6 <getcallerpcs+0x6f>
80105675:	81 7d fc ff ff ff 7f 	cmpl   $0x7fffffff,-0x4(%ebp)
8010567c:	76 48                	jbe    801056c6 <getcallerpcs+0x6f>
8010567e:	83 7d fc ff          	cmpl   $0xffffffff,-0x4(%ebp)
80105682:	74 42                	je     801056c6 <getcallerpcs+0x6f>
      break;
    pcs[i] = ebp[1];     // saved %eip
80105684:	8b 45 f8             	mov    -0x8(%ebp),%eax
80105687:	8d 14 85 00 00 00 00 	lea    0x0(,%eax,4),%edx
8010568e:	8b 45 0c             	mov    0xc(%ebp),%eax
80105691:	01 c2                	add    %eax,%edx
80105693:	8b 45 fc             	mov    -0x4(%ebp),%eax
80105696:	8b 40 04             	mov    0x4(%eax),%eax
80105699:	89 02                	mov    %eax,(%edx)
    ebp = (uint*)ebp[0]; // saved %ebp
8010569b:	8b 45 fc             	mov    -0x4(%ebp),%eax
8010569e:	8b 00                	mov    (%eax),%eax
801056a0:	89 45 fc             	mov    %eax,-0x4(%ebp)
  for(i = 0; i < 10; i++){
801056a3:	ff 45 f8             	incl   -0x8(%ebp)
801056a6:	83 7d f8 09          	cmpl   $0x9,-0x8(%ebp)
801056aa:	7e c3                	jle    8010566f <getcallerpcs+0x18>
  }
  for(; i < 10; i++)
801056ac:	eb 18                	jmp    801056c6 <getcallerpcs+0x6f>
    pcs[i] = 0;
801056ae:	8b 45 f8             	mov    -0x8(%ebp),%eax
801056b1:	8d 14 85 00 00 00 00 	lea    0x0(,%eax,4),%edx
801056b8:	8b 45 0c             	mov    0xc(%ebp),%eax
801056bb:	01 d0                	add    %edx,%eax
801056bd:	c7 00 00 00 00 00    	movl   $0x0,(%eax)
  for(; i < 10; i++)
801056c3:	ff 45 f8             	incl   -0x8(%ebp)
801056c6:	83 7d f8 09          	cmpl   $0x9,-0x8(%ebp)
801056ca:	7e e2                	jle    801056ae <getcallerpcs+0x57>
}
801056cc:	c9                   	leave  
801056cd:	c3                   	ret    
...
801056d8:	74 17                	je     801056f1 <holding+0x23>
801056da:	8b 45 08             	mov    0x8(%ebp),%eax
801056dd:	8b 50 08             	mov    0x8(%eax),%edx
801056e0:	65 a1 00 00 00 00    	mov    %gs:0x0,%eax
801056e6:	39 c2                	cmp    %eax,%edx
801056e8:	75 07                	jne    801056f1 <holding+0x23>
801056ea:	b8 01 00 00 00       	mov    $0x1,%eax
801056ef:	eb 05                	jmp    801056f6 <holding+0x28>
...
801056fb:	83 ec 10             	sub    $0x10,%esp
  ...
  eflags = readeflags();
801056fe:	e8 3c fe ff ff       	call   8010553f <readeflags>
80105703:	89 45 fc             	mov    %eax,-0x4(%ebp)
  cli();
80105706:	e8 49 fe ff ff       	call   80105554 <cli>
  if(cpu->ncli++ == 0)
8010570b:	65 a1 00 00 00 00    	mov    %gs:0x0,%eax
80105711:	8b 90 ac 00 00 00    	mov    0xac(%eax),%edx
80105717:	85 d2                	test   %edx,%edx
80105719:	0f 94 c1             	sete   %cl
8010571c:	42                   	inc    %edx
8010571d:	89 90 ac 00 00 00    	mov    %edx,0xac(%eax)
80105723:	84 c9                	test   %cl,%cl
80105725:	74 15                	je     8010573c <pushcli+0x44>
    cpu->intena = eflags & FL_IF;
80105727:	65 a1 00 00 00 00    	mov    %gs:0x0,%eax
8010572d:	8b 55 fc             	mov    -0x4(%ebp),%edx
80105730:	81 e2 00 02 00 00    	and    $0x200,%edx
80105736:	89 90 b0 00 00 00    	mov    %edx,0xb0(%eax)
}
8010573c:	c9                   	leave  
8010573d:	c3                   	ret    
...
80105741:	83 ec 18             	sub    $0x18,%esp
  if(readeflags()&FL_IF)
80105744:	e8 f6 fd ff ff       	call   8010553f <readeflags>
80105749:	25 00 02 00 00       	and    $0x200,%eax
8010574e:	85 c0                	test   %eax,%eax
80105750:	74 0c                	je     8010575e <popcli+0x20>
    panic("popcli - interruptible");
80105752:	c7 04 24 30 92 10 80 	movl   $0x80109230,(%esp)
80105759:	e8 d8 ad ff ff       	call   80100536 <panic>
  if(--cpu->ncli < 0)
8010575e:	65 a1 00 00 00 00    	mov    %gs:0x0,%eax
80105764:	8b 90 ac 00 00 00    	mov    0xac(%eax),%edx
8010576a:	4a                   	dec    %edx
8010576b:	89 90 ac 00 00 00    	mov    %edx,0xac(%eax)
80105771:	8b 80 ac 00 00 00    	mov    0xac(%eax),%eax
80105777:	85 c0                	test   %eax,%eax
80105779:	79 0c                	jns    80105787 <popcli+0x49>
    panic("popcli");
8010577b:	c7 04 24 47 92 10 80 	movl   $0x80109247,(%esp)
80105782:	e8 af ad ff ff       	call   80100536 <panic>
  if(cpu->ncli == 0 && cpu->intena)
80105787:	65 a1 00 00 00 00    	mov    %gs:0x0,%eax
8010578d:	8b 80 ac 00 00 00    	mov    0xac(%eax),%eax
80105793:	85 c0                	test   %eax,%eax
80105795:	75 15                	jne    801057ac <popcli+0x6e>
80105797:	65 a1 00 00 00 00    	mov    %gs:0x0,%eax
8010579d:	8b 80 b0 00 00 00    	mov    0xb0(%eax),%eax
801057a3:	85 c0                	test   %eax,%eax
801057a5:	74 05                	je     801057ac <popcli+0x6e>
    sti();
801057a7:	e8 ae fd ff ff       	call   8010555a <sti>
}
801057ac:	c9                   	leave  
801057ad:	c3                   	ret    
...
801057b3:	8b 4d 08             	mov    0x8(%ebp),%ecx
801057b6:	8b 55 10             	mov    0x10(%ebp),%edx
801057b9:	8b 45 0c             	mov    0xc(%ebp),%eax
801057bc:	89 cb                	mov    %ecx,%ebx
801057be:	89 df                	mov    %ebx,%edi
801057c0:	89 d1                	mov    %edx,%ecx
801057c2:	fc                   	cld    
801057c3:	f3 aa                	rep stos %al,%es:(%edi)
801057c5:	89 ca                	mov    %ecx,%edx
801057c7:	89 fb                	mov    %edi,%ebx
801057c9:	89 5d 08             	mov    %ebx,0x8(%ebp)
...
801057d8:	8b 4d 08             	mov    0x8(%ebp),%ecx
801057db:	8b 55 10             	mov    0x10(%ebp),%edx
801057de:	8b 45 0c             	mov    0xc(%ebp),%eax
801057e1:	89 cb                	mov    %ecx,%ebx
801057e3:	89 df                	mov    %ebx,%edi
801057e5:	89 d1                	mov    %edx,%ecx
801057e7:	fc                   	cld    
801057e8:	f3 ab                	rep stos %eax,%es:(%edi)
801057ea:	89 ca                	mov    %ecx,%edx
801057ec:	89 fb                	mov    %edi,%ebx
801057ee:	89 5d 08             	mov    %ebx,0x8(%ebp)
...
80105806:	75 49                	jne    80105851 <memset+0x59>
80105808:	8b 45 10             	mov    0x10(%ebp),%eax
8010580b:	83 e0 03             	and    $0x3,%eax
8010580e:	85 c0                	test   %eax,%eax
80105810:	75 3f                	jne    80105851 <memset+0x59>
    c &= 0xFF;
80105812:	81 65 0c ff 00 00 00 	andl   $0xff,0xc(%ebp)
    stosl(dst, (c<<24)|(c<<16)|(c<<8)|c, n/4);
80105819:	8b 45 10             	mov    0x10(%ebp),%eax
8010581c:	c1 e8 02             	shr    $0x2,%eax
8010581f:	89 c2                	mov    %eax,%edx
80105821:	8b 45 0c             	mov    0xc(%ebp),%eax
80105824:	89 c1                	mov    %eax,%ecx
80105826:	c1 e1 18             	shl    $0x18,%ecx
80105829:	8b 45 0c             	mov    0xc(%ebp),%eax
8010582c:	c1 e0 10             	shl    $0x10,%eax
8010582f:	09 c1                	or     %eax,%ecx
80105831:	8b 45 0c             	mov    0xc(%ebp),%eax
80105834:	c1 e0 08             	shl    $0x8,%eax
80105837:	09 c8                	or     %ecx,%eax
80105839:	0b 45 0c             	or     0xc(%ebp),%eax
8010583c:	89 54 24 08          	mov    %edx,0x8(%esp)
80105840:	89 44 24 04          	mov    %eax,0x4(%esp)
80105844:	8b 45 08             	mov    0x8(%ebp),%eax
80105847:	89 04 24             	mov    %eax,(%esp)
8010584a:	e8 84 ff ff ff       	call   801057d3 <stosl>
8010584f:	eb 19                	jmp    8010586a <memset+0x72>
  } else
    stosb(dst, c, n);
...
80105865:	e8 44 ff ff ff       	call   801057ae <stosb>
  return dst;
...
8010587e:	89 45 f8             	mov    %eax,-0x8(%ebp)
  while(n-- > 0){
80105881:	eb 2c                	jmp    801058af <memcmp+0x40>
    if(*s1 != *s2)
80105883:	8b 45 fc             	mov    -0x4(%ebp),%eax
80105886:	8a 10                	mov    (%eax),%dl
80105888:	8b 45 f8             	mov    -0x8(%ebp),%eax
8010588b:	8a 00                	mov    (%eax),%al
8010588d:	38 c2                	cmp    %al,%dl
8010588f:	74 18                	je     801058a9 <memcmp+0x3a>
      return *s1 - *s2;
80105891:	8b 45 fc             	mov    -0x4(%ebp),%eax
80105894:	8a 00                	mov    (%eax),%al
80105896:	0f b6 d0             	movzbl %al,%edx
80105899:	8b 45 f8             	mov    -0x8(%ebp),%eax
8010589c:	8a 00                	mov    (%eax),%al
8010589e:	0f b6 c0             	movzbl %al,%eax
801058a1:	89 d1                	mov    %edx,%ecx
801058a3:	29 c1                	sub    %eax,%ecx
801058a5:	89 c8                	mov    %ecx,%eax
801058a7:	eb 19                	jmp    801058c2 <memcmp+0x53>
    s1++, s2++;
801058a9:	ff 45 fc             	incl   -0x4(%ebp)
801058ac:	ff 45 f8             	incl   -0x8(%ebp)
  while(n-- > 0){
801058af:	83 7d 10 00          	cmpl   $0x0,0x10(%ebp)
801058b3:	0f 95 c0             	setne  %al
801058b6:	ff 4d 10             	decl   0x10(%ebp)
801058b9:	84 c0                	test   %al,%al
801058bb:	75 c6                	jne    80105883 <memcmp+0x14>
  }
...
801058d3:	89 45 f8             	mov    %eax,-0x8(%ebp)
  if(s < d && s + n > d){
801058d6:	8b 45 fc             	mov    -0x4(%ebp),%eax
801058d9:	3b 45 f8             	cmp    -0x8(%ebp),%eax
801058dc:	73 4d                	jae    8010592b <memmove+0x67>
801058de:	8b 45 10             	mov    0x10(%ebp),%eax
801058e1:	8b 55 fc             	mov    -0x4(%ebp),%edx
801058e4:	01 d0                	add    %edx,%eax
801058e6:	3b 45 f8             	cmp    -0x8(%ebp),%eax
801058e9:	76 40                	jbe    8010592b <memmove+0x67>
    s += n;
801058eb:	8b 45 10             	mov    0x10(%ebp),%eax
801058ee:	01 45 fc             	add    %eax,-0x4(%ebp)
    d += n;
801058f1:	8b 45 10             	mov    0x10(%ebp),%eax
801058f4:	01 45 f8             	add    %eax,-0x8(%ebp)
    while(n-- > 0)
801058f7:	eb 10                	jmp    80105909 <memmove+0x45>
      *--d = *--s;
801058f9:	ff 4d f8             	decl   -0x8(%ebp)
801058fc:	ff 4d fc             	decl   -0x4(%ebp)
801058ff:	8b 45 fc             	mov    -0x4(%ebp),%eax
80105902:	8a 10                	mov    (%eax),%dl
80105904:	8b 45 f8             	mov    -0x8(%ebp),%eax
80105907:	88 10                	mov    %dl,(%eax)
    while(n-- > 0)
80105909:	83 7d 10 00          	cmpl   $0x0,0x10(%ebp)
8010590d:	0f 95 c0             	setne  %al
80105910:	ff 4d 10             	decl   0x10(%ebp)
80105913:	84 c0                	test   %al,%al
80105915:	75 e2                	jne    801058f9 <memmove+0x35>
  if(s < d && s + n > d){
80105917:	eb 21                	jmp    8010593a <memmove+0x76>
  } else
    while(n-- > 0)
      *d++ = *s++;
80105919:	8b 45 fc             	mov    -0x4(%ebp),%eax
8010591c:	8a 10                	mov    (%eax),%dl
8010591e:	8b 45 f8             	mov    -0x8(%ebp),%eax
80105921:	88 10                	mov    %dl,(%eax)
80105923:	ff 45 f8             	incl   -0x8(%ebp)
80105926:	ff 45 fc             	incl   -0x4(%ebp)
80105929:	eb 01                	jmp    8010592c <memmove+0x68>
    while(n-- > 0)
8010592b:	90                   	nop
8010592c:	83 7d 10 00          	cmpl   $0x0,0x10(%ebp)
80105930:	0f 95 c0             	setne  %al
80105933:	ff 4d 10             	decl   0x10(%ebp)
80105936:	84 c0                	test   %al,%al
80105938:	75 df                	jne    80105919 <memmove+0x55>
...
80105959:	e8 66 ff ff ff       	call   801058c4 <memmove>
}
8010595e:	c9                   	leave  
8010595f:	c3                   	ret    
...
80105961:	89 e5                	mov    %esp,%ebp
  while(n > 0 && *p && *p == *q)
80105963:	eb 09                	jmp    8010596e <strncmp+0xe>
    n--, p++, q++;
80105965:	ff 4d 10             	decl   0x10(%ebp)
80105968:	ff 45 08             	incl   0x8(%ebp)
8010596b:	ff 45 0c             	incl   0xc(%ebp)
  while(n > 0 && *p && *p == *q)
8010596e:	83 7d 10 00          	cmpl   $0x0,0x10(%ebp)
80105972:	74 17                	je     8010598b <strncmp+0x2b>
80105974:	8b 45 08             	mov    0x8(%ebp),%eax
80105977:	8a 00                	mov    (%eax),%al
80105979:	84 c0                	test   %al,%al
8010597b:	74 0e                	je     8010598b <strncmp+0x2b>
8010597d:	8b 45 08             	mov    0x8(%ebp),%eax
80105980:	8a 10                	mov    (%eax),%dl
80105982:	8b 45 0c             	mov    0xc(%ebp),%eax
80105985:	8a 00                	mov    (%eax),%al
80105987:	38 c2                	cmp    %al,%dl
80105989:	74 da                	je     80105965 <strncmp+0x5>
  if(n == 0)
8010598b:	83 7d 10 00          	cmpl   $0x0,0x10(%ebp)
8010598f:	75 07                	jne    80105998 <strncmp+0x38>
    return 0;
80105991:	b8 00 00 00 00       	mov    $0x0,%eax
80105996:	eb 16                	jmp    801059ae <strncmp+0x4e>
  return (uchar)*p - (uchar)*q;
80105998:	8b 45 08             	mov    0x8(%ebp),%eax
8010599b:	8a 00                	mov    (%eax),%al
8010599d:	0f b6 d0             	movzbl %al,%edx
801059a0:	8b 45 0c             	mov    0xc(%ebp),%eax
801059a3:	8a 00                	mov    (%eax),%al
801059a5:	0f b6 c0             	movzbl %al,%eax
801059a8:	89 d1                	mov    %edx,%ecx
801059aa:	29 c1                	sub    %eax,%ecx
801059ac:	89 c8                	mov    %ecx,%eax
}
801059ae:	5d                   	pop    %ebp
801059af:	c3                   	ret    
...
801059b3:	83 ec 10             	sub    $0x10,%esp
  char *os;
  
  os = s;
801059b6:	8b 45 08             	mov    0x8(%ebp),%eax
801059b9:	89 45 fc             	mov    %eax,-0x4(%ebp)
  while(n-- > 0 && (*s++ = *t++) != 0)
801059bc:	90                   	nop
801059bd:	83 7d 10 00          	cmpl   $0x0,0x10(%ebp)
801059c1:	0f 9f c0             	setg   %al
801059c4:	ff 4d 10             	decl   0x10(%ebp)
801059c7:	84 c0                	test   %al,%al
801059c9:	74 2b                	je     801059f6 <strncpy+0x46>
801059cb:	8b 45 0c             	mov    0xc(%ebp),%eax
801059ce:	8a 10                	mov    (%eax),%dl
801059d0:	8b 45 08             	mov    0x8(%ebp),%eax
801059d3:	88 10                	mov    %dl,(%eax)
801059d5:	8b 45 08             	mov    0x8(%ebp),%eax
801059d8:	8a 00                	mov    (%eax),%al
801059da:	84 c0                	test   %al,%al
801059dc:	0f 95 c0             	setne  %al
801059df:	ff 45 08             	incl   0x8(%ebp)
801059e2:	ff 45 0c             	incl   0xc(%ebp)
801059e5:	84 c0                	test   %al,%al
801059e7:	75 d4                	jne    801059bd <strncpy+0xd>
    ;
  while(n-- > 0)
801059e9:	eb 0b                	jmp    801059f6 <strncpy+0x46>
    *s++ = 0;
801059eb:	8b 45 08             	mov    0x8(%ebp),%eax
801059ee:	c6 00 00             	movb   $0x0,(%eax)
801059f1:	ff 45 08             	incl   0x8(%ebp)
801059f4:	eb 01                	jmp    801059f7 <strncpy+0x47>
  while(n-- > 0)
801059f6:	90                   	nop
801059f7:	83 7d 10 00          	cmpl   $0x0,0x10(%ebp)
801059fb:	0f 9f c0             	setg   %al
801059fe:	ff 4d 10             	decl   0x10(%ebp)
80105a01:	84 c0                	test   %al,%al
80105a03:	75 e6                	jne    801059eb <strncpy+0x3b>
  return os;
...
80105a0d:	83 ec 10             	sub    $0x10,%esp
  char *os;
  
  os = s;
80105a10:	8b 45 08             	mov    0x8(%ebp),%eax
80105a13:	89 45 fc             	mov    %eax,-0x4(%ebp)
  if(n <= 0)
80105a16:	83 7d 10 00          	cmpl   $0x0,0x10(%ebp)
80105a1a:	7f 05                	jg     80105a21 <safestrcpy+0x17>
    return os;
80105a1c:	8b 45 fc             	mov    -0x4(%ebp),%eax
80105a1f:	eb 30                	jmp    80105a51 <safestrcpy+0x47>
  while(--n > 0 && (*s++ = *t++) != 0)
80105a21:	ff 4d 10             	decl   0x10(%ebp)
80105a24:	83 7d 10 00          	cmpl   $0x0,0x10(%ebp)
80105a28:	7e 1e                	jle    80105a48 <safestrcpy+0x3e>
...
80105a37:	8a 00                	mov    (%eax),%al
80105a39:	84 c0                	test   %al,%al
80105a3b:	0f 95 c0             	setne  %al
80105a3e:	ff 45 08             	incl   0x8(%ebp)
80105a41:	ff 45 0c             	incl   0xc(%ebp)
80105a44:	84 c0                	test   %al,%al
80105a46:	75 d9                	jne    80105a21 <safestrcpy+0x17>
    ;
  *s = 0;
80105a48:	8b 45 08             	mov    0x8(%ebp),%eax
80105a4b:	c6 00 00             	movb   $0x0,(%eax)
  return os;
...
80105a56:	83 ec 10             	sub    $0x10,%esp
  int n;

  for(n = 0; s[n]; n++)
80105a59:	c7 45 fc 00 00 00 00 	movl   $0x0,-0x4(%ebp)
80105a60:	eb 03                	jmp    80105a65 <strlen+0x12>
80105a62:	ff 45 fc             	incl   -0x4(%ebp)
80105a65:	8b 55 fc             	mov    -0x4(%ebp),%edx
80105a68:	8b 45 08             	mov    0x8(%ebp),%eax
80105a6b:	01 d0                	add    %edx,%eax
80105a6d:	8a 00                	mov    (%eax),%al
80105a6f:	84 c0                	test   %al,%al
80105a71:	75 ef                	jne    80105a62 <strlen+0xf>
    ;
  return n;
...
80105a98:	3b 45 08             	cmp    0x8(%ebp),%eax
80105a9b:	76 12                	jbe    80105aaf <fetchint+0x22>
...
80105aad:	76 07                	jbe    80105ab6 <fetchint+0x29>
    return -1;
80105aaf:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80105ab4:	eb 0f                	jmp    80105ac5 <fetchint+0x38>
  *ip = *(int*)(addr);
...
80105ad5:	3b 45 08             	cmp    0x8(%ebp),%eax
80105ad8:	77 07                	ja     80105ae1 <fetchstr+0x1a>
    return -1;
80105ada:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80105adf:	eb 46                	jmp    80105b27 <fetchstr+0x60>
  *pp = (char*)addr;
80105ae1:	8b 55 08             	mov    0x8(%ebp),%edx
80105ae4:	8b 45 0c             	mov    0xc(%ebp),%eax
80105ae7:	89 10                	mov    %edx,(%eax)
  ep = (char*)proc->sz;
80105ae9:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
80105aef:	8b 00                	mov    (%eax),%eax
80105af1:	89 45 f8             	mov    %eax,-0x8(%ebp)
  for(s = *pp; s < ep; s++)
80105af4:	8b 45 0c             	mov    0xc(%ebp),%eax
80105af7:	8b 00                	mov    (%eax),%eax
80105af9:	89 45 fc             	mov    %eax,-0x4(%ebp)
80105afc:	eb 1c                	jmp    80105b1a <fetchstr+0x53>
    if(*s == 0)
80105afe:	8b 45 fc             	mov    -0x4(%ebp),%eax
80105b01:	8a 00                	mov    (%eax),%al
80105b03:	84 c0                	test   %al,%al
80105b05:	75 10                	jne    80105b17 <fetchstr+0x50>
      return s - *pp;
80105b07:	8b 55 fc             	mov    -0x4(%ebp),%edx
80105b0a:	8b 45 0c             	mov    0xc(%ebp),%eax
80105b0d:	8b 00                	mov    (%eax),%eax
80105b0f:	89 d1                	mov    %edx,%ecx
80105b11:	29 c1                	sub    %eax,%ecx
80105b13:	89 c8                	mov    %ecx,%eax
80105b15:	eb 10                	jmp    80105b27 <fetchstr+0x60>
  for(s = *pp; s < ep; s++)
80105b17:	ff 45 fc             	incl   -0x4(%ebp)
80105b1a:	8b 45 fc             	mov    -0x4(%ebp),%eax
80105b1d:	3b 45 f8             	cmp    -0x8(%ebp),%eax
80105b20:	72 dc                	jb     80105afe <fetchstr+0x37>
  return -1;
...
80105b38:	8b 50 44             	mov    0x44(%eax),%edx
80105b3b:	8b 45 08             	mov    0x8(%ebp),%eax
80105b3e:	c1 e0 02             	shl    $0x2,%eax
80105b41:	01 d0                	add    %edx,%eax
80105b43:	8d 50 04             	lea    0x4(%eax),%edx
80105b46:	8b 45 0c             	mov    0xc(%ebp),%eax
80105b49:	89 44 24 04          	mov    %eax,0x4(%esp)
80105b4d:	89 14 24             	mov    %edx,(%esp)
80105b50:	e8 38 ff ff ff       	call   80105a8d <fetchint>
}
80105b55:	c9                   	leave  
80105b56:	c3                   	ret    
...
80105b6a:	e8 ba ff ff ff       	call   80105b29 <argint>
80105b6f:	85 c0                	test   %eax,%eax
80105b71:	79 07                	jns    80105b7a <argptr+0x23>
    return -1;
80105b73:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80105b78:	eb 3d                	jmp    80105bb7 <argptr+0x60>
...
80105b89:	73 16                	jae    80105ba1 <argptr+0x4a>
...
80105b9f:	76 07                	jbe    80105ba8 <argptr+0x51>
    return -1;
80105ba1:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80105ba6:	eb 0f                	jmp    80105bb7 <argptr+0x60>
  *pp = (char*)i;
...
80105bbc:	83 ec 18             	sub    $0x18,%esp
  int addr;
  if(argint(n, &addr) < 0)
80105bbf:	8d 45 fc             	lea    -0x4(%ebp),%eax
80105bc2:	89 44 24 04          	mov    %eax,0x4(%esp)
80105bc6:	8b 45 08             	mov    0x8(%ebp),%eax
80105bc9:	89 04 24             	mov    %eax,(%esp)
80105bcc:	e8 58 ff ff ff       	call   80105b29 <argint>
80105bd1:	85 c0                	test   %eax,%eax
80105bd3:	79 07                	jns    80105bdc <argstr+0x23>
    return -1;
80105bd5:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80105bda:	eb 12                	jmp    80105bee <argstr+0x35>
  return fetchstr(addr, pp);
80105bdc:	8b 45 fc             	mov    -0x4(%ebp),%eax
80105bdf:	8b 55 0c             	mov    0xc(%ebp),%edx
80105be2:	89 54 24 04          	mov    %edx,0x4(%esp)
80105be6:	89 04 24             	mov    %eax,(%esp)
80105be9:	e8 d9 fe ff ff       	call   80105ac7 <fetchstr>
}
80105bee:	c9                   	leave  
80105bef:	c3                   	ret    
...
80105bf4:	83 ec 24             	sub    $0x24,%esp
  int num;

  num = proc->tf->eax;
80105bf7:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
80105bfd:	8b 40 18             	mov    0x18(%eax),%eax
80105c00:	8b 40 1c             	mov    0x1c(%eax),%eax
80105c03:	89 45 f4             	mov    %eax,-0xc(%ebp)
  if(num > 0 && num < NELEM(syscalls) && syscalls[num]) {
80105c06:	83 7d f4 00          	cmpl   $0x0,-0xc(%ebp)
80105c0a:	7e 30                	jle    80105c3c <syscall+0x4c>
80105c0c:	8b 45 f4             	mov    -0xc(%ebp),%eax
80105c0f:	83 f8 20             	cmp    $0x20,%eax
80105c12:	77 28                	ja     80105c3c <syscall+0x4c>
80105c14:	8b 45 f4             	mov    -0xc(%ebp),%eax
80105c17:	8b 04 85 40 c0 10 80 	mov    -0x7fef3fc0(,%eax,4),%eax
80105c1e:	85 c0                	test   %eax,%eax
80105c20:	74 1a                	je     80105c3c <syscall+0x4c>
    proc->tf->eax = syscalls[num]();
80105c22:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
80105c28:	8b 58 18             	mov    0x18(%eax),%ebx
80105c2b:	8b 45 f4             	mov    -0xc(%ebp),%eax
80105c2e:	8b 04 85 40 c0 10 80 	mov    -0x7fef3fc0(,%eax,4),%eax
80105c35:	ff d0                	call   *%eax
80105c37:	89 43 1c             	mov    %eax,0x1c(%ebx)
80105c3a:	eb 3d                	jmp    80105c79 <syscall+0x89>
  } else {
    cprintf("%d %s: unknown sys call %d\n",
            proc->pid, proc->name, num);
80105c3c:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
80105c42:	8d 48 6c             	lea    0x6c(%eax),%ecx
80105c45:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
    cprintf("%d %s: unknown sys call %d\n",
80105c4b:	8b 40 10             	mov    0x10(%eax),%eax
80105c4e:	8b 55 f4             	mov    -0xc(%ebp),%edx
80105c51:	89 54 24 0c          	mov    %edx,0xc(%esp)
80105c55:	89 4c 24 08          	mov    %ecx,0x8(%esp)
80105c59:	89 44 24 04          	mov    %eax,0x4(%esp)
80105c5d:	c7 04 24 4e 92 10 80 	movl   $0x8010924e,(%esp)
80105c64:	e8 38 a7 ff ff       	call   801003a1 <cprintf>
    proc->tf->eax = -1;
...
80105c82:	83 ec 28             	sub    $0x28,%esp
  int fd;
  struct file *f;
...
80105c92:	e8 92 fe ff ff       	call   80105b29 <argint>
80105c97:	85 c0                	test   %eax,%eax
80105c99:	79 07                	jns    80105ca2 <argfd+0x23>
    return -1;
80105c9b:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80105ca0:	eb 50                	jmp    80105cf2 <argfd+0x73>
  if(fd < 0 || fd >= NOFILE || (f=proc->ofile[fd]) == 0)
80105ca2:	8b 45 f0             	mov    -0x10(%ebp),%eax
80105ca5:	85 c0                	test   %eax,%eax
80105ca7:	78 21                	js     80105cca <argfd+0x4b>
80105ca9:	8b 45 f0             	mov    -0x10(%ebp),%eax
80105cac:	83 f8 0f             	cmp    $0xf,%eax
80105caf:	7f 19                	jg     80105cca <argfd+0x4b>
...
80105cc8:	75 07                	jne    80105cd1 <argfd+0x52>
    return -1;
80105cca:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80105ccf:	eb 21                	jmp    80105cf2 <argfd+0x73>
  if(pfd)
80105cd1:	83 7d 0c 00          	cmpl   $0x0,0xc(%ebp)
80105cd5:	74 08                	je     80105cdf <argfd+0x60>
    *pfd = fd;
...
80105ce3:	74 08                	je     80105ced <argfd+0x6e>
    *pf = f;
...
80105cf7:	83 ec 10             	sub    $0x10,%esp
  ...
  for(fd = 0; fd < NOFILE; fd++){
80105cfa:	c7 45 fc 00 00 00 00 	movl   $0x0,-0x4(%ebp)
80105d01:	eb 2f                	jmp    80105d32 <fdalloc+0x3e>
    if(proc->ofile[fd] == 0){
80105d03:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
80105d09:	8b 55 fc             	mov    -0x4(%ebp),%edx
80105d0c:	83 c2 08             	add    $0x8,%edx
80105d0f:	8b 44 90 08          	mov    0x8(%eax,%edx,4),%eax
80105d13:	85 c0                	test   %eax,%eax
80105d15:	75 18                	jne    80105d2f <fdalloc+0x3b>
      proc->ofile[fd] = f;
80105d17:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
80105d1d:	8b 55 fc             	mov    -0x4(%ebp),%edx
80105d20:	8d 4a 08             	lea    0x8(%edx),%ecx
80105d23:	8b 55 08             	mov    0x8(%ebp),%edx
80105d26:	89 54 88 08          	mov    %edx,0x8(%eax,%ecx,4)
      return fd;
80105d2a:	8b 45 fc             	mov    -0x4(%ebp),%eax
80105d2d:	eb 0e                	jmp    80105d3d <fdalloc+0x49>
  for(fd = 0; fd < NOFILE; fd++){
80105d2f:	ff 45 fc             	incl   -0x4(%ebp)
80105d32:	83 7d fc 0f          	cmpl   $0xf,-0x4(%ebp)
80105d36:	7e cb                	jle    80105d03 <fdalloc+0xf>
    }
  }
  return -1;
...
80105d42:	83 ec 28             	sub    $0x28,%esp
  struct file *f;
  int fd;
...
80105da3:	c7 44 24 04 00 00 00 	movl   $0x0,0x4(%esp)
80105daa:	00 
80105dab:	c7 04 24 00 00 00 00 	movl   $0x0,(%esp)
80105db2:	e8 c8 fe ff ff       	call   80105c7f <argfd>
80105db7:	85 c0                	test   %eax,%eax
80105db9:	78 35                	js     80105df0 <sys_read+0x5a>
80105dbb:	8d 45 f0             	lea    -0x10(%ebp),%eax
80105dbe:	89 44 24 04          	mov    %eax,0x4(%esp)
80105dc2:	c7 04 24 02 00 00 00 	movl   $0x2,(%esp)
80105dc9:	e8 5b fd ff ff       	call   80105b29 <argint>
80105dce:	85 c0                	test   %eax,%eax
80105dd0:	78 1e                	js     80105df0 <sys_read+0x5a>
80105dd2:	8b 45 f0             	mov    -0x10(%ebp),%eax
80105dd5:	89 44 24 08          	mov    %eax,0x8(%esp)
80105dd9:	8d 45 ec             	lea    -0x14(%ebp),%eax
80105ddc:	89 44 24 04          	mov    %eax,0x4(%esp)
80105de0:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
80105de7:	e8 6b fd ff ff       	call   80105b57 <argptr>
80105dec:	85 c0                	test   %eax,%eax
80105dee:	79 07                	jns    80105df7 <sys_read+0x61>
    return -1;
80105df0:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80105df5:	eb 19                	jmp    80105e10 <sys_read+0x7a>
  return fileread(f, p, n);
80105df7:	8b 4d f0             	mov    -0x10(%ebp),%ecx
80105dfa:	8b 55 ec             	mov    -0x14(%ebp),%edx
80105dfd:	8b 45 f4             	mov    -0xc(%ebp),%eax
80105e00:	89 4c 24 08          	mov    %ecx,0x8(%esp)
80105e04:	89 54 24 04          	mov    %edx,0x4(%esp)
80105e08:	89 04 24             	mov    %eax,(%esp)
80105e0b:	e8 a4 b2 ff ff       	call   801010b4 <fileread>
}
80105e10:	c9                   	leave  
80105e11:	c3                   	ret    
...
80105e1f:	c7 44 24 04 00 00 00 	movl   $0x0,0x4(%esp)
80105e26:	00 
80105e27:	c7 04 24 00 00 00 00 	movl   $0x0,(%esp)
80105e2e:	e8 4c fe ff ff       	call   80105c7f <argfd>
80105e33:	85 c0                	test   %eax,%eax
80105e35:	78 35                	js     80105e6c <sys_write+0x5a>
80105e37:	8d 45 f0             	lea    -0x10(%ebp),%eax
80105e3a:	89 44 24 04          	mov    %eax,0x4(%esp)
80105e3e:	c7 04 24 02 00 00 00 	movl   $0x2,(%esp)
80105e45:	e8 df fc ff ff       	call   80105b29 <argint>
80105e4a:	85 c0                	test   %eax,%eax
80105e4c:	78 1e                	js     80105e6c <sys_write+0x5a>
...
80105e63:	e8 ef fc ff ff       	call   80105b57 <argptr>
80105e68:	85 c0                	test   %eax,%eax
80105e6a:	79 07                	jns    80105e73 <sys_write+0x61>
    return -1;
80105e6c:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80105e71:	eb 19                	jmp    80105e8c <sys_write+0x7a>
  return filewrite(f, p, n);
80105e73:	8b 4d f0             	mov    -0x10(%ebp),%ecx
80105e76:	8b 55 ec             	mov    -0x14(%ebp),%edx
80105e79:	8b 45 f4             	mov    -0xc(%ebp),%eax
80105e7c:	89 4c 24 08          	mov    %ecx,0x8(%esp)
80105e80:	89 54 24 04          	mov    %edx,0x4(%esp)
80105e84:	89 04 24             	mov    %eax,(%esp)
80105e87:	e8 e3 b2 ff ff       	call   8010116f <filewrite>
}
80105e8c:	c9                   	leave  
80105e8d:	c3                   	ret    
...
80105e91:	83 ec 28             	sub    $0x28,%esp
  int fd;
  struct file *f;
  argfd(0, &fd, &f);
80105e94:	8d 45 f0             	lea    -0x10(%ebp),%eax
80105e97:	89 44 24 08          	mov    %eax,0x8(%esp)
80105e9b:	8d 45 f4             	lea    -0xc(%ebp),%eax
80105e9e:	89 44 24 04          	mov    %eax,0x4(%esp)
80105ea2:	c7 04 24 00 00 00 00 	movl   $0x0,(%esp)
80105ea9:	e8 d1 fd ff ff       	call   80105c7f <argfd>
  if (f->type == FD_INODE) {
80105eae:	8b 45 f0             	mov    -0x10(%ebp),%eax
80105eb1:	8b 00                	mov    (%eax),%eax
80105eb3:	83 f8 02             	cmp    $0x2,%eax
80105eb6:	75 20                	jne    80105ed8 <sys_isatty+0x4a>
...
80105ec0:	74 16                	je     80105ed8 <sys_isatty+0x4a>
...
80105ecf:	75 07                	jne    80105ed8 <sys_isatty+0x4a>
      return 1;
80105ed1:	b8 01 00 00 00       	mov    $0x1,%eax
80105ed6:	eb 05                	jmp    80105edd <sys_isatty+0x4f>
  }
  return 0;
...
80105ee2:	83 ec 48             	sub    $0x48,%esp
	int zerosize, i;
	char *zeroed, *z;
	...
	argfd(0, &fd, &f);
80105ee5:	8d 45 d4             	lea    -0x2c(%ebp),%eax
80105ee8:	89 44 24 08          	mov    %eax,0x8(%esp)
80105eec:	8d 45 e0             	lea    -0x20(%ebp),%eax
80105eef:	89 44 24 04          	mov    %eax,0x4(%esp)
80105ef3:	c7 04 24 00 00 00 00 	movl   $0x0,(%esp)
80105efa:	e8 80 fd ff ff       	call   80105c7f <argfd>
	argint(1, &offset);
80105eff:	8d 45 dc             	lea    -0x24(%ebp),%eax
80105f02:	89 44 24 04          	mov    %eax,0x4(%esp)
80105f06:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
80105f0d:	e8 17 fc ff ff       	call   80105b29 <argint>
	argint(2, &base);
80105f12:	8d 45 d8             	lea    -0x28(%ebp),%eax
80105f15:	89 44 24 04          	mov    %eax,0x4(%esp)
80105f19:	c7 04 24 02 00 00 00 	movl   $0x2,(%esp)
80105f20:	e8 04 fc ff ff       	call   80105b29 <argint>

	if( base == SEEK_SET) {
80105f25:	8b 45 d8             	mov    -0x28(%ebp),%eax
80105f28:	85 c0                	test   %eax,%eax
80105f2a:	75 06                	jne    80105f32 <sys_lseek+0x53>
		newoff = offset;
80105f2c:	8b 45 dc             	mov    -0x24(%ebp),%eax
80105f2f:	89 45 f4             	mov    %eax,-0xc(%ebp)
	}

	if (base == SEEK_CUR)
80105f32:	8b 45 d8             	mov    -0x28(%ebp),%eax
80105f35:	83 f8 01             	cmp    $0x1,%eax
80105f38:	75 0e                	jne    80105f48 <sys_lseek+0x69>
		newoff = f->off + offset;
80105f3a:	8b 45 d4             	mov    -0x2c(%ebp),%eax
80105f3d:	8b 50 14             	mov    0x14(%eax),%edx
80105f40:	8b 45 dc             	mov    -0x24(%ebp),%eax
80105f43:	01 d0                	add    %edx,%eax
80105f45:	89 45 f4             	mov    %eax,-0xc(%ebp)

	if (base == SEEK_END)
80105f48:	8b 45 d8             	mov    -0x28(%ebp),%eax
80105f4b:	83 f8 02             	cmp    $0x2,%eax
80105f4e:	75 11                	jne    80105f61 <sys_lseek+0x82>
		newoff = f->ip->size + offset;
80105f50:	8b 45 d4             	mov    -0x2c(%ebp),%eax
80105f53:	8b 40 10             	mov    0x10(%eax),%eax
80105f56:	8b 50 18             	mov    0x18(%eax),%edx
80105f59:	8b 45 dc             	mov    -0x24(%ebp),%eax
80105f5c:	01 d0                	add    %edx,%eax
80105f5e:	89 45 f4             	mov    %eax,-0xc(%ebp)
	if (newoff < f->ip->size)
80105f61:	8b 55 f4             	mov    -0xc(%ebp),%edx
80105f64:	8b 45 d4             	mov    -0x2c(%ebp),%eax
80105f67:	8b 40 10             	mov    0x10(%eax),%eax
80105f6a:	8b 40 18             	mov    0x18(%eax),%eax
80105f6d:	39 c2                	cmp    %eax,%edx
80105f6f:	73 0a                	jae    80105f7b <sys_lseek+0x9c>
		return -1;
80105f71:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80105f76:	e9 92 00 00 00       	jmp    8010600d <sys_lseek+0x12e>

	if (newoff > f->ip->size){
80105f7b:	8b 55 f4             	mov    -0xc(%ebp),%edx
80105f7e:	8b 45 d4             	mov    -0x2c(%ebp),%eax
80105f81:	8b 40 10             	mov    0x10(%eax),%eax
80105f84:	8b 40 18             	mov    0x18(%eax),%eax
80105f87:	39 c2                	cmp    %eax,%edx
80105f89:	76 74                	jbe    80105fff <sys_lseek+0x120>
		zerosize = newoff - f->ip->size;
80105f8b:	8b 55 f4             	mov    -0xc(%ebp),%edx
80105f8e:	8b 45 d4             	mov    -0x2c(%ebp),%eax
80105f91:	8b 40 10             	mov    0x10(%eax),%eax
80105f94:	8b 40 18             	mov    0x18(%eax),%eax
80105f97:	89 d1                	mov    %edx,%ecx
80105f99:	29 c1                	sub    %eax,%ecx
80105f9b:	89 c8                	mov    %ecx,%eax
80105f9d:	89 45 f0             	mov    %eax,-0x10(%ebp)
		zeroed = kalloc();
80105fa0:	e8 19 cb ff ff       	call   80102abe <kalloc>
80105fa5:	89 45 e4             	mov    %eax,-0x1c(%ebp)
		z = zeroed;
80105fa8:	8b 45 e4             	mov    -0x1c(%ebp),%eax
80105fab:	89 45 e8             	mov    %eax,-0x18(%ebp)
		for (i = 0; i < 4096; i++)
80105fae:	c7 45 ec 00 00 00 00 	movl   $0x0,-0x14(%ebp)
80105fb5:	eb 0c                	jmp    80105fc3 <sys_lseek+0xe4>
			*z++ = 0;
80105fb7:	8b 45 e8             	mov    -0x18(%ebp),%eax
80105fba:	c6 00 00             	movb   $0x0,(%eax)
80105fbd:	ff 45 e8             	incl   -0x18(%ebp)
		for (i = 0; i < 4096; i++)
80105fc0:	ff 45 ec             	incl   -0x14(%ebp)
80105fc3:	81 7d ec ff 0f 00 00 	cmpl   $0xfff,-0x14(%ebp)
80105fca:	7e eb                	jle    80105fb7 <sys_lseek+0xd8>
		while (zerosize > 0){
80105fcc:	eb 20                	jmp    80105fee <sys_lseek+0x10f>
			filewrite(f, zeroed, zerosize);
80105fce:	8b 45 d4             	mov    -0x2c(%ebp),%eax
80105fd1:	8b 55 f0             	mov    -0x10(%ebp),%edx
80105fd4:	89 54 24 08          	mov    %edx,0x8(%esp)
80105fd8:	8b 55 e4             	mov    -0x1c(%ebp),%edx
80105fdb:	89 54 24 04          	mov    %edx,0x4(%esp)
80105fdf:	89 04 24             	mov    %eax,(%esp)
80105fe2:	e8 88 b1 ff ff       	call   8010116f <filewrite>
			zerosize -= 4096;
80105fe7:	81 6d f0 00 10 00 00 	subl   $0x1000,-0x10(%ebp)
		while (zerosize > 0){
80105fee:	83 7d f0 00          	cmpl   $0x0,-0x10(%ebp)
80105ff2:	7f da                	jg     80105fce <sys_lseek+0xef>
		}
		kfree(zeroed);
80105ff4:	8b 45 e4             	mov    -0x1c(%ebp),%eax
80105ff7:	89 04 24             	mov    %eax,(%esp)
80105ffa:	e8 26 ca ff ff       	call   80102a25 <kfree>
	}

	f->off = newoff;
80105fff:	8b 45 d4             	mov    -0x2c(%ebp),%eax
80106002:	8b 55 f4             	mov    -0xc(%ebp),%edx
80106005:	89 50 14             	mov    %edx,0x14(%eax)
	return 0;
...
80106012:	83 ec 28             	sub    $0x28,%esp
  int fd;
  struct file *f;
  
  if(argfd(0, &fd, &f) < 0)
80106015:	8d 45 f0             	lea    -0x10(%ebp),%eax
80106018:	89 44 24 08          	mov    %eax,0x8(%esp)
8010601c:	8d 45 f4             	lea    -0xc(%ebp),%eax
8010601f:	89 44 24 04          	mov    %eax,0x4(%esp)
80106023:	c7 04 24 00 00 00 00 	movl   $0x0,(%esp)
8010602a:	e8 50 fc ff ff       	call   80105c7f <argfd>
8010602f:	85 c0                	test   %eax,%eax
80106031:	79 07                	jns    8010603a <sys_close+0x2b>
    return -1;
80106033:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80106038:	eb 24                	jmp    8010605e <sys_close+0x4f>
  proc->ofile[fd] = 0;
...
80106054:	e8 42 af ff ff       	call   80100f9b <fileclose>
  return 0;
...
8010607c:	e8 fe fb ff ff       	call   80105c7f <argfd>
80106081:	85 c0                	test   %eax,%eax
80106083:	78 1f                	js     801060a4 <sys_fstat+0x44>
80106085:	c7 44 24 08 14 00 00 	movl   $0x14,0x8(%esp)
8010608c:	00 
8010608d:	8d 45 f0             	lea    -0x10(%ebp),%eax
80106090:	89 44 24 04          	mov    %eax,0x4(%esp)
80106094:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
8010609b:	e8 b7 fa ff ff       	call   80105b57 <argptr>
801060a0:	85 c0                	test   %eax,%eax
801060a2:	79 07                	jns    801060ab <sys_fstat+0x4b>
    return -1;
801060a4:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
801060a9:	eb 12                	jmp    801060bd <sys_fstat+0x5d>
  return filestat(f, st);
801060ab:	8b 55 f0             	mov    -0x10(%ebp),%edx
801060ae:	8b 45 f4             	mov    -0xc(%ebp),%eax
801060b1:	89 54 24 04          	mov    %edx,0x4(%esp)
801060b5:	89 04 24             	mov    %eax,(%esp)
801060b8:	e8 a8 af ff ff       	call   80101065 <filestat>
}
801060bd:	c9                   	leave  
801060be:	c3                   	ret    
...
801060c2:	83 ec 38             	sub    $0x38,%esp
  char name[DIRSIZ], *new, *old;
  struct inode *dp, *ip;

  if(argstr(0, &old) < 0 || argstr(1, &new) < 0)
801060c5:	8d 45 d8             	lea    -0x28(%ebp),%eax
801060c8:	89 44 24 04          	mov    %eax,0x4(%esp)
801060cc:	c7 04 24 00 00 00 00 	movl   $0x0,(%esp)
801060d3:	e8 e1 fa ff ff       	call   80105bb9 <argstr>
801060d8:	85 c0                	test   %eax,%eax
801060da:	78 17                	js     801060f3 <sys_link+0x34>
801060dc:	8d 45 dc             	lea    -0x24(%ebp),%eax
801060df:	89 44 24 04          	mov    %eax,0x4(%esp)
801060e3:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
801060ea:	e8 ca fa ff ff       	call   80105bb9 <argstr>
801060ef:	85 c0                	test   %eax,%eax
801060f1:	79 0a                	jns    801060fd <sys_link+0x3e>
    return -1;
801060f3:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
801060f8:	e9 37 01 00 00       	jmp    80106234 <sys_link+0x175>
  if((ip = namei(old)) == 0)
801060fd:	8b 45 d8             	mov    -0x28(%ebp),%eax
80106100:	89 04 24             	mov    %eax,(%esp)
80106103:	e8 d7 c2 ff ff       	call   801023df <namei>
80106108:	89 45 f4             	mov    %eax,-0xc(%ebp)
8010610b:	83 7d f4 00          	cmpl   $0x0,-0xc(%ebp)
8010610f:	75 0a                	jne    8010611b <sys_link+0x5c>
    return -1;
80106111:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80106116:	e9 19 01 00 00       	jmp    80106234 <sys_link+0x175>

  begin_trans();
8010611b:	e8 b0 d0 ff ff       	call   801031d0 <begin_trans>

  ilock(ip);
80106120:	8b 45 f4             	mov    -0xc(%ebp),%eax
80106123:	89 04 24             	mov    %eax,(%esp)
80106126:	e8 1a b7 ff ff       	call   80101845 <ilock>
  if(ip->type == T_DIR){
8010612b:	8b 45 f4             	mov    -0xc(%ebp),%eax
8010612e:	8b 40 10             	mov    0x10(%eax),%eax
80106131:	66 83 f8 01          	cmp    $0x1,%ax
80106135:	75 1a                	jne    80106151 <sys_link+0x92>
    iunlockput(ip);
80106137:	8b 45 f4             	mov    -0xc(%ebp),%eax
8010613a:	89 04 24             	mov    %eax,(%esp)
8010613d:	e8 84 b9 ff ff       	call   80101ac6 <iunlockput>
    commit_trans();
80106142:	e8 d2 d0 ff ff       	call   80103219 <commit_trans>
    return -1;
80106147:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
8010614c:	e9 e3 00 00 00       	jmp    80106234 <sys_link+0x175>
  }

  ip->nlink++;
80106151:	8b 45 f4             	mov    -0xc(%ebp),%eax
80106154:	66 8b 40 16          	mov    0x16(%eax),%ax
80106158:	40                   	inc    %eax
80106159:	8b 55 f4             	mov    -0xc(%ebp),%edx
8010615c:	66 89 42 16          	mov    %ax,0x16(%edx)
  iupdate(ip);
80106160:	8b 45 f4             	mov    -0xc(%ebp),%eax
80106163:	89 04 24             	mov    %eax,(%esp)
80106166:	e8 20 b5 ff ff       	call   8010168b <iupdate>
  iunlock(ip);
8010616b:	8b 45 f4             	mov    -0xc(%ebp),%eax
8010616e:	89 04 24             	mov    %eax,(%esp)
80106171:	e8 1a b8 ff ff       	call   80101990 <iunlock>

  if((dp = nameiparent(new, name)) == 0)
80106176:	8b 45 dc             	mov    -0x24(%ebp),%eax
80106179:	8d 55 e2             	lea    -0x1e(%ebp),%edx
8010617c:	89 54 24 04          	mov    %edx,0x4(%esp)
80106180:	89 04 24             	mov    %eax,(%esp)
80106183:	e8 79 c2 ff ff       	call   80102401 <nameiparent>
80106188:	89 45 f0             	mov    %eax,-0x10(%ebp)
8010618b:	83 7d f0 00          	cmpl   $0x0,-0x10(%ebp)
8010618f:	74 68                	je     801061f9 <sys_link+0x13a>
    goto bad;
  ilock(dp);
80106191:	8b 45 f0             	mov    -0x10(%ebp),%eax
80106194:	89 04 24             	mov    %eax,(%esp)
80106197:	e8 a9 b6 ff ff       	call   80101845 <ilock>
  if(dp->dev != ip->dev || dirlink(dp, name, ip->inum) < 0){
8010619c:	8b 45 f0             	mov    -0x10(%ebp),%eax
8010619f:	8b 10                	mov    (%eax),%edx
801061a1:	8b 45 f4             	mov    -0xc(%ebp),%eax
801061a4:	8b 00                	mov    (%eax),%eax
801061a6:	39 c2                	cmp    %eax,%edx
801061a8:	75 20                	jne    801061ca <sys_link+0x10b>
801061aa:	8b 45 f4             	mov    -0xc(%ebp),%eax
801061ad:	8b 40 04             	mov    0x4(%eax),%eax
801061b0:	89 44 24 08          	mov    %eax,0x8(%esp)
801061b4:	8d 45 e2             	lea    -0x1e(%ebp),%eax
801061b7:	89 44 24 04          	mov    %eax,0x4(%esp)
801061bb:	8b 45 f0             	mov    -0x10(%ebp),%eax
801061be:	89 04 24             	mov    %eax,(%esp)
801061c1:	e8 62 bf ff ff       	call   80102128 <dirlink>
801061c6:	85 c0                	test   %eax,%eax
801061c8:	79 0d                	jns    801061d7 <sys_link+0x118>
    iunlockput(dp);
801061ca:	8b 45 f0             	mov    -0x10(%ebp),%eax
801061cd:	89 04 24             	mov    %eax,(%esp)
801061d0:	e8 f1 b8 ff ff       	call   80101ac6 <iunlockput>
    goto bad;
801061d5:	eb 23                	jmp    801061fa <sys_link+0x13b>
  }
  iunlockput(dp);
801061d7:	8b 45 f0             	mov    -0x10(%ebp),%eax
801061da:	89 04 24             	mov    %eax,(%esp)
801061dd:	e8 e4 b8 ff ff       	call   80101ac6 <iunlockput>
  iput(ip);
801061e2:	8b 45 f4             	mov    -0xc(%ebp),%eax
801061e5:	89 04 24             	mov    %eax,(%esp)
801061e8:	e8 08 b8 ff ff       	call   801019f5 <iput>

  commit_trans();
801061ed:	e8 27 d0 ff ff       	call   80103219 <commit_trans>

  return 0;
801061f2:	b8 00 00 00 00       	mov    $0x0,%eax
801061f7:	eb 3b                	jmp    80106234 <sys_link+0x175>
    goto bad;
801061f9:	90                   	nop
...
80106200:	e8 40 b6 ff ff       	call   80101845 <ilock>
  ip->nlink--;
80106205:	8b 45 f4             	mov    -0xc(%ebp),%eax
80106208:	66 8b 40 16          	mov    0x16(%eax),%ax
8010620c:	48                   	dec    %eax
8010620d:	8b 55 f4             	mov    -0xc(%ebp),%edx
80106210:	66 89 42 16          	mov    %ax,0x16(%edx)
  iupdate(ip);
80106214:	8b 45 f4             	mov    -0xc(%ebp),%eax
80106217:	89 04 24             	mov    %eax,(%esp)
8010621a:	e8 6c b4 ff ff       	call   8010168b <iupdate>
  iunlockput(ip);
8010621f:	8b 45 f4             	mov    -0xc(%ebp),%eax
80106222:	89 04 24             	mov    %eax,(%esp)
80106225:	e8 9c b8 ff ff       	call   80101ac6 <iunlockput>
  commit_trans();
8010622a:	e8 ea cf ff ff       	call   80103219 <commit_trans>
  return -1;
...
80106239:	83 ec 38             	sub    $0x38,%esp
  int off;
  struct dirent de;

  for(off=2*sizeof(de); off<dp->size; off+=sizeof(de)){
8010623c:	c7 45 f4 20 00 00 00 	movl   $0x20,-0xc(%ebp)
80106243:	eb 4a                	jmp    8010628f <isdirempty+0x59>
    if(readi(dp, (char*)&de, off, sizeof(de)) != sizeof(de))
80106245:	8b 45 f4             	mov    -0xc(%ebp),%eax
80106248:	c7 44 24 0c 10 00 00 	movl   $0x10,0xc(%esp)
8010624f:	00 
...
80106261:	e8 e6 ba ff ff       	call   80101d4c <readi>
80106266:	83 f8 10             	cmp    $0x10,%eax
80106269:	74 0c                	je     80106277 <isdirempty+0x41>
      panic("isdirempty: readi");
8010626b:	c7 04 24 6a 92 10 80 	movl   $0x8010926a,(%esp)
80106272:	e8 bf a2 ff ff       	call   80100536 <panic>
    if(de.inum != 0)
80106277:	8b 45 e4             	mov    -0x1c(%ebp),%eax
8010627a:	66 85 c0             	test   %ax,%ax
8010627d:	74 07                	je     80106286 <isdirempty+0x50>
      return 0;
8010627f:	b8 00 00 00 00       	mov    $0x0,%eax
80106284:	eb 1b                	jmp    801062a1 <isdirempty+0x6b>
  for(off=2*sizeof(de); off<dp->size; off+=sizeof(de)){
80106286:	8b 45 f4             	mov    -0xc(%ebp),%eax
80106289:	83 c0 10             	add    $0x10,%eax
8010628c:	89 45 f4             	mov    %eax,-0xc(%ebp)
8010628f:	8b 55 f4             	mov    -0xc(%ebp),%edx
80106292:	8b 45 08             	mov    0x8(%ebp),%eax
80106295:	8b 40 18             	mov    0x18(%eax),%eax
80106298:	39 c2                	cmp    %eax,%edx
8010629a:	72 a9                	jb     80106245 <isdirempty+0xf>
  }
  return 1;
8010629c:	b8 01 00 00 00       	mov    $0x1,%eax
}
801062a1:	c9                   	leave  
801062a2:	c3                   	ret    
...
801062a6:	83 ec 48             	sub    $0x48,%esp
  struct inode *ip, *dp;
  struct dirent de;
  ...
  if(argstr(0, &path) < 0)
801062a9:	8d 45 cc             	lea    -0x34(%ebp),%eax
801062ac:	89 44 24 04          	mov    %eax,0x4(%esp)
801062b0:	c7 04 24 00 00 00 00 	movl   $0x0,(%esp)
801062b7:	e8 fd f8 ff ff       	call   80105bb9 <argstr>
801062bc:	85 c0                	test   %eax,%eax
801062be:	79 0a                	jns    801062ca <sys_unlink+0x27>
    return -1;
801062c0:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
801062c5:	e9 a4 01 00 00       	jmp    8010646e <sys_unlink+0x1cb>
  if((dp = nameiparent(path, name)) == 0)
801062ca:	8b 45 cc             	mov    -0x34(%ebp),%eax
801062cd:	8d 55 d2             	lea    -0x2e(%ebp),%edx
801062d0:	89 54 24 04          	mov    %edx,0x4(%esp)
801062d4:	89 04 24             	mov    %eax,(%esp)
801062d7:	e8 25 c1 ff ff       	call   80102401 <nameiparent>
801062dc:	89 45 f4             	mov    %eax,-0xc(%ebp)
801062df:	83 7d f4 00          	cmpl   $0x0,-0xc(%ebp)
801062e3:	75 0a                	jne    801062ef <sys_unlink+0x4c>
    return -1;
801062e5:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
801062ea:	e9 7f 01 00 00       	jmp    8010646e <sys_unlink+0x1cb>

  begin_trans();
801062ef:	e8 dc ce ff ff       	call   801031d0 <begin_trans>

  ilock(dp);
801062f4:	8b 45 f4             	mov    -0xc(%ebp),%eax
801062f7:	89 04 24             	mov    %eax,(%esp)
801062fa:	e8 46 b5 ff ff       	call   80101845 <ilock>

  // Cannot unlink "." or "..".
  if(namecmp(name, ".") == 0 || namecmp(name, "..") == 0)
801062ff:	c7 44 24 04 7c 92 10 	movl   $0x8010927c,0x4(%esp)
80106306:	80 
80106307:	8d 45 d2             	lea    -0x2e(%ebp),%eax
8010630a:	89 04 24             	mov    %eax,(%esp)
8010630d:	e8 2f bd ff ff       	call   80102041 <namecmp>
80106312:	85 c0                	test   %eax,%eax
80106314:	0f 84 3f 01 00 00    	je     80106459 <sys_unlink+0x1b6>
8010631a:	c7 44 24 04 7e 92 10 	movl   $0x8010927e,0x4(%esp)
80106321:	80 
80106322:	8d 45 d2             	lea    -0x2e(%ebp),%eax
80106325:	89 04 24             	mov    %eax,(%esp)
80106328:	e8 14 bd ff ff       	call   80102041 <namecmp>
8010632d:	85 c0                	test   %eax,%eax
8010632f:	0f 84 24 01 00 00    	je     80106459 <sys_unlink+0x1b6>
    goto bad;

  if((ip = dirlookup(dp, name, &off)) == 0)
80106335:	8d 45 c8             	lea    -0x38(%ebp),%eax
80106338:	89 44 24 08          	mov    %eax,0x8(%esp)
8010633c:	8d 45 d2             	lea    -0x2e(%ebp),%eax
8010633f:	89 44 24 04          	mov    %eax,0x4(%esp)
80106343:	8b 45 f4             	mov    -0xc(%ebp),%eax
80106346:	89 04 24             	mov    %eax,(%esp)
80106349:	e8 15 bd ff ff       	call   80102063 <dirlookup>
8010634e:	89 45 f0             	mov    %eax,-0x10(%ebp)
80106351:	83 7d f0 00          	cmpl   $0x0,-0x10(%ebp)
80106355:	0f 84 fd 00 00 00    	je     80106458 <sys_unlink+0x1b5>
    goto bad;
  ilock(ip);
8010635b:	8b 45 f0             	mov    -0x10(%ebp),%eax
8010635e:	89 04 24             	mov    %eax,(%esp)
80106361:	e8 df b4 ff ff       	call   80101845 <ilock>

  if(ip->nlink < 1)
80106366:	8b 45 f0             	mov    -0x10(%ebp),%eax
80106369:	66 8b 40 16          	mov    0x16(%eax),%ax
8010636d:	66 85 c0             	test   %ax,%ax
80106370:	7f 0c                	jg     8010637e <sys_unlink+0xdb>
    panic("unlink: nlink < 1");
80106372:	c7 04 24 81 92 10 80 	movl   $0x80109281,(%esp)
80106379:	e8 b8 a1 ff ff       	call   80100536 <panic>
  if(ip->type == T_DIR && !isdirempty(ip)){
8010637e:	8b 45 f0             	mov    -0x10(%ebp),%eax
80106381:	8b 40 10             	mov    0x10(%eax),%eax
80106384:	66 83 f8 01          	cmp    $0x1,%ax
80106388:	75 1f                	jne    801063a9 <sys_unlink+0x106>
8010638a:	8b 45 f0             	mov    -0x10(%ebp),%eax
8010638d:	89 04 24             	mov    %eax,(%esp)
80106390:	e8 a1 fe ff ff       	call   80106236 <isdirempty>
80106395:	85 c0                	test   %eax,%eax
80106397:	75 10                	jne    801063a9 <sys_unlink+0x106>
    iunlockput(ip);
80106399:	8b 45 f0             	mov    -0x10(%ebp),%eax
8010639c:	89 04 24             	mov    %eax,(%esp)
8010639f:	e8 22 b7 ff ff       	call   80101ac6 <iunlockput>
    goto bad;
801063a4:	e9 b0 00 00 00       	jmp    80106459 <sys_unlink+0x1b6>
  }

  memset(&de, 0, sizeof(de));
801063a9:	c7 44 24 08 10 00 00 	movl   $0x10,0x8(%esp)
801063b0:	00 
801063b1:	c7 44 24 04 00 00 00 	movl   $0x0,0x4(%esp)
801063b8:	00 
801063b9:	8d 45 e0             	lea    -0x20(%ebp),%eax
801063bc:	89 04 24             	mov    %eax,(%esp)
801063bf:	e8 34 f4 ff ff       	call   801057f8 <memset>
  if(writei(dp, (char*)&de, off, sizeof(de)) != sizeof(de))
801063c4:	8b 45 c8             	mov    -0x38(%ebp),%eax
801063c7:	c7 44 24 0c 10 00 00 	movl   $0x10,0xc(%esp)
801063ce:	00 
801063cf:	89 44 24 08          	mov    %eax,0x8(%esp)
801063d3:	8d 45 e0             	lea    -0x20(%ebp),%eax
801063d6:	89 44 24 04          	mov    %eax,0x4(%esp)
801063da:	8b 45 f4             	mov    -0xc(%ebp),%eax
801063dd:	89 04 24             	mov    %eax,(%esp)
801063e0:	e8 cc ba ff ff       	call   80101eb1 <writei>
801063e5:	83 f8 10             	cmp    $0x10,%eax
801063e8:	74 0c                	je     801063f6 <sys_unlink+0x153>
    panic("unlink: writei");
801063ea:	c7 04 24 93 92 10 80 	movl   $0x80109293,(%esp)
801063f1:	e8 40 a1 ff ff       	call   80100536 <panic>
  if(ip->type == T_DIR){
801063f6:	8b 45 f0             	mov    -0x10(%ebp),%eax
801063f9:	8b 40 10             	mov    0x10(%eax),%eax
801063fc:	66 83 f8 01          	cmp    $0x1,%ax
80106400:	75 1a                	jne    8010641c <sys_unlink+0x179>
    dp->nlink--;
80106402:	8b 45 f4             	mov    -0xc(%ebp),%eax
80106405:	66 8b 40 16          	mov    0x16(%eax),%ax
80106409:	48                   	dec    %eax
8010640a:	8b 55 f4             	mov    -0xc(%ebp),%edx
8010640d:	66 89 42 16          	mov    %ax,0x16(%edx)
    iupdate(dp);
80106411:	8b 45 f4             	mov    -0xc(%ebp),%eax
80106414:	89 04 24             	mov    %eax,(%esp)
80106417:	e8 6f b2 ff ff       	call   8010168b <iupdate>
  }
  iunlockput(dp);
8010641c:	8b 45 f4             	mov    -0xc(%ebp),%eax
8010641f:	89 04 24             	mov    %eax,(%esp)
80106422:	e8 9f b6 ff ff       	call   80101ac6 <iunlockput>

  ip->nlink--;
80106427:	8b 45 f0             	mov    -0x10(%ebp),%eax
8010642a:	66 8b 40 16          	mov    0x16(%eax),%ax
8010642e:	48                   	dec    %eax
8010642f:	8b 55 f0             	mov    -0x10(%ebp),%edx
80106432:	66 89 42 16          	mov    %ax,0x16(%edx)
  iupdate(ip);
80106436:	8b 45 f0             	mov    -0x10(%ebp),%eax
80106439:	89 04 24             	mov    %eax,(%esp)
8010643c:	e8 4a b2 ff ff       	call   8010168b <iupdate>
  iunlockput(ip);
80106441:	8b 45 f0             	mov    -0x10(%ebp),%eax
80106444:	89 04 24             	mov    %eax,(%esp)
80106447:	e8 7a b6 ff ff       	call   80101ac6 <iunlockput>

  commit_trans();
8010644c:	e8 c8 cd ff ff       	call   80103219 <commit_trans>

  return 0;
80106451:	b8 00 00 00 00       	mov    $0x0,%eax
80106456:	eb 16                	jmp    8010646e <sys_unlink+0x1cb>
    goto bad;
80106458:	90                   	nop
...
8010645f:	e8 62 b6 ff ff       	call   80101ac6 <iunlockput>
  commit_trans();
80106464:	e8 b0 cd ff ff       	call   80103219 <commit_trans>
  return -1;
...
80106473:	83 ec 48             	sub    $0x48,%esp
80106476:	8b 4d 0c             	mov    0xc(%ebp),%ecx
80106479:	8b 55 10             	mov    0x10(%ebp),%edx
8010647c:	8b 45 14             	mov    0x14(%ebp),%eax
8010647f:	66 89 4d d4          	mov    %cx,-0x2c(%ebp)
80106483:	66 89 55 d0          	mov    %dx,-0x30(%ebp)
80106487:	66 89 45 cc          	mov    %ax,-0x34(%ebp)
  uint off;
  struct inode *ip, *dp;
  char name[DIRSIZ];

  if((dp = nameiparent(path, name)) == 0)
8010648b:	8d 45 de             	lea    -0x22(%ebp),%eax
8010648e:	89 44 24 04          	mov    %eax,0x4(%esp)
80106492:	8b 45 08             	mov    0x8(%ebp),%eax
80106495:	89 04 24             	mov    %eax,(%esp)
80106498:	e8 64 bf ff ff       	call   80102401 <nameiparent>
8010649d:	89 45 f4             	mov    %eax,-0xc(%ebp)
801064a0:	83 7d f4 00          	cmpl   $0x0,-0xc(%ebp)
801064a4:	75 0a                	jne    801064b0 <create+0x40>
    return 0;
801064a6:	b8 00 00 00 00       	mov    $0x0,%eax
801064ab:	e9 79 01 00 00       	jmp    80106629 <create+0x1b9>
  ilock(dp);
801064b0:	8b 45 f4             	mov    -0xc(%ebp),%eax
801064b3:	89 04 24             	mov    %eax,(%esp)
801064b6:	e8 8a b3 ff ff       	call   80101845 <ilock>

  if((ip = dirlookup(dp, name, &off)) != 0){
801064bb:	8d 45 ec             	lea    -0x14(%ebp),%eax
801064be:	89 44 24 08          	mov    %eax,0x8(%esp)
...
801064cf:	e8 8f bb ff ff       	call   80102063 <dirlookup>
801064d4:	89 45 f0             	mov    %eax,-0x10(%ebp)
801064d7:	83 7d f0 00          	cmpl   $0x0,-0x10(%ebp)
801064db:	74 46                	je     80106523 <create+0xb3>
    iunlockput(dp);
801064dd:	8b 45 f4             	mov    -0xc(%ebp),%eax
801064e0:	89 04 24             	mov    %eax,(%esp)
801064e3:	e8 de b5 ff ff       	call   80101ac6 <iunlockput>
    ilock(ip);
801064e8:	8b 45 f0             	mov    -0x10(%ebp),%eax
801064eb:	89 04 24             	mov    %eax,(%esp)
801064ee:	e8 52 b3 ff ff       	call   80101845 <ilock>
    if(type == T_FILE && ip->type == T_FILE)
801064f3:	66 83 7d d4 02       	cmpw   $0x2,-0x2c(%ebp)
801064f8:	75 14                	jne    8010650e <create+0x9e>
801064fa:	8b 45 f0             	mov    -0x10(%ebp),%eax
801064fd:	8b 40 10             	mov    0x10(%eax),%eax
80106500:	66 83 f8 02          	cmp    $0x2,%ax
80106504:	75 08                	jne    8010650e <create+0x9e>
      return ip;
80106506:	8b 45 f0             	mov    -0x10(%ebp),%eax
80106509:	e9 1b 01 00 00       	jmp    80106629 <create+0x1b9>
    iunlockput(ip);
8010650e:	8b 45 f0             	mov    -0x10(%ebp),%eax
80106511:	89 04 24             	mov    %eax,(%esp)
80106514:	e8 ad b5 ff ff       	call   80101ac6 <iunlockput>
    return 0;
80106519:	b8 00 00 00 00       	mov    $0x0,%eax
8010651e:	e9 06 01 00 00       	jmp    80106629 <create+0x1b9>
  }

  if((ip = ialloc(dp->dev, type)) == 0)
80106523:	0f bf 55 d4          	movswl -0x2c(%ebp),%edx
80106527:	8b 45 f4             	mov    -0xc(%ebp),%eax
8010652a:	8b 00                	mov    (%eax),%eax
8010652c:	89 54 24 04          	mov    %edx,0x4(%esp)
80106530:	89 04 24             	mov    %eax,(%esp)
80106533:	e8 6b b0 ff ff       	call   801015a3 <ialloc>
80106538:	89 45 f0             	mov    %eax,-0x10(%ebp)
8010653b:	83 7d f0 00          	cmpl   $0x0,-0x10(%ebp)
8010653f:	75 0c                	jne    8010654d <create+0xdd>
    panic("create: ialloc");
80106541:	c7 04 24 a2 92 10 80 	movl   $0x801092a2,(%esp)
80106548:	e8 e9 9f ff ff       	call   80100536 <panic>

  ilock(ip);
8010654d:	8b 45 f0             	mov    -0x10(%ebp),%eax
80106550:	89 04 24             	mov    %eax,(%esp)
80106553:	e8 ed b2 ff ff       	call   80101845 <ilock>
  ip->major = major;
80106558:	8b 55 f0             	mov    -0x10(%ebp),%edx
8010655b:	8b 45 d0             	mov    -0x30(%ebp),%eax
8010655e:	66 89 42 12          	mov    %ax,0x12(%edx)
  ip->minor = minor;
80106562:	8b 55 f0             	mov    -0x10(%ebp),%edx
80106565:	8b 45 cc             	mov    -0x34(%ebp),%eax
80106568:	66 89 42 14          	mov    %ax,0x14(%edx)
  ip->nlink = 1;
8010656c:	8b 45 f0             	mov    -0x10(%ebp),%eax
8010656f:	66 c7 40 16 01 00    	movw   $0x1,0x16(%eax)
  iupdate(ip);
80106575:	8b 45 f0             	mov    -0x10(%ebp),%eax
80106578:	89 04 24             	mov    %eax,(%esp)
8010657b:	e8 0b b1 ff ff       	call   8010168b <iupdate>

  if(type == T_DIR){  // Create . and .. entries.
80106580:	66 83 7d d4 01       	cmpw   $0x1,-0x2c(%ebp)
80106585:	75 68                	jne    801065ef <create+0x17f>
    dp->nlink++;  // for ".."
80106587:	8b 45 f4             	mov    -0xc(%ebp),%eax
8010658a:	66 8b 40 16          	mov    0x16(%eax),%ax
8010658e:	40                   	inc    %eax
8010658f:	8b 55 f4             	mov    -0xc(%ebp),%edx
80106592:	66 89 42 16          	mov    %ax,0x16(%edx)
    iupdate(dp);
80106596:	8b 45 f4             	mov    -0xc(%ebp),%eax
80106599:	89 04 24             	mov    %eax,(%esp)
8010659c:	e8 ea b0 ff ff       	call   8010168b <iupdate>
    // No ip->nlink++ for ".": avoid cyclic ref count.
    if(dirlink(ip, ".", ip->inum) < 0 || dirlink(ip, "..", dp->inum) < 0)
801065a1:	8b 45 f0             	mov    -0x10(%ebp),%eax
801065a4:	8b 40 04             	mov    0x4(%eax),%eax
801065a7:	89 44 24 08          	mov    %eax,0x8(%esp)
801065ab:	c7 44 24 04 7c 92 10 	movl   $0x8010927c,0x4(%esp)
801065b2:	80 
801065b3:	8b 45 f0             	mov    -0x10(%ebp),%eax
801065b6:	89 04 24             	mov    %eax,(%esp)
801065b9:	e8 6a bb ff ff       	call   80102128 <dirlink>
801065be:	85 c0                	test   %eax,%eax
801065c0:	78 21                	js     801065e3 <create+0x173>
801065c2:	8b 45 f4             	mov    -0xc(%ebp),%eax
801065c5:	8b 40 04             	mov    0x4(%eax),%eax
801065c8:	89 44 24 08          	mov    %eax,0x8(%esp)
801065cc:	c7 44 24 04 7e 92 10 	movl   $0x8010927e,0x4(%esp)
801065d3:	80 
801065d4:	8b 45 f0             	mov    -0x10(%ebp),%eax
801065d7:	89 04 24             	mov    %eax,(%esp)
801065da:	e8 49 bb ff ff       	call   80102128 <dirlink>
801065df:	85 c0                	test   %eax,%eax
801065e1:	79 0c                	jns    801065ef <create+0x17f>
      panic("create dots");
801065e3:	c7 04 24 b1 92 10 80 	movl   $0x801092b1,(%esp)
801065ea:	e8 47 9f ff ff       	call   80100536 <panic>
  }

  if(dirlink(dp, name, ip->inum) < 0)
801065ef:	8b 45 f0             	mov    -0x10(%ebp),%eax
801065f2:	8b 40 04             	mov    0x4(%eax),%eax
801065f5:	89 44 24 08          	mov    %eax,0x8(%esp)
801065f9:	8d 45 de             	lea    -0x22(%ebp),%eax
801065fc:	89 44 24 04          	mov    %eax,0x4(%esp)
80106600:	8b 45 f4             	mov    -0xc(%ebp),%eax
80106603:	89 04 24             	mov    %eax,(%esp)
80106606:	e8 1d bb ff ff       	call   80102128 <dirlink>
8010660b:	85 c0                	test   %eax,%eax
8010660d:	79 0c                	jns    8010661b <create+0x1ab>
    panic("create: dirlink");
8010660f:	c7 04 24 bd 92 10 80 	movl   $0x801092bd,(%esp)
80106616:	e8 1b 9f ff ff       	call   80100536 <panic>

  iunlockput(dp);
8010661b:	8b 45 f4             	mov    -0xc(%ebp),%eax
8010661e:	89 04 24             	mov    %eax,(%esp)
80106621:	e8 a0 b4 ff ff       	call   80101ac6 <iunlockput>
...
8010662e:	83 ec 38             	sub    $0x38,%esp
  char *path;
  int fd, omode;
  struct file *f;
  struct inode *ip;
...
80106631:	8d 45 e8             	lea    -0x18(%ebp),%eax
80106634:	89 44 24 04          	mov    %eax,0x4(%esp)
80106638:	c7 04 24 00 00 00 00 	movl   $0x0,(%esp)
8010663f:	e8 75 f5 ff ff       	call   80105bb9 <argstr>
80106644:	85 c0                	test   %eax,%eax
80106646:	78 17                	js     8010665f <sys_open+0x34>
80106648:	8d 45 e4             	lea    -0x1c(%ebp),%eax
8010664b:	89 44 24 04          	mov    %eax,0x4(%esp)
8010664f:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
80106656:	e8 ce f4 ff ff       	call   80105b29 <argint>
8010665b:	85 c0                	test   %eax,%eax
8010665d:	79 0a                	jns    80106669 <sys_open+0x3e>
    return -1;
8010665f:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80106664:	e9 47 01 00 00       	jmp    801067b0 <sys_open+0x185>
  if(omode & O_CREATE){
80106669:	8b 45 e4             	mov    -0x1c(%ebp),%eax
8010666c:	25 00 02 00 00       	and    $0x200,%eax
80106671:	85 c0                	test   %eax,%eax
80106673:	74 40                	je     801066b5 <sys_open+0x8a>
    begin_trans();
80106675:	e8 56 cb ff ff       	call   801031d0 <begin_trans>
    ip = create(path, T_FILE, 0, 0);
8010667a:	8b 45 e8             	mov    -0x18(%ebp),%eax
8010667d:	c7 44 24 0c 00 00 00 	movl   $0x0,0xc(%esp)
80106684:	00 
80106685:	c7 44 24 08 00 00 00 	movl   $0x0,0x8(%esp)
8010668c:	00 
8010668d:	c7 44 24 04 02 00 00 	movl   $0x2,0x4(%esp)
80106694:	00 
80106695:	89 04 24             	mov    %eax,(%esp)
80106698:	e8 d3 fd ff ff       	call   80106470 <create>
8010669d:	89 45 f4             	mov    %eax,-0xc(%ebp)
    commit_trans();
801066a0:	e8 74 cb ff ff       	call   80103219 <commit_trans>
    if(ip == 0)
801066a5:	83 7d f4 00          	cmpl   $0x0,-0xc(%ebp)
801066a9:	75 5b                	jne    80106706 <sys_open+0xdb>
      return -1;
801066ab:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
801066b0:	e9 fb 00 00 00       	jmp    801067b0 <sys_open+0x185>
  } else {
    if((ip = namei(path)) == 0)
801066b5:	8b 45 e8             	mov    -0x18(%ebp),%eax
801066b8:	89 04 24             	mov    %eax,(%esp)
801066bb:	e8 1f bd ff ff       	call   801023df <namei>
801066c0:	89 45 f4             	mov    %eax,-0xc(%ebp)
801066c3:	83 7d f4 00          	cmpl   $0x0,-0xc(%ebp)
801066c7:	75 0a                	jne    801066d3 <sys_open+0xa8>
      return -1;
801066c9:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
801066ce:	e9 dd 00 00 00       	jmp    801067b0 <sys_open+0x185>
    ilock(ip);
801066d3:	8b 45 f4             	mov    -0xc(%ebp),%eax
801066d6:	89 04 24             	mov    %eax,(%esp)
801066d9:	e8 67 b1 ff ff       	call   80101845 <ilock>
    if(ip->type == T_DIR && omode != O_RDONLY){
801066de:	8b 45 f4             	mov    -0xc(%ebp),%eax
801066e1:	8b 40 10             	mov    0x10(%eax),%eax
801066e4:	66 83 f8 01          	cmp    $0x1,%ax
801066e8:	75 1c                	jne    80106706 <sys_open+0xdb>
801066ea:	8b 45 e4             	mov    -0x1c(%ebp),%eax
801066ed:	85 c0                	test   %eax,%eax
801066ef:	74 15                	je     80106706 <sys_open+0xdb>
      iunlockput(ip);
801066f1:	8b 45 f4             	mov    -0xc(%ebp),%eax
801066f4:	89 04 24             	mov    %eax,(%esp)
801066f7:	e8 ca b3 ff ff       	call   80101ac6 <iunlockput>
      return -1;
801066fc:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80106701:	e9 aa 00 00 00       	jmp    801067b0 <sys_open+0x185>
    }
  }

  if((f = filealloc()) == 0 || (fd = fdalloc(f)) < 0){
80106706:	e8 e8 a7 ff ff       	call   80100ef3 <filealloc>
8010670b:	89 45 f0             	mov    %eax,-0x10(%ebp)
8010670e:	83 7d f0 00          	cmpl   $0x0,-0x10(%ebp)
80106712:	74 14                	je     80106728 <sys_open+0xfd>
80106714:	8b 45 f0             	mov    -0x10(%ebp),%eax
80106717:	89 04 24             	mov    %eax,(%esp)
8010671a:	e8 d5 f5 ff ff       	call   80105cf4 <fdalloc>
8010671f:	89 45 ec             	mov    %eax,-0x14(%ebp)
80106722:	83 7d ec 00          	cmpl   $0x0,-0x14(%ebp)
80106726:	79 23                	jns    8010674b <sys_open+0x120>
    if(f)
80106728:	83 7d f0 00          	cmpl   $0x0,-0x10(%ebp)
8010672c:	74 0b                	je     80106739 <sys_open+0x10e>
      fileclose(f);
8010672e:	8b 45 f0             	mov    -0x10(%ebp),%eax
80106731:	89 04 24             	mov    %eax,(%esp)
80106734:	e8 62 a8 ff ff       	call   80100f9b <fileclose>
    iunlockput(ip);
80106739:	8b 45 f4             	mov    -0xc(%ebp),%eax
8010673c:	89 04 24             	mov    %eax,(%esp)
8010673f:	e8 82 b3 ff ff       	call   80101ac6 <iunlockput>
    return -1;
80106744:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80106749:	eb 65                	jmp    801067b0 <sys_open+0x185>
  }
  iunlock(ip);
8010674b:	8b 45 f4             	mov    -0xc(%ebp),%eax
8010674e:	89 04 24             	mov    %eax,(%esp)
80106751:	e8 3a b2 ff ff       	call   80101990 <iunlock>

  f->type = FD_INODE;
80106756:	8b 45 f0             	mov    -0x10(%ebp),%eax
80106759:	c7 00 02 00 00 00    	movl   $0x2,(%eax)
  f->ip = ip;
8010675f:	8b 45 f0             	mov    -0x10(%ebp),%eax
80106762:	8b 55 f4             	mov    -0xc(%ebp),%edx
80106765:	89 50 10             	mov    %edx,0x10(%eax)
  f->off = 0;
80106768:	8b 45 f0             	mov    -0x10(%ebp),%eax
8010676b:	c7 40 14 00 00 00 00 	movl   $0x0,0x14(%eax)
  f->readable = !(omode & O_WRONLY);
80106772:	8b 45 e4             	mov    -0x1c(%ebp),%eax
80106775:	83 e0 01             	and    $0x1,%eax
80106778:	85 c0                	test   %eax,%eax
8010677a:	0f 94 c0             	sete   %al
8010677d:	88 c2                	mov    %al,%dl
8010677f:	8b 45 f0             	mov    -0x10(%ebp),%eax
80106782:	88 50 08             	mov    %dl,0x8(%eax)
  f->writable = (omode & O_WRONLY) || (omode & O_RDWR);
80106785:	8b 45 e4             	mov    -0x1c(%ebp),%eax
80106788:	83 e0 01             	and    $0x1,%eax
8010678b:	85 c0                	test   %eax,%eax
8010678d:	75 0a                	jne    80106799 <sys_open+0x16e>
8010678f:	8b 45 e4             	mov    -0x1c(%ebp),%eax
80106792:	83 e0 02             	and    $0x2,%eax
80106795:	85 c0                	test   %eax,%eax
80106797:	74 07                	je     801067a0 <sys_open+0x175>
80106799:	b8 01 00 00 00       	mov    $0x1,%eax
8010679e:	eb 05                	jmp    801067a5 <sys_open+0x17a>
801067a0:	b8 00 00 00 00       	mov    $0x0,%eax
801067a5:	88 c2                	mov    %al,%dl
801067a7:	8b 45 f0             	mov    -0x10(%ebp),%eax
801067aa:	88 50 09             	mov    %dl,0x9(%eax)
  return fd;
...
801067b5:	83 ec 28             	sub    $0x28,%esp
  ...
  begin_trans();
801067b8:	e8 13 ca ff ff       	call   801031d0 <begin_trans>
  if(argstr(0, &path) < 0 || (ip = create(path, T_DIR, 0, 0)) == 0){
801067bd:	8d 45 f0             	lea    -0x10(%ebp),%eax
801067c0:	89 44 24 04          	mov    %eax,0x4(%esp)
801067c4:	c7 04 24 00 00 00 00 	movl   $0x0,(%esp)
801067cb:	e8 e9 f3 ff ff       	call   80105bb9 <argstr>
801067d0:	85 c0                	test   %eax,%eax
801067d2:	78 2c                	js     80106800 <sys_mkdir+0x4e>
801067d4:	8b 45 f0             	mov    -0x10(%ebp),%eax
801067d7:	c7 44 24 0c 00 00 00 	movl   $0x0,0xc(%esp)
801067de:	00 
801067df:	c7 44 24 08 00 00 00 	movl   $0x0,0x8(%esp)
801067e6:	00 
801067e7:	c7 44 24 04 01 00 00 	movl   $0x1,0x4(%esp)
801067ee:	00 
801067ef:	89 04 24             	mov    %eax,(%esp)
801067f2:	e8 79 fc ff ff       	call   80106470 <create>
801067f7:	89 45 f4             	mov    %eax,-0xc(%ebp)
801067fa:	83 7d f4 00          	cmpl   $0x0,-0xc(%ebp)
801067fe:	75 0c                	jne    8010680c <sys_mkdir+0x5a>
    commit_trans();
80106800:	e8 14 ca ff ff       	call   80103219 <commit_trans>
    return -1;
80106805:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
8010680a:	eb 15                	jmp    80106821 <sys_mkdir+0x6f>
  }
  iunlockput(ip);
8010680c:	8b 45 f4             	mov    -0xc(%ebp),%eax
8010680f:	89 04 24             	mov    %eax,(%esp)
80106812:	e8 af b2 ff ff       	call   80101ac6 <iunlockput>
  commit_trans();
80106817:	e8 fd c9 ff ff       	call   80103219 <commit_trans>
  return 0;
...
80106826:	83 ec 38             	sub    $0x38,%esp
  ...
  begin_trans();
80106829:	e8 a2 c9 ff ff       	call   801031d0 <begin_trans>
  if((len=argstr(0, &path)) < 0 ||
8010682e:	8d 45 ec             	lea    -0x14(%ebp),%eax
80106831:	89 44 24 04          	mov    %eax,0x4(%esp)
80106835:	c7 04 24 00 00 00 00 	movl   $0x0,(%esp)
8010683c:	e8 78 f3 ff ff       	call   80105bb9 <argstr>
80106841:	89 45 f4             	mov    %eax,-0xc(%ebp)
80106844:	83 7d f4 00          	cmpl   $0x0,-0xc(%ebp)
80106848:	78 5e                	js     801068a8 <sys_mknod+0x85>
     argint(1, &major) < 0 ||
8010684a:	8d 45 e8             	lea    -0x18(%ebp),%eax
8010684d:	89 44 24 04          	mov    %eax,0x4(%esp)
80106851:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
80106858:	e8 cc f2 ff ff       	call   80105b29 <argint>
  if((len=argstr(0, &path)) < 0 ||
8010685d:	85 c0                	test   %eax,%eax
8010685f:	78 47                	js     801068a8 <sys_mknod+0x85>
     argint(2, &minor) < 0 ||
80106861:	8d 45 e4             	lea    -0x1c(%ebp),%eax
80106864:	89 44 24 04          	mov    %eax,0x4(%esp)
80106868:	c7 04 24 02 00 00 00 	movl   $0x2,(%esp)
8010686f:	e8 b5 f2 ff ff       	call   80105b29 <argint>
     argint(1, &major) < 0 ||
80106874:	85 c0                	test   %eax,%eax
80106876:	78 30                	js     801068a8 <sys_mknod+0x85>
     (ip = create(path, T_DEV, major, minor)) == 0){
80106878:	8b 45 e4             	mov    -0x1c(%ebp),%eax
8010687b:	0f bf c8             	movswl %ax,%ecx
8010687e:	8b 45 e8             	mov    -0x18(%ebp),%eax
80106881:	0f bf d0             	movswl %ax,%edx
80106884:	8b 45 ec             	mov    -0x14(%ebp),%eax
     argint(2, &minor) < 0 ||
80106887:	89 4c 24 0c          	mov    %ecx,0xc(%esp)
8010688b:	89 54 24 08          	mov    %edx,0x8(%esp)
8010688f:	c7 44 24 04 03 00 00 	movl   $0x3,0x4(%esp)
80106896:	00 
80106897:	89 04 24             	mov    %eax,(%esp)
8010689a:	e8 d1 fb ff ff       	call   80106470 <create>
8010689f:	89 45 f0             	mov    %eax,-0x10(%ebp)
801068a2:	83 7d f0 00          	cmpl   $0x0,-0x10(%ebp)
801068a6:	75 0c                	jne    801068b4 <sys_mknod+0x91>
    commit_trans();
801068a8:	e8 6c c9 ff ff       	call   80103219 <commit_trans>
    return -1;
801068ad:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
801068b2:	eb 15                	jmp    801068c9 <sys_mknod+0xa6>
  }
  iunlockput(ip);
801068b4:	8b 45 f0             	mov    -0x10(%ebp),%eax
801068b7:	89 04 24             	mov    %eax,(%esp)
801068ba:	e8 07 b2 ff ff       	call   80101ac6 <iunlockput>
  commit_trans();
801068bf:	e8 55 c9 ff ff       	call   80103219 <commit_trans>
  return 0;
...
801068ce:	83 ec 28             	sub    $0x28,%esp
  char *path;
  struct inode *ip;
...
8010695e:	81 ec a8 00 00 00    	sub    $0xa8,%esp
  char *path, *argv[MAXARG];
  int i;
  uint uargv, uarg;

  if(argstr(0, &path) < 0 || argint(1, (int*)&uargv) < 0){
80106964:	8d 45 f0             	lea    -0x10(%ebp),%eax
80106967:	89 44 24 04          	mov    %eax,0x4(%esp)
8010696b:	c7 04 24 00 00 00 00 	movl   $0x0,(%esp)
80106972:	e8 42 f2 ff ff       	call   80105bb9 <argstr>
80106977:	85 c0                	test   %eax,%eax
80106979:	78 1a                	js     80106995 <sys_exec+0x3a>
8010697b:	8d 85 6c ff ff ff    	lea    -0x94(%ebp),%eax
80106981:	89 44 24 04          	mov    %eax,0x4(%esp)
80106985:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
8010698c:	e8 98 f1 ff ff       	call   80105b29 <argint>
80106991:	85 c0                	test   %eax,%eax
80106993:	79 0a                	jns    8010699f <sys_exec+0x44>
    return -1;
80106995:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
8010699a:	e9 c7 00 00 00       	jmp    80106a66 <sys_exec+0x10b>
  }
  memset(argv, 0, sizeof(argv));
8010699f:	c7 44 24 08 80 00 00 	movl   $0x80,0x8(%esp)
801069a6:	00 
801069a7:	c7 44 24 04 00 00 00 	movl   $0x0,0x4(%esp)
801069ae:	00 
801069af:	8d 85 70 ff ff ff    	lea    -0x90(%ebp),%eax
801069b5:	89 04 24             	mov    %eax,(%esp)
801069b8:	e8 3b ee ff ff       	call   801057f8 <memset>
  for(i=0;; i++){
801069bd:	c7 45 f4 00 00 00 00 	movl   $0x0,-0xc(%ebp)
    if(i >= NELEM(argv))
801069c4:	8b 45 f4             	mov    -0xc(%ebp),%eax
801069c7:	83 f8 1f             	cmp    $0x1f,%eax
801069ca:	76 0a                	jbe    801069d6 <sys_exec+0x7b>
      return -1;
801069cc:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
801069d1:	e9 90 00 00 00       	jmp    80106a66 <sys_exec+0x10b>
    if(fetchint(uargv+4*i, (int*)&uarg) < 0)
801069d6:	8b 45 f4             	mov    -0xc(%ebp),%eax
801069d9:	c1 e0 02             	shl    $0x2,%eax
801069dc:	89 c2                	mov    %eax,%edx
801069de:	8b 85 6c ff ff ff    	mov    -0x94(%ebp),%eax
801069e4:	01 c2                	add    %eax,%edx
801069e6:	8d 85 68 ff ff ff    	lea    -0x98(%ebp),%eax
801069ec:	89 44 24 04          	mov    %eax,0x4(%esp)
801069f0:	89 14 24             	mov    %edx,(%esp)
801069f3:	e8 95 f0 ff ff       	call   80105a8d <fetchint>
801069f8:	85 c0                	test   %eax,%eax
801069fa:	79 07                	jns    80106a03 <sys_exec+0xa8>
      return -1;
801069fc:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80106a01:	eb 63                	jmp    80106a66 <sys_exec+0x10b>
    if(uarg == 0){
80106a03:	8b 85 68 ff ff ff    	mov    -0x98(%ebp),%eax
80106a09:	85 c0                	test   %eax,%eax
80106a0b:	75 26                	jne    80106a33 <sys_exec+0xd8>
      argv[i] = 0;
80106a0d:	8b 45 f4             	mov    -0xc(%ebp),%eax
80106a10:	c7 84 85 70 ff ff ff 	movl   $0x0,-0x90(%ebp,%eax,4)
80106a17:	00 00 00 00 
      break;
80106a1b:	90                   	nop
    }
...
80106a1f:	8d 95 70 ff ff ff    	lea    -0x90(%ebp),%edx
80106a25:	89 54 24 04          	mov    %edx,0x4(%esp)
80106a29:	89 04 24             	mov    %eax,(%esp)
80106a2c:	e8 9a a0 ff ff       	call   80100acb <exec>
80106a31:	eb 33                	jmp    80106a66 <sys_exec+0x10b>
    if(fetchstr(uarg, &argv[i]) < 0)
80106a33:	8d 85 70 ff ff ff    	lea    -0x90(%ebp),%eax
80106a39:	8b 55 f4             	mov    -0xc(%ebp),%edx
80106a3c:	c1 e2 02             	shl    $0x2,%edx
80106a3f:	01 c2                	add    %eax,%edx
80106a41:	8b 85 68 ff ff ff    	mov    -0x98(%ebp),%eax
80106a47:	89 54 24 04          	mov    %edx,0x4(%esp)
80106a4b:	89 04 24             	mov    %eax,(%esp)
80106a4e:	e8 74 f0 ff ff       	call   80105ac7 <fetchstr>
80106a53:	85 c0                	test   %eax,%eax
80106a55:	79 07                	jns    80106a5e <sys_exec+0x103>
      return -1;
80106a57:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80106a5c:	eb 08                	jmp    80106a66 <sys_exec+0x10b>
  for(i=0;; i++){
80106a5e:	ff 45 f4             	incl   -0xc(%ebp)
  }
80106a61:	e9 5e ff ff ff       	jmp    801069c4 <sys_exec+0x69>
}
80106a66:	c9                   	leave  
80106a67:	c3                   	ret    
...
80106a6b:	83 ec 38             	sub    $0x38,%esp
  int *fd;
  struct file *rf, *wf;
  int fd0, fd1;

  if(argptr(0, (void*)&fd, 2*sizeof(fd[0])) < 0)
80106a6e:	c7 44 24 08 08 00 00 	movl   $0x8,0x8(%esp)
80106a75:	00 
80106a76:	8d 45 ec             	lea    -0x14(%ebp),%eax
80106a79:	89 44 24 04          	mov    %eax,0x4(%esp)
80106a7d:	c7 04 24 00 00 00 00 	movl   $0x0,(%esp)
80106a84:	e8 ce f0 ff ff       	call   80105b57 <argptr>
80106a89:	85 c0                	test   %eax,%eax
80106a8b:	79 0a                	jns    80106a97 <sys_pipe+0x2f>
    return -1;
80106a8d:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80106a92:	e9 9b 00 00 00       	jmp    80106b32 <sys_pipe+0xca>
  if(pipealloc(&rf, &wf) < 0)
80106a97:	8d 45 e4             	lea    -0x1c(%ebp),%eax
80106a9a:	89 44 24 04          	mov    %eax,0x4(%esp)
80106a9e:	8d 45 e8             	lea    -0x18(%ebp),%eax
80106aa1:	89 04 24             	mov    %eax,(%esp)
80106aa4:	e8 69 d1 ff ff       	call   80103c12 <pipealloc>
80106aa9:	85 c0                	test   %eax,%eax
80106aab:	79 07                	jns    80106ab4 <sys_pipe+0x4c>
    return -1;
80106aad:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80106ab2:	eb 7e                	jmp    80106b32 <sys_pipe+0xca>
  fd0 = -1;
80106ab4:	c7 45 f4 ff ff ff ff 	movl   $0xffffffff,-0xc(%ebp)
  if((fd0 = fdalloc(rf)) < 0 || (fd1 = fdalloc(wf)) < 0){
80106abb:	8b 45 e8             	mov    -0x18(%ebp),%eax
80106abe:	89 04 24             	mov    %eax,(%esp)
80106ac1:	e8 2e f2 ff ff       	call   80105cf4 <fdalloc>
80106ac6:	89 45 f4             	mov    %eax,-0xc(%ebp)
80106ac9:	83 7d f4 00          	cmpl   $0x0,-0xc(%ebp)
80106acd:	78 14                	js     80106ae3 <sys_pipe+0x7b>
80106acf:	8b 45 e4             	mov    -0x1c(%ebp),%eax
80106ad2:	89 04 24             	mov    %eax,(%esp)
80106ad5:	e8 1a f2 ff ff       	call   80105cf4 <fdalloc>
80106ada:	89 45 f0             	mov    %eax,-0x10(%ebp)
80106add:	83 7d f0 00          	cmpl   $0x0,-0x10(%ebp)
80106ae1:	79 37                	jns    80106b1a <sys_pipe+0xb2>
    if(fd0 >= 0)
80106ae3:	83 7d f4 00          	cmpl   $0x0,-0xc(%ebp)
80106ae7:	78 14                	js     80106afd <sys_pipe+0x95>
      proc->ofile[fd0] = 0;
80106ae9:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
80106aef:	8b 55 f4             	mov    -0xc(%ebp),%edx
80106af2:	83 c2 08             	add    $0x8,%edx
80106af5:	c7 44 90 08 00 00 00 	movl   $0x0,0x8(%eax,%edx,4)
80106afc:	00 
    fileclose(rf);
80106afd:	8b 45 e8             	mov    -0x18(%ebp),%eax
80106b00:	89 04 24             	mov    %eax,(%esp)
80106b03:	e8 93 a4 ff ff       	call   80100f9b <fileclose>
    fileclose(wf);
80106b08:	8b 45 e4             	mov    -0x1c(%ebp),%eax
80106b0b:	89 04 24             	mov    %eax,(%esp)
80106b0e:	e8 88 a4 ff ff       	call   80100f9b <fileclose>
    return -1;
80106b13:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80106b18:	eb 18                	jmp    80106b32 <sys_pipe+0xca>
  }
  fd[0] = fd0;
80106b1a:	8b 45 ec             	mov    -0x14(%ebp),%eax
80106b1d:	8b 55 f4             	mov    -0xc(%ebp),%edx
80106b20:	89 10                	mov    %edx,(%eax)
  fd[1] = fd1;
80106b22:	8b 45 ec             	mov    -0x14(%ebp),%eax
80106b25:	8d 50 04             	lea    0x4(%eax),%edx
80106b28:	8b 45 f0             	mov    -0x10(%ebp),%eax
80106b2b:	89 02                	mov    %eax,(%edx)
  return 0;
80106b2d:	b8 00 00 00 00       	mov    $0x0,%eax
}
80106b32:	c9                   	leave  
80106b33:	c3                   	ret    
...
80106b37:	83 ec 08             	sub    $0x8,%esp
  return fork();
80106b3a:	e8 6f d9 ff ff       	call   801044ae <fork>
}
80106b3f:	c9                   	leave  
80106b40:	c3                   	ret    
...
80106b44:	83 ec 08             	sub    $0x8,%esp
  exit();
80106b47:	e8 e6 da ff ff       	call   80104632 <exit>
...
80106b56:	83 ec 08             	sub    $0x8,%esp
  return wait();
80106b59:	e8 74 dc ff ff       	call   801047d2 <wait>
}
80106b5e:	c9                   	leave  
80106b5f:	c3                   	ret    
...
80106b74:	e8 b0 ef ff ff       	call   80105b29 <argint>
80106b79:	85 c0                	test   %eax,%eax
80106b7b:	79 07                	jns    80106b84 <sys_kill+0x24>
    return -1;
80106b7d:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80106b82:	eb 0b                	jmp    80106b8f <sys_kill+0x2f>
  return kill(pid);
80106b84:	8b 45 f4             	mov    -0xc(%ebp),%eax
80106b87:	89 04 24             	mov    %eax,(%esp)
80106b8a:	e8 82 e0 ff ff       	call   80104c11 <kill>
}
80106b8f:	c9                   	leave  
80106b90:	c3                   	ret    
...
80106bb3:	e8 71 ef ff ff       	call   80105b29 <argint>
80106bb8:	85 c0                	test   %eax,%eax
80106bba:	79 07                	jns    80106bc3 <sys_sbrk+0x24>
    return -1;
80106bbc:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80106bc1:	eb 24                	jmp    80106be7 <sys_sbrk+0x48>
  addr = proc->sz;
80106bc3:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
80106bc9:	8b 00                	mov    (%eax),%eax
80106bcb:	89 45 f4             	mov    %eax,-0xc(%ebp)
  if(growproc(n) < 0)
80106bce:	8b 45 f0             	mov    -0x10(%ebp),%eax
80106bd1:	89 04 24             	mov    %eax,(%esp)
80106bd4:	e8 30 d8 ff ff       	call   80104409 <growproc>
80106bd9:	85 c0                	test   %eax,%eax
80106bdb:	79 07                	jns    80106be4 <sys_sbrk+0x45>
    return -1;
80106bdd:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80106be2:	eb 03                	jmp    80106be7 <sys_sbrk+0x48>
  return addr;
...
80106bec:	83 ec 28             	sub    $0x28,%esp
  ...
  if(argint(0, &n) < 0)
80106bef:	8d 45 f0             	lea    -0x10(%ebp),%eax
80106bf2:	89 44 24 04          	mov    %eax,0x4(%esp)
80106bf6:	c7 04 24 00 00 00 00 	movl   $0x0,(%esp)
80106bfd:	e8 27 ef ff ff       	call   80105b29 <argint>
80106c02:	85 c0                	test   %eax,%eax
80106c04:	79 07                	jns    80106c0d <sys_sleep+0x24>
    return -1;
80106c06:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80106c0b:	eb 6c                	jmp    80106c79 <sys_sleep+0x90>
  acquire(&tickslock);
80106c0d:	c7 04 24 20 3c 11 80 	movl   $0x80113c20,(%esp)
80106c14:	e8 8d e9 ff ff       	call   801055a6 <acquire>
  ticks0 = ticks;
80106c19:	a1 60 44 11 80       	mov    0x80114460,%eax
80106c1e:	89 45 f4             	mov    %eax,-0xc(%ebp)
  while(ticks - ticks0 < n){
80106c21:	eb 34                	jmp    80106c57 <sys_sleep+0x6e>
    if(proc->killed){
80106c23:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
80106c29:	8b 40 24             	mov    0x24(%eax),%eax
80106c2c:	85 c0                	test   %eax,%eax
80106c2e:	74 13                	je     80106c43 <sys_sleep+0x5a>
      release(&tickslock);
80106c30:	c7 04 24 20 3c 11 80 	movl   $0x80113c20,(%esp)
80106c37:	e8 cc e9 ff ff       	call   80105608 <release>
      return -1;
80106c3c:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80106c41:	eb 36                	jmp    80106c79 <sys_sleep+0x90>
    }
    sleep(&ticks, &tickslock);
80106c43:	c7 44 24 04 20 3c 11 	movl   $0x80113c20,0x4(%esp)
80106c4a:	80 
80106c4b:	c7 04 24 60 44 11 80 	movl   $0x80114460,(%esp)
80106c52:	e8 87 de ff ff       	call   80104ade <sleep>
  while(ticks - ticks0 < n){
80106c57:	a1 60 44 11 80       	mov    0x80114460,%eax
80106c5c:	89 c2                	mov    %eax,%edx
80106c5e:	2b 55 f4             	sub    -0xc(%ebp),%edx
80106c61:	8b 45 f0             	mov    -0x10(%ebp),%eax
80106c64:	39 c2                	cmp    %eax,%edx
80106c66:	72 bb                	jb     80106c23 <sys_sleep+0x3a>
  }
  release(&tickslock);
80106c68:	c7 04 24 20 3c 11 80 	movl   $0x80113c20,(%esp)
80106c6f:	e8 94 e9 ff ff       	call   80105608 <release>
  return 0;
...
80106c7e:	83 ec 28             	sub    $0x28,%esp
  ...
  acquire(&tickslock);
80106c81:	c7 04 24 20 3c 11 80 	movl   $0x80113c20,(%esp)
80106c88:	e8 19 e9 ff ff       	call   801055a6 <acquire>
  xticks = ticks;
80106c8d:	a1 60 44 11 80       	mov    0x80114460,%eax
80106c92:	89 45 f4             	mov    %eax,-0xc(%ebp)
  release(&tickslock);
80106c95:	c7 04 24 20 3c 11 80 	movl   $0x80113c20,(%esp)
80106c9c:	e8 67 e9 ff ff       	call   80105608 <release>
  return xticks;
...
80106ca9:	83 ec 08             	sub    $0x8,%esp
  procdump(); // Print a process listing to console.
80106cac:	e8 e4 df ff ff       	call   80104c95 <procdump>
  return 0; 
80106cb1:	b8 00 00 00 00       	mov    $0x0,%eax
}
80106cb6:	c9                   	leave  
80106cb7:	c3                   	ret    

80106cb8 <sys_set_priority>:
...
80106ccc:	e8 58 ee ff ff       	call   80105b29 <argint>
  proc->priority=pr;
80106cd1:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
80106cd7:	8b 55 f4             	mov    -0xc(%ebp),%edx
80106cda:	89 90 80 00 00 00    	mov    %edx,0x80(%eax)
  return 0;
...
80106cf4:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
80106cfb:	e8 29 ee ff ff       	call   80105b29 <argint>
80106d00:	85 c0                	test   %eax,%eax
80106d02:	78 17                	js     80106d1b <sys_semget+0x34>
80106d04:	8d 45 f4             	lea    -0xc(%ebp),%eax
80106d07:	89 44 24 04          	mov    %eax,0x4(%esp)
80106d0b:	c7 04 24 00 00 00 00 	movl   $0x0,(%esp)
80106d12:	e8 12 ee ff ff       	call   80105b29 <argint>
80106d17:	85 c0                	test   %eax,%eax
80106d19:	79 07                	jns    80106d22 <sys_semget+0x3b>
    return -1;
80106d1b:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80106d20:	eb 12                	jmp    80106d34 <sys_semget+0x4d>
...
80106d2f:	e8 b2 e0 ff ff       	call   80104de6 <semget>
}
80106d34:	c9                   	leave  
80106d35:	c3                   	ret    

80106d36 <sys_semfree>:
...
80106d43:	c7 04 24 00 00 00 00 	movl   $0x0,(%esp)
80106d4a:	e8 da ed ff ff       	call   80105b29 <argint>
80106d4f:	85 c0                	test   %eax,%eax
80106d51:	79 07                	jns    80106d5a <sys_semfree+0x24>
    return -1;
80106d53:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80106d58:	eb 0b                	jmp    80106d65 <sys_semfree+0x2f>
  return semfree(semid);
80106d5a:	8b 45 f4             	mov    -0xc(%ebp),%eax
80106d5d:	89 04 24             	mov    %eax,(%esp)
80106d60:	e8 de e1 ff ff       	call   80104f43 <semfree>
}
80106d65:	c9                   	leave  
80106d66:	c3                   	ret    

80106d67 <sys_semdown>:
...
80106d6a:	83 ec 28             	sub    $0x28,%esp
  int semid;
  if(argint(0, &semid) < 0)
80106d6d:	8d 45 f4             	lea    -0xc(%ebp),%eax
80106d70:	89 44 24 04          	mov    %eax,0x4(%esp)
80106d74:	c7 04 24 00 00 00 00 	movl   $0x0,(%esp)
80106d7b:	e8 a9 ed ff ff       	call   80105b29 <argint>
80106d80:	85 c0                	test   %eax,%eax
80106d82:	79 07                	jns    80106d8b <sys_semdown+0x24>
    return -1;
80106d84:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80106d89:	eb 0b                	jmp    80106d96 <sys_semdown+0x2f>
  return semdown(semid);
80106d8b:	8b 45 f4             	mov    -0xc(%ebp),%eax
80106d8e:	89 04 24             	mov    %eax,(%esp)
80106d91:	e8 44 e2 ff ff       	call   80104fda <semdown>
}
80106d96:	c9                   	leave  
80106d97:	c3                   	ret    
...
80106dd2:	8b 55 0c             	mov    0xc(%ebp),%edx
80106dd5:	66 89 45 fc          	mov    %ax,-0x4(%ebp)
80106dd9:	88 55 f8             	mov    %dl,-0x8(%ebp)
  asm volatile("out %0,%1" : : "a" (data), "d" (port));
80106ddc:	8a 45 f8             	mov    -0x8(%ebp),%al
80106ddf:	8b 55 fc             	mov    -0x4(%ebp),%edx
...
80106de8:	83 ec 18             	sub    $0x18,%esp
  // Interrupt 100 times/sec.
  outb(TIMER_MODE, TIMER_SEL0 | TIMER_RATEGEN | TIMER_16BIT);
80106deb:	c7 44 24 04 34 00 00 	movl   $0x34,0x4(%esp)
80106df2:	00 
80106df3:	c7 04 24 43 00 00 00 	movl   $0x43,(%esp)
80106dfa:	e8 ca ff ff ff       	call   80106dc9 <outb>
  outb(IO_TIMER1, TIMER_DIV(100) % 256);
80106dff:	c7 44 24 04 9c 00 00 	movl   $0x9c,0x4(%esp)
80106e06:	00 
80106e07:	c7 04 24 40 00 00 00 	movl   $0x40,(%esp)
80106e0e:	e8 b6 ff ff ff       	call   80106dc9 <outb>
  outb(IO_TIMER1, TIMER_DIV(100) / 256);
80106e13:	c7 44 24 04 2e 00 00 	movl   $0x2e,0x4(%esp)
80106e1a:	00 
80106e1b:	c7 04 24 40 00 00 00 	movl   $0x40,(%esp)
80106e22:	e8 a2 ff ff ff       	call   80106dc9 <outb>
  picenable(IRQ_TIMER);
80106e27:	c7 04 24 00 00 00 00 	movl   $0x0,(%esp)
80106e2e:	e8 6e cc ff ff       	call   80103aa1 <picenable>
}
80106e33:	c9                   	leave  
80106e34:	c3                   	ret    
...
80106e35:	1e                   	push   %ds
80106e36:	06                   	push   %es
80106e37:	0f a0                	push   %fs
80106e39:	0f a8                	push   %gs
80106e3b:	60                   	pusha  
80106e3c:	66 b8 10 00          	mov    $0x10,%ax
80106e40:	8e d8                	mov    %eax,%ds
80106e42:	8e c0                	mov    %eax,%es
80106e44:	66 b8 18 00          	mov    $0x18,%ax
80106e48:	8e e0                	mov    %eax,%fs
80106e4a:	8e e8                	mov    %eax,%gs
80106e4c:	54                   	push   %esp
80106e4d:	e8 c4 01 00 00       	call   80107016 <trap>
80106e52:	83 c4 04             	add    $0x4,%esp

80106e55 <trapret>:
80106e55:	61                   	popa   
80106e56:	0f a9                	pop    %gs
80106e58:	0f a1                	pop    %fs
80106e5a:	07                   	pop    %es
80106e5b:	1f                   	pop    %ds
...
80106e69:	48                   	dec    %eax
80106e6a:	66 89 45 fa          	mov    %ax,-0x6(%ebp)
  pd[1] = (uint)p;
80106e6e:	8b 45 08             	mov    0x8(%ebp),%eax
80106e71:	66 89 45 fc          	mov    %ax,-0x4(%ebp)
  pd[2] = (uint)p >> 16;
...
80106e8b:	83 ec 10             	sub    $0x10,%esp
  uint val;
  asm volatile("movl %%cr2,%0" : "=r" (val));
80106e8e:	0f 20 d3             	mov    %cr2,%ebx
80106e91:	89 5d f8             	mov    %ebx,-0x8(%ebp)
  return val;
80106e94:	8b 45 f8             	mov    -0x8(%ebp),%eax
}
...
80106ea0:	83 ec 28             	sub    $0x28,%esp
  int i;

  for(i = 0; i < 256; i++)
80106ea3:	c7 45 f4 00 00 00 00 	movl   $0x0,-0xc(%ebp)
80106eaa:	e9 b8 00 00 00       	jmp    80106f67 <tvinit+0xca>
    SETGATE(idt[i], 0, SEG_KCODE<<3, vectors[i], 0);
80106eaf:	8b 45 f4             	mov    -0xc(%ebp),%eax
80106eb2:	8b 04 85 c4 c0 10 80 	mov    -0x7fef3f3c(,%eax,4),%eax
80106eb9:	8b 55 f4             	mov    -0xc(%ebp),%edx
80106ebc:	66 89 04 d5 60 3c 11 	mov    %ax,-0x7feec3a0(,%edx,8)
80106ec3:	80 
80106ec4:	8b 45 f4             	mov    -0xc(%ebp),%eax
80106ec7:	66 c7 04 c5 62 3c 11 	movw   $0x8,-0x7feec39e(,%eax,8)
80106ece:	80 08 00 
80106ed1:	8b 45 f4             	mov    -0xc(%ebp),%eax
80106ed4:	8a 14 c5 64 3c 11 80 	mov    -0x7feec39c(,%eax,8),%dl
80106edb:	83 e2 e0             	and    $0xffffffe0,%edx
80106ede:	88 14 c5 64 3c 11 80 	mov    %dl,-0x7feec39c(,%eax,8)
80106ee5:	8b 45 f4             	mov    -0xc(%ebp),%eax
80106ee8:	8a 14 c5 64 3c 11 80 	mov    -0x7feec39c(,%eax,8),%dl
80106eef:	83 e2 1f             	and    $0x1f,%edx
80106ef2:	88 14 c5 64 3c 11 80 	mov    %dl,-0x7feec39c(,%eax,8)
80106ef9:	8b 45 f4             	mov    -0xc(%ebp),%eax
80106efc:	8a 14 c5 65 3c 11 80 	mov    -0x7feec39b(,%eax,8),%dl
80106f03:	83 e2 f0             	and    $0xfffffff0,%edx
80106f06:	83 ca 0e             	or     $0xe,%edx
80106f09:	88 14 c5 65 3c 11 80 	mov    %dl,-0x7feec39b(,%eax,8)
80106f10:	8b 45 f4             	mov    -0xc(%ebp),%eax
80106f13:	8a 14 c5 65 3c 11 80 	mov    -0x7feec39b(,%eax,8),%dl
80106f1a:	83 e2 ef             	and    $0xffffffef,%edx
80106f1d:	88 14 c5 65 3c 11 80 	mov    %dl,-0x7feec39b(,%eax,8)
80106f24:	8b 45 f4             	mov    -0xc(%ebp),%eax
80106f27:	8a 14 c5 65 3c 11 80 	mov    -0x7feec39b(,%eax,8),%dl
80106f2e:	83 e2 9f             	and    $0xffffff9f,%edx
80106f31:	88 14 c5 65 3c 11 80 	mov    %dl,-0x7feec39b(,%eax,8)
80106f38:	8b 45 f4             	mov    -0xc(%ebp),%eax
80106f3b:	8a 14 c5 65 3c 11 80 	mov    -0x7feec39b(,%eax,8),%dl
80106f42:	83 ca 80             	or     $0xffffff80,%edx
80106f45:	88 14 c5 65 3c 11 80 	mov    %dl,-0x7feec39b(,%eax,8)
80106f4c:	8b 45 f4             	mov    -0xc(%ebp),%eax
80106f4f:	8b 04 85 c4 c0 10 80 	mov    -0x7fef3f3c(,%eax,4),%eax
80106f56:	c1 e8 10             	shr    $0x10,%eax
80106f59:	8b 55 f4             	mov    -0xc(%ebp),%edx
80106f5c:	66 89 04 d5 66 3c 11 	mov    %ax,-0x7feec39a(,%edx,8)
80106f63:	80 
  for(i = 0; i < 256; i++)
80106f64:	ff 45 f4             	incl   -0xc(%ebp)
80106f67:	81 7d f4 ff 00 00 00 	cmpl   $0xff,-0xc(%ebp)
80106f6e:	0f 8e 3b ff ff ff    	jle    80106eaf <tvinit+0x12>
  SETGATE(idt[T_SYSCALL], 1, SEG_KCODE<<3, vectors[T_SYSCALL], DPL_USER);
80106f74:	a1 c4 c1 10 80       	mov    0x8010c1c4,%eax
80106f79:	66 a3 60 3e 11 80    	mov    %ax,0x80113e60
80106f7f:	66 c7 05 62 3e 11 80 	movw   $0x8,0x80113e62
80106f86:	08 00 
80106f88:	a0 64 3e 11 80       	mov    0x80113e64,%al
80106f8d:	83 e0 e0             	and    $0xffffffe0,%eax
80106f90:	a2 64 3e 11 80       	mov    %al,0x80113e64
80106f95:	a0 64 3e 11 80       	mov    0x80113e64,%al
80106f9a:	83 e0 1f             	and    $0x1f,%eax
80106f9d:	a2 64 3e 11 80       	mov    %al,0x80113e64
80106fa2:	a0 65 3e 11 80       	mov    0x80113e65,%al
80106fa7:	83 c8 0f             	or     $0xf,%eax
80106faa:	a2 65 3e 11 80       	mov    %al,0x80113e65
80106faf:	a0 65 3e 11 80       	mov    0x80113e65,%al
80106fb4:	83 e0 ef             	and    $0xffffffef,%eax
80106fb7:	a2 65 3e 11 80       	mov    %al,0x80113e65
80106fbc:	a0 65 3e 11 80       	mov    0x80113e65,%al
80106fc1:	83 c8 60             	or     $0x60,%eax
80106fc4:	a2 65 3e 11 80       	mov    %al,0x80113e65
80106fc9:	a0 65 3e 11 80       	mov    0x80113e65,%al
80106fce:	83 c8 80             	or     $0xffffff80,%eax
80106fd1:	a2 65 3e 11 80       	mov    %al,0x80113e65
80106fd6:	a1 c4 c1 10 80       	mov    0x8010c1c4,%eax
80106fdb:	c1 e8 10             	shr    $0x10,%eax
80106fde:	66 a3 66 3e 11 80    	mov    %ax,0x80113e66
  
  initlock(&tickslock, "time");
80106fe4:	c7 44 24 04 d0 92 10 	movl   $0x801092d0,0x4(%esp)
80106feb:	80 
80106fec:	c7 04 24 20 3c 11 80 	movl   $0x80113c20,(%esp)
80106ff3:	e8 8d e5 ff ff       	call   80105585 <initlock>
}
80106ff8:	c9                   	leave  
80106ff9:	c3                   	ret    
...
80106ffd:	83 ec 08             	sub    $0x8,%esp
  lidt(idt, sizeof(idt));
80107000:	c7 44 24 04 00 08 00 	movl   $0x800,0x4(%esp)
80107007:	00 
80107008:	c7 04 24 60 3c 11 80 	movl   $0x80113c60,(%esp)
8010700f:	e8 4c fe ff ff       	call   80106e60 <lidt>
}
80107014:	c9                   	leave  
80107015:	c3                   	ret    
...
80107019:	57                   	push   %edi
8010701a:	56                   	push   %esi
8010701b:	53                   	push   %ebx
8010701c:	83 ec 3c             	sub    $0x3c,%esp
  if(tf->trapno == T_SYSCALL){
8010701f:	8b 45 08             	mov    0x8(%ebp),%eax
80107022:	8b 40 30             	mov    0x30(%eax),%eax
80107025:	83 f8 40             	cmp    $0x40,%eax
80107028:	75 3e                	jne    80107068 <trap+0x52>
    if(proc->killed)
8010702a:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
80107030:	8b 40 24             	mov    0x24(%eax),%eax
80107033:	85 c0                	test   %eax,%eax
80107035:	74 05                	je     8010703c <trap+0x26>
      exit();
80107037:	e8 f6 d5 ff ff       	call   80104632 <exit>
    proc->tf = tf;
8010703c:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
80107042:	8b 55 08             	mov    0x8(%ebp),%edx
80107045:	89 50 18             	mov    %edx,0x18(%eax)
    syscall();
80107048:	e8 a3 eb ff ff       	call   80105bf0 <syscall>
    if(proc->killed)
8010704d:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
80107053:	8b 40 24             	mov    0x24(%eax),%eax
80107056:	85 c0                	test   %eax,%eax
80107058:	0f 84 3f 02 00 00    	je     8010729d <trap+0x287>
      exit();
8010705e:	e8 cf d5 ff ff       	call   80104632 <exit>
    return;
80107063:	e9 35 02 00 00       	jmp    8010729d <trap+0x287>
  }

  switch(tf->trapno){
80107068:	8b 45 08             	mov    0x8(%ebp),%eax
8010706b:	8b 40 30             	mov    0x30(%eax),%eax
8010706e:	83 e8 20             	sub    $0x20,%eax
80107071:	83 f8 1f             	cmp    $0x1f,%eax
80107074:	0f 87 b7 00 00 00    	ja     80107131 <trap+0x11b>
8010707a:	8b 04 85 78 93 10 80 	mov    -0x7fef6c88(,%eax,4),%eax
80107081:	ff e0                	jmp    *%eax
  case T_IRQ0 + IRQ_TIMER:
    if(cpu->id == 0){
80107083:	65 a1 00 00 00 00    	mov    %gs:0x0,%eax
80107089:	8a 00                	mov    (%eax),%al
8010708b:	84 c0                	test   %al,%al
8010708d:	75 2f                	jne    801070be <trap+0xa8>
      acquire(&tickslock);
8010708f:	c7 04 24 20 3c 11 80 	movl   $0x80113c20,(%esp)
80107096:	e8 0b e5 ff ff       	call   801055a6 <acquire>
      ticks++;
8010709b:	a1 60 44 11 80       	mov    0x80114460,%eax
801070a0:	40                   	inc    %eax
801070a1:	a3 60 44 11 80       	mov    %eax,0x80114460
      wakeup(&ticks);
801070a6:	c7 04 24 60 44 11 80 	movl   $0x80114460,(%esp)
801070ad:	e8 34 db ff ff       	call   80104be6 <wakeup>
      release(&tickslock);
801070b2:	c7 04 24 20 3c 11 80 	movl   $0x80113c20,(%esp)
801070b9:	e8 4a e5 ff ff       	call   80105608 <release>
    }
    lapiceoi();
801070be:	e8 dc bd ff ff       	call   80102e9f <lapiceoi>
    break;
801070c3:	e9 3c 01 00 00       	jmp    80107204 <trap+0x1ee>
  case T_IRQ0 + IRQ_IDE:
    ideintr();
801070c8:	e8 f0 b5 ff ff       	call   801026bd <ideintr>
    lapiceoi();
801070cd:	e8 cd bd ff ff       	call   80102e9f <lapiceoi>
    break;
801070d2:	e9 2d 01 00 00       	jmp    80107204 <trap+0x1ee>
  case T_IRQ0 + IRQ_IDE+1:
    // Bochs generates spurious IDE1 interrupts.
    break;
  case T_IRQ0 + IRQ_KBD:
    kbdintr();
801070d7:	e8 a6 bb ff ff       	call   80102c82 <kbdintr>
    lapiceoi();
801070dc:	e8 be bd ff ff       	call   80102e9f <lapiceoi>
    break;
801070e1:	e9 1e 01 00 00       	jmp    80107204 <trap+0x1ee>
  case T_IRQ0 + IRQ_COM1:
    uartintr();
801070e6:	e8 af 03 00 00       	call   8010749a <uartintr>
    lapiceoi();
801070eb:	e8 af bd ff ff       	call   80102e9f <lapiceoi>
    break;
801070f0:	e9 0f 01 00 00       	jmp    80107204 <trap+0x1ee>
  case T_IRQ0 + 7:
...
801070f5:	8b 45 08             	mov    0x8(%ebp),%eax
    cprintf("cpu%d: spurious interrupt at %x:%x\n",
801070f8:	8b 48 38             	mov    0x38(%eax),%ecx
            cpu->id, tf->cs, tf->eip);
801070fb:	8b 45 08             	mov    0x8(%ebp),%eax
801070fe:	8b 40 3c             	mov    0x3c(%eax),%eax
    cprintf("cpu%d: spurious interrupt at %x:%x\n",
80107101:	0f b7 d0             	movzwl %ax,%edx
            cpu->id, tf->cs, tf->eip);
80107104:	65 a1 00 00 00 00    	mov    %gs:0x0,%eax
8010710a:	8a 00                	mov    (%eax),%al
    cprintf("cpu%d: spurious interrupt at %x:%x\n",
...
8010711b:	c7 04 24 d8 92 10 80 	movl   $0x801092d8,(%esp)
80107122:	e8 7a 92 ff ff       	call   801003a1 <cprintf>
    lapiceoi();
80107127:	e8 73 bd ff ff       	call   80102e9f <lapiceoi>
    break;
8010712c:	e9 d3 00 00 00       	jmp    80107204 <trap+0x1ee>
...
80107139:	74 10                	je     8010714b <trap+0x135>
8010713b:	8b 45 08             	mov    0x8(%ebp),%eax
8010713e:	8b 40 3c             	mov    0x3c(%eax),%eax
80107141:	0f b7 c0             	movzwl %ax,%eax
80107144:	83 e0 03             	and    $0x3,%eax
80107147:	85 c0                	test   %eax,%eax
80107149:	75 45                	jne    80107190 <trap+0x17a>
      // In kernel, it must be our mistake.
      cprintf("unexpected trap %d from cpu %d eip %x (cr2=0x%x)\n",
8010714b:	e8 37 fd ff ff       	call   80106e87 <rcr2>
              tf->trapno, cpu->id, tf->eip, rcr2());
80107150:	8b 55 08             	mov    0x8(%ebp),%edx
      cprintf("unexpected trap %d from cpu %d eip %x (cr2=0x%x)\n",
80107153:	8b 5a 38             	mov    0x38(%edx),%ebx
              tf->trapno, cpu->id, tf->eip, rcr2());
80107156:	65 8b 15 00 00 00 00 	mov    %gs:0x0,%edx
8010715d:	8a 12                	mov    (%edx),%dl
      cprintf("unexpected trap %d from cpu %d eip %x (cr2=0x%x)\n",
8010715f:	0f b6 ca             	movzbl %dl,%ecx
              tf->trapno, cpu->id, tf->eip, rcr2());
80107162:	8b 55 08             	mov    0x8(%ebp),%edx
      cprintf("unexpected trap %d from cpu %d eip %x (cr2=0x%x)\n",
80107165:	8b 52 30             	mov    0x30(%edx),%edx
80107168:	89 44 24 10          	mov    %eax,0x10(%esp)
8010716c:	89 5c 24 0c          	mov    %ebx,0xc(%esp)
80107170:	89 4c 24 08          	mov    %ecx,0x8(%esp)
80107174:	89 54 24 04          	mov    %edx,0x4(%esp)
80107178:	c7 04 24 fc 92 10 80 	movl   $0x801092fc,(%esp)
8010717f:	e8 1d 92 ff ff       	call   801003a1 <cprintf>
      panic("trap");
80107184:	c7 04 24 2e 93 10 80 	movl   $0x8010932e,(%esp)
8010718b:	e8 a6 93 ff ff       	call   80100536 <panic>
    }
    // In user space, assume process misbehaved.
    cprintf("pid %d %s: trap %d err %d on cpu %d "
80107190:	e8 f2 fc ff ff       	call   80106e87 <rcr2>
80107195:	89 c2                	mov    %eax,%edx
            "eip 0x%x addr 0x%x--kill proc\n",
            proc->pid, proc->name, tf->trapno, tf->err, cpu->id, tf->eip, 
80107197:	8b 45 08             	mov    0x8(%ebp),%eax
    cprintf("pid %d %s: trap %d err %d on cpu %d "
8010719a:	8b 78 38             	mov    0x38(%eax),%edi
            proc->pid, proc->name, tf->trapno, tf->err, cpu->id, tf->eip, 
8010719d:	65 a1 00 00 00 00    	mov    %gs:0x0,%eax
801071a3:	8a 00                	mov    (%eax),%al
    cprintf("pid %d %s: trap %d err %d on cpu %d "
801071a5:	0f b6 f0             	movzbl %al,%esi
            proc->pid, proc->name, tf->trapno, tf->err, cpu->id, tf->eip, 
801071a8:	8b 45 08             	mov    0x8(%ebp),%eax
    cprintf("pid %d %s: trap %d err %d on cpu %d "
801071ab:	8b 58 34             	mov    0x34(%eax),%ebx
            proc->pid, proc->name, tf->trapno, tf->err, cpu->id, tf->eip, 
801071ae:	8b 45 08             	mov    0x8(%ebp),%eax
    cprintf("pid %d %s: trap %d err %d on cpu %d "
801071b1:	8b 48 30             	mov    0x30(%eax),%ecx
            proc->pid, proc->name, tf->trapno, tf->err, cpu->id, tf->eip, 
801071b4:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
801071ba:	83 c0 6c             	add    $0x6c,%eax
801071bd:	89 45 e4             	mov    %eax,-0x1c(%ebp)
801071c0:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
    cprintf("pid %d %s: trap %d err %d on cpu %d "
801071c6:	8b 40 10             	mov    0x10(%eax),%eax
801071c9:	89 54 24 1c          	mov    %edx,0x1c(%esp)
801071cd:	89 7c 24 18          	mov    %edi,0x18(%esp)
801071d1:	89 74 24 14          	mov    %esi,0x14(%esp)
801071d5:	89 5c 24 10          	mov    %ebx,0x10(%esp)
801071d9:	89 4c 24 0c          	mov    %ecx,0xc(%esp)
801071dd:	8b 55 e4             	mov    -0x1c(%ebp),%edx
801071e0:	89 54 24 08          	mov    %edx,0x8(%esp)
801071e4:	89 44 24 04          	mov    %eax,0x4(%esp)
801071e8:	c7 04 24 34 93 10 80 	movl   $0x80109334,(%esp)
801071ef:	e8 ad 91 ff ff       	call   801003a1 <cprintf>
            rcr2());
    proc->killed = 1;
801071f4:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
801071fa:	c7 40 24 01 00 00 00 	movl   $0x1,0x24(%eax)
80107201:	eb 01                	jmp    80107204 <trap+0x1ee>
    break;
80107203:	90                   	nop
  }
...
8010720c:	74 23                	je     80107231 <trap+0x21b>
8010720e:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
80107214:	8b 40 24             	mov    0x24(%eax),%eax
80107217:	85 c0                	test   %eax,%eax
80107219:	74 16                	je     80107231 <trap+0x21b>
8010721b:	8b 45 08             	mov    0x8(%ebp),%eax
8010721e:	8b 40 3c             	mov    0x3c(%eax),%eax
80107221:	0f b7 c0             	movzwl %ax,%eax
80107224:	83 e0 03             	and    $0x3,%eax
80107227:	83 f8 03             	cmp    $0x3,%eax
8010722a:	75 05                	jne    80107231 <trap+0x21b>
    exit();
8010722c:	e8 01 d4 ff ff       	call   80104632 <exit>
...
80107239:	74 33                	je     8010726e <trap+0x258>
8010723b:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
80107241:	8b 40 0c             	mov    0xc(%eax),%eax
80107244:	83 f8 04             	cmp    $0x4,%eax
80107247:	75 25                	jne    8010726e <trap+0x258>
80107249:	8b 45 08             	mov    0x8(%ebp),%eax
8010724c:	8b 40 30             	mov    0x30(%eax),%eax
8010724f:	83 f8 20             	cmp    $0x20,%eax
80107252:	75 1a                	jne    8010726e <trap+0x258>
80107254:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
8010725a:	8b 50 7c             	mov    0x7c(%eax),%edx
8010725d:	42                   	inc    %edx
8010725e:	89 50 7c             	mov    %edx,0x7c(%eax)
80107261:	8b 40 7c             	mov    0x7c(%eax),%eax
80107264:	83 f8 06             	cmp    $0x6,%eax
80107267:	75 05                	jne    8010726e <trap+0x258>
      ...
      yield();
80107269:	e8 e5 d7 ff ff       	call   80104a53 <yield>
  }
...
80107276:	74 26                	je     8010729e <trap+0x288>
80107278:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
8010727e:	8b 40 24             	mov    0x24(%eax),%eax
80107281:	85 c0                	test   %eax,%eax
80107283:	74 19                	je     8010729e <trap+0x288>
80107285:	8b 45 08             	mov    0x8(%ebp),%eax
80107288:	8b 40 3c             	mov    0x3c(%eax),%eax
8010728b:	0f b7 c0             	movzwl %ax,%eax
8010728e:	83 e0 03             	and    $0x3,%eax
80107291:	83 f8 03             	cmp    $0x3,%eax
80107294:	75 08                	jne    8010729e <trap+0x288>
    exit();
80107296:	e8 97 d3 ff ff       	call   80104632 <exit>
8010729b:	eb 01                	jmp    8010729e <trap+0x288>
    return;
8010729d:	90                   	nop
}
8010729e:	83 c4 3c             	add    $0x3c,%esp
801072a1:	5b                   	pop    %ebx
801072a2:	5e                   	pop    %esi
801072a3:	5f                   	pop    %edi
801072a4:	5d                   	pop    %ebp
...
801072aa:	83 ec 14             	sub    $0x14,%esp
801072ad:	8b 45 08             	mov    0x8(%ebp),%eax
801072b0:	66 89 45 e8          	mov    %ax,-0x18(%ebp)
  asm volatile("in %1,%0" : "=a" (data) : "d" (port));
801072b4:	8b 55 e8             	mov    -0x18(%ebp),%edx
801072b7:	66 89 55 ea          	mov    %dx,-0x16(%ebp)
801072bb:	66 8b 55 ea          	mov    -0x16(%ebp),%dx
801072bf:	ec                   	in     (%dx),%al
801072c0:	88 c3                	mov    %al,%bl
801072c2:	88 5d fb             	mov    %bl,-0x5(%ebp)
  return data;
801072c5:	8a 45 fb             	mov    -0x5(%ebp),%al
}
801072c8:	83 c4 14             	add    $0x14,%esp
801072cb:	5b                   	pop    %ebx
801072cc:	5d                   	pop    %ebp
801072cd:	c3                   	ret    
...
801072d7:	8b 55 0c             	mov    0xc(%ebp),%edx
801072da:	66 89 45 fc          	mov    %ax,-0x4(%ebp)
801072de:	88 55 f8             	mov    %dl,-0x8(%ebp)
  asm volatile("out %0,%1" : : "a" (data), "d" (port));
801072e1:	8a 45 f8             	mov    -0x8(%ebp),%al
801072e4:	8b 55 fc             	mov    -0x4(%ebp),%edx
801072e7:	ee                   	out    %al,(%dx)
}
801072e8:	c9                   	leave  
801072e9:	c3                   	ret    
...
801072ed:	83 ec 28             	sub    $0x28,%esp
  ...
  // Turn off the FIFO
  outb(COM1+2, 0);
801072f0:	c7 44 24 04 00 00 00 	movl   $0x0,0x4(%esp)
801072f7:	00 
801072f8:	c7 04 24 fa 03 00 00 	movl   $0x3fa,(%esp)
801072ff:	e8 ca ff ff ff       	call   801072ce <outb>
  
  // 9600 baud, 8 data bits, 1 stop bit, parity off.
  outb(COM1+3, 0x80);    // Unlock divisor
80107304:	c7 44 24 04 80 00 00 	movl   $0x80,0x4(%esp)
8010730b:	00 
8010730c:	c7 04 24 fb 03 00 00 	movl   $0x3fb,(%esp)
80107313:	e8 b6 ff ff ff       	call   801072ce <outb>
  outb(COM1+0, 115200/9600);
80107318:	c7 44 24 04 0c 00 00 	movl   $0xc,0x4(%esp)
8010731f:	00 
80107320:	c7 04 24 f8 03 00 00 	movl   $0x3f8,(%esp)
80107327:	e8 a2 ff ff ff       	call   801072ce <outb>
  outb(COM1+1, 0);
8010732c:	c7 44 24 04 00 00 00 	movl   $0x0,0x4(%esp)
80107333:	00 
80107334:	c7 04 24 f9 03 00 00 	movl   $0x3f9,(%esp)
8010733b:	e8 8e ff ff ff       	call   801072ce <outb>
  outb(COM1+3, 0x03);    // Lock divisor, 8 data bits.
80107340:	c7 44 24 04 03 00 00 	movl   $0x3,0x4(%esp)
80107347:	00 
80107348:	c7 04 24 fb 03 00 00 	movl   $0x3fb,(%esp)
8010734f:	e8 7a ff ff ff       	call   801072ce <outb>
  outb(COM1+4, 0);
80107354:	c7 44 24 04 00 00 00 	movl   $0x0,0x4(%esp)
8010735b:	00 
8010735c:	c7 04 24 fc 03 00 00 	movl   $0x3fc,(%esp)
80107363:	e8 66 ff ff ff       	call   801072ce <outb>
  outb(COM1+1, 0x01);    // Enable receive interrupts.
80107368:	c7 44 24 04 01 00 00 	movl   $0x1,0x4(%esp)
8010736f:	00 
80107370:	c7 04 24 f9 03 00 00 	movl   $0x3f9,(%esp)
80107377:	e8 52 ff ff ff       	call   801072ce <outb>

  // If status is 0xFF, no serial port.
  if(inb(COM1+5) == 0xFF)
8010737c:	c7 04 24 fd 03 00 00 	movl   $0x3fd,(%esp)
80107383:	e8 1e ff ff ff       	call   801072a6 <inb>
80107388:	3c ff                	cmp    $0xff,%al
8010738a:	74 69                	je     801073f5 <uartinit+0x10b>
    return;
  uart = 1;
8010738c:	c7 05 8c c6 10 80 01 	movl   $0x1,0x8010c68c
80107393:	00 00 00 

  // Acknowledge pre-existing interrupt conditions;
  // enable interrupts.
  inb(COM1+2);
80107396:	c7 04 24 fa 03 00 00 	movl   $0x3fa,(%esp)
8010739d:	e8 04 ff ff ff       	call   801072a6 <inb>
  inb(COM1+0);
801073a2:	c7 04 24 f8 03 00 00 	movl   $0x3f8,(%esp)
801073a9:	e8 f8 fe ff ff       	call   801072a6 <inb>
  picenable(IRQ_COM1);
801073ae:	c7 04 24 04 00 00 00 	movl   $0x4,(%esp)
801073b5:	e8 e7 c6 ff ff       	call   80103aa1 <picenable>
  ioapicenable(IRQ_COM1, 0);
801073ba:	c7 44 24 04 00 00 00 	movl   $0x0,0x4(%esp)
801073c1:	00 
801073c2:	c7 04 24 04 00 00 00 	movl   $0x4,(%esp)
801073c9:	e8 6c b5 ff ff       	call   8010293a <ioapicenable>
  
  // Announce that we're here.
  for(p="xv6...\n"; *p; p++)
801073ce:	c7 45 f4 f8 93 10 80 	movl   $0x801093f8,-0xc(%ebp)
801073d5:	eb 13                	jmp    801073ea <uartinit+0x100>
    uartputc(*p);
801073d7:	8b 45 f4             	mov    -0xc(%ebp),%eax
801073da:	8a 00                	mov    (%eax),%al
801073dc:	0f be c0             	movsbl %al,%eax
801073df:	89 04 24             	mov    %eax,(%esp)
801073e2:	e8 11 00 00 00       	call   801073f8 <uartputc>
  for(p="xv6...\n"; *p; p++)
801073e7:	ff 45 f4             	incl   -0xc(%ebp)
801073ea:	8b 45 f4             	mov    -0xc(%ebp),%eax
801073ed:	8a 00                	mov    (%eax),%al
801073ef:	84 c0                	test   %al,%al
801073f1:	75 e4                	jne    801073d7 <uartinit+0xed>
801073f3:	eb 01                	jmp    801073f6 <uartinit+0x10c>
    return;
801073f5:	90                   	nop
}
801073f6:	c9                   	leave  
...
801073fb:	83 ec 28             	sub    $0x28,%esp
  int i;

  if(!uart)
801073fe:	a1 8c c6 10 80       	mov    0x8010c68c,%eax
80107403:	85 c0                	test   %eax,%eax
80107405:	74 4c                	je     80107453 <uartputc+0x5b>
    return;
  for(i = 0; i < 128 && !(inb(COM1+5) & 0x20); i++)
80107407:	c7 45 f4 00 00 00 00 	movl   $0x0,-0xc(%ebp)
8010740e:	eb 0f                	jmp    8010741f <uartputc+0x27>
    microdelay(10);
80107410:	c7 04 24 0a 00 00 00 	movl   $0xa,(%esp)
80107417:	e8 a8 ba ff ff       	call   80102ec4 <microdelay>
  for(i = 0; i < 128 && !(inb(COM1+5) & 0x20); i++)
8010741c:	ff 45 f4             	incl   -0xc(%ebp)
8010741f:	83 7d f4 7f          	cmpl   $0x7f,-0xc(%ebp)
80107423:	7f 16                	jg     8010743b <uartputc+0x43>
80107425:	c7 04 24 fd 03 00 00 	movl   $0x3fd,(%esp)
8010742c:	e8 75 fe ff ff       	call   801072a6 <inb>
80107431:	0f b6 c0             	movzbl %al,%eax
80107434:	83 e0 20             	and    $0x20,%eax
80107437:	85 c0                	test   %eax,%eax
80107439:	74 d5                	je     80107410 <uartputc+0x18>
  outb(COM1+0, c);
8010743b:	8b 45 08             	mov    0x8(%ebp),%eax
8010743e:	0f b6 c0             	movzbl %al,%eax
80107441:	89 44 24 04          	mov    %eax,0x4(%esp)
80107445:	c7 04 24 f8 03 00 00 	movl   $0x3f8,(%esp)
8010744c:	e8 7d fe ff ff       	call   801072ce <outb>
80107451:	eb 01                	jmp    80107454 <uartputc+0x5c>
    return;
80107453:	90                   	nop
}
80107454:	c9                   	leave  
...
80107459:	83 ec 04             	sub    $0x4,%esp
  if(!uart)
8010745c:	a1 8c c6 10 80       	mov    0x8010c68c,%eax
80107461:	85 c0                	test   %eax,%eax
80107463:	75 07                	jne    8010746c <uartgetc+0x16>
    return -1;
80107465:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
8010746a:	eb 2c                	jmp    80107498 <uartgetc+0x42>
  if(!(inb(COM1+5) & 0x01))
8010746c:	c7 04 24 fd 03 00 00 	movl   $0x3fd,(%esp)
80107473:	e8 2e fe ff ff       	call   801072a6 <inb>
80107478:	0f b6 c0             	movzbl %al,%eax
8010747b:	83 e0 01             	and    $0x1,%eax
8010747e:	85 c0                	test   %eax,%eax
80107480:	75 07                	jne    80107489 <uartgetc+0x33>
    return -1;
80107482:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80107487:	eb 0f                	jmp    80107498 <uartgetc+0x42>
  return inb(COM1+0);
80107489:	c7 04 24 f8 03 00 00 	movl   $0x3f8,(%esp)
80107490:	e8 11 fe ff ff       	call   801072a6 <inb>
...
801074a0:	c7 04 24 56 74 10 80 	movl   $0x80107456,(%esp)
801074a7:	e8 e4 92 ff ff       	call   80100790 <consoleintr>
}
801074ac:	c9                   	leave  
801074ad:	c3                   	ret    
...
801074b2:	e9 7e f9 ff ff       	jmp    80106e35 <alltraps>

801074b7 <vector1>:
801074b7:	6a 00                	push   $0x0
801074b9:	6a 01                	push   $0x1
801074bb:	e9 75 f9 ff ff       	jmp    80106e35 <alltraps>

801074c0 <vector2>:
801074c0:	6a 00                	push   $0x0
801074c2:	6a 02                	push   $0x2
801074c4:	e9 6c f9 ff ff       	jmp    80106e35 <alltraps>

801074c9 <vector3>:
801074c9:	6a 00                	push   $0x0
801074cb:	6a 03                	push   $0x3
801074cd:	e9 63 f9 ff ff       	jmp    80106e35 <alltraps>

801074d2 <vector4>:
801074d2:	6a 00                	push   $0x0
801074d4:	6a 04                	push   $0x4
801074d6:	e9 5a f9 ff ff       	jmp    80106e35 <alltraps>

801074db <vector5>:
801074db:	6a 00                	push   $0x0
801074dd:	6a 05                	push   $0x5
801074df:	e9 51 f9 ff ff       	jmp    80106e35 <alltraps>

801074e4 <vector6>:
801074e4:	6a 00                	push   $0x0
801074e6:	6a 06                	push   $0x6
801074e8:	e9 48 f9 ff ff       	jmp    80106e35 <alltraps>

801074ed <vector7>:
801074ed:	6a 00                	push   $0x0
801074ef:	6a 07                	push   $0x7
801074f1:	e9 3f f9 ff ff       	jmp    80106e35 <alltraps>

801074f6 <vector8>:
801074f6:	6a 08                	push   $0x8
801074f8:	e9 38 f9 ff ff       	jmp    80106e35 <alltraps>

801074fd <vector9>:
801074fd:	6a 00                	push   $0x0
801074ff:	6a 09                	push   $0x9
80107501:	e9 2f f9 ff ff       	jmp    80106e35 <alltraps>

80107506 <vector10>:
80107506:	6a 0a                	push   $0xa
80107508:	e9 28 f9 ff ff       	jmp    80106e35 <alltraps>

8010750d <vector11>:
8010750d:	6a 0b                	push   $0xb
8010750f:	e9 21 f9 ff ff       	jmp    80106e35 <alltraps>

80107514 <vector12>:
80107514:	6a 0c                	push   $0xc
80107516:	e9 1a f9 ff ff       	jmp    80106e35 <alltraps>

8010751b <vector13>:
8010751b:	6a 0d                	push   $0xd
8010751d:	e9 13 f9 ff ff       	jmp    80106e35 <alltraps>

80107522 <vector14>:
80107522:	6a 0e                	push   $0xe
80107524:	e9 0c f9 ff ff       	jmp    80106e35 <alltraps>

80107529 <vector15>:
80107529:	6a 00                	push   $0x0
8010752b:	6a 0f                	push   $0xf
8010752d:	e9 03 f9 ff ff       	jmp    80106e35 <alltraps>

80107532 <vector16>:
80107532:	6a 00                	push   $0x0
80107534:	6a 10                	push   $0x10
80107536:	e9 fa f8 ff ff       	jmp    80106e35 <alltraps>

8010753b <vector17>:
8010753b:	6a 11                	push   $0x11
8010753d:	e9 f3 f8 ff ff       	jmp    80106e35 <alltraps>

80107542 <vector18>:
80107542:	6a 00                	push   $0x0
80107544:	6a 12                	push   $0x12
80107546:	e9 ea f8 ff ff       	jmp    80106e35 <alltraps>

8010754b <vector19>:
8010754b:	6a 00                	push   $0x0
8010754d:	6a 13                	push   $0x13
8010754f:	e9 e1 f8 ff ff       	jmp    80106e35 <alltraps>

80107554 <vector20>:
80107554:	6a 00                	push   $0x0
80107556:	6a 14                	push   $0x14
80107558:	e9 d8 f8 ff ff       	jmp    80106e35 <alltraps>

8010755d <vector21>:
8010755d:	6a 00                	push   $0x0
8010755f:	6a 15                	push   $0x15
80107561:	e9 cf f8 ff ff       	jmp    80106e35 <alltraps>

80107566 <vector22>:
80107566:	6a 00                	push   $0x0
80107568:	6a 16                	push   $0x16
8010756a:	e9 c6 f8 ff ff       	jmp    80106e35 <alltraps>

8010756f <vector23>:
8010756f:	6a 00                	push   $0x0
80107571:	6a 17                	push   $0x17
80107573:	e9 bd f8 ff ff       	jmp    80106e35 <alltraps>

80107578 <vector24>:
80107578:	6a 00                	push   $0x0
8010757a:	6a 18                	push   $0x18
8010757c:	e9 b4 f8 ff ff       	jmp    80106e35 <alltraps>

80107581 <vector25>:
80107581:	6a 00                	push   $0x0
80107583:	6a 19                	push   $0x19
80107585:	e9 ab f8 ff ff       	jmp    80106e35 <alltraps>

8010758a <vector26>:
8010758a:	6a 00                	push   $0x0
8010758c:	6a 1a                	push   $0x1a
8010758e:	e9 a2 f8 ff ff       	jmp    80106e35 <alltraps>

80107593 <vector27>:
80107593:	6a 00                	push   $0x0
80107595:	6a 1b                	push   $0x1b
80107597:	e9 99 f8 ff ff       	jmp    80106e35 <alltraps>

8010759c <vector28>:
8010759c:	6a 00                	push   $0x0
8010759e:	6a 1c                	push   $0x1c
801075a0:	e9 90 f8 ff ff       	jmp    80106e35 <alltraps>

801075a5 <vector29>:
801075a5:	6a 00                	push   $0x0
801075a7:	6a 1d                	push   $0x1d
801075a9:	e9 87 f8 ff ff       	jmp    80106e35 <alltraps>

801075ae <vector30>:
801075ae:	6a 00                	push   $0x0
801075b0:	6a 1e                	push   $0x1e
801075b2:	e9 7e f8 ff ff       	jmp    80106e35 <alltraps>

801075b7 <vector31>:
801075b7:	6a 00                	push   $0x0
801075b9:	6a 1f                	push   $0x1f
801075bb:	e9 75 f8 ff ff       	jmp    80106e35 <alltraps>

801075c0 <vector32>:
801075c0:	6a 00                	push   $0x0
801075c2:	6a 20                	push   $0x20
801075c4:	e9 6c f8 ff ff       	jmp    80106e35 <alltraps>

801075c9 <vector33>:
801075c9:	6a 00                	push   $0x0
801075cb:	6a 21                	push   $0x21
801075cd:	e9 63 f8 ff ff       	jmp    80106e35 <alltraps>

801075d2 <vector34>:
801075d2:	6a 00                	push   $0x0
801075d4:	6a 22                	push   $0x22
801075d6:	e9 5a f8 ff ff       	jmp    80106e35 <alltraps>

801075db <vector35>:
801075db:	6a 00                	push   $0x0
801075dd:	6a 23                	push   $0x23
801075df:	e9 51 f8 ff ff       	jmp    80106e35 <alltraps>

801075e4 <vector36>:
801075e4:	6a 00                	push   $0x0
801075e6:	6a 24                	push   $0x24
801075e8:	e9 48 f8 ff ff       	jmp    80106e35 <alltraps>

801075ed <vector37>:
801075ed:	6a 00                	push   $0x0
801075ef:	6a 25                	push   $0x25
801075f1:	e9 3f f8 ff ff       	jmp    80106e35 <alltraps>

801075f6 <vector38>:
801075f6:	6a 00                	push   $0x0
801075f8:	6a 26                	push   $0x26
801075fa:	e9 36 f8 ff ff       	jmp    80106e35 <alltraps>

801075ff <vector39>:
801075ff:	6a 00                	push   $0x0
80107601:	6a 27                	push   $0x27
80107603:	e9 2d f8 ff ff       	jmp    80106e35 <alltraps>

80107608 <vector40>:
80107608:	6a 00                	push   $0x0
8010760a:	6a 28                	push   $0x28
8010760c:	e9 24 f8 ff ff       	jmp    80106e35 <alltraps>

80107611 <vector41>:
80107611:	6a 00                	push   $0x0
80107613:	6a 29                	push   $0x29
80107615:	e9 1b f8 ff ff       	jmp    80106e35 <alltraps>

8010761a <vector42>:
8010761a:	6a 00                	push   $0x0
8010761c:	6a 2a                	push   $0x2a
8010761e:	e9 12 f8 ff ff       	jmp    80106e35 <alltraps>

80107623 <vector43>:
80107623:	6a 00                	push   $0x0
80107625:	6a 2b                	push   $0x2b
80107627:	e9 09 f8 ff ff       	jmp    80106e35 <alltraps>

8010762c <vector44>:
8010762c:	6a 00                	push   $0x0
8010762e:	6a 2c                	push   $0x2c
80107630:	e9 00 f8 ff ff       	jmp    80106e35 <alltraps>

80107635 <vector45>:
80107635:	6a 00                	push   $0x0
80107637:	6a 2d                	push   $0x2d
80107639:	e9 f7 f7 ff ff       	jmp    80106e35 <alltraps>

8010763e <vector46>:
8010763e:	6a 00                	push   $0x0
80107640:	6a 2e                	push   $0x2e
80107642:	e9 ee f7 ff ff       	jmp    80106e35 <alltraps>

80107647 <vector47>:
80107647:	6a 00                	push   $0x0
80107649:	6a 2f                	push   $0x2f
8010764b:	e9 e5 f7 ff ff       	jmp    80106e35 <alltraps>

80107650 <vector48>:
80107650:	6a 00                	push   $0x0
80107652:	6a 30                	push   $0x30
80107654:	e9 dc f7 ff ff       	jmp    80106e35 <alltraps>

80107659 <vector49>:
80107659:	6a 00                	push   $0x0
8010765b:	6a 31                	push   $0x31
8010765d:	e9 d3 f7 ff ff       	jmp    80106e35 <alltraps>

80107662 <vector50>:
80107662:	6a 00                	push   $0x0
80107664:	6a 32                	push   $0x32
80107666:	e9 ca f7 ff ff       	jmp    80106e35 <alltraps>

8010766b <vector51>:
8010766b:	6a 00                	push   $0x0
8010766d:	6a 33                	push   $0x33
8010766f:	e9 c1 f7 ff ff       	jmp    80106e35 <alltraps>

80107674 <vector52>:
80107674:	6a 00                	push   $0x0
80107676:	6a 34                	push   $0x34
80107678:	e9 b8 f7 ff ff       	jmp    80106e35 <alltraps>

8010767d <vector53>:
8010767d:	6a 00                	push   $0x0
8010767f:	6a 35                	push   $0x35
80107681:	e9 af f7 ff ff       	jmp    80106e35 <alltraps>

80107686 <vector54>:
80107686:	6a 00                	push   $0x0
80107688:	6a 36                	push   $0x36
8010768a:	e9 a6 f7 ff ff       	jmp    80106e35 <alltraps>

8010768f <vector55>:
8010768f:	6a 00                	push   $0x0
80107691:	6a 37                	push   $0x37
80107693:	e9 9d f7 ff ff       	jmp    80106e35 <alltraps>

80107698 <vector56>:
80107698:	6a 00                	push   $0x0
8010769a:	6a 38                	push   $0x38
8010769c:	e9 94 f7 ff ff       	jmp    80106e35 <alltraps>

801076a1 <vector57>:
801076a1:	6a 00                	push   $0x0
801076a3:	6a 39                	push   $0x39
801076a5:	e9 8b f7 ff ff       	jmp    80106e35 <alltraps>

801076aa <vector58>:
801076aa:	6a 00                	push   $0x0
801076ac:	6a 3a                	push   $0x3a
801076ae:	e9 82 f7 ff ff       	jmp    80106e35 <alltraps>

801076b3 <vector59>:
801076b3:	6a 00                	push   $0x0
801076b5:	6a 3b                	push   $0x3b
801076b7:	e9 79 f7 ff ff       	jmp    80106e35 <alltraps>

801076bc <vector60>:
801076bc:	6a 00                	push   $0x0
801076be:	6a 3c                	push   $0x3c
801076c0:	e9 70 f7 ff ff       	jmp    80106e35 <alltraps>

801076c5 <vector61>:
801076c5:	6a 00                	push   $0x0
801076c7:	6a 3d                	push   $0x3d
801076c9:	e9 67 f7 ff ff       	jmp    80106e35 <alltraps>

801076ce <vector62>:
801076ce:	6a 00                	push   $0x0
801076d0:	6a 3e                	push   $0x3e
801076d2:	e9 5e f7 ff ff       	jmp    80106e35 <alltraps>

801076d7 <vector63>:
801076d7:	6a 00                	push   $0x0
801076d9:	6a 3f                	push   $0x3f
801076db:	e9 55 f7 ff ff       	jmp    80106e35 <alltraps>

801076e0 <vector64>:
801076e0:	6a 00                	push   $0x0
801076e2:	6a 40                	push   $0x40
801076e4:	e9 4c f7 ff ff       	jmp    80106e35 <alltraps>

801076e9 <vector65>:
801076e9:	6a 00                	push   $0x0
801076eb:	6a 41                	push   $0x41
801076ed:	e9 43 f7 ff ff       	jmp    80106e35 <alltraps>

801076f2 <vector66>:
801076f2:	6a 00                	push   $0x0
801076f4:	6a 42                	push   $0x42
801076f6:	e9 3a f7 ff ff       	jmp    80106e35 <alltraps>

801076fb <vector67>:
801076fb:	6a 00                	push   $0x0
801076fd:	6a 43                	push   $0x43
801076ff:	e9 31 f7 ff ff       	jmp    80106e35 <alltraps>

80107704 <vector68>:
80107704:	6a 00                	push   $0x0
80107706:	6a 44                	push   $0x44
80107708:	e9 28 f7 ff ff       	jmp    80106e35 <alltraps>

8010770d <vector69>:
8010770d:	6a 00                	push   $0x0
8010770f:	6a 45                	push   $0x45
80107711:	e9 1f f7 ff ff       	jmp    80106e35 <alltraps>

80107716 <vector70>:
80107716:	6a 00                	push   $0x0
80107718:	6a 46                	push   $0x46
8010771a:	e9 16 f7 ff ff       	jmp    80106e35 <alltraps>

8010771f <vector71>:
8010771f:	6a 00                	push   $0x0
80107721:	6a 47                	push   $0x47
80107723:	e9 0d f7 ff ff       	jmp    80106e35 <alltraps>

80107728 <vector72>:
80107728:	6a 00                	push   $0x0
8010772a:	6a 48                	push   $0x48
8010772c:	e9 04 f7 ff ff       	jmp    80106e35 <alltraps>

80107731 <vector73>:
80107731:	6a 00                	push   $0x0
80107733:	6a 49                	push   $0x49
80107735:	e9 fb f6 ff ff       	jmp    80106e35 <alltraps>

8010773a <vector74>:
8010773a:	6a 00                	push   $0x0
8010773c:	6a 4a                	push   $0x4a
8010773e:	e9 f2 f6 ff ff       	jmp    80106e35 <alltraps>

80107743 <vector75>:
80107743:	6a 00                	push   $0x0
80107745:	6a 4b                	push   $0x4b
80107747:	e9 e9 f6 ff ff       	jmp    80106e35 <alltraps>

8010774c <vector76>:
8010774c:	6a 00                	push   $0x0
8010774e:	6a 4c                	push   $0x4c
80107750:	e9 e0 f6 ff ff       	jmp    80106e35 <alltraps>

80107755 <vector77>:
80107755:	6a 00                	push   $0x0
80107757:	6a 4d                	push   $0x4d
80107759:	e9 d7 f6 ff ff       	jmp    80106e35 <alltraps>

8010775e <vector78>:
8010775e:	6a 00                	push   $0x0
80107760:	6a 4e                	push   $0x4e
80107762:	e9 ce f6 ff ff       	jmp    80106e35 <alltraps>

80107767 <vector79>:
80107767:	6a 00                	push   $0x0
80107769:	6a 4f                	push   $0x4f
8010776b:	e9 c5 f6 ff ff       	jmp    80106e35 <alltraps>

80107770 <vector80>:
80107770:	6a 00                	push   $0x0
80107772:	6a 50                	push   $0x50
80107774:	e9 bc f6 ff ff       	jmp    80106e35 <alltraps>

80107779 <vector81>:
80107779:	6a 00                	push   $0x0
8010777b:	6a 51                	push   $0x51
8010777d:	e9 b3 f6 ff ff       	jmp    80106e35 <alltraps>

80107782 <vector82>:
80107782:	6a 00                	push   $0x0
80107784:	6a 52                	push   $0x52
80107786:	e9 aa f6 ff ff       	jmp    80106e35 <alltraps>

8010778b <vector83>:
8010778b:	6a 00                	push   $0x0
8010778d:	6a 53                	push   $0x53
8010778f:	e9 a1 f6 ff ff       	jmp    80106e35 <alltraps>

80107794 <vector84>:
80107794:	6a 00                	push   $0x0
80107796:	6a 54                	push   $0x54
80107798:	e9 98 f6 ff ff       	jmp    80106e35 <alltraps>

8010779d <vector85>:
8010779d:	6a 00                	push   $0x0
8010779f:	6a 55                	push   $0x55
801077a1:	e9 8f f6 ff ff       	jmp    80106e35 <alltraps>

801077a6 <vector86>:
801077a6:	6a 00                	push   $0x0
801077a8:	6a 56                	push   $0x56
801077aa:	e9 86 f6 ff ff       	jmp    80106e35 <alltraps>

801077af <vector87>:
801077af:	6a 00                	push   $0x0
801077b1:	6a 57                	push   $0x57
801077b3:	e9 7d f6 ff ff       	jmp    80106e35 <alltraps>

801077b8 <vector88>:
801077b8:	6a 00                	push   $0x0
801077ba:	6a 58                	push   $0x58
801077bc:	e9 74 f6 ff ff       	jmp    80106e35 <alltraps>

801077c1 <vector89>:
801077c1:	6a 00                	push   $0x0
801077c3:	6a 59                	push   $0x59
801077c5:	e9 6b f6 ff ff       	jmp    80106e35 <alltraps>

801077ca <vector90>:
801077ca:	6a 00                	push   $0x0
801077cc:	6a 5a                	push   $0x5a
801077ce:	e9 62 f6 ff ff       	jmp    80106e35 <alltraps>

801077d3 <vector91>:
801077d3:	6a 00                	push   $0x0
801077d5:	6a 5b                	push   $0x5b
801077d7:	e9 59 f6 ff ff       	jmp    80106e35 <alltraps>

801077dc <vector92>:
801077dc:	6a 00                	push   $0x0
801077de:	6a 5c                	push   $0x5c
801077e0:	e9 50 f6 ff ff       	jmp    80106e35 <alltraps>

801077e5 <vector93>:
801077e5:	6a 00                	push   $0x0
801077e7:	6a 5d                	push   $0x5d
801077e9:	e9 47 f6 ff ff       	jmp    80106e35 <alltraps>

801077ee <vector94>:
801077ee:	6a 00                	push   $0x0
801077f0:	6a 5e                	push   $0x5e
801077f2:	e9 3e f6 ff ff       	jmp    80106e35 <alltraps>

801077f7 <vector95>:
801077f7:	6a 00                	push   $0x0
801077f9:	6a 5f                	push   $0x5f
801077fb:	e9 35 f6 ff ff       	jmp    80106e35 <alltraps>

80107800 <vector96>:
80107800:	6a 00                	push   $0x0
80107802:	6a 60                	push   $0x60
80107804:	e9 2c f6 ff ff       	jmp    80106e35 <alltraps>

80107809 <vector97>:
80107809:	6a 00                	push   $0x0
8010780b:	6a 61                	push   $0x61
8010780d:	e9 23 f6 ff ff       	jmp    80106e35 <alltraps>

80107812 <vector98>:
80107812:	6a 00                	push   $0x0
80107814:	6a 62                	push   $0x62
80107816:	e9 1a f6 ff ff       	jmp    80106e35 <alltraps>

8010781b <vector99>:
8010781b:	6a 00                	push   $0x0
8010781d:	6a 63                	push   $0x63
8010781f:	e9 11 f6 ff ff       	jmp    80106e35 <alltraps>

80107824 <vector100>:
80107824:	6a 00                	push   $0x0
80107826:	6a 64                	push   $0x64
80107828:	e9 08 f6 ff ff       	jmp    80106e35 <alltraps>

8010782d <vector101>:
8010782d:	6a 00                	push   $0x0
8010782f:	6a 65                	push   $0x65
80107831:	e9 ff f5 ff ff       	jmp    80106e35 <alltraps>

80107836 <vector102>:
80107836:	6a 00                	push   $0x0
80107838:	6a 66                	push   $0x66
8010783a:	e9 f6 f5 ff ff       	jmp    80106e35 <alltraps>

8010783f <vector103>:
8010783f:	6a 00                	push   $0x0
80107841:	6a 67                	push   $0x67
80107843:	e9 ed f5 ff ff       	jmp    80106e35 <alltraps>

80107848 <vector104>:
80107848:	6a 00                	push   $0x0
8010784a:	6a 68                	push   $0x68
8010784c:	e9 e4 f5 ff ff       	jmp    80106e35 <alltraps>

80107851 <vector105>:
80107851:	6a 00                	push   $0x0
80107853:	6a 69                	push   $0x69
80107855:	e9 db f5 ff ff       	jmp    80106e35 <alltraps>

8010785a <vector106>:
8010785a:	6a 00                	push   $0x0
8010785c:	6a 6a                	push   $0x6a
8010785e:	e9 d2 f5 ff ff       	jmp    80106e35 <alltraps>

80107863 <vector107>:
80107863:	6a 00                	push   $0x0
80107865:	6a 6b                	push   $0x6b
80107867:	e9 c9 f5 ff ff       	jmp    80106e35 <alltraps>

8010786c <vector108>:
8010786c:	6a 00                	push   $0x0
8010786e:	6a 6c                	push   $0x6c
80107870:	e9 c0 f5 ff ff       	jmp    80106e35 <alltraps>

80107875 <vector109>:
80107875:	6a 00                	push   $0x0
80107877:	6a 6d                	push   $0x6d
80107879:	e9 b7 f5 ff ff       	jmp    80106e35 <alltraps>

8010787e <vector110>:
8010787e:	6a 00                	push   $0x0
80107880:	6a 6e                	push   $0x6e
80107882:	e9 ae f5 ff ff       	jmp    80106e35 <alltraps>

80107887 <vector111>:
80107887:	6a 00                	push   $0x0
80107889:	6a 6f                	push   $0x6f
8010788b:	e9 a5 f5 ff ff       	jmp    80106e35 <alltraps>

80107890 <vector112>:
80107890:	6a 00                	push   $0x0
80107892:	6a 70                	push   $0x70
80107894:	e9 9c f5 ff ff       	jmp    80106e35 <alltraps>

80107899 <vector113>:
80107899:	6a 00                	push   $0x0
8010789b:	6a 71                	push   $0x71
8010789d:	e9 93 f5 ff ff       	jmp    80106e35 <alltraps>

801078a2 <vector114>:
801078a2:	6a 00                	push   $0x0
801078a4:	6a 72                	push   $0x72
801078a6:	e9 8a f5 ff ff       	jmp    80106e35 <alltraps>

801078ab <vector115>:
801078ab:	6a 00                	push   $0x0
801078ad:	6a 73                	push   $0x73
801078af:	e9 81 f5 ff ff       	jmp    80106e35 <alltraps>

801078b4 <vector116>:
801078b4:	6a 00                	push   $0x0
801078b6:	6a 74                	push   $0x74
801078b8:	e9 78 f5 ff ff       	jmp    80106e35 <alltraps>

801078bd <vector117>:
801078bd:	6a 00                	push   $0x0
801078bf:	6a 75                	push   $0x75
801078c1:	e9 6f f5 ff ff       	jmp    80106e35 <alltraps>

801078c6 <vector118>:
801078c6:	6a 00                	push   $0x0
801078c8:	6a 76                	push   $0x76
801078ca:	e9 66 f5 ff ff       	jmp    80106e35 <alltraps>

801078cf <vector119>:
801078cf:	6a 00                	push   $0x0
801078d1:	6a 77                	push   $0x77
801078d3:	e9 5d f5 ff ff       	jmp    80106e35 <alltraps>

801078d8 <vector120>:
801078d8:	6a 00                	push   $0x0
801078da:	6a 78                	push   $0x78
801078dc:	e9 54 f5 ff ff       	jmp    80106e35 <alltraps>

801078e1 <vector121>:
801078e1:	6a 00                	push   $0x0
801078e3:	6a 79                	push   $0x79
801078e5:	e9 4b f5 ff ff       	jmp    80106e35 <alltraps>

801078ea <vector122>:
801078ea:	6a 00                	push   $0x0
801078ec:	6a 7a                	push   $0x7a
801078ee:	e9 42 f5 ff ff       	jmp    80106e35 <alltraps>

801078f3 <vector123>:
801078f3:	6a 00                	push   $0x0
801078f5:	6a 7b                	push   $0x7b
801078f7:	e9 39 f5 ff ff       	jmp    80106e35 <alltraps>

801078fc <vector124>:
801078fc:	6a 00                	push   $0x0
801078fe:	6a 7c                	push   $0x7c
80107900:	e9 30 f5 ff ff       	jmp    80106e35 <alltraps>

80107905 <vector125>:
80107905:	6a 00                	push   $0x0
80107907:	6a 7d                	push   $0x7d
80107909:	e9 27 f5 ff ff       	jmp    80106e35 <alltraps>

8010790e <vector126>:
8010790e:	6a 00                	push   $0x0
80107910:	6a 7e                	push   $0x7e
80107912:	e9 1e f5 ff ff       	jmp    80106e35 <alltraps>

80107917 <vector127>:
80107917:	6a 00                	push   $0x0
80107919:	6a 7f                	push   $0x7f
8010791b:	e9 15 f5 ff ff       	jmp    80106e35 <alltraps>

80107920 <vector128>:
80107920:	6a 00                	push   $0x0
80107922:	68 80 00 00 00       	push   $0x80
80107927:	e9 09 f5 ff ff       	jmp    80106e35 <alltraps>

8010792c <vector129>:
8010792c:	6a 00                	push   $0x0
8010792e:	68 81 00 00 00       	push   $0x81
80107933:	e9 fd f4 ff ff       	jmp    80106e35 <alltraps>

80107938 <vector130>:
80107938:	6a 00                	push   $0x0
8010793a:	68 82 00 00 00       	push   $0x82
8010793f:	e9 f1 f4 ff ff       	jmp    80106e35 <alltraps>

80107944 <vector131>:
80107944:	6a 00                	push   $0x0
80107946:	68 83 00 00 00       	push   $0x83
8010794b:	e9 e5 f4 ff ff       	jmp    80106e35 <alltraps>

80107950 <vector132>:
80107950:	6a 00                	push   $0x0
80107952:	68 84 00 00 00       	push   $0x84
80107957:	e9 d9 f4 ff ff       	jmp    80106e35 <alltraps>

8010795c <vector133>:
8010795c:	6a 00                	push   $0x0
8010795e:	68 85 00 00 00       	push   $0x85
80107963:	e9 cd f4 ff ff       	jmp    80106e35 <alltraps>

80107968 <vector134>:
80107968:	6a 00                	push   $0x0
8010796a:	68 86 00 00 00       	push   $0x86
8010796f:	e9 c1 f4 ff ff       	jmp    80106e35 <alltraps>

80107974 <vector135>:
80107974:	6a 00                	push   $0x0
80107976:	68 87 00 00 00       	push   $0x87
8010797b:	e9 b5 f4 ff ff       	jmp    80106e35 <alltraps>

80107980 <vector136>:
80107980:	6a 00                	push   $0x0
80107982:	68 88 00 00 00       	push   $0x88
80107987:	e9 a9 f4 ff ff       	jmp    80106e35 <alltraps>

8010798c <vector137>:
8010798c:	6a 00                	push   $0x0
8010798e:	68 89 00 00 00       	push   $0x89
80107993:	e9 9d f4 ff ff       	jmp    80106e35 <alltraps>

80107998 <vector138>:
80107998:	6a 00                	push   $0x0
8010799a:	68 8a 00 00 00       	push   $0x8a
8010799f:	e9 91 f4 ff ff       	jmp    80106e35 <alltraps>

801079a4 <vector139>:
801079a4:	6a 00                	push   $0x0
801079a6:	68 8b 00 00 00       	push   $0x8b
801079ab:	e9 85 f4 ff ff       	jmp    80106e35 <alltraps>

801079b0 <vector140>:
801079b0:	6a 00                	push   $0x0
801079b2:	68 8c 00 00 00       	push   $0x8c
801079b7:	e9 79 f4 ff ff       	jmp    80106e35 <alltraps>

801079bc <vector141>:
801079bc:	6a 00                	push   $0x0
801079be:	68 8d 00 00 00       	push   $0x8d
801079c3:	e9 6d f4 ff ff       	jmp    80106e35 <alltraps>

801079c8 <vector142>:
801079c8:	6a 00                	push   $0x0
801079ca:	68 8e 00 00 00       	push   $0x8e
801079cf:	e9 61 f4 ff ff       	jmp    80106e35 <alltraps>

801079d4 <vector143>:
801079d4:	6a 00                	push   $0x0
801079d6:	68 8f 00 00 00       	push   $0x8f
801079db:	e9 55 f4 ff ff       	jmp    80106e35 <alltraps>

801079e0 <vector144>:
801079e0:	6a 00                	push   $0x0
801079e2:	68 90 00 00 00       	push   $0x90
801079e7:	e9 49 f4 ff ff       	jmp    80106e35 <alltraps>

801079ec <vector145>:
801079ec:	6a 00                	push   $0x0
801079ee:	68 91 00 00 00       	push   $0x91
801079f3:	e9 3d f4 ff ff       	jmp    80106e35 <alltraps>

801079f8 <vector146>:
801079f8:	6a 00                	push   $0x0
801079fa:	68 92 00 00 00       	push   $0x92
801079ff:	e9 31 f4 ff ff       	jmp    80106e35 <alltraps>

80107a04 <vector147>:
80107a04:	6a 00                	push   $0x0
80107a06:	68 93 00 00 00       	push   $0x93
80107a0b:	e9 25 f4 ff ff       	jmp    80106e35 <alltraps>

80107a10 <vector148>:
80107a10:	6a 00                	push   $0x0
80107a12:	68 94 00 00 00       	push   $0x94
80107a17:	e9 19 f4 ff ff       	jmp    80106e35 <alltraps>

80107a1c <vector149>:
80107a1c:	6a 00                	push   $0x0
80107a1e:	68 95 00 00 00       	push   $0x95
80107a23:	e9 0d f4 ff ff       	jmp    80106e35 <alltraps>

80107a28 <vector150>:
80107a28:	6a 00                	push   $0x0
80107a2a:	68 96 00 00 00       	push   $0x96
80107a2f:	e9 01 f4 ff ff       	jmp    80106e35 <alltraps>

80107a34 <vector151>:
80107a34:	6a 00                	push   $0x0
80107a36:	68 97 00 00 00       	push   $0x97
80107a3b:	e9 f5 f3 ff ff       	jmp    80106e35 <alltraps>

80107a40 <vector152>:
80107a40:	6a 00                	push   $0x0
80107a42:	68 98 00 00 00       	push   $0x98
80107a47:	e9 e9 f3 ff ff       	jmp    80106e35 <alltraps>

80107a4c <vector153>:
80107a4c:	6a 00                	push   $0x0
80107a4e:	68 99 00 00 00       	push   $0x99
80107a53:	e9 dd f3 ff ff       	jmp    80106e35 <alltraps>

80107a58 <vector154>:
80107a58:	6a 00                	push   $0x0
80107a5a:	68 9a 00 00 00       	push   $0x9a
80107a5f:	e9 d1 f3 ff ff       	jmp    80106e35 <alltraps>

80107a64 <vector155>:
80107a64:	6a 00                	push   $0x0
80107a66:	68 9b 00 00 00       	push   $0x9b
80107a6b:	e9 c5 f3 ff ff       	jmp    80106e35 <alltraps>

80107a70 <vector156>:
80107a70:	6a 00                	push   $0x0
80107a72:	68 9c 00 00 00       	push   $0x9c
80107a77:	e9 b9 f3 ff ff       	jmp    80106e35 <alltraps>

80107a7c <vector157>:
80107a7c:	6a 00                	push   $0x0
80107a7e:	68 9d 00 00 00       	push   $0x9d
80107a83:	e9 ad f3 ff ff       	jmp    80106e35 <alltraps>

80107a88 <vector158>:
80107a88:	6a 00                	push   $0x0
80107a8a:	68 9e 00 00 00       	push   $0x9e
80107a8f:	e9 a1 f3 ff ff       	jmp    80106e35 <alltraps>

80107a94 <vector159>:
80107a94:	6a 00                	push   $0x0
80107a96:	68 9f 00 00 00       	push   $0x9f
80107a9b:	e9 95 f3 ff ff       	jmp    80106e35 <alltraps>

80107aa0 <vector160>:
80107aa0:	6a 00                	push   $0x0
80107aa2:	68 a0 00 00 00       	push   $0xa0
80107aa7:	e9 89 f3 ff ff       	jmp    80106e35 <alltraps>

80107aac <vector161>:
80107aac:	6a 00                	push   $0x0
80107aae:	68 a1 00 00 00       	push   $0xa1
80107ab3:	e9 7d f3 ff ff       	jmp    80106e35 <alltraps>

80107ab8 <vector162>:
80107ab8:	6a 00                	push   $0x0
80107aba:	68 a2 00 00 00       	push   $0xa2
80107abf:	e9 71 f3 ff ff       	jmp    80106e35 <alltraps>

80107ac4 <vector163>:
80107ac4:	6a 00                	push   $0x0
80107ac6:	68 a3 00 00 00       	push   $0xa3
80107acb:	e9 65 f3 ff ff       	jmp    80106e35 <alltraps>

80107ad0 <vector164>:
80107ad0:	6a 00                	push   $0x0
80107ad2:	68 a4 00 00 00       	push   $0xa4
80107ad7:	e9 59 f3 ff ff       	jmp    80106e35 <alltraps>

80107adc <vector165>:
80107adc:	6a 00                	push   $0x0
80107ade:	68 a5 00 00 00       	push   $0xa5
80107ae3:	e9 4d f3 ff ff       	jmp    80106e35 <alltraps>

80107ae8 <vector166>:
80107ae8:	6a 00                	push   $0x0
80107aea:	68 a6 00 00 00       	push   $0xa6
80107aef:	e9 41 f3 ff ff       	jmp    80106e35 <alltraps>

80107af4 <vector167>:
80107af4:	6a 00                	push   $0x0
80107af6:	68 a7 00 00 00       	push   $0xa7
80107afb:	e9 35 f3 ff ff       	jmp    80106e35 <alltraps>

80107b00 <vector168>:
80107b00:	6a 00                	push   $0x0
80107b02:	68 a8 00 00 00       	push   $0xa8
80107b07:	e9 29 f3 ff ff       	jmp    80106e35 <alltraps>

80107b0c <vector169>:
80107b0c:	6a 00                	push   $0x0
80107b0e:	68 a9 00 00 00       	push   $0xa9
80107b13:	e9 1d f3 ff ff       	jmp    80106e35 <alltraps>

80107b18 <vector170>:
80107b18:	6a 00                	push   $0x0
80107b1a:	68 aa 00 00 00       	push   $0xaa
80107b1f:	e9 11 f3 ff ff       	jmp    80106e35 <alltraps>

80107b24 <vector171>:
80107b24:	6a 00                	push   $0x0
80107b26:	68 ab 00 00 00       	push   $0xab
80107b2b:	e9 05 f3 ff ff       	jmp    80106e35 <alltraps>

80107b30 <vector172>:
80107b30:	6a 00                	push   $0x0
80107b32:	68 ac 00 00 00       	push   $0xac
80107b37:	e9 f9 f2 ff ff       	jmp    80106e35 <alltraps>

80107b3c <vector173>:
80107b3c:	6a 00                	push   $0x0
80107b3e:	68 ad 00 00 00       	push   $0xad
80107b43:	e9 ed f2 ff ff       	jmp    80106e35 <alltraps>

80107b48 <vector174>:
80107b48:	6a 00                	push   $0x0
80107b4a:	68 ae 00 00 00       	push   $0xae
80107b4f:	e9 e1 f2 ff ff       	jmp    80106e35 <alltraps>

80107b54 <vector175>:
80107b54:	6a 00                	push   $0x0
80107b56:	68 af 00 00 00       	push   $0xaf
80107b5b:	e9 d5 f2 ff ff       	jmp    80106e35 <alltraps>

80107b60 <vector176>:
80107b60:	6a 00                	push   $0x0
80107b62:	68 b0 00 00 00       	push   $0xb0
80107b67:	e9 c9 f2 ff ff       	jmp    80106e35 <alltraps>

80107b6c <vector177>:
80107b6c:	6a 00                	push   $0x0
80107b6e:	68 b1 00 00 00       	push   $0xb1
80107b73:	e9 bd f2 ff ff       	jmp    80106e35 <alltraps>

80107b78 <vector178>:
80107b78:	6a 00                	push   $0x0
80107b7a:	68 b2 00 00 00       	push   $0xb2
80107b7f:	e9 b1 f2 ff ff       	jmp    80106e35 <alltraps>

80107b84 <vector179>:
80107b84:	6a 00                	push   $0x0
80107b86:	68 b3 00 00 00       	push   $0xb3
80107b8b:	e9 a5 f2 ff ff       	jmp    80106e35 <alltraps>

80107b90 <vector180>:
80107b90:	6a 00                	push   $0x0
80107b92:	68 b4 00 00 00       	push   $0xb4
80107b97:	e9 99 f2 ff ff       	jmp    80106e35 <alltraps>

80107b9c <vector181>:
80107b9c:	6a 00                	push   $0x0
80107b9e:	68 b5 00 00 00       	push   $0xb5
80107ba3:	e9 8d f2 ff ff       	jmp    80106e35 <alltraps>

80107ba8 <vector182>:
80107ba8:	6a 00                	push   $0x0
80107baa:	68 b6 00 00 00       	push   $0xb6
80107baf:	e9 81 f2 ff ff       	jmp    80106e35 <alltraps>

80107bb4 <vector183>:
80107bb4:	6a 00                	push   $0x0
80107bb6:	68 b7 00 00 00       	push   $0xb7
80107bbb:	e9 75 f2 ff ff       	jmp    80106e35 <alltraps>

80107bc0 <vector184>:
80107bc0:	6a 00                	push   $0x0
80107bc2:	68 b8 00 00 00       	push   $0xb8
80107bc7:	e9 69 f2 ff ff       	jmp    80106e35 <alltraps>

80107bcc <vector185>:
80107bcc:	6a 00                	push   $0x0
80107bce:	68 b9 00 00 00       	push   $0xb9
80107bd3:	e9 5d f2 ff ff       	jmp    80106e35 <alltraps>

80107bd8 <vector186>:
80107bd8:	6a 00                	push   $0x0
80107bda:	68 ba 00 00 00       	push   $0xba
80107bdf:	e9 51 f2 ff ff       	jmp    80106e35 <alltraps>

80107be4 <vector187>:
80107be4:	6a 00                	push   $0x0
80107be6:	68 bb 00 00 00       	push   $0xbb
80107beb:	e9 45 f2 ff ff       	jmp    80106e35 <alltraps>

80107bf0 <vector188>:
80107bf0:	6a 00                	push   $0x0
80107bf2:	68 bc 00 00 00       	push   $0xbc
80107bf7:	e9 39 f2 ff ff       	jmp    80106e35 <alltraps>

80107bfc <vector189>:
80107bfc:	6a 00                	push   $0x0
80107bfe:	68 bd 00 00 00       	push   $0xbd
80107c03:	e9 2d f2 ff ff       	jmp    80106e35 <alltraps>

80107c08 <vector190>:
80107c08:	6a 00                	push   $0x0
80107c0a:	68 be 00 00 00       	push   $0xbe
80107c0f:	e9 21 f2 ff ff       	jmp    80106e35 <alltraps>

80107c14 <vector191>:
80107c14:	6a 00                	push   $0x0
80107c16:	68 bf 00 00 00       	push   $0xbf
80107c1b:	e9 15 f2 ff ff       	jmp    80106e35 <alltraps>

80107c20 <vector192>:
80107c20:	6a 00                	push   $0x0
80107c22:	68 c0 00 00 00       	push   $0xc0
80107c27:	e9 09 f2 ff ff       	jmp    80106e35 <alltraps>

80107c2c <vector193>:
80107c2c:	6a 00                	push   $0x0
80107c2e:	68 c1 00 00 00       	push   $0xc1
80107c33:	e9 fd f1 ff ff       	jmp    80106e35 <alltraps>

80107c38 <vector194>:
80107c38:	6a 00                	push   $0x0
80107c3a:	68 c2 00 00 00       	push   $0xc2
80107c3f:	e9 f1 f1 ff ff       	jmp    80106e35 <alltraps>

80107c44 <vector195>:
80107c44:	6a 00                	push   $0x0
80107c46:	68 c3 00 00 00       	push   $0xc3
80107c4b:	e9 e5 f1 ff ff       	jmp    80106e35 <alltraps>

80107c50 <vector196>:
80107c50:	6a 00                	push   $0x0
80107c52:	68 c4 00 00 00       	push   $0xc4
80107c57:	e9 d9 f1 ff ff       	jmp    80106e35 <alltraps>

80107c5c <vector197>:
80107c5c:	6a 00                	push   $0x0
80107c5e:	68 c5 00 00 00       	push   $0xc5
80107c63:	e9 cd f1 ff ff       	jmp    80106e35 <alltraps>

80107c68 <vector198>:
80107c68:	6a 00                	push   $0x0
80107c6a:	68 c6 00 00 00       	push   $0xc6
80107c6f:	e9 c1 f1 ff ff       	jmp    80106e35 <alltraps>

80107c74 <vector199>:
80107c74:	6a 00                	push   $0x0
80107c76:	68 c7 00 00 00       	push   $0xc7
80107c7b:	e9 b5 f1 ff ff       	jmp    80106e35 <alltraps>

80107c80 <vector200>:
80107c80:	6a 00                	push   $0x0
80107c82:	68 c8 00 00 00       	push   $0xc8
80107c87:	e9 a9 f1 ff ff       	jmp    80106e35 <alltraps>

80107c8c <vector201>:
80107c8c:	6a 00                	push   $0x0
80107c8e:	68 c9 00 00 00       	push   $0xc9
80107c93:	e9 9d f1 ff ff       	jmp    80106e35 <alltraps>

80107c98 <vector202>:
80107c98:	6a 00                	push   $0x0
80107c9a:	68 ca 00 00 00       	push   $0xca
80107c9f:	e9 91 f1 ff ff       	jmp    80106e35 <alltraps>

80107ca4 <vector203>:
80107ca4:	6a 00                	push   $0x0
80107ca6:	68 cb 00 00 00       	push   $0xcb
80107cab:	e9 85 f1 ff ff       	jmp    80106e35 <alltraps>

80107cb0 <vector204>:
80107cb0:	6a 00                	push   $0x0
80107cb2:	68 cc 00 00 00       	push   $0xcc
80107cb7:	e9 79 f1 ff ff       	jmp    80106e35 <alltraps>

80107cbc <vector205>:
80107cbc:	6a 00                	push   $0x0
80107cbe:	68 cd 00 00 00       	push   $0xcd
80107cc3:	e9 6d f1 ff ff       	jmp    80106e35 <alltraps>

80107cc8 <vector206>:
80107cc8:	6a 00                	push   $0x0
80107cca:	68 ce 00 00 00       	push   $0xce
80107ccf:	e9 61 f1 ff ff       	jmp    80106e35 <alltraps>

80107cd4 <vector207>:
80107cd4:	6a 00                	push   $0x0
80107cd6:	68 cf 00 00 00       	push   $0xcf
80107cdb:	e9 55 f1 ff ff       	jmp    80106e35 <alltraps>

80107ce0 <vector208>:
80107ce0:	6a 00                	push   $0x0
80107ce2:	68 d0 00 00 00       	push   $0xd0
80107ce7:	e9 49 f1 ff ff       	jmp    80106e35 <alltraps>

80107cec <vector209>:
80107cec:	6a 00                	push   $0x0
80107cee:	68 d1 00 00 00       	push   $0xd1
80107cf3:	e9 3d f1 ff ff       	jmp    80106e35 <alltraps>

80107cf8 <vector210>:
80107cf8:	6a 00                	push   $0x0
80107cfa:	68 d2 00 00 00       	push   $0xd2
80107cff:	e9 31 f1 ff ff       	jmp    80106e35 <alltraps>

80107d04 <vector211>:
80107d04:	6a 00                	push   $0x0
80107d06:	68 d3 00 00 00       	push   $0xd3
80107d0b:	e9 25 f1 ff ff       	jmp    80106e35 <alltraps>

80107d10 <vector212>:
80107d10:	6a 00                	push   $0x0
80107d12:	68 d4 00 00 00       	push   $0xd4
80107d17:	e9 19 f1 ff ff       	jmp    80106e35 <alltraps>

80107d1c <vector213>:
80107d1c:	6a 00                	push   $0x0
80107d1e:	68 d5 00 00 00       	push   $0xd5
80107d23:	e9 0d f1 ff ff       	jmp    80106e35 <alltraps>

80107d28 <vector214>:
80107d28:	6a 00                	push   $0x0
80107d2a:	68 d6 00 00 00       	push   $0xd6
80107d2f:	e9 01 f1 ff ff       	jmp    80106e35 <alltraps>

80107d34 <vector215>:
80107d34:	6a 00                	push   $0x0
80107d36:	68 d7 00 00 00       	push   $0xd7
80107d3b:	e9 f5 f0 ff ff       	jmp    80106e35 <alltraps>

80107d40 <vector216>:
80107d40:	6a 00                	push   $0x0
80107d42:	68 d8 00 00 00       	push   $0xd8
80107d47:	e9 e9 f0 ff ff       	jmp    80106e35 <alltraps>

80107d4c <vector217>:
80107d4c:	6a 00                	push   $0x0
80107d4e:	68 d9 00 00 00       	push   $0xd9
80107d53:	e9 dd f0 ff ff       	jmp    80106e35 <alltraps>

80107d58 <vector218>:
80107d58:	6a 00                	push   $0x0
80107d5a:	68 da 00 00 00       	push   $0xda
80107d5f:	e9 d1 f0 ff ff       	jmp    80106e35 <alltraps>

80107d64 <vector219>:
80107d64:	6a 00                	push   $0x0
80107d66:	68 db 00 00 00       	push   $0xdb
80107d6b:	e9 c5 f0 ff ff       	jmp    80106e35 <alltraps>

80107d70 <vector220>:
80107d70:	6a 00                	push   $0x0
80107d72:	68 dc 00 00 00       	push   $0xdc
80107d77:	e9 b9 f0 ff ff       	jmp    80106e35 <alltraps>

80107d7c <vector221>:
80107d7c:	6a 00                	push   $0x0
80107d7e:	68 dd 00 00 00       	push   $0xdd
80107d83:	e9 ad f0 ff ff       	jmp    80106e35 <alltraps>

80107d88 <vector222>:
80107d88:	6a 00                	push   $0x0
80107d8a:	68 de 00 00 00       	push   $0xde
80107d8f:	e9 a1 f0 ff ff       	jmp    80106e35 <alltraps>

80107d94 <vector223>:
80107d94:	6a 00                	push   $0x0
80107d96:	68 df 00 00 00       	push   $0xdf
80107d9b:	e9 95 f0 ff ff       	jmp    80106e35 <alltraps>

80107da0 <vector224>:
80107da0:	6a 00                	push   $0x0
80107da2:	68 e0 00 00 00       	push   $0xe0
80107da7:	e9 89 f0 ff ff       	jmp    80106e35 <alltraps>

80107dac <vector225>:
80107dac:	6a 00                	push   $0x0
80107dae:	68 e1 00 00 00       	push   $0xe1
80107db3:	e9 7d f0 ff ff       	jmp    80106e35 <alltraps>

80107db8 <vector226>:
80107db8:	6a 00                	push   $0x0
80107dba:	68 e2 00 00 00       	push   $0xe2
80107dbf:	e9 71 f0 ff ff       	jmp    80106e35 <alltraps>

80107dc4 <vector227>:
80107dc4:	6a 00                	push   $0x0
80107dc6:	68 e3 00 00 00       	push   $0xe3
80107dcb:	e9 65 f0 ff ff       	jmp    80106e35 <alltraps>

80107dd0 <vector228>:
80107dd0:	6a 00                	push   $0x0
80107dd2:	68 e4 00 00 00       	push   $0xe4
80107dd7:	e9 59 f0 ff ff       	jmp    80106e35 <alltraps>

80107ddc <vector229>:
80107ddc:	6a 00                	push   $0x0
80107dde:	68 e5 00 00 00       	push   $0xe5
80107de3:	e9 4d f0 ff ff       	jmp    80106e35 <alltraps>

80107de8 <vector230>:
80107de8:	6a 00                	push   $0x0
80107dea:	68 e6 00 00 00       	push   $0xe6
80107def:	e9 41 f0 ff ff       	jmp    80106e35 <alltraps>

80107df4 <vector231>:
80107df4:	6a 00                	push   $0x0
80107df6:	68 e7 00 00 00       	push   $0xe7
80107dfb:	e9 35 f0 ff ff       	jmp    80106e35 <alltraps>

80107e00 <vector232>:
80107e00:	6a 00                	push   $0x0
80107e02:	68 e8 00 00 00       	push   $0xe8
80107e07:	e9 29 f0 ff ff       	jmp    80106e35 <alltraps>

80107e0c <vector233>:
80107e0c:	6a 00                	push   $0x0
80107e0e:	68 e9 00 00 00       	push   $0xe9
80107e13:	e9 1d f0 ff ff       	jmp    80106e35 <alltraps>

80107e18 <vector234>:
80107e18:	6a 00                	push   $0x0
80107e1a:	68 ea 00 00 00       	push   $0xea
80107e1f:	e9 11 f0 ff ff       	jmp    80106e35 <alltraps>

80107e24 <vector235>:
80107e24:	6a 00                	push   $0x0
80107e26:	68 eb 00 00 00       	push   $0xeb
80107e2b:	e9 05 f0 ff ff       	jmp    80106e35 <alltraps>

80107e30 <vector236>:
80107e30:	6a 00                	push   $0x0
80107e32:	68 ec 00 00 00       	push   $0xec
80107e37:	e9 f9 ef ff ff       	jmp    80106e35 <alltraps>

80107e3c <vector237>:
80107e3c:	6a 00                	push   $0x0
80107e3e:	68 ed 00 00 00       	push   $0xed
80107e43:	e9 ed ef ff ff       	jmp    80106e35 <alltraps>

80107e48 <vector238>:
80107e48:	6a 00                	push   $0x0
80107e4a:	68 ee 00 00 00       	push   $0xee
80107e4f:	e9 e1 ef ff ff       	jmp    80106e35 <alltraps>

80107e54 <vector239>:
80107e54:	6a 00                	push   $0x0
80107e56:	68 ef 00 00 00       	push   $0xef
80107e5b:	e9 d5 ef ff ff       	jmp    80106e35 <alltraps>

80107e60 <vector240>:
80107e60:	6a 00                	push   $0x0
80107e62:	68 f0 00 00 00       	push   $0xf0
80107e67:	e9 c9 ef ff ff       	jmp    80106e35 <alltraps>

80107e6c <vector241>:
80107e6c:	6a 00                	push   $0x0
80107e6e:	68 f1 00 00 00       	push   $0xf1
80107e73:	e9 bd ef ff ff       	jmp    80106e35 <alltraps>

80107e78 <vector242>:
80107e78:	6a 00                	push   $0x0
80107e7a:	68 f2 00 00 00       	push   $0xf2
80107e7f:	e9 b1 ef ff ff       	jmp    80106e35 <alltraps>

80107e84 <vector243>:
80107e84:	6a 00                	push   $0x0
80107e86:	68 f3 00 00 00       	push   $0xf3
80107e8b:	e9 a5 ef ff ff       	jmp    80106e35 <alltraps>

80107e90 <vector244>:
80107e90:	6a 00                	push   $0x0
80107e92:	68 f4 00 00 00       	push   $0xf4
80107e97:	e9 99 ef ff ff       	jmp    80106e35 <alltraps>

80107e9c <vector245>:
80107e9c:	6a 00                	push   $0x0
80107e9e:	68 f5 00 00 00       	push   $0xf5
80107ea3:	e9 8d ef ff ff       	jmp    80106e35 <alltraps>

80107ea8 <vector246>:
80107ea8:	6a 00                	push   $0x0
80107eaa:	68 f6 00 00 00       	push   $0xf6
80107eaf:	e9 81 ef ff ff       	jmp    80106e35 <alltraps>

80107eb4 <vector247>:
80107eb4:	6a 00                	push   $0x0
80107eb6:	68 f7 00 00 00       	push   $0xf7
80107ebb:	e9 75 ef ff ff       	jmp    80106e35 <alltraps>

80107ec0 <vector248>:
80107ec0:	6a 00                	push   $0x0
80107ec2:	68 f8 00 00 00       	push   $0xf8
80107ec7:	e9 69 ef ff ff       	jmp    80106e35 <alltraps>

80107ecc <vector249>:
80107ecc:	6a 00                	push   $0x0
80107ece:	68 f9 00 00 00       	push   $0xf9
80107ed3:	e9 5d ef ff ff       	jmp    80106e35 <alltraps>

80107ed8 <vector250>:
80107ed8:	6a 00                	push   $0x0
80107eda:	68 fa 00 00 00       	push   $0xfa
80107edf:	e9 51 ef ff ff       	jmp    80106e35 <alltraps>

80107ee4 <vector251>:
80107ee4:	6a 00                	push   $0x0
80107ee6:	68 fb 00 00 00       	push   $0xfb
80107eeb:	e9 45 ef ff ff       	jmp    80106e35 <alltraps>

80107ef0 <vector252>:
80107ef0:	6a 00                	push   $0x0
80107ef2:	68 fc 00 00 00       	push   $0xfc
80107ef7:	e9 39 ef ff ff       	jmp    80106e35 <alltraps>

80107efc <vector253>:
80107efc:	6a 00                	push   $0x0
80107efe:	68 fd 00 00 00       	push   $0xfd
80107f03:	e9 2d ef ff ff       	jmp    80106e35 <alltraps>

80107f08 <vector254>:
80107f08:	6a 00                	push   $0x0
80107f0a:	68 fe 00 00 00       	push   $0xfe
80107f0f:	e9 21 ef ff ff       	jmp    80106e35 <alltraps>

80107f14 <vector255>:
80107f14:	6a 00                	push   $0x0
80107f16:	68 ff 00 00 00       	push   $0xff
80107f1b:	e9 15 ef ff ff       	jmp    80106e35 <alltraps>

80107f20 <lgdt>:
{
80107f20:	55                   	push   %ebp
80107f21:	89 e5                	mov    %esp,%ebp
80107f23:	83 ec 10             	sub    $0x10,%esp
  pd[0] = size-1;
80107f26:	8b 45 0c             	mov    0xc(%ebp),%eax
80107f29:	48                   	dec    %eax
80107f2a:	66 89 45 fa          	mov    %ax,-0x6(%ebp)
  pd[1] = (uint)p;
80107f2e:	8b 45 08             	mov    0x8(%ebp),%eax
80107f31:	66 89 45 fc          	mov    %ax,-0x4(%ebp)
  pd[2] = (uint)p >> 16;
80107f35:	8b 45 08             	mov    0x8(%ebp),%eax
80107f38:	c1 e8 10             	shr    $0x10,%eax
80107f3b:	66 89 45 fe          	mov    %ax,-0x2(%ebp)
  asm volatile("lgdt (%0)" : : "r" (pd));
80107f3f:	8d 45 fa             	lea    -0x6(%ebp),%eax
80107f42:	0f 01 10             	lgdtl  (%eax)
}
80107f45:	c9                   	leave  
80107f46:	c3                   	ret    
...
80107f50:	66 89 45 fc          	mov    %ax,-0x4(%ebp)
  asm volatile("ltr %0" : : "r" (sel));
80107f54:	8b 45 fc             	mov    -0x4(%ebp),%eax
80107f57:	0f 00 d8             	ltr    %ax
}
80107f5a:	c9                   	leave  
80107f5b:	c3                   	ret    
...
80107f81:	05 00 00 00 80       	add    $0x80000000,%eax
80107f86:	5d                   	pop    %ebp
80107f87:	c3                   	ret    
...
80107f8e:	05 00 00 00 80       	add    $0x80000000,%eax
80107f93:	5d                   	pop    %ebp
80107f94:	c3                   	ret    
...
80107f99:	83 ec 24             	sub    $0x24,%esp
  ...
  c = &cpus[cpunum()];
80107f9c:	e8 a4 ae ff ff       	call   80102e45 <cpunum>
80107fa1:	89 c2                	mov    %eax,%edx
80107fa3:	89 d0                	mov    %edx,%eax
80107fa5:	d1 e0                	shl    %eax
80107fa7:	01 d0                	add    %edx,%eax
80107fa9:	c1 e0 04             	shl    $0x4,%eax
80107fac:	29 d0                	sub    %edx,%eax
80107fae:	c1 e0 02             	shl    $0x2,%eax
80107fb1:	05 60 09 11 80       	add    $0x80110960,%eax
80107fb6:	89 45 f4             	mov    %eax,-0xc(%ebp)
  c->gdt[SEG_KCODE] = SEG(STA_X|STA_R, 0, 0xffffffff, 0);
80107fb9:	8b 45 f4             	mov    -0xc(%ebp),%eax
80107fbc:	66 c7 40 78 ff ff    	movw   $0xffff,0x78(%eax)
80107fc2:	8b 45 f4             	mov    -0xc(%ebp),%eax
80107fc5:	66 c7 40 7a 00 00    	movw   $0x0,0x7a(%eax)
80107fcb:	8b 45 f4             	mov    -0xc(%ebp),%eax
80107fce:	c6 40 7c 00          	movb   $0x0,0x7c(%eax)
80107fd2:	8b 45 f4             	mov    -0xc(%ebp),%eax
80107fd5:	8a 50 7d             	mov    0x7d(%eax),%dl
80107fd8:	83 e2 f0             	and    $0xfffffff0,%edx
80107fdb:	83 ca 0a             	or     $0xa,%edx
80107fde:	88 50 7d             	mov    %dl,0x7d(%eax)
80107fe1:	8b 45 f4             	mov    -0xc(%ebp),%eax
80107fe4:	8a 50 7d             	mov    0x7d(%eax),%dl
80107fe7:	83 ca 10             	or     $0x10,%edx
80107fea:	88 50 7d             	mov    %dl,0x7d(%eax)
80107fed:	8b 45 f4             	mov    -0xc(%ebp),%eax
80107ff0:	8a 50 7d             	mov    0x7d(%eax),%dl
80107ff3:	83 e2 9f             	and    $0xffffff9f,%edx
80107ff6:	88 50 7d             	mov    %dl,0x7d(%eax)
80107ff9:	8b 45 f4             	mov    -0xc(%ebp),%eax
80107ffc:	8a 50 7d             	mov    0x7d(%eax),%dl
80107fff:	83 ca 80             	or     $0xffffff80,%edx
80108002:	88 50 7d             	mov    %dl,0x7d(%eax)
80108005:	8b 45 f4             	mov    -0xc(%ebp),%eax
80108008:	8a 50 7e             	mov    0x7e(%eax),%dl
8010800b:	83 ca 0f             	or     $0xf,%edx
8010800e:	88 50 7e             	mov    %dl,0x7e(%eax)
80108011:	8b 45 f4             	mov    -0xc(%ebp),%eax
80108014:	8a 50 7e             	mov    0x7e(%eax),%dl
80108017:	83 e2 ef             	and    $0xffffffef,%edx
8010801a:	88 50 7e             	mov    %dl,0x7e(%eax)
8010801d:	8b 45 f4             	mov    -0xc(%ebp),%eax
80108020:	8a 50 7e             	mov    0x7e(%eax),%dl
80108023:	83 e2 df             	and    $0xffffffdf,%edx
80108026:	88 50 7e             	mov    %dl,0x7e(%eax)
80108029:	8b 45 f4             	mov    -0xc(%ebp),%eax
8010802c:	8a 50 7e             	mov    0x7e(%eax),%dl
8010802f:	83 ca 40             	or     $0x40,%edx
80108032:	88 50 7e             	mov    %dl,0x7e(%eax)
80108035:	8b 45 f4             	mov    -0xc(%ebp),%eax
80108038:	8a 50 7e             	mov    0x7e(%eax),%dl
8010803b:	83 ca 80             	or     $0xffffff80,%edx
8010803e:	88 50 7e             	mov    %dl,0x7e(%eax)
80108041:	8b 45 f4             	mov    -0xc(%ebp),%eax
80108044:	c6 40 7f 00          	movb   $0x0,0x7f(%eax)
  c->gdt[SEG_KDATA] = SEG(STA_W, 0, 0xffffffff, 0);
80108048:	8b 45 f4             	mov    -0xc(%ebp),%eax
8010804b:	66 c7 80 80 00 00 00 	movw   $0xffff,0x80(%eax)
80108052:	ff ff 
80108054:	8b 45 f4             	mov    -0xc(%ebp),%eax
80108057:	66 c7 80 82 00 00 00 	movw   $0x0,0x82(%eax)
8010805e:	00 00 
80108060:	8b 45 f4             	mov    -0xc(%ebp),%eax
80108063:	c6 80 84 00 00 00 00 	movb   $0x0,0x84(%eax)
8010806a:	8b 45 f4             	mov    -0xc(%ebp),%eax
8010806d:	8a 90 85 00 00 00    	mov    0x85(%eax),%dl
80108073:	83 e2 f0             	and    $0xfffffff0,%edx
80108076:	83 ca 02             	or     $0x2,%edx
80108079:	88 90 85 00 00 00    	mov    %dl,0x85(%eax)
8010807f:	8b 45 f4             	mov    -0xc(%ebp),%eax
80108082:	8a 90 85 00 00 00    	mov    0x85(%eax),%dl
80108088:	83 ca 10             	or     $0x10,%edx
8010808b:	88 90 85 00 00 00    	mov    %dl,0x85(%eax)
80108091:	8b 45 f4             	mov    -0xc(%ebp),%eax
80108094:	8a 90 85 00 00 00    	mov    0x85(%eax),%dl
8010809a:	83 e2 9f             	and    $0xffffff9f,%edx
8010809d:	88 90 85 00 00 00    	mov    %dl,0x85(%eax)
801080a3:	8b 45 f4             	mov    -0xc(%ebp),%eax
801080a6:	8a 90 85 00 00 00    	mov    0x85(%eax),%dl
801080ac:	83 ca 80             	or     $0xffffff80,%edx
801080af:	88 90 85 00 00 00    	mov    %dl,0x85(%eax)
801080b5:	8b 45 f4             	mov    -0xc(%ebp),%eax
801080b8:	8a 90 86 00 00 00    	mov    0x86(%eax),%dl
801080be:	83 ca 0f             	or     $0xf,%edx
801080c1:	88 90 86 00 00 00    	mov    %dl,0x86(%eax)
801080c7:	8b 45 f4             	mov    -0xc(%ebp),%eax
801080ca:	8a 90 86 00 00 00    	mov    0x86(%eax),%dl
801080d0:	83 e2 ef             	and    $0xffffffef,%edx
801080d3:	88 90 86 00 00 00    	mov    %dl,0x86(%eax)
801080d9:	8b 45 f4             	mov    -0xc(%ebp),%eax
801080dc:	8a 90 86 00 00 00    	mov    0x86(%eax),%dl
801080e2:	83 e2 df             	and    $0xffffffdf,%edx
801080e5:	88 90 86 00 00 00    	mov    %dl,0x86(%eax)
...
80108106:	83 ca 80             	or     $0xffffff80,%edx
80108109:	88 90 86 00 00 00    	mov    %dl,0x86(%eax)
8010810f:	8b 45 f4             	mov    -0xc(%ebp),%eax
80108112:	c6 80 87 00 00 00 00 	movb   $0x0,0x87(%eax)
  c->gdt[SEG_UCODE] = SEG(STA_X|STA_R, 0, 0xffffffff, DPL_USER);
80108119:	8b 45 f4             	mov    -0xc(%ebp),%eax
8010811c:	66 c7 80 90 00 00 00 	movw   $0xffff,0x90(%eax)
80108123:	ff ff 
80108125:	8b 45 f4             	mov    -0xc(%ebp),%eax
80108128:	66 c7 80 92 00 00 00 	movw   $0x0,0x92(%eax)
8010812f:	00 00 
80108131:	8b 45 f4             	mov    -0xc(%ebp),%eax
80108134:	c6 80 94 00 00 00 00 	movb   $0x0,0x94(%eax)
8010813b:	8b 45 f4             	mov    -0xc(%ebp),%eax
8010813e:	8a 90 95 00 00 00    	mov    0x95(%eax),%dl
80108144:	83 e2 f0             	and    $0xfffffff0,%edx
80108147:	83 ca 0a             	or     $0xa,%edx
8010814a:	88 90 95 00 00 00    	mov    %dl,0x95(%eax)
80108150:	8b 45 f4             	mov    -0xc(%ebp),%eax
80108153:	8a 90 95 00 00 00    	mov    0x95(%eax),%dl
80108159:	83 ca 10             	or     $0x10,%edx
8010815c:	88 90 95 00 00 00    	mov    %dl,0x95(%eax)
80108162:	8b 45 f4             	mov    -0xc(%ebp),%eax
80108165:	8a 90 95 00 00 00    	mov    0x95(%eax),%dl
8010816b:	83 ca 60             	or     $0x60,%edx
8010816e:	88 90 95 00 00 00    	mov    %dl,0x95(%eax)
80108174:	8b 45 f4             	mov    -0xc(%ebp),%eax
80108177:	8a 90 95 00 00 00    	mov    0x95(%eax),%dl
8010817d:	83 ca 80             	or     $0xffffff80,%edx
80108180:	88 90 95 00 00 00    	mov    %dl,0x95(%eax)
80108186:	8b 45 f4             	mov    -0xc(%ebp),%eax
80108189:	8a 90 96 00 00 00    	mov    0x96(%eax),%dl
8010818f:	83 ca 0f             	or     $0xf,%edx
80108192:	88 90 96 00 00 00    	mov    %dl,0x96(%eax)
80108198:	8b 45 f4             	mov    -0xc(%ebp),%eax
8010819b:	8a 90 96 00 00 00    	mov    0x96(%eax),%dl
801081a1:	83 e2 ef             	and    $0xffffffef,%edx
801081a4:	88 90 96 00 00 00    	mov    %dl,0x96(%eax)
801081aa:	8b 45 f4             	mov    -0xc(%ebp),%eax
801081ad:	8a 90 96 00 00 00    	mov    0x96(%eax),%dl
801081b3:	83 e2 df             	and    $0xffffffdf,%edx
801081b6:	88 90 96 00 00 00    	mov    %dl,0x96(%eax)
801081bc:	8b 45 f4             	mov    -0xc(%ebp),%eax
801081bf:	8a 90 96 00 00 00    	mov    0x96(%eax),%dl
801081c5:	83 ca 40             	or     $0x40,%edx
...
801081e3:	c6 80 97 00 00 00 00 	movb   $0x0,0x97(%eax)
  c->gdt[SEG_UDATA] = SEG(STA_W, 0, 0xffffffff, DPL_USER);
801081ea:	8b 45 f4             	mov    -0xc(%ebp),%eax
801081ed:	66 c7 80 98 00 00 00 	movw   $0xffff,0x98(%eax)
801081f4:	ff ff 
801081f6:	8b 45 f4             	mov    -0xc(%ebp),%eax
801081f9:	66 c7 80 9a 00 00 00 	movw   $0x0,0x9a(%eax)
80108200:	00 00 
80108202:	8b 45 f4             	mov    -0xc(%ebp),%eax
80108205:	c6 80 9c 00 00 00 00 	movb   $0x0,0x9c(%eax)
8010820c:	8b 45 f4             	mov    -0xc(%ebp),%eax
8010820f:	8a 90 9d 00 00 00    	mov    0x9d(%eax),%dl
...
80108224:	8a 90 9d 00 00 00    	mov    0x9d(%eax),%dl
8010822a:	83 ca 10             	or     $0x10,%edx
8010822d:	88 90 9d 00 00 00    	mov    %dl,0x9d(%eax)
80108233:	8b 45 f4             	mov    -0xc(%ebp),%eax
80108236:	8a 90 9d 00 00 00    	mov    0x9d(%eax),%dl
8010823c:	83 ca 60             	or     $0x60,%edx
8010823f:	88 90 9d 00 00 00    	mov    %dl,0x9d(%eax)
80108245:	8b 45 f4             	mov    -0xc(%ebp),%eax
80108248:	8a 90 9d 00 00 00    	mov    0x9d(%eax),%dl
8010824e:	83 ca 80             	or     $0xffffff80,%edx
80108251:	88 90 9d 00 00 00    	mov    %dl,0x9d(%eax)
80108257:	8b 45 f4             	mov    -0xc(%ebp),%eax
8010825a:	8a 90 9e 00 00 00    	mov    0x9e(%eax),%dl
80108260:	83 ca 0f             	or     $0xf,%edx
80108263:	88 90 9e 00 00 00    	mov    %dl,0x9e(%eax)
80108269:	8b 45 f4             	mov    -0xc(%ebp),%eax
8010826c:	8a 90 9e 00 00 00    	mov    0x9e(%eax),%dl
80108272:	83 e2 ef             	and    $0xffffffef,%edx
80108275:	88 90 9e 00 00 00    	mov    %dl,0x9e(%eax)
8010827b:	8b 45 f4             	mov    -0xc(%ebp),%eax
8010827e:	8a 90 9e 00 00 00    	mov    0x9e(%eax),%dl
80108284:	83 e2 df             	and    $0xffffffdf,%edx
80108287:	88 90 9e 00 00 00    	mov    %dl,0x9e(%eax)
8010828d:	8b 45 f4             	mov    -0xc(%ebp),%eax
80108290:	8a 90 9e 00 00 00    	mov    0x9e(%eax),%dl
80108296:	83 ca 40             	or     $0x40,%edx
...
801082b4:	c6 80 9f 00 00 00 00 	movb   $0x0,0x9f(%eax)

  // Map cpu, and curproc
  c->gdt[SEG_KCPU] = SEG(STA_W, &c->cpu, 8, 0);
801082bb:	8b 45 f4             	mov    -0xc(%ebp),%eax
801082be:	05 b4 00 00 00       	add    $0xb4,%eax
801082c3:	8b 55 f4             	mov    -0xc(%ebp),%edx
801082c6:	81 c2 b4 00 00 00    	add    $0xb4,%edx
801082cc:	c1 ea 10             	shr    $0x10,%edx
801082cf:	88 d1                	mov    %dl,%cl
801082d1:	8b 55 f4             	mov    -0xc(%ebp),%edx
801082d4:	81 c2 b4 00 00 00    	add    $0xb4,%edx
801082da:	c1 ea 18             	shr    $0x18,%edx
801082dd:	8b 5d f4             	mov    -0xc(%ebp),%ebx
801082e0:	66 c7 83 88 00 00 00 	movw   $0x0,0x88(%ebx)
801082e7:	00 00 
801082e9:	8b 5d f4             	mov    -0xc(%ebp),%ebx
801082ec:	66 89 83 8a 00 00 00 	mov    %ax,0x8a(%ebx)
801082f3:	8b 45 f4             	mov    -0xc(%ebp),%eax
801082f6:	88 88 8c 00 00 00    	mov    %cl,0x8c(%eax)
801082fc:	8b 45 f4             	mov    -0xc(%ebp),%eax
801082ff:	8a 88 8d 00 00 00    	mov    0x8d(%eax),%cl
80108305:	83 e1 f0             	and    $0xfffffff0,%ecx
80108308:	83 c9 02             	or     $0x2,%ecx
8010830b:	88 88 8d 00 00 00    	mov    %cl,0x8d(%eax)
80108311:	8b 45 f4             	mov    -0xc(%ebp),%eax
80108314:	8a 88 8d 00 00 00    	mov    0x8d(%eax),%cl
8010831a:	83 c9 10             	or     $0x10,%ecx
8010831d:	88 88 8d 00 00 00    	mov    %cl,0x8d(%eax)
80108323:	8b 45 f4             	mov    -0xc(%ebp),%eax
80108326:	8a 88 8d 00 00 00    	mov    0x8d(%eax),%cl
8010832c:	83 e1 9f             	and    $0xffffff9f,%ecx
8010832f:	88 88 8d 00 00 00    	mov    %cl,0x8d(%eax)
80108335:	8b 45 f4             	mov    -0xc(%ebp),%eax
80108338:	8a 88 8d 00 00 00    	mov    0x8d(%eax),%cl
8010833e:	83 c9 80             	or     $0xffffff80,%ecx
80108341:	88 88 8d 00 00 00    	mov    %cl,0x8d(%eax)
80108347:	8b 45 f4             	mov    -0xc(%ebp),%eax
8010834a:	8a 88 8e 00 00 00    	mov    0x8e(%eax),%cl
80108350:	83 e1 f0             	and    $0xfffffff0,%ecx
80108353:	88 88 8e 00 00 00    	mov    %cl,0x8e(%eax)
80108359:	8b 45 f4             	mov    -0xc(%ebp),%eax
8010835c:	8a 88 8e 00 00 00    	mov    0x8e(%eax),%cl
80108362:	83 e1 ef             	and    $0xffffffef,%ecx
80108365:	88 88 8e 00 00 00    	mov    %cl,0x8e(%eax)
8010836b:	8b 45 f4             	mov    -0xc(%ebp),%eax
8010836e:	8a 88 8e 00 00 00    	mov    0x8e(%eax),%cl
80108374:	83 e1 df             	and    $0xffffffdf,%ecx
80108377:	88 88 8e 00 00 00    	mov    %cl,0x8e(%eax)
8010837d:	8b 45 f4             	mov    -0xc(%ebp),%eax
80108380:	8a 88 8e 00 00 00    	mov    0x8e(%eax),%cl
80108386:	83 c9 40             	or     $0x40,%ecx
80108389:	88 88 8e 00 00 00    	mov    %cl,0x8e(%eax)
8010838f:	8b 45 f4             	mov    -0xc(%ebp),%eax
80108392:	8a 88 8e 00 00 00    	mov    0x8e(%eax),%cl
80108398:	83 c9 80             	or     $0xffffff80,%ecx
8010839b:	88 88 8e 00 00 00    	mov    %cl,0x8e(%eax)
801083a1:	8b 45 f4             	mov    -0xc(%ebp),%eax
801083a4:	88 90 8f 00 00 00    	mov    %dl,0x8f(%eax)

  lgdt(c->gdt, sizeof(c->gdt));
801083aa:	8b 45 f4             	mov    -0xc(%ebp),%eax
801083ad:	83 c0 70             	add    $0x70,%eax
801083b0:	c7 44 24 04 38 00 00 	movl   $0x38,0x4(%esp)
801083b7:	00 
801083b8:	89 04 24             	mov    %eax,(%esp)
801083bb:	e8 60 fb ff ff       	call   80107f20 <lgdt>
  loadgs(SEG_KCPU << 3);
801083c0:	c7 04 24 18 00 00 00 	movl   $0x18,(%esp)
801083c7:	e8 90 fb ff ff       	call   80107f5c <loadgs>
  
  // Initialize cpu-local storage.
  cpu = c;
801083cc:	8b 45 f4             	mov    -0xc(%ebp),%eax
801083cf:	65 a3 00 00 00 00    	mov    %eax,%gs:0x0
  proc = 0;
801083d5:	65 c7 05 04 00 00 00 	movl   $0x0,%gs:0x4
801083dc:	00 00 00 00 
}
801083e0:	83 c4 24             	add    $0x24,%esp
801083e3:	5b                   	pop    %ebx
801083e4:	5d                   	pop    %ebp
801083e5:	c3                   	ret    
...
801083e9:	83 ec 28             	sub    $0x28,%esp
  pde_t *pde;
  pte_t *pgtab;

  pde = &pgdir[PDX(va)];
801083ec:	8b 45 0c             	mov    0xc(%ebp),%eax
801083ef:	c1 e8 16             	shr    $0x16,%eax
801083f2:	8d 14 85 00 00 00 00 	lea    0x0(,%eax,4),%edx
801083f9:	8b 45 08             	mov    0x8(%ebp),%eax
801083fc:	01 d0                	add    %edx,%eax
801083fe:	89 45 f0             	mov    %eax,-0x10(%ebp)
  if(*pde & PTE_P){
80108401:	8b 45 f0             	mov    -0x10(%ebp),%eax
80108404:	8b 00                	mov    (%eax),%eax
80108406:	83 e0 01             	and    $0x1,%eax
80108409:	85 c0                	test   %eax,%eax
8010840b:	74 17                	je     80108424 <walkpgdir+0x3e>
...
8010841a:	e8 69 fb ff ff       	call   80107f88 <p2v>
8010841f:	89 45 f4             	mov    %eax,-0xc(%ebp)
80108422:	eb 4b                	jmp    8010846f <walkpgdir+0x89>
  } else {
    if(!alloc || (pgtab = (pte_t*)kalloc()) == 0) // kalloc es 0 cuando no puede asignar la memoria.
80108424:	83 7d 10 00          	cmpl   $0x0,0x10(%ebp)
80108428:	74 0e                	je     80108438 <walkpgdir+0x52>
8010842a:	e8 8f a6 ff ff       	call   80102abe <kalloc>
8010842f:	89 45 f4             	mov    %eax,-0xc(%ebp)
80108432:	83 7d f4 00          	cmpl   $0x0,-0xc(%ebp)
80108436:	75 07                	jne    8010843f <walkpgdir+0x59>
      return 0;
80108438:	b8 00 00 00 00       	mov    $0x0,%eax
8010843d:	eb 47                	jmp    80108486 <walkpgdir+0xa0>
    // Make sure all those PTE_P bits are zero.
    memset(pgtab, 0, PGSIZE);
8010843f:	c7 44 24 08 00 10 00 	movl   $0x1000,0x8(%esp)
80108446:	00 
80108447:	c7 44 24 04 00 00 00 	movl   $0x0,0x4(%esp)
8010844e:	00 
8010844f:	8b 45 f4             	mov    -0xc(%ebp),%eax
80108452:	89 04 24             	mov    %eax,(%esp)
80108455:	e8 9e d3 ff ff       	call   801057f8 <memset>
...
80108460:	e8 16 fb ff ff       	call   80107f7b <v2p>
80108465:	89 c2                	mov    %eax,%edx
80108467:	83 ca 07             	or     $0x7,%edx
...
80108472:	c1 e8 0c             	shr    $0xc,%eax
80108475:	25 ff 03 00 00       	and    $0x3ff,%eax
...
801084bf:	e8 22 ff ff ff       	call   801083e6 <walkpgdir>
801084c4:	89 45 ec             	mov    %eax,-0x14(%ebp)
801084c7:	83 7d ec 00          	cmpl   $0x0,-0x14(%ebp)
801084cb:	75 07                	jne    801084d4 <mappages+0x4c>
...
801084cd:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
801084d2:	eb 46                	jmp    8010851a <mappages+0x92>
    if(*pte & PTE_P)
801084d4:	8b 45 ec             	mov    -0x14(%ebp),%eax
801084d7:	8b 00                	mov    (%eax),%eax
801084d9:	83 e0 01             	and    $0x1,%eax
801084dc:	85 c0                	test   %eax,%eax
801084de:	74 0c                	je     801084ec <mappages+0x64>
      panic("remap");
801084e0:	c7 04 24 00 94 10 80 	movl   $0x80109400,(%esp)
801084e7:	e8 4a 80 ff ff       	call   80100536 <panic>
    *pte = pa | perm | PTE_P;
801084ec:	8b 45 18             	mov    0x18(%ebp),%eax
801084ef:	0b 45 14             	or     0x14(%ebp),%eax
801084f2:	89 c2                	mov    %eax,%edx
801084f4:	83 ca 01             	or     $0x1,%edx
801084f7:	8b 45 ec             	mov    -0x14(%ebp),%eax
801084fa:	89 10                	mov    %edx,(%eax)
    if(a == last)
801084fc:	8b 45 f4             	mov    -0xc(%ebp),%eax
801084ff:	3b 45 f0             	cmp    -0x10(%ebp),%eax
80108502:	74 10                	je     80108514 <mappages+0x8c>
      break;
    a += PGSIZE;
80108504:	81 45 f4 00 10 00 00 	addl   $0x1000,-0xc(%ebp)
    pa += PGSIZE;
8010850b:	81 45 14 00 10 00 00 	addl   $0x1000,0x14(%ebp)
  }
80108512:	eb 96                	jmp    801084aa <mappages+0x22>
      break;
80108514:	90                   	nop
  return 0;
...
8010851f:	53                   	push   %ebx
80108520:	83 ec 34             	sub    $0x34,%esp
  pde_t *pgdir;
  struct kmap *k;

  if((pgdir = (pde_t*)kalloc()) == 0)
80108523:	e8 96 a5 ff ff       	call   80102abe <kalloc>
80108528:	89 45 f0             	mov    %eax,-0x10(%ebp)
8010852b:	83 7d f0 00          	cmpl   $0x0,-0x10(%ebp)
8010852f:	75 0a                	jne    8010853b <setupkvm+0x1f>
    return 0;
80108531:	b8 00 00 00 00       	mov    $0x0,%eax
80108536:	e9 98 00 00 00       	jmp    801085d3 <setupkvm+0xb7>
  memset(pgdir, 0, PGSIZE);
8010853b:	c7 44 24 08 00 10 00 	movl   $0x1000,0x8(%esp)
80108542:	00 
80108543:	c7 44 24 04 00 00 00 	movl   $0x0,0x4(%esp)
8010854a:	00 
8010854b:	8b 45 f0             	mov    -0x10(%ebp),%eax
8010854e:	89 04 24             	mov    %eax,(%esp)
80108551:	e8 a2 d2 ff ff       	call   801057f8 <memset>
  if (p2v(PHYSTOP) > (void*)DEVSPACE)
80108556:	c7 04 24 00 00 00 0e 	movl   $0xe000000,(%esp)
8010855d:	e8 26 fa ff ff       	call   80107f88 <p2v>
80108562:	3d 00 00 00 fe       	cmp    $0xfe000000,%eax
80108567:	76 0c                	jbe    80108575 <setupkvm+0x59>
    panic("PHYSTOP too high");
80108569:	c7 04 24 06 94 10 80 	movl   $0x80109406,(%esp)
80108570:	e8 c1 7f ff ff       	call   80100536 <panic>
  for(k = kmap; k < &kmap[NELEM(kmap)]; k++)
80108575:	c7 45 f4 e0 c4 10 80 	movl   $0x8010c4e0,-0xc(%ebp)
8010857c:	eb 49                	jmp    801085c7 <setupkvm+0xab>
    if(mappages(pgdir, k->virt, k->phys_end - k->phys_start, 
                (uint)k->phys_start, k->perm) < 0)
8010857e:	8b 45 f4             	mov    -0xc(%ebp),%eax
    if(mappages(pgdir, k->virt, k->phys_end - k->phys_start, 
80108581:	8b 48 0c             	mov    0xc(%eax),%ecx
                (uint)k->phys_start, k->perm) < 0)
80108584:	8b 45 f4             	mov    -0xc(%ebp),%eax
    if(mappages(pgdir, k->virt, k->phys_end - k->phys_start, 
80108587:	8b 50 04             	mov    0x4(%eax),%edx
8010858a:	8b 45 f4             	mov    -0xc(%ebp),%eax
8010858d:	8b 58 08             	mov    0x8(%eax),%ebx
80108590:	8b 45 f4             	mov    -0xc(%ebp),%eax
80108593:	8b 40 04             	mov    0x4(%eax),%eax
80108596:	29 c3                	sub    %eax,%ebx
80108598:	8b 45 f4             	mov    -0xc(%ebp),%eax
8010859b:	8b 00                	mov    (%eax),%eax
8010859d:	89 4c 24 10          	mov    %ecx,0x10(%esp)
801085a1:	89 54 24 0c          	mov    %edx,0xc(%esp)
801085a5:	89 5c 24 08          	mov    %ebx,0x8(%esp)
801085a9:	89 44 24 04          	mov    %eax,0x4(%esp)
801085ad:	8b 45 f0             	mov    -0x10(%ebp),%eax
801085b0:	89 04 24             	mov    %eax,(%esp)
801085b3:	e8 d0 fe ff ff       	call   80108488 <mappages>
801085b8:	85 c0                	test   %eax,%eax
801085ba:	79 07                	jns    801085c3 <setupkvm+0xa7>
      return 0;
801085bc:	b8 00 00 00 00       	mov    $0x0,%eax
801085c1:	eb 10                	jmp    801085d3 <setupkvm+0xb7>
  for(k = kmap; k < &kmap[NELEM(kmap)]; k++)
801085c3:	83 45 f4 10          	addl   $0x10,-0xc(%ebp)
801085c7:	81 7d f4 20 c5 10 80 	cmpl   $0x8010c520,-0xc(%ebp)
801085ce:	72 ae                	jb     8010857e <setupkvm+0x62>
  return pgdir;
801085d0:	8b 45 f0             	mov    -0x10(%ebp),%eax
}
801085d3:	83 c4 34             	add    $0x34,%esp
801085d6:	5b                   	pop    %ebx
801085d7:	5d                   	pop    %ebp
801085d8:	c3                   	ret    
...
801085dc:	83 ec 08             	sub    $0x8,%esp
  kpgdir = setupkvm();
801085df:	e8 38 ff ff ff       	call   8010851c <setupkvm>
801085e4:	a3 b8 44 11 80       	mov    %eax,0x801144b8
  switchkvm();
801085e9:	e8 02 00 00 00       	call   801085f0 <switchkvm>
}
801085ee:	c9                   	leave  
801085ef:	c3                   	ret    
...
801085f3:	83 ec 04             	sub    $0x4,%esp
  lcr3(v2p(kpgdir));   // switch to the kernel page table
801085f6:	a1 b8 44 11 80       	mov    0x801144b8,%eax
801085fb:	89 04 24             	mov    %eax,(%esp)
801085fe:	e8 78 f9 ff ff       	call   80107f7b <v2p>
80108603:	89 04 24             	mov    %eax,(%esp)
80108606:	e8 65 f9 ff ff       	call   80107f70 <lcr3>
}
8010860b:	c9                   	leave  
8010860c:	c3                   	ret    
...
80108611:	83 ec 14             	sub    $0x14,%esp
  pushcli();
80108614:	e8 df d0 ff ff       	call   801056f8 <pushcli>
  cpu->gdt[SEG_TSS] = SEG16(STS_T32A, &cpu->ts, sizeof(cpu->ts)-1, 0);
80108619:	65 a1 00 00 00 00    	mov    %gs:0x0,%eax
8010861f:	65 8b 15 00 00 00 00 	mov    %gs:0x0,%edx
80108626:	83 c2 08             	add    $0x8,%edx
80108629:	65 8b 0d 00 00 00 00 	mov    %gs:0x0,%ecx
80108630:	83 c1 08             	add    $0x8,%ecx
80108633:	c1 e9 10             	shr    $0x10,%ecx
80108636:	88 cb                	mov    %cl,%bl
80108638:	65 8b 0d 00 00 00 00 	mov    %gs:0x0,%ecx
8010863f:	83 c1 08             	add    $0x8,%ecx
80108642:	c1 e9 18             	shr    $0x18,%ecx
80108645:	66 c7 80 a0 00 00 00 	movw   $0x67,0xa0(%eax)
8010864c:	67 00 
8010864e:	66 89 90 a2 00 00 00 	mov    %dx,0xa2(%eax)
80108655:	88 98 a4 00 00 00    	mov    %bl,0xa4(%eax)
8010865b:	8a 90 a5 00 00 00    	mov    0xa5(%eax),%dl
80108661:	83 e2 f0             	and    $0xfffffff0,%edx
80108664:	83 ca 09             	or     $0x9,%edx
80108667:	88 90 a5 00 00 00    	mov    %dl,0xa5(%eax)
8010866d:	8a 90 a5 00 00 00    	mov    0xa5(%eax),%dl
80108673:	83 ca 10             	or     $0x10,%edx
80108676:	88 90 a5 00 00 00    	mov    %dl,0xa5(%eax)
8010867c:	8a 90 a5 00 00 00    	mov    0xa5(%eax),%dl
80108682:	83 e2 9f             	and    $0xffffff9f,%edx
80108685:	88 90 a5 00 00 00    	mov    %dl,0xa5(%eax)
8010868b:	8a 90 a5 00 00 00    	mov    0xa5(%eax),%dl
80108691:	83 ca 80             	or     $0xffffff80,%edx
80108694:	88 90 a5 00 00 00    	mov    %dl,0xa5(%eax)
8010869a:	8a 90 a6 00 00 00    	mov    0xa6(%eax),%dl
801086a0:	83 e2 f0             	and    $0xfffffff0,%edx
801086a3:	88 90 a6 00 00 00    	mov    %dl,0xa6(%eax)
801086a9:	8a 90 a6 00 00 00    	mov    0xa6(%eax),%dl
801086af:	83 e2 ef             	and    $0xffffffef,%edx
801086b2:	88 90 a6 00 00 00    	mov    %dl,0xa6(%eax)
801086b8:	8a 90 a6 00 00 00    	mov    0xa6(%eax),%dl
801086be:	83 e2 df             	and    $0xffffffdf,%edx
801086c1:	88 90 a6 00 00 00    	mov    %dl,0xa6(%eax)
801086c7:	8a 90 a6 00 00 00    	mov    0xa6(%eax),%dl
801086cd:	83 ca 40             	or     $0x40,%edx
801086d0:	88 90 a6 00 00 00    	mov    %dl,0xa6(%eax)
801086d6:	8a 90 a6 00 00 00    	mov    0xa6(%eax),%dl
801086dc:	83 e2 7f             	and    $0x7f,%edx
801086df:	88 90 a6 00 00 00    	mov    %dl,0xa6(%eax)
801086e5:	88 88 a7 00 00 00    	mov    %cl,0xa7(%eax)
  cpu->gdt[SEG_TSS].s = 0;
801086eb:	65 a1 00 00 00 00    	mov    %gs:0x0,%eax
801086f1:	8a 90 a5 00 00 00    	mov    0xa5(%eax),%dl
801086f7:	83 e2 ef             	and    $0xffffffef,%edx
801086fa:	88 90 a5 00 00 00    	mov    %dl,0xa5(%eax)
  cpu->ts.ss0 = SEG_KDATA << 3;
80108700:	65 a1 00 00 00 00    	mov    %gs:0x0,%eax
80108706:	66 c7 40 10 10 00    	movw   $0x10,0x10(%eax)
  cpu->ts.esp0 = (uint)proc->kstack + KSTACKSIZE;
8010870c:	65 a1 00 00 00 00    	mov    %gs:0x0,%eax
80108712:	65 8b 15 04 00 00 00 	mov    %gs:0x4,%edx
80108719:	8b 52 08             	mov    0x8(%edx),%edx
8010871c:	81 c2 00 10 00 00    	add    $0x1000,%edx
80108722:	89 50 0c             	mov    %edx,0xc(%eax)
  ltr(SEG_TSS << 3);
80108725:	c7 04 24 30 00 00 00 	movl   $0x30,(%esp)
8010872c:	e8 16 f8 ff ff       	call   80107f47 <ltr>
  if(p->pgdir == 0)
80108731:	8b 45 08             	mov    0x8(%ebp),%eax
80108734:	8b 40 04             	mov    0x4(%eax),%eax
80108737:	85 c0                	test   %eax,%eax
80108739:	75 0c                	jne    80108747 <switchuvm+0x13a>
    panic("switchuvm: no pgdir");
8010873b:	c7 04 24 17 94 10 80 	movl   $0x80109417,(%esp)
80108742:	e8 ef 7d ff ff       	call   80100536 <panic>
  lcr3(v2p(p->pgdir));  // switch to new address space
80108747:	8b 45 08             	mov    0x8(%ebp),%eax
8010874a:	8b 40 04             	mov    0x4(%eax),%eax
8010874d:	89 04 24             	mov    %eax,(%esp)
80108750:	e8 26 f8 ff ff       	call   80107f7b <v2p>
80108755:	89 04 24             	mov    %eax,(%esp)
80108758:	e8 13 f8 ff ff       	call   80107f70 <lcr3>
  popcli();
8010875d:	e8 dc cf ff ff       	call   8010573e <popcli>
}
80108762:	83 c4 14             	add    $0x14,%esp
80108765:	5b                   	pop    %ebx
80108766:	5d                   	pop    %ebp
80108767:	c3                   	ret    
...
8010876b:	83 ec 38             	sub    $0x38,%esp
  char *mem;
  
  if(sz >= PGSIZE)
8010876e:	81 7d 10 ff 0f 00 00 	cmpl   $0xfff,0x10(%ebp)
80108775:	76 0c                	jbe    80108783 <inituvm+0x1b>
    panic("inituvm: more than a page");
80108777:	c7 04 24 2b 94 10 80 	movl   $0x8010942b,(%esp)
8010877e:	e8 b3 7d ff ff       	call   80100536 <panic>
  mem = kalloc();
80108783:	e8 36 a3 ff ff       	call   80102abe <kalloc>
80108788:	89 45 f4             	mov    %eax,-0xc(%ebp)
  memset(mem, 0, PGSIZE);
8010878b:	c7 44 24 08 00 10 00 	movl   $0x1000,0x8(%esp)
80108792:	00 
80108793:	c7 44 24 04 00 00 00 	movl   $0x0,0x4(%esp)
8010879a:	00 
8010879b:	8b 45 f4             	mov    -0xc(%ebp),%eax
8010879e:	89 04 24             	mov    %eax,(%esp)
801087a1:	e8 52 d0 ff ff       	call   801057f8 <memset>
  mappages(pgdir, 0, PGSIZE, v2p(mem), PTE_W|PTE_U);
801087a6:	8b 45 f4             	mov    -0xc(%ebp),%eax
801087a9:	89 04 24             	mov    %eax,(%esp)
801087ac:	e8 ca f7 ff ff       	call   80107f7b <v2p>
801087b1:	c7 44 24 10 06 00 00 	movl   $0x6,0x10(%esp)
801087b8:	00 
801087b9:	89 44 24 0c          	mov    %eax,0xc(%esp)
801087bd:	c7 44 24 08 00 10 00 	movl   $0x1000,0x8(%esp)
801087c4:	00 
801087c5:	c7 44 24 04 00 00 00 	movl   $0x0,0x4(%esp)
801087cc:	00 
801087cd:	8b 45 08             	mov    0x8(%ebp),%eax
801087d0:	89 04 24             	mov    %eax,(%esp)
801087d3:	e8 b0 fc ff ff       	call   80108488 <mappages>
  memmove(mem, init, sz);
801087d8:	8b 45 10             	mov    0x10(%ebp),%eax
801087db:	89 44 24 08          	mov    %eax,0x8(%esp)
801087df:	8b 45 0c             	mov    0xc(%ebp),%eax
801087e2:	89 44 24 04          	mov    %eax,0x4(%esp)
801087e6:	8b 45 f4             	mov    -0xc(%ebp),%eax
801087e9:	89 04 24             	mov    %eax,(%esp)
801087ec:	e8 d3 d0 ff ff       	call   801058c4 <memmove>
}
801087f1:	c9                   	leave  
801087f2:	c3                   	ret    
...
801087f7:	83 ec 24             	sub    $0x24,%esp
  uint i, pa, n;
  pte_t *pte;
...
80108804:	74 0c                	je     80108812 <loaduvm+0x1f>
    panic("loaduvm: addr must be page aligned");
80108806:	c7 04 24 48 94 10 80 	movl   $0x80109448,(%esp)
8010880d:	e8 24 7d ff ff       	call   80100536 <panic>
  for(i = 0; i < sz; i += PGSIZE){
80108812:	c7 45 f4 00 00 00 00 	movl   $0x0,-0xc(%ebp)
80108819:	e9 ad 00 00 00       	jmp    801088cb <loaduvm+0xd8>
    if((pte = walkpgdir(pgdir, addr+i, 0)) == 0)
8010881e:	8b 45 f4             	mov    -0xc(%ebp),%eax
80108821:	8b 55 0c             	mov    0xc(%ebp),%edx
80108824:	01 d0                	add    %edx,%eax
80108826:	c7 44 24 08 00 00 00 	movl   $0x0,0x8(%esp)
8010882d:	00 
8010882e:	89 44 24 04          	mov    %eax,0x4(%esp)
80108832:	8b 45 08             	mov    0x8(%ebp),%eax
80108835:	89 04 24             	mov    %eax,(%esp)
80108838:	e8 a9 fb ff ff       	call   801083e6 <walkpgdir>
8010883d:	89 45 ec             	mov    %eax,-0x14(%ebp)
80108840:	83 7d ec 00          	cmpl   $0x0,-0x14(%ebp)
80108844:	75 0c                	jne    80108852 <loaduvm+0x5f>
      panic("loaduvm: address should exist");
80108846:	c7 04 24 6b 94 10 80 	movl   $0x8010946b,(%esp)
8010884d:	e8 e4 7c ff ff       	call   80100536 <panic>
    pa = PTE_ADDR(*pte);
80108852:	8b 45 ec             	mov    -0x14(%ebp),%eax
80108855:	8b 00                	mov    (%eax),%eax
80108857:	25 00 f0 ff ff       	and    $0xfffff000,%eax
8010885c:	89 45 e8             	mov    %eax,-0x18(%ebp)
    if(sz - i < PGSIZE)
...
8010886b:	3d ff 0f 00 00       	cmp    $0xfff,%eax
80108870:	77 11                	ja     80108883 <loaduvm+0x90>
      n = sz - i;
80108872:	8b 45 f4             	mov    -0xc(%ebp),%eax
80108875:	8b 55 18             	mov    0x18(%ebp),%edx
80108878:	89 d1                	mov    %edx,%ecx
8010887a:	29 c1                	sub    %eax,%ecx
8010887c:	89 c8                	mov    %ecx,%eax
8010887e:	89 45 f0             	mov    %eax,-0x10(%ebp)
80108881:	eb 07                	jmp    8010888a <loaduvm+0x97>
    else
      n = PGSIZE;
80108883:	c7 45 f0 00 10 00 00 	movl   $0x1000,-0x10(%ebp)
    if(readi(ip, p2v(pa), offset+i, n) != n)
8010888a:	8b 45 f4             	mov    -0xc(%ebp),%eax
8010888d:	8b 55 14             	mov    0x14(%ebp),%edx
80108890:	8d 1c 02             	lea    (%edx,%eax,1),%ebx
80108893:	8b 45 e8             	mov    -0x18(%ebp),%eax
80108896:	89 04 24             	mov    %eax,(%esp)
80108899:	e8 ea f6 ff ff       	call   80107f88 <p2v>
8010889e:	8b 55 f0             	mov    -0x10(%ebp),%edx
801088a1:	89 54 24 0c          	mov    %edx,0xc(%esp)
801088a5:	89 5c 24 08          	mov    %ebx,0x8(%esp)
801088a9:	89 44 24 04          	mov    %eax,0x4(%esp)
801088ad:	8b 45 10             	mov    0x10(%ebp),%eax
801088b0:	89 04 24             	mov    %eax,(%esp)
801088b3:	e8 94 94 ff ff       	call   80101d4c <readi>
801088b8:	3b 45 f0             	cmp    -0x10(%ebp),%eax
801088bb:	74 07                	je     801088c4 <loaduvm+0xd1>
      return -1;
801088bd:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
801088c2:	eb 18                	jmp    801088dc <loaduvm+0xe9>
  for(i = 0; i < sz; i += PGSIZE){
801088c4:	81 45 f4 00 10 00 00 	addl   $0x1000,-0xc(%ebp)
801088cb:	8b 45 f4             	mov    -0xc(%ebp),%eax
801088ce:	3b 45 18             	cmp    0x18(%ebp),%eax
801088d1:	0f 82 47 ff ff ff    	jb     8010881e <loaduvm+0x2b>
  }
  return 0;
801088d7:	b8 00 00 00 00       	mov    $0x0,%eax
}
801088dc:	83 c4 24             	add    $0x24,%esp
801088df:	5b                   	pop    %ebx
801088e0:	5d                   	pop    %ebp
801088e1:	c3                   	ret    
...
801088e5:	83 ec 38             	sub    $0x38,%esp
  char *mem;
  uint a;

  if(newsz >= KERNBASE)
801088e8:	8b 45 10             	mov    0x10(%ebp),%eax
801088eb:	85 c0                	test   %eax,%eax
801088ed:	79 0a                	jns    801088f9 <allocuvm+0x17>
    return 0;
801088ef:	b8 00 00 00 00       	mov    $0x0,%eax
801088f4:	e9 c1 00 00 00       	jmp    801089ba <allocuvm+0xd8>
  if(newsz < oldsz)
801088f9:	8b 45 10             	mov    0x10(%ebp),%eax
801088fc:	3b 45 0c             	cmp    0xc(%ebp),%eax
801088ff:	73 08                	jae    80108909 <allocuvm+0x27>
    return oldsz;
80108901:	8b 45 0c             	mov    0xc(%ebp),%eax
80108904:	e9 b1 00 00 00       	jmp    801089ba <allocuvm+0xd8>

  a = PGROUNDUP(oldsz);
80108909:	8b 45 0c             	mov    0xc(%ebp),%eax
8010890c:	05 ff 0f 00 00       	add    $0xfff,%eax
80108911:	25 00 f0 ff ff       	and    $0xfffff000,%eax
80108916:	89 45 f4             	mov    %eax,-0xc(%ebp)
  for(; a < newsz; a += PGSIZE){
80108919:	e9 8d 00 00 00       	jmp    801089ab <allocuvm+0xc9>
    mem = kalloc();
8010891e:	e8 9b a1 ff ff       	call   80102abe <kalloc>
80108923:	89 45 f0             	mov    %eax,-0x10(%ebp)
    if(mem == 0){
80108926:	83 7d f0 00          	cmpl   $0x0,-0x10(%ebp)
8010892a:	75 2c                	jne    80108958 <allocuvm+0x76>
      cprintf("allocuvm out of memory\n");
8010892c:	c7 04 24 89 94 10 80 	movl   $0x80109489,(%esp)
80108933:	e8 69 7a ff ff       	call   801003a1 <cprintf>
      deallocuvm(pgdir, newsz, oldsz);
80108938:	8b 45 0c             	mov    0xc(%ebp),%eax
8010893b:	89 44 24 08          	mov    %eax,0x8(%esp)
...
8010894c:	e8 6b 00 00 00       	call   801089bc <deallocuvm>
      return 0;
80108951:	b8 00 00 00 00       	mov    $0x0,%eax
80108956:	eb 62                	jmp    801089ba <allocuvm+0xd8>
    }
    memset(mem, 0, PGSIZE);
80108958:	c7 44 24 08 00 10 00 	movl   $0x1000,0x8(%esp)
8010895f:	00 
80108960:	c7 44 24 04 00 00 00 	movl   $0x0,0x4(%esp)
80108967:	00 
80108968:	8b 45 f0             	mov    -0x10(%ebp),%eax
8010896b:	89 04 24             	mov    %eax,(%esp)
8010896e:	e8 85 ce ff ff       	call   801057f8 <memset>
    mappages(pgdir, (char*)a, PGSIZE, v2p(mem), PTE_W|PTE_U);
80108973:	8b 45 f0             	mov    -0x10(%ebp),%eax
80108976:	89 04 24             	mov    %eax,(%esp)
80108979:	e8 fd f5 ff ff       	call   80107f7b <v2p>
8010897e:	8b 55 f4             	mov    -0xc(%ebp),%edx
80108981:	c7 44 24 10 06 00 00 	movl   $0x6,0x10(%esp)
80108988:	00 
80108989:	89 44 24 0c          	mov    %eax,0xc(%esp)
8010898d:	c7 44 24 08 00 10 00 	movl   $0x1000,0x8(%esp)
80108994:	00 
80108995:	89 54 24 04          	mov    %edx,0x4(%esp)
80108999:	8b 45 08             	mov    0x8(%ebp),%eax
8010899c:	89 04 24             	mov    %eax,(%esp)
8010899f:	e8 e4 fa ff ff       	call   80108488 <mappages>
  for(; a < newsz; a += PGSIZE){
801089a4:	81 45 f4 00 10 00 00 	addl   $0x1000,-0xc(%ebp)
801089ab:	8b 45 f4             	mov    -0xc(%ebp),%eax
801089ae:	3b 45 10             	cmp    0x10(%ebp),%eax
801089b1:	0f 82 67 ff ff ff    	jb     8010891e <allocuvm+0x3c>
  }
  return newsz;
...
801089bf:	83 ec 38             	sub    $0x38,%esp
  pte_t *pte;
  uint a, pa;
  int save_this = 1; // New: Add in project final 
801089c2:	c7 45 f0 01 00 00 00 	movl   $0x1,-0x10(%ebp)

  if(newsz >= oldsz)
801089c9:	8b 45 10             	mov    0x10(%ebp),%eax
801089cc:	3b 45 0c             	cmp    0xc(%ebp),%eax
801089cf:	72 08                	jb     801089d9 <deallocuvm+0x1d>
    return oldsz;
801089d1:	8b 45 0c             	mov    0xc(%ebp),%eax
801089d4:	e9 b8 00 00 00       	jmp    80108a91 <deallocuvm+0xd5>
...
801089e9:	e9 94 00 00 00       	jmp    80108a82 <deallocuvm+0xc6>
    pte = walkpgdir(pgdir, (char*)a, 0);
801089ee:	8b 45 f4             	mov    -0xc(%ebp),%eax
801089f1:	c7 44 24 08 00 00 00 	movl   $0x0,0x8(%esp)
801089f8:	00 
801089f9:	89 44 24 04          	mov    %eax,0x4(%esp)
801089fd:	8b 45 08             	mov    0x8(%ebp),%eax
80108a00:	89 04 24             	mov    %eax,(%esp)
80108a03:	e8 de f9 ff ff       	call   801083e6 <walkpgdir>
80108a08:	89 45 ec             	mov    %eax,-0x14(%ebp)
    if(!pte)
80108a0b:	83 7d ec 00          	cmpl   $0x0,-0x14(%ebp)
80108a0f:	75 09                	jne    80108a1a <deallocuvm+0x5e>
      a += (NPTENTRIES - 1) * PGSIZE;
80108a11:	81 45 f4 00 f0 3f 00 	addl   $0x3ff000,-0xc(%ebp)
80108a18:	eb 61                	jmp    80108a7b <deallocuvm+0xbf>
    else if((*pte & PTE_P) != 0){
80108a1a:	8b 45 ec             	mov    -0x14(%ebp),%eax
80108a1d:	8b 00                	mov    (%eax),%eax
80108a1f:	83 e0 01             	and    $0x1,%eax
80108a22:	85 c0                	test   %eax,%eax
80108a24:	74 55                	je     80108a7b <deallocuvm+0xbf>
      pa = PTE_ADDR(*pte);
80108a26:	8b 45 ec             	mov    -0x14(%ebp),%eax
80108a29:	8b 00                	mov    (%eax),%eax
80108a2b:	25 00 f0 ff ff       	and    $0xfffff000,%eax
80108a30:	89 45 e8             	mov    %eax,-0x18(%ebp)
      save_this = is_shared(pa); //New: Add in project final
80108a33:	8b 45 e8             	mov    -0x18(%ebp),%eax
80108a36:	89 04 24             	mov    %eax,(%esp)
80108a39:	e8 a4 03 00 00       	call   80108de2 <is_shared>
80108a3e:	89 45 f0             	mov    %eax,-0x10(%ebp)
      if(pa == 0)
80108a41:	83 7d e8 00          	cmpl   $0x0,-0x18(%ebp)
80108a45:	75 0c                	jne    80108a53 <deallocuvm+0x97>
        panic("kfree");
80108a47:	c7 04 24 a1 94 10 80 	movl   $0x801094a1,(%esp)
80108a4e:	e8 e3 7a ff ff       	call   80100536 <panic>
      // char *v = p2v(pa);
      // kfree(v);
      // *pte = 0;
      if (!save_this){ // New: Add in project final, ahi uno solo, le aplico el kfree
80108a53:	83 7d f0 00          	cmpl   $0x0,-0x10(%ebp)
80108a57:	75 22                	jne    80108a7b <deallocuvm+0xbf>
        char *v = p2v(pa);
80108a59:	8b 45 e8             	mov    -0x18(%ebp),%eax
80108a5c:	89 04 24             	mov    %eax,(%esp)
80108a5f:	e8 24 f5 ff ff       	call   80107f88 <p2v>
80108a64:	89 45 e4             	mov    %eax,-0x1c(%ebp)
        kfree(v);
80108a67:	8b 45 e4             	mov    -0x1c(%ebp),%eax
80108a6a:	89 04 24             	mov    %eax,(%esp)
80108a6d:	e8 b3 9f ff ff       	call   80102a25 <kfree>
        *pte = 0;
80108a72:	8b 45 ec             	mov    -0x14(%ebp),%eax
80108a75:	c7 00 00 00 00 00    	movl   $0x0,(%eax)
  for(; a  < oldsz; a += PGSIZE){
80108a7b:	81 45 f4 00 10 00 00 	addl   $0x1000,-0xc(%ebp)
80108a82:	8b 45 f4             	mov    -0xc(%ebp),%eax
80108a85:	3b 45 0c             	cmp    0xc(%ebp),%eax
80108a88:	0f 82 60 ff ff ff    	jb     801089ee <deallocuvm+0x32>
      }
    }
  }
  return newsz;
...
80108a96:	83 ec 28             	sub    $0x28,%esp
  ...
  if(pgdir == 0)
80108a99:	83 7d 08 00          	cmpl   $0x0,0x8(%ebp)
80108a9d:	75 0c                	jne    80108aab <freevm+0x18>
    panic("freevm: no pgdir");
80108a9f:	c7 04 24 a7 94 10 80 	movl   $0x801094a7,(%esp)
80108aa6:	e8 8b 7a ff ff       	call   80100536 <panic>
  deallocuvm(pgdir, KERNBASE, 0);
80108aab:	c7 44 24 08 00 00 00 	movl   $0x0,0x8(%esp)
80108ab2:	00 
80108ab3:	c7 44 24 04 00 00 00 	movl   $0x80000000,0x4(%esp)
80108aba:	80 
80108abb:	8b 45 08             	mov    0x8(%ebp),%eax
80108abe:	89 04 24             	mov    %eax,(%esp)
80108ac1:	e8 f6 fe ff ff       	call   801089bc <deallocuvm>
  for(i = 0; i < NPDENTRIES; i++){
80108ac6:	c7 45 f4 00 00 00 00 	movl   $0x0,-0xc(%ebp)
80108acd:	eb 47                	jmp    80108b16 <freevm+0x83>
    if(pgdir[i] & PTE_P){
80108acf:	8b 45 f4             	mov    -0xc(%ebp),%eax
80108ad2:	8d 14 85 00 00 00 00 	lea    0x0(,%eax,4),%edx
80108ad9:	8b 45 08             	mov    0x8(%ebp),%eax
80108adc:	01 d0                	add    %edx,%eax
80108ade:	8b 00                	mov    (%eax),%eax
80108ae0:	83 e0 01             	and    $0x1,%eax
80108ae3:	85 c0                	test   %eax,%eax
80108ae5:	74 2c                	je     80108b13 <freevm+0x80>
...
80108b00:	e8 83 f4 ff ff       	call   80107f88 <p2v>
80108b05:	89 45 f0             	mov    %eax,-0x10(%ebp)
      kfree(v);
80108b08:	8b 45 f0             	mov    -0x10(%ebp),%eax
80108b0b:	89 04 24             	mov    %eax,(%esp)
80108b0e:	e8 12 9f ff ff       	call   80102a25 <kfree>
  for(i = 0; i < NPDENTRIES; i++){
80108b13:	ff 45 f4             	incl   -0xc(%ebp)
80108b16:	81 7d f4 ff 03 00 00 	cmpl   $0x3ff,-0xc(%ebp)
80108b1d:	76 b0                	jbe    80108acf <freevm+0x3c>
    }
  }
  kfree((char*)pgdir);
80108b1f:	8b 45 08             	mov    0x8(%ebp),%eax
80108b22:	89 04 24             	mov    %eax,(%esp)
80108b25:	e8 fb 9e ff ff       	call   80102a25 <kfree>
}
80108b2a:	c9                   	leave  
80108b2b:	c3                   	ret    
...
{
80108b2c:	55                   	push   %ebp
80108b2d:	89 e5                	mov    %esp,%ebp
80108b2f:	83 ec 28             	sub    $0x28,%esp
  pte_t *pte;

  pte = walkpgdir(pgdir, uva, 0);
80108b32:	c7 44 24 08 00 00 00 	movl   $0x0,0x8(%esp)
80108b39:	00 
80108b3a:	8b 45 0c             	mov    0xc(%ebp),%eax
80108b3d:	89 44 24 04          	mov    %eax,0x4(%esp)
80108b41:	8b 45 08             	mov    0x8(%ebp),%eax
80108b44:	89 04 24             	mov    %eax,(%esp)
80108b47:	e8 9a f8 ff ff       	call   801083e6 <walkpgdir>
80108b4c:	89 45 f4             	mov    %eax,-0xc(%ebp)
  if(pte == 0)
80108b4f:	83 7d f4 00          	cmpl   $0x0,-0xc(%ebp)
80108b53:	75 0c                	jne    80108b61 <clearpteu+0x35>
    panic("clearpteu");
80108b55:	c7 04 24 b8 94 10 80 	movl   $0x801094b8,(%esp)
80108b5c:	e8 d5 79 ff ff       	call   80100536 <panic>
  *pte &= ~PTE_U;
80108b61:	8b 45 f4             	mov    -0xc(%ebp),%eax
80108b64:	8b 00                	mov    (%eax),%eax
80108b66:	89 c2                	mov    %eax,%edx
80108b68:	83 e2 fb             	and    $0xfffffffb,%edx
80108b6b:	8b 45 f4             	mov    -0xc(%ebp),%eax
80108b6e:	89 10                	mov    %edx,(%eax)
}
80108b70:	c9                   	leave  
80108b71:	c3                   	ret    
...
80108b76:	83 ec 44             	sub    $0x44,%esp
  pte_t *pte;
  uint pa, i, flags;
  char *mem;
  ...
  if((d = setupkvm()) == 0)
80108b79:	e8 9e f9 ff ff       	call   8010851c <setupkvm>
80108b7e:	89 45 f0             	mov    %eax,-0x10(%ebp)
80108b81:	83 7d f0 00          	cmpl   $0x0,-0x10(%ebp)
80108b85:	75 0a                	jne    80108b91 <copyuvm+0x1f>
    return 0;
80108b87:	b8 00 00 00 00       	mov    $0x0,%eax
80108b8c:	e9 43 01 00 00       	jmp    80108cd4 <copyuvm+0x162>
  for(i = 0; i < sz; i += PGSIZE){
80108b91:	c7 45 f4 00 00 00 00 	movl   $0x0,-0xc(%ebp)
80108b98:	e9 12 01 00 00       	jmp    80108caf <copyuvm+0x13d>
    if((pte = walkpgdir(pgdir, (void *) i, 0)) == 0)
80108b9d:	8b 45 f4             	mov    -0xc(%ebp),%eax
80108ba0:	c7 44 24 08 00 00 00 	movl   $0x0,0x8(%esp)
80108ba7:	00 
80108ba8:	89 44 24 04          	mov    %eax,0x4(%esp)
80108bac:	8b 45 08             	mov    0x8(%ebp),%eax
80108baf:	89 04 24             	mov    %eax,(%esp)
80108bb2:	e8 2f f8 ff ff       	call   801083e6 <walkpgdir>
80108bb7:	89 45 ec             	mov    %eax,-0x14(%ebp)
80108bba:	83 7d ec 00          	cmpl   $0x0,-0x14(%ebp)
80108bbe:	75 0c                	jne    80108bcc <copyuvm+0x5a>
      panic("copyuvm: pte should exist");
80108bc0:	c7 04 24 c2 94 10 80 	movl   $0x801094c2,(%esp)
80108bc7:	e8 6a 79 ff ff       	call   80100536 <panic>
    if(!(*pte & PTE_P))
80108bcc:	8b 45 ec             	mov    -0x14(%ebp),%eax
80108bcf:	8b 00                	mov    (%eax),%eax
80108bd1:	83 e0 01             	and    $0x1,%eax
80108bd4:	85 c0                	test   %eax,%eax
80108bd6:	75 0c                	jne    80108be4 <copyuvm+0x72>
      panic("copyuvm: page not present");
80108bd8:	c7 04 24 dc 94 10 80 	movl   $0x801094dc,(%esp)
80108bdf:	e8 52 79 ff ff       	call   80100536 <panic>
    pa = PTE_ADDR(*pte);
80108be4:	8b 45 ec             	mov    -0x14(%ebp),%eax
80108be7:	8b 00                	mov    (%eax),%eax
80108be9:	25 00 f0 ff ff       	and    $0xfffff000,%eax
80108bee:	89 45 e8             	mov    %eax,-0x18(%ebp)
    flags = PTE_FLAGS(*pte);
80108bf1:	8b 45 ec             	mov    -0x14(%ebp),%eax
80108bf4:	8b 00                	mov    (%eax),%eax
80108bf6:	25 ff 0f 00 00       	and    $0xfff,%eax
80108bfb:	89 45 e4             	mov    %eax,-0x1c(%ebp)

    only_map = is_shared(pa); // New: Add in project final
80108bfe:	8b 45 e8             	mov    -0x18(%ebp),%eax
80108c01:	89 04 24             	mov    %eax,(%esp)
80108c04:	e8 d9 01 00 00       	call   80108de2 <is_shared>
80108c09:	89 45 e0             	mov    %eax,-0x20(%ebp)
    if (!only_map) { 
80108c0c:	83 7d e0 00          	cmpl   $0x0,-0x20(%ebp)
80108c10:	75 6a                	jne    80108c7c <copyuvm+0x10a>
      if((mem = kalloc()) == 0) // el kalloc no pudo asignar la memoria
80108c12:	e8 a7 9e ff ff       	call   80102abe <kalloc>
80108c17:	89 45 dc             	mov    %eax,-0x24(%ebp)
80108c1a:	83 7d dc 00          	cmpl   $0x0,-0x24(%ebp)
80108c1e:	0f 84 9c 00 00 00    	je     80108cc0 <copyuvm+0x14e>
        goto bad;
      memmove(mem, (char*)p2v(pa), PGSIZE);
80108c24:	8b 45 e8             	mov    -0x18(%ebp),%eax
80108c27:	89 04 24             	mov    %eax,(%esp)
80108c2a:	e8 59 f3 ff ff       	call   80107f88 <p2v>
80108c2f:	c7 44 24 08 00 10 00 	movl   $0x1000,0x8(%esp)
80108c36:	00 
80108c37:	89 44 24 04          	mov    %eax,0x4(%esp)
80108c3b:	8b 45 dc             	mov    -0x24(%ebp),%eax
80108c3e:	89 04 24             	mov    %eax,(%esp)
80108c41:	e8 7e cc ff ff       	call   801058c4 <memmove>
      if(mappages(d, (void*)i, PGSIZE, v2p(mem), flags) < 0)
80108c46:	8b 5d e4             	mov    -0x1c(%ebp),%ebx
80108c49:	8b 45 dc             	mov    -0x24(%ebp),%eax
80108c4c:	89 04 24             	mov    %eax,(%esp)
80108c4f:	e8 27 f3 ff ff       	call   80107f7b <v2p>
80108c54:	8b 55 f4             	mov    -0xc(%ebp),%edx
80108c57:	89 5c 24 10          	mov    %ebx,0x10(%esp)
80108c5b:	89 44 24 0c          	mov    %eax,0xc(%esp)
80108c5f:	c7 44 24 08 00 10 00 	movl   $0x1000,0x8(%esp)
80108c66:	00 
80108c67:	89 54 24 04          	mov    %edx,0x4(%esp)
80108c6b:	8b 45 f0             	mov    -0x10(%ebp),%eax
80108c6e:	89 04 24             	mov    %eax,(%esp)
80108c71:	e8 12 f8 ff ff       	call   80108488 <mappages>
80108c76:	85 c0                	test   %eax,%eax
80108c78:	79 2e                	jns    80108ca8 <copyuvm+0x136>
        goto bad;
80108c7a:	eb 48                	jmp    80108cc4 <copyuvm+0x152>
    } else {
      if(mappages(d, (void*)i, PGSIZE, pa, flags) < 0)
80108c7c:	8b 55 e4             	mov    -0x1c(%ebp),%edx
80108c7f:	8b 45 f4             	mov    -0xc(%ebp),%eax
80108c82:	89 54 24 10          	mov    %edx,0x10(%esp)
80108c86:	8b 55 e8             	mov    -0x18(%ebp),%edx
80108c89:	89 54 24 0c          	mov    %edx,0xc(%esp)
80108c8d:	c7 44 24 08 00 10 00 	movl   $0x1000,0x8(%esp)
80108c94:	00 
80108c95:	89 44 24 04          	mov    %eax,0x4(%esp)
80108c99:	8b 45 f0             	mov    -0x10(%ebp),%eax
80108c9c:	89 04 24             	mov    %eax,(%esp)
80108c9f:	e8 e4 f7 ff ff       	call   80108488 <mappages>
80108ca4:	85 c0                	test   %eax,%eax
80108ca6:	78 1b                	js     80108cc3 <copyuvm+0x151>
  for(i = 0; i < sz; i += PGSIZE){
80108ca8:	81 45 f4 00 10 00 00 	addl   $0x1000,-0xc(%ebp)
80108caf:	8b 45 f4             	mov    -0xc(%ebp),%eax
80108cb2:	3b 45 0c             	cmp    0xc(%ebp),%eax
80108cb5:	0f 82 e2 fe ff ff    	jb     80108b9d <copyuvm+0x2b>
        goto bad;
     }
  }
  return d;
80108cbb:	8b 45 f0             	mov    -0x10(%ebp),%eax
80108cbe:	eb 14                	jmp    80108cd4 <copyuvm+0x162>
        goto bad;
80108cc0:	90                   	nop
80108cc1:	eb 01                	jmp    80108cc4 <copyuvm+0x152>
        goto bad;
80108cc3:	90                   	nop
...
80108cca:	e8 c4 fd ff ff       	call   80108a93 <freevm>
  return 0;
80108ccf:	b8 00 00 00 00       	mov    $0x0,%eax
}
80108cd4:	83 c4 44             	add    $0x44,%esp
80108cd7:	5b                   	pop    %ebx
80108cd8:	5d                   	pop    %ebp
80108cd9:	c3                   	ret    
...
80108cf5:	e8 ec f6 ff ff       	call   801083e6 <walkpgdir>
80108cfa:	89 45 f4             	mov    %eax,-0xc(%ebp)
  if((*pte & PTE_P) == 0)
80108cfd:	8b 45 f4             	mov    -0xc(%ebp),%eax
80108d00:	8b 00                	mov    (%eax),%eax
80108d02:	83 e0 01             	and    $0x1,%eax
80108d05:	85 c0                	test   %eax,%eax
80108d07:	75 07                	jne    80108d10 <uva2ka+0x36>
    return 0;
80108d09:	b8 00 00 00 00       	mov    $0x0,%eax
80108d0e:	eb 25                	jmp    80108d35 <uva2ka+0x5b>
  if((*pte & PTE_U) == 0)
80108d10:	8b 45 f4             	mov    -0xc(%ebp),%eax
80108d13:	8b 00                	mov    (%eax),%eax
80108d15:	83 e0 04             	and    $0x4,%eax
80108d18:	85 c0                	test   %eax,%eax
80108d1a:	75 07                	jne    80108d23 <uva2ka+0x49>
    return 0;
80108d1c:	b8 00 00 00 00       	mov    $0x0,%eax
80108d21:	eb 12                	jmp    80108d35 <uva2ka+0x5b>
  return (char*)p2v(PTE_ADDR(*pte));
80108d23:	8b 45 f4             	mov    -0xc(%ebp),%eax
80108d26:	8b 00                	mov    (%eax),%eax
80108d28:	25 00 f0 ff ff       	and    $0xfffff000,%eax
80108d2d:	89 04 24             	mov    %eax,(%esp)
80108d30:	e8 53 f2 ff ff       	call   80107f88 <p2v>
}
80108d35:	c9                   	leave  
80108d36:	c3                   	ret    
...
80108d3a:	83 ec 28             	sub    $0x28,%esp
  char *buf, *pa0;
  uint n, va0;

  buf = (char*)p;
80108d3d:	8b 45 10             	mov    0x10(%ebp),%eax
80108d40:	89 45 f4             	mov    %eax,-0xc(%ebp)
  while(len > 0){
80108d43:	e9 89 00 00 00       	jmp    80108dd1 <copyout+0x9a>
    va0 = (uint)PGROUNDDOWN(va);
80108d48:	8b 45 0c             	mov    0xc(%ebp),%eax
80108d4b:	25 00 f0 ff ff       	and    $0xfffff000,%eax
80108d50:	89 45 ec             	mov    %eax,-0x14(%ebp)
    pa0 = uva2ka(pgdir, (char*)va0);
80108d53:	8b 45 ec             	mov    -0x14(%ebp),%eax
80108d56:	89 44 24 04          	mov    %eax,0x4(%esp)
80108d5a:	8b 45 08             	mov    0x8(%ebp),%eax
80108d5d:	89 04 24             	mov    %eax,(%esp)
80108d60:	e8 75 ff ff ff       	call   80108cda <uva2ka>
80108d65:	89 45 e8             	mov    %eax,-0x18(%ebp)
    if(pa0 == 0)
80108d68:	83 7d e8 00          	cmpl   $0x0,-0x18(%ebp)
80108d6c:	75 07                	jne    80108d75 <copyout+0x3e>
      return -1;
80108d6e:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80108d73:	eb 6b                	jmp    80108de0 <copyout+0xa9>
    n = PGSIZE - (va - va0);
80108d75:	8b 45 0c             	mov    0xc(%ebp),%eax
80108d78:	8b 55 ec             	mov    -0x14(%ebp),%edx
80108d7b:	89 d1                	mov    %edx,%ecx
80108d7d:	29 c1                	sub    %eax,%ecx
80108d7f:	89 c8                	mov    %ecx,%eax
80108d81:	05 00 10 00 00       	add    $0x1000,%eax
80108d86:	89 45 f0             	mov    %eax,-0x10(%ebp)
    if(n > len)
80108d89:	8b 45 f0             	mov    -0x10(%ebp),%eax
80108d8c:	3b 45 14             	cmp    0x14(%ebp),%eax
80108d8f:	76 06                	jbe    80108d97 <copyout+0x60>
      n = len;
80108d91:	8b 45 14             	mov    0x14(%ebp),%eax
80108d94:	89 45 f0             	mov    %eax,-0x10(%ebp)
    memmove(pa0 + (va - va0), buf, n);
80108d97:	8b 45 ec             	mov    -0x14(%ebp),%eax
80108d9a:	8b 55 0c             	mov    0xc(%ebp),%edx
80108d9d:	29 c2                	sub    %eax,%edx
80108d9f:	8b 45 e8             	mov    -0x18(%ebp),%eax
80108da2:	01 c2                	add    %eax,%edx
80108da4:	8b 45 f0             	mov    -0x10(%ebp),%eax
80108da7:	89 44 24 08          	mov    %eax,0x8(%esp)
80108dab:	8b 45 f4             	mov    -0xc(%ebp),%eax
80108dae:	89 44 24 04          	mov    %eax,0x4(%esp)
80108db2:	89 14 24             	mov    %edx,(%esp)
80108db5:	e8 0a cb ff ff       	call   801058c4 <memmove>
    len -= n;
80108dba:	8b 45 f0             	mov    -0x10(%ebp),%eax
80108dbd:	29 45 14             	sub    %eax,0x14(%ebp)
    buf += n;
80108dc0:	8b 45 f0             	mov    -0x10(%ebp),%eax
80108dc3:	01 45 f4             	add    %eax,-0xc(%ebp)
    va = va0 + PGSIZE;
80108dc6:	8b 45 ec             	mov    -0x14(%ebp),%eax
80108dc9:	05 00 10 00 00       	add    $0x1000,%eax
80108dce:	89 45 0c             	mov    %eax,0xc(%ebp)
  while(len > 0){
80108dd1:	83 7d 14 00          	cmpl   $0x0,0x14(%ebp)
80108dd5:	0f 85 6d ff ff ff    	jne    80108d48 <copyout+0x11>
  }
  return 0;
...
int
is_shared(uint pa){
80108de2:	55                   	push   %ebp
80108de3:	89 e5                	mov    %esp,%ebp
80108de5:	83 ec 28             	sub    $0x28,%esp
  int j;
  struct sharedmemory* shared_array = get_shm_table(); 
80108de8:	e8 53 c6 ff ff       	call   80105440 <get_shm_table>
80108ded:	89 45 ec             	mov    %eax,-0x14(%ebp)
  int shared = 0;
80108df0:	c7 45 f0 00 00 00 00 	movl   $0x0,-0x10(%ebp)

  for(j=0; j<MAXSHM; j++){ // recorro mi arreglo sharedmemory
80108df7:	c7 45 f4 00 00 00 00 	movl   $0x0,-0xc(%ebp)
80108dfe:	eb 42                	jmp    80108e42 <is_shared+0x60>
...
80108e06:	e8 7d f1 ff ff       	call   80107f88 <p2v>
80108e0b:	8b 55 f4             	mov    -0xc(%ebp),%edx
80108e0e:	8d 0c d5 00 00 00 00 	lea    0x0(,%edx,8),%ecx
80108e15:	8b 55 ec             	mov    -0x14(%ebp),%edx
80108e18:	01 ca                	add    %ecx,%edx
80108e1a:	8b 12                	mov    (%edx),%edx
80108e1c:	39 d0                	cmp    %edx,%eax
80108e1e:	75 1f                	jne    80108e3f <is_shared+0x5d>
80108e20:	8b 45 f4             	mov    -0xc(%ebp),%eax
80108e23:	8d 14 c5 00 00 00 00 	lea    0x0(,%eax,8),%edx
80108e2a:	8b 45 ec             	mov    -0x14(%ebp),%eax
80108e2d:	01 d0                	add    %edx,%eax
80108e2f:	8b 40 04             	mov    0x4(%eax),%eax
80108e32:	85 c0                	test   %eax,%eax
80108e34:	7e 09                	jle    80108e3f <is_shared+0x5d>
      shared = j+1;
80108e36:	8b 45 f4             	mov    -0xc(%ebp),%eax
80108e39:	40                   	inc    %eax
80108e3a:	89 45 f0             	mov    %eax,-0x10(%ebp)
      break;
80108e3d:	eb 09                	jmp    80108e48 <is_shared+0x66>
  for(j=0; j<MAXSHM; j++){ // recorro mi arreglo sharedmemory
80108e3f:	ff 45 f4             	incl   -0xc(%ebp)
80108e42:	83 7d f4 0b          	cmpl   $0xb,-0xc(%ebp)
80108e46:	7e b8                	jle    80108e00 <is_shared+0x1e>
    }
  }
  return shared; // ahi uno solo
80108e48:	8b 45 f0             	mov    -0x10(%ebp),%eax
}
80108e4b:	c9                   	leave  
80108e4c:	c3                   	ret    
