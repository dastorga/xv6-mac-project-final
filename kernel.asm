...
80105396:	89 45 f0             	mov    %eax,-0x10(%ebp)
            // tabla de pagina del proceso, tamaño de la memoria del proceso, PGSIZE, dir. memoria fisica, Page table/directory entry flags.
...
801053be:	83 c1 28             	add    $0x28,%ecx
...
801053f6:	8b 90 b8 00 00 00    	mov    0xb8(%eax),%edx
801053fc:	42                   	inc    %edx
801053fd:	89 90 b8 00 00 00    	mov    %edx,0xb8(%eax)
...
80105482:	8b 80 b8 00 00 00    	mov    0xb8(%eax),%eax
...
80106bf8:	eb 6c                	jmp    80106c66 <sys_sleep+0x90>
  acquire(&tickslock);
80106bfa:	c7 04 24 20 40 11 80 	movl   $0x80114020,(%esp)
80106c01:	e8 8d e9 ff ff       	call   80105593 <acquire>
  ticks0 = ticks;
80106c06:	a1 60 48 11 80       	mov    0x80114860,%eax
...
80106c1b:	74 13                	je     80106c30 <sys_sleep+0x5a>
      release(&tickslock);
80106c1d:	c7 04 24 20 40 11 80 	movl   $0x80114020,(%esp)
...
80106c30:	c7 44 24 04 20 40 11 	movl   $0x80114020,0x4(%esp)
80106c37:	80 
80106c38:	c7 04 24 60 48 11 80 	movl   $0x80114860,(%esp)
80106c3f:	e8 87 de ff ff       	call   80104acb <sleep>
  while(ticks - ticks0 < n){
80106c44:	a1 60 48 11 80       	mov    0x80114860,%eax
...
80106c53:	72 bb                	jb     80106c10 <sys_sleep+0x3a>
  ...
  release(&tickslock);
80106c55:	c7 04 24 20 40 11 80 	movl   $0x80114020,(%esp)
...
80106c6b:	83 ec 28             	sub    $0x28,%esp
  ...
  acquire(&tickslock);
80106c6e:	c7 04 24 20 40 11 80 	movl   $0x80114020,(%esp)
80106c75:	e8 19 e9 ff ff       	call   80105593 <acquire>
  xticks = ticks;
80106c7a:	a1 60 48 11 80       	mov    0x80114860,%eax
80106c7f:	89 45 f4             	mov    %eax,-0xc(%ebp)
  release(&tickslock);
80106c82:	c7 04 24 20 40 11 80 	movl   $0x80114020,(%esp)
...
80106ea9:	66 89 04 d5 60 40 11 	mov    %ax,-0x7feebfa0(,%edx,8)
80106eb0:	80 
80106eb1:	8b 45 f4             	mov    -0xc(%ebp),%eax
80106eb4:	66 c7 04 c5 62 40 11 	movw   $0x8,-0x7feebf9e(,%eax,8)
80106ebb:	80 08 00 
80106ebe:	8b 45 f4             	mov    -0xc(%ebp),%eax
80106ec1:	8a 14 c5 64 40 11 80 	mov    -0x7feebf9c(,%eax,8),%dl
80106ec8:	83 e2 e0             	and    $0xffffffe0,%edx
80106ecb:	88 14 c5 64 40 11 80 	mov    %dl,-0x7feebf9c(,%eax,8)
80106ed2:	8b 45 f4             	mov    -0xc(%ebp),%eax
80106ed5:	8a 14 c5 64 40 11 80 	mov    -0x7feebf9c(,%eax,8),%dl
80106edc:	83 e2 1f             	and    $0x1f,%edx
80106edf:	88 14 c5 64 40 11 80 	mov    %dl,-0x7feebf9c(,%eax,8)
80106ee6:	8b 45 f4             	mov    -0xc(%ebp),%eax
80106ee9:	8a 14 c5 65 40 11 80 	mov    -0x7feebf9b(,%eax,8),%dl
80106ef0:	83 e2 f0             	and    $0xfffffff0,%edx
80106ef3:	83 ca 0e             	or     $0xe,%edx
80106ef6:	88 14 c5 65 40 11 80 	mov    %dl,-0x7feebf9b(,%eax,8)
80106efd:	8b 45 f4             	mov    -0xc(%ebp),%eax
80106f00:	8a 14 c5 65 40 11 80 	mov    -0x7feebf9b(,%eax,8),%dl
80106f07:	83 e2 ef             	and    $0xffffffef,%edx
80106f0a:	88 14 c5 65 40 11 80 	mov    %dl,-0x7feebf9b(,%eax,8)
80106f11:	8b 45 f4             	mov    -0xc(%ebp),%eax
80106f14:	8a 14 c5 65 40 11 80 	mov    -0x7feebf9b(,%eax,8),%dl
80106f1b:	83 e2 9f             	and    $0xffffff9f,%edx
80106f1e:	88 14 c5 65 40 11 80 	mov    %dl,-0x7feebf9b(,%eax,8)
80106f25:	8b 45 f4             	mov    -0xc(%ebp),%eax
80106f28:	8a 14 c5 65 40 11 80 	mov    -0x7feebf9b(,%eax,8),%dl
80106f2f:	83 ca 80             	or     $0xffffff80,%edx
80106f32:	88 14 c5 65 40 11 80 	mov    %dl,-0x7feebf9b(,%eax,8)
...
80106f49:	66 89 04 d5 66 40 11 	mov    %ax,-0x7feebf9a(,%edx,8)
80106f50:	80 
  for(i = 0; i < 256; i++)
...
80106f66:	66 a3 60 42 11 80    	mov    %ax,0x80114260
80106f6c:	66 c7 05 62 42 11 80 	movw   $0x8,0x80114262
80106f73:	08 00 
80106f75:	a0 64 42 11 80       	mov    0x80114264,%al
80106f7a:	83 e0 e0             	and    $0xffffffe0,%eax
80106f7d:	a2 64 42 11 80       	mov    %al,0x80114264
80106f82:	a0 64 42 11 80       	mov    0x80114264,%al
80106f87:	83 e0 1f             	and    $0x1f,%eax
80106f8a:	a2 64 42 11 80       	mov    %al,0x80114264
80106f8f:	a0 65 42 11 80       	mov    0x80114265,%al
80106f94:	83 c8 0f             	or     $0xf,%eax
80106f97:	a2 65 42 11 80       	mov    %al,0x80114265
80106f9c:	a0 65 42 11 80       	mov    0x80114265,%al
80106fa1:	83 e0 ef             	and    $0xffffffef,%eax
80106fa4:	a2 65 42 11 80       	mov    %al,0x80114265
80106fa9:	a0 65 42 11 80       	mov    0x80114265,%al
80106fae:	83 c8 60             	or     $0x60,%eax
80106fb1:	a2 65 42 11 80       	mov    %al,0x80114265
80106fb6:	a0 65 42 11 80       	mov    0x80114265,%al
80106fbb:	83 c8 80             	or     $0xffffff80,%eax
80106fbe:	a2 65 42 11 80       	mov    %al,0x80114265
80106fc3:	a1 c4 c1 10 80       	mov    0x8010c1c4,%eax
80106fc8:	c1 e8 10             	shr    $0x10,%eax
80106fcb:	66 a3 66 42 11 80    	mov    %ax,0x80114266
  
  initlock(&tickslock, "time");
80106fd1:	c7 44 24 04 bc 92 10 	movl   $0x801092bc,0x4(%esp)
80106fd8:	80 
80106fd9:	c7 04 24 20 40 11 80 	movl   $0x80114020,(%esp)
...
80106ff4:	00 
80106ff5:	c7 04 24 60 40 11 80 	movl   $0x80114060,(%esp)
...
8010707a:	75 2f                	jne    801070ab <trap+0xa8>
      acquire(&tickslock);
8010707c:	c7 04 24 20 40 11 80 	movl   $0x80114020,(%esp)
80107083:	e8 0b e5 ff ff       	call   80105593 <acquire>
      ticks++;
80107088:	a1 60 48 11 80       	mov    0x80114860,%eax
8010708d:	40                   	inc    %eax
8010708e:	a3 60 48 11 80       	mov    %eax,0x80114860
      wakeup(&ticks);
80107093:	c7 04 24 60 48 11 80 	movl   $0x80114860,(%esp)
8010709a:	e8 34 db ff ff       	call   80104bd3 <wakeup>
      release(&tickslock);
8010709f:	c7 04 24 20 40 11 80 	movl   $0x80114020,(%esp)
...
801085d1:	a3 b8 48 11 80       	mov    %eax,0x801148b8
  switchkvm();
...
801085e3:	a1 b8 48 11 80       	mov    0x801148b8,%eax
